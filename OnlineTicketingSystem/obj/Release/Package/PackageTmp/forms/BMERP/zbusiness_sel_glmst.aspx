<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="zbusiness_sel_glmst.aspx.cs"
    Inherits="OnlineTicketingSystem.forms.BMERP.zbusiness_sel_glmst" EnableEventValidation="false" %>
            ...
            <tr>
                <td style="font-size: large">
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                    <asp:Label ID="Label1" runat="server" Text="Select Level for Business" Style="font-weight: 700;
                            ...
                            <table width="100%">
                                <tr>
                                    <td style="text-align: center">
                                        <asp:Button ID="btnAdd" runat="server" Text="Add" Width="99px" OnClick="btnAdd_Click" /><%--<asp:Label
                                            ID="Label2" runat="server" Text="Label"></asp:Label>--%>
                                        <asp:Button ID="btnUpdate0" runat="server" Text="Update" 
                                            Width="99px" onclick="btnUpdate0_Click" />
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None"
                                            ...
                                            <Columns>
                                                <asp:TemplateField HeaderText="Business Id">
                                                    <ItemTemplate>
                                                         <asp:LinkButton ID="zid1" runat="server" Text='<%#Eval("zid1") %>' OnClick="FillControls"></asp:LinkButton>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:BoundField DataField="zorg" HeaderText="Business" />
                                                <asp:BoundField DataField="xhrc1" HeaderText="Level1" />
                                                <asp:BoundField DataField="xhrc2" HeaderText="Level2" />
                                                <asp:BoundField DataField="xhrc3" HeaderText="Level3" />
                                                <asp:BoundField DataField="xhrc4" HeaderText="Level4" />
                                                <asp:BoundField DataField="xhrc5" HeaderText="Level5" />                                            
                                            </Columns>
