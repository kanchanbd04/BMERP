<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="mssupinfo.aspx.cs" Inherits="OnlineTicketingSystem.forms.BMERP.ms.supplier.mssupinfo" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $('#<%=business.ClientID %>').live('click', function (e) {
                ...
                var page = "../../../BMERP/zbusiness_sel_ms_sup.aspx?key=" + key1;
                var $dialog = $('<div></div>')
                .html('<iframe style="border: 0px; " src="' + page + '" width="100%" height="100%"></iframe>')
                .dialog({
                    autoOpen: false,
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <tr>
        <td class="style4">
            <strong>Supplier Info</strong></td>
        <td class="style2" rowspan="2">
        <table width="100%">
         <tr>
        <td class="style400" colspan="4">
            Confirmed Supplier Record(s) List</td>
    </tr>
    <tr><td>
                ...
                Width="536px">
                    ...
                    <asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="#333333" 
                        ...
                        <asp:LinkButton ID="xrow" runat="server"  Text='<%#Eval("xrow") %>' OnClick="FillControls"></asp:LinkButton>
                             ...
                             <asp:BoundField DataField="xsup" HeaderText="Supplier Number" />
                            <asp:BoundField DataField="xorg" HeaderText="Company" />
                            <asp:BoundField DataField="xeffdt" HeaderText="Effected Date" DataFormatString="{0:d}" />
                            <asp:BoundField DataField="xmobile" HeaderText="Mobile" />
            ...
            <table style="width:100%;">
                ...
                <tr>
                    <td class="style32">
                        Customer Prefix</td>
                    <td class="style33">
                        <asp:Label ID="xtrn" runat="server" Text="SUP-"></asp:Label>
                    </td>
                    <td class="style7">
                        Supplier ID</td>
                    <td class="style29">
                        <asp:TextBox ID="xsup" runat="server" Width="151px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td class="style32">
                    ...
                    <td class="style7">
                        Opening Date</td>
                    <td class="style29">
                        <asp:TextBox ID="xdateact" runat="server" Width="151px"></asp:TextBox>
                        [MM/DD/YYYY]</td>
                </tr>
                <tr>
                    <td class="style32">
                ...
                <tr>
                    ...
                    <td class="style7">
                        Country</td>
                    <td class="style29">
                        <asp:DropDownList ID="xcountry" runat="server" Height="20px" 
                              Width="151px"  >
                ...
                <tr>
                    <td class="style32">
                        Supplier Group</td>
                    <td class="style33">
                        <asp:DropDownList ID="xtype" runat="server" Height="20px" 
                              Width="151px" 
                            >
                            <asp:ListItem>[Select]</asp:ListItem>
                            <asp:ListItem>Local</asp:ListItem>
                            <asp:ListItem>Oversease</asp:ListItem>
                        </asp:DropDownList>
                    </td>
                    <td class="style7">
                        Active?</td>
