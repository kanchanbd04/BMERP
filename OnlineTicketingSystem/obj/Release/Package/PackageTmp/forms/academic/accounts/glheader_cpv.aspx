<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="glheader_cpv.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.glheader_cpv" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <script type="text/javascript">
                ...
                $("body").on("click", ".bm_am_btn_save", function () {
                    ...
                    var mendatoryFields = [
                             <%-- { "id": "<%= xsession.ClientID%>", "prop": "combo", "tab": "0" },--%>
                                ...
                                { "id": "<%= xacccr.ClientID%>", "prop": "listtext", "tab": "0" },
                                { "id": "<%= xprimecr.ClientID%>", "prop": "text", "tab": "0" }
               ...
               <%-- $("body").on("blur", "[id*=xacccr]", function () {
                    alert(document.getElementById('<%=hxacc.ClientID %>').value + ' ' + document.getElementById('<%=hxsub.ClientID %>').value);
                    return false;
                });--%>
                ...
                $("body").on("keyup", "[id*=xamountdr]", function () {
                    ...
                    var grandTotalcr = 0;
                     ...
                     //grid.rows[grid.rows.length - 1].cells[4].children[0].value = grandTotal;
                     grid.rows[grid.rows.length - 1].cells[3].innerHTML = grandTotaldr;
                     grid.rows[grid.rows.length - 1].cells[4].innerHTML = grandTotalcr + xprimecr;
                                ...
                                <div class="bm_layout_box_padding" style="padding-top: 0px;">
                                    ...
                                    <div style="width: 100%; clear: both;">
                                        ...
                                        <div>
                                            <div class="bm_ctl_container_50_100" style="width: 270px; float: left">
                                                <div class="bm_ctl_label_align_right_50_100" style="width: 120px">
                                                    <asp:Label ID="Label6" runat="server" Text=" Cash Account :" AssociatedControlID="xacccr"
                                                        CssClass="label"></asp:Label>
                                                </div>
                                                <div class="bm_clt_ctl_50_100" style="width: 148px">
                                        ...
                                        <div class="bm_ctl_container_100_special" style="width: 270px;">
                                            <div class="bm_ctl_label_align_right_100_special" style="width: 120px">
                                                <asp:Label ID="Label9" runat="server" Text="Amount :" AssociatedControlID="xprimecr"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_100_special" style="width: 148px">
