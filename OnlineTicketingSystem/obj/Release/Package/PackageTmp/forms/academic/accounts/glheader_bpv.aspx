<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="glheader_bpv.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.glheader_bpv" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
               ...
               <%--$("body").on("blur", "#<%=xtfccode.ClientID%>", function() {
                ...
                $("body").on("keyup", "[id*=xamountdr]", function () {
                    ...
                    var grid = document.getElementById('<%=GridView1.ClientID %>');
                     ...
                     var xprimecr = grandTotaldr - grandTotalcr;

                     $("#<%= xprimecr.ClientID%>").val(xprimecr);
                     //grid.rows[grid.rows.length - 1].cells[4].children[0].value = grandTotal;
                     grid.rows[grid.rows.length - 1].cells[6].innerHTML = grandTotaldr;
                     grid.rows[grid.rows.length - 1].cells[7].innerHTML = grandTotalcr + xprimecr;
            ...
            var xterm = $("#<%= xterm.ClientID%>").val();--%>
                   ...
                   <%--  var xstatus = $("#<%= hiddenxstatus.ClientID%>").val();--%>
                    var openwin = window.open('/forms/academic/reports/accounts/glvoucherpv.aspx?zid=' + zid + '&xvoucher=' + xvoucher1, 'bpv', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, copyhistory=no, width=' + screen.width + ', height=' + screen.height + ', top=0, left=0, targets=_blank');
                     openwin.focus();
                     //openwin.print();
                     //return false;
                 }
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Bank Payment Voucher</span>
                    </div>
                </div>
                                ...
                                <div class="bm_layout_box_padding" style="padding-top: 0px;">
                                    ...
                                    <div style="width: 100%; clear: both;">
                                        ...
                                        <div>
                                            <div class="bm_ctl_container_50_100" style="width: 270px; float: left">
                                                <div class="bm_ctl_label_align_right_50_100" style="width: 120px">
                                                    <asp:Label ID="Label6" runat="server" Text=" Bank Account :" AssociatedControlID="xacccr"
                                                        CssClass="label"></asp:Label>
                                                </div>
                                                <div class="bm_clt_ctl_50_100" style="width: 148px">
                                                    ...
                                                    <div class="bm_list_text" style="width: 120px">
                                                        <asp:TextBox ID="xacccr" runat="server" CssClass="bm_academic_textbox_50_100 bm_academic_ctl_global bm_academic_textbox "
                                                             ></asp:TextBox>
                                                    </div>
                                                    <div class="bm_list_img">
                                                        <asp:Image ID="Image1" runat="server" ImageUrl="~/images/list-am32x32.png" CssClass="bm_academic_list bm_xacccr" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div style="float: left; padding-left: 5px; padding-top: 1px">
                                        ...
                                        <div class="bm_ctl_container_100_special" style="width: 270px;">
                                            <div class="bm_ctl_label_align_right_100_special" style="width: 120px">
                                                <asp:Label ID="Label16" runat="server" Text="Amount :" AssociatedControlID="xprimecr"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_100_special" style="width: 148px">
                                                <asp:TextBox ReadOnly="True"  ID="xprimecr" runat="server" CssClass="bm_academic_textbox_50_100 bm_academic_ctl_global bm_academic_textbox "></asp:TextBox>
                                            </div>
                                        </div>
                                        ...
                                        <div class="bm_ctl_container_100_special" style="width: 270px;">
                                            <div class="bm_ctl_label_align_right_100_special" style="width: 120px">
                                                <asp:Label ID="Label9" runat="server" Text="Payment Type :" AssociatedControlID="xpaytypecr"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_100_special" style="width: 148px">
                                                <asp:DropDownList ID="xpaytypecr" runat="server" CssClass="bm_academic_dropdown_100_special bm_academic_ctl_global bm_academic_dropdown" >
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                        ...
                                        <div class="bm_ctl_container_100_special" style="width: 270px;">
                                            <div class="bm_ctl_label_align_right_100_special" style="width: 120px">
                                                <asp:Label ID="Label10" runat="server" Text="Cheque/Ref No :" AssociatedControlID="xchequecr"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_100_special" style="width: 148px">
                                                <asp:TextBox ID="xchequecr" runat="server" CssClass="bm_academic_textbox_50_100 bm_academic_ctl_global bm_academic_textbox "></asp:TextBox>
                                            </div>
                                        </div>
                                        </div>
                                        ...
                                        <div class="bm_ctl_container_100_special" style="width: 270px;">
                                            <div class="bm_ctl_label_align_right_100_special" style="width: 120px">
                                                <asp:Label ID="Label15" runat="server" Text="Cheque Date :" AssociatedControlID="xdateclrcr"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_100_special" style="width: 148px">
                                                <asp:TextBox ID="xdateclrcr" runat="server" CssClass="bm_academic_textbox_50_100 bm_academic_ctl_global bm_academic_datepicker"></asp:TextBox>
                                            </div>
                                        </div>
                                        </div>
                                                    ...
                                                    <Columns>
                                                      ...
                                                      <%--  <asp:TemplateField HeaderText="Sub Account">
                                                       ...
                                                       <%-- <asp:TemplateField HeaderText="Description">
                                                        ...
                                                        <asp:TemplateField HeaderText="Credit" HeaderStyle-CssClass="displaynone" FooterStyle-CssClass="displaynone"> <%--HeaderStyle-CssClass="displaynone" FooterStyle-CssClass="displaynone"--%>
                                                            <ItemStyle Width="120px" HorizontalAlign="Center" CssClass="displaynone"/> <%--CssClass="displaynone"--%>
                                                            <ItemTemplate>
                                    ...
                                    <div class="bm_academic_grid_container" id="list" runat="server">
                                        <div class="grid_header">
                                            <div class="grid_header_label" id="_grid_header" runat="server">
                                                Bank Payment Voucher(s) List - Unposted
                                            </div>
                                    ...
                                    <div class="bm_academic_grid_container" id="Div1" runat="server">
                                        <div class="grid_header">
                                            <div class="grid_header_label" id="Div2" runat="server">
                                                Bank Payment Voucher(s) List - Posted
                                            </div>
                                            <div class="grid_header_control">
                                            </div>
                                            <div class="flot_right">
