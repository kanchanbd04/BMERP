<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="glsupstm.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.glsupstm" %>
    ...
    <script type="text/javascript">
       ...
       function fnShowReport() {
         ...
         <%--  var nara1 = $("#<%= nara.ClientID%>").val();--%>
           ...
           var openwin = window.open('/forms/academic/reports/accounts/glsupstmrpt.aspx?zid=' + zid + '&fsup=' + fsup1 + '&fdate=' + fdate1 + '&tdate=' + tdate1 + '&tsup=' + tsup1 , 'supled', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, copyhistory=no, width=' + screen.width + ', height=' + screen.height + ', top=0, left=0, targets=_blank');
            openwin.focus();
            //openwin.print();
            return false;
        }
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Supplier Ledger</span>
                    </div>
                </div>
                                            ...
                                            <div class="bm_ctl_container_50_100" style="width: 270px; float: left">
                                                ...
                                                <div class="bm_clt_ctl_50_100" style="width: 148px">
                                                    ...
                                                    <div class="bm_list_text" style="width: 120px">
                                                        <asp:TextBox ID="fsup" runat="server" Text="0" CssClass="bm_academic_textbox_50_100 bm_academic_ctl_global bm_academic_textbox "></asp:TextBox>
                                                    </div>
                                        ...
                                        <div>
                                            <div class="bm_ctl_container_50_100" style="width: 270px; float: left">
                                                ...
                                                <div class="bm_clt_ctl_50_100" style="width: 148px">
                                                    ...
                                                    <div class="bm_list_text" style="width: 120px">
                                                        <asp:TextBox ID="tsup" runat="server" Text="z" CssClass="bm_academic_textbox_50_100 bm_academic_ctl_global bm_academic_textbox "></asp:TextBox>
                                                    </div>
                                                    <div class="bm_list_img">
