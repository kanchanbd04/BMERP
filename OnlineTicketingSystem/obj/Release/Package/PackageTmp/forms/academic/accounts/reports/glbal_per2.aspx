<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="glbal_per2.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.glbal_per2" %>
...
.GridViewScrollFooterFreeze TD {
    ...
    <script type="text/javascript">
       ...
       function fnShowReport() {
           ...
           var type1 = $("#<%= type.ClientID%>").val();
           <%--var drcr1 = $("#<%= drcr.ClientID%>").val();
           var led_break_up1 = $("#<%= led_break_up.ClientID%>").val();
           var nara1 = $("#<%= nara.ClientID%>").val();--%>
            

           var openwin = window.open('/forms/academic/reports/accounts/glbal_per2_rpt.aspx?zid=' + zid + '&fdate=' + fdate1 + '&tdate=' + tdate1 + '&ob=' + ob1 + '&year=' + year1 + '&type=' + type1, 'gltrialbal', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, copyhistory=no, width=' + screen.width + ', height=' + screen.height + ', top=0, left=0, targets=_blank');
            openwin.focus();
            //openwin.print();
            return false;
        }
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Periodical Trial Balance</span>
                    </div>
                </div>
                                ...
                                <div class="bm_layout_box_padding" style="padding-top: 10px; min-height: 300px;">
                                    ...
                                    <div style="width: 100%; clear: both;">
                                     ...
                                     <%--<div>
                                        ...
                                        <div class="bm_ctl_container_50_50" style="float: left; width: 270px">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label2" runat="server" Text="OB of Revenue A/C :" AssociatedControlID="ob"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 148px">
