<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="glbsfmt_dt.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.glbsfmt_dt" %>
...
.GridViewScrollFooterFreeze TD {
    ...
    <script type="text/javascript">
       ...
       function fnShowReport() {
           ...
           var rb1 = document.getElementById("<%=RadioButtonList2.ClientID%>");
           ...
           var openwin = window.open('/forms/academic/reports/accounts/glbsfmt_dt_rpt.aspx?zid=' + zid + '&fdate=' + fdate1 + '&tdate=' + tdate1 + '&year=' + year1 + '&xtype2=' + xtype2, 'glbsfmt_dt', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, copyhistory=no, width=' + screen.width + ', height=' + screen.height + ', top=0, left=0, targets=_blank');
            openwin.focus();
            //openwin.print();
            return false;
        }
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Periodical Balance Sheet</span>
                    </div>
                </div>
                                     ...
                                     <%--<div>
                                        ...
                                        <div style="width: 100%; " >
                                            ...
                                            <div style="float: left; padding-left: 5px">
                                                <asp:RadioButtonList ID="RadioButtonList2" runat="server" RepeatDirection="Horizontal" OnSelectedIndexChanged="RadioButtonList2_OnSelectedIndexChanged" AutoPostBack="True">
                                                    <asp:ListItem Text="As at date" Value="As at date" Selected="True"></asp:ListItem>
                                       ...
                                       <div class="bm_clt_padding">
                                        ...
                                        <div class="bm_ctl_container_50_50" style="float: left; width: 270px">
                                            ...
                                            <div class="bm_clt_ctl_50_50" style="width: 148px">
                                                <asp:DropDownList ID="acctype" runat="server" CssClass="bm_academic_dropdown_50_50 bm_academic_ctl_global bm_academic_dropdown bm_xclass">
                                                </asp:DropDownList>
                ...
                <asp:HiddenField ID="hxfdate" runat="server" />
        </ContentTemplate>
    </asp:UpdatePanel>
</asp:Content>
