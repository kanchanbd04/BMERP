<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="glplfmt_n1_dt.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.glplfmt_n1_dt" %>
...
.GridViewScrollFooterFreeze TD {
    ...
    <script type="text/javascript">
       ...
       function fnShowReport() {
           ...
           var openwin = window.open('/forms/academic/reports/accounts/glplfmt_n1_dt_rpt.aspx?zid=' + zid + '&fdate=' + fdate1 + '&tdate=' + tdate1 + '&year=' + year1 , 'glplfmt_n1_dt', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, copyhistory=no, width=' + screen.width + ', height=' + screen.height + ', top=0, left=0, targets=_blank');
            openwin.focus();
            //openwin.print();
            return false;
        }
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Periodical Income Statement</span>
                    </div>
                </div>
