<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="glpostvoucher.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.glpostvoucher" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <script type="text/javascript">
                ...
                $("body").on("click", "#<%=dgvunposted.ClientID%> input[id*='chkvoucher']:checkbox", function () {
                    //Get number of checkboxes in list either checked or not checked
                    var totalCheckboxes = $("#<%=dgvunposted.ClientID%> input[id*='chkvoucher']:checkbox").size();
                    //Get number of checked checkboxes in list
                    var checkedCheckboxes = $("#<%=dgvunposted.ClientID%> input[id*='chkvoucher']:checkbox:checked").size();
                    //Check / Uncheck top checkbox if all the checked boxes in list are checked
                    $("#<%=dgvunposted.ClientID%> input[id*='chkall']:checkbox").attr('checked', totalCheckboxes == checkedCheckboxes);
                });

                <%-- $("#<%=GridView1.ClientID%> input[id*='chkall']:checkbox").click(function () {--%>
                $("body").on("click", "#<%=dgvunposted.ClientID%> input[id*='chkall']:checkbox", function () {
                    //Check/uncheck all checkboxes in list according to main checkbox 
                    $("#<%=dgvunposted.ClientID%> input[id*='chkvoucher']:checkbox").attr('checked', $(this).is(':checked'));
                });

                $("body").on("click", ".btnconf", function () {
                    //alert("Hi");
                    var row = this.parentNode.parentNode;
                    var rowIndex = row.rowIndex - 1;
                    ...
                    var grid = document.getElementById('<%=dgvunposted.ClientID %>');
          ...
          //gridviewScroll();
            ...
            $('#<%=GridView1.ClientID%>').gridviewScroll({
                ...
                function fnPrintInfo(link) {
                    //alert("Hi");
                    var row = link.parentNode.parentNode;
                    var rowIndex = row.rowIndex - 1;
                    var zid = <%= HttpContext.Current.Session["business"] %>;
            var grid = document.getElementById('<%=dgvunposted.ClientID %>');
                       var xvoucher1 = grid.rows[rowIndex + 1].cells[1].children[0].innerText;
                    //alert(xvoucher1.substring(0,4));
                    var openwin;
                    var xprefix1 = xvoucher1.substring(0, 4);
                    if (xprefix1 == "CPV-") {
                        openwin = window.open('/forms/academic/accounts/glheader_cpv.aspx?subnav=myDropdown17&link=LinkButton17&xid=180015001&xvoucher=' + xvoucher1, 'cpv1', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, copyhistory=no, width=' + screen.width + ', height=' + screen.height + ', top=0, left=0, targets=_blank');
                        openwin.focus();
                    }else if (xprefix1 == "CRV-") {
                        openwin = window.open('/forms/academic/accounts/glheader_crv.aspx?subnav=myDropdown17&link=LinkButton17&xid=180010001&xvoucher=' + xvoucher1, 'crv1', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, copyhistory=no, width=' + screen.width + ', height=' + screen.height + ', top=0, left=0, targets=_blank');
                        openwin.focus();
                    } else if (xprefix1 == "BPV-") {
                        openwin = window.open('/forms/academic/accounts/glheader_bpv.aspx?subnav=myDropdown17&link=LinkButton17&xid=180015005&xvoucher=' + xvoucher1, 'bpv1', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, copyhistory=no, width=' + screen.width + ', height=' + screen.height + ', top=0, left=0, targets=_blank');
                        openwin.focus();
                    }else if (xprefix1 == "BRV-") {
                        openwin = window.open('/forms/academic/accounts/glheader_brv.aspx?subnav=myDropdown17&link=LinkButton17&xid=180010005&xvoucher=' + xvoucher1, 'brv1', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, copyhistory=no, width=' + screen.width + ', height=' + screen.height + ', top=0, left=0, targets=_blank');
                        openwin.focus();
                    }else if (xprefix1 == "JV--") {
                        openwin = window.open('/forms/academic/accounts/glheader_jv.aspx?subnav=myDropdown17&link=LinkButton17&xid=180020001&xvoucher=' + xvoucher1, 'bpv1', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, copyhistory=no, width=' + screen.width + ', height=' + screen.height + ', top=0, left=0, targets=_blank');
                        openwin.focus();
                    }else {
                        openwin = window.open('/forms/academic/accounts/glheader_cont.aspx?subnav=myDropdown17&link=LinkButton17&xid=180020005&xvoucher=' + xvoucher1, 'voucher', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, copyhistory=no, width=' + screen.width + ', height=' + screen.height + ', top=0, left=0, targets=_blank');
                        openwin.focus();
                    }

                    //   if (xprefix1 == "CPV-") {
                    //       openwin = window.open('/forms/academic/reports/accounts/glvoucherpv.aspx?zid=' + zid + '&xvoucher=' + xvoucher1, 'cpv1', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, copyhistory=no, width=' + screen.width + ', height=' + screen.height + ', top=0, left=0, targets=_blank');
                    //       openwin.focus();
                    //   }else if (xprefix1 == "CRV-") {
                    //      openwin = window.open('/forms/academic/reports/accounts/glvoucherrcv1.aspx?zid=' + zid + '&xvoucher=' + xvoucher1, 'crv1', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, copyhistory=no, width=' + screen.width + ', height=' + screen.height + ', top=0, left=0, targets=_blank');
                    //       openwin.focus();
                    //   } else if (xprefix1 == "BPV-") {
                    //       openwin = window.open('/forms/academic/reports/accounts/glvoucherpv.aspx?zid=' + zid + '&xvoucher=' + xvoucher1, 'bpv1', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, copyhistory=no, width=' + screen.width + ', height=' + screen.height + ', top=0, left=0, targets=_blank');
                    //       openwin.focus();
                    //   }else if (xprefix1 == "BRV-") {
                    //       openwin = window.open('/forms/academic/reports/accounts/glvoucherrcv1.aspx?zid=' + zid + '&xvoucher=' + xvoucher1, 'brv1', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, copyhistory=no, width=' + screen.width + ', height=' + screen.height + ', top=0, left=0, targets=_blank');
                    //       openwin.focus();
                    //   }else {
                    //       openwin = window.open('/forms/academic/reports/accounts/glvoucherjv.aspx?zid=' + zid + '&xvoucher=' + xvoucher1, 'voucher', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, copyhistory=no, width=' + screen.width + ', height=' + screen.height + ', top=0, left=0, targets=_blank');
                    //       openwin.focus();
                    //}
                    //var openwin = window.open('/forms/academic/reports/hrteacherinfoindivirpt.aspx?zid=' + zid + '&xemp=' + xemp , 'hrteacherinfoindivi', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, copyhistory=no, width=' + screen.width + ', height=' + screen.height + ', top=0, left=0, targets=_blank');
                       //openwin.focus();
                       ////openwin.print();
                       ////e.preventDefault();
                       return false;
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Check and Post Voucher</span>
                    </div>
                </div>
                ...
                <div class="bm_academic_container_body1">
                    ...
                    <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                        <ContentTemplate>
                            <table style="padding-bottom: 3px; padding-top: 3px;"><tr>
                                <td style="background-color: silver; color: black;">
                                <%--<div style="display: inline-block; vertical-align: top;">--%>
                                    <asp:RadioButtonList ID="RadioButtonList1" runat="server" RepeatDirection="Horizontal" OnSelectedIndexChanged="RadioButtonList1_OnSelectedIndexChanged" AutoPostBack="True">
                                        <asp:ListItem Text="Show All" Value="Show All" Selected="True"></asp:ListItem>
                                        <asp:ListItem Text="Filter" Value="Filter"></asp:ListItem>
                                    </asp:RadioButtonList>
                                <%--</div>--%></td>

                                <%--<div runat="server" id="listfilter" style="display: inline-block;vertical-align: top;">--%>
                                    <td style="background-color: lightblue; color: black;">
                                    <table style="border: 1px solid silver;" runat="server" id="listfilter">
                                        <tr>
                                            <td>From Type:</td>
                                            <td><asp:DropDownList ID="xftype" runat="server"></asp:DropDownList></td>
                                            <td style="padding-left: 10px;">To Type:</td>
                                            <td><asp:DropDownList ID="xttype" runat="server"></asp:DropDownList></td>
                                                <td style="padding-left: 10px;">From Date:</td>
                                            <td><asp:TextBox ID="xfdatefilter" runat="server" CssClass="bm_academic_datepicker"></asp:TextBox></td>
                                            <td style="padding-left: 10px;">To Date:</td>
                                            <td><asp:TextBox ID="xtdatefilter" runat="server" CssClass="bm_academic_datepicker"></asp:TextBox></td>
                                        </tr>
                                    </table>
                                </td><%--</div>--%>
                                
                                <td><asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/images/reload70.png"
                                        Width="25px" Height="25px" OnClick="fnFillGrid6" CssClass="bm_academic_button_zoom" /></td>
                                    ...
                                    <div class="bm_academic_grid_container" id="list" runat="server">
                                        <div class="grid_header">
                                            <div class="grid_header_label" id="_grid_header" runat="server">
                                                Pending List for Check & Post Voucher(s)
                                            </div>
                                            <div class="grid_header_control">
                                            </div>
                                            <div class="flot_right" style="display: none;">
                                        ...
                                        <div class="grid_body">
                                            ...
                                            <div style="padding: 2px;  width: 100%; background-color: #a9a9a9; color: black;">
                                                <table>
                                                    <tr>
                                                        <td><span id="grdtitle" runat="server"></span></td>
                                                    </tr>
                                                </table>
                                            </div>
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Voucher No.">
                                                        ...
                                                        <%--    <asp:LinkButton ID="xvoucher" runat="server" Text='<%#Eval("xvoucher") %>' CssClass="_gridrow_link"
                                                                ></asp:LinkButton>--%>
                                                   <asp:HyperLink ID="xvoucher" runat="server"  CssClass="_gridrow_link" ForeColor="blue" OnClick="fnPrintInfo(this);"  Text='<%#Eval("xvoucher") %>'>
                                                    ...
                                                    <asp:BoundField DataField="xdesctrn" HeaderText="Type" ItemStyle-Width="200px"
                                                        ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="pad5" />
                                                    ...
                                                    <asp:TemplateField>
                                                        <HeaderTemplate>
                                                            <%--<input id="btnConfDropout" type="button" value="Confirm" class="bm_academic_button5 bm_am_btn_edit btnconf"/>--%>
                                                            <asp:Button ID="btnOk1" runat="server" Text="Post Selected" CssClass="bm_academic_button3 bm_am_btn_ok1 btnok1"  Width="100px" OnClientClick="javascript:ConfirmMessage1();" OnClick="btnOk1_OnClick" />
                                                        </HeaderTemplate>
                                                        <ItemStyle Width="120px" HorizontalAlign="Center" />
                                                        <ItemTemplate>
                                                            <%--<input id="btnConfDropout" type="button" value="Confirm" class="bm_academic_button5 bm_am_btn_edit btnconf"/>--%>
                                                            <asp:Button ID="btnOk2" runat="server" Text="Post This" CssClass="bm_academic_button5 bm_am_btn_ok2 btnok2" OnClientClick="javascript:ConfirmMessage();" OnClick="btnOk_OnClick" Width="100px" />
                                                        </ItemTemplate>
                                        ...
                                        <div class="grid_body">
                                            <asp:GridView ID="dgvPromotedistSubmitted" runat="server" AutoGenerateColumns="False" ShowFooter="False"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="xsession" HeaderText="Session" ItemStyle-Width="100px"
                                                        ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="pad5" />
                                                    ...
                                                    <asp:BoundField DataField="xclass" HeaderText="Class" ItemStyle-Width="100px"
                                                        ItemStyle-HorizontalAlign="left" ItemStyle-CssClass="pad5" />
                                                    <asp:BoundField DataField="xgroup" HeaderText="Group" ItemStyle-Width="100px"
                                                        ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="pad5" />
                                                    <asp:BoundField DataField="xsection" HeaderText="Section" ItemStyle-Width="100px"
                                                        ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="pad5" />
                                                    <asp:BoundField DataField="xdateacc" HeaderText="Dropout Date" DataFormatString="{0:dd/MM/yyyy}"
                                                        ItemStyle-Width="100px" ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="pad5" />
                                                    <%--<asp:BoundField DataField="xtype" HeaderText="Type" ItemStyle-Width="150px"
                                                        ItemStyle-HorizontalAlign="Left" ItemStyle-CssClass="pad5" />--%>
                                                    <asp:BoundField DataField="xreason" HeaderText="Reason" ItemStyle-Width="250px"
                                                        ItemStyle-HorizontalAlign="Left" ItemStyle-CssClass="pad5" />
                ...
                <asp:Panel ID="pnlpopup" runat="server" BackColor="White" Height="360px" Width="400px"
                    Style="display: none">
                    <table width="100%" style="border: Solid 3px #619CFD; width: 100%; height: 100%; border-collapse: collapse;"
                        ...
                        <tr style="background-color: #619CFD">
                            <td style="height: 15px; color: white; font-size: 14px;" align="left">Comfirm Dropout
                            </td>
                        </tr>
                        <tr>
