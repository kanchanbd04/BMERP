<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="imitemset.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.imitemset" %>
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Item Set</span>
                    </div>
                </div>
                        ...
                        <div class="bm_layout_container">
                            <div class="bm_layout_box_100">
                                ...
                                <div class="bm_layout_box_padding" style="padding-top: 0px;">
                                    ...
                                    <div style="display: inline-block; width: 450px; font-size: 14px; vertical-align: top; color: #0000ff;">
                                        <table>
                                            ...
                                            <tr>
                                                ...
                                                <td>:</td>
                                                <td>
                                                    <asp:DropDownList ID="xclass" runat="server" AutoPostBack="True" OnTextChanged="xclass_OnTextChanged"></asp:DropDownList>
                                                </td>
                                            </tr>

                                            <tr>
                                                <td style="text-align: right">Set Name</td>
                                                <td>:</td>
                                                <td>
                                                    <asp:TextBox ID="xsetname" runat="server" Text=""></asp:TextBox>
                                                </td>
                                            </tr>
                                     ...
                                     <div style="width: 450px; display: inline-block; height: 400px; vertical-align: top; ">
                                        
                                        <div class="bm_academic_grid_container" style="height: 100%; padding: 2px;">
                                        <div class="grid_header" style="height: 35px;">
                                            <div class="grid_header_label" >
                                              Item set for &nbsp; <asp:Label ID="xclass_tl" runat="server" ></asp:Label>
                                            </div>
                                            ...
                                            <Columns>
                                               <asp:BoundField DataField="xclass" HeaderText="Class" 
                                                    ...
                                                    <asp:TemplateField HeaderText="Set Name">
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="xsetname" runat="server" Text='<%#Eval("xsetname") %>' CssClass="_gridrow_link"
