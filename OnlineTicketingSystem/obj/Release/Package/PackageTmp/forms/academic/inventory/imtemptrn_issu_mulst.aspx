<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="imtemptrn_issu_mulst.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.imtemptrn_issu_mulst" %>
                ...
                $("body").on("blur", "[id*=xitem]", function() {
                  ...
                  <%--  var xclass1 = $("#<%=xclass.ClientID%>").val();
                   ...
                   <%-- var xeffdate1 = $("#<%=xcdate.ClientID%>").val();
                    ...
                    $.ajax({
                        type: "POST",
                        url: "/edusoft.asmx/ItemInfo",
                        data: "{ zid: '" + zid1 + "', xitem:'" + xitem1 + "', xwh:'"+xwh1+"' }",
                        dataType: "json",
                        contentType: "application/json; charset=utf-8",
                        success: function (data) {
                            //alert(data.d);
                     ...
                     <%--    //$("#<%=xname.ClientID%>").val(student.xname);
                            ...
                            row.cells[3].getElementsByTagName("input")[0].value = stdinfo.xstock;
                            row.cells[5].getElementsByTagName("input")[0].value = stdinfo.xunitiss;
                            row.cells[9].getElementsByTagName("input")[0].value = stdinfo.xcfiss;
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">General Issue Multiple Students'</span>
                    </div>
                </div>
                                    ...
                                    <div style="width: 100%; clear: both;">
                                      ...
                                      <%--  <div class="bm_clt_padding">
                                        ...
                                        <div style="display: none;">
                                            <div class="bm_ctl_container_50_100" style="width: 270px; float: left">
                                                <div class="bm_ctl_label_align_right_50_100" style="width: 120px">
                                                    <asp:Label ID="Label6" runat="server" Text="Teacher/Employee:" AssociatedControlID="xemp"
                                                        CssClass="label"></asp:Label>
                                                </div>
                                                <div class="bm_clt_ctl_50_100" style="width: 148px">
                                                    ...
                                                    <div class="bm_list_text" style="width: 120px">
                                                        <asp:TextBox ID="xemp" runat="server" CssClass="bm_academic_textbox_50_100 bm_academic_ctl_global bm_academic_textbox "
                                                            AutoPostBack="True" OnTextChanged="xtfccode_OnTextChanged"></asp:TextBox>
                                                    </div>
                                                    <div class="bm_list_img">
                                                        <asp:Image ID="Image2" runat="server" ImageUrl="~/images/list-am32x32.png" CssClass="bm_academic_list bm_xemp" />
                                                    </div>
                                                </div>
                                            </div>
                                       ...
                                       <div class="bm_clt_padding">
                                        ...
                                        <div class="bm_ctl_container_100_special" style="width: 270px;">
                                            <div class="bm_ctl_label_align_right_100_special" style="width: 120px">
                                                <asp:Label ID="Label7" runat="server" Text="Class :" AssociatedControlID="xglevel2"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_100_special" style="width: 148px">
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Stock In Hand">
                                                            ...
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:TextBox ID="xstock" runat="server" CssClass="bm_academic_textbox_50_100 bm_academic_ctl_global bm_academic_textbox" BackColor="Transparent" ForeColor="Black" Enabled="False"></asp:TextBox>
