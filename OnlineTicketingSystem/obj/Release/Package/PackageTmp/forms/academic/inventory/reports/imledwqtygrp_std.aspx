<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="imledwqtygrp_std.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.imledwqtygrp_std" %>
...
.GridViewScrollFooterFreeze TD {
    ...
    <script type="text/javascript">
       ...
       function fnShowReport() {
            ...
            var fitem1 = $("#<%= fitem.ClientID%>").val();
            var titem1 = $("#<%= titem.ClientID%>").val();
           ...
           //var xfdate1 = new Date(+dateParts[2], dateParts[1] - 1, +dateParts[0]);
            ...
            var openwin = window.open('/forms/academic/reports/inventory/imledwqtygrp_stdrpt.aspx?zid=' + zid + '&fdate=' + fdate1 + '&tdate=' + tdate1 + '&fware=' + fware1 + '&fgitem=' + fgitem1 + '&tgitem=' + tgitem1 + '&fitem=' + fitem1 + '&titem=' + titem1 + '&xstdid=' + xstdid1 , 'itemlgdstd', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, copyhistory=no, width=' + screen.width + ', height=' + screen.height + ', top=0, left=0, targets=_blank');
            openwin.focus();
            //openwin.print();
            return false;
        }
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
           ...
           $("body").on("click", ".bm_item", function () {
               ...
               fnOpenItemList2(<%= HttpContext.Current.Session["business"] %>, $(this).parent(".bm_list_img").siblings(".bm_list_text").find(".bm_academic_textbox").attr("ID"), $(this).parent(".bm_list_img").siblings(".bm_list_text").find(".bm_academic_textbox").val(), $(this).parent(".bm_list_img").parent(".bm_clt_ctl_50_100").parent(".bm_ctl_container_50_100").siblings().find(".fitemname").attr("ID"));
                    $("#<%=fitem.ClientID%>").focus();

                    return false;
           });

                $("body").on("click", ".bm_item2", function () {
                    //alert("Hi");
                   
                    fnOpenItemList2(<%= HttpContext.Current.Session["business"] %>, $(this).parent(".bm_list_img").siblings(".bm_list_text").find(".bm_academic_textbox").attr("ID"), $(this).parent(".bm_list_img").siblings(".bm_list_text").find(".bm_academic_textbox").val(), $(this).parent(".bm_list_img").parent(".bm_clt_ctl_50_100").parent(".bm_ctl_container_50_100").siblings().find(".titemname").attr("ID"));
                      $("#<%=titem.ClientID%>").focus();
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Item Ledger Student</span>
                    </div>
                </div>
                                    ...
                                    <div style="width: 100%; clear: both;">
                                     ...
                                     <%--   <div>
                                       ...
                                       <%-- <div class="bm_clt_padding">
                                        ...
                                        <div class="bm_ctl_container_50_50" style="float: left; width: 270px">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label2" runat="server" Text="Warehouse :" AssociatedControlID="fware"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 148px">
                                        ...
                                        <div>
                                            <div class="bm_ctl_container_50_100" style="width: 270px; float: left">
                                                <div class="bm_ctl_label_align_right_50_100" style="width: 120px">
                                                    <asp:Label ID="Label44444" runat="server" Text=" From Item :" AssociatedControlID="fitem"
                                                        CssClass="label"></asp:Label>
                                                </div>
                                                <div class="bm_clt_ctl_50_100" style="width: 148px">
                                                    
                                                    <div class="bm_list_text" style="width: 120px">
                                                        <asp:TextBox ID="fitem" runat="server" CssClass="bm_academic_textbox_50_100 bm_academic_ctl_global bm_academic_textbox "></asp:TextBox>
                                                    </div>
                                                    <div class="bm_list_img">
                                            ...
                                            <div style="float: left; padding-left: 5px; padding-top: 1px">
                                                <asp:Label ID="fitemname" runat="server" Text="" CssClass="fitemname"></asp:Label>
                                            </div>
                                        ...
                                        <div>
                                            <div class="bm_ctl_container_50_100" style="width: 270px; float: left">
                                                <div class="bm_ctl_label_align_right_50_100" style="width: 120px">
                                                    <asp:Label ID="Label5" runat="server" Text=" To Item :" AssociatedControlID="titem"
                                                        CssClass="label"></asp:Label>
                                                </div>
                                                <div class="bm_clt_ctl_50_100" style="width: 148px">
                                                    
                                                    <div class="bm_list_text" style="width: 120px">
                                                        <asp:TextBox ID="titem" runat="server" CssClass="bm_academic_textbox_50_100 bm_academic_ctl_global bm_academic_textbox "></asp:TextBox>
                                                    </div>
                                                    <div class="bm_list_img">
                                                        <asp:Image ID="Image2" runat="server" ImageUrl="~/images/list-am32x32.png" CssClass="bm_academic_list bm_item2" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div style="float: left; padding-left: 5px; padding-top: 1px">
                                                <asp:Label ID="titemname" runat="server" Text="" CssClass="titemname"></asp:Label>
                                            </div>
                                        ...
                                        <div>
                                            <div class="bm_ctl_container_50_100" style="width: 270px; float: left">
                                                <div class="bm_ctl_label_align_right_50_100" style="width: 120px">
                                                    <asp:Label ID="Label6" runat="server" Text="Student :" AssociatedControlID="xstdid"
                                                        CssClass="label"></asp:Label>
                                                </div>
                                                <div class="bm_clt_ctl_50_100" style="width: 148px">
                                                    ...
                                                    <div class="bm_list_img">
                                                        <asp:Image ID="Image3" runat="server" ImageUrl="~/images/list-am32x32.png" CssClass="bm_academic_list bm_xstdid" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div style="float: left; padding-left: 5px; padding-top: 1px">
