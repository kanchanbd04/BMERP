<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="studentlist3.aspx.cs" Inherits="OnlineTicketingSystem.forms.BMERP.studentlist3"
                            ...
                            <asp:GridView ID="_grid_emp" runat="server" AutoGenerateColumns="False" ShowFooter="true"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="Ref.">
                                        ...
                                        <ItemTemplate>
                                            <asp:LinkButton ID="xcode" runat="server" Text='<%#Eval("xrow") %>' OnClientClick='<%# String.Format("update(\"{0}\",\"{1}\");", Eval("xstdid"),Eval("xname")) %>' CssClass="_gridrow_link"></asp:LinkButton>
                                        </ItemTemplate>
                                        <FooterTemplate>
