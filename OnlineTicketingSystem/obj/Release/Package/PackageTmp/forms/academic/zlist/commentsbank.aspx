<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="commentsbank.aspx.cs" Inherits="OnlineTicketingSystem.forms.BMERP.commentsbank"
                            ...
                            <div style="padding: 10px;" >
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td>:</td>
                                        <td>
                                            <asp:DropDownList ID="xcat1" runat="server" AutoPostBack="True" OnSelectedIndexChanged="xcat1_OnSelectedIndexChanged"></asp:DropDownList>
                                        </td>
                                        <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                        <td>Category 2</td>
                                        <td>:</td>
                                        <td>
                                            <asp:DropDownList ID="xcat2" runat="server" AutoPostBack="True" OnSelectedIndexChanged="xcat1_OnSelectedIndexChanged"></asp:DropDownList>
                                        </td>
                                ...
                                PagerStyle-CssClass="PagerStyle" GridLines="None">
                                 <Columns>
                                    <asp:TemplateField HeaderText="">
                                        ...
                                        <ItemTemplate>
                                            <asp:LinkButton ID="xselect" runat="server" Text='Select' OnClientClick='<%# String.Format("update(\"{0}\");", Eval("xcomments")) %>' CssClass="_gridrow_link"></asp:LinkButton>
                                        </ItemTemplate>
                                      <%--  <FooterTemplate>
                                            <asp:Label ID="footerlabel" Text="Total" CssClass="footer_label_total" runat="server" />
                                        </FooterTemplate>--%>
                                    </asp:TemplateField>
                                    <asp:BoundField DataField="xcomments" HeaderText="Comments" ItemStyle-Width="450px" ItemStyle-CssClass="_grid_text_padding" />

                                  <%--   <asp:BoundField DataField="xacc" HeaderText="Account" ItemStyle-Width="100px" ItemStyle-CssClass="_grid_text_padding" />
