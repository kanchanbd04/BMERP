<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="booklist1.aspx.cs" Inherits="OnlineTicketingSystem.forms.BMERP.booklist1"
                                ...
                                PagerStyle-CssClass="PagerStyle" GridLines="None">
                                 <Columns>
                                    <asp:TemplateField HeaderText="Book Code">
                                        ...
                                        <ItemTemplate>
                                            <asp:LinkButton ID="xlbord" runat="server" Text='<%#Eval("xlbord") %>' OnClientClick='<%# String.Format("update(\"{0}\",\"{1}\",\"{2}\");", Eval("xlbord"),Eval("xlbtitle"),Eval("xlbstatus")) %>' CssClass="_gridrow_link"></asp:LinkButton>
                                        </ItemTemplate>
                                      <%--  <FooterTemplate>
                                    ...
                                    <asp:BoundField DataField="xlbtitle" HeaderText="Title" ItemStyle-Width="250px" ItemStyle-CssClass="_grid_text_padding" />
                                     <asp:BoundField DataField="xlbstatus" HeaderText="Status" ItemStyle-Width="100px" ItemStyle-CssClass="_grid_text_padding" />
