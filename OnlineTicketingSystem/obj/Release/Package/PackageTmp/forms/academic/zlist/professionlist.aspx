<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="professionlist.aspx.cs" Inherits="OnlineTicketingSystem.forms.BMERP.professionlist"
                ...
                <div class="bm_academic_grid_container" id="list" runat="server">
                    ...
                    <div class="grid_body">
                        <asp:GridView ID="_grid_emp" runat="server" AutoGenerateColumns="False" ShowFooter="true"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="Profession's">
