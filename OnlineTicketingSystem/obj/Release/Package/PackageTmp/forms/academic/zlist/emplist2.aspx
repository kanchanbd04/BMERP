<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="emplist2.aspx.cs" Inherits="OnlineTicketingSystem.forms.BMERP.emplist2"
                        ...
                        <asp:GridView ID="_grid_emp" runat="server" AutoGenerateColumns="False" ShowFooter="true"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="Employee ID">
                                    ...
                                    <ItemTemplate>
                                        <asp:LinkButton ID="xcode" runat="server" Text='<%#Eval("xemp") %>' OnClientClick='<%# String.Format("update(\"{0}\",\"{1}\");", Eval("xemp"),Eval("xemp")) %>' CssClass="_gridrow_link"></asp:LinkButton>
                                    </ItemTemplate>
                                    <FooterTemplate>
