<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="issuelist.aspx.cs" Inherits="OnlineTicketingSystem.forms.BMERP.issuelist"
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function update(updstr,updstr1) {
            ...
            //alert(ctlid);
            window.opener.update5(updstr, ctlid, updstr1, ctlid1);
            self.close();
        }
    </script>
</head>
                            ...
                            <asp:GridView ID="_grid_emp" runat="server" AutoGenerateColumns="False" ShowFooter="true"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="Ref.">
                                        ...
                                        <ItemTemplate>
                                            <asp:LinkButton ID="xcode" runat="server" Text='<%#Eval("ximtmptrn") %>' OnClientClick='<%# String.Format("update(\"{0}\",\"{1}\");", Eval("ximtmptrn"),Eval("ximtmptrn")) %>' CssClass="_gridrow_link"></asp:LinkButton>
                                        </ItemTemplate>
                                        <FooterTemplate>
                                            <asp:Label ID="footerlabel" Text="Total" CssClass="footer_label_total" runat="server" />
                                        </FooterTemplate>
                                    </asp:TemplateField>
                                    <asp:BoundField DataField="xstdid" HeaderText="ID" ItemStyle-Width="80px" ItemStyle-CssClass="_grid_text_padding" ItemStyle-HorizontalAlign="Center"/>
                                    <asp:BoundField DataField="xname" HeaderText="Name" ItemStyle-Width="250px" ItemStyle-CssClass="_grid_text_padding" />
                                    <asp:BoundField DataField="xclass" HeaderText="Class" ItemStyle-Width="80px" ItemStyle-CssClass="_grid_text_padding" ItemStyle-HorizontalAlign="Center"/>
                                    <asp:BoundField DataField="xfwh" HeaderText="Warehouse" ItemStyle-Width="200px" ItemStyle-CssClass="_grid_text_padding" ItemStyle-HorizontalAlign="Center"/>
