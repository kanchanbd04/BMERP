<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="booklist4.aspx.cs" Inherits="OnlineTicketingSystem.forms.BMERP.booklist4"
    ...
    <script type="text/javascript">
        ...
        function update(str) {
         ...
         var ctlid = $("#<%= ctlid_v.ClientID%>").val();
            ...
            window.opener.update12(res[0], res[1], res[2], res[3], res[4], res[5], ctlid, ctlid1, ctlid2, ctlid3, ctlid4, ctlid5);
            self.close();
        }
    </script>
</head>
                            ...
                            <asp:GridView ID="_grid_emp" runat="server" AutoGenerateColumns="False" ShowFooter="true"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="Book Code">
                                        ...
                                        <ItemTemplate>
                                            <asp:LinkButton ID="xlbord" runat="server" Text='<%#Eval("xlbord") %>' OnClientClick='<%# String.Format("update(\"{0}\");", Eval("xlbord")+"|"+Eval("xlbtitle")+"|"+Eval("xlbmemcode")+"|"+Eval("mem_name")+"|"+Eval("xlbtrncode")+"|"+Eval("xlbmemtype")) %>' CssClass="_gridrow_link"></asp:LinkButton>
                                        </ItemTemplate>
                                        <FooterTemplate>
