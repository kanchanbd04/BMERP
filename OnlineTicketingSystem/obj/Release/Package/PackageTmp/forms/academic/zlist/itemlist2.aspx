<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="itemlist2.aspx.cs" Inherits="OnlineTicketingSystem.forms.BMERP.itemlist2"
                            ...
                            <asp:GridView ID="_grid_emp" runat="server" AutoGenerateColumns="False" ShowFooter="true"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="Item Code">
                                        ...
                                        <ItemTemplate>
                                            <asp:LinkButton ID="xitem" runat="server" Text='<%#Eval("xitem") %>' OnClientClick='<%# String.Format("update(\"{0}\",\"{1}\");", Eval("xitem"),Eval("xdesc")) %>' CssClass="_gridrow_link"></asp:LinkButton>
                                        </ItemTemplate>
                                        <FooterTemplate>
                                            <asp:Label ID="footerlabel" Text="Total" CssClass="footer_label_total" runat="server" />
                                        </FooterTemplate>
                                    </asp:TemplateField>
                                    <asp:BoundField DataField="xdesc" HeaderText="Description" ItemStyle-Width="250px" ItemStyle-CssClass="_grid_text_padding" ItemStyle-HorizontalAlign="Left"/>
