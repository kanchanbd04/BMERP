<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tfccodelist3.aspx.cs" Inherits="OnlineTicketingSystem.forms.BMERP.tfccodelist3"
                            ...
                            <asp:GridView ID="_grid_emp" runat="server" AutoGenerateColumns="False" ShowFooter="true"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="Code">
                                        ...
                                        <ItemTemplate>
                                            <asp:LinkButton ID="xcode" runat="server" Text='<%#Eval("xcode") %>' OnClientClick='<%# String.Format("update(\"{0}\",\"{1}\");", Eval("xcode"),Eval("xdescdet")) %>' CssClass="_gridrow_link"></asp:LinkButton>
                                        </ItemTemplate>
                                        <FooterTemplate>
