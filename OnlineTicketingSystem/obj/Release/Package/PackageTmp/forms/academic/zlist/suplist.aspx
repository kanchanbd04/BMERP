<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="suplist.aspx.cs" Inherits="OnlineTicketingSystem.forms.BMERP.suplist"
                    ...
                    <div class="bm_academic_grid_container" id="list" runat="server">
                        ...
                        <div class="grid_body">
                            <asp:GridView ID="_grid_emp" runat="server" AutoGenerateColumns="False" ShowFooter="true"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="Supplier No">
                                        <ItemStyle Width="100px" HorizontalAlign="Center" />
                                        <ItemTemplate>
                                            <asp:LinkButton ID="xsup" runat="server" Text='<%#Eval("xsup") %>' OnClientClick='<%# String.Format("update(\"{0}\",\"{1}\");", Eval("xsup"),Eval("xorg")) %>' CssClass="_gridrow_link"></asp:LinkButton>
                                        </ItemTemplate>
                                        <FooterTemplate>
                                            <asp:Label ID="footerlabel" Text="Total" CssClass="footer_label_total" runat="server" />
                                        </FooterTemplate>
                                    </asp:TemplateField>
                                    <asp:BoundField DataField="xorg" HeaderText="Name" ItemStyle-Width="250px" ItemStyle-CssClass="_grid_text_padding" />
