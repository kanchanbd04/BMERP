<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="studentlist6.aspx.cs" Inherits="OnlineTicketingSystem.forms.BMERP.studentlist6"
                            ...
                            <asp:GridView ID="_grid_emp" runat="server" AutoGenerateColumns="False" ShowFooter="true"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="Ref.">
                                        ...
                                        <ItemTemplate>
                                            <asp:LinkButton ID="xcode" runat="server" Text='<%#Eval("xrow") %>' OnClientClick='<%# String.Format("update(\"{0}\",\"{1}\");", Eval("xstdid"),Eval("xname1")) %>' CssClass="_gridrow_link"></asp:LinkButton>
                                        </ItemTemplate>
                                        <FooterTemplate>
                                    ...
                                    <asp:BoundField DataField="xsection" HeaderText="Section" ItemStyle-Width="80px" ItemStyle-CssClass="_grid_text_padding" ItemStyle-HorizontalAlign="Center"/>
