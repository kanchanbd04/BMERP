<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="authorlist.aspx.cs" Inherits="OnlineTicketingSystem.forms.BMERP.authorlist"
                            ...
                            <asp:GridView ID="_grid_emp" runat="server" AutoGenerateColumns="False" ShowFooter="true"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="Ref.">
                                        ...
                                        <ItemTemplate>
                                            <asp:LinkButton ID="xlbauthr" runat="server" Text='<%#Eval("xlbauthr") %>' OnClientClick='<%# String.Format("update(\"{0}\",\"{1}\");", Eval("xlbauthr"),Eval("xname")) %>' CssClass="_gridrow_link"></asp:LinkButton>
                                        </ItemTemplate>
                                        <FooterTemplate>
