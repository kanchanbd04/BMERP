<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tfccodelist1.aspx.cs" Inherits="OnlineTicketingSystem.forms.BMERP.tfccodelist1"
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function update(updstr) {
            ...
            window.opener.update8(updstr, ctlid);
            self.close();
        }
    </script>
</head>
                            ...
                            <asp:GridView ID="_grid_emp" runat="server" AutoGenerateColumns="False" ShowFooter="true"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="Code">
                                        ...
                                        <ItemTemplate>
                                            <asp:LinkButton ID="xcode" runat="server" Text='<%#Eval("xcode") %>' OnClientClick='<%# String.Format("update(\"{0}\");", Eval("xcode")) %>' CssClass="_gridrow_link"></asp:LinkButton>
                                        </ItemTemplate>
                                        <FooterTemplate>
                                            <asp:Label ID="footerlabel" Text="Total" CssClass="footer_label_total" runat="server" />
                                        </FooterTemplate>
                                    </asp:TemplateField>
                                    <asp:BoundField DataField="xdescdet" HeaderText="Description" ItemStyle-Width="150px" ItemStyle-CssClass="_grid_text_padding" />
