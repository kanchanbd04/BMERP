<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="studentlist1.aspx.cs" Inherits="OnlineTicketingSystem.forms.BMERP.studentlist1"
                ...
                <div class="bm_academic_grid_container" id="list" runat="server">
                    ...
                    <div class="grid_body">
                        <asp:GridView ID="_grid_emp" runat="server" AutoGenerateColumns="False" ShowFooter="true"
                            ...
                            <Columns>
                                <asp:BoundField DataField="xrow" Visible="False" HeaderText="Row" ItemStyle-Width="100px" ItemStyle-CssClass="_grid_text_padding" ItemStyle-HorizontalAlign="Center"/>
                                 ...
                                 <asp:BoundField DataField="xclass" HeaderText="Class" ItemStyle-Width="100px" ItemStyle-CssClass="_grid_text_padding" ItemStyle-HorizontalAlign="Center"/>
                                 <asp:BoundField DataField="xgroup" HeaderText="Group" ItemStyle-Width="100px" ItemStyle-CssClass="_grid_text_padding" ItemStyle-HorizontalAlign="Center"/>
                                 <asp:BoundField DataField="xsection" HeaderText="Section" ItemStyle-Width="100px" ItemStyle-CssClass="_grid_text_padding" ItemStyle-HorizontalAlign="Center"/>--%>
                                 <asp:BoundField DataField="xstdid"  HeaderText="ID" ItemStyle-Width="100px" ItemStyle-CssClass="_grid_text_padding" ItemStyle-HorizontalAlign="Center"/>
                                <asp:TemplateField HeaderText="Student Name">
                                    <ItemStyle Width="200px" HorizontalAlign="Left" />
                                    <ItemTemplate>
                                        <asp:LinkButton ID="xname" runat="server" Text='<%#Eval("xname") %>' OnClientClick='<%# String.Format("update(\"{0}\",\"{1}\");", Eval("xname"),Eval("xrow")) %>' CssClass="_gridrow_link"></asp:LinkButton>
                                    </ItemTemplate>
                                    <FooterTemplate>
