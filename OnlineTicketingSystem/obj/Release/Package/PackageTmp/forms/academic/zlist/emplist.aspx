<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="emplist.aspx.cs" Inherits="OnlineTicketingSystem.forms.BMERP.emplist"
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function update(updstr, updstr2) {
            ...
            //alert(ctlid);
            window.opener.update4(updstr, updstr2, ctlid, ctlid2);
            self.close();
        }
    </script>
</head>
                        ...
                        <asp:GridView ID="_grid_emp" runat="server" AutoGenerateColumns="False" ShowFooter="true"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="Employee ID">
                                    ...
                                    <ItemTemplate>
                                        <asp:LinkButton ID="xcode" runat="server" Text='<%#Eval("xemp") %>' OnClientClick='<%# String.Format("update(\"{0}\",\"{1}\");", Eval("xname"),Eval("xemp")) %>' CssClass="_gridrow_link"></asp:LinkButton>
                                    </ItemTemplate>
                                    <FooterTemplate>
                                ...
                                <asp:BoundField DataField="xfather" HeaderText="Father's Name" ItemStyle-Width="100px" ItemStyle-CssClass="_grid_text_padding"/>
