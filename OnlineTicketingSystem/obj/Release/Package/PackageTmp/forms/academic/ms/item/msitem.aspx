<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="msitem.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.msitem" %>
            ...
            <%--    $("body").on("change", "#<%=xclass.ClientID%>", function() {
               ...
               <%--     if ($("#<%=hxstatus.ClientID%>").val() == "")--%>
                ...
                $("body").on("click", ".bm_item", function () {
                    //alert("Hi");
                    fnOpenItemList(<%= HttpContext.Current.Session["business"] %>, $(this).parent(".bm_list_img").siblings(".bm_list_text").find(".bm_academic_textbox").attr("ID"), $(this).parent(".bm_list_img").siblings(".bm_list_text").find(".bm_academic_textbox").val());
                    
                    $("#<%=xitem.ClientID%>").focus();
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Item Master</span>
                    </div>
                </div>
                            ...
                            <div class="bm_layout_box_100">
                                ...
                                <div class="bm_layout_box_padding" style="padding-top: 0px;">
                                    ...
                                    <div style="width: 40%; clear: both; display: inline-block; padding-top: 5px; vertical-align: top;">
                                        <div style="width: 100%">
                                            <div style="float: left;">
                                                <div class="bm_ctl_container_50_50" style="width: 350px">
                                                    <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                        <asp:Label ID="Label11" runat="server" Text="Item Code :" AssociatedControlID="xitem"
                                                            CssClass="label mendatory"></asp:Label>
                                                    </div>
                                                    <div class="bm_clt_ctl_50_50" style="width: 228px">
                                                        <div class="bm_list_text" style="width: 200px; float: left;">
                                                            <asp:TextBox ID="xitem" runat="server" CssClass="bm_academic_textbox_50_40 bm_academic_ctl_global bm_academic_textbox"
                                                                ></asp:TextBox>
                                                        </div>
                                                        <div class="bm_list_img" style="float: left;">
                                                            <asp:Image ID="Image4" runat="server" ImageUrl="~/images/list-am32x32.png" CssClass="bm_academic_list bm_item" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="bm_ctl_container_50_50" style="width: 350px">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label9" runat="server" Text="Item Group :" AssociatedControlID="xglevel1"
                                                    CssClass="label mendatory"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 228px">

                                                <asp:DropDownList ID="xglevel1" runat="server" CssClass="bm_academic_dropdown_50_50 bm_academic_ctl_global bm_academic_dropdown bm_xclass" AutoPostBack="True" OnTextChanged="fnFillGrid6">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                        <div class="bm_clt_padding">
                                        ...
                                        <div class="bm_ctl_container_50_50" style="width: 350px">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label15" runat="server" Text="Category Code :" AssociatedControlID="xglevel3"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 228px">

                                                <asp:DropDownList ID="xglevel3" runat="server" CssClass="bm_academic_dropdown_50_50 bm_academic_ctl_global bm_academic_dropdown bm_xclass">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                        <div class="bm_clt_padding">
                                        ...
                                        <div class="bm_ctl_container_50_50" style="width: 270px">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label37" runat="server" Text="Currency of Cost :" AssociatedControlID="xcurcost"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 148px">

                                                <asp:DropDownList ID="xcurcost" runat="server" CssClass="bm_academic_dropdown_50_50 bm_academic_ctl_global bm_academic_dropdown bm_xclass">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                        <div class="bm_clt_padding">
                                        ...
                                        <div class="bm_ctl_container_50_50" style="width: 270px">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label38" runat="server" Text="Currency of Price :" AssociatedControlID="xcurprice"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 148px">

                                                <asp:DropDownList ID="xcurprice" runat="server" CssClass="bm_academic_dropdown_50_50 bm_academic_ctl_global bm_academic_dropdown bm_xclass">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                        <div class="bm_clt_padding">
                                        ...
                                        <div class="bm_ctl_container_50_50" style="width: 270px">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label41" runat="server" Text="Stock Type :" AssociatedControlID="xstype"
                                                    CssClass="label mendatory"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 148px">

                                                <asp:DropDownList ID="xstype" runat="server" CssClass="bm_academic_dropdown_50_50 bm_academic_ctl_global bm_academic_dropdown bm_xclass">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                        <div class="bm_clt_padding">
                                        ...
                                        <div class="bm_ctl_container_50_50" style="width: 270px">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label43" runat="server" Text="Selling Unit :" AssociatedControlID="xunitsel"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 148px">

                                                <asp:DropDownList ID="xunitsel" runat="server" CssClass="bm_academic_dropdown_50_50 bm_academic_ctl_global bm_academic_dropdown bm_xclass">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                        <div class="bm_clt_padding">
                                        ...
                                        <div class="bm_ctl_container_50_50" style="width: 270px">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label44" runat="server" Text="Purchase Unit :" AssociatedControlID="xunitpur"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 148px">

                                                <asp:DropDownList ID="xunitpur" runat="server" CssClass="bm_academic_dropdown_50_50 bm_academic_ctl_global bm_academic_dropdown bm_xclass">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                        <div class="bm_clt_padding">
                                        ...
                                        <div class="bm_ctl_container_50_50" style="width: 270px">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label45" runat="server" Text="Issue Unit :" AssociatedControlID="xunitiss"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 148px">
                                                <asp:DropDownList ID="xunitiss" runat="server" CssClass="bm_academic_dropdown_50_50 bm_academic_ctl_global bm_academic_dropdown bm_xclass">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                        <div class="bm_clt_padding">
                                        ...
                                        <div style="width: 100%">
                                            <div class="bm_ctl_container_100_special" style="width: 120px; float: left;">
                                                <div class="bm_ctl_label_align_right_100_special" style="width: 100%">
                                                    <asp:Label ID="Label49" runat="server" Text="Costing Method :"
                                                        CssClass="label"></asp:Label>
                                                </div>
                                            </div>
                                            <div style="float: left; padding-left: 5px">
                                                <asp:RadioButtonList ID="xcostmeth" runat="server" RepeatDirection="Vertical">
                                                    <asp:ListItem Text="Batch" Value="Batch" ></asp:ListItem>
                                                    <asp:ListItem Text="FIFO" Value="FIFO"></asp:ListItem>
                                                    <asp:ListItem Text="Weighted Average" Value="Weighted Average" Selected="True"></asp:ListItem>
                                                </asp:RadioButtonList>
                                            </div>
                                        </div>
                                        <div class="bm_clt_padding">
                                        ...
                                        <div class="bm_ctl_container_50_50" style="width: 270px">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label51" runat="server" Text="Fixed Assets Item :" AssociatedControlID="xitemfaflag"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 148px">

                                                <asp:DropDownList ID="xitemfaflag" runat="server" CssClass="bm_academic_dropdown_50_50 bm_academic_ctl_global bm_academic_dropdown bm_xclass">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div style="width: 40%; clear: both; display: inline-block; padding-top: 5px; vertical-align: top;">
                                        ...
                                        <div class="bm_ctl_container_50_50" style="width: 400px">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label13" runat="server" Text="Item Description :" AssociatedControlID="xdesc"
                                                    CssClass="label mendatory"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 278px">
                                                <asp:TextBox ID="xdesc" runat="server" CssClass="bm_academic_textbox_50_40 bm_academic_ctl_global bm_academic_textbox"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="bm_clt_padding">
                                        </div>
                                        <div class="bm_ctl_container_50_50" style="width: 350px">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label12" runat="server" Text="Item Class :" AssociatedControlID="xglevel2"
                                                    CssClass="label mendatory"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 228px">

                                                <asp:DropDownList ID="xglevel2" runat="server" CssClass="bm_academic_dropdown_50_50 bm_academic_ctl_global bm_academic_dropdown bm_xclass">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                        <div class="bm_clt_padding">
                                        ...
                                        <div class="bm_ctl_container_50_50" style="width: 350px">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label16" runat="server" Text="Item Type :" AssociatedControlID="xglevel4"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 228px">

                                                <asp:DropDownList ID="xglevel4" runat="server" CssClass="bm_academic_dropdown_50_50 bm_academic_ctl_global bm_academic_dropdown bm_xclass">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                        <div class="bm_clt_padding">
                                        ...
                                        <div class="bm_ctl_container_50_50" style="width: 200px">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label39" runat="server" Text="Standard Cost :" AssociatedControlID="xstdcost"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 78px">
                                                <asp:TextBox ID="xstdcost" runat="server" CssClass="bm_academic_textbox_50_40 bm_academic_ctl_global bm_academic_textbox"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="bm_clt_padding">
                                        </div>
                                        <div class="bm_ctl_container_50_50" style="width: 200px">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label40" runat="server" Text="Standard Price :" AssociatedControlID="xstdprice"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 78px">
                                                <asp:TextBox ID="xstdprice" runat="server" CssClass="bm_academic_textbox_50_40 bm_academic_ctl_global bm_academic_textbox"></asp:TextBox>
                                            </div>
                                        </div>
                                        ...
                                        <div class="bm_ctl_container_50_50" style="width: 270px">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label42" runat="server" Text="Stocking Unit :" AssociatedControlID="xunitstk"
                                                    CssClass="label mendatory"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 148px">

                                                <asp:DropDownList ID="xunitstk" runat="server" CssClass="bm_academic_dropdown_50_50 bm_academic_ctl_global bm_academic_dropdown bm_xclass">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                        ...
                                        <div class="bm_ctl_container_50_50" style="width: 200px">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label46" runat="server" Text="C. F. Selling :" AssociatedControlID="xcfsel"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 78px">
                                                <asp:TextBox ID="xcfsel" runat="server" CssClass="bm_academic_textbox_50_40 bm_academic_ctl_global bm_academic_textbox"></asp:TextBox>
                                            </div>
                                        </div>
                                        ...
                                        <div class="bm_ctl_container_50_50" style="width: 200px">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label47" runat="server" Text="C. F. Purchase :" AssociatedControlID="xcfpur"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 78px">
                                                <asp:TextBox ID="xcfpur" runat="server" CssClass="bm_academic_textbox_50_40 bm_academic_ctl_global bm_academic_textbox"></asp:TextBox>
                                            </div>
                                        </div>
                                        ...
                                        <div class="bm_ctl_container_50_50" style="width: 200px">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label48" runat="server" Text="C. F. Issue :" AssociatedControlID="xcfiss"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 78px">
                                                <asp:TextBox ID="xcfiss" runat="server" CssClass="bm_academic_textbox_50_40 bm_academic_ctl_global bm_academic_textbox"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="bm_clt_padding">
                                        </div>
                                        <div style="width: 100%">
                                            <div class="bm_ctl_container_100_special" style="width: 120px; float: left;">
                                                <div class="bm_ctl_label_align_right_100_special" style="width: 100%">
                                                    <asp:Label ID="Label50" runat="server" Text="Item Status :"
                                                        CssClass="label"></asp:Label>
                                                </div>
                                            </div>
                                            <div style="float: left; padding-left: 5px">
                                                <asp:RadioButtonList ID="xstatusitem" runat="server" RepeatDirection="Vertical">
                                        ...
                                        <div class="bm_ctl_container_50_50" style="width: 270px">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label17" runat="server" Text="Item Set :" AssociatedControlID="xitemset"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 148px">

                                                <asp:DropDownList ID="xitemset" runat="server" CssClass="bm_academic_dropdown_50_50 bm_academic_ctl_global bm_academic_dropdown bm_xclass">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <asp:GridView ID="dgvcollectionew" runat="server" AutoGenerateColumns="False" ShowFooter="False"
                                                ...
                                                <Columns>
                                                    <asp:TemplateField HeaderText="Item Code">
                                                        <ItemStyle Width="150px" HorizontalAlign="Center" />
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="xrow" runat="server" Text='<%#Eval("xitem") %>' CssClass="_gridrow_link"
                                                    ...
                                                    <asp:BoundField DataField="xstdid" HeaderText="Student ID" ItemStyle-Width="150px"
                                                        ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="pad5" />--%>
                                                    <asp:BoundField DataField="xdesc" HeaderText="Description" ItemStyle-Width="250px"
                                                        ItemStyle-HorizontalAlign="Left" ItemStyle-CssClass="pad5" />
                                                    <asp:BoundField DataField="xglevel1" HeaderText="Item Group" ItemStyle-Width="120px"
                                                        ItemStyle-HorizontalAlign="Left" ItemStyle-CssClass="pad5" />
