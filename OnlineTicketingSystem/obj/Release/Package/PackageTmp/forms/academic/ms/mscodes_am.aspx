<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="mscodes_am.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.admission.mscodes_am" %>
                        ...
                        <div class="bm_layout_box_padding">
                            ...
                            <div class="bm_ctl_container_100_45">
                                <div class="bm_ctl_label_align_right_100_45">
                                    <asp:Label ID="Label7" runat="server" Text="Alternate Code :" AssociatedControlID="xcodealt1"
                                        CssClass="label"></asp:Label>
                                </div>
                                <div class="bm_clt_ctl_100_45">
                                    <asp:TextBox ID="xcodealt1" runat="server" CssClass="bm_academic_textbox_100_45 bm_academic_ctl_global bm_academic_textbox"></asp:TextBox>
                                </div>
                            </div>
                            <div class="bm_clt_padding">
                            </div>
                ...
                <div class="bm_academic_grid_container" id="list" runat="server">
                    ...
                    <div class="grid_body">
                        <asp:GridView ID="_grid_codes" runat="server" AutoGenerateColumns="False" ShowFooter="true"
                            ...
                            <Columns>
                                <asp:BoundField DataField="xtype" HeaderText="Code Type" ItemStyle-Width="150px" ItemStyle-HorizontalAlign="Center"/>
                                <asp:TemplateField HeaderText="Code">
                                    <ItemStyle Width="250px" HorizontalAlign="Center" />
                                    <ItemTemplate>
                                        <asp:LinkButton ID="xcode" runat="server" Text='<%#Eval("xcode") %>' CssClass="_gridrow_link" OnClick="FillControls"></asp:LinkButton>
                                    </ItemTemplate>
                                    <FooterTemplate>
                                ...
                                <asp:BoundField DataField="xcodealt1" HeaderText="Alternate Code" />
                                <asp:BoundField DataField="xcodealt" HeaderText="Sequence" />
