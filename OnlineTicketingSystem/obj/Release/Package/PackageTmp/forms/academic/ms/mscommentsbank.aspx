<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="mscommentsbank.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.mscommentsbank" %>
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Comments Bank</span>
                    </div>
                </div>
                    ...
                    <div class="bm_academic_container_body_input_section">
                        <div class="bm_layout_container">
                            <div class="bm_layout_box_100">
                                    ...
                                    <div style="width: 100%; clear: both; min-height: 300px">
                                        ...
                                        <div class="bm_ctl_container_100_special" style="width: 300px;">
                                            <div class="bm_ctl_label_align_right_100_special" style="width: 90px">
                                                <asp:Label ID="Label7" runat="server" Text="Type:" AssociatedControlID="xtype"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                        ...
                                        <div class="bm_ctl_container_100_special" style="width: 300px;">
                                            <div class="bm_ctl_label_align_right_100_special" style="width: 90px">
                                                <asp:Label ID="Label4" runat="server" Text="Category 1 :" AssociatedControlID="xcat1"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_100_special" style="width: 208px">
                                                <asp:DropDownList ID="xcat1" runat="server" CssClass="bm_academic_dropdown_100_special bm_academic_ctl_global bm_academic_dropdown"
                                                    AutoPostBack="True" OnTextChanged="xsubject_OnTextChanged">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                        ...
                                        <div class="bm_ctl_container_100_special" style="width: 300px;">
                                            <div class="bm_ctl_label_align_right_100_special" style="width: 90px">
                                                <asp:Label ID="Label5" runat="server" Text="Category 2 :" AssociatedControlID="xcat2"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_100_special" style="width: 208px">
                                                <asp:DropDownList ID="xcat2" runat="server" CssClass="bm_academic_dropdown_100_special bm_academic_ctl_global bm_academic_dropdown"
                                                    AutoPostBack="True" OnTextChanged="xsubject_OnTextChanged">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                ...
                                <div class="bm_ctl_container_dynamic_100_80_l" style="width: 90px;">
                                    <div class="bm_ctl_label_align_right_dynamic_100_80_l">
                                        <asp:Label ID="Label6" runat="server" Text="Comments :" CssClass="label"></asp:Label>
                                    </div>
                                </div>
                                <div class="bm_clt_ctl_dynamic_100_80">
                                    <div class="_ctl_padding">
                                        <textarea id="xcomments" class="bm_academic_textarea_100_80  bm_academic_textarea"
                                            style="width: 500px; height: 100px;" runat="server"></textarea>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div style="display: none;">
                                            <div class="bm_ctl_container_100_special" style="width: 90px; float: left">
                                                <div class="bm_ctl_label_align_right_100_special" style="width: 90px">
                                                    <asp:Label ID="Label1" runat="server" Text="Comments :"
                                                        CssClass="label"></asp:Label>
                                                </div>
                                                <%--<div class="bm_clt_ctl_100_special" style="width: 148px">
                                   ...
                                   <%--     <div class="bm_clt_padding">
                                        ...
                                        <div style="display: none;">
                                            ...
                                            <div style="border: 1px solid #696969; width: 1000px; float: left; min-height: 25px">
                                                <asp:CheckBoxList ID="xext" runat="server" RepeatDirection="Horizontal" CellSpacing="10" RepeatColumns="8"></asp:CheckBoxList>
                                            </div>
                                        </div>
                                        <div class="bm_clt_padding">
                                        </div>
                                        ...
                                        <asp:Button ID="btnAddSubject" runat="server" Text="Add Comments" CssClass="bm_academic_button5 bm_am_btn_addnew" Width="140px"
                                            OnClick="btnAddSubject_OnClick" />
                                         <asp:Button ID="btnUpdateComments" runat="server" Text="Update Comments" CssClass="bm_academic_button5 bm_am_btn_addnew" Width="140px"
                                            OnClick="btnUpdateComments_OnClick" />
...
<div style="width: 100%; clear: both; padding-top: 5px">
                                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" ShowFooter="true"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="xcat1" HeaderText="Category 1" ItemStyle-Width="100px"
                                                    ItemStyle-HorizontalAlign="left" ItemStyle-CssClass="pad5" />
                                                <asp:BoundField DataField="xcat2" HeaderText="Category 2" ItemStyle-Width="100px"
                                                    ItemStyle-HorizontalAlign="left" ItemStyle-CssClass="pad5" />
                                                 <asp:BoundField DataField="xtype" HeaderText="Type" ItemStyle-Width="150px"
                                                    ItemStyle-HorizontalAlign="left" ItemStyle-CssClass="pad5" />
                                                <asp:BoundField DataField="xcomments" HeaderText="Comments" ItemStyle-Width="550px"
                                                    ItemStyle-HorizontalAlign="left" ItemStyle-CssClass="pad5" />

                                                 <asp:TemplateField HeaderText="">
                                                    <ItemStyle Width="150px" HorizontalAlign="Center" />
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="LinkButton2" runat="server"  OnClick="ImageButton2_OnClick">Select</asp:LinkButton>
