<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="amgradeconf.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.admission.amgradeconf" %>
                        ...
                        <div class="bm_layout_box_padding">
                            ...
                            <div class="bm_ctl_container_100_45 required" >
                                <div class="bm_ctl_label_align_right_100_45 label_bg">
                                    <asp:Label ID="Label26" runat="server" Text="Effected Date :" AssociatedControlID="xeffdate"
                                        CssClass="label"></asp:Label>
                                </div>
                                <div class="bm_clt_ctl_100_45">
                                    <asp:TextBox ID="xeffdate" runat="server" CssClass="bm_academic_textbox_100_45 bm_academic_ctl_global bm_academic_datepicker"></asp:TextBox>
                                </div>
                            </div>
                            <div class="bm_clt_padding">
                            </div>
