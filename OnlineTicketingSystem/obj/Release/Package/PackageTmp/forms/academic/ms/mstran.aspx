<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="mstran.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.admission.mstran" %>
                ...
                <div class="bm_layout_container">
                    <div class="bm_layout_box_100">
                        <div class="bm_layout_box_padding">
                            ...
                            <div class="bm_ctl_container_100_35" style="display: inline-block; width: 300px;">
                                            <div class="bm_ctl_label_align_right_100_35" style="width: 172px">
                                                <asp:Label ID="Label9" runat="server" Text="Action :" AssociatedControlID="xaction"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_100_35" style="width:126px">
                                                <asp:DropDownList ID="xaction" runat="server" CssClass="bm_academic_dropdown_100_35 bm_academic_ctl_global bm_academic_dropdown">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                           <%-- <div class="bm_clt_padding">
                            ...
                            <div class="bm_ctl_container_100_45">
                                <div class="bm_ctl_label_align_right_100_45">
                                    <asp:Label ID="Label7" runat="server" Text="Description :" AssociatedControlID="xdesc"
                                        CssClass="label"></asp:Label>
                                </div>
                                <div class="bm_clt_ctl_100_45">
                                    <asp:TextBox ID="xdesc" runat="server" CssClass="bm_academic_textbox_100_45 bm_academic_ctl_global bm_academic_textbox"></asp:TextBox>
                                </div>
                            </div>
                            <%--<div class="bm_clt_padding">
                            </div>
