<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="mscommonconfig.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.mscommonconfig" %>
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Classwise Subject Setup</span>
                    </div>
                </div>
                                        ...
                                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" ShowFooter="true"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="">
                                                    ...
                                                    <ItemTemplate>
                                                        <%--<asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/images/delete216x16.png" OnClientClick="javascript:ConfirmMessage1();" OnClick="ImageButton1_OnClick"/>--%>
