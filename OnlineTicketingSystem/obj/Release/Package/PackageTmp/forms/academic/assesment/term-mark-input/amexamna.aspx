<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/academic_site.Master"
    CodeBehind="amexamna.aspx.cs" Inherits="OnlineTicketingSystem.forms.BMERP.amexamna"
...
//                            scrolling: "yes" // must have the jquery-1.3.2.min.js script installed to use
            ...
            grid.insertBefore(newTh, tbody); //puts thead behore tbody--%>
                    ...
                    //    var trb = tbody.getElementsByTagName("tr")[i];
                    //    if (i == 0 || i == 1) {
                    //        trb.classList.add("GridViewScrollHeader");
                    //    } else {
                    //        trb.classList.add("GridViewScrollItem");
                    //    }
                    //    grid.appendChild(trb);
                    ...
                    <%--                        var gridHeader = $('#<%=GridView1.ClientID %>').clone(true);
                        $(gridHeader).find("tr:gt(1)").remove();
            ...
            <%--MakeStaticHeader('#<%=GridView1.ClientID %>', 600, 1229.4, 60, false);--%>
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Term Exam N/A</span>
                    </div>
                </div>
                ...
                <div class="bm_academic_container_body1">
                                ...
                                <div class="bm_layout_box_padding">
                                    ...
                                    <div style="width: 100%; clear: both;">
                                        <div style="padding-bottom: 10px;">
                                            <table>
                                                <tr>
                                                    <td><span style="font-size: 16px; font-weight: bold;">Search By : </span></td>
                                                    <td>
                                                        <asp:RadioButton AutoPostBack="True" ID="rdoID" runat="server" GroupName="student" Text="Student ID" OnCheckedChanged="rdo_OnCheckedChanged" /></td>
                                                    <td>
                                                        <asp:RadioButton AutoPostBack="True" ID="rdoClass" runat="server" GroupName="student" Text="Class Name" OnCheckedChanged="rdo_OnCheckedChanged" /></td>
                                                </tr>
                                            </table>
                                        </div>
                                       
                                        <div id="studentid" runat="server">
                                             <div class="bm_ctl_container_100_special" style="display: inline-block;">
                                                <div class="bm_ctl_label_align_right_100_special">
                                                    <asp:Label ID="Label2" runat="server" Text="Session :" AssociatedControlID="xsession_id"
                                                        CssClass="label"></asp:Label>
                                                </div>
                                                <div class="bm_clt_ctl_100_special">
                                                    <asp:DropDownList ID="xsession_id" runat="server" CssClass="bm_academic_dropdown_100_special bm_academic_ctl_global bm_academic_dropdown">
                                                    </asp:DropDownList>
                                                </div>
                                            </div>
                                            <div class="bm_ctl_container_50_50" style="display: inline-block; width: 230px">
                                                <div class="bm_ctl_label_align_right_50_50" style="width: 80px">
                                                    <asp:Label ID="Label1" runat="server" Text="Student ID :" AssociatedControlID="xstdid"
                                                        CssClass="label "></asp:Label>
                                                </div>
                                            ...
                                            <div class="bm_ctl_container_50_50" style="display: inline-block; width: 32px; border: none; padding-left: 10px;">
                                        ...
                                        <div id="classname" runat="server">
                                            ...
                                            <div class="bm_ctl_container_50_50" style="display: inline-block; width: 200px; border: none; padding-left: 10px;">
                                                <div class="bm_clt_ctl_50_50" style="width: 100%;">
                                                    <asp:Button ID="btnShowList" runat="server" Text="Show List" CssClass="bm_academic_button3 bm_am_btn_save" OnClick="btnShowList_OnClick"/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="bm_academic_container_footer">
                        <div class="footer_list_padding2" style="min-height: 320px;">
                           ...
                           <div class="bm_academic_grid_container"  style="padding-left: 10px">
                               <div>
                               ...
                               <div id="list" runat="server">
                                ...
                                <table >
                                    <tr>
                                        <td>Student ID</td>
                                        <td>:</td>
                                        <td><asp:Label ID="xstdid1" runat="server" Text=""></asp:Label></td>
                                    </tr>
                                     <tr>
                                        <td>Student Name</td>
                                        <td>:</td>
                                        <td><asp:Label ID="xname" runat="server" Text=""></asp:Label></td>
                                    </tr>
                                    <tr>
                                        <td>Mother's Name</td>
                                        <td>:</td>
                                        <td><asp:Label ID="xmname" runat="server" Text=""></asp:Label></td>
                                    </tr>
                                    <tr>
                                        <td>Father's Name</td>
                                        <td>:</td>
                                        <td><asp:Label ID="xfname" runat="server" Text=""></asp:Label></td>
                                    </tr>
                                    <tr>
                                        <td>Class</td>
                                        <td>:</td>
                                        <td><asp:Label ID="xclass1" runat="server" Text=""></asp:Label></td>
                                    </tr>
                                    <tr>
                                        <td>Group</td>
                                        <td>:</td>
                                        <td><asp:Label ID="xgroup1" runat="server" Text=""></asp:Label></td>
                                    </tr>
                                    <tr>
                                        <td>Section</td>
                                        <td>:</td>
                                        <td><asp:Label ID="xsection1" runat="server" Text=""></asp:Label></td>
                                    </tr>
                                    <tr>
                                        <td>Term Exam(s) Not Applicable</td>
                                        <td>:</td>
                                        <td><div style="width: 100%;" id="placeholder9" runat="server"></div></td>
                                    </tr>
                                    <tr>
                                        <td>Note</td>
                                        <td>:</td>
                                        <td>
                                            <asp:TextBox ID="xremarks" runat="server" TextMode="MultiLine" ></asp:TextBox></td>
                                    </tr>
                                </table>
