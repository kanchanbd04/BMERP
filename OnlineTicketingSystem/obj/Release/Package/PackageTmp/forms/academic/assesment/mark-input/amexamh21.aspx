<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="amexamh21.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.amexamh21" %>
            ...
            <div class="bm_academic_container" style="color: black;">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Class Test Marks Approval Status</span>
                    </div>
                </div>
                        ...
                        <div class="button_section_padding">
                            <table width="100%" style="border-collapse: collapse;">
                                <tr style="width: 100%">
                                    ...
                                    <td style="width: 40%">
                                        <div class="button_section_style1" style="display: none;">
