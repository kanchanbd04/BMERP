<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/academic_site.Master"
    CodeBehind="asreportcardmock.aspx.cs" Inherits="OnlineTicketingSystem.forms.BMERP.asreportcardmock"
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript">
        function fnPrintNumSchedule() {
            ...
            //$.ajax({
            //                url: "asreportcardmock.aspx/fnGetStatus",
...
//            openwin.focus();
            //openwin.print();
            //return false;
            var openwin = window.open('/forms/academic/reports/rptreportcardmock.aspx?zid=' + zid + '&xsession=' + xsession1 + '&xterm=' + xterm1 + '&xclass=' + xclass1 + '&xgroup=' + xgroup1 + '&xsection=' + xsection1 , 'tabulation', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, copyhistory=no, width=' + screen.width + ', height=' + screen.height + ', top=0, left=0, targets=_blank');
            openwin.focus();
        }
    </script>
</asp:Content>
