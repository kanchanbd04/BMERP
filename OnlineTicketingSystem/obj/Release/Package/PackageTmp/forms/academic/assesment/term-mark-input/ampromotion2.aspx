<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="ampromotion2.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.ampromotion2" %>
    ...
    <div class="bm_academic_container">
        <div class="bm_academic_container_header">
            <div class="header_label1" id="header_label" runat="server">
                <span class="bm_am_header_round">Auto Promotion (All Students')</span>
            </div>
        </div>
                    ...
                    <div class="footer_list_padding1" style="padding-top: 0px;">
                        <div class="bm_academic_grid_container2" style="width: 100%" id="divliststd" runat="server">
                           <%-- <div style="float: left; width: 20%; margin: 4px 2px 0px 10px;">--%>
                             <div style="width: 98%; margin: 4px 2px 0px 10px;">
                                <table style="border: Solid 3px #619CFD; width: 100%; height: 100%; border-collapse: collapse;"
                                    cellpadding="0" cellspacing="0">
                                   
                                    <tr style="background-color: #619CFD">
                                        <td style="height: 20px; color: white; font-size: 16px; font-weight: bold; padding-bottom: 5px;" align="left">Promoted To
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <table width="40%">
                                                <tr>
                                                    ...
                                                    <td>:</td>
                                                    <td>
                                                        <asp:DropDownList ID="xsessionpro" runat="server" Width="98%">
                                                        </asp:DropDownList>
                                                    </td>
                                               ...
                                               <%-- </tr>
                                                <tr>--%>
                                                    ...
                                                    <td>:</td>
                                                    <td>
                                                        <asp:DropDownList ID="xclasspro" runat="server" Width="98%">
                                                        </asp:DropDownList>
                                                    </td>
                                               ...
                                               <%-- </tr>
                                                <tr>--%>
                                                  <%--  <td>Group</td>
                                                    <td>:</td>
                                                    <td>
                                                        <asp:DropDownList ID="xgrouppro" runat="server" Width="98%">
                                                        </asp:DropDownList>
                                                    </td>--%>
                                                    <td>Status</td>
                                                    <td>:</td>
                                    ...
                                    <%--<tr style="background-color: #619CFD">
                                        <td style="height: 15px; color: white; font-size: 14px" align="left">Note
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td align="left" style="padding: 5px;">
                                            <textarea id="xdetails" class="bm_academic_textarea_100_50  bm_academic_textarea"
                                                style="width: 100%; height: 250px;" runat="server"></textarea>
                                        </td>
                                    </tr>--%>
                           ...
                           <%-- <div style="float: left; width: 100%; margin-bottom: 10px;">--%>
                             <div style="width: 98%; margin-bottom: 10px; margin-left: 10px; border: 2px solid #619CFD;">
                                ...
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" ShowFooter="false"
                                    ...
                                    PagerStyle-CssClass="PagerStyle" GridLines="None" OnRowDataBound="OnRowDataBound"> <%--UseAccessibleHeaderText="true" AllowSorting="True" OnSorting="GridView1_Sorting"--%>
                                        ...
                                        <asp:GridView ID="dgvPromotedistNew" runat="server" AutoGenerateColumns="False" ShowFooter="False"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="xsection" HeaderText="Section" ItemStyle-Width="150px"
                                                    ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="pad5" />
                                                <asp:BoundField DataField="xsessionpro" HeaderText="Session (Promoted)" ItemStyle-Width="150px"
                                                    ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="pad5" />
                                                <asp:BoundField DataField="xclasspro" HeaderText="Class (Promoted)" ItemStyle-Width="150px"
                                                    ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="pad5" />
                                                <asp:BoundField DataField="xgrouppro" HeaderText="Group (Promoted)" ItemStyle-Width="150px"
                                                    ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="pad5" />
