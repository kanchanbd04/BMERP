<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/academic_site.Master"
    CodeBehind="amexamhhmock4.aspx.cs" Inherits="OnlineTicketingSystem.forms.BMERP.amexamhhmock4"
...
//                            scrolling: "yes" // must have the jquery-1.3.2.min.js script installed to use
        ...
        function ConfirmMessage3() {
            ...
            var selectedvalue = confirm("Press 'OK' to approve tabulation sheet for " + document.getElementById('<%=xclass.ClientID %>').value + ".");
            if (selectedvalue) {
    ...
    <div class="bm_academic_container">
        <div class="bm_academic_container_header">
            <div class="header_label1" id="header_label" runat="server">
                <span class="bm_am_header_round">Mock Exam Tabulation Sheet Approval</span>
            </div>
        </div>
