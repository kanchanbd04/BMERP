<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="amexamh123.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.amexamh123" %>
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Class Test Marks Approval (Class Teacher)</span>
                    </div>
                </div>
                            ...
                            <table width="100%" style="border-collapse: collapse;">
                                <tr style="width: 100%">
                                    <td style="width: 60%">
                                        ...
                                        <div class="bm_ctl_container_100_special" style="display: none; width: 110px">
                        ...
                        <div class="bm_layout_container">
                            <div class="bm_layout_box_100">
                                <div class="bm_layout_box_padding" style="padding-top: 0px;">
                                    ...
                                    <div style="width: 100%; clear: both; font-size: 14px; color: black;">
                                        <span>Session :</span>
                                        <span><asp:Label ID="lblxsession" runat="server" Text=""></asp:Label></span>
                                        <span style="padding-left: 10px;"></span>

                                         <span>Term :</span>
                                        <span><asp:Label ID="lblxterm" runat="server" Text=""></asp:Label></span>
                                        <span style="padding-left: 10px;"></span>
                                        
                                        <span>Class :</span>
                                        <span><asp:Label ID="lblxclass" runat="server" Text=""></asp:Label></span>
                                        <span style="padding-left: 10px;"></span>
                                        
                                        <span>Group :</span>
                                        <span><asp:Label ID="lblxgroup" runat="server" Text=""></asp:Label></span>
                                        <span style="padding-left: 10px;"></span>
                                        
                                        <span>Section :</span>
                                        <span><asp:Label ID="lblxsection" runat="server" Text=""></asp:Label></span>
                                        <span style="padding-left: 10px;"></span>
                                        
                                        <span>Subject :</span>
                                        <span><asp:Label ID="lblxsubject" runat="server" Text=""></asp:Label></span>
                                        <span style="padding-left: 10px;"></span>
                                        
                                         <span>CT No :</span>
                                        <span><asp:Label ID="lblctno" runat="server" Text=""></asp:Label></span>
                                        <span style="padding-left: 10px;"></span>
                                        
                                        <span>Marks :</span>
                                        <span><asp:Label ID="lblxmarks" runat="server" Text=""></asp:Label></span>
                                        <span style="padding-left: 10px;"></span>
                                        
                                        <span>Date :</span>
                                        <span><asp:Label ID="lblxdate" runat="server" Text=""></asp:Label></span>
                                        <span style="padding-left: 10px;"></span>
                                        ...
                                        <div class="bm_ctl_container_100_special" style="display: none">
                                            ...
                                            <div class="bm_clt_ctl_100_special" style="width: 103px;">
                                                <asp:DropDownList ID="xclass" runat="server" CssClass="bm_academic_dropdown_100_special bm_academic_ctl_global bm_academic_dropdown"
                                                    AutoPostBack="True" OnTextChanged="combo_OnTextChanged_class" Enabled="False">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                        ...
                                        <div class="bm_ctl_container_100_special" style="display: none; width: 250px">
                                            <div class="bm_ctl_label_align_right_100_special" style="width: 64px">
                                            ...
                                            <div class="bm_clt_ctl_100_special" style="width: 184px">
                                                <asp:DropDownList ID="xsubject" runat="server" CssClass="bm_academic_dropdown_100_special bm_academic_ctl_global bm_academic_dropdown"
                                                    AutoPostBack="True" OnTextChanged="combo_OnTextChanged_subject" Enabled="False">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                        <div class="bm_ctl_container_100_special" style="display: none; width: 260px" runat="server" id="_xext">
                                        ...
                                        <div class="bm_ctl_container_100_special" style="display: none; width: 110px;" runat="server" id="_xpaper">
                                    ...
                                    <div style="width: 100%; clear: both; padding-top: 5px; display: none;">
                                        <div class="bm_ctl_container_100_special" style="display: inline-block;">
                                            ...
                                            <div class="bm_clt_ctl_100_special" style="width: 103px">
                                                <asp:DropDownList ID="xcttype" runat="server" CssClass="bm_academic_dropdown_100_special bm_academic_ctl_global bm_academic_dropdown"
                                                    AutoPostBack="True" OnTextChanged="xcttype_Click" Enabled="False">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                        <div class="bm_ctl_container_100_special" style="display: inline-block; width: 130px">
                                            ...
                                            <div class="bm_clt_ctl_100_special" style="width: 63px">
                                                <asp:DropDownList ID="xctno" runat="server" CssClass="bm_academic_dropdown_100_special bm_academic_ctl_global bm_academic_dropdown"
                                                    AutoPostBack="True" OnTextChanged="xctno_Click" Enabled="False">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                        <div class="bm_ctl_container_100_special" style="display: inline-block;" runat="server"
                                            ...
                                            <div class="bm_clt_ctl_100_special" style="width: 103px">
                                                <asp:DropDownList ID="xreference" runat="server" CssClass="bm_academic_dropdown_100_special bm_academic_ctl_global bm_academic_dropdown"
                                                    AutoPostBack="True" OnTextChanged="xreference_Click" Enabled="False">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                        <div class="bm_ctl_container_100_special" style="display: inline-block; width: 210px"
                                            ...
                                            <div class="bm_clt_ctl_100_special" style="width: 108px">
                                                <%-- <asp:DropDownList ID="xdate" runat="server" CssClass="bm_academic_dropdown_100_special bm_academic_ctl_global bm_academic_dropdown" AutoPostBack="True" OnTextChanged="btnRefresh_Click">
                                                </asp:DropDownList>--%>
                                      ...
                                      <span>Class Teacher :</span>
                                        <span><asp:Label ID="lblxcteacher" runat="server" Text=""></asp:Label></span>
                                        <span style="padding-left: 10px;"></span>
                                        
                                         <span>Subject Teacher :</span>
                                        <span><asp:Label ID="lblxsteacher" runat="server" Text=""></asp:Label></span>
                                        <span style="padding-left: 10px;"></span>
                                    ...
                                    <div style="width: 100%; clear: both; padding-top: 5px; ">
                                         <span>Topic :</span>
                                        <span><asp:Label ID="lblxtopic" runat="server" Text=""></asp:Label></span>
                                        <span style="padding-left: 10px;"></span>
                        ...
                        <div class="bm_academic_container_footer">
                            <div class="footer_list_padding1">
                                <div class="bm_academic_grid_container2" style="width: 100%">
                                    <div style="float: left; width: 20%; margin: 4px 2px 0px 10px; display: none;">
