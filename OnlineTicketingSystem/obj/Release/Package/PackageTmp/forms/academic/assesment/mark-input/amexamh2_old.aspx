<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="amexamh2_old.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.amexamh2_old" %>
                                       ...
                                       <%-- <div class="bm_ctl_container_100_special" style="display: inline-block; width: 160px">
                                        ...
                                        <div class="bm_ctl_container_100_special" style="display: inline-block; width: 110px">
                                            <div class="bm_ctl_label_align_right_100_special" style="width: 50px">
                                                <asp:Label ID="Label16" runat="server" Text="Term :" AssociatedControlID="xterm" CssClass="label"></asp:Label>
                                            </div>
                                        ...
                                        <div class="bm_ctl_container_100_special" style="display: inline-block; width: 250px;">
                                         ...
                                         <div class="bm_ctl_container_100_special" style="display: inline-block; width: 260px" runat="server" id="_xext">
                                            <div class="bm_ctl_label_align_right_100_special" style="width: 74px">
                                                <asp:Label ID="Label1" runat="server" Text="Extension :" AssociatedControlID="xext"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_100_special" style="width: 184px">
                                    ...
                                    <div style="width: 100%; clear: both; padding-top: 5px">
                                        ...
                                        <div class="bm_ctl_container_100_special" style="display: inline-block; width: 350px"
                                            ...
                                            <div class="bm_clt_ctl_100_special" style="width: 282px">
                                                <asp:TextBox ID="xreason" runat="server" CssClass="bm_academic_textbox_100_special bm_academic_ctl_global bm_academic_textbox" Enabled="False"></asp:TextBox>
                                            </div>
                                        </div>
                                        ...
                                        <div class="bm_ctl_container_100_special" style="display: none; width: 250px" >
                                            <div class="bm_ctl_label_align_right_100_special" style="width: 110px">
                                                <asp:Label ID="Label14" runat="server" Text="Permission Type :" AssociatedControlID="xpermission"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_100_special" style="width: 138px">
                                                <asp:DropDownList ID="xpermission" runat="server" CssClass="bm_academic_dropdown_100_special bm_academic_ctl_global bm_academic_dropdown"
                                                    AutoPostBack="True" OnTextChanged="xpermission_Click" Enabled="False">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
