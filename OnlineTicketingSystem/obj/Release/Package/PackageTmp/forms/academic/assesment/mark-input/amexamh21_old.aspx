<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="amexamh21_old.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.amexamh21_old" %>
                                        ...
                                        <div class="bm_ctl_container_100_special" style="display: inline-block; width: 210px">
                                            ...
                                            <div class="bm_clt_ctl_100_special">
                                                ...
                                                <asp:TextBox ID="xdate" runat="server" CssClass="bm_academic_textbox_100_special bm_academic_ctl_global bm_academic_datepicker"
                                                    AutoPostBack="True" OnTextChanged="xdate_Click" Enabled="False"></asp:TextBox>
                                            </div>
                                        </div>
                                        ...
                                        <div class="bm_ctl_container_100_special" style="display: none; width: 250px" >
                                            ...
                                            <div class="bm_clt_ctl_100_special" style="width: 138px">
                                                <asp:DropDownList ID="xpermission" runat="server" CssClass="bm_academic_dropdown_100_special bm_academic_ctl_global bm_academic_dropdown"
                                                    AutoPostBack="True" OnTextChanged="xpermission_Click">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
