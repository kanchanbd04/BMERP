<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="pradvdadj.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.pradvdadj" %>
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                       <span class="bm_am_header_round">Loan Adjustment Details for Employee: &nbsp;<span id="spanxemp" runat="server"> </span></span>
                    </div>
                </div>
                                    ...
                                    <div style="display: inline-block; width: 400px; font-size: 14px; vertical-align: top; color: #0000ff;">
                                        <table>
                                             <tr>
                                                ...
                                                <td>:</td>
                                                <td>
                                                    <asp:TextBox ID="xline" runat="server" Text="0" width="50px" ReadOnly="True"></asp:TextBox>
                                                </td>
                                            </tr>
                                              ...
                                              <tr>
                                                ...
                                                <td>:</td>
                                                <td>
                                                    <asp:Label ID="advance" runat="server" Text="0"></asp:Label>
                                                </td>
                                            </tr>
                                              ...
                                              <tr>
                                                ...
                                                <td>:</td>
                                                <td>
                                                    <asp:Label ID="amount" runat="server" Text="0"></asp:Label>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                             ...
                                             <tr>
                                                ...
                                                <td>:</td>
                                                <td>
                                                    <asp:TextBox ID="xdatesch" runat="server" CssClass=" bm_academic_datepicker"></asp:TextBox>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>:</td>
                                                <td>
                                                    <asp:TextBox ID="xpayamt" runat="server" Text="0"></asp:TextBox>
                                                </td>
                                            </tr>
                                        ...
                                        <div class="grid_body" >
                                            <asp:GridView ID="dgvcollectionpaid" runat="server" AutoGenerateColumns="False" ShowFooter="False"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="xpayamt" HeaderText="Payment Amount" ItemStyle-Width="120px"
