<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="princremenh.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.princremenh" %>
            ...
            <%--    $("body").on("change", "#<%=xclass.ClientID%>", function() {
               ...
               <%--     if ($("#<%=hxstatus.ClientID%>").val() == "")--%>
                ...
                function ConfirmMessage() {
                    var selectedvalue = confirm("Do you really want to confirm this record?? After confirm cann't change record.");
                    if (selectedvalue) {
          ...
          //gridviewScroll();
            ...
            $('#<%=GridView1.ClientID%>').gridviewScroll({
                ...
                <%--//$('.bm_xsubcb').click(function () {
                    $("body").on("click", ".bm_xsubcb", function () {
                ...
                $("body").on("click", ".bm_tmpdesc", function () {
                    //alert($(this).parent(".bm_span2").siblings(".bm_span3").find(".bm_label1").attr("ID"));
                    fnOpenPayScale(<%= HttpContext.Current.Session["business"] %>,$(this).parent(".bm_span2").siblings(".bm_span1").find(".bm_text1").attr("ID"),$(this).parent(".bm_span2").siblings(".bm_span1").find(".bm_text1").val(),$(this).parent(".bm_span2").siblings(".bm_span3").find(".bm_label1").attr("ID")); 
                });
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Increment History</span>
                    </div>
                </div>
                    ...
                    <div class="bm_academic_container_body_button_section">
                        <div class="button_section_padding" style="border-bottom: 0px; padding-bottom: 0px">
                            <div class="button_section_style1" style="text-align: left; margin-bottom: 5px;">
                                ...
                                <asp:Button ID="btnPaid" runat="server" Text="Confirm" CssClass="bm_academic_button3 bm_am_btn_paid"
                                    ...
                                    <div style="display: inline-block; width: 350px; font-size: 14px; vertical-align: top; color: #0000ff;">
                                        <table>
                                            ...
                                            <tr>
                                                ...
                                                <td>:</td>
                                                <td>
                                                    <asp:Label ID="xdept" runat="server"></asp:Label>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>:</td>
                                                <td>
                                                    <asp:Label ID="xlocation" runat="server"></asp:Label>
                                                </td>
                                            </tr>


                                            <tr>
                                                <td style="text-align: right">Increment Effective Date</td>
                                                <td>:</td>
                                                <td>
                                            ...
                                            <tr>
                                                <td style="text-align: right">Promotional Status</td>
                                                <td>:</td>
                                                <td>
                                                    <asp:DropDownList ID="xsites" runat="server" AutoPostBack="True" OnSelectedIndexChanged="xsites_OnSelectedIndexChanged"></asp:DropDownList>
                                                </td>
                                            </tr>
                                            
                                             <tr id="xnewdesig_tr" runat="server">
                                                <td style="text-align: right">New Designation</td>
                                                <td>:</td>
                                                <td>
                                                    <asp:DropDownList ID="xnewdesig" runat="server"></asp:DropDownList>
                                                </td>
                                            </tr>
                                            
                                             <tr>
                                                <td style="text-align: right">Entry by</td>
                                                <td>:</td>
                                                <td>
                                             ...
                                             <tr>
                                                <td style="text-align: right">Confirm by</td>
                                                <td>:</td>
                                                <td>
                                                   <asp:Label ID="xemail1" runat="server"></asp:Label>
                                                </td>
                                            </tr>
                                            
                                             <tr>
                                                <td style="text-align: right">Qualifying Year</td>
                                                <td>:</td>
                                                <td>
                                                   <asp:Label ID="xyearq" runat="server"></asp:Label>
                                                </td>
                                            </tr>
                                    ...
                                    <div style="display: inline-block; width: 350px; font-size: 14px; vertical-align: top; color: #0000ff;">
                                        <table>
                                            ...
                                            <tr>
                                                ...
                                                <td>:</td>
                                                <td>
                                                    <asp:Label ID="xdesig" runat="server"></asp:Label>
                                                </td>
                                            </tr>

                                            <tr>
                                                <td style="text-align: right">Pay scale Code</td>
                                                <td>:</td>
                                                <td>
                                                    <asp:Label ID="xoldpsclcode" runat="server"></asp:Label>
                                                </td>
                                            </tr>

                                            <tr>
                                                <td style="text-align: right">Increment Letter Reference</td>
                                                <td>:</td>
                                                <td>
                                                    <asp:TextBox ID="xref" runat="server"></asp:TextBox>
                                                </td>
                                            </tr>
                                            
                                            <tr>
                                                <td style="text-align: right">Confirmation Status</td>
                                                <td>:</td>
                                                <td>
                                                    <asp:Label ID="xpostflag" runat="server"></asp:Label>
                                                </td>
                                            </tr>
                                            
                                             <tr id="xpsclcode_tr" runat="server">
                                                <td style="text-align: right">New Pay scale Code</td>
                                                <td>:</td>
                                                <td>
                                                   <span class="bm_span1">
                                                        <asp:TextBox ID="xpsclcode" runat="server" Height="20px" Width="150px" CssClass="bm_text1"></asp:TextBox>
                                                    </span>
                                                    <span class="bm_span2">
                                                        <asp:Image ID="Image6" runat="server" ImageUrl="~/images/list-am32x32.png" Height="20px" Width="20px" ImageAlign="Top" CssClass="bm_academic_list3 bm_tmpdesc" />
                                                    </span>
                                                    <span class="bm_span3" style="display: none;">
                                                        <asp:Label ID="tmpdesc" runat="server" Text="" CssClass="bm_label1"></asp:Label>
                                                    </span>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                              ...
                                              <tr>
                                                <td style="text-align: right">Period Ends on Day</td>
                                                <td>:</td>
                                                <td>
                                                    <asp:Label ID="xperend" runat="server"></asp:Label>
                                                </td>
                                            </tr>
                                    ...
                                    <div style="width: 450px; display: inline-block; height: 300px; border: 1px solid #a9a9a9;vertical-align: top; ">
                                        ...
                                        <div class="grid_body" style="overflow-y: scroll; height: 90%; width: 100%;">
                                         <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" ShowFooter="true"
                                            ...
                                            <Columns>
                                                <asp:BoundField DataField="xpaycode" HeaderText="Payment Code" ItemStyle-Width="80px"
                                                ...
                                                <asp:BoundField DataField="xdesc" HeaderText="Description" ItemStyle-Width="200px"
                                                 ...
                                                 <asp:BoundField DataField="xsign" HeaderText="Sign" ItemStyle-Width="50px"
                                                    ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="pad5" />

                                                <asp:BoundField DataField="xamount" HeaderText="Increment Amount" ItemStyle-Width="100px"
                                                    ItemStyle-HorizontalAlign="Left" ItemStyle-CssClass="pad5" />
                        ...
                        <div class="bm_academic_container_footer">
                            ...
                            <div class="bm_academic_container_body_button_section">
                                <div class="button_section_padding">
                                    ...
                                    Visible="False" />--%>
                                        <asp:Button ID="btnPaid1" runat="server" Text="Confirm" CssClass="bm_academic_button3 bm_am_btn_paid"
                                            OnClientClick="javascript:ConfirmMessage();" OnClick="btnPaid_Click" />
                                    ...
                                    <div class="bm_academic_grid_container" id="list" runat="server">
                                        <div class="grid_header">
                                            <div class="grid_header_label" id="_grid_header" runat="server">
                                                 List of Increment for: &nbsp; <asp:Label ID="xempid" runat="server" ></asp:Label>
                                            </div>
                                            <div class="grid_header_control">
                                            </div>
                                            <div class="flot_right">
                                        ...
                                        <div class="grid_body">
                                            <asp:GridView ID="dgvcollectionew" runat="server" AutoGenerateColumns="False" ShowFooter="False"
                                                ...
                                                <asp:TemplateField HeaderText="Employee Code">
                                                    ...
                                                    <asp:BoundField DataField="xdept" HeaderText="Department" ItemStyle-Width="150px"
                                                        ItemStyle-HorizontalAlign="Left" ItemStyle-CssClass="pad5"  />
                                                    
                                                    <asp:BoundField DataField="xpaydate" HeaderText="Effective Date" DataFormatString="{0:dd/MM/yyyy}"
                                                        ItemStyle-Width="120px" ItemStyle-HorizontalAlign="Center" />
                                                    
                                                     <asp:BoundField DataField="xsites" HeaderText="Promotional Status" ItemStyle-Width="150px"
                                                        ItemStyle-HorizontalAlign="Left" ItemStyle-CssClass="pad5"  />
                                                    
                                                     <asp:BoundField DataField="xlocation" HeaderText="Location" ItemStyle-Width="100px"
                                                        ItemStyle-HorizontalAlign="Left" ItemStyle-CssClass="pad5"  />
                                                    
                                                     <asp:BoundField DataField="xpostflag" HeaderText="Flag" ItemStyle-Width="100px"
                                                        ItemStyle-HorizontalAlign="Left" ItemStyle-CssClass="pad5"  />
