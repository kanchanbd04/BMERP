<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="prlvyear.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.prlvyear" %>
            ...
            <%--    $("body").on("change", "#<%=xclass.ClientID%>", function() {
               ...
               <%--     if ($("#<%=hxstatus.ClientID%>").val() == "")--%>
                ...
                function ConfirmMessage() {
                    var selectedvalue = confirm("Do you really want to approve this record?? After approve cann't change record.");
                    if (selectedvalue) {
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Leave Year</span>
                    </div>
                </div>
                    ...
                    <div class="bm_academic_container_body_button_section">
                        <div class="button_section_padding" style="border-bottom: 0px; padding-bottom: 0px">
                           ...
                           <%--     <input type="button" id="btnDetails" value="Details" class="bm_academic_button3 bm_am_btn_details" />--%>
                                ...
                                <asp:Button ID="btnConfirm" runat="server" Text="Approve" CssClass="bm_academic_button3 bm_am_btn_edit"
                        ...
                        <div class="bm_layout_container">
                            <div class="bm_layout_box_100">
                                ...
                                <div class="bm_layout_box_padding" style="padding-top: 0px;">
                                    ...
                                    <div style="width: 40%; clear: both; display: none; padding-top: 5px; vertical-align: top;">
                                        <div class="bm_ctl_container_50_50" style="width: 200px">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label9" runat="server" Text="Supplier Prefix :" AssociatedControlID="xtrnsup"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 78px">
                                                <asp:DropDownList ID="xtrnsup" runat="server" CssClass="bm_academic_dropdown_50_50 bm_academic_ctl_global bm_academic_dropdown bm_xclass">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                        <div class="bm_clt_padding">
                                        ...
                                        <div class="bm_ctl_container_50_50" style="width: 400px">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label12" runat="server" Text="Company :" AssociatedControlID="xorg"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 278px">
                                                <asp:TextBox ID="xorg" runat="server" CssClass="bm_academic_textbox_50_40 bm_academic_ctl_global bm_academic_textbox"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    <div style="width: 40%; clear: both; display: none; padding-top: 5px; vertical-align: top;">
                                        <div style="width: 100%">
                                            <div style="float: left;">
                                                <div class="bm_ctl_container_50_50" style="width: 270px">
                                                    <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                        <asp:Label ID="Label11" runat="server" Text="Supplier Number :" AssociatedControlID="xsup"
                                                            CssClass="label"></asp:Label>
                                                    </div>
                                                    <div class="bm_clt_ctl_50_50" style="width: 148px">

                                                        <asp:TextBox ID="xsup" runat="server" CssClass="bm_academic_textbox_50_40 bm_academic_ctl_global bm_academic_textbox"
                                                            AutoPostBack="True" OnTextChanged="FillControl2"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="bm_ctl_container_50_50" style="width: 400px">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label13" runat="server" Text="Proprietor Name :" AssociatedControlID="xfirst"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 278px">
                                                <asp:TextBox ID="xfirst" runat="server" CssClass="bm_academic_textbox_50_40 bm_academic_ctl_global bm_academic_textbox"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="bm_ctl_container_50_50" style="width: 885px; display: none;">
                                        <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                            <asp:Label ID="Label15" runat="server" Text="Address :" AssociatedControlID="xadd1"
                                                CssClass="label"></asp:Label>
                                        </div>
                                        <div class="bm_clt_ctl_50_50" style="width: 763px">
                                            <asp:TextBox ID="xadd1" runat="server" CssClass="bm_academic_textbox_50_40 bm_academic_ctl_global bm_academic_textbox"></asp:TextBox>
                                        </div>
                                    </div>
                                    ...
                                    <div class="bm_ctl_container_50_50" style="width: 885px; display: none;">
                                        <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                            <asp:Label ID="Label16" runat="server" Text="Bank A/C :" AssociatedControlID="xbankref"
                                                CssClass="label"></asp:Label>
                                        </div>
                                        <div class="bm_clt_ctl_50_50" style="width: 763px">
                                            <asp:TextBox ID="xbankref" runat="server" CssClass="bm_academic_textbox_50_40 bm_academic_ctl_global bm_academic_textbox"></asp:TextBox>
                                        </div>
                                    </div>
                                    ...
                                    <div style="width: 40%; clear: both; display: none; padding-top: 5px; vertical-align: top;">
                                        <div class="bm_ctl_container_50_50" style="width: 200px">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label17" runat="server" Text="Zip :" AssociatedControlID="xzip"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 78px">
                                                <asp:TextBox ID="xzip" runat="server" CssClass="bm_academic_textbox_50_40 bm_academic_ctl_global bm_academic_textbox"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="bm_clt_padding">
                                        </div>
                                        <div class="bm_ctl_container_50_50" style="width: 400px">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label19" runat="server" Text="Contact Person :" AssociatedControlID="xlast"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 278px">
                                                <asp:TextBox ID="xlast" runat="server" CssClass="bm_academic_textbox_50_40 bm_academic_ctl_global bm_academic_textbox"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="bm_clt_padding">
                                        </div>
                                        <div class="bm_ctl_container_50_50" style="width: 400px">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label23" runat="server" Text="Email :" AssociatedControlID="xemail1"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 278px">
                                        ...
                                        <div class="bm_ctl_container_50_50" style="width: 400px">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label24" runat="server" Text="Mobile No :" AssociatedControlID="xmobile"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 278px">
                                                <asp:TextBox ID="xmobile" runat="server" CssClass="bm_academic_textbox_50_40 bm_academic_ctl_global bm_academic_textbox"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="bm_clt_padding">
                                        </div>
                                        <div class="bm_ctl_container_50_50" style="width: 400px">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label26" runat="server" Text="URL :" AssociatedControlID="xurl"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 278px">
                                                <asp:TextBox ID="xurl" runat="server" CssClass="bm_academic_textbox_50_40 bm_academic_ctl_global bm_academic_textbox"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="bm_clt_padding">
                                        </div>
                                        <div class="bm_ctl_container_50_50" style="width: 270px">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label29" runat="server" Text="Supplier Group :" AssociatedControlID="xgsup"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 148px">

                                                <asp:DropDownList ID="xgsup" runat="server" CssClass="bm_academic_dropdown_50_50 bm_academic_ctl_global bm_academic_dropdown bm_xclass">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                        <div class="bm_clt_padding">
                                        ...
                                        <div style="width: 100%">
                                            <div class="bm_ctl_container_100_special" style="width: 120px; float: left;">
                                                <div class="bm_ctl_label_align_right_100_special" style="width: 100%">
                                                    <asp:Label ID="Label30" runat="server" Text="Supplier Status :"
                                                        CssClass="label"></asp:Label>
                                                </div>
                                            </div>
                                            <div style="float: left; padding-left: 5px">
                                                <asp:RadioButtonList ID="xstatussup" runat="server" RepeatDirection="Horizontal">
                                                    <asp:ListItem Text="1-Open" Value="1-Open" Selected="True"></asp:ListItem>
                                                    <asp:ListItem Text="2-Held" Value="2-Held"></asp:ListItem>
                                                </asp:RadioButtonList>
                                            </div>
                                        </div>
                                        ...
                                        <div class="bm_ctl_container_50_50" style="width: 270px">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label34" runat="server" Text="Credit Limit :" AssociatedControlID="xcrlimit"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 148px">
                                                <asp:TextBox ID="xcrlimit" runat="server" CssClass="bm_academic_textbox_50_40 bm_academic_ctl_global bm_academic_textbox"></asp:TextBox>
                                            </div>
                                        </div>
                                        ...
                                        <div class="bm_ctl_container_50_50" style="width: 400px">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label35" runat="server" Text="Entry By :" AssociatedControlID="zemail"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 278px">
                                    ...
                                    <div style="width: 40%; clear: both; display: none; padding-top: 5px; vertical-align: top;">
                                        <div class="bm_ctl_container_50_50" style="width: 270px">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label20" runat="server" Text="Country :" AssociatedControlID="xcountry"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 148px">

                                                <asp:DropDownList ID="xcountry" runat="server" CssClass="bm_academic_dropdown_50_50 bm_academic_ctl_global bm_academic_dropdown bm_xclass">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                        <div class="bm_clt_padding">
                                        ...
                                        <div class="bm_ctl_container_50_50" style="width: 400px">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label21" runat="server" Text="Designation :" AssociatedControlID="xdesig"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 278px">
                                                <asp:TextBox ID="xdesig" runat="server" CssClass="bm_academic_textbox_50_40 bm_academic_ctl_global bm_academic_textbox"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="bm_clt_padding">
                                        </div>
                                        <div class="bm_ctl_container_50_50" style="width: 400px">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label22" runat="server" Text="Phone :" AssociatedControlID="xphone"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 278px">
                                        ...
                                        <div class="bm_ctl_container_50_50" style="width: 400px">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label25" runat="server" Text="Fax :" AssociatedControlID="xfax"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 278px">
                                                <asp:TextBox ID="xfax" runat="server" CssClass="bm_academic_textbox_50_40 bm_academic_ctl_global bm_academic_textbox"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="bm_clt_padding">
                                        </div>
                                        <div style="width: 100%">
                                            <div class="bm_ctl_container_50_100" style="width: 270px; float: left">
                                                <div class="bm_ctl_label_align_right_50_100" style="width: 120px">
                                                    <asp:Label ID="Label27" runat="server" Text="Control Account :" AssociatedControlID="xaccap"
                                                        CssClass="label"></asp:Label>
                                                </div>
                                                <div class="bm_clt_ctl_50_100" style="width: 148px">
                                                    ...
                                                    <div class="bm_list_text" style="width: 120px">
                                                        <asp:TextBox ID="xaccap" runat="server" CssClass="bm_academic_textbox_50_100 bm_academic_ctl_global bm_academic_textbox "
                                                            OnTextChanged="xstdid_OnTextChanged" AutoPostBack="True"></asp:TextBox>
                                                    </div>
                                                    <div class="bm_list_img">
                                                        <asp:Image ID="Image2" runat="server" ImageUrl="~/images/list-am32x32.png" CssClass="bm_academic_list bm_accap" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div style="float: left; padding-left: 5px; padding-top: 1px">
                                                <asp:Label ID="xappapname" runat="server" Text="" CssClass="xstdname"></asp:Label>
                                            </div>
                                        </div>
                                        <div class="bm_clt_padding">
                                        </div>
                                        <div class="bm_ctl_container_50_50" style="width: 270px">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label28" runat="server" Text="Tax Scope :" AssociatedControlID="xtaxscope"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 148px">

                                                <asp:DropDownList ID="xtaxscope" runat="server" CssClass="bm_academic_dropdown_50_50 bm_academic_ctl_global bm_academic_dropdown bm_xclass">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                        <div class="bm_clt_padding">
                                        ...
                                        <div style="width: 100%">
                                            <div class="bm_ctl_container_100_special" style="width: 120px; float: left;">
                                                <div class="bm_ctl_label_align_right_100_special" style="width: 100%">
                                                    <asp:Label ID="Label32" runat="server" Text="Gl Entry Status :"
                                                        CssClass="label"></asp:Label>
                                                </div>
                                            </div>
                                            <div style="float: left; padding-left: 5px">
                                        ...
                                        <div class="bm_ctl_container_50_50" style="width: 270px">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label33" runat="server" Text="Credit Terms :" AssociatedControlID="xcrterms"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 148px">
                                                <asp:TextBox ID="xcrterms" runat="server" CssClass="bm_academic_textbox_50_40 bm_academic_ctl_global bm_academic_textbox"></asp:TextBox>
                                            </div>
                                        </div>
                                    ...
                                    <div style="display: inline-block; width: 500px; font-size: 14px; vertical-align: top; color: #0000ff;">
                                        <table>
                                            ...
                                            <tr>
                                                <td style="text-align: right">Employee Category</td>
                                                <td>:</td>
                                                <td>
                                                    <asp:DropDownList ID="xempcat" runat="server"></asp:DropDownList>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>:</td>
                                                <td>
                                                    <asp:TextBox ID="xyear" runat="server"></asp:TextBox>

                                                    <span>
                                                        <asp:ImageButton ID="ImageButton3" ImageUrl="~/images/search32x32.png" runat="server" OnClick="FillControl2"
                                                            CssClass="bm_academic_list" Width="20px" Height="20px" />
                                                    </span>
                                                </td>
                                            </tr>

                                            <tr>
                                                <td style="text-align: right">Effectivity Date</td>
                                                <td>:</td>
                                                <td>
                                                    <asp:TextBox ID="xdateeff" runat="server" CssClass=" bm_academic_datepicker"></asp:TextBox>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>:</td>
                                                <td>
                                                    <asp:TextBox ID="xdateexp" runat="server" CssClass=" bm_academic_datepicker"></asp:TextBox>
                                                </td>
                                            </tr>
                                            ...
                                            <%--<tr>
                                                ...
                                                <td>
                                                    <asp:TextBox ID="xnote" runat="server" TextMode="MultiLine"  Height="80" Width="300"></asp:TextBox></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>:</td>
                                                <td>
                                                    <asp:Label ID="xstatus" runat="server" Text=""></asp:Label>
                                            </tr>--%>
                                        </table>
                                    </div>
                                    ...
                                    <div class="button_section_style1" style="text-align: left; margin-top: 10px;">
                                       ...
                                       <%-- <input type="button" id="btnDetails1" value="Details" class="bm_academic_button3 bm_am_btn_details" />--%>
                                        ...
                                        <asp:Button ID="btnDelete1" runat="server" Text="Delete" CssClass="bm_academic_button3 bm_am_btn_delete"
                                            OnClientClick="javascript:ConfirmMessage1();" OnClick="btnDelete_Click" />
                                        <asp:Button ID="btnConfirm1" runat="server" Text="Approve" CssClass="bm_academic_button3 bm_am_btn_edit"
                                            OnClientClick="javascript:ConfirmMessage();" OnClick="btnConfirm_Click" />
                                        ...
                                        <div class="grid_body">
                                            <asp:GridView ID="dgvcollectionew" runat="server" AutoGenerateColumns="False" ShowFooter="False"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="xempcat" HeaderText="Employee Category"
                                                        ItemStyle-Width="250px" ItemStyle-HorizontalAlign="Center" />

                                                    <asp:TemplateField HeaderText="Year">
                                                        <ItemStyle Width="120px" HorizontalAlign="Center" />
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="xyear" runat="server" Text='<%#Eval("xyear") %>' CssClass="_gridrow_link"
                                                                OnClick="FillControl"></asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>

                                                    <asp:BoundField DataField="xdateeff" HeaderText="Effectivity Date" DataFormatString="{0:dd/MM/yyyy}"
                                                        ItemStyle-Width="120px" ItemStyle-HorizontalAlign="Center" />

                                                    <asp:BoundField DataField="xdateexp" HeaderText="Expiration Date" DataFormatString="{0:dd/MM/yyyy}"
                                                        ItemStyle-Width="120px" ItemStyle-HorizontalAlign="Center" />
...
<%-- <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                 <asp:Button ID="Button5" runat="server" Text="Button" CssClass="disnone" OnClick="Button5_OnClick"/>--%>
                <script>
                    //$("body").on("click", ".bm_am_btn_details", function () {
                          <%-- $('#<%= xsub.ClientID%>').val("");
                                    $('#<%= xdesc1.ClientID%>').val("");
                    ...
                    $("body").on("click", ".save21", function () {

                        $("#<%= message1.ClientID%>").empty();
                        //alert("hi");
                        var zid1 = <%= HttpContext.Current.Session["business"] %>;
                        var xempcat1 = $('#<%= xempcat.ClientID%>').val();
                        var xyear1 = $('#<%= xyear.ClientID%>').val();
                        var xleave1 = $('#<%= xleave.ClientID%>').val();
                        var xefffrom1 = 0;
                        var xcalcday1 = 0;
                        var xleavecfd1 = $('#<%= xleavecfd.ClientID%>').val();
                        var xleavecfy1 = $('#<%= xleavecfy.ClientID%>').val();
                        var xmaxleave1 = $('#<%= xmaxleave.ClientID%>').val();
                        var xminleave1 = $('#<%= xminleave.ClientID%>').val();
                        var xmaxencash1 = $('#<%= xmaxencash.ClientID%>').val();
                        var xminencash1 = $('#<%= xminencash.ClientID%>').val();
                        var xmaxoffers1 = 0;
                        var xminencash1 = $('#<%= xminencash.ClientID%>').val();
                        var xfstslabday1 = 0;
                        var xsndslabday1 = 0;
                        ...
                        if (xleave1 == "") {
                            <%-- $("#<%= message1.ClientID%>").val("<font style='color:f00;'>Select Leave Type.</font>");--%>
                ...
                <style>
                    .panel {
                        border: Solid 3px #619CFD;
                    }
                    .bm_academic_button30 {
                        width: 80px;
                        cursor: pointer;
                    }
                    .disnone {
                ...
                <asp:Panel ID="pnlpopup" runat="server" BackColor="White" Height="600px" Width="900px" CssClass="panel" ScrollBars="Vertical">
                    ...
                    <div style="padding-left: 10px; padding-top: 10px;">
                      <%--  <asp:Button ID="Button4" runat="server" Text="Save" CssClass="bm_academic_button3" />--%>
                        <input type="button" id="btnSave21" value="Save" class="bm_academic_button30 save21" >
                        <input type="button" id="btnDelete21" value="Delete" class="bm_academic_button30">
                        <input type="button" id="btnConfirm21" value="Confirm" class="bm_academic_button30">
                        <input type="button" id="btnCancel" value="Close" class="bm_academic_button30">
                    </div>
                    <div style="padding-left: 10px;vertical-align: top; color: #0000ff; font-size: 14px;">
                        <fieldset>
                           <%-- <legend></legend>--%>
                            
                            <div style="vertical-align: top; display: inline-block; width: 48%;">
                            <table width="100%" style="width: 100%; height: 100%; border-collapse: collapse;"
                                cellpadding="0" cellspacing="0">
                                <tr>
                                    <td align="left" style="padding: 5px;">
                                        <table style="border: none;">
                                            <tr>
                                                <td style="text-align: right;">Leave Type
                                                </td>
                                                <td>:
                                                </td>
                                                <td >
                                                    <asp:DropDownList ID="xleave" runat="server"></asp:DropDownList>
                                                </td>
                                            </tr>
                                            
                                             <tr>
                                                <td style="text-align: right;">Leave Carry Over Limit Day(s)
                                                </td>
                                                <td>:
                                                </td>
                                                <td >
                                                    <asp:TextBox ID="xleavecfd" runat="server" Text="0"></asp:TextBox>
                                                </td>
                                            </tr>
                                            
                                            <tr>
                                                <td style="text-align: right;">Day(s) on Leave at a stretch (Max)
                                                </td>
                                                <td>:
                                                </td>
                                                <td >
                                                    <asp:TextBox ID="xmaxleave" runat="server" Text="0"></asp:TextBox>
                                                </td>
                                            </tr>
                                            
                                             <tr>
                                                <td style="text-align: right;">Maximum Encashment%
                                                </td>
                                                <td>:
                                                </td>
                                                <td >
                                                    <asp:TextBox ID="xmaxencash" runat="server" Text="0.00"></asp:TextBox>
                                                </td>
                                            </tr>
                                            
                                            <tr>
                                                <td style="text-align: right;">Policy Status
                                                </td>
                                                <td>:
                                                </td>
                                                <td >
                            ...
                            <table width="100%" style="width: 100%; height: 100%; border-collapse: collapse;"
                                ...
                                <tr>
                                    <td align="left" style="padding: 5px;">
                                        <table style="border: none;">
                                            <tr>
                                                <td style="text-align: right;">Allocated Leave Day(s)
                                                </td>
                                                <td>:
                                                </td>
                                                <td >
                                                    <asp:TextBox ID="xleavealc" runat="server" Text="0"></asp:TextBox>
                                                </td>
                                            </tr>
                                            
                                            <tr>
                                                <td style="text-align: right;">Max Carry Over for No. of Year
                                                </td>
                                                <td>:
                                                </td>
                                                <td >
                                                    <asp:TextBox ID="xleavecfy" runat="server" Text="0"></asp:TextBox>
                                                </td>
                                            </tr>
                                            
                                             <tr>
                                                <td style="text-align: right;">Day(s) on Leave at a stretch (Min)
                                                </td>
                                                <td>:
                                                </td>
                                                <td >
                                                    <asp:TextBox ID="xminleave" runat="server" Text="0"></asp:TextBox>
                                                </td>
                                            </tr>
                                            
                                            <tr>
                                                <td style="text-align: right;">Minimum Encashment%
                                                </td>
                                                <td>:
                                                </td>
                                                <td >
                                                    <asp:TextBox ID="xminencash" runat="server" Text="0.00"></asp:TextBox>
                                                </td>
                                            </tr>
                    ...
                    <div style="padding-left: 10px">
                       <%-- <asp:Button ID="Button3" runat="server" Text="Save" CssClass="bm_academic_button3" />--%>
                        <input type="button" id="btnSave22" value="Save" class="bm_academic_button30 save21">
                        <input type="button" id="btnDelete22" value="Delete" class="bm_academic_button30">
                        <input type="button" id="btnConfirm22" value="Confirm" class="bm_academic_button30">

                        <input type="button" id="btnCancel1" value="Close" class="bm_academic_button30">
                    </div>
                    ...
                    <div style="padding-left: 10px; padding-top: 10px;">
                         ...
                         <div class="bm_academic_container_footer">
                                <div class="footer_list_padding">
                                    <div class="bm_academic_grid_container" id="Div3" runat="server">
                                        <div class="grid_header">
                                            <div class="grid_header_label" id="Div4" runat="server">
                                                Added Record(s)
                                            </div>
                                            <div class="grid_header_control">
                                            </div>
                                            <div class="flot_right">
                                                ...
                                                <div class="grid_header_row">
                                                    <asp:TextBox ID="_gridrow2" runat="server" AutoPostBack="True" CssClass="_gridrow"
                                                        OnTextChanged="fnFillGrid6"></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="grid_body">
                                            <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" ShowFooter="False"
                                                CssClass="bm_academic_grid" HeaderStyle-CssClass="HeaderStyle" FooterStyle-CssClass="FooterStyle"
                                                RowStyle-CssClass="RowStyle" AlternatingRowStyle-CssClass="AlternatingRowStyle"
                                                PagerStyle-CssClass="PagerStyle" GridLines="None">
                                                <Columns>
