<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="pratd.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.pratd" %>
    ...
    <script type="text/javascript">
       ...
       function fnShowReport() {
        ...
        <%--   var dateParts1 = $("#<%= tdate.ClientID%>").val().split("/");--%>
           ...
           var openwin = window.open('/forms/academic/reports/hrm/pratdrpt.aspx?zid=' + zid + '&femp=' + femp1 + '&temp=' + temp1 + '&fdep=' + fdep1.replace(/&/gi, "%26") + '&tdep=' + tdep1.replace(/&/gi, "%26") + '&floc=' + floc1 + '&tloc=' + tloc1 + '&fdate=' + fdate1, 'pratd', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, copyhistory=no, width=' + screen.width + ', height=' + screen.height + ', top=0, left=0, targets=_blank');
            openwin.focus();
            //openwin.print();
            return false;
        }
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Daily Attendance Sheet</span>
                    </div>
                </div>
