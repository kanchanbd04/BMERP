<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="prleave_u.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.prleave_u" %>
            ...
            <%--    $("body").on("change", "#<%=xclass.ClientID%>", function() {
               ...
               <%--     if ($("#<%=hxstatus.ClientID%>").val() == "")--%>
                ...
                function ConfirmMessage() {
                    var selectedvalue = confirm("Do you really want to approve this record?");
                    if (selectedvalue) {
                ...
                function ConfirmMessageCheck() {
                    var selectedvalue = confirm("Do you really want to check this record?");
                    if (selectedvalue) {
                        document.getElementById('<%=txtCheckValue.ClientID %>').value = "Yes";
                    } else {
                        document.getElementById('<%=txtCheckValue.ClientID %>').value = "No";
                    }
                }

                function ConfirmMessagePre() {
                    var selectedvalue = confirm("Do you really want to Pre approve this record?");
                    if (selectedvalue) {
                        document.getElementById('<%=txtPreValue.ClientID %>').value = "Yes";
                    } else {
                        document.getElementById('<%=txtPreValue.ClientID %>').value = "No";
                    }
                }

                function ConfirmMessageCancel() {
                    var selectedvalue = confirm("Do you really want to cancel this record?");
                    if (selectedvalue) {
                        document.getElementById('<%=txtCancelValue.ClientID %>').value = "Yes";
                    } else {
                        document.getElementById('<%=txtCancelValue.ClientID %>').value = "No";
                    }
                }
            ...
            $('#<%=GridView1.ClientID%>').gridviewScroll({
              ...
              <%--      var xsession =  $("#<%= xsession.ClientID%>").val();
                ...
                $("body").on("click", ".bm_xemp", function () {
                    ...
                    fnOpenEMPList1(<%= HttpContext.Current.Session["business"] %>,$(this).parent(".bm_span2").siblings(".bm_span1").find(".bm_text1").attr("ID"),$(this).parent(".bm_span2").siblings(".bm_span1").find(".bm_text1").val(),$("#<%= xname.ClientID%>").attr("ID"));
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round" id="header_lebel_val" runat="server">Unallocated and Outstation</span>
                    </div>
                </div>
                        ...
                        <div class="button_section_padding" style="border-bottom: 0px; padding-bottom: 0px">
                            <div class="button_section_style1" style="text-align: left; margin-bottom: 5px;">
                                ...
                                <asp:Button ID="btnDelete" runat="server" Text="Delete" CssClass="bm_academic_button3 bm_am_btn_delete"
                                 ...
                                 <asp:Button ID="btnCheck" runat="server" Text="Check" CssClass="bm_academic_button3 bm_am_btn_check"
                                    OnClientClick="javascript:ConfirmMessageCheck();" OnClick="btnCheck_Click" />
                                <asp:Button ID="btnPreApprove" runat="server" Text="Pre approve" CssClass="bm_academic_button3 bm_am_btn_preapprove"
                                    OnClientClick="javascript:ConfirmMessagePre();" OnClick="btnPreApprove_Click" />
                                 <asp:Button ID="btnCancel2" runat="server" Text="Cancel" CssClass="bm_academic_button3 bm_am_btn_cancel"
                                    OnClientClick="javascript:ConfirmMessageCancel();" OnClick="btnCancel_Click" />
...
<div style="width: 720px; display: inline-block; vertical-align: top;">
                                    ...
                                    <div style="display: inline-block; width: 350px; font-size: 14px; vertical-align: top; color: #0000ff;">
                                        <table>
                                            <tr>
                                                <td style="text-align: right">Employee Code</td>
                                                <td>:</td>
                                                <td>
                                                    <%--<asp:Label ID="xemp" runat="server"></asp:Label>--%>
                                                        <span class="bm_span1">
                                             ...
                                             <tr>
                                                ...
                                                <td>:</td>
                                                <td>
                                                    <asp:Label ID="xrow" runat="server"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>:</td>
                                                <td>
                                                    <asp:DropDownList ID="xleave" runat="server" AutoPostBack="True" OnSelectedIndexChanged="fnFillGrid6"></asp:DropDownList></td>
                                            </tr>
                                            <tr>
                                                <td style="text-align: right">Leave Start Date</td>
                                                <td>:</td>
                                                <td>
                                                    <asp:TextBox ID="xfdate" runat="server" CssClass=" bm_academic_datepicker"></asp:TextBox></td>
                                            </tr>
                                            
                                            <tr>
                                                <td style="text-align: right">From OutStation Time <br>(HH:MM:SS)</td>
                                                <td>:</td>
                                                <td>
                                                    <asp:TextBox ID="xintime" runat="server"  Text="00:00:00"></asp:TextBox></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>:</td>
                                                <td>
                                                    <asp:DropDownList ID="xstatleave" runat="server"></asp:DropDownList></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>:</td>
                                                <td>
                                                    <asp:Label ID="xpflag" runat="server" ></asp:Label></td>
                                            </tr>
                                    ...
                                    <div style="display: inline-block; width: 350px; font-size: 14px; vertical-align: top; color: #0000ff;">
                                        <table>
                                            <tr>
                                                ...
                                                <td>:</td>
                                                <td>
                                                    <asp:Label ID="xname" runat="server"></asp:Label>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>:</td>
                                                <td>
                                                    <asp:Label ID="xdate" runat="server"></asp:Label></td>
                                            </tr>

                                            <tr>
                                                <td style="text-align: right">Leave End Date</td>
                                                <td>:</td>
                                                <td>
                                                    <asp:TextBox ID="xtdate" runat="server" CssClass=" bm_academic_datepicker"></asp:TextBox></td>
                                            </tr>
                                            
                                            <tr>
                                                <td style="text-align: right">To OutStation Time <br>(HH:MM:SS)</td>
                                                <td>:</td>
                                                <td>
                                                    <asp:TextBox ID="xouttime" runat="server"  Text="00:00:00"></asp:TextBox></td>
                                            </tr>

                                            <tr>
                                                <td style="text-align: right">Leave for Day(s)</td>
                                                <td>:</td>
                                                <td>
                                                    <asp:TextBox ID="xleavetkn" runat="server" Text="0" ReadOnly="True"></asp:TextBox></td>
                                            </tr>
                                    ...
                                    <div style="display: inline-block; width: 700px; font-size: 14px; vertical-align: top; color: #0000ff;">
                                        ...
                                        <table>
                                            ...
                                            <tr>
                                                <td style="text-align: right; width: 110px">Reason</td>
                                                <td>:</td>
                                                <td>
                                                    <asp:TextBox ID="xlong" runat="server" Width="480" TextMode="MultiLine" Height="60"></asp:TextBox></td>
                                            </tr>

                                            <tr style="display: none;">
                                                <td style="text-align: right; width: 110px">Reason for Cancel</td>
                                                <td>:</td>
                                                <td>
                                                    <asp:TextBox ID="xnote" runat="server" Width="480" TextMode="MultiLine" Height="60"></asp:TextBox></td>
                                            </tr>
                                    ...
                                    <div style="display: inline-block; width: 350px; font-size: 14px; vertical-align: top; color: #0000ff;">
                                        <table>
                                            <tr>
                                                <td style="text-align: right; width: 110px;">Year</td>
                                                <td>:</td>
                                                <td>
                                                    <asp:Label ID="xyear" runat="server"></asp:Label></td>
                                            </tr>
                                            
                                            <tr>
                                                <td style="text-align: right; width: 110px;">Entry By</td>
                                                <td>:</td>
                                                <td>
                                                    <asp:Label ID="zemail" runat="server"></asp:Label></td>
                                            </tr>
                                    ...
                                    <div style="display: inline-block; width: 350px; font-size: 14px; vertical-align: top; color: #0000ff;">
                                        <table>
                                            <tr>
                                                <td style="text-align: right;width: 110px;">Period</td>
                                                <td>:</td>
                                                <td>
                                                    <asp:Label ID="xper" runat="server"></asp:Label></td>
                                            </tr>
                                            
                                            <tr>
                                                <td style="text-align: right;width: 110px;">Update By</td>
                                                <td>:</td>
                                                <td>
                                                    <asp:Label ID="xemail" runat="server"></asp:Label></td>
                                            </tr>
                                    ...
                                    <div style="width: 450px; display: none; height: 300px; border: 1px solid #a9a9a9;vertical-align: top; ">
                                        
                                        <div class="bm_academic_grid_container" style="height: 100%; padding: 2px;">
                                        <div class="grid_header" style="height: 10%;">
                                            <div class="grid_header_label" >
                                               Leave Status (Balance) of &nbsp; <asp:Label ID="xempid" runat="server" ></asp:Label>
                                            </div>
                                        ...
                                        <div class="grid_body" style="overflow-y: scroll; height: 90%; width: 100%;">
                                         <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" ShowFooter="true"
                                            ...
                                            <Columns>
                                                <asp:BoundField DataField="xyear" HeaderText="Year" ItemStyle-Width="80px"
                                                    ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="pad5" />
                                                <asp:BoundField DataField="xleave" HeaderText="Type" ItemStyle-Width="80px"
                                                    ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="pad5" />
                                                <asp:BoundField DataField="xmdbl" HeaderText="Opening" ItemStyle-Width="80px"
                                                    ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="pad5" />
                                                <asp:BoundField DataField="xmdlmt" HeaderText="Limit" ItemStyle-Width="80px"
                                                    ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="pad5" />
                                                 <asp:BoundField DataField="xmdavl" HeaderText="Availed" ItemStyle-Width="80px"
                                                    ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="pad5" />
                                                <asp:BoundField DataField="xbal" HeaderText="Balance" ItemStyle-Width="80px"
                                                    ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="pad5" />
                                            </Columns>
                                        </asp:GridView>
                                                </div>    
                                ...
                                <div class="button_section_padding">
                                    <div class="button_section_style1" style="text-align: left; margin-top: 10px;">
                                        ...
                                        <asp:Button ID="btnDelete1" runat="server" Text="Delete" CssClass="bm_academic_button3 bm_am_btn_delete"
                                            OnClientClick="javascript:ConfirmMessage1();" OnClick="btnDelete_Click" />
                                 <asp:Button ID="btnCheck1" runat="server" Text="Check" CssClass="bm_academic_button3 bm_am_btn_check"
                                    OnClientClick="javascript:ConfirmMessageCheck();" OnClick="btnCheck_Click" />
                                <asp:Button ID="btnPreApprove1" runat="server" Text="Pre approve" CssClass="bm_academic_button3 bm_am_btn_preapprove"
                                    OnClientClick="javascript:ConfirmMessagePre();" OnClick="btnPreApprove_Click" />
                                 <asp:Button ID="btnCancel1" runat="server" Text="Cancel" CssClass="bm_academic_button3 bm_am_btn_cancel"
                                    OnClientClick="javascript:ConfirmMessageCancel();" OnClick="btnCancel_Click" />
                            ...
                            <div class="bm_academic_container_footer">
                                <div class="footer_list_padding">
                                    <div class="bm_academic_grid_container" id="list" runat="server">
                                        ...
                                        <div class="grid_body">
                                            <asp:GridView ID="dgvlistapp" runat="server" AutoGenerateColumns="False" ShowFooter="False"
                                                CssClass="bm_academic_grid" HeaderStyle-CssClass="HeaderStyle" FooterStyle-CssClass="FooterStyle"
                                                RowStyle-CssClass="RowStyle" AlternatingRowStyle-CssClass="AlternatingRowStyle"
                                                PagerStyle-CssClass="PagerStyle" GridLines="None">
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="xrow" HeaderText="Row" ItemStyle-Width="100px"
                                                     ...
                                                     <asp:BoundField DataField="xleave" HeaderText="Leave Type" ItemStyle-Width="150px"
                                                        ItemStyle-HorizontalAlign="Left" ItemStyle-CssClass="pad5"  />
                                                    ...
                                                    <asp:BoundField DataField="xleavetkn" HeaderText="Leave for Day(s)" ItemStyle-Width="120px"
                                                        ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="pad5" HtmlEncode="False" />

                                                    <asp:BoundField DataField="xpflag" HeaderText="Process Flag" ItemStyle-Width="120px"
                                                        ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="pad5" />
                                                    
                                                    <asp:BoundField DataField="zemail" HeaderText="Entry By" ItemStyle-Width="150px"
                                                        ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="pad5" />

                                                     <asp:BoundField DataField="xemail" HeaderText="Update By" ItemStyle-Width="150px"
                                                        ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="pad5" />
                                    ...
                                    <div class="bm_academic_grid_container" id="Div1" runat="server">
                                        <div class="grid_header">
                                            <div class="grid_header_label" id="Div2" runat="server">
                                                Break Up of &nbsp; <asp:Label ID="xempcode1" runat="server" Text="Label"></asp:Label>
                                        ...
                                        <div class="grid_body">
                                            <asp:GridView ID="dgvbreakup" runat="server" AutoGenerateColumns="False" ShowFooter="False"
                                                CssClass="bm_academic_grid" HeaderStyle-CssClass="HeaderStyle" FooterStyle-CssClass="FooterStyle"
                                                RowStyle-CssClass="RowStyle" AlternatingRowStyle-CssClass="AlternatingRowStyle"
                                                PagerStyle-CssClass="PagerStyle" GridLines="None">
                                                 <Columns>
                                    ...
                                    <div class="bm_academic_grid_container" id="Div3" runat="server">
                                        <div class="grid_header">
                                            <div class="grid_header_label" id="Div4" runat="server">
                                                <%--Detail Break Up of : &nbsp; <asp:Label ID="xempcode2" runat="server" Text="Label"></asp:Label>--%>
                                                Approved List(s)
                                            </div>
                                            <div class="grid_header_control">
                                            </div>
             ...
             <asp:Panel ID="pnlpopup" runat="server" BackColor="White" Height="530px" Width="800px"
                    ...
                    <table width="100%" style="border: Solid 3px #619CFD; width: 100%; height: 100%; border-collapse: collapse;"
                        ...
                        <tr style="background-color: #619CFD; height: 30px; text-align: right;">
                            <td>
                                <asp:ImageButton ID="btnCancel1111" runat="server" ImageUrl="~/images/close-window.png"
                ...
                <asp:HiddenField ID="txtCheckValue" runat="server" />
                <asp:HiddenField ID="txtPreValue" runat="server" />
                <asp:HiddenField ID="txtCancelValue" runat="server" />
