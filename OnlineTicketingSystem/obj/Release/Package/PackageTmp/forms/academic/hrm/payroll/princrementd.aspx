<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="princrementd.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.princrementd" %>
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Increment History of Employee: &nbsp;<span id="spanxemp" runat="server"> </span>- &nbsp; <span id="spanxname" runat="server"></span>
                    </div>
                </div>
                                                ...
                                                <td>
                                                    ...
                                                    <span class="bm_span3">
                                                        <asp:Label ID="tmpdesc" runat="server" Text="" CssClass="bm_label1"></asp:Label>
                                                             ...
                                                             <tr>
                                                                <td style="text-align: right;">Code Type
                                                                </td>
                                                                <td>:
                                                                </td>
                                                                <td>
                                                                    <asp:DropDownList ID="xtypedum" runat="server"></asp:DropDownList>
                                                                </td>
                                                            </tr>

                                                            <tr>
                                                                <td style="text-align: right;">Increment Amount
                                                                </td>
                                                                <td>:
                                                                </td>
                                                                <td>
                                                            ...
                                                            <tr>
                                                                <td style="text-align: right;">Created By
                                                                </td>
                                                                <td>:
                                                                </td>
                                                                <td>
                                                            ...
                                                            <tr>
                                                                <td style="text-align: right;">Update By
                                                                </td>
                                                                <td>:
                                                                </td>
                                                                <td>
