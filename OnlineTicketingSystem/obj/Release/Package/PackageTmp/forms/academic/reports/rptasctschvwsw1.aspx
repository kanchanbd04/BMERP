<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rptasctschvwsw1.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.reports.rptasctschvwsw1" %>
    ...
    <div class="bm_academic_container" style="padding: 10px;">
        <div class="bm_academic_container_header">
          ...
          <div style="font-weight: bold; font-size: 1.2em;"> <asp:Label ID="xorg" runat="server" Text="Presidency International School"></asp:Label> </div>
           <div><asp:Label ID="Label6" runat="server" Text="Class Test Schedule (Period wise)"></asp:Label></div>
            <hr/>
            <div>
                <table>
            ...
            <tr><td>Month</td><td> :</td><td> <asp:Label ID="hxmonth" runat="server" Text="Month"></asp:Label></td></tr>
            <tr><td>Status</td><td> :</td><td> <asp:Label ID="hxstatus" runat="server" Text="Status"></asp:Label></td></tr>
            </table>
            </div>
        </div>
                ...
                <div class="bm_academic_grid_container" id="list" runat="server">
                    ...
                    <div class="grid_body1">
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" ShowFooter="true"
                                    ...
                                    GridLines="None" OnDataBound="GridView1_DataBound1" OnRowDataBound="OnRowDataBound" OnRowCreated="GridView1_RowCreated"
