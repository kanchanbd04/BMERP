<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="amtfcdiscatwise.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.amtfcdiscatwise" %>
    ...
    <script type="text/javascript">
        ...
        function fnShowReport() {
          ...
          <%--  var xbank1 = $("#<%= xbank.ClientID%>").val();--%>
            ...
            var openwin = window.open('/forms/academic/reports/amtfcdiscatwiserpt.aspx?zid=' + zid + '&xclass=' + xclass1 + '&xstdid=' + xstdid1  + '&xsession=' + xsession1 + '&xdistype=' + xdistype1 + '&xpaytype=' + xpaytype1 + '&xrtype=' + xrtype1 + '&xtype2=' + xtype2 + '&xper1=' + xper1, 'amtfcdiscatwiserpt', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, copyhistory=no, width=' + screen.width + ', height=' + screen.height + ', top=0, left=0, targets=_blank');
            openwin.focus();
            //openwin.print();
            return false;
        }
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Summery Discount Report</span>
                    </div>
                </div>
                            ...
                            <div class="bm_layout_box_100">
                                ...
                                <div class="bm_layout_box_padding" style="padding-top: 10px; min-height: 300px;">
                                    ...
                                    <div style="width: 100%; clear: both;">
                                        ...
                                        <div class="bm_ctl_container_50_50" style="float: left; width: 270px;">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label1" runat="server" Text="Period :" AssociatedControlID="xperiod"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 148px">
                                                <asp:DropDownList ID="xperiod" runat="server" CssClass="bm_academic_dropdown_50_50 bm_academic_ctl_global bm_academic_dropdown bm_xclass">
                                                </asp:DropDownList>
                                        ...
                                        <div class="bm_ctl_container_50_50" style="float: left; width: 270px; ">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label17" runat="server" Text="Discount Type :" AssociatedControlID="xdistype"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 148px">
                                                <asp:DropDownList ID="xdistype" runat="server" CssClass="bm_academic_dropdown_50_50 bm_academic_ctl_global bm_academic_dropdown bm_xclass">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                       ...
                                       <%-- <div class="bm_clt_padding">
                                        ...
                                        <div class="bm_ctl_container_100_special" style="width: 270px; display: none;">
                                            <div class="bm_ctl_label_align_right_100_special" style="width: 120px">
                                                <asp:Label ID="Label1" runat="server" Text="To Period :" AssociatedControlID="xperiod"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_100_special" style="width: 148px">
                                                <asp:DropDownList ID="xperiod" runat="server" CssClass="bm_academic_dropdown_100_special bm_academic_ctl_global bm_academic_dropdown"
                                                    > 
                                                </asp:DropDownList>
                                            </div>
                                        </div>
