<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="ambalancest.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.ambalancest" %>
...
.GridViewScrollFooterFreeze TD {
    ...
    <%--   var rb = document.getElementById("<%=RadioButtonList1.ClientID%>");
            ...
            var openwin = window.open('/forms/academic/reports/ambalancestrpt.aspx?zid=' + zid + '&xtfccode=' + xtfccode1 + '&xclass=' + xclass1 + '&xschool=' + xschool1 + '&xfdate=' + xfdate1 + '&xtdate=' + xtdate1 + '&xsize=' + xsize1 + '&xorientation=' + xorientation1 + '&xtype2=' + xtype2 + '&xsession=' + xsession1 + '&xstdid=' + xstdid1 + '&xpaytype=' + xpaytype1 + '&xsection=' + xsection1 + '&xrtype=' + xrtype1, 'ambalancest', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, copyhistory=no, width=' + screen.width + ', height=' + screen.height + ', top=0, left=0, targets=_blank');
             openwin.focus();
             //openwin.print();
             return false;
         }
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Statement of Balance</span>
                    </div>
                </div>
