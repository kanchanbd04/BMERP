<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="amtfc1_copy.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.amtfc1_copy" %>
          ...
          //gridviewScroll();
                                ...
                                <div class="bm_hotkey" style="clear: both; padding-left: 10px; padding-bottom: 5px">
                                    <table style="border: 1px solid white">
                                        <tr style="border: 1px solid white">
                                            ...
                                            <td style="background-color: silver; color: green; margin: 1px">Save - Alt + S</td>
                                            <td style="background-color: silver; color: red; margin: 1px">Delete - Alt + D</td>
                                            <td style="background-color: silver; color: blue; margin: 1px">Paid - Alt + P</td>
                                            <td style="background-color: silver; color: chocolate; margin: 1px">Print - Alt + Shift + P</td>
                                            <td style="background-color: silver; color: black; margin: 1px">Refresh - Alt + R</td>
                                            ...
                                            <div style="float: left;">
                                                <div class="bm_ctl_container_50_50" style="float: left; width: 270px">
                                                    ...
                                                    <div class="bm_clt_ctl_50_50" style="width: 148px">
                                                        ...
                                                        <asp:TextBox ID="xrow1" runat="server" CssClass="bm_academic_textbox_50_40 bm_academic_ctl_global bm_academic_textbox"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
            ...
            <cc1:ModalPopupExtender ID="ModalPopupExtender1" runat="server" TargetControlID="btnShowList"
                ...
                <div style="display: none">
                    <asp:Button ID="Button1" runat="server" Text="Button1" CssClass="bm_academic_button3  " OnClick="combo_OnTextChanged" />
