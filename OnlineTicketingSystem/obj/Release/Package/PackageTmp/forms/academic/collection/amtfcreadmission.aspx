<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/academic_site.Master"
    CodeBehind="amtfcreadmission.aspx.cs" Inherits="OnlineTicketingSystem.forms.BMERP.amtfcreadmission"
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    <script type="text/javascript">
        ...
        function fnTFCAdmission(link) {
            ...
            var xrow = grid.rows[rowIndex + 1].cells[grid.rows[rowIndex + 1].cells.length - 3].children[0].innerText;
            //alert(xrow);
            var openwin = window.open("/forms/academic/collection/amtfcreadmission1.aspx?subnav=" + searchParams.get('subnav') + "&link=" + searchParams.get('link') + "&xrow=" + xrow, 'tfcadmission', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, copyhistory=no, width=1235, height=650, top=' + top + ', left=' + left + ', targets=_blank');
            openwin.focus();
                 return false;
        }
    </script>
                    ...
                    <div class="grid_body">
                        <asp:GridView ID="_grid_emp" runat="server" AutoGenerateColumns="False" ShowFooter="true"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Student's ID">
                                    <ItemStyle Width="100px" HorizontalAlign="Center" />
                                    <ItemTemplate>
                                        <asp:LinkButton ID="xstdid" runat="server" Text='<%#Eval("xstdid") %>' CssClass="_gridrow_link"
