<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="amtfcdue3.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.amtfcdue3" %>
                ...
                $("body").on("blur", "[id*=xstdid]", function() {
                  ...
                  <%--  var xclass1 = $("#<%=xclass.ClientID%>").val();
                   ...
                   <%-- var xeffdate1 = $("#<%=xcdate.ClientID%>").val();
                    ...
                    //var xstdid1 = '3036';
                    //alert(zid1);
                    var xcdate1 = $("#<%=xcdate.ClientID%>").val();
                    var xtfccode1 = $("#<%=xtfccode.ClientID%>").val();

                    $.ajax({
                        type: "POST",
                        url: "/edusoft.asmx/StudentInformationAccounts1",
                        data: "{ zid: '" + zid1 + "', xsession:'" + xsession1 + "', xstdid: '" + xstdid1 + "', xcdate:'"+ xcdate1 +"', xtfccode:'"+ xtfccode1 +"' }",
                        dataType: "json",
                        contentType: "application/json; charset=utf-8",
                        success: function (data) {
                            //alert(data.d);
                     ...
                     <%--    //$("#<%=xname.ClientID%>").val(student.xname);
                            ...
                            if (stdinfo.xstdid != "") {
                                row.cells[2].getElementsByTagName("input")[0].value = stdinfo.xname;
                                row.cells[3].getElementsByTagName("input")[0].value = stdinfo.xclass;
                                row.cells[1].getElementsByTagName("input")[0].value = stdinfo.xstdid;
                                //row.cells[4].getElementsByTagName("input")[0].value = stdinfo.xamount;
                            } else {
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Generate Dues Studentwise</span>
                    </div>
                </div>
                                                ...
                                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" ShowFooter="True"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Student ID">
                                                            ...
                                                            <ItemTemplate>
                                                                <div class="bm_clt_ctl_50_100" style="width: 148px">
                                                                    <div class="bm_list_text" style="width: 146px">
                                                                        <%--width: 120px--%>
                                                                   ...
                                                                   <%-- <div class="bm_list_img" style="display: none;">
                                                                        <asp:Image ID="Image4" runat="server" ImageUrl="~/images/list-am32x32.png" CssClass="bm_academic_list bm_student" Height="22px" />
                                                                    </div>--%>
                                                                </div>
                                                            </ItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="Amount">
                                                            ...
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:TextBox ID="xamtdue" runat="server" CssClass="bm_academic_textbox_50_100 bm_academic_ctl_global bm_academic_textbox right xamtdue"></asp:TextBox>
                                                         ...
                                                         <asp:TemplateField HeaderText="Discount Amount">
                                                            ...
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:TextBox ID="xdisfixed" runat="server" CssClass="bm_academic_textbox_50_100 bm_academic_ctl_global bm_academic_textbox right xamtdue"></asp:TextBox>
