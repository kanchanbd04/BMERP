<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="amtfcadvancedrcv.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.amtfcadvancedrcv" %>
...
.GridViewScrollFooterFreeze TD {
    ...
    <script type="text/javascript">
        ...
        function fnShowReport() {
          ...
          var zid = <%= HttpContext.Current.Session["business"] %>;
            ...
            var xmonth1 = $("#<%= xmonth.ClientID%>").val();
    ...
    <%--   var rb = document.getElementById("<%=RadioButtonList1.ClientID%>");
            ...
            var openwin = window.open('/forms/academic/reports/amtfcadvancedrcvrpt.aspx?zid=' + zid + '&xtfccode=' + xtfccode1 + '&xclass=' + xclass1 + '&xschool=' + xschool1 + '&xfdate=' + xfdate1 + '&xtdate=' + xtdate1 + '&xsize=' + xsize1 + '&xorientation=' + xorientation1 + '&xtype2=' + xtype2 + '&xsession=' + xsession1 + '&xstdid=' + xstdid1 + '&xpaytype=' + xpaytype1 + '&xsection=' + xsection1, 'ambalancest', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, copyhistory=no, width=' + screen.width + ', height=' + screen.height + ', top=0, left=0, targets=_blank');
             openwin.focus();
             //openwin.print();
             return false;
         }
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Advanced Received</span>
                    </div>
                </div>
                                ...
                                <div class="bm_layout_box_padding" style="padding-top: 10px; min-height: 300px;">
                                    ...
                                    <div style="width: 100%; clear: both;">
                                       ...
                                       <div class="bm_clt_padding">
                                        ...
                                        <div class="bm_ctl_container_100_special" style="width: 270px;">
                                            <div class="bm_ctl_label_align_right_100_special" style="width: 120px">
                                                <asp:Label ID="Label12" runat="server" Text="Month :" AssociatedControlID="xmonth"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_100_special" style="width: 148px">
                                                <asp:DropDownList ID="xmonth" runat="server" CssClass="bm_academic_dropdown_100_special bm_academic_ctl_global bm_academic_dropdown"
                                                    > 
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                        ...
                                        <div class="bm_ctl_container_100_special" style="width: 270px;">
                                            <div class="bm_ctl_label_align_right_100_special" style="width: 120px">
                                                <asp:Label ID="Label13" runat="server" Text="Year :" AssociatedControlID="xyear"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_100_special" style="width: 148px">
                                               <asp:TextBox ID="xyear" runat="server" CssClass="bm_academic_textbox_50_100 bm_academic_ctl_global bm_academic_textbox "></asp:TextBox>
                                            </div>
                                        </div>
                                        ...
                                        </div></div> <div style="display: inline-block; vertical-align: top;">**Only for studentwise </div>
                                            </div>
