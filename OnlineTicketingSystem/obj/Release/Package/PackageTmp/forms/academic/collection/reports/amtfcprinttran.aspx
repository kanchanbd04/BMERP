<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="amtfcprinttran.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.amtfcprinttran" %>
        ...
        function fnShowReport() {
          ...
          <%-- // var xclass1 = $("#<%= xclass.ClientID%>").val();--%>
           ...
           <%-- var dateParts1 = $("#<%= xtdate.ClientID%>").val().split("/");--%>
            ...
            var xrow1 = $("#<%= xrow.ClientID%>").val();
            <%--//var xterm1 = $("#<%= xterm.ClientID%>").val();--%>
          <%--  var xbank1 = $("#<%= xbank.ClientID%>").val();--%>
           

            var openwin = window.open('/forms/academic/reports/rptamtf3.aspx?zid=' + zid  + '&xrow=' + xrow1, 'printreceipt', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, copyhistory=no, width=' + screen.width + ', height=' + screen.height + ', top=0, left=0, targets=_blank');
            openwin.focus();
            //openwin.print();
            return false;
        }
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Print Receipt</span>
                    </div>
                </div>
                                    ...
                                    <div style="width: 100%; clear: both;">
                                         ...
                                         <div class="bm_ctl_container_50_100" style="width: 270px; float: left">
                                                <div class="bm_ctl_label_align_right_50_100" style="width: 120px">
                                                    <asp:Label ID="Label1" runat="server" Text="Transaction No :" AssociatedControlID="xrow"
                                                        CssClass="label"></asp:Label>
                                                </div>
                                                <div class="bm_clt_ctl_50_100" style="width: 148px">
                                                    <asp:TextBox ID="xrow" runat="server" CssClass="bm_academic_textbox_50_100 bm_academic_ctl_global bm_academic_textbox"></asp:TextBox>
