<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/academic_site.Master"
    CodeBehind="teacherdegree.aspx.cs" Inherits="OnlineTicketingSystem.forms.BMERP.teacherdegree"
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
  ...
  border-collapse: collapse;*/
        ...
        ._grid_header_searchbox  {

           
}

._grid_header_searchbox  ._searchbox{
    border: 3px solid #FFFFFF;
    padding-bottom: 2px;
    font-family: Myriad Pro,tahoma;
    background: url('/images/search32x32.png') no-repeat right #FFFFFF;
    background-size: contain;
    padding-right: 25px;
}

 ._grid_header_searchbox  ._searchbox1{
    border: 3px solid #FFFFFF;
    padding-bottom: 2px;
    font-family: Myriad Pro,tahoma;
    background: url('/images/search32x32.png') no-repeat right #FFFFFF;
...
._grid_header_searchbox ._searchbox:focus {
    background-color: #f7dc6f;
}

._grid_header_searchbox ._searchbox1:focus {
    background-color: #f7dc6f;
}
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Subject & Degree</span>
                    </div>
                </div>
                        ...
                        <div class="bm_academic_grid_container" id="list" runat="server">
                            <div class="grid_header">
                                ...
                                <div class="grid_header_control" style="margin-left: 15px; margin-top: 5px;">
                                    ...
                                    <div class="bm_ctl_container_100_special" style="float: left; width: 200px">
                                        <div class="bm_ctl_label_align_right_100_special" style="width: 75px">
                                            <asp:Label ID="Label2" runat="server" Text="Degree :" AssociatedControlID="xdegree"
                                                CssClass="label"></asp:Label>
                                        </div>
                                        <div class="bm_clt_ctl_100_special" style="width: 123px">
                                            <asp:DropDownList ID="xdegree" runat="server" CssClass="bm_academic_dropdown_100_special bm_academic_ctl_global bm_academic_dropdown">
                                            </asp:DropDownList>
                                        </div>
                                    </div>
                                    <div class="bm_ctl_container_100_special" style="float: left; width: 400px;">
                                        <div class="bm_ctl_label_align_right_100_special" style="width: 85px">
                                            <asp:Label ID="Label1" runat="server" Text="Subject :" AssociatedControlID="xsubject"
                                                CssClass="label"></asp:Label>
                                        </div>
                                        <div class="bm_clt_ctl_100_special" style="width: 313px">
                                    ...
                                    <div style="float: left;">
                                        <div class="_grid_header_searchbox" >
                                            <asp:TextBox ID="_searchbox" runat="server" AutoPostBack="True" CssClass="_searchbox1"
                                                Width="200px" OnTextChanged="fnFillDataGrid"></asp:TextBox>
                                        </div>
                                   </div>
                            ...
                            <div class="grid_body" style="margin-top: 5px">
                                <div id="grid" style="width: 100%; margin-left: 0px;" runat="server">
