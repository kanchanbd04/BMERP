<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="oldstudent.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.admission.oldstudent" %>
    ...
    <div class="bm_academic_container">
        <div class="bm_academic_container_header">
            <div class="header_label1" id="header_label" runat="server">
                <span class="bm_am_header_round">Update Student's Information </span>
            </div>
        </div>
                                ...
                                <div class="bm_layout_box_50">
                                    <div class="bm_layout_box_padding">
                                        ...
                                        <div class="bm_ctl_container_50_50">
                                            ...
                                            <div class="bm_clt_ctl_50_50">
                                                <%-- <asp:TextBox ID="xsession_admis" runat="server" CssClass="bm_academic_textbox_50_50 bm_academic_ctl_global bm_academic_textbox"
                                                    Enabled="False"></asp:TextBox>--%>
                                                <asp:DropDownList ID="xsession_admis" runat="server" CssClass="bm_academic_dropdown_50_60 bm_academic_ctl_global bm_academic_dropdown">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                        ...
                                        <div style="width: 100%;">
                                                ...
                                                <div class="bm_ctl_container_50_50" style="float: left; ">
                                                    ...
                                                    <div class="bm_clt_ctl_50_50">
                                                        <asp:TextBox ID="xstdid" runat="server" CssClass="bm_academic_textbox_50_50 bm_academic_ctl_global bm_academic_textbox"
                                                            AutoPostBack="True" OnTextChanged="FillControls3"></asp:TextBox>
                                                        <%--will be read only--%>
                                                    </div>
                                            ...
                                            <div style="float: left; padding-left: 3px;">
                                                <asp:ImageButton ID="ImageButton13" ImageUrl="~/images/search32x32.png" runat="server"
                                                    CssClass="bm_academic_list" OnClick="FillControls3" Width="25px" Height="25px" />
                                            </div>
                                        </div>
                                        <div class="bm_clt_padding" style="padding-bottom: 1px">
                                        </div>
                                        ...
                                        <div class="bm_ctl_container_50_100">
                                            ...
                                            <div class="bm_clt_ctl_50_100">
                                                <div class="bm_list_text">
                                                    <asp:TextBox ID="xprofession_admis" runat="server" CssClass="bm_academic_textbox_50_100 bm_academic_ctl_global bm_academic_textbox "></asp:TextBox>
                                                </div>
                                                <div class="bm_list_img">
                                        ...
                                        <div class="bm_ctl_container_50_100">
                                            ...
                                            <div class="bm_clt_ctl_50_100">
                                                <div class="bm_list_text">
                                                    <asp:TextBox ID="xprofession1_admis" runat="server" CssClass="bm_academic_textbox_50_100 bm_academic_ctl_global bm_academic_textbox "></asp:TextBox>
                                                </div>
                                                <div class="bm_list_img">
                                                    <asp:Image ID="Image6" runat="server" ImageUrl="~/images/list-am32x32.png" CssClass="bm_academic_list bm_profession" />
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="bm_layout_box_50">
                                    <div class="bm_layout_box_padding">
                                        ...
                                        <div class="bm_ctl_container_50_60">
                                            ...
                                            <div class="bm_clt_ctl_50_60">
                                                <asp:TextBox ID="xclass_admis" runat="server" CssClass="bm_academic_textbox_50_60 bm_academic_ctl_global bm_academic_textbox"
                                                    Enabled="False"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="bm_clt_padding">
                                        ...
                                        <div class="bm_ctl_container_50_60">
                                            ...
                                            <div class="bm_clt_ctl_50_60">
                                                ...
                                                <asp:TextBox ID="xgroup_admis" runat="server" CssClass="bm_academic_textbox_50_50 bm_academic_ctl_global bm_academic_textbox"
                                                    Enabled="False"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="bm_clt_padding">
                                        ...
                                        <div class="bm_ctl_container_50_60">
                                            ...
                                            <div class="bm_clt_ctl_50_60">
                                                ...
                                                <%-- <asp:TextBox ID="xsection" runat="server" CssClass="bm_academic_textbox_50_50 bm_academic_ctl_global bm_academic_textbox"
                                                    Enabled="False"></asp:TextBox>--%>
                                            </div>
                                        </div>
                                         <div class="bm_clt_padding">
                                        ...
                                        <div class="bm_ctl_container_50_60" style="display: none">
                                            <div class="bm_ctl_label_align_right_50_60">
                                        ...
                                        <div class="bm_ctl_container_50_60">
                                            ...
                                            <div class="bm_clt_ctl_50_60">
                                                <asp:TextBox ID="xdob_admis" runat="server" CssClass="bm_academic_textbox_50_60 bm_academic_ctl_global bm_academic_datepicker"
                                                    ></asp:TextBox>
                                            </div>
                                        </div>
                                        <%-- <div class="bm_clt_padding">
                                        ...
                                        <div class="bm_ctl_container_50_60">
                                            ...
                                            <div class="bm_clt_ctl_50_60">
                                               <%-- <asp:TextBox ID="xreligion_admis" runat="server" CssClass="bm_academic_textbox_50_60 bm_academic_ctl_global bm_academic_textbox"
                                                    Enabled="False"></asp:TextBox>--%>
                                                <asp:DropDownList ID="xreligion_admis" runat="server" CssClass="bm_academic_dropdown_50_60 bm_academic_ctl_global bm_academic_dropdown">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                        <div class="bm_clt_padding">
                                        ...
                                        <div class="bm_ctl_container_50_60">
                                            ...
                                            <div class="bm_clt_ctl_50_60">
                                                <asp:DropDownList ID="xgender_admis" runat="server" CssClass="bm_academic_dropdown_50_60 bm_academic_ctl_global bm_academic_dropdown">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                        ...
                                        <div style="float: left; margin-right: 0px; margin-left: 0px">
                                            <div>
                                                <table style="border: none;">
                                                    <tr>
                                                        <td colspan="2" style="text-align: center; border: 1px solid #00ced1">Student Image
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="width: 100px">
                            ...
                            <div class="grid_header">
                                ...
                                <div class="grid_header_control">
                                    <div class="grid_ctl_padding" style="margin-left: 80px">
                                        ...
                                        <div class="bm_ctl_container_100_s_grid">
                                            <div class="bm_ctl_label_align_right_100_s_grid" style="width: 40%">
                                                <asp:Label ID="Label73" runat="server" Text="Section :" AssociatedControlID="grid_xsection"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_100_s_grid" style="width: 60%">
                                                <asp:DropDownList ID="grid_xsection" AutoPostBack="True" runat="server" CssClass="bm_academic_dropdown_100_s_grid bm_academic_ctl_global bm_academic_dropdown"
                                                    OnTextChanged="fnFillDataGrid">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                ...
                                <asp:GridView ID="_grid_admis_stdinfo" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="xstdid" HeaderText="Student ID" ItemStyle-Width="200px"
                                            ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="pad5" />
                                        <asp:BoundField DataField="xname" HeaderText="Student's Name" ItemStyle-Width="300px"
                                            ItemStyle-CssClass="pad5" />
                                        <asp:BoundField DataField="xmname" HeaderText="Mother's Name" ItemStyle-Width="300px"
                                            ItemStyle-CssClass="pad5" />
                                        <asp:BoundField DataField="xfname" HeaderText="Father's Name" ItemStyle-Width="300px"
                                            ItemStyle-CssClass="pad5" />
                                        <asp:BoundField DataField="xcontact" HeaderText="Contact No." ItemStyle-Width="350px"
                                            ItemStyle-HorizontalAlign="Left" ItemStyle-CssClass="pad5" />
                                        
                                        <asp:BoundField DataField="xgender" HeaderText="Gender" ItemStyle-Width="100px"
                                            ItemStyle-HorizontalAlign="Left" ItemStyle-CssClass="pad5" />
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                <%--<asp:CheckBox ID="status" runat="server" Enabled="false" Checked='<%# (Eval("zactive").ToString() == "1" ? true : false) %>' />--%>
