<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="hrmststaff.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.admission.hrmststaff" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('.bm_teacher').click(function () {
                //alert("Hi");
                fnOpenEMPList2(<%= HttpContext.Current.Session["business"] %>,$(this).parent(".bm_list_img").siblings(".bm_list_text").find(".bm_academic_textbox").attr("ID"),'staff',$(this).parent(".bm_list_img").siblings(".bm_list_text").find(".bm_academic_textbox").val());
             });
        });
    </script>
</asp:Content>
    ...
    <div class="bm_academic_container">
        <div class="bm_academic_container_header">
            <div class="header_label1" id="header_label" runat="server">
                <span class="bm_am_header_round">Employee Info</span>
            </div>
        </div>
        ...
        <div style="width: 100%; margin-top: 5px; margin-bottom: 5px; border: 1px solid #1e90ff;
            ...
            <font style="font-weight: bold; color: #0000cd">Employee ID :</font>
            <asp:Label ID="xempd" runat="server" Font-Bold="True" ForeColor="#009933"></asp:Label><span
                style="margin-left: 15px;"></span> <font style="font-weight: bold; color: #0000cd">Employee
                    Name :</font>
                                            ...
                                            <div style="float: left; width: 360px;">
                                                ...
                                                <div class="bm_ctl_container_60_100" >
                                                    <div class="bm_ctl_label_align_right_60_100" style="width:170px;">
                                                        <asp:Label ID="Label79" runat="server" Text="Employee ID :" AssociatedControlID="xemp"
                                            ...
                                            <tr>
                                                <td>
                                                 ...
                                                 <td>
                                                    <div class="bm_ctl_container_100_special" style="width: 270px;">
                                                        <div class="bm_ctl_label_align_right_100_special" style="width: 120px">
                                                            <asp:Label ID="Label69" runat="server" Text="Provident Fund Eligibility" AssociatedControlID="xpfflag"
                                                                CssClass="label" Font-Size="11px"></asp:Label>
                                                        </div>
                                                        <div class="bm_clt_ctl_100_special" style="width: 148px">
                        ...
                        <div class="bm_academic_grid_container" id="list" runat="server">
                            <div class="grid_header">
                                <div class="grid_header_label" id="_grid_header" runat="server">
                                    Employee's Personal Information (Quick Contact) :
                                </div>
                            ...
                            <div class="grid_body">
                                <asp:GridView ID="_grid_teacherinfo_breakup" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="xname" HeaderText="Employee Name" ItemStyle-Width="250px"
                                            ItemStyle-CssClass="pad5" />
