<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/academic_site.Master"
    CodeBehind="stdlist.aspx.cs" Inherits="OnlineTicketingSystem.forms.BMERP.stdlist"
                            ...
                            <div class="grid_body">
                                <div style="width: 65%; float: left;">
                                    <asp:GridView ID="_grid_emp" runat="server" AutoGenerateColumns="False" ShowFooter="true"
                                        ...
                                        PagerStyle-CssClass="PagerStyle" GridLines="None" OnRowDataBound="_grid_emp_OnRowDataBound" AllowSorting="True" OnSorting="GridView1_Sorting">
                                        <Columns>
                                    ...
                                    <FooterTemplate>
                                        <asp:Label ID="footerlabel" Text="Total" CssClass="footer_label_total" runat="server" />
                                           ...
                                           <%-- <asp:TemplateField HeaderText="Student's ID">
                                            ...
                                            <asp:BoundField DataField="xstdid" HeaderText="Student's ID" ItemStyle-Width="100px" ItemStyle-HorizontalAlign="Center"
                                    ...
                                    ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="pad5" />--%>
                                          ...
                                          <%--  <asp:BoundField DataField="xfname" HeaderText="Father's Name" ItemStyle-Width="250px"
                                            ...
                                            <asp:BoundField DataField="xblood" HeaderText="Blood Group" ItemStyle-Width="80px"
                                                ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="pad5" />
                                            <asp:BoundField DataField="xgender" HeaderText="Gender" ItemStyle-Width="120px" ItemStyle-HorizontalAlign="Center"
                                                ItemStyle-CssClass="pad5" />--%>
                                            <%--  <asp:BoundField DataField="xgender" HeaderText="Gender" ItemStyle-Width="100px" ItemStyle-HorizontalAlign="Center"
                                    ItemStyle-CssClass="pad5" />--%>
                                            <%--   <asp:BoundField DataField="xsession" HeaderText="Session" ItemStyle-Width="120px"
                                    ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="pad5" />
                                     <asp:BoundField DataField="xclass" HeaderText="Class" ItemStyle-Width="120px"
                                    ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="pad5" />
                                     <asp:BoundField DataField="xgroup" HeaderText="Group" ItemStyle-Width="120px"
                                    ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="pad5" />--%>
                                ...
                                <div style="font-weight: bold; width: 30%; float: left; padding: 10px; border: solid 1px #000000;
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Label ID="xclasscoordinator" runat="server" Text=""></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td style="vertical-align: top;">
                                                <asp:Label ID="xclassteacher" runat="server" Text=""></asp:Label>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
