<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="amdoublepro_entry.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.amdoublepro_entry" %>
        ...
        <ContentTemplate>
            <script type="text/javascript">
                ...
                $("body").on("click", ".bm_student", function () {
                    ...
                    if ($("#<%=hxstatus.ClientID%>").val() == "New" || $("#<%=hxstatus.ClientID%>").val() == "") {
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Class Interchange Entry</span>
                    </div>
                </div>
                                ...
                                <div class="bm_academic_grid_container2" style="width: 100%" id="divliststd" runat="server">
                                    ...
                                    <div style="width: 98%; margin-bottom: 10px; margin-left: 10px;">
                                       ...
                                       <%-- <div class="bm_clt_padding">
                                        ...
                                        <div class="bm_ctl_container_50_50" style="float: left; width: 270px">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label20" runat="server" Text="New Class :" AssociatedControlID="xclasspro"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 148px">
                                                <asp:DropDownList ID="xclasspro" runat="server" CssClass="bm_academic_dropdown_50_50 bm_academic_ctl_global bm_academic_dropdown" >
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                        ...
                                        <div class="bm_ctl_container_50_50" style="float: left; width: 270px">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label21" runat="server" Text="New Group :" AssociatedControlID="xgrouppro"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 148px">
                                                <asp:DropDownList ID="xgrouppro" runat="server" CssClass="bm_academic_dropdown_50_50 bm_academic_ctl_global bm_academic_dropdown" >
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                        ...
                                        <div class="bm_ctl_container_50_50" style="float: left; width: 270px">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label22" runat="server" Text="New Section :" AssociatedControlID="xsectionpro"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 148px">
                                                <asp:DropDownList ID="xsectionpro" runat="server" CssClass="bm_academic_dropdown_50_50 bm_academic_ctl_global bm_academic_dropdown" >
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                      ...
                                      <%--  <div class="bm_clt_padding">
                                       ...
                                       <%-- <div class="bm_clt_padding">
                                        ...
                                        <div class="bm_ctl_container_50_50" style="float: left; width: 270px">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label13" runat="server" Text="Date :" AssociatedControlID="xdate"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 148px">
                                        ...
                                        <div class="bm_ctl_container_dynamic_100_80">
                                            <div class="bm_ctl_container_dynamic_100_80_l" style="width: 120px">
                                                <div class="bm_ctl_label_align_right_dynamic_100_80_l">
                                                    <asp:Label ID="Label17" runat="server" Text="Pre-approved By :" CssClass="label"></asp:Label>
                                                </div>
                                            </div>
                                            <div class="bm_clt_ctl_dynamic_100_80 bm_academic_label">
                                                <div id="xpreapprovedby" runat="server">
                                                    xemail@bm.com
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="bm_ctl_container_dynamic_100_80">
                                            <div class="bm_ctl_container_dynamic_100_80_l" style="width: 120px">
                                                <div class="bm_ctl_label_align_right_dynamic_100_80_l">
                                                    <asp:Label ID="Label19" runat="server" Text="Approved By :" CssClass="label"></asp:Label>
                                                </div>
                                            </div>
                                            <div class="bm_clt_ctl_dynamic_100_80 bm_academic_label">
                                    ...
                                    <div class="bm_academic_grid_container" id="Div3" runat="server">
                                        <div class="grid_header">
                                            <div class="grid_header_label" id="Div4" runat="server">
                                                Class Interchange List (Pre-approved)
                                            </div>
                                            <div class="grid_header_control">
                                            </div>
                                            <div class="flot_right">
                                    ...
                                    <div class="bm_academic_grid_container" id="Div1" runat="server">
                                        <div class="grid_header">
                                            <div class="grid_header_label" id="Div2" runat="server">
                                                Class Interchange List (Approved)
                                            </div>
                                            <div class="grid_header_control">
                                            </div>
                                            <div class="flot_right">
