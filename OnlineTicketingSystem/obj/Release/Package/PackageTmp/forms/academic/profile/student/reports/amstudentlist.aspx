<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="amstudentlist.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.amstudentlist" %>
    ...
    <script type="text/javascript">
        ...
        function fnShowReport() {
          ...
          var zid = <%= HttpContext.Current.Session["business"] %>;
            ...
            var openwin = window.open('/forms/academic/reports/amstudentlistrpt.aspx?zid=' + zid + '&xsession=' + xsession1 + '&xclass=' + xclass1 + '&xgroup=' + xgroup1 + '&xsection=' + xsection1 + '&xtype=' + xtype1 + '&xrtype=' + xrtype1, 'rptamstudentlist', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, copyhistory=no, width=' + screen.width + ', height=' + screen.height + ', top=0, left=0, targets=_blank');
             openwin.focus();
             //openwin.print();
             return false;
        }
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Students' List</span>
                    </div>
                </div>
                    ...
                    <div class="bm_academic_container_body_input_section">
                        <div class="bm_layout_container">
                            <div class="bm_layout_box_100" style="width: 500px;display: inline-block">
                                ...
                                <fieldset>
                                    <legend>Download Mobile Number</legend>
                                    ...
                                    <div style="horiz-align: right">
                                        <asp:Button ID="btnDownload" runat="server" Text="Download" CssClass="bm_academic_button5 bm_am_btn_download"
