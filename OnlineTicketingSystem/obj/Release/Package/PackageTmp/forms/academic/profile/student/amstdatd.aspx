<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="amexamh.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.amstdatd" %>
        ...
        $("body").on("click", ".bm_am_btn_save", function () {
            ...
            var mendatoryFields = [
                                 { "id": "<%= xsession.ClientID%>", "prop": "combo", "tab": "0" },
                                    ...
                                    { "id": "<%= xdays.ClientID%>", "prop": "text", "tab": "0" }
                                ];
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Students Termwise Attendance</span>
                    </div>
                </div>
                                ...
                                <div class="bm_layout_box_padding" style="padding-top: 0px;">
                                    ...
                                    <div style="width: 100%; clear: both;">
                                       ...
                                       <%-- <div class="bm_ctl_container_100_special" style="display: inline-block; width: 160px">
                                        ...
                                        <div class="bm_ctl_container_100_special" style="display: inline-block; width: 150px">
                                            <div class="bm_ctl_label_align_right_100_special" style="width: 100px">
                                                <asp:Label ID="Label10" runat="server" Text="Working Days :" AssociatedControlID="xdays"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_100_special" style="width: 48px">
                                                <asp:TextBox ID="xdays" runat="server" CssClass="bm_academic_textbox_100_special bm_academic_ctl_global bm_academic_textbox"></asp:TextBox>
                                            </div>
                                        </div>
