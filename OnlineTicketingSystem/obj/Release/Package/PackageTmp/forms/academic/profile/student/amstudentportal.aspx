<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="amstudentportal.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.amstudentportal" %>
    ...
    <div class="bm_academic_container">
        <div class="bm_academic_container_header">
            <div class="header_label1" id="header_label" runat="server">
                <span class="bm_am_header_round">Student Portal Status</span>
            </div>
        </div>
            ...
            <div class="bm_academic_container_body_input_section">
                ...
                <div class="bm_academic_container_footer">
                    <div class="footer_list_padding1" style="padding-top: 0px;">
                        <div class="bm_academic_grid_container2" style="width: 80%; float: left;" id="divliststd" runat="server">
                         ...
                         <div style="font-weight: bold; width: 15%; float: left; padding: 10px; border: solid 1px #000000;
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Label ID="xadmit" runat="server" Text=""></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                <asp:Label ID="xreport" runat="server" Text=""></asp:Label>
                                            </td>
                                        </tr>
