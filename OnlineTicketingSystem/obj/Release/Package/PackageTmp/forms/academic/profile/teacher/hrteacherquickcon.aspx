<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="hrteacherquickcon.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.admission.hrteacherquickcon" %>
    ...
    <script type="text/javascript">
        ...
        function fnPrintInfo(link) {
          ...
          var row = link.parentNode.parentNode;
            ...
            var grid = document.getElementById('<%=_grid_teacherinfo_breakup.ClientID %>');
            var xemp = grid.rows[rowIndex + 1].cells[0].children[0].innerText;
            //alert(xemp);
    ...
    <div class="bm_academic_container">
        <div class="bm_academic_container_header">
            <div class="header_label1" id="header_label" runat="server">
                <span class="bm_am_header_round">Personal Information</span>
            </div>
        </div>
        ...
        <div style="width: 100%; margin-top: 5px; margin-bottom: 5px; border: 1px solid #1e90ff;
            padding: 5px; text-align: center;display:none">
        ...
        <div class="bm_academic_container_body" style="display:none">
                                    ...
                                    <div class="bm_layout_box_padding">
                                        ...
                                        <div class="bm_ctl_container_60_80">
                                            ...
                                            <div class="bm_clt_ctl_60_80">
                                                <asp:DropDownList ID="xposition_job" runat="server" CssClass="bm_academic_dropdown_60_80 bm_academic_ctl_global bm_academic_dropdown">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                        <div class="bm_clt_padding">
                                        ...
                                        <div class="bm_ctl_container_60_80" style="width: 50%">
                                            <div class="bm_ctl_label_align_right_60_80" style="width: 48.8%">
                                                <asp:Label ID="Label76" runat="server" Text="From Date :" AssociatedControlID="xfdate_job"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_60_80" style="width: 51.2%">
                        ...
                        <div class="bm_academic_grid_container" id="list" runat="server">
                            <div class="grid_header">
                                ...
                                <div class="flot_right">
                                    ...
                                    <div class="grid_header_row" style="display: none;">
                                ...
                                <asp:GridView ID="_grid_teacherinfo_breakup" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="No.">
                                            ...
                                            <ItemTemplate>
                                                <%--<asp:Label ID="xserial" runat="server" Text=""></asp:Label>--%>
                                                 <%#Container.DataItemIndex+1 %>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="ID" SortExpression="xemp">
                                            <ItemStyle Width="100px" HorizontalAlign="Center" />
                                            <ItemTemplate>
                                               <%-- <asp:LinkButton ID="xemp" runat="server" Text='<%#Eval("xemp") %>' CssClass="_gridrow_link"
                                                    OnClientClick="fnPrintInfo(this);" ></asp:LinkButton>--%>
                                                <%--<asp:HyperLink ID="xemp" runat="server"  CssClass="_gridrow_link" ForeColor="blue" OnClick="fnPrintInfo(this);" ><%#Eval("xemp") %> </asp:HyperLink>--%>
                                                <asp:Label ID="xemp" runat="server" Text='<%#Eval("xemp") %>'></asp:Label>
                                        ...
                                        <asp:BoundField DataField="xname" HeaderText="Teacher's Name" ItemStyle-Width="250px"
                                            ItemStyle-CssClass="pad5" HtmlEncode="False" SortExpression="xname"/>
                                      
                                        <asp:BoundField DataField="xparents" HeaderText="Parent's Name" ItemStyle-Width="250px"
                                            ItemStyle-CssClass="pad5" HtmlEncode="False"/>
                                         <asp:BoundField DataField="xspouse" HeaderText="Spouse" ItemStyle-Width="150px"
                                            ItemStyle-CssClass="pad5" />
                                         <asp:BoundField DataField="xecontact" HeaderText="Emergency Contact" ItemStyle-Width="200px"
                                            ItemStyle-CssClass="pad5" HtmlEncode="False"/>
                                        <asp:BoundField DataField="xpadd" HeaderText="Address" ItemStyle-Width="200px" ItemStyle-CssClass="pad5" />
                                         <%-- <asp:BoundField DataField="xemail1" HeaderText="Email" ItemStyle-Width="100px"
                                            ItemStyle-CssClass="pad5" HtmlEncode="False"/>--%>
                                        <asp:BoundField DataField="xblood" HeaderText="BG" ItemStyle-Width="40px"
                                            ItemStyle-CssClass="pad5" />
                                        <asp:TemplateField>
                                            <ItemTemplate>
