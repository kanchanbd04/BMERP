<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="amvehiclecard.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.amvehiclecard" %>
        ...
        function fnShowReport() {
          ...
          var zid = <%= HttpContext.Current.Session["business"] %>;
           ...
           <%-- var xtype1 = $("#<%= xtype.ClientID%>").val();
            ...
            var openwin = window.open('/forms/academic/reports/amvehiclerpt.aspx?zid=' + zid + '&xsession=' + xsession1 + '&xclass=' + xclass1 + '&xgroup=' + xgroup1 + '&xsection=' + xsection1 , 'rptvehiclerpt', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, copyhistory=no, width=' + screen.width + ', height=' + screen.height + ', top=0, left=0, targets=_blank');
             openwin.focus();
             //openwin.print();
             return false;
        }
