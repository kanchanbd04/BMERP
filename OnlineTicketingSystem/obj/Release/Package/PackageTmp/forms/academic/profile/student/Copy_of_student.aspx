<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="Copy_of_student.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.admission.Copy_of_student" %>
        ...
        <div class="bm_academic_container_body">
            <div class="bm_academic_container_body_input_section">
                <cc1:TabContainer ID="TabContainer1" runat="server" CssClass="bm_academic_tab_250 bm_am_tab1"
                    Height="600px" ScrollBars="Auto" OnActiveTabChanged="TabContainer1_ActiveTabChanged"
                    AutoPostBack="True">
                                ...
                                <div class="bm_layout_box_50">
                                    <div class="bm_layout_box_padding">
                                        ...
                                        <div style="width: 100%">
                                            ...
                                            <div style="float: left; padding-left: 3px;">
                                                <asp:ImageButton ID="ImageButton1" ImageUrl="~/images/search32x32.png" runat="server"
                                                    CssClass="bm_academic_list" OnClick="FillControls2" />
                                                <%--<asp:Image ID="Image5" runat="server" ImageUrl="~/images/search32x32.png" CssClass="bm_academic_list" />--%>
                                            </div>
                                        </div>
                                        <div class="bm_clt_padding">
                                        </div>
                                        ...
                                        <div style="width: 100%">
                                            ...
                                            <div class="bm_ctl_container_50_50" style="float: left; margin-left: 3px; width: 8%">
                                            ...
                                            <div class="bm_ctl_container_50_40" style="float: left; margin-left: 5px; width: 14.5%">
                                                <div class="bm_ctl_label_align_right_50_40" style="width: 40%">
                                        ...
                                        <div class="bm_ctl_container_50_60" style="border: none; width: 95%; text-align: right">
                                            ...
                                            <div class="bm_clt_ctl_50_60" style="width: 100%">
                                                <asp:ImageButton ID="ImageButton7" runat="server" ImageUrl="~/images/printer-blue-icon.png"
                                                    Width="32px" Height="32px" OnClientClick="fnPrintAdmit();" />
                                            </div>
                                        </div>
                                                    ...
                                                    <table style="border: none;">
                                                        <tr>
                                                            <td style="width: 100px">
                                                                <asp:RadioButton ID="rdoUpload" runat="server" Checked="True" GroupName="image" 
                                    ...
                                    <div class="bm_layout_box_padding">
                                        ...
                                        <div style="width: 100%">
                                            <%-- <div style="float: left; width: 25%">
                                                <div class="bm_ctl_container_100_25" style="width: 100%">
                                                    <div class="bm_ctl_label_align_right_100_25">
                                                        <asp:Label ID="Label22" runat="server" Text="Number of Exam :" AssociatedControlID="xnumexam"
                                                            CssClass="label"></asp:Label>
                                                    </div>
                                                    <div class="bm_clt_ctl_100_25">
                                                        <asp:DropDownList ID="xnumexam" runat="server" CssClass="bm_academic_dropdown_100_25 bm_academic_ctl_global bm_academic_dropdown">
                                                        </asp:DropDownList>
                                                    </div>
                                                </div>
                                            </div>--%>
                                            ...
                                            <div class="bm_ctl_container_100_25">
                                                <div class="bm_ctl_label_align_right_100_25">
                                                    <asp:Label ID="Label23" runat="server" Text="Exam Date :" AssociatedControlID="xexamdate_res"
                                                        CssClass="label"></asp:Label>
                                                </div>
                                                <div class="bm_clt_ctl_100_25">
                                        ...
                                        <div style="width: 100%">
                                            <div style="float: left; width: 25%">
                                                <div class="bm_ctl_container_100_25" style="width: 100%">
                                                    <div class="bm_ctl_label_align_right_100_25">
                                                        <asp:Label ID="Label24" runat="server" Text="Class :" AssociatedControlID="xclass_res"
                                                            CssClass="label"></asp:Label>
                                                    </div>
                                                    <div class="bm_clt_ctl_100_25">
