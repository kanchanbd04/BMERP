<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="amstudentlist_prof.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.amstudentlist_prof" %>
    ...
    <script type="text/javascript">
        ...
        function fnShowReport() {
          ...
          var zid = <%= HttpContext.Current.Session["business"] %>;
            ...
            var openwin = window.open('/forms/academic/reports/amstudentlist_profrpt.aspx?zid=' + zid + '&xsession=' + xsession1 + '&xclass=' + xclass1 + '&xgroup=' + xgroup1 + '&xsection=' + xsection1 + '&xtype=' + xtype1 + '&xrtype=' + xrtype1, 'rptamstudentlistprof', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, copyhistory=no, width=' + screen.width + ', height=' + screen.height + ', top=0, left=0, targets=_blank');
             openwin.focus();
             //openwin.print();
             return false;
        }
        ...
        function fnShowReport1() {
            ...
            var openwin = window.open('/forms/academic/reports/amstudentlistaccrpt.aspx?zid=' + zid + '&xsession=' + xsession1 + '&xclass=' + xclass1 + '&xgroup=' + xgroup1 + '&xsection=' + xsection1 + '&xtype=' + xtype1 + '&xrtype=' + xrtype1, 'rptamstudentlist', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, copyhistory=no, width=' + screen.width + ', height=' + screen.height + ', top=0, left=0, targets=_blank');
            openwin.focus();
            //openwin.print();
            return false;
        }
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <script type="text/javascript">
                ...
                $("body").on("click", ".bm_profession", function () {
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Profession-wise Students' List</span>
                    </div>
                </div>
                            ...
                            <div class="bm_layout_box_100" style="width: 500px;display: inline-block">
                                ...
                                <div class="bm_layout_box_padding" style="padding-top: 10px; min-height: 300px;">
                                    ...
                                    <div style="width: 100%; clear: both;">
                                        ...
                                        <div class="bm_ctl_container_50_100" style="width: 290px;">
                                                                    <div class="bm_ctl_label_align_right_50_100" style="width: 120px;">
                                                                        <asp:Label ID="Label9" runat="server" Text=" Profession :" AssociatedControlID="xprof"
                                                                            CssClass="label"></asp:Label>
                                                                    </div>
                                                                    <div class="bm_clt_ctl_50_100" style="width: 168px;">
                                                                        <div class="bm_list_text" style="width: 85%">
                                                                            <asp:TextBox ID="xprof" runat="server" CssClass="bm_academic_textbox_50_100 bm_academic_ctl_global bm_academic_textbox "></asp:TextBox>
                                                                        </div>
                                                                        <div class="bm_list_img" style="width: 15%">
