<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="teacherlistprint.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.teacherlistprint" %>
    ...
    <script type="text/javascript">
        ...
        function fnShowReport() {
          ...
          <%--  var xbank1 = $("#<%= xbank.ClientID%>").val();--%>
            ...
            var openwin = window.open('/forms/academic/reports/teacherlist.aspx?zid=' + zid + '&xclass=' + xclass1 , 'teacherlist', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, copyhistory=no, width=' + screen.width + ', height=' + screen.height + ', top=0, left=0, targets=_blank');
            openwin.focus();
            //openwin.print();
            return false;
        }
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Teacher List For Print</span>
                    </div>
                </div>
