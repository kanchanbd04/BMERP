<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="stdvivasch.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.admission.stdvivasch" %>
...
//                return true;
        ...
        function fnPrintResultPdf() {
            ...
            var xsession1 = $("#<%= xsession_res.ClientID%>").val();
             ...
             var xschfor1 = $("#<%= xschfor.ClientID%>").val();

            var left = Math.round((screen.width / 2) - (500 / 2));
            var top = Math.round((screen.height / 2) - (500 / 2));
            var openwin = window.open('/forms/academic/reports/stdvivalist.aspx?xtype=pdf&xsession='+xsession1+'&xclass='+xclass1+'&xgroup='+xgroup1+'&xnumexam='+xnumexam1+'&xschfor='+xschfor1, 'result', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, copyhistory=no, width=450, height=450, top='+ top +', left='+ left +', targets=_blank');
            openwin.focus();
            return false;
        }
        ...
        function fnPrintResultWord() {
            ...
            var left = Math.round((screen.width / 2) - (500 / 2));
            var top = Math.round((screen.height / 2) - (500 / 2));
            var openwin = window.open('/forms/academic/reports/stdvivalist.aspx?xtype=word&xsession='+xsession1+'&xclass='+xclass1+'&xgroup='+xgroup1+'&xnumexam='+xnumexam1+'&xschfor='+xschfor1, 'result', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, copyhistory=no, width=450, height=450, top='+ top +', left='+ left +', targets=_blank');
            openwin.focus();
            return false;
        }
        ...
        function fnPrintResultExcel() {
            ...
            var left = Math.round((screen.width / 2) - (500 / 2));
            var top = Math.round((screen.height / 2) - (500 / 2));
            var openwin = window.open('/forms/academic/reports/stdvivalist.aspx?xtype=excel&xsession='+xsession1+'&xclass='+xclass1+'&xgroup='+xgroup1+'&xnumexam='+xnumexam1+'&xschfor='+xschfor1, 'result', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, copyhistory=no, width=450, height=450, top='+ top +', left='+ left +', targets=_blank');
            openwin.focus();
            return false;
        }
                                    ...
                                    <div class="bm_layout_box_padding">
                                        ...
                                        <div class="bm_ctl_container_100_25">
                                            <div class="bm_ctl_label_align_right_100_25">
                                                <asp:Label ID="Label31" runat="server" Text="Schedule For :" AssociatedControlID="xschfor"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                        ...
                                        <div style="width: 100%">
                                            ...
                                            <div style="float: left; width: 20%; margin-left: 10px;">
                                                <div class="bm_ctl_container_100_25" style="width: 100%">
                                                    ...
                                                    <div class="bm_clt_ctl_100_25" style="width: 60%;">
                                                        <asp:TextBox Enabled="False" ID="xexamdate_res" runat="server" CssClass="bm_academic_textbox_100_25 bm_academic_ctl_global bm_academic_datepicker"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
