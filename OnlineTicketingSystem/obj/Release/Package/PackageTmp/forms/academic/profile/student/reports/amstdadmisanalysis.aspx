<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/academic_site.Master"
    CodeBehind="amstdadmisanalysis.aspx.cs" Inherits="OnlineTicketingSystem.forms.BMERP.amstdadmisanalysis"
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        $("body").on("click", ".bm_button_reload", function(e) {
            ...
            //$.ajax({
            //    type: "POST",
            //    url: "amstdadmisanalysis.aspx/GetSchool",
            //    data: "",
            //    contentType: "application/json; charset=utf-8",
            //    dataType: "json",
            //    success: OnSuccess,
        ...
        //    //alert('Hi!');
        //    var school = $($.parseXML(r.d)).find("Table");

        //    var i = 1;
        //    $.each(school, function () {
        //        //alert($(this).find("xschool").text());
    ...
    <div class="bm_academic_container">
        <div class="bm_academic_container_header">
            <div class="header_label1" id="header_label" runat="server">
                <span class="bm_am_header_round">Admission Analysis</span>
            </div>
        </div>
        ...
        <div class="bm_academic_container_footer">
            <div class="footer_list_padding2">
                ...
                <div class="bm_academic_grid_container" id="list" runat="server">
                        ...
                        <div class="grid_header_control" style="margin-left: 15px; margin-top: 5px;">
                            ...
                            <div class="bm_ctl_container_100_special" style="display: inline-block; width: 250px">
                                <div class="bm_ctl_label_align_right_100_special" style="width: 100px">
                                    <asp:Label ID="Label1" runat="server" Text="Display For :" AssociatedControlID="xyear" CssClass="label"></asp:Label>
                                </div>
                                <div class="bm_clt_ctl_100_special" style="width: 148px">
                                    <asp:DropDownList ID="xyear" runat="server" CssClass="bm_academic_dropdown_100_special bm_academic_ctl_global bm_academic_dropdown">
                                        <asp:ListItem Value="4">Last 5 Years</asp:ListItem>  
                                        <asp:ListItem Value="2">Last 3 Years</asp:ListItem>
                                        <asp:ListItem Value="1">Last 2 Years</asp:ListItem>    
                        ...
                        <div class="flot_right">
                            ...
                            <div class="bm_ctl_container_50_50" style="float: left; width: 32px; margin-top: 5px; border: none; height: 32px; margin-right: 15px">
                                <div class="bm_clt_ctl_50_50" style="width: 100%;">
                                    ...
                                    <%--<input type="image" src="/images/reload70.png" width="25px" height="25px" class="bm_academic_button_zoom bm_button_reload" id="bm_button_reload" />--%>
                    ...
                    <div class="grid_body">
                       <%-- <div id="grid" style="float: left; width: 500px; margin-top: 5px; visibility: hidden;">
                            ...
                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" ShowFooter="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="xprevious" HeaderText="Last Session" ItemStyle-Width="100px"
                                        ItemStyle-CssClass="_grid_text_padding" ItemStyle-HorizontalAlign="Center" />
                                    <asp:BoundField DataField="xreadmis" HeaderText="Readmission" ItemStyle-Width="100px"
                                        ItemStyle-CssClass="_grid_text_padding" ItemStyle-HorizontalAlign="Center" />
                                    <asp:BoundField DataField="xnew" HeaderText="New" ItemStyle-Width="100px"
                                        ItemStyle-CssClass="_grid_text_padding" ItemStyle-HorizontalAlign="Center" />
                       ...
                       <%-- <div style="float: left; margin-left: 7px;" runat="server" id="barchart">
                        ...
                        <div id="ChartContainer" style="margin-top: 5px; width: 100%; " runat="server" >
                            <%--dasda
                           <canvas id="canJunior" width="100%"></canvas>
                            <script>
                                var color = Chart.helpers.color;

                                window.chart = new Chart (document.getElementById('canJunior').getContext('2d'), 
                                { type:'bar', 
                                    data: {labels: ['Playgroup','Nursery','KG','Class I','Class II','My Class'],
                                        datasets: [
                                            {
                                                label: '2018/19',
                                                backgroundColor: '#00FF00',
                                                data:[64,76,90,90,92,0]
                                            },
                                            {
                                                label: '2019/20',
                                                backgroundColor: color(window.chartColors.blue).alpha(0.5).rgbString(),
                                                data:[63,83,83,92,97,0]
                                            }
                                        ]
                                    }, 
                                    options:
                           ...
                           <%-- <canvas id="canJunior" width="100%"></canvas>
                            <script>
                                ...
                                window.chart = new Chart(document.getElementById('canJunior').getContext('2d'),
                                {
                                    type:'bar', 
                                    data: {
                                        labels: ['Playgroup','Nursery','KG','Class I','Class II','My Class'],
                                        datasets: [
                                        {
                                            label: '2018/19',
                                        ...
                                        {
                                            label: '2019/20',
                                            backgroundColor: color('#8549ba').alpha(0.5).rgbString(),
                                            borderColor: "#8549ba",
                                            data:[63,83,83,92,97,0]
                                        }
                                        ]
                            ...
                            <script>
                                ...
                                window.chart = new Chart(document.getElementById('canJunior').getContext('2d'),
                                {
                                    ...
                                    data:
                                    {
                                        ...
                                        {
                                            label: '2019/20',
                                            backgroundColor: color("#537bc4").alpha(0.5).rgbString(),
                                            borderColor: "#537bc4",
                                            data:[63,83,83,92,97,0]
                                        }
                                        ]
                            ...
                            <%--<canvas id="canJunior1" width="100%"></canvas>
                            <script>
                                var color = Chart.helpers.color;
                                window.chart = new Chart(document.getElementById('canJunior').getContext('2d'),
                                {
                       ...
                       <%-- <div id="totalContainer" style="margin-top: 5px; width: 18%; float: left;" runat="server">
