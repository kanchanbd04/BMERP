<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="vahiclerpt.aspx.cs" Inherits="OnlineTicketingSystem.forms.sc.Reports.vahiclerpt" %>
...
<body>
    ...
    <div>
        ...
        <div id="printable" style="width: 1344px; height: 816px;">
            <table class="style1" style="width: 100%">
                <tr>
                    <td class="style4" colspan="7">
                        V<strong>ahicle Wise Report</strong>
                    </td>
                </tr>
                <tr>
                    <td class="style8">
