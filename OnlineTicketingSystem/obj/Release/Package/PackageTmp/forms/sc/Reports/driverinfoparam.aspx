<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="driverinfoparam.aspx.cs" Inherits="OnlineTicketingSystem.forms.sc.Reports.driverinfoparam" %>
...
<link rel="stylesheet" href="../../../Scripts/jquery-ui-1.9.2.custom/development-bundle/themes/base/jquery.ui.all.css">
    ...
    <script>
        ...
        $("[id*=btnShow]").live("click", function () {
            ...
            window.open("driverinforpt.aspx?xfrom1=" + xfrom1 + "&xto1=" + xto1);
