<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="mansalerpt.aspx.cs" Inherits="OnlineTicketingSystem.forms.sc.Reports.mansalerpt" %>
...
<body>
    ...
    <div>
        ...
        <div id="printable" style="width: 1122.24px; height: 793.92px;">
            <table class="style1" style="width: 100%">
                <tr>
                    <td class="style4" colspan="7">
                        <strong>Manual Ticket Report</strong>
                    </td>
                </tr>
                <tr>
                    <td class="style8">
