<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="mansaleparam.aspx.cs" Inherits="OnlineTicketingSystem.forms.sc.Reports.mansaleparam" %>
...
<link rel="stylesheet" href="../../../Scripts/jquery-ui-1.9.2.custom/development-bundle/themes/base/jquery.ui.all.css">
    ...
    <script>
        ...
        $("[id*=btnShow]").live("click", function () {
            ...
            window.open("mansalerpt.aspx?xfrom1=" + xfrom1 + "&xto1=" + xto1);
