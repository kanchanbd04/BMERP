<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ztsalereturn.aspx.cs" Inherits="OnlineTicketingSystem.forms.sc.ztsalereturn"  EnableEventValidation="false"%>
...
//            // }
        ...
        $("[id*=btnsale]").live("click", function () {
            ...
            var xname123 = $("#<%= xname1.ClientID%>").val();
            var xphone123 = $("#<%= xphone1.ClientID%>").val();
            var xvotid123 = $("#<%= xvotid1.ClientID%>").val();

            $("#<%= xname.ClientID%>").val(xname123);
            $("#<%= xphone.ClientID%>").val(xphone123);
            $("#<%= xvotid.ClientID%>").val(xvotid123);
        ...
        $("[id*=btnReload]").live("click", function () {
        ...
        $("[id*=btnsave]").live("click", function () {
            ...
            $.ajax({
                url: "ztsalereturn.aspx/fnReturnTic",

                type: "POST",

                data: "{'date1' :'" + xdate1 + "', 'coach1' :'" + xcoach1 + "','seat1':'" + xseat1 + "','time1':'" + Time + "','route1' : '" + route + "','name1':'" + xname1 + "','phone1':'" + xphone1 + "','votid1':'" + xvotid1 + "','boarding1':'" + xboarding1 + "','rate1':'" + xrate1 + "', 'amount1':'" + xamount1 + "','seatid1':'" + xseatid1 + "'}",
...
<body>
    ...
    <asp:Panel ID="MasterPanel" runat="server" Height="853px" ScrollBars="Auto">
                            ...
                            <tr>
                                <td class="style1116" colspan="2">
                                    <asp:ImageButton ID="btnrefresh" runat="server" ImageUrl="~/images/reload70.png"
                                         OnClientClick="JavaScript:resetObject()" onclick="btnrefresh_Click" />
                                </td>
                            </tr>
                            <tr>
                                <td class="style1116" colspan="2">
                ...
                <ContentTemplate>
                    <asp:Panel ID="Panel5" runat="server" Height="691px">
                        <table class="style1102">
                            ...
                            <tr>
                                <td class="style1127">
                                    <button id="btncngpass" class="mybutton" hidden="hidden">
                                        Change<br>
                                        Password</button>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td class="style1127">
                                    <asp:Button ID="btnReload" runat="server" BackColor="#33CCCC" BorderColor="#996633"
                                        Font-Bold="True" Font-Size="Medium" ForeColor="White" Height="30px" Text="Reload Page"
                                        Width="120px" onclick="btnReload_Click1" Visible="False"  />
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td class="style1128">
                                    <asp:Button ID="btnclose" runat="server" BackColor="#33CCCC" BorderColor="#996633"
                                        Font-Bold="True" Font-Size="Medium" ForeColor="White" Height="30px" Text="Colse"
                                        Width="120px" />
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td class="style1127">
                                    <button id="btnconfbooking" class="mybutton" hidden="hidden">
                                        Confirm<br>
                                        Booking</button>
                                </td>
                            </tr>
                            <tr>
                                <td class="style1127">
                                    <asp:Button ID="btnreservation" runat="server" BackColor="#33CCCC" BorderColor="#996633"
                                        ...
                                        Width="120px" OnClick="btnreservation_Click" Visible="False" />
                                </td>
                            </tr>
                            <tr>
                                <td class="style1127">
        ...
        <div id="RightDiv" 
            style="float: left; height: 797px; width: 402px; background-color: #FFFFFF;">
                        ...
                        <table class="style1111353">
                            <tr>
                                <td class="style1111357">
                                    <asp:Panel ID="salelist" runat="server" Height="354px" ScrollBars="Both" 
                                        ...
                                        <tr>
                                            <td class="style1111365" colspan="4" valign="top">
                                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                                    ForeColor="#333333" GridLines="None" Height="41px" 
                            ...
                            <tr>
                                <td class="style1111356">
                                    <asp:Panel ID="bookinglist" runat="server" Height="354px" ScrollBars="Both" 
                                        Width="400px" Visible="False">
    ...
    <asp:HiddenField ID="xdisrate" runat="server" />
     ...
     <asp:HiddenField ID="xname1" runat="server" />
     <asp:HiddenField ID="xphone1" runat="server" />
     <asp:HiddenField ID="xvotid1" runat="server" />
     <asp:HiddenField ID="xcoachno1" runat="server" />
    </div>
    </form>
</body>
</html>
