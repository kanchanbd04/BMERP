<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="vmvech.aspx.cs" Inherits="OnlineTicketingSystem.forms.sc.vmvech" %>
                    ...
                    <asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="#333333" 
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="Vehicle Number">
                              <ItemTemplate>
                        <asp:LinkButton ID="xfareid" runat="server"  Text='<%#Eval("xvehicle") %>' OnClick="FillControls"></asp:LinkButton>
                       
                    </ItemTemplate>
                            </asp:TemplateField>

                            <asp:BoundField  DataField="xchasis" HeaderText="Chasis No" />
                            <asp:BoundField  DataField="xengine" HeaderText="Engine No" />
            ...
            <table style="width:100%;">
                ...
                <tr>
                    <td class="style34">
                        Vehicle Number</td>
                    <td class="style32">
                        <asp:TextBox ID="xvehicle" runat="server" Width="151px"></asp:TextBox>
                ...
                <tr>
                    <td class="style31">
                        Chasis No</td>
                    <td class="style32">
                        <asp:TextBox ID="xchasis" runat="server" Width="151px"></asp:TextBox>
                    </td>
                    <td class="style31">
                        </td>
                    <td class="style33">
                ...
                <tr>
                    <td class="style31">
                        Engine No&nbsp; </td>
                    <td class="style32">
                        <asp:TextBox ID="xengine" runat="server" Width="151px"></asp:TextBox>
                    </td>
                    <td class="style31">
                        </td>
                    <td class="style33">
                ...
                <tr>
                    ...
                    <td class="style32">
                        <asp:TextBox ID="xregdate" runat="server" Width="151px"></asp:TextBox>
                    </td>
                    <td class="style31">
                        </td>
                    <td class="style33">
                ...
                <tr>
                    <td class="style31">
                        Unit</td>
                    <td class="style32">
                        <asp:DropDownList ID="zid" runat="server" Width="151px">
                        </asp:DropDownList>
