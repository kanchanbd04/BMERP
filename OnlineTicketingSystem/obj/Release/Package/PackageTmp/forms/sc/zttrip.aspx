<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="zttrip.aspx.cs" Inherits="OnlineTicketingSystem.forms.sc.zttrip" %>
...
--%>
     ...
     <script>
         $(function () {
             $("#<%=xstdt.ClientID %>").datepicker();
         });
	</script>
    <script>
        $(function () {
            $("#<%=xendt.ClientID %>").datepicker();
        });
	</script>
     <script>
                    ...
                    <asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="#333333" 
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="ID">
                              <ItemTemplate>
                        <asp:LinkButton ID="xfareid" runat="server"  Text='<%#Eval("xtripid") %>' OnClick="FillControls"></asp:LinkButton>
                       
                    </ItemTemplate>
                            </asp:TemplateField>

                            <asp:BoundField  DataField="xcoachno" HeaderText="Coach No" />
                            <asp:BoundField  DataField="xdepttime" HeaderText="Departure Time" />
                            <asp:BoundField  DataField="xdeptplace" HeaderText="Departure Place" />
                            <asp:BoundField  DataField="xmrid" HeaderText="Main Route" />
                            <asp:BoundField  DataField="xstdt" DataFormatString="{0:d}" HeaderText="Start Date" />
                            <asp:BoundField  DataField="xendt" DataFormatString="{0:d}" HeaderText="End Date" />
            ...
            <table style="width:100%;">
                ...
                <tr>
                    <td class="style34">
                        ID</td>
                    <td class="style32">
                        <asp:Label ID="xtripid" runat="server" Text="Label"></asp:Label>
                    </td>
                    <td class="style36">
                        </td>
                    <td class="style33">
                ...
                <tr>
                    <td class="style34">
                        Coach No</td>
                    <td class="style32">
                        <asp:DropDownList ID="xcoachno1" runat="server" Height="24px" Width="151px" 
                ...
                <tr>
                    <td class="style34">
                        Departure Time</td>
                    <td class="style32">
                        <asp:Label ID="xdepttime" runat="server" Text="Label"></asp:Label>
                    </td>
                    <td class="style31">
                        &nbsp;</td>
                    <td class="style33">
                ...
                <tr>
                    <td class="style34">
                        Departure Place</td>
                    <td class="style32">
                        <asp:DropDownList ID="xdeptplace" runat="server" Width="151px">
                        </asp:DropDownList>
                    </td>
                    <td class="style31">
                        &nbsp;</td>
                ...
                <tr>
                    <td class="style34">
                        Main Route&nbsp; </td>
                    <td class="style32">
                        <asp:Label ID="xmrid" runat="server" Text="Label"></asp:Label>
                    </td>
                    <td class="style31">
                        </td>
                    <td class="style33">
                ...
                <tr>
                    <td class="style34">
                        Start Date</td>
                    <td class="style32">
                        <asp:TextBox ID="xstdt" runat="server" Width="151px"></asp:TextBox>
                ...
                <tr>
                    <td class="style34">
                        End Date</td>
                    <td class="style32">
                        <asp:TextBox ID="xendt" runat="server" Width="151px"></asp:TextBox>
