...
{
    public partial class imdailytrnrpt : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                crystalReport.Load(Server.MapPath("~/reports/imdailytrn.rpt")); // path of report 
                ...
                crystalReport.SetParameterValue("tgitem", tgitem);
