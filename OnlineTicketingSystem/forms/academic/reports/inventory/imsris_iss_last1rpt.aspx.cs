...
{
    public partial class imsris_iss_last1rpt : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                crystalReport.Load(Server.MapPath("~/reports/imsris_iss_last1.rpt")); // path of report 
                ...
                crystalReport.SetParameterValue("xgroup", fgitem);
