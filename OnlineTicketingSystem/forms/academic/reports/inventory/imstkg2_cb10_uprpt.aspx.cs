...
{
    public partial class imstkg2_cb10_uprpt : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                //string tware = Request.QueryString["tware"].ToString();
                ...
                //string fstd = Request.QueryString["xfstd"].ToString();
                //string tstd = Request.QueryString["xtstd"].ToString();
                ...
                crystalReport.Load(Server.MapPath("~/reports/imstkg2_cb10_up.rpt")); // path of report 
                ...
                //crystalReport.SetParameterValue("fwh", fware);
                //crystalReport.SetParameterValue("twh", tware);
                crystalReport.SetParameterValue("fgroup", fgitem);
                crystalReport.SetParameterValue("tgroup", tgitem);
                //crystalReport.SetParameterValue("femp", fstd);
                //crystalReport.SetParameterValue("temp", tstd);
