...
{
    public partial class glbal_per2_rpt : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                crystalReport.Load(Server.MapPath("~/reports/glbal_per2.rpt")); // path of report 
                ...
                crystalReport.SetParameterValue("xglrpt", type);
