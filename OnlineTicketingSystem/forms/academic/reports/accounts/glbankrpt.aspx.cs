...
{
    public partial class glbankrpt : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                crystalReport.Load(Server.MapPath("~/reports/glbank.rpt")); // path of report 
                ...
                crystalReport.SetParameterValue("narr", nara);
