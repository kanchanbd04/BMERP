...
{
    public partial class gladvemp6_salaryrpt : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                string fsup = Request.QueryString["fsup"].ToString();
                ...
                string tsup = Request.QueryString["tsup"].ToString();
                ...
                crystalReport.Load(Server.MapPath("~/reports/gladvemp6_salary.rpt")); // path of report 
                ...
                //crystalReport.SetParameterValue("fsup", fsup);
                //crystalReport.SetParameterValue("sub", sub);
                crystalReport.SetParameterValue("frdate", fdate);
                ...
                //crystalReport.SetParameterValue("tsup", tsup);
