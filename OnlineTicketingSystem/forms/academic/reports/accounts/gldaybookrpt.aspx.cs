...
{
    public partial class gldaybookrpt : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                crystalReport.Load(Server.MapPath("~/reports/gltrndbtyp2d.rpt")); // path of report 
                ...
                crystalReport.SetParameterValue("frdate", frdate);
