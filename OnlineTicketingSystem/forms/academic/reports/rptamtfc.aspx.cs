...
{
    public partial class rptamtfc : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                crystalReport.Load(Server.MapPath("~/reports/amtfc.rpt")); // path of report 
                //crystalReport.Load(zglobal.reportPath + "amtfc.rpt");
