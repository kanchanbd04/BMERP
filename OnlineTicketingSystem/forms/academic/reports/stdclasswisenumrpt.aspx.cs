...
{
    public partial class stdclasswisenumrpt : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
               ...
               // Response.Write(xfdate + "  " + xtdate);
                ...
                crystalReport.Load(Server.MapPath("~/reports/stdclasswisenum.rpt")); // path of report 
                ...
                string fileName = "StudentList_" + xsession + "_" + DateTime.Today.Date;
