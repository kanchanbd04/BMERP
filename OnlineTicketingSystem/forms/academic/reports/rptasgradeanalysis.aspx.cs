...
{
    public partial class rptasgradeanalysis : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                crystalReport.Load(Server.MapPath("~/reports/asgradeanalysis.rpt")); // path of report 
                ...
                crystalReport.SetParameterValue("xflag", xflag);
