...
{
    public partial class pratdmon_emp_leave_date1rpt : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                crystalReport.Load(Server.MapPath("~/reports/pratdmon_emp_leave_date1.rpt")); // path of report 
