...
{
    public partial class amstudentlist_profrpt : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                crystalReport.Load(Server.MapPath("~/reports/amstudentlist_prof.rpt")); // path of report 
                ...
                crystalReport.SetParameterValue("xprof", xtype);
