...
{
    public partial class amtfcduercvrpt : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (xtype1 == "Details")
                {
                    crystalReport.Load(Server.MapPath("~/reports/amtfcduercv_details.rpt")); 
                    //crystalReport.Load(zglobal.reportPath + "amtfcduercv_details.rpt");
                }
                else
                {
                    crystalReport.Load(Server.MapPath("~/reports/amtfcduercv_summery.rpt")); 
