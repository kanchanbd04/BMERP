...
{
    public partial class amattn_ctrpt : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                //else
                //{
                crystalReport.Load(Server.MapPath("~/reports/amattn_ct.rpt")); 
                ...
                //crystalReport.SetParameterValue("xsection", xsection);
                crystalReport.SetParameterValue("xdate", xfdate);
