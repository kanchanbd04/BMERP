...
{
    public partial class lbissumemtyp1rpt : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                string memcode = Request.QueryString["memcode"].ToString();
                string memtype = Request.QueryString["memtype"].ToString();
                ...
                crystalReport.Load(Server.MapPath("~/reports/lbissumemtyp1.rpt")); // path of report 
                ...
                crystalReport.SetParameterValue("memcode", memcode);
                crystalReport.SetParameterValue("memtype", memtype);
