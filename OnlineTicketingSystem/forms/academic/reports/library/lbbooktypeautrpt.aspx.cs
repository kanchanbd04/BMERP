...
{
    public partial class lbbooktypeautrpt : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                crystalReport.Load(Server.MapPath("~/reports/lbbooktypeaut.rpt")); // path of report 
                ...
                crystalReport.SetParameterValue("author", author);
