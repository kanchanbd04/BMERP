...
{
    public partial class lbbookrptrpt : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                string bookcode = Request.QueryString["bookcode"].ToString();
               ...
               // Response.Write(xfdate + "  " + xtdate);
                ...
                crystalReport.Load(Server.MapPath("~/reports/lbbook.rpt")); // path of report 
                //crystalReport.Load(zglobal.reportPath + "amtfcadmitcard.rpt");
                crystalReport.SetParameterValue("zid", zid);
                crystalReport.SetParameterValue("bookcode", bookcode);
