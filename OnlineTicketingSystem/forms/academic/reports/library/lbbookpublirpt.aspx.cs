...
{
    public partial class lbbookpublirpt : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                string publisher = Request.QueryString["publisher"].ToString();
                ...
                crystalReport.Load(Server.MapPath("~/reports/lbbookpubli.rpt")); // path of report 
                ...
                crystalReport.SetParameterValue("publisher", publisher);
