...
{
    public partial class amduest_tuition_feerpt : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                string xper = Request.QueryString["xper"].ToString();
                ...
                {
                    crystalReport.Load(Server.MapPath("~/reports/amduest_tuition_fee.rpt")); 
                ...
                crystalReport.SetParameterValue("xper", xper);
