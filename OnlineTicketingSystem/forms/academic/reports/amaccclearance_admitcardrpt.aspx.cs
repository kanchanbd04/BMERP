...
{
    public partial class amaccclearance_admitcardrpt : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                string xflag = Request.QueryString["xflag"].ToString();
                ...
                //if (xtype1 == "Details (Headwise)")
                //{
                //    crystalReport.Load(Server.MapPath("~/reports/ambalancest_details_headwise.rpt")); 
                ...
                //else
                //{
                crystalReport.Load(Server.MapPath("~/reports/amaccclearance_admitcard.rpt")); 
                ...
                crystalReport.SetParameterValue("xflag", xflg);
