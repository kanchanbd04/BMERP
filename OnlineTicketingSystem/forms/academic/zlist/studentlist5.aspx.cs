...
{
    public partial class studentlist5 : System.Web.UI.Page
    {
        ...
        public void fnFillDataGrid()
        {
            ...
            string str = "SELECT TOP " + _gridrow.Text.Trim().ToString() + " right(xrow,4) as xref, xclass,xrow,xsession,xclass,xname,(xmname + '<br>' + xcellno) as xmname,(xfname + '<br>' + xcellno1) as xfname,xgender FROM amadmison WHERE (xsession = '" + xsession + "' and (xname like '%" + xname + "%' or right(xrow,4) like '%"+xname+"%')) and zid=@zid  ";
