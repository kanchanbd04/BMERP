...
{
    public partial class tfccodelist3 : System.Web.UI.Page
    {
        ...
        public void fnFillDataGrid()
        {
            ...
            dts.Reset();
            string str = "SELECT TOP " + _gridrow.Text.Trim().ToString() + "  xcode,xdescdet FROM mscodesam WHERE (xcode like '%" + filter + "%' or xdescdet like '%" + filter + "%') and zid=@zid and xtype='TFC Code' and zactive=1 and not (xprops like '%xtype=Monthly%' or xprops like '%xtype=Yearly%')";
