<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="studentlist.aspx.cs" Inherits="OnlineTicketingSystem.forms.BMERP.studentlist"
                ...
                <div class="bm_academic_grid_container" id="list" runat="server">
                    ...
                    <div class="grid_body">
                        <asp:GridView ID="_grid_emp" runat="server" AutoGenerateColumns="False" ShowFooter="true"
                            ...
                            <Columns>
                                <%--<asp:BoundField DataField="xrow" HeaderText="Row" ItemStyle-Width="100px" ItemStyle-CssClass="_grid_text_padding" ItemStyle-HorizontalAlign="Center"/>--%>
                                <asp:TemplateField HeaderText="Row">
                                    <ItemStyle Width="100px" HorizontalAlign="Left" />
                                    <ItemTemplate>
                                        <asp:LinkButton ID="xname" runat="server" Text='<%#Eval("xrow") %>' OnClientClick='<%# String.Format("update(\"{0}\",\"{1}\");", Eval("xname"),Eval("xrow")) %>' CssClass="_gridrow_link"></asp:LinkButton>
                                    </ItemTemplate>
                                    <FooterTemplate>
                              ...
                              <%--  <asp:TemplateField HeaderText="Student Name">
                                ...
                                <asp:BoundField DataField="xname" HeaderText="Student's Name" ItemStyle-Width="200px" ItemStyle-CssClass="_grid_text_padding" HtmlEncode="False"/>
                                ...
                                <asp:BoundField DataField="xgender" HeaderText="Gender" ItemStyle-Width="150px" ItemStyle-CssClass="_grid_text_padding" HtmlEncode="False"/>
