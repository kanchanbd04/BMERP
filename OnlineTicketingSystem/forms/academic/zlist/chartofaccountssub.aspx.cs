...
{
    public partial class chartofaccountssub : System.Web.UI.Page
    {
        ...
        public void fnFillDataGrid()
        {
            ...
            dts.Reset();
            string str = "SELECT TOP " + _gridrow.Text.Trim().ToString() + "  xacc,xdesc,xsub,xdescsub, xdescsub,xacctype,xaccusage,xaccsource FROM glmstvw " +
                         "WHERE ( xsub like '%"+ filter +"%' or xdescsub like '%"+ filter +"%') " +
                         "and zid=@zid and zactive=1 and xaccsource<>'None' and xacc='"+xacc+"'";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //    //}
                ...
                xacc = Request.QueryString["xacc"] != "" ? Request.QueryString["xacc"] : "";
                if (!IsPostBack)
                {
                    //zid = Request.QueryString["zid"] != "" ? Request.QueryString["zid"] : "-1";
