<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="chartofaccounts.aspx.cs" Inherits="OnlineTicketingSystem.forms.BMERP.chartofaccounts"
                            ...
                            <asp:GridView ID="_grid_emp" runat="server" AutoGenerateColumns="False" ShowFooter="true"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="Code">
                                        ...
                                        <ItemTemplate>
                                            <asp:LinkButton ID="xacc" runat="server" Text='<%#Eval("xacc") %>' OnClientClick='<%# String.Format("update(\"{0}\",\"{1}\");", Eval("xacc"),Eval("xdesc")) %>' CssClass="_gridrow_link"></asp:LinkButton>
                                        </ItemTemplate>
                                      <%--  <FooterTemplate>
