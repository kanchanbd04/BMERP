<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="studentlist2.aspx.cs" Inherits="OnlineTicketingSystem.forms.BMERP.studentlist2"
                        ...
                        <div class="grid_body">
                            <asp:GridView ID="_grid_emp" runat="server" AutoGenerateColumns="False" ShowFooter="true"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="xstdid" HeaderText="ID" ItemStyle-Width="100px" ItemStyle-CssClass="_grid_text_padding" />
