...
namespace OnlineTicketingSystem.forms.BMERP
{
    public partial class openlist : System.Web.UI.Page
    {
        ...
        public void fnFillDataGrid()
        {
            ...
            dts.Reset();
            string str = "SELECT distinct TOP " + _gridrow.Text.Trim().ToString() + "  " + xfield + " as xcode FROM " + xtable + " WHERE (" + xfield + " like '%" + filter + "%') and zid=@zid";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //    //}
                ...
                if (!IsPostBack)
                {
                    ...
                    xtable = Request.QueryString["xtable"] != "" ? Request.QueryString["xtable"] : "table";
                    xfield = Request.QueryString["xfield"] != "" ? Request.QueryString["xfield"] : "field";
                    //filter = Request.QueryString["filter"] != "" ? Request.QueryString["filter"] : "";
                    ctlid_v.Value = ctlid;
