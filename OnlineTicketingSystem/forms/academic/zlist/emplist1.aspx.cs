...
{
    public partial class emplist1 : System.Web.UI.Page
    {
        ...
        public void fnFillDataGrid()
        {
            ...
            dts.Reset();
            string str = "SELECT TOP " + _gridrow.Text.Trim().ToString() + "  xemp,xname FROM hrmst WHERE (xemp like '%" + filter + "%' or xname like '%" + filter + "%') and zid=@zid and xstatusemp='A-Active'";
