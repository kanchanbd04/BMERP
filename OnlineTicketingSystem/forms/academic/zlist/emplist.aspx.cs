...
namespace OnlineTicketingSystem.forms.BMERP
{
    public partial class emplist : System.Web.UI.Page
    {
        ...
        public void fnFillDataGrid()
        {
            ...
            dts.Reset();
            string str = "SELECT TOP " + _gridrow.Text.Trim().ToString() + "  xemp,xname,xfather FROM hrmst WHERE (xemp like '%" + filter + "%' or xname like '%" + filter + "%') and zid=@zid and xstatusemp='A-Active'";
