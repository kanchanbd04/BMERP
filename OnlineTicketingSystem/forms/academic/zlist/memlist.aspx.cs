...
namespace OnlineTicketingSystem.forms.BMERP
{
    public partial class memlist : System.Web.UI.Page
    {
        ...
        public void fnFillDataGrid()
        {
            ...
            dts.Reset();
            string str = "SELECT TOP " + _gridrow.Text.Trim().ToString() + "  xlbmemcode,xname,xtype FROM lbmemlistvw WHERE (xlbmemcode like '%" + filter + "%' or xname like '%" + filter + "%') and zid=@zid ";
