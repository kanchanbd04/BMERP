<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="commentslist.aspx.cs" Inherits="OnlineTicketingSystem.forms.BMERP.commentslist"
                        ...
                        <asp:GridView ID="_grid_emp" runat="server" AutoGenerateColumns="False" ShowFooter="true"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="Comments">
                                    ...
                                    <ItemTemplate>
                                        <asp:LinkButton ID="xcode" runat="server" Text='<%#Eval("xdescdet") %>' OnClientClick='<%# String.Format("update(\"{0}\");", Eval("xdescdet")) %>' CssClass="_gridrow_link"></asp:LinkButton>
                                    </ItemTemplate>
                                    <FooterTemplate>
