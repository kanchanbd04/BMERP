<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="booklist5.aspx.cs" Inherits="OnlineTicketingSystem.forms.BMERP.booklist5"
                            ...
                            <asp:GridView ID="_grid_emp" runat="server" AutoGenerateColumns="False" ShowFooter="true"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="Code">
                                        ...
                                        <ItemTemplate>
                                            <asp:LinkButton ID="xlbord" runat="server" Text='<%#Eval("xlbord") %>' OnClientClick='<%# String.Format("update(\"{0}\",\"{1}\");", Eval("xlbord"),Eval("xlbtitle")) %>' CssClass="_gridrow_link"></asp:LinkButton>
                                        </ItemTemplate>
                                        <FooterTemplate>
