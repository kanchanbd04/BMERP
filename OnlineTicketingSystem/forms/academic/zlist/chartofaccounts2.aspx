<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="chartofaccounts2.aspx.cs" Inherits="OnlineTicketingSystem.forms.BMERP.chartofaccounts2"
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function update(updstr,updstr1,updstr2) {
            //alert("Hi");
            //alert(updstr);
            ...
            window.opener.update10(updstr, updstr1, updstr2,updstr, ctlid, ctlid1, ctlid2, ctlid3);
            self.close();
        }
    </script>
</head>
                                ...
                                PagerStyle-CssClass="PagerStyle" GridLines="None">
                                 <Columns>
                                    <asp:TemplateField HeaderText="Account">
                                        ...
                                        <ItemTemplate>
                                            <asp:LinkButton ID="xsub" runat="server" Text='<%#Eval("xsub") %>' OnClientClick='<%# String.Format("update(\"{0}\",\"{1}\",\"{2}\");", Eval("xsub"),Eval("xdesc1"),Eval("xacc")) %>' CssClass="_gridrow_link"></asp:LinkButton>
                                        </ItemTemplate>
                                      <%--  <FooterTemplate>
                                            <asp:Label ID="footerlabel" Text="Total" CssClass="footer_label_total" runat="server" />
                                        </FooterTemplate>--%>
                                    </asp:TemplateField>
                                    <asp:BoundField DataField="xdescsub" HeaderText="Description" ItemStyle-Width="150px" ItemStyle-CssClass="_grid_text_padding" />
