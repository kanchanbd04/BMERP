<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="chartofaccountssub.aspx.cs" Inherits="OnlineTicketingSystem.forms.BMERP.chartofaccountssub"
                                ...
                                PagerStyle-CssClass="PagerStyle" GridLines="None">
                                 <Columns>
                                    <asp:TemplateField HeaderText="Account">
                                        ...
                                        <ItemTemplate>
                                            <asp:LinkButton ID="xsub" runat="server" Text='<%#Eval("xsub") %>' OnClientClick='<%# String.Format("update(\"{0}\",\"{1}\");", Eval("xsub"),Eval("xdescsub")) %>' CssClass="_gridrow_link"></asp:LinkButton>
                                        </ItemTemplate>
                                      <%--  <FooterTemplate>
