<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="memlist.aspx.cs" Inherits="OnlineTicketingSystem.forms.BMERP.memlist"
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function update(updstr, updstr1, updstr2) {
            ...
            window.opener.update51(updstr, ctlid, updstr1, ctlid1, updstr2, ctlid2);
            self.close();
        }
    </script>
</head>
                            ...
                            <asp:GridView ID="_grid_emp" runat="server" AutoGenerateColumns="False" ShowFooter="true"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="Emp. ID">
                                        ...
                                        <ItemTemplate>
                                            <asp:LinkButton ID="xlbmemcode" runat="server" Text='<%#Eval("xlbmemcode") %>' OnClientClick='<%# String.Format("update(\"{0}\",\"{1}\",\"{2}\");", Eval("xlbmemcode"),Eval("xname"),Eval("xtype")) %>' CssClass="_gridrow_link"></asp:LinkButton>
                                        </ItemTemplate>
                                        <FooterTemplate>
                                    ...
                                    <asp:BoundField DataField="xtype" HeaderText="Type" ItemStyle-Width="100px" ItemStyle-CssClass="_grid_text_padding" ItemStyle-HorizontalAlign="Center"/>
