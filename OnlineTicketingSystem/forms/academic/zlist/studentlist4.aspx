<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="studentlist4.aspx.cs" Inherits="OnlineTicketingSystem.forms.BMERP.studentlist4"
                            ...
                            <asp:GridView ID="_grid_emp" runat="server" AutoGenerateColumns="False" ShowFooter="true"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="Ref.">
                                        ...
                                        <ItemTemplate>
                                            <asp:LinkButton ID="xcode" runat="server" Text='<%#Eval("xrow") %>' OnClientClick='<%# String.Format("update(\"{0}\");", Eval("xstdid")) %>' CssClass="_gridrow_link"></asp:LinkButton>
                                        </ItemTemplate>
                                        <FooterTemplate>
