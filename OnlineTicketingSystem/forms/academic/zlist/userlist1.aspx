<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="userlist1.aspx.cs" Inherits="OnlineTicketingSystem.forms.BMERP.userlist1"
                            ...
                            <asp:GridView ID="_grid_emp" runat="server" AutoGenerateColumns="False" ShowFooter="true"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="User ID">
                                        ...
                                        <ItemTemplate>
                                            <asp:LinkButton ID="xuser" runat="server" Text='<%#Eval("xuser") %>' OnClientClick='<%# String.Format("update(\"{0}\",\"{1}\");", Eval("xuser"),Eval("xusername")) %>' CssClass="_gridrow_link"></asp:LinkButton>
                                        </ItemTemplate>
                                        <FooterTemplate>
                                            <asp:Label ID="footerlabel" Text="Total" CssClass="footer_label_total" runat="server" />
                                        </FooterTemplate>
                                    </asp:TemplateField>
                                    <asp:BoundField DataField="xusername" HeaderText="User Name" ItemStyle-Width="250px" ItemStyle-CssClass="_grid_text_padding" />
                                    <asp:BoundField DataField="xempcode" HeaderText="Emp. Code" ItemStyle-Width="120px" ItemStyle-CssClass="_grid_text_padding" />
                                    <asp:BoundField DataField="xrole" HeaderText="Role" ItemStyle-Width="120px" ItemStyle-CssClass="_grid_text_padding" />
