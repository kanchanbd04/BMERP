<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="payscale.aspx.cs" Inherits="OnlineTicketingSystem.forms.BMERP.payscale"
                            ...
                            <asp:GridView ID="_grid_emp" runat="server" AutoGenerateColumns="False" ShowFooter="true"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="Code">
                                        ...
                                        <ItemTemplate>
                                            <asp:LinkButton ID="xpsclcode" runat="server" Text='<%#Eval("xpsclcode") %>' OnClientClick='<%# String.Format("update(\"{0}\",\"{1}\");", Eval("xpsclcode"),Eval("xdesc")) %>' CssClass="_gridrow_link"></asp:LinkButton>
                                        </ItemTemplate>
                                      <%--  <FooterTemplate>
