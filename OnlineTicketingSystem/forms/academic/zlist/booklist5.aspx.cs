...
{
    public partial class booklist5 : System.Web.UI.Page
    {
        ...
        public void fnFillDataGrid()
        {
            ...
            dts.Reset();
            string str = "SELECT TOP " + _gridrow.Text.Trim().ToString() + "  * FROM lbbook WHERE (xlbord like N'%" + filter + "%' or xlbtitle like N'%" + filter + "%') and zid=@zid ";
