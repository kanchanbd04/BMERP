...
{
    public partial class paycodeadv : System.Web.UI.Page
    {
        ...
        public void fnFillDataGrid()
        {
            ...
            dts.Reset();
            string str = "SELECT TOP " + _gridrow.Text.Trim().ToString() + "  xpaycode,xdesc FROM prpayhead WHERE (xpaycode like '%" + filter + "%' or xdesc like '%" + filter + "%') and zid=@zid and xoption='Advance'";
