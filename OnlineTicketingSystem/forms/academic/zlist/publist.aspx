<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="publist.aspx.cs" Inherits="OnlineTicketingSystem.forms.BMERP.publist"
                            ...
                            <asp:GridView ID="_grid_emp" runat="server" AutoGenerateColumns="False" ShowFooter="true"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="Ref.">
                                        ...
                                        <ItemTemplate>
                                            <asp:LinkButton ID="xlbpubcode" runat="server" Text='<%#Eval("xlbpubcode") %>' OnClientClick='<%# String.Format("update(\"{0}\",\"{1}\");", Eval("xlbpubcode"),Eval("xname")) %>' CssClass="_gridrow_link"></asp:LinkButton>
                                        </ItemTemplate>
                                        <FooterTemplate>
