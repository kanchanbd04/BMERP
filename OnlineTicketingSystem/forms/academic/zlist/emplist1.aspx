<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="emplist1.aspx.cs" Inherits="OnlineTicketingSystem.forms.BMERP.emplist1"
                            ...
                            <asp:GridView ID="_grid_emp" runat="server" AutoGenerateColumns="False" ShowFooter="true"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="Emp. ID">
                                        ...
                                        <ItemTemplate>
                                            <asp:LinkButton ID="xemp" runat="server" Text='<%#Eval("xemp") %>' OnClientClick='<%# String.Format("update(\"{0}\",\"{1}\");", Eval("xemp"),Eval("xname")) %>' CssClass="_gridrow_link"></asp:LinkButton>
                                        </ItemTemplate>
                                        <FooterTemplate>
