...
namespace OnlineTicketingSystem.forms.BMERP
{
    public partial class commentslist : System.Web.UI.Page
    {
        ...
        public void fnFillDataGrid()
        {
            ...
            dts.Reset();
            string str = "SELECT TOP " + _gridrow.Text.Trim().ToString() + "  xcode,xdescdet FROM mscodesam WHERE (xcode like '%" + filter + "%') and zid=@zid and xtype='Comments' and zactive=1 order by xcodealt";
