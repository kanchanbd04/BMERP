...
namespace OnlineTicketingSystem.forms.BMERP
{
    public partial class chartofaccounts : System.Web.UI.Page
    {
        ...
        public void fnFillDataGrid()
        {
            ...
            dts.Reset();
            string str = "SELECT TOP " + _gridrow.Text.Trim().ToString() + "  xacc,xdesc,xacctype,xaccusage,xaccsource FROM glmst WHERE (xacc like '%" + filter + "%' or xdesc like '%" + filter + "%') and zid=@zid and zactive=1";
