...
{
    public partial class emplist2 : System.Web.UI.Page
    {
        ...
        public void fnFillDataGrid()
        {
            ...
            dts.Reset();
            string str = "SELECT TOP " + _gridrow.Text.Trim().ToString() + "  xemp,xname,xfather FROM hrmst WHERE (xemp like '%" + filter + "%' or xname like '%" + filter + "%') and zid=@zid and xstatusemp='A-Active' and xtype='"+ xtype +"'";
            //string str = "SELECT TOP " + _gridrow.Text.Trim().ToString() + "  xemp,xname,xfather FROM hrmst WHERE (xemp like '%" + filter + "%' or xname like '%" + filter + "%') and zid=@zid";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //    //}
                ...
                xtype = Request.QueryString["type"] != "" ? Request.QueryString["type"] : "";
                if (!IsPostBack)
                {
                    //zid = Request.QueryString["zid"] != "" ? Request.QueryString["zid"] : "-1";
