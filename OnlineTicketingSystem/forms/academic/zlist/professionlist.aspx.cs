...
{
    public partial class professionlist : System.Web.UI.Page
    {
        ...
        public void fnFillDataGrid()
        {
            ...
            dts.Reset();
            string str = "SELECT TOP " + _gridrow.Text.Trim().ToString() + "  xcode FROM mscodesam WHERE (xcode like '%" + filter + "%') and zid=@zid and xtype='Profession' and zactive=1";
