...
namespace OnlineTicketingSystem.forms.BMERP
{
    public partial class studentlist : System.Web.UI.Page
    {
        ...
        public void fnFillDataGrid()
        {
            ...
            string str = "SELECT TOP " + _gridrow.Text.Trim().ToString() + "  xrow,xsession,xclass,xname,(xmname + '<br>' + xcellno) as xmname,(xfname + '<br>' + xcellno1) as xfname,xgender FROM amadmis WHERE (xclass = '" + xclass + "' and xsession = '" + xsession + "' and xname like '%" + xname + "%') and zid=@zid AND coalesce(xstatus3,'')<>'Revised' ";
