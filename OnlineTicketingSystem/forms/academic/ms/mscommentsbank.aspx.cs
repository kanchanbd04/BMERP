...
{
    public partial class mscommentsbank : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
         ...
         //           btnPaid1.Visible = false;
                    ...
                    xtype.Items.Add("");
                    xtype.Items.Add("Class Test Comments");
                    xtype.Items.Add("Subject Comments");
                    xtype.Items.Add("Overall Comments");
...
//                                           FROM amclasssubh WHERE zid=@zid AND xclass=@xclass order by  xsubject";
                    ...
                    string query = "SELECT * FROM mscommentsbank where zid=@zid and xclass=@xclass and xsubject=@xsubject and xcat1=@xcat1 and xcat2=@xcat2 and xtype=@xtype";
                    ...
                    da.SelectCommand.Parameters.AddWithValue("@xcat1", xcat1.Text.ToString().Trim());
                    da.SelectCommand.Parameters.AddWithValue("@xcat2", xcat2.Text.ToString().Trim());
            ...
            using (SqlConnection con = new SqlConnection(zglobal.constring))
            {
                ...
                {
                    con.Open();
                    string query = "SELECT * FROM mscommentsbank where zid=@zid order by xclass,xtype,xsubject,xcat1,xcat2";
        ...
        private void fnFillControl(string xrow123)
        {
            ...
            string str = "Select * from mscommentsbank where zid=@zid  and xrow=@xrow";
            ...
            xcat1.Text = dttemp.Rows[0]["xcat1"].ToString();
            xcat2.Text = dttemp.Rows[0]["xcat2"].ToString();
            xcomments.Value = dttemp.Rows[0]["xcomments"].ToString();
            ...
            try
            {
                ...
                using (TransactionScope tran = new TransactionScope())
                {
                    using (SqlConnection conn = new SqlConnection(zglobal.constring))
                    {
                        ...
                        string query =
                                    "INSERT INTO mscommentsbank (ztime,zid,xrow,xclass,xsubject,xcat1,xcat2,xcomments,xtype,zemail) " +
                                    "VALUES(@ztime,@zid,@xrow,@xclass,@xsubject,@xcat1,@xcat2,@xcomments,@xtype,@zemail) ";

                        xrow = zglobal.GetMaximumIdInt("xrow", "mscommentsbank", " zid=" + _zid, 1, 1);
                        ViewState["xrow"] = xrow;
                        ...
                        cmd.Parameters.AddWithValue("@xsubject", xsubject1);
                        cmd.Parameters.AddWithValue("@xcat1", xcat1.Text.Trim().ToString());
                        cmd.Parameters.AddWithValue("@xcat2", xcat2.Text.Trim().ToString());
                        cmd.Parameters.AddWithValue("@xcomments", xcomments.Value.Trim().ToString());
                        cmd.Parameters.AddWithValue("@xtype", xtype.Text.Trim().ToString());
                        cmd.Parameters.AddWithValue("@zemail", zemail);
                        cmd.ExecuteNonQuery();
                ...
                if (txtconformmessageValue1.Value == "Yes")
                {
                    using (TransactionScope tran = new TransactionScope())
                    {
                        using (SqlConnection conn = new SqlConnection(zglobal.constring))
                        {
                            ...
                            string query = "DELETE FROM mscommentsbank WHERE zid=@zid AND xrow=@xrow";
                            cmd.Parameters.Clear();

                            cmd.CommandText = query;
                            cmd.Parameters.AddWithValue("@zid", _zid);
                            cmd.Parameters.AddWithValue("@xrow", Convert.ToInt32(GridView1.Rows[rowID].Cells[8].Text));
                            cmd.ExecuteNonQuery();
        ...
        protected void ImageButton2_OnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                fnFillControl(GridView1.Rows[rowID].Cells[8].Text);
        ...
        protected void btnUpdateComments_OnClick(object sender, EventArgs e)
        {
            try
            {
                message.InnerText = "";
                ...
                using (TransactionScope tran = new TransactionScope())
                {
                    using (SqlConnection conn = new SqlConnection(zglobal.constring))
                    {
                        ...
                        string query =
                                    "UPDATE mscommentsbank SET zutime=@ztime,xclass=@xclass,xsubject=@xsubject,xcat1=@xcat1,xcat2=@xcat2,xcomments=@xcomments,xtype=@xtype,xemail=@zemail " +
                                    "where zid=@zid and xrow=@xrow ";
