...
{
    public partial class mscodes_am_evn : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                using (TransactionScope tran = new TransactionScope())
                {
                    using (SqlConnection conn = new SqlConnection(zglobal.constring))
                    {
                        ...
                        string xcodealt1 = xcodealt.SelectedValue.ToString().Trim();
        ...
        public void fnFillDataGrid()
        {
            ...
            da.SelectCommand.Parameters.AddWithValue("@xtype", xtype1);
            da.SelectCommand.Parameters.AddWithValue("@xcodealt", xcodealt.SelectedValue.ToString().Trim());
            da.Fill(dts, "tempztcode");
