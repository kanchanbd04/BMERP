    ...
    public partial class msitem : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!IsPostBack)
                {
                    ...
                    zglobal.fnGetComboDataCD("Currency", xcurcost);
                    zglobal.fnGetComboDataCD("Currency", xcurprice);
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (xitem.Text == "" || xitem.Text == string.Empty || xitem.Text == "[Select]")
                {
                    rtnMessage = rtnMessage + "<li>Item Code</li>";
                    isValid = false;
                }
                if (xdesc.Text == "" || xdesc.Text == string.Empty || xdesc.Text == "[Select]")
                {
                    rtnMessage = rtnMessage + "<li>Item Description</li>";
                    isValid = false;
                }
                ...
                if (xglevel2.Text == "" || xglevel2.Text == string.Empty || xglevel2.Text == "[Select]")
                {
                    rtnMessage = rtnMessage + "<li>Item Class</li>";
                    isValid = false;
                }
                if (xstype.Text == "" || xstype.Text == string.Empty || xstype.Text == "[Select]")
                {
                    rtnMessage = rtnMessage + "<li>Stock Type</li>";
                    isValid = false;
                }
                if (xunitstk.Text == "" || xunitstk.Text == string.Empty || xunitstk.Text == "[Select]")
                {
                    rtnMessage = rtnMessage + "<li>Stocking Unit</li>";
                    isValid = false;
                }
                ...
                using (TransactionScope tran = new TransactionScope())
                {
                    ...
                    if (ViewState["xitem"] == null)
                    {
                        ...
                        using (SqlConnection con = new SqlConnection(zglobal.constring))
                        {
                            using (DataSet dts = new DataSet())
                            {
                                con.Open();
                                string query =
                                    "SELECT * FROM msitem WHERE zid=@zid AND xdesc=@xdesc and xglevel1=@xglevel1 and xglevel2=@xglevel2 and xglevel3=@xglevel3";

                                SqlDataAdapter da = new SqlDataAdapter(query, con);

                                da.SelectCommand.Parameters.AddWithValue("@zid", _zid);
                                da.SelectCommand.Parameters.AddWithValue("@xdesc", xdesc.Text.ToString().Trim());
                                ...
                                da.SelectCommand.Parameters.AddWithValue("@xglevel3", xglevel3.Text.ToString().Trim());
                        ...
                        using (SqlConnection conn = new SqlConnection(zglobal.constring))
                        {
                            ...
                            string query =
                               "INSERT INTO msitem (ztime,zid,xitem,xdesc,xglevel1,xglevel2,xglevel3,xglevel4,xunitstk,xunitpur,xcfpur,xunitiss,xcfiss,xunitsel,xcfsel,xcostmeth,xstype,xstdprice," +
                               "xstdcost,xcurprice,xcurcost,xstatusitem,xitemfaflag,zemail,xitemset) " +
                               "VALUES(@ztime,@zid,@xitem,@xdesc,@xglevel1,@xglevel2,@xglevel3,@xglevel4,@xunitstk,@xunitpur,@xcfpur,@xunitiss,@xcfiss,@xunitsel,@xcfsel,@xcostmeth,@xstype,@xstdprice, " +
                               "@xstdcost,@xcurprice,@xcurcost,@xstatusitem,@xitemfaflag,@zemail,@xitemset) ";
                            ...
                            xitem1 = xitem.Text.Trim().ToString();
                            ViewState["xitem"] = xitem1;
                            xitemm = xitem1;

                            xdesc1 = xdesc.Text.ToString().Trim();
                            xglevel11 = xglevel1.Text.ToString().Trim();
                            xglevel21 = xglevel2.Text.ToString().Trim();
                            xglevel31 = xglevel3.Text.ToString().Trim();
                            xglevel41 = xglevel4.Text.ToString().Trim();
                            xunitstk1 = xunitstk.Text.ToString().Trim();
                            xunitpur1 = xunitpur.Text.ToString().Trim();
                            xcfpur1 = Convert.ToDecimal(xcfpur.Text.ToString().Trim() == "" ? "0" : xcfpur.Text.ToString().Trim());
                            xunitiss1 = xunitiss.Text.Trim().ToString();
                            xcfiss1 = Convert.ToDecimal(xcfiss.Text.Trim().ToString() == "" ? "0" : xcfiss.Text.ToString().Trim());
                            xunitsel1 = xunitsel.Text.Trim().ToString();
                            xcfsel1 = Convert.ToDecimal(xcfsel.Text.Trim().ToString() == "" ? "0" : xcfsel.Text.ToString().Trim());
                            xcostmeth1 = xcostmeth.SelectedItem.Text.Trim().ToString();
                            xstype1 = xstype.Text.Trim().ToString();
                            xstdprice1 = Convert.ToDecimal(xstdprice.Text.Trim().ToString() == "" ? "0" : xstdprice.Text.ToString().Trim());
                            xstdcost1 = Convert.ToDecimal(xstdcost.Text.Trim().ToString() == "" ? "0" : xstdcost.Text.ToString().Trim());
                            xcurprice1 = xcurprice.Text.ToString();
                            xcurcost1 = xcurcost.Text.ToString();
                            xstatusitem1 = xstatusitem.SelectedItem.Text.Trim().ToString();
                            xitemfaflag1 = xitemfaflag.Text.ToString();

                            cmd.CommandText = query;
                            cmd.Parameters.AddWithValue("@ztime", ztime);
                            cmd.Parameters.AddWithValue("@zid", _zid);
                            cmd.Parameters.AddWithValue("@xitem", xitem1);
                            cmd.Parameters.AddWithValue("@xdesc", xdesc1);
                            cmd.Parameters.AddWithValue("@xglevel1", xglevel11);
                            cmd.Parameters.AddWithValue("@xglevel2", xglevel21);
                            cmd.Parameters.AddWithValue("@xglevel3", xglevel31);
                            cmd.Parameters.AddWithValue("@xglevel4", xglevel41);
                            cmd.Parameters.AddWithValue("@xunitstk", xunitstk1);
                            cmd.Parameters.AddWithValue("@xunitpur", xunitpur1);
                            cmd.Parameters.AddWithValue("@xcfpur", xcfpur1);
                            cmd.Parameters.AddWithValue("@xunitiss", xunitiss1);
                            cmd.Parameters.AddWithValue("@xcfiss", xcfiss1);
                            cmd.Parameters.AddWithValue("@xunitsel", xunitsel1);
                            cmd.Parameters.AddWithValue("@xcfsel", xcfsel1);
                            cmd.Parameters.AddWithValue("@xcostmeth", xcostmeth1);
                            cmd.Parameters.AddWithValue("@xstype", xstype1);
                            cmd.Parameters.AddWithValue("@xstdprice", xstdprice1);
                            cmd.Parameters.AddWithValue("@xstdcost", xstdcost1);
                            cmd.Parameters.AddWithValue("@xcurprice", xcurprice1);
                            cmd.Parameters.AddWithValue("@xcurcost", xcurcost1);
                            cmd.Parameters.AddWithValue("@xstatusitem", xstatusitem1);
                            cmd.Parameters.AddWithValue("@xitemfaflag", xitemfaflag1);
                            cmd.Parameters.AddWithValue("@zemail", zemail1);
                            cmd.Parameters.AddWithValue("@xitemset", xitemset.Text.Trim().ToString());
                            cmd.ExecuteNonQuery();
                        }
                    }
                    ...
                    using (SqlConnection conn = new SqlConnection(zglobal.constring))
                    {
                        ...
                        if (xitemm == "")
                        {
                            ...
                            query = "UPDATE msitem SET zutime=@zutime,xemail=@xemail, xdesc=@xdesc, " +
                                    "xglevel1=@xglevel1,xglevel2=@xglevel2,xglevel3=@xglevel3,xglevel4=@xglevel4,xunitstk=@xunitstk,xunitpur=@xunitpur,xcfpur=@xcfpur," +
                                   "xunitiss=@xunitiss,xcfiss=@xcfiss," +
                                    "xunitsel=@xunitsel,xcfsel=@xcfsel,xcostmeth=@xcostmeth,xstype=@xstype,xstdprice=@xstdprice,xstdcost=@xstdcost,xcurprice=@xcurprice, " +
                                    "xcurcost=@xcurcost, xstatusitem=@xstatusitem,xitemfaflag=@xitemfaflag,xitemset=@xitemset " +
                            ...
                            cmd.CommandText = query;
                            cmd.Parameters.AddWithValue("@zid", _zid);
                            cmd.Parameters.AddWithValue("@xitem", ViewState["xitem"].ToString());
                ...
                xitem.Text = ViewState["xitem"].ToString();
                fnButtonState();
                fnFillGrid2();
        ...
        private void fnFillGrid2()
        {
            ...
            using (SqlConnection con = new SqlConnection(zglobal.constring))
            {
                using (DataSet dts1 = new DataSet())
                {
                    con.Open();
                    string query =
                         "SELECT Top " + Int32.Parse(_gridrow.Text.Trim().ToString()) + " xitem,xdesc,xglevel1 " +
                         "FROM msitem WHERE zid=@zid and xglevel1=@xglevel1 " +
                         "order by xglevel1,xdesc asc";

                    SqlDataAdapter da1 = new SqlDataAdapter(query, con);

                    da1.SelectCommand.Parameters.AddWithValue("@zid", _zid);
                    da1.SelectCommand.Parameters.AddWithValue("@xglevel1", xglevel1.Text.Trim().ToString());
        ...
        protected void FillControl2(object sender, EventArgs e)
        {
            try
            {
                ...
                if (xitem.Text.Trim().ToString() != String.Empty)
                {
                    fnFillControl(xitem.Text.Trim().ToString());
                    fnFillGrid2();
                }
                else
                {
                    message.InnerHtml = "Enter item code.";
        ...
        private void fnFillControl(string xitem1)
        {
            message.InnerHtml = "";
            ...
            SqlDataAdapter da = new SqlDataAdapter(str, conn1);
            da.SelectCommand.Parameters.AddWithValue("@zid", _zid);
            da.SelectCommand.Parameters.AddWithValue("@xitem", xitem1);
            da.Fill(dts, "tempztcode");
            ...
            {
                message.InnerHtml = "Wrong item code.";
                message.Style.Value = zglobal.am_warningmsg;
                
                return;
            }

            ViewState["xitem"] = xitem1.ToString();
            //hiddenxrow.Value = ViewState["xrow"].ToString();

            xitem.Text = dttemp.Rows[0]["xitem"].ToString();
            xdesc.Text = dttemp.Rows[0]["xdesc"].ToString();
            xglevel1.Text = dttemp.Rows[0]["xglevel1"].ToString();
            xglevel2.Text = dttemp.Rows[0]["xglevel2"].ToString();
            xglevel3.Text = dttemp.Rows[0]["xglevel3"].ToString();
            xglevel4.Text = dttemp.Rows[0]["xglevel4"].ToString();
            xunitstk.Text = dttemp.Rows[0]["xunitstk"].ToString();
            ...
            xunitpur.Text = dttemp.Rows[0]["xunitpur"].ToString();
            //xchqdate.Text = Convert.ToDateTime(dttemp.Rows[0]["xchqdate"]).ToString("dd/MM/yyyy");
            //xchqno.Text = dttemp.Rows[0]["xchqno"].ToString();
            xcfpur.Text = dttemp.Rows[0]["xcfpur"].ToString();
            xunitiss.Text = dttemp.Rows[0]["xunitiss"].ToString();
            xcfiss.Text = dttemp.Rows[0]["xcfiss"].ToString();
            xunitsel.Text = dttemp.Rows[0]["xunitsel"].ToString();
            xcfsel.Text = dttemp.Rows[0]["xcfsel"].ToString();
            xcostmeth.Text = dttemp.Rows[0]["xcostmeth"].ToString();
            xstype.Text = dttemp.Rows[0]["xstype"].ToString();
            xstdprice.Text = dttemp.Rows[0]["xstdprice"].ToString();
            xstdcost.Text = dttemp.Rows[0]["xstdcost"].ToString();
            xcurprice.Text = dttemp.Rows[0]["xcurprice"].ToString();
            xcurcost.Text = dttemp.Rows[0]["xcurcost"].ToString();
            xstatusitem.Text = dttemp.Rows[0]["xstatusitem"].ToString();
            xitemfaflag.Text = dttemp.Rows[0]["xitemfaflag"].ToString();
            zemail.Text = dttemp.Rows[0]["zemail"].ToString();
            xemail.Text = dttemp.Rows[0]["xemail"].ToString();
            xitemset.Text = dttemp.Rows[0]["xitemset"].ToString();
                    ...
                    if (txtconformmessageValue1.Value == "Yes")
                    {
                        ...
                        using (TransactionScope tran = new TransactionScope())
                        {
                            using (SqlConnection conn = new SqlConnection(zglobal.constring))
                            {
                                ...
                                string query = "DELETE FROM msitem WHERE zid=@zid AND xitem=@xitem";
                                cmd.Parameters.Clear();
