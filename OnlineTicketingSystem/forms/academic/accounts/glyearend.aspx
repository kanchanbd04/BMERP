<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="glyearend.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.glyearend" %>
        ...
        <ContentTemplate>--%>
          ...
          //gridviewScroll();
            ...
            $('#<%=GridView1.ClientID%>').gridviewScroll({
                ...
                //});
                    $("body").on("click",".bm_xsubcpv",function () {
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Year End Process</span>
                    </div>
                </div>
                    ...
                    <div class="bm_academic_container_body_button_section">
                        <div class="button_section_padding" style="border-bottom: 0px; padding-bottom: 0px">
                            <div class="button_section_style1" style="text-align: left; margin-bottom: 5px;">
                                ...
                                <asp:Button ID="btnSave" runat="server" Text="Process" CssClass="bm_academic_button3 bm_am_btn_save"
                            ...
                            <div class="bm_layout_box_100">
                              ...
                              <%--  </div>--%>
                                <div class="bm_layout_box_padding" style="padding-top: 0px;">
                                    ...
                                    <div style="display: inline-block; width: 500px; font-size: 14px; vertical-align: top; color: #0000ff; min-height: 300px;">
                                        <table>
                                            <tr>
                                                <td style="text-align: right">Year</td>
                                                <td>:</td>
                                                <td>
                                                    <asp:TextBox ID="xyear" runat="server" CssClass=" bm_academic_textbox" Width="80"></asp:TextBox>
                                                </td>
                                            </tr>
                                            ...
                                            <td style="text-align: left">
                                                <span class="bm_span1">
                                                    <asp:TextBox ID="xacc" runat="server" Height="20px" Width="150px" CssClass="bm_text1"></asp:TextBox>
                                                </span>
                                                <span class="bm_span2">
                                                ...
                                                <span class="bm_span3">
                                                    <asp:Label ID="xacctitle" runat="server" Text="" CssClass="bm_label1"></asp:Label>
                                                </span>
                                            ...
                                            <tr>
                                                <td style="text-align: right">Voucher Prefix</td>
                                                <td>:</td>
                                                <td>
                                                    <asp:Label ID="xtrngl" runat="server" Text="OB--"></asp:Label>
                                                </td>
                                            </tr>
                                ...
                                <div class="button_section_padding">
                                    <div class="button_section_style1" style="text-align: left; margin-top: 10px;">
                                        <asp:Button ID="btnRefresh1" runat="server" Text="Refresh" CssClass="bm_academic_button3 bm_am_btn_refresh"
                                            OnClick="btnRefresh_Click" />
                                        <asp:Button ID="btnSave1" runat="server" Text="Process" CssClass="bm_academic_button3 bm_am_btn_save"
                                            OnClick="btnSave_Click" />
                                                    ...
                                                    <asp:TemplateField HeaderText="Date" >
                                                        ...
                                                        <ItemTemplate >
                                                            <asp:LinkButton ID="xdate" runat="server" Text='<%# Bind("xdate", "{0:dd/MM/yyyy}") %>' CssClass="_gridrow_link"
                                                                OnClick="FillControl" DataFormatString="{0:dd/MM/yyyy}"></asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>

                                                    <asp:BoundField DataField="xshift" HeaderText="Shift Code" 
                                                        ItemStyle-Width="120px" ItemStyle-HorizontalAlign="Center" />

                                                    <asp:BoundField DataField="xremark" HeaderText="Remarks" ItemStyle-Width="120px"
                                                        ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="pad5" HtmlEncode="False"/>

                                                    <asp:BoundField DataField="xstatus" HeaderText="Status" ItemStyle-Width="120px"
                                                        ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="pad5" />
