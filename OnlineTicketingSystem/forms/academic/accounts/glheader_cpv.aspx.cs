...
{
    public partial class glheader_cpv : System.Web.UI.Page
    {
            ...
            try
            {
                if (!IsPostBack)
                {
                    ...
                    else
                    {
                        ...
                        xacccr.Text = zglobal.fnGetValue("xsubcpv", "msdef",
                    "zid=" + Convert.ToInt32(Convert.ToString(HttpContext.Current.Session["business"])));

                        hxacc.Value = zglobal.fnGetValue("xacccpv", "msdef",
                            "zid=" + Convert.ToInt32(Convert.ToString(HttpContext.Current.Session["business"])));

                        hxsub.Value = zglobal.fnGetValue("xsubcpv", "msdef",
                            "zid=" + Convert.ToInt32(Convert.ToString(HttpContext.Current.Session["business"])));
                    }
                ...
                //xacccr.Text = "10101101";
                //hxacc.Value = "10101101";
                //hxsub.Value = "10101101";
        ...
        private void fnCalculateTotal()
        {
            ...
            GridView1.FooterRow.Cells[4].Text = (xamountcr1 + xprimecr1).ToString(zglobal.CurrecnyFormatSpecifier, zglobal.GetCultureInfo());
