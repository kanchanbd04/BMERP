...
{
    public partial class glheader_cont : System.Web.UI.Page
    {
                    ...
                    if (tempTable.Rows.Count > 0)
                    {
                        ...
                        foreach (GridViewRow row in GridView1.Rows)
                        {
                            ...
                            if (i < tempTable.Rows.Count)
                            {
                                ...
                                xdateclr1.Text = Convert.ToDateTime(tempTable.Rows[i]["xdateclr"].ToString()).ToString("dd/MM/yyyy");
