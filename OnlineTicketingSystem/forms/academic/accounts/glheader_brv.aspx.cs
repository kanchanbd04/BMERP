...
{
    public partial class glheader_brv : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!IsPostBack)
                {
                    ...
                    xpaytypedr.Items.Clear();
                    xpaytypedr.Items.Add("Cheque");
                    xpaytypedr.Items.Add("DD");
                    xpaytypedr.Items.Add("TT");
                    xpaytypedr.Items.Add("Online");
                    xpaytypedr.Items.Add("Pay Order");
                    xpaytypedr.Items.Add("Transfer");
                    xpaytypedr.Text = "Cheque";
                    ...
                    else
                    {
                        ...
                        xaccdr.Text = zglobal.fnGetValue("xsubbrv", "msdef",
                    "zid=" + Convert.ToInt32(Convert.ToString(HttpContext.Current.Session["business"])));

                        hxacc.Value = zglobal.fnGetValue("xaccbrv", "msdef",
                            "zid=" + Convert.ToInt32(Convert.ToString(HttpContext.Current.Session["business"])));

                        hxsub.Value = zglobal.fnGetValue("xsubbrv", "msdef",
                            "zid=" + Convert.ToInt32(Convert.ToString(HttpContext.Current.Session["business"])));
                    }
                ...
                xdescdr.Text = zglobal.fnGetValue("xdesc1", "glmstvw1",
        ...
        private void fnCalculateTotal()
        {
            ...
            decimal xprimedr1 = xamountcr1 - xamountdr1;
            xprimedr.Text = Convert.ToString(xprimedr1);

            GridView1.FooterRow.Cells[6].Text = (xamountdr1 + xprimedr1).ToString(zglobal.CurrecnyFormatSpecifier, zglobal.GetCultureInfo());
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //if (xprimedr.Text == "" || xprimedr.Text == string.Empty || xprimedr.Text == "[Select]")
                //{
                //    rtnMessage = rtnMessage + "<li>Amount</li>";
                //    isValid = false;
                //}
                if (xchequedr.Text == "" || xchequedr.Text == string.Empty || xchequedr.Text == "[Select]")
                {
                    rtnMessage = rtnMessage + "<li>Cheque/Ref No</li>";
                    isValid = false;
                }
                if (xdateclrdr.Text == "" || xdateclrdr.Text == string.Empty || xdateclrdr.Text == "[Select]")
                {
                ...
                if (xaccdr.Text.Trim().ToString() != hxsub.Value.ToString().Trim())
                {
                ...
                if (xprimedr.Text.Trim().ToString() != String.Empty)
                {
                    dramt = Convert.ToDecimal(xprimedr.Text.Trim().ToString());
                }
                        ...
                        foreach (GridViewRow row in GridView1.Rows)
                        {
                            ...
                            if (count == 1)
                            {
                                if (xprimedr.Text.Trim().ToString() != String.Empty)
                                {
                                    ...
                                    //xprime1 = Convert.ToDecimal(xprimedr.Text.Trim().ToString());
                                    //xcheque1 = xchequedr.Text.Trim().ToString();
                                    //xpaytype1 = xpaytypedr.Text.Trim().ToString();
                                    //xdateclr1 = xdateclrdr.Text.ToString().Trim() != string.Empty
                                    //? DateTime.ParseExact(xdateclrdr.Text.ToString().Trim(), "dd/MM/yyyy",
                                    //    CultureInfo.InvariantCulture)
                                    //: new DateTime(2999, 12, 31);
                                    ...
                                    cmd.Parameters.AddWithValue("@xprime", Convert.ToDecimal(xprimedr.Text.Trim().ToString()));
                                    cmd.Parameters.AddWithValue("@xbase", xexch1 * Convert.ToDecimal(xprimedr.Text.Trim().ToString()));
                                    cmd.Parameters.AddWithValue("@xacctype", xacctype1);
                                    cmd.Parameters.AddWithValue("@xcheque", xchequedr.Text.Trim().ToString());
                                    cmd.Parameters.AddWithValue("@xpaytype", xpaytypedr.Text.Trim().ToString());
                                    cmd.Parameters.AddWithValue("@xstatus", xstatus1);
                                    cmd.Parameters.AddWithValue("@xdateclr", xdateclrdr.Text.ToString().Trim() != string.Empty
                                    ? DateTime.ParseExact(xdateclrdr.Text.ToString().Trim(), "dd/MM/yyyy",
                                        CultureInfo.InvariantCulture)
                                    : new DateTime(2999, 12, 31));
                                    cmd.ExecuteNonQuery();
                            ...
                            if (xsub123.Text.Trim().ToString() != string.Empty)
                            {
                                if (count == 1)
                                {
                                    xrow1 = zglobal.GetMaximumIdInt("xrow", "gldetail",
                                    " zid=" + _zid + " and xvoucher='" + Convert.ToString(ViewState["xvoucher"] + "'"), "row");
                                }
        ...
        private void fnFillControl(string xrow123)
        {
                ...
                using (DataSet dts1 = new DataSet())
                {
                    ...
                    if (tempTable.Rows.Count > 0)
                    {
                        ...
                        foreach (DataRow row in tempTable.Rows)
                        {
                            ...
                            {
                                xaccdr.Text = tempTable.Rows[i]["xsub"].ToString();
                                xprimedr.Text = tempTable.Rows[i]["xamountcr"].ToString();
                                xdescdr.Text = tempTable.Rows[i]["xdesc"].ToString();
                                hxacc.Value = tempTable.Rows[i]["xacc"].ToString();
                                hxsub.Value = tempTable.Rows[i]["xsub"].ToString();
                                xpaytypedr.Text = tempTable.Rows[i]["xpaytype"].ToString();
                                xchequedr.Text = tempTable.Rows[i]["xcheque"].ToString();
                                xdateclrdr.Text = Convert.ToDateTime(tempTable.Rows[i]["xdateclr"].ToString()).ToString("dd/MM/yyyy");
                                if (xdateclrdr.Text == "31/12/2999")
                                {
                                    xdateclrdr.Text = "";
                                }
                            }
                        ...
                        foreach (GridViewRow row in GridView1.Rows)
                        {
                            ...
                            if (i < tempTable.Rows.Count)
                            {
                                ...
                                {
                                    xsub1.Text = tempTable.Rows[i+1]["xsub"].ToString();
                                    xdesc1.Text = tempTable.Rows[i+1]["xdesc"].ToString();
                                    xamountdr1.Text = tempTable.Rows[i+1]["xamountdr"].ToString();
                                    xamountcr1.Text = tempTable.Rows[i+1]["xamountcr"].ToString();
                                    xrem1.Text = tempTable.Rows[i+1]["xrem"].ToString();
                                    xacc1.Text = tempTable.Rows[i+1]["xacc"].ToString();
                                    xpaytype1.Text = tempTable.Rows[i+1]["xpaytype"].ToString();
                                    xcheque1.Text = tempTable.Rows[i+1]["xcheque"].ToString();
                                    xdateclr1.Text =
                                        Convert.ToDateTime(tempTable.Rows[i+1]["xdateclr"].ToString())
                                            .ToString("dd/MM/yyyy");
            ...
            if (dttemp.Rows[0]["xpostflag"].ToString() == "Posted")
            {
                ...
                xaccdr.Enabled = false;
                xprimedr.Enabled = false;
                xpaytypedr.Enabled = false;
                xchequedr.Enabled = false;
                xdateclrdr.Enabled = false;
            ...
            else
            {
                ...
                xpaytypedr.Enabled = true;
                xchequedr.Enabled = true;
                xdateclrdr.Enabled = true;
            }
