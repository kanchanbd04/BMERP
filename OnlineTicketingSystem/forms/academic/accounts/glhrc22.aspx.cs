...
{
    public partial class glhrc22 : Page
    {
        public int _zid;
        ...
        protected void FillControls(object sender, EventArgs e)
        {
            try
            {
                ...
                string str = "SELECT xhrc2,xlong FROM glhrc2 where zid=@zid and xhrc1=@xhrc1 and xhrc2=@xhrc2";
        ...
        public void fnFillDataGrid()
        {
            ...
            dts.Reset();
            string str = "SELECT xhrc2 FROM glhrc2 WHERE zid=@zid and xhrc1=@xhrc1";
            SqlDataAdapter da = new SqlDataAdapter(str, conn1);
            da.SelectCommand.Parameters.AddWithValue("@zid", _zid);
            da.SelectCommand.Parameters.AddWithValue("@xhrc1", ViewState["level1"]);
            da.Fill(dts, "tempztcode");
            ...
            if (dtztcode.Rows.Count > 0)
            {
                ...
                dts.Reset();
                str = "SELECT xhrc3 FROM glhrc3 WHERE zid=@zid and xhrc1=@xhrc1 and xhrc2=@xhrc2";
                da = new SqlDataAdapter(str, conn1);
                da.SelectCommand.Parameters.AddWithValue("@zid", _zid);
                da.SelectCommand.Parameters.AddWithValue("@xhrc1", ViewState["level1"]);
            ...
            try
            {
                    ...
                    using (TransactionScope tran = new TransactionScope())
                    {
                        using (SqlConnection conn = new SqlConnection(zglobal.constring))
                        {
                            ...
                            cmd.Connection = conn;
                            string query = "INSERT INTO glhrc2 (ztime,zid,xhrc1,xhrc2,xlong) " +
                                           "VALUES(@ztime,@zid,@xhrc1,@xhrc2,@xlong) ";
            ...
            try
            {
                    ...
                    using (TransactionScope tran = new TransactionScope())
                    {
                        using (SqlConnection conn = new SqlConnection(zglobal.constring))
                        {
                            ...
                            SqlCommand cmd = new SqlCommand();
                            cmd.Connection = conn;
                            string query = "UPDATE glhrc2 SET zutime=@zutime,xlong=@xlong " +
                                           "WHERE zid=@zid and xhrc1=@xhrc1 and xhrc2=@xhrc2";
                ...
                if (txtconformmessageValue.Value == "Yes")
                {
                    ...
                    using (TransactionScope tran = new TransactionScope())
                    {
                        using (SqlConnection conn = new SqlConnection(zglobal.constring))
                        {
                            ...
                            SqlCommand cmd = new SqlCommand();
                            cmd.Connection = conn;
                            string query = "DELETE FROM glhrc2 WHERE zid=@zid and xhrc1=@xhrc1 and xhrc2=@xhrc2";
                            string xhrc11 = ViewState["level1"].ToString();
                            string xhrc211 = xhrc2.Text.ToString().Trim(); 
                            cmd.Parameters.AddWithValue("@zid", _zid);
                            cmd.Parameters.AddWithValue("@xhrc1", xhrc11);
                            ...
                            query = "DELETE FROM glhrc3 WHERE zid=@zid and xhrc1=@xhrc1 and xhrc2=@xhrc2";
                            cmd.CommandText = query;
                            cmd.Parameters.AddWithValue("@zid", _zid);
                            cmd.Parameters.AddWithValue("@xhrc1", xhrc11);
                            cmd.Parameters.AddWithValue("@xhrc2", xhrc211);
                            ...
                            cmd.Parameters.Clear();
                            query = "DELETE FROM glhrc4 WHERE zid=@zid and xhrc1=@xhrc1 and xhrc2=@xhrc2";
                            cmd.CommandText = query;
                            cmd.Parameters.AddWithValue("@zid", _zid);
                            cmd.Parameters.AddWithValue("@xhrc1", xhrc11);
                            cmd.Parameters.AddWithValue("@xhrc2", xhrc211);
                            ...
                            cmd.Parameters.Clear();
                            query = "DELETE FROM glhrc5 WHERE zid=@zid and xhrc1=@xhrc1 and xhrc2=@xhrc2";
                            cmd.CommandText = query;
                            cmd.Parameters.AddWithValue("@zid", _zid);
                            cmd.Parameters.AddWithValue("@xhrc1", xhrc11);
                            cmd.Parameters.AddWithValue("@xhrc2", xhrc211);
        ...
        protected void LinkButton3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (ViewState["level2"] == null)
                {
                    ...
                    string str = "SELECT TOP 1 xhrc2 FROM glhrc2 WHERE zid=@zid and xhrc1=@xhrc1";
                    SqlDataAdapter da = new SqlDataAdapter(str, conn1);
                    da.SelectCommand.Parameters.AddWithValue("@zid", _zid);
                    da.SelectCommand.Parameters.AddWithValue("@xhrc1", ViewState["level1"]);
                    da.Fill(dts, "tempztcode");
                ...
                Response.Redirect("~/forms/academic/accounts/glhrc33.aspx?level1=" + Server.UrlEncode(ViewState["level1"].ToString()) + "&level2=" + Server.UrlEncode(ViewState["level2"].ToString()) + "&subnav=" + Server.UrlEncode(ViewState["subnav"].ToString()) + "&link=" + Server.UrlEncode(ViewState["link"].ToString()) + "&xid=" + Server.UrlEncode(ViewState["xid"].ToString()));
            }
            catch (Exception exp)
            {
                msg.InnerHtml = exp.Message;
        ...
        public void fnGoToNextLevel(object sender, EventArgs e)
        {
            try
            {
                ...
                //    conn1.Dispose();
                //}
                Response.Redirect("~/forms/academic/accounts/glhrc33.aspx?level1=" + Server.UrlEncode(ViewState["level1"].ToString()) + "&level2=" + Server.UrlEncode(ViewState["level2"].ToString()) + "&level3=" + Server.UrlEncode(((LinkButton)sender).Text) + "&subnav=" + Server.UrlEncode(ViewState["subnav"].ToString()) + "&link=" + Server.UrlEncode(ViewState["link"].ToString()) + "&xid=" + Server.UrlEncode(ViewState["xid"].ToString()));
            }
            catch (Exception exp)
            {
                msg.InnerHtml = exp.Message;
