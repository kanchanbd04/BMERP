...
{
    public partial class msstatus_yearperiod : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                header_label.InnerHtml = "Set Year/Period";
                xtypestatus.InnerHtml = "GL Year/Period";
                xtypestatus1 = "GL Year/Period";
                if (!IsPostBack)
                {
        ...
        private void fnGetOffset()
        {
            ...
            string str = "SELECT coalesce(xnote,'') as xnote FROM msstatus WHERE xtypestatus=@xtypestatus and zid=@zid";
            ...
            {
                xnote.Text = dtztcode.Rows[0]["xnote"].ToString();
            }
            else
            {
                xnote.Text = "";
            ...
            try
            {
                ...
                using (TransactionScope tran = new TransactionScope())
                {
                    using (SqlConnection conn = new SqlConnection(zglobal.constring))
                    {
                        ...
                        int _zid = Convert.ToInt32(Convert.ToString(HttpContext.Current.Session["business"]));
                        string xnote1 = xnote.Text.Trim().ToString();
                        ...
                        query = "INSERT INTO msstatus (ztime,zid,xtypestatus,xnote,xdate) " +
                                       "VALUES(@ztime,@zid,@xtypestatus,@xnote,@xdate) ";
