<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="glheader_brv.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.glheader_brv" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
               ...
               <%--$("body").on("blur", "#<%=xtfccode.ClientID%>", function() {
                ...
                $("body").on("click", ".bm_acc", function () {
                   ...
                   <%-- var xst = document.getElementById('<%=hxstatus.ClientID %>').value;
                    if (xst == '' || xst == 'New' || xst == 'Undo' || xst == 'Undo1' || xst == 'Open')
                    {
                        fnOpenChartofAccountsJV(<%= HttpContext.Current.Session["business"] %>,$(this).parent(".bm_list_img").siblings(".bm_list_text").find(".bm_academic_textbox").attr("ID"),$(this).parent(".bm_list_img").siblings(".bm_list_text").find(".bm_academic_textbox").val(),row.cells[2].getElementsByTagName("input")[0].id,row.cells[10].getElementsByTagName("input")[0].id);
                        $(this).parent(".bm_list_img").siblings(".bm_list_text").find(".bm_academic_textbox").focus();
                    }--%>
                ...
                $("body").on("click", ".bm_xaccdr", function () {
                    ...
                    //alert($(this).parent(".bm_list_img").parent(".bm_clt_ctl_50_100").parent(".bm_ctl_container_50_100").siblings().find(".xstdname").attr("ID"));
                    <%-- if ($("#<%=hxstatus.ClientID%>").val() == "")--%> 
                  <%--  alert(document.getElementById('<%=hxacc.ClientID %>').id);--%>
                     var xst = document.getElementById('<%=hxstatus.ClientID %>').value;
                     if (xst == '' || xst == 'New' || xst == 'Undo' || xst == 'Undo1' || xst == 'Open')
                     {
                         fnOpenChartofAccounts2(<%= HttpContext.Current.Session["business"] %>,$(this).parent(".bm_list_img").siblings(".bm_list_text").find(".bm_academic_textbox").attr("ID"),$(this).parent(".bm_list_img").siblings(".bm_list_text").find(".bm_academic_textbox").val(),$(this).parent(".bm_list_img").parent(".bm_clt_ctl_50_100").parent(".bm_ctl_container_50_100").siblings().find(".xdescdr").attr("ID"),$("#<%=hxacc.ClientID%>").attr("ID"),$("#<%=hxsub.ClientID%>").attr("ID"),"Bank");
                         //$(this).parent(".bm_list_img").siblings(".bm_list_text").find(".bm_academic_textbox").focus();
                        
                     }

                     <%--alert(document.getElementById('<%=hxacc.ClientID %>').value + ' ' + document.getElementById('<%=hxsub.ClientID %>').value);--%>
                ...
                <%--$("body").on("keyup", "[id*=xamountdr]", function () {
                   ...
                   for (var i = 1; i < grid.rows.length - 1; i++) {
                       var xamountdr1 = parseFloat(grid.rows[i].cells[6].children[0].value );
                ...
                $("body").on("keyup", "[id*=xamountcr]", function () {
                    ...
                    for (var i = 1; i < grid.rows.length - 1; i++) {
                        var xamou1ntcr1 = parseFloat(grid.rows[i].cells[7].children[0].value );
                    ...
                    //grid.rows[grid.rows.length - 1].cells[4].children[0].value = grandTotal;
                    grid.rows[grid.rows.length - 1].cells[7].innerHTML = grandTotal;
                ...
                $("body").on("keyup", "[id*=xamountdr]", function () {
                    ...
                    var grid = document.getElementById('<%=GridView1.ClientID %>');
                     ...
                     for (var i = 1; i < grid.rows.length - 1; i++) {
                         var xamountdr1 = parseFloat(grid.rows[i].cells[6].children[0].value );
                         var xamountcr1 = parseFloat(grid.rows[i].cells[7].children[0].value );
                         ...
                         grandTotaldr = grandTotaldr + xamountdr1;


                         grandTotalcr = grandTotalcr + xamountcr1;
                     }

                     var xprimedr = grandTotalcr - grandTotaldr;

                    $("#<%= xprimedr.ClientID%>").val(xprimedr);

                    //grid.rows[grid.rows.length - 1].cells[4].children[0].value = grandTotal;
                    grid.rows[grid.rows.length - 1].cells[6].innerHTML = grandTotaldr + xprimedr;
                    grid.rows[grid.rows.length - 1].cells[7].innerHTML = grandTotalcr;
            ...
            var xterm = $("#<%= xterm.ClientID%>").val();--%>
                   ...
                   <%--  var xstatus = $("#<%= hiddenxstatus.ClientID%>").val();--%>
                    var openwin = window.open('/forms/academic/reports/accounts/glvoucherrcv1.aspx?zid=' + zid + '&xvoucher=' + xvoucher1, 'brv', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, copyhistory=no, width=' + screen.width + ', height=' + screen.height + ', top=0, left=0, targets=_blank');
                     openwin.focus();
                     //openwin.print();
                     //return false;
                 }
          ...
          //gridviewScroll();
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Bank Receipt Voucher</span>
                    </div>
                </div>
                            ...
                            <div class="button_section_style1" style="text-align: left; margin-bottom: 5px;">
                                ...
                                <asp:Button ID="btnSubmit" runat="server" Text="Confirm" CssClass="bm_academic_button3 bm_am_btn_edit"
                                  ...
                                  <asp:Button ID="btnUndo" runat="server" Text="Undo" CssClass="bm_academic_button3 bm_am_btn_undo"
                                     OnClientClick="javascript:ConfirmMessage3();" OnClick="btnUndo_Click"/>
                            ...
                            <div class="bm_layout_box_100">
                                ...
                                <div class="bm_layout_box_padding" style="padding-top: 0px;">
                                    ...
                                    <div style="width: 100%; clear: both;">
                                        ...
                                        <div class="bm_ctl_container_100_special" style="width: 270px;">
                                            <div class="bm_ctl_label_align_right_100_special" style="width: 120px">
                                                <asp:Label ID="Label1" runat="server" Text="Received From :" AssociatedControlID="xdesc03"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_100_special" style="width: 148px">
                                        ...
                                        <div>
                                            <div class="bm_ctl_container_50_100" style="width: 270px; float: left">
                                                <div class="bm_ctl_label_align_right_50_100" style="width: 120px">
                                                    <asp:Label ID="Label6" runat="server" Text=" Bank Account :" AssociatedControlID="xaccdr"
                                                        CssClass="label"></asp:Label>
                                                </div>
                                                <div class="bm_clt_ctl_50_100" style="width: 148px">
                                                    ...
                                                    <div class="bm_list_text" style="width: 120px">
                                                        <asp:TextBox ID="xaccdr" runat="server" CssClass="bm_academic_textbox_50_100 bm_academic_ctl_global bm_academic_textbox "
                                                             ></asp:TextBox>
                                                    </div>
                                                    <div class="bm_list_img">
                                                        <asp:Image ID="Image1" runat="server" ImageUrl="~/images/list-am32x32.png" CssClass="bm_academic_list bm_xaccdr" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div style="float: left; padding-left: 5px; padding-top: 1px">
                                        ...
                                        <div class="bm_ctl_container_100_special" style="width: 270px;">
                                            <div class="bm_ctl_label_align_right_100_special" style="width: 120px">
                                                <asp:Label ID="Label16" runat="server" Text="Amount :" AssociatedControlID="xprimedr"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_100_special" style="width: 148px">
                                                <asp:TextBox ReadOnly="True"  ID="xprimedr" runat="server" CssClass="bm_academic_textbox_50_100 bm_academic_ctl_global bm_academic_textbox "></asp:TextBox>
                                            </div>
                                        </div>
                                        ...
                                        <div class="bm_ctl_container_100_special" style="width: 270px;">
                                            <div class="bm_ctl_label_align_right_100_special" style="width: 120px">
                                                <asp:Label ID="Label9" runat="server" Text="Payment Type :" AssociatedControlID="xpaytypedr"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_100_special" style="width: 148px">
                                                <asp:DropDownList ID="xpaytypedr" runat="server" CssClass="bm_academic_dropdown_100_special bm_academic_ctl_global bm_academic_dropdown" >
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                        
                                        <div runat="server" id="cheque">
                                         <div class="bm_clt_padding">
                                        </div>
                                        <div class="bm_ctl_container_100_special" style="width: 270px;">
                                            <div class="bm_ctl_label_align_right_100_special" style="width: 120px">
                                                <asp:Label ID="Label10" runat="server" Text="Cheque/Ref No :" AssociatedControlID="xchequedr"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_100_special" style="width: 148px">
                                                <asp:TextBox ID="xchequedr" runat="server" CssClass="bm_academic_textbox_50_100 bm_academic_ctl_global bm_academic_textbox "></asp:TextBox>
                                            </div>
                                        </div>
                                        </div>
                                        
                                         <div runat="server" id="dateclr">
                                         <div class="bm_clt_padding">
                                        </div>
                                        <div class="bm_ctl_container_100_special" style="width: 270px;">
                                            <div class="bm_ctl_label_align_right_100_special" style="width: 120px">
                                                <asp:Label ID="Label15" runat="server" Text="Cheque Date :" AssociatedControlID="xdateclrdr"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_100_special" style="width: 148px">
                                                <asp:TextBox ID="xdateclrdr" runat="server" CssClass="bm_academic_textbox_50_100 bm_academic_ctl_global bm_academic_datepicker"></asp:TextBox>
                                            </div>
                                        </div>
                                        </div>
                                                    ...
                                                    <Columns>
                                                      ...
                                                      <%--  <asp:TemplateField HeaderText="Sub Account">
                                                       ...
                                                       <%-- <asp:TemplateField HeaderText="Description">
                                                           ...
                                                           <asp:TemplateField HeaderText="Payment Type" HeaderStyle-CssClass="displaynone" FooterStyle-CssClass="displaynone">
                                                            <ItemStyle Width="100px" HorizontalAlign="Center" CssClass="displaynone"/>
                                                            <ItemTemplate>

                                                                <asp:DropDownList ID="xpaytype" runat="server" CssClass="bm_academic_dropdown_100_special  "></asp:DropDownList>

                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        
                                                           <asp:TemplateField HeaderText="Cheque No." HeaderStyle-CssClass="displaynone" FooterStyle-CssClass="displaynone">
                                                            <ItemStyle Width="100px" HorizontalAlign="Center" CssClass="displaynone"/>
                                                            <ItemTemplate>

                                                                <asp:TextBox ID="xcheque" runat="server" CssClass="bm_academic_textbox_50_100 bm_academic_ctl_global bm_academic_textbox right " ></asp:TextBox>

                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        
                                                         <asp:TemplateField HeaderText="Cheque Date" HeaderStyle-CssClass="displaynone" FooterStyle-CssClass="displaynone">
                                                            <ItemStyle Width="130px" HorizontalAlign="Center" CssClass="displaynone"/>
                                                            <ItemTemplate>

                                                                <asp:TextBox ID="xdateclr" runat="server" CssClass="bm_academic_textbox_50_40 bm_academic_ctl_global bm_academic_datepicker" ></asp:TextBox>

                                                            </ItemTemplate>
                                                        </asp:TemplateField>

                                                        <asp:TemplateField HeaderText="Debit"  HeaderStyle-CssClass="displaynone" FooterStyle-CssClass="displaynone">
                                                            <ItemStyle Width="120px" HorizontalAlign="Center" CssClass="displaynone"/>
                                                            <ItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="Amount" > <%--HeaderStyle-CssClass="displaynone" FooterStyle-CssClass="displaynone"--%>
                                                            <ItemStyle Width="120px" HorizontalAlign="Center" /> <%--CssClass="displaynone"--%>
                                                            <ItemTemplate>
                                    ...
                                    <div class="bm_academic_grid_container" id="list" runat="server">
                                        <div class="grid_header">
                                            <div class="grid_header_label" id="_grid_header" runat="server">
                                                Bank Receipt Voucher(s) List - Unposted
                                            </div>
                                    ...
                                    <div class="bm_academic_grid_container" id="Div1" runat="server">
                                        <div class="grid_header">
                                            <div class="grid_header_label" id="Div2" runat="server">
                                                Bank Receipt Voucher(s) List - Posted
                                            </div>
                                            <div class="grid_header_control">
                                            </div>
                                            <div class="flot_right">
            ...
            <cc1:ModalPopupExtender ID="ModalPopupExtender1" runat="server" TargetControlID="btnShowList"
                ...
                <asp:HiddenField ID="hxeffdate" runat="server" />
                 <asp:HiddenField ID="hxacc" runat="server" />
                <asp:HiddenField ID="hxsub" runat="server" />
        </ContentTemplate>
    </asp:UpdatePanel>
</asp:Content>
