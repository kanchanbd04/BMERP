...
{
    public partial class glhrc55 : Page
    {
        public int _zid;
        ...
        protected void FillControls(object sender, EventArgs e)
        {
            try
            {
                ...
                string str = "SELECT xhrc5,xlong FROM glhrc5 where zid=@zid and xhrc1=@xhrc1 and xhrc2=@xhrc2 and xhrc3=@xhrc3 and xhrc4=@xhrc4 and xhrc5=@xhrc5";
        ...
        public void fnFillDataGrid()
        {
            ...
            dts.Reset();
            string str = "SELECT xhrc5 FROM glhrc5 WHERE zid=@zid and xhrc1=@xhrc1 and xhrc2=@xhrc2 and xhrc3=@xhrc3 and xhrc4=@xhrc4";
            SqlDataAdapter da = new SqlDataAdapter(str, conn1);
            da.SelectCommand.Parameters.AddWithValue("@zid", _zid);
            da.SelectCommand.Parameters.AddWithValue("@xhrc1", ViewState["level1"]);
            da.SelectCommand.Parameters.AddWithValue("@xhrc2", ViewState["level2"]);
            ...
            try
            {
                    ...
                    using (TransactionScope tran = new TransactionScope())
                    {
                        using (SqlConnection conn = new SqlConnection(zglobal.constring))
                        {
                            ...
                            cmd.Connection = conn;
                            string query = "INSERT INTO glhrc5 (ztime,zid,xhrc1,xhrc2,xhrc3,xhrc4,xhrc5,xlong) " +
                                           "VALUES(@ztime,@zid,@xhrc1,@xhrc2,@xhrc3,@xhrc4,@xhrc5,@xlong) ";
            ...
            try
            {
                    ...
                    using (TransactionScope tran = new TransactionScope())
                    {
                        using (SqlConnection conn = new SqlConnection(zglobal.constring))
                        {
                            ...
                            SqlCommand cmd = new SqlCommand();
                            cmd.Connection = conn;
                            string query = "UPDATE glhrc5 SET zutime=@zutime,xlong=@xlong " +
                                           "WHERE zid=@zid and xhrc1=@xhrc1 and xhrc2=@xhrc2 and xhrc3=@xhrc3 and xhrc4=@xhrc4 and xhrc5=@xhrc5";
                ...
                if (txtconformmessageValue.Value == "Yes")
                {
                    ...
                    using (TransactionScope tran = new TransactionScope())
                    {
                        using (SqlConnection conn = new SqlConnection(zglobal.constring))
                        {
                            ...
                            SqlCommand cmd = new SqlCommand();
                            cmd.Connection = conn;
                            string query = "DELETE FROM glhrc5 WHERE zid=@zid and xhrc1=@xhrc1 and xhrc2=@xhrc2 and xhrc3=@xhrc3 and xhrc4=@xhrc4 and xhrc5=@xhrc5";
                            string xhrc11 = ViewState["level1"].ToString();
                            string xhrc21 = ViewState["level2"].ToString();
                            string xhrc31 = ViewState["level3"].ToString();
                            string xhrc41 = ViewState["level4"].ToString();
