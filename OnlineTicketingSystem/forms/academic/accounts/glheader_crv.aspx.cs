...
{
    public partial class glheader_crv : System.Web.UI.Page
    {
            ...
            try
            {
                if (!IsPostBack)
                {
                    ...
                    else
                    {
                        ...
                        xaccdr.Text = zglobal.fnGetValue("xsubcrv", "msdef",
                    "zid=" + Convert.ToInt32(Convert.ToString(HttpContext.Current.Session["business"])));

                        hxacc.Value = zglobal.fnGetValue("xacccrv", "msdef",
                            "zid=" + Convert.ToInt32(Convert.ToString(HttpContext.Current.Session["business"])));

                        hxsub.Value = zglobal.fnGetValue("xsubcrv", "msdef",
                            "zid=" + Convert.ToInt32(Convert.ToString(HttpContext.Current.Session["business"])));
                    }
        ...
        private void fnCalculateTotal()
        {
            ...
            GridView1.FooterRow.Cells[3].Text = (xamountdr1 + xprimedr1).ToString(zglobal.CurrecnyFormatSpecifier, zglobal.GetCultureInfo());
            ...
            GridView1.FooterRow.Cells[4].Text = (xamountcr1 ).ToString(zglobal.CurrecnyFormatSpecifier, zglobal.GetCultureInfo());
        ...
        //    GridView1.FooterRow.Cells[3].Text = xamountdr1.ToString(zglobal.CurrecnyFormatSpecifier, zglobal.GetCultureInfo());
        //    GridView1.FooterRow.Cells[3].Font.Bold = true;
        //    GridView1.FooterRow.Cells[3].HorizontalAlign = HorizontalAlign.Right;
        //    GridView1.FooterRow.Cells[3].ForeColor = Color.White;
            ...
            if (ViewState["CurrentTable"] != null)
            {
                ...
                if (dtCurrentTable.Rows.Count > 0)
                {
                    ...
                    for (int i = 0; i < dtCurrentTable.Rows.Count - 1; i++)
                    {
                        ...
                        TextBox box3 = (TextBox)GridView1.Rows[i].Cells[3].FindControl("xamountdr");
                        TextBox box4 = (TextBox)GridView1.Rows[i].Cells[4].FindControl("xamountcr");
                        TextBox box5 = (TextBox)GridView1.Rows[i].Cells[5].FindControl("xrem");
                        TextBox box6 = (TextBox)GridView1.Rows[i].Cells[6].FindControl("xacc");
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    rtnMessage = rtnMessage + "<li>Cash Account</li>";
                    isValid = false;
                }
                ...
                using (DataSet dts1 = new DataSet())
                {
                    ...
                    string query =
                         @"select xrow,xsub,(select xdesc1 from glmstvw1 
                            ...
                            case when xprime<0 then cast(abs(xprime) as varchar(50)) else '' end as xamountcr,xrem,xacc
                    ...
                    if (tempTable.Rows.Count > 0)
                    {
                        ...
                        foreach (DataRow row in tempTable.Rows)
                        {
                            ...
                            if (i !=0)
                            {
                                ...
                                dr["Column3"] = tempTable.Rows[i]["xamountdr"].ToString();
                                dr["Column4"] = tempTable.Rows[i]["xamountcr"].ToString();
                                dr["Column5"] = tempTable.Rows[i]["xrem"].ToString();
                                dr["Column6"] = tempTable.Rows[i]["xacc"].ToString();
                                dt.Rows.Add(dr);
                            ...
                            else
                            {
                                ...
                                xprimedr.Text = tempTable.Rows[i]["xamountdr"].ToString();
