<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="glspgroupbal_dt.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.glspgroupbal_dt" %>
...
.GridViewScrollFooterFreeze TD {
    ...
    <script type="text/javascript">
        ...
        function fnShowReport() {
           ...
           <%-- var facc = $("#<%= xacc.ClientID%>").val();
            var sub = $("#<%= xsub.ClientID%>").val();--%>
           ...
           <%--var ob1 = $("#<%= ob.ClientID%>").val();--%>
           var year1 = $("#<%= xyear.ClientID%>").val();
           var acctype1 = $("#<%= acctype.ClientID%>").val();
           <%--var drcr1 = $("#<%= drcr.ClientID%>").val();
           var led_break_up1 = $("#<%= led_break_up.ClientID%>").val();
           var nara1 = $("#<%= nara.ClientID%>").val();--%>
           ...
           var rb11 = document.getElementById("<%=RadioButtonList1.ClientID%>");
           var label11 = rb11.getElementsByTagName("label");
           var radio11 = rb11.getElementsByTagName("input");
           var pltype1 = '';
           for (var i = 0; i < radio11.length; i++) {
               if (radio11[i].checked) {
                   //alert("SelectedText: " + label[i].innerHTML);
                   pltype1 = label11[i].innerHTML;
                   break;
               }
           }
           ...
           var xrtype1 = $("#<%= xrtype.ClientID%>").val();
            ...
            var openwin = window.open('/forms/academic/reports/accounts/glspgroupbal_dt_rpt.aspx?zid=' + zid + '&fdate=' + fdate1 + '&tdate=' + tdate1 + '&year=' + year1 + '&acctype=' + acctype1 + '&xtype=' + xtype2 + '&xrtype=' + xrtype1 + '&pltype=' + pltype1, 'glspgroupbal_dt', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, copyhistory=no, width=' + screen.width + ', height=' + screen.height + ', top=0, left=0, targets=_blank');
           openwin.focus();
           //openwin.print();
           return false;
       }
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <script type="text/javascript">
                ...
                //$("body").on("change", ".bm_acctype", function () {
                //    //alert("Hi");
                //    if ($(this).val() == "PL") {
                //        $(".pltype").show();
                //    } else {
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Periodical Accounts Note</span>
                    </div>
                </div>
                                ...
                                <div class="bm_layout_box_padding" style="padding-top: 10px; min-height: 300px;">
                                    ...
                                    <div style="width: 100%; clear: both;">
                                        ...
                                        <%--<div>
                                            <div class="bm_ctl_container_50_100" style="width: 270px; float: left">
                                                <div class="bm_ctl_label_align_right_50_100" style="width: 120px">
                                                    <asp:Label ID="Label4444" runat="server" Text=" Account :" AssociatedControlID="xacc"
                                                        CssClass="label"></asp:Label>
                                                </div>
                                                <div class="bm_clt_ctl_50_100" style="width: 148px">
                                                    ...
                                                    <div class="bm_list_img">
                                                        <asp:Image ID="Image1" runat="server" ImageUrl="~/images/list-am32x32.png" CssClass="bm_academic_list bm_xacc" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div style="float: left; padding-left: 5px; padding-top: 1px">
                                                <asp:Label ID="xdesc" runat="server" Text="" CssClass="xdesc"></asp:Label>
                                            </div>
                                        ...
                                        <div>
                                            <div class="bm_ctl_container_50_100" style="width: 270px; float: left">
                                                <div class="bm_ctl_label_align_right_50_100" style="width: 120px">
                                                    <asp:Label ID="Label3" runat="server" Text=" Sub Account :" AssociatedControlID="xsub"
                                                        CssClass="label"></asp:Label>
                                                </div>
                                                <div class="bm_clt_ctl_50_100" style="width: 148px">
                                                    ...
                                                    <div class="bm_list_img">
                                                        <asp:Image ID="Image2" runat="server" ImageUrl="~/images/list-am32x32.png" CssClass="bm_academic_list bm_xsub" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div style="float: left; padding-left: 5px; padding-top: 1px">
                                                <asp:Label ID="xdescsub" runat="server" Text="" CssClass="xdescsub"></asp:Label>
                                            </div>
                                        ...
                                        <div class="bm_ctl_container_50_50" style="float: left; width: 270px">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label5" runat="server" Text="To Date :" AssociatedControlID="tdate"
                                                    CssClass="label "></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 148px">
                                        ...
                                        <div class="bm_ctl_container_50_50" style="float: left; width: 270px">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label3" runat="server" Text="Year :" AssociatedControlID="xyear"
                                                    CssClass="label "></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 148px">
                                                <asp:TextBox ID="xyear" runat="server" CssClass="bm_academic_textbox_50_40 bm_academic_ctl_global bm_academic_textbox"></asp:TextBox>
                                            </div>
                                        </div>
                                        ...
                                        <div class="bm_ctl_container_50_50" style="float: left; width: 270px">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label2" runat="server" Text="Type (PL/BS) :" AssociatedControlID="acctype"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 148px">
                                                <asp:DropDownList ID="acctype" runat="server" CssClass="bm_academic_dropdown_50_50 bm_academic_ctl_global bm_academic_dropdown bm_xclass bm_acctype"
                                                   AutoPostBack="True" OnSelectedIndexChanged="acctype_OnSelectedIndexChanged">
                                                </asp:DropDownList>
                                            </div>
                                        </div>

                                        <div runat="server" id="pltype" class="pltype">
                                            <div class="bm_clt_padding">
                                            </div>
                                            <div style="width: 100%">
                                                <div class="bm_ctl_container_100_special" style="width: 120px; float: left;">
                                                    <div class="bm_ctl_label_align_right_100_special" style="width: 100%">
                                                        <asp:Label ID="Label1" runat="server" Text="PL Type :"
                                                            CssClass="label"></asp:Label>
                                                    </div>
                                                </div>
                                                <div style="float: left; padding-left: 5px">
                                                    <asp:RadioButtonList ID="RadioButtonList1" runat="server" RepeatDirection="Horizontal">
                                                        <asp:ListItem Text="PL" Value="PL" Selected="True"></asp:ListItem>
                                                        <asp:ListItem Text="PL Without Books/Stationary" Value="PL Without Books/Stationary"></asp:ListItem>
                                                        <asp:ListItem Text="PL Only With Tuition Fees" Value="PL Only With Tuition Fees"></asp:ListItem>
                                                    </asp:RadioButtonList>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="bm_ctl_container_50_50" style="float: left; width: 270px">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label12" runat="server" Text="Report Format :" AssociatedControlID="xrtype"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 148px">
                                        ...
                                        <div class="bm_ctl_container_50_50" style="float: left; width: 270px">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label1" runat="server" Text="Report Type :" AssociatedControlID="type"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 148px">
                                                <asp:DropDownList ID="type" runat="server" CssClass="bm_academic_dropdown_50_50 bm_academic_ctl_global bm_academic_dropdown bm_xclass">
                                                </asp:DropDownList>
                                        ...
                                        <div class="bm_ctl_container_50_50" style="float: left; width: 270px">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label6" runat="server" Text="Ledger Break up :" AssociatedControlID="led_break_up"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 148px">
                                                <asp:DropDownList ID="led_break_up" runat="server" CssClass="bm_academic_dropdown_50_50 bm_academic_ctl_global bm_academic_dropdown bm_xclass">
                                                </asp:DropDownList>
                                        ...
                                        <div class="bm_ctl_container_50_50" style="float: left; width: 270px">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label4" runat="server" Text="Narration :" AssociatedControlID="nara"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 148px">
                                                <asp:DropDownList ID="nara" runat="server" CssClass="bm_academic_dropdown_50_50 bm_academic_ctl_global bm_academic_dropdown bm_xclass">
                                                </asp:DropDownList>
