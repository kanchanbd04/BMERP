...
{
    public partial class gltrnbydate_bnkpay : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!IsPostBack)
                {
                    ...
                    frdate.Text = DateTime.Today.ToString("dd/MM/yyyy"); ;
                ...
                xdescsub.Text = zglobal.fnGetValue("xdescsub", "glmstvw",
                 "zid=" + Convert.ToInt32(Convert.ToString(HttpContext.Current.Session["business"])) + " and xacc='10101201' " +
                 "and xsub='" + xfsub.Text.Trim().ToString() + "'");

                xdescsub1.Text = zglobal.fnGetValue("xdescsub", "glmstvw",
                 "zid=" + Convert.ToInt32(Convert.ToString(HttpContext.Current.Session["business"])) + " and xacc='10101201' " +
                 "and xsub='" + xtsub.Text.Trim().ToString() + "'");
