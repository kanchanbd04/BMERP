...
{
    public partial class glspgroupbal_dt : System.Web.UI.Page
    {
        ...
        protected void acctype_OnSelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                if (acctype.Text == "PL")
                {
                    pltype.Attributes.Add("style","display:block;"); 
                }
                else
                {
                    pltype.Attributes.Add("style", "display:none;"); 
                }
