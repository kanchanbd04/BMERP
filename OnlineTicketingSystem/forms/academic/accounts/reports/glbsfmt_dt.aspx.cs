...
{
    public partial class glbsfmt_dt : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!IsPostBack)
                {
                    ...
                    //acctype.Items.Add("PL");
                    //acctype.Items.Add("BS");
                    //acctype.Text = "PL";
                    ...
                    DateTime xfdate1 = new DateTime(tempyear, offset+1, 1);

                    //Response.Write(xfdate1.ToString("dd/MM/yyyy"));
                    hxfdate.Value = xfdate1.ToString("dd/MM/yyyy");
                    fdate.Text = hxfdate.Value;

                    _date.Attributes.Add("style", "display:none;"); 
                }
        ...
        protected void RadioButtonList2_OnSelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                if (RadioButtonList2.Items.FindByValue("As at date").Selected)
                {
                ...
                else
                {
                    ...
                    _date.Attributes.Add("style", "display:block;");
                    fdate.Text = DateTime.Today.ToString("dd/MM/yyyy");
                }
