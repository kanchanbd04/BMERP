<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="glhrc22.aspx.cs" Inherits="OnlineTicketingSystem.forms.BMERP.Accounts.glhrc22" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
           <%-- $('#<%=business.ClientID %>').live('click', function (e) {
                ...
                var page = "../../BMERP/zbusiness_sel.aspx?level=level2&xhrc1=<%= ViewState["level1"] %>&xhrc2=<%= ViewState["level2"] %>"
                var $dialog = $('<div></div>')
    ...
    <table style="width: 98%; height: 111px;">
        <tr>
            <td class="style4" colspan="2">
                <strong>Accounts Group Level 2</strong>
            </td>
           <%-- <td class="style2" rowspan="2">
                ...
                <table class="style5">
                    <tr>
                          <td  class="style400">
                              <asp:Label ID="level1" runat="server" Text="Label"></asp:Label>
                          </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="Level2">
                                <ItemTemplate>
                                    <asp:LinkButton ID="xhrc2" runat="server" Text='<%#Eval("xhrc2") %>' OnClick="FillControls"></asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
            ...
            <td class="style3">
                <table class="style5">
                        ...
                        <td class="style7" colspan="3">
                            <table class="style5">
                                <tr>
                                    ...
                                    <td>
                                        <asp:LinkButton ID="LinkButton3" runat="server" onclick="LinkButton3_Click">level3&gt;&gt;</asp:LinkButton>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="style10">
                            <asp:TextBox ID="xhrc2" runat="server" Width="251px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="style8">
                                ...
                                <asp:GridView ID="GridView2" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Level3">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="xhrc3" runat="server" Text='<%#Eval("xhrc3") %>' OnClick="fnGoToNextLevel"></asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                    <EditRowStyle BackColor="#999999" />
