<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/academic_site.Master"
    CodeBehind="asmeappstall.aspx.cs" Inherits="OnlineTicketingSystem.forms.BMERP.asmeappstall"
        ...
        <ContentTemplate>
            <script type="text/javascript">
                ...
                $("body").on("click", ".bm_circle_button_coordinator", function () {
                 ...
                 //var openwin = window.open("/forms/academic/assesment/mock-exam-input/amexamhmock3.aspx?subnav=myDropdown44&link=LinkButton44&xsession=" + xsession1 + "&xterm=" + xterm1 + "&xclass=" + xclass1 + "&xgroup=" + xgroup1 + "&xsection=" + xsection1 + "&xsubject=" + xsubject1.replace(/&/gi, "%26") + "&xpaper=" + xpaper1 + "&xext=" + xext1 + "&xcttype=" + xcttype1 + "&xctno=" + xctno1, 'ctstcoall', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, copyhistory=no, width=600, height=500, top=' + top + ', left=' + left + ', targets=_blank');
                    var openwin = window.open("/forms/academic/assesment/mock-exam-input/amexamhmock3.aspx?subnav=myDropdown44&link=LinkButton44&xsession=" + xsession1 + "&xterm=" + xterm1 + "&xclass=" + xclass1 + "&xgroup=" + xgroup1 + "&xsection=" + xsection1 + "&xsubject=" + xsubject1.replace(/&/gi, "%26") + "&xpaper=" + xpaper1 + "&xext=" + xext1 + "&xcttype=" + xcttype1 + "&xctno=" + xctno1, 'ctstcoall', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, copyhistory=no, width=' + screen.width + ', height=' + screen.height + ', top=0, left=0, targets=_blank');
                 openwin.focus();
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Mock Exam Status At a Glance</span>
                    </div>
                </div>
