...
{
    public partial class asmeappstco : System.Web.UI.Page
    {
        ...
        private void BindGrid()
        {
            ...
            string str1 = "SELECT ROW_NUMBER() OVER (ORDER BY xcttype desc, xctno asc) AS xid,* FROM amexamh inner join amexamd on amexamh.zid=amexamd.zid and amexamh.xrow=amexamd.xrow " +
                "WHERE amexamh.zid=@zid AND xsession=@xsession AND xclass=@xclass AND xterm=@xterm AND xgroup=@xgroup AND xtype='Mock Exam'  AND xsection=@xsection  order by xstdid";
            ...
            string str = "SELECT xsubject,xpaper,coalesce(xext,'') as xext,count(*) FROM amexamh inner join amexamd on amexamh.zid=amexamd.zid and amexamh.xrow=amexamd.xrow " +
               "WHERE amexamh.zid=@zid AND xsession=@xsession AND xclass=@xclass AND xterm=@xterm AND xgroup=@xgroup AND xtype='Mock Exam'  AND xsection=@xsection  " +
            ...
            try
            {
                ...
                if (e.Row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    if (result.Length > 0)
                    {
                        ...
                        btn1.CssClass = "bm_square_button2 bm_square_button_coordinator";
                    ...
                    //        //{
                    //        //    btn1.Attributes["style"] = "background-color: #F7941E";
                    //        //    btn2.Attributes["style"] = "background-color: #F7941E";
                    //        //    btn3.Attributes["style"] = "background-color: #F7941E";
                    //        //}
                    ...
                    //        {
                    //            btn1.Attributes["style"] = "background-color: #44C8F5";
                    //            btn2.Attributes["style"] = "background-color: #44C8F5";
                    //            btn3.Attributes["style"] = "background-color: #F7941E";
                    ...
                    //            btn1.Attributes["style"] = "background-color: #44C8F5";
                    //            btn2.Attributes["style"] = "background-color: #44C8F5";
                    //            btn3.Attributes["style"] = "background-color: #44C8F5";
