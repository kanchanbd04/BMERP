<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/academic_site.Master"
    CodeBehind="amexamhh4.aspx.cs" Inherits="OnlineTicketingSystem.forms.BMERP.amexamhh4"
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server"  EnableViewState="true">
        <ContentTemplate>
                ...
                <script type="text/javascript" language="javascript">
                   ...
                   <%-- $("body").on("click", ".bm_am_btn_approve", function () {
                        //alert("HI");
                        //return false;
                        var selectedvalue = confirm("Press 'OK' to approve tabulation sheet " + document.getElementById('<%=xclass.ClientID %>').value + ".");
                          if (selectedvalue) {
                              document.getElementById('<%=happrove.ClientID %>').value = "Yes";
            } else {
                document.getElementById('<%=happrove.ClientID %>').value = "No";
            }
                          //return false;
                      });--%>
    ...
    <div class="bm_academic_container">
        <div class="bm_academic_container_header">
            <div class="header_label1" id="header_label" runat="server">
                <span class="bm_am_header_round">Term Exam Tabulation Sheet Approval</span>
            </div>
        </div>
    ...
    <asp:Button ID="btnShowPopup" runat="server" Style="display: none" />
            ...
            <asp:Panel ID="pnlpopup" runat="server" BackColor="White" Height="280px" Width="400px"
                ...
                <table width="100%" style="border: Solid 3px #619CFD; width: 100%; height: 100%;
                    ...
                    <tr style="background-color: #619CFD">
                        <td style="height: 15px; color: white; font-size: 14px;" align="left">
                            Comments for <span id="term" > </span>
                        </td>
                    </tr>
    ...
    <asp:HiddenField ID="hiddenxstatus" runat="server" />
             <asp:HiddenField ID="happrove" runat="server" />
