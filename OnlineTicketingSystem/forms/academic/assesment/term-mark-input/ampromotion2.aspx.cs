...
{
    public partial class ampromotion2 : System.Web.UI.Page
    {
        ...
        private void BindGrid()
        {
            ...
            if (dtmarks.Rows.Count > 0)
            {
                ...
                string xpromotion = zglobal.fnProperty1("Class", xclass.Text.ToString().Trim(), "xpromotion");
                //if (dtmarks2.Rows.Count > 0)
                if(xpromotion=="yes")
                {
                    //ViewState["amexamph_result_avg1"] = dtmarks2;
                    ViewState["amexamph_result_avg1"] = "yes";
                ...
                else
                {
                    ...
                    message.InnerHtml = "This class is not configured for auto promotion.";
                        ...
                        using (SqlConnection conn = new SqlConnection(zglobal.constring))
                        {
                            ...
                            foreach (GridViewRow row in GridView1.Rows)
                            {
                                ...
                                query = "INSERT INTO ampromotiond (zid,xrow,xline,xsrow,xpromoted,xstatus1,xsection,xgroup) " +
                                        "VALUES(@zid,@xrow,@xline,@xsrow,@xpromoted,@xstatus1,@xsection,@xgroup) ";
