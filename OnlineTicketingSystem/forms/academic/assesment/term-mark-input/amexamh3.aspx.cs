...
{
    public partial class amexamh3 : System.Web.UI.Page
    {
                    ...
                    if (txtconformmessageValue.Value == "Yes")
                    {
                        ...
                        using (TransactionScope tran = new TransactionScope())
                        {
                            using (SqlConnection conn = new SqlConnection(zglobal.constring))
                            {
                                ...
                                query =
                                    "UPDATE amexamh SET xstatus=@xstatus,xsubmitedby=@xsubmitedby,xsubmitdt=@xsubmitdt,xflag10=@xflag10 " +
                                    "WHERE zid=@zid AND xrow=@xrow ";
                                cmd.Parameters.Clear();
                                ...
                                cmd.Parameters.AddWithValue("@xflag10", xflag10);
                                cmd.ExecuteNonQuery();
                            }
