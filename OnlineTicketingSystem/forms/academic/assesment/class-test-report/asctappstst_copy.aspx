<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/academic_site.Master"
    CodeBehind="asctappstst_copy.aspx.cs" Inherits="OnlineTicketingSystem.forms.BMERP.asctappstst_copy"
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            $("body").on("click", ".bm_student", function () {
             ...
             $("body").on("click", ".bm_circle_button_subject", function () {
...
//                 }
                 ...
                 var openwin = window.open("/forms/academic/assesment/mark-input/amexamh.aspx?subnav=myDropdown44&link=LinkButton44&xsession=" + xsession1 + "&xterm=" + xterm1 + "&xclass=" + xclass1 + "&xgroup=" + xgroup1 + "&xsection=" + xsection1 + "&xsubject=" + xsubject1.replace(/&/gi, "%26") + "&xpaper=" + xpaper1 + "&xext=" + xext1 + "&xcttype=" + xcttype1 + "&xctno=" + xctno1,'ctstst','toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, copyhistory=no, width=600, height=500, top=' + top + ', left=' + left + ', targets=_blank');
                 openwin.focus();
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Class Test Approval Status (Subject Teacher)</span>
                    </div>
                </div>
