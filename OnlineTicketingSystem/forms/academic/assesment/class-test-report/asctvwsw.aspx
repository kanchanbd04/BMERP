<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/academic_site.Master"
    CodeBehind="asctvwsw.aspx.cs" Inherits="OnlineTicketingSystem.forms.BMERP.asctvwsw"
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    <script type="text/javascript">
        ...
        function fnPrintInfo(xsrow,xname) {
            //alert("Hi");
           ...
           var xsession = $("#<%= xsession.ClientID%>").val();
            ...
            var xgroup = $("#<%= xgroup.ClientID%>").val();
            var xsection = $("#<%= xsection.ClientID%>").val();
            var openwin = window.open('/forms/academic/assesment/class-test-report/asctvwindivi.aspx?xsrow=' + xsrow + '&xsession=' + xsession + '&xterm=' + xterm + '&xclass=' + xclass + '&xgroup=' + xgroup + '&xsection=' + xsection + '&xname=' + xname , 'asctvwindivirpt123', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, copyhistory=no, width=' + screen.width + ', height=' + screen.height + ', top=0, left=0, targets=_blank');
             openwin.focus();
             //openwin.print();
             return false;
        }
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Class Test Result (Section)</span>
                    </div>
                </div>
