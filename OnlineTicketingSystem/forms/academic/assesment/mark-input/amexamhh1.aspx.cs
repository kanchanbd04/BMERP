...
{
    public partial class amexamhh1 : System.Web.UI.Page
    {
                    ...
                    using (DataSet dts1 = new DataSet())
                    {
                        ...
                        if (dtamexamd.Rows.Count > 0)
                        {
                            ...
                            foreach (DataRow row in dtamexamd.Rows)
                            {
                                ...
                                //if (eo_ % 2 == 0)
                                //{
                                //    tfield.ItemStyle.BackColor = ColorTranslator.FromHtml("#D3EAD9");
                                //}
                                //else
                                //{
                                //    tfield.ItemStyle.BackColor = ColorTranslator.FromHtml("#E4F2E7");
                                //}
