...
{
    public partial class amexamhh6 : System.Web.UI.Page
    {
                ...
                using (SqlConnection con = new SqlConnection(zglobal.constring))
                {
                    using (DataSet dts1 = new DataSet())
                    {
                       ...
                       //"group by zid,xtype,xsession,xterm,xclass,xgroup,xsubject,xpaper,xstdid";
                        ...
                        //  string query =
                        //"select xstdid,xsubject,xpaper,count(xstdid) as xnumexam, sum(coalesce(xna,0)) as xna from amexamvw where zid=@zid AND xtype='Class Test'  " +
                        //"and xsession=@xsession and xterm=@xterm and xclass=@xclass and xgroup=@xgroup   " +
        ...
        private void BindGrid()
        {
            ...
            string str1 = "SELECT ROW_NUMBER() OVER (ORDER BY xcttype desc, xctno asc) AS xid,* FROM amexamh inner join amexamd on amexamh.zid=amexamd.zid and amexamh.xrow=amexamd.xrow " +
                "WHERE amexamh.zid=@zid AND xsession=@xsession AND xclass=@xclass AND xterm=@xterm AND xgroup=@xgroup and xsubject=@xsubject AND xtype='Class Test'   order by xsection";
            ...
            da11.SelectCommand.Parameters.AddWithValue("@xterm", xterm.Text.ToString().Trim());
            da11.SelectCommand.Parameters.AddWithValue("@xgroup", xgroup.Text.ToString().Trim());
            da11.SelectCommand.Parameters.AddWithValue("@xsubject", xsubject_1.Text.ToString().Trim());
            ...
            string str = "SELECT distinct xsubject,xpaper,coalesce(xext,'') as xext FROM amexamh inner join amexamd on amexamh.zid=amexamd.zid and amexamh.xrow=amexamd.xrow  " +
                " WHERE amexamh.zid=@zid AND amexamh.xsession=@xsession AND amexamh.xclass=@xclass AND amexamh.xterm=@xterm AND amexamh.xgroup=@xgroup and xsubject=@xsubject AND amexamh.xtype='Class Test'  order by xsubject,xpaper,xext";
            ...
            da.SelectCommand.Parameters.AddWithValue("@xsubject", xsubject_1.Text.ToString().Trim());
            ...
            if (dtmarks.Rows.Count > 0)
            {
                ...
                using (SqlConnection con = new SqlConnection(zglobal.constring))
                {
                    ...
                    "select xsubject,xpaper,coalesce(xext,'') as xext,MAX(tbl.best) as best1 from " +
                       ...
                       "WHERE zid=@zid AND xsession=@xsession AND xclass=@xclass AND xterm=@xterm AND xgroup=@xgroup  and xsubject=@xsubject" +
                       " group by xsubject,xpaper,coalesce(xext,'') ";
                        ...
                        //da1.SelectCommand.Parameters.AddWithValue("@xsection", xsection.Text.ToString().Trim());
                        //da1.SelectCommand.Parameters.AddWithValue("@xsrow", _student.Value.ToString().Trim());
                        da1.SelectCommand.Parameters.AddWithValue("@xsubject", xsubject_1.Text.ToString().Trim());
                ...
                using (SqlConnection con = new SqlConnection(zglobal.constring))
                {
                    using (DataSet dts1 = new DataSet())
                    {
                       ...
                       "WHERE zid=@zid AND xsession=@xsession AND xclass=@xclass AND xterm=@xterm AND xgroup=@xgroup AND xtype='Class Test' AND " +
                       "xstatus in ('Test','New','Approved3') and xsubject=@xsubject";
                        ...
                        if (dtamexamhh.Rows.Count > 0)
                        {
                            ...
                            //}
                            if (dtamexamhh.Rows[0]["xstatus"].ToString() == "Test")
                            {
                                btnSave.Enabled = true;
                            }
                            else
                    ...
                    using (DataSet dts1 = new DataSet())
                    {
                        ...
                        if (dtamexamd.Rows.Count > 0)
                        {
                            ...
                            foreach (DataRow row in dtamexamd.Rows)
                            {
                                ...
                                //tfield.ItemStyle.CssClass = "hand";
                ...
                for (int i = 0; i <= GridView1.Rows.Count - 2; i++)
                {
                    ...
                    if (ctn != 0)
                    {
                        ...
                        {
                            //ctn = 10 + i;
                            currRow.Cells[m+10].BackColor = ColorTranslator.FromHtml(htmlColorCode);
                    ...
                    if (ctn != 0)
                    {
                        ...
                        {
                            //ctn = 10 + i;
                            nextRow.Cells[m+10].BackColor = ColorTranslator.FromHtml(htmlColorCode);
                        }
                    }
                ...
                if (e.Row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    if (ViewState["amexamhh"] != null)
                    {
                        ...
                        if (result50.Length > 0)
                        {
                            ...
                            //}
                            if (result50[0]["xstatus"].ToString() == "Test")
                            {
                                dlistPerc.Enabled = true;
                            }
                            else
                    ...
                    if (ViewState["amexamhh"] != null)
                    {
                        ...
                        if (result50.Length > 0)
                        {
                            ...
                            dlistBest.Text = result50[0]["xtbest"].ToString() == "0" ? "" : result50[0]["xtbest"].ToString();
        ...
        protected void ImageOnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                if (row != null)
                {
                    ...
                    //    var query1 = from row4 in ((DataTable)ViewState["amstd3"]).AsEnumerable()
                    //                 where row4.Field<string>("xsubject") == xsubject1 && row4.Field<string>("xpaper") == xpaper1 &&
                    //                 row4.Field<int>("xnumexam") == Convert.ToInt32(result10[0]["best1"].ToString())
                    //                 select new
                    //                 {
                    //                     xstdid = row4.Field<string>("xstdid")
                    //                 };
                    ...
                    SqlConnection con123 = new SqlConnection(zglobal.constring);
        ...
        protected void btnApprove_Click(object sender, EventArgs e)
        {
            ...
            //        //    TextBox dlistPerc1 = row.FindControl("dlistPerc") as TextBox;
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //btnUndo.Enabled = false;
                //btnUndo1.Enabled = false;
                ViewState["xstatus"] = "Test";
                // hxstatus.Value = "Approved2";
                hiddenxstatus.Value = "Test";
                // fnButtonState();
                BindGrid();
                //fnFillGrid2();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    //zglobal.fnGetComboDataCD("Section", xsection);
                    zglobal.fnGetComboDataCD("Class Subject", xsubject_1);
        ...
        protected void combo_OnTextChanged_class(object sender, EventArgs e)
        {
            try
            {
                ...
                zglobal.fnGetComboDataCDSubject(xclass.Text.ToString().Trim(), xsubject_1);
