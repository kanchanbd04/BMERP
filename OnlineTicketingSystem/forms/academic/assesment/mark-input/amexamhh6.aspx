<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/academic_site.Master"
    CodeBehind="amexamhh6.aspx.cs" Inherits="OnlineTicketingSystem.forms.BMERP.amexamhh6"
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <style>
        ...
        .bm_academic_grid1 th, .bm_academic_grid1 .FooterStyle
        {
         ...
         .hand { cursor: pointer; } /* cross browser hand */
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <script type="text/javascript">
                ...
                $("body").on("click", ".lblGrade", function() {
                    //alert("Hi");
                    ...
                    //alert(grid.rows[rowIndex+1].cells[cell].children[0].name);
                    var grade_init = grid.rows[rowIndex + 1].cells[cell].children[0].name;
                    var grade_name = grade_init.slice(-1);
                   
                    if (grade_name == "*") {
                        grade_name = grade_init.slice(-2);
                    }
...
<%--                   var zid1 = <%= HttpContext.Current.Session["business"] %>;
                    ...
                    var xsubject1 = grid.rows[rowIndex + 1].cells[1].innerText;
                    var xpaper1 = grid.rows[rowIndex + 1].cells[2].innerText;--%>


                    //$.ajax({
                    //    type: "POST",
                    //    url: "/edusoft.asmx/ListStudentGrade",
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Working Before Class Test Approval</span>
                    </div>
                </div>
                                ...
                                <div class="grid_header_control" style="margin-left: 15px; margin-top: 5px;">
                                    ...
                                    <div class="bm_ctl_container_100_special" style="display: inline-block; width: 250px">
                                        <div class="bm_ctl_label_align_right_100_special" style="width: 64px">
                                            <asp:Label ID="Label60000" runat="server" Text="Subject :" AssociatedControlID="xsubject_1"
                                                CssClass="label"></asp:Label>
                                        </div>
                                        <div class="bm_clt_ctl_100_special" style="width: 184px">
                                            <asp:DropDownList ID="xsubject_1" runat="server" CssClass="bm_academic_dropdown_100_special bm_academic_ctl_global bm_academic_dropdown"
                                                >
                                            </asp:DropDownList>
                                        </div>
                                    </div>
