...
{
    public partial class amexamh123 : System.Web.UI.Page
    {
            ...
            try
            {
                if (!IsPostBack)
                {
                    ...
                    if (xsession1 != "" && xterm1 != "" && xclass1 != "" && xsection1 != "" && xsubject1 != "" && xcttype1 != "" && xctno1 != "")
                    {
                        ...
                        lblxsession.Text = xsession1;
                        lblxterm.Text = xterm1;
                        lblxclass.Text = xclass1;
                        lblxgroup.Text = xgroup1;
                        lblxsection.Text = xsection1;

                        if ((xpaper1 != "" || xpaper1 != String.Empty) && (xext1 != "" || xext1 != String.Empty))
                        {
                            lblxsubject.Text = xsubject1 + "(" + xext1 + ")" + "-" + xpaper1;

                        }
                        else if ((xpaper1 != "" || xpaper1 != String.Empty) && (xext1 == "" || xext1 == String.Empty))
                        {
                            lblxsubject.Text = xsubject1 + "-" + xpaper1;
                        }
                        else if ((xpaper1 == "" || xpaper1 == String.Empty) && (xext1 != "" || xext1 != String.Empty))
                        {
                            lblxsubject.Text = xsubject1 + "(" + xext1 + ")";
                        }
                        else
                        {
                            lblxsubject.Text = xsubject1;
                        }

                        lblctno.Text = xcttype1 + "-" + xctno1;
        ...
        protected void FillControl(object sender, EventArgs e)
        {
            try
            {
                ...
                if (row != null)
                {
                    ...
                    lblxdate.Text = GridView2.Rows[index].Cells[3].Text;
                    ...
                    if (xctno.Text != "")
                    {
                        ...
                        if (ViewState["xdate1"] != null)
                        {
                            ...
                            if (xdate1.Date >= xnsdate1.Date || xdate1.Date < xpsdate.Date)
                            {
                                ...
                                lblxdate.Text = Convert.ToString(ViewState["xdate1"]);
                    ...
                    using (SqlConnection conn = new SqlConnection(zglobal.constring))
                    {
                        using (DataSet dts = new DataSet())
                        {
                            ...
                            if (dtexam.Rows.Count > 0)
                            {
                                ...
                                lblxtopic.Text = dtexam.Rows[0]["xtopic"].ToString();
                                lblxcteacher.Text = dtexam.Rows[0]["xcteacher1"].ToString();
                                lblxsteacher.Text = dtexam.Rows[0]["xsteacher1"].ToString();
                    ...
                    using (SqlConnection conn = new SqlConnection(zglobal.constring))
                    {
                        using (DataSet dts = new DataSet())
                        {
                            ...
                            if (dtexam.Rows.Count > 0)
                            {
                                ...
                                lblxdate.Text = Convert.ToDateTime(dtexam.Rows[0]["xdate"]).ToString("dd/MM/yyyy");
                                    ...
                                    dtexam.Rows[0]["xrefcttype"].ToString() != "")
                                {
                                    ...
                                    lblctno.Text = lblctno.Text + " Ref:- " + xref;
                                }
                            ...
                            if (dtexam.Rows.Count > 0)
                            {
                                ...
                                foreach (DataRow row in dtexam.Rows)
                                {
                                    if (row["xdate"].Equals(DBNull.Value) == false)
                                    {
                                        ...
                                        {
                                            xdate.Text = Convert.ToDateTime(row["xdate"]).ToString("dd/MM/yyyy");
                                            lblxdate.Text = Convert.ToDateTime(row["xdate"]).ToString("dd/MM/yyyy");
