...
{
    public partial class asfinalreportcard : System.Web.UI.Page
    {
        ...
        public void fnFillDataGrid(object sender, EventArgs e)
        {
            try
            {
                ...
                using (SqlConnection con = new SqlConnection(zglobal.constring))
                {
                    using (DataSet dts1 = new DataSet())
                    {
                        ...
                        else
                        {
                            ...
                            report.Attributes.Add("src", "about:black");
                            return;
                        }
                ...
                //crystalReport.Load(Server.MapPath("~/reports/amreportcardfinaloffline.rpt")); // path of report 
                ...
                //crystalReport.SetParameterValue("xsection", xsection1);
                ...
                //myParam1.ParameterFieldName = "xsession";
                //myDiscreteValue1.Value = xsession1;
                ...
                //myParam11.ParameterFieldName = "xclass";
                //myDiscreteValue11.Value = xclass1;
                ...
                //myParam111.ParameterFieldName = "xgroup";
                //myDiscreteValue111.Value = xgroup1;
                ...
                //myParamSection.ParameterFieldName = "xsection";
                //myDiscreteValueSection.Value = xsection1;
                ...
                report.Attributes.Add("src", "/forms/academic/reports/rptreportcardfinaloffline.aspx?zid=" + zid1 + "&xsession=" + xsession1 + "&xclass=" + xclass1 + "&xgroup=" + xgroup1 + "&xsection=" + xsection1);
