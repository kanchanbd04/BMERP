<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/academic_site.Master"
    CodeBehind="asfinalreportcard.aspx.cs" Inherits="OnlineTicketingSystem.forms.BMERP.asfinalreportcard"
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function fnPrintNumSchedule() {
            ...
            $.ajax({
                url: "asreportcard.aspx/fnGetStatus",

                type: "POST",

                data: "{'xsession1' : '" + xsession1 + "', 'xterm1':'" + xterm1 + "', 'xclass1' : '" + xclass1 + "', 'xgroup1' : '" + xgroup1 + "', 'xsection1' : '" + xsection1 + "'}",
                ...
                success: function (res) {
                    ...
                    if (r != "success") {
                        if (r == "fail") {
                            var r1 = confirm("Do you want to print report card without attendance entry?");
                            if (r1 == true) {
                                var openwin = window.open('/forms/academic/reports/rptreportcard.aspx?zid=' + zid + '&xsession=' + xsession1 + '&xterm=' + xterm1 + '&xclass=' + xclass1 + '&xgroup=' + xgroup1 + '&xsection=' + xsection1 , 'tabulation', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, copyhistory=no, width=' + screen.width + ', height=' + screen.height + ', top=0, left=0, targets=_blank');
                                openwin.focus();
                            } 
                        } else {
                            alert(r);
...
//            var openwin = window.open('/forms/academic/reports/rptreportcard.aspx?zid=' + zid + '&xsession=' + xsession + '&xterm=' + xterm + '&xclass=' + xclass + '&xgroup=' + xgroup + '&xsection=' + xsection , 'tabulation', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, copyhistory=no, width=' + screen.width + ', height=' + screen.height + ', top=0, left=0, targets=_blank');
//            openwin.focus();
            //openwin.print();
            //return false;
        }
    ...
    <div class="bm_academic_container">
        <div class="bm_academic_container_header">
            <div class="header_label1" id="header_label" runat="server">
                <span class="bm_am_header_round">Final Report Card</span>
            </div>
        </div>
                ...
                <div class="bm_academic_grid_container" id="list" runat="server">
                    <div class="grid_header">
                        ...
                        <div class="flot_right">
                            ...
                            <div class="bm_ctl_container_100_special" style="float: left;margin-top: 5px;
                                margin-right: 10px; width: 122px; display: none;">
                                <div class="bm_ctl_label_align_right_100_special">
                            ...
                            <div class="bm_ctl_container_50_50" style="float: left; width: 32px; margin-top: 5px;
                                ...
                                <div class="bm_clt_ctl_50_50" style="width: 100%;">
                                    <asp:ImageButton ID="btnRefresh" runat="server" ImageUrl="~/images/reload70.png"
                                        Width="25px" Height="25px" OnClick="fnFillDataGrid" CssClass="bm_academic_button_zoom" ToolTip="Show"/>
                                </div>
                            </div>
                           
                            
                          <%--  <div class="bm_ctl_container_50_50" style="float: left; width: 32px; margin-top: 5px;
                                margin-left: 10px; border: none; height: 32px; ">
                                <div class="bm_clt_ctl_50_50" style="width: 100%;">
                                    <asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="~/images/download.png"
                                        Width="25px" Height="25px" OnClientClick="fnPrintNumSchedule();" OnClick="fnFillDataGrid" CssClass="bm_academic_button_zoom" ToolTip="Download"/>
                                </div>
                            </div>
                             ...
                             <div class="bm_ctl_container_50_50" style="float: left; width: 32px; margin-top: 5px;
                                ...
                                <div class="bm_clt_ctl_50_50" style="width: 100%;">
                                    <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/images/printer-blue-icon.png"
                                        Width="25px" Height="25px" OnClientClick="fnPrintNumSchedule();" OnClick="fnFillDataGrid" CssClass="bm_academic_button_zoom" ToolTip="Print"/>
                                </div>
                            </div>--%>
                    ...
                    <div class="grid_body">
                        ...
                        <div style="width: 100%; height: 550px;" >
                            <iframe id="report" runat="server" style="height: 100%; width: 100%; border: none; ">
                         
                     </iframe>
                           <%--<CR:CrystalReportViewer BestFitPage="False" Height="1200px" Width="100%" ID="CrystalReportViewer1" runat="server" AutoDataBind="true" EnableParameterPrompt="False" BorderStyle="None" HasToggleGroupTreeButton="False" HasCrystalLogo="False" HasDrillUpButton="False" HasSearchButton="True" HasGotoPageButton="True" HasPageNavigationButtons="True" EnableDatabaseLogonPrompt="False" EnableDrillDown="False" HasDrilldownTabs="False" HasToggleParameterPanelButton="False" GroupTreeStyle-ShowLines="False" ToolPanelView="None" PrintMode="Pdf" PageZoomFactor="100" HasExportButton="True" HasPrintButton="True" ShowAllPageIds="False" SeparatePages="True" />--%>
                        </div>
                    </div>
                </div>
            </div>
