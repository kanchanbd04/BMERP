<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/academic_site.Master"
    CodeBehind="asgradeanalysis.aspx.cs" Inherits="OnlineTicketingSystem.forms.BMERP.asgradeanalysis"
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    <script type="text/javascript">
        ...
        // alert("Hi");
            ...
            var xflag = $("#<%= xflag.ClientID%>").val();
            <%--var xsubject = $("#<%= xsubject.ClientID%>").val();
            var xpaper = $("#<%= xpaper.ClientID%>").val();--%>
            var openwin = window.open('/forms/academic/reports/rptasgradeanalysis.aspx?zid=' + zid + '&xsession=' + xsession + '&xterm=' + xterm + '&xclass=' + xclass + '&xgroup=' + xgroup + '&xsection=' + xsection + '&xflag=' + xflag , 'asgradeanalysis', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, copyhistory=no, width=' + screen.width + ', height=' + screen.height + ', top=0, left=0, targets=_blank');
              openwin.focus();
            //openwin.print();
            //return false;
        } 
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Grade Analysis (Subject Wise)</span>
                    </div>
                </div>
                ...
                <div class="bm_academic_container_footer">
                    <div class="footer_list_padding2">
                        <div style="margin-left: 15px; margin-bottom: 5px; width: 100%;">
                          ...
                          <%--  <div class="bm_ctl_container_100_special" style="display: inline-block; margin-left: 700px; border: none">
                        ...
                        <div class="bm_academic_grid_container" id="list" runat="server">
                            ...
                            <div class="bm_ctl_container_100_special" style="display: inline-block; width: 110px">
                                ...
                                <div class="bm_clt_ctl_100_special" style="width: 58px">
                                    ...
                                    <div class="bm_ctl_container_100_special" style="display: inline-block;">
                                        <div class="bm_ctl_label_align_right_100_special" style="width: 60%">
                                            <asp:Label ID="Label3" runat="server" Text="Show Marks :" AssociatedControlID="xflag"
                                                CssClass="label"></asp:Label>
                                        </div>
                                        <div class="bm_clt_ctl_100_special" style="width: 40%">
                                            <asp:DropDownList ID="xflag" runat="server" CssClass="bm_academic_dropdown_100_special bm_academic_ctl_global bm_academic_dropdown"
                                                AutoPostBack="True" OnTextChanged="combo_OnTextChanged">
                            ...
                            <div class="grid_body" style="width: 1229.4px; overflow: auto;">
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" ShowFooter="true"
                                    CssClass="bm_academic_grid1 bm_academic_grid4" FooterStyle-CssClass="FooterStyle" RowStyle-CssClass="RowStyle"
