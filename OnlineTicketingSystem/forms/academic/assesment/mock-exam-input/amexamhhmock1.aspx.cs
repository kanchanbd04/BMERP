...
{
    public partial class amexamhhmock1 : System.Web.UI.Page
    {
        ...
        private void BindGrid()
        {
            ...
            string str1 = "SELECT ROW_NUMBER() OVER (ORDER BY xcttype desc, xctno asc) AS xid,* FROM amexamh inner join amexamd on amexamh.zid=amexamd.zid and amexamh.xrow=amexamd.xrow " +
                "WHERE amexamh.zid=@zid AND xsession=@xsession AND xclass=@xclass AND xterm=@xterm AND xgroup=@xgroup AND xtype='Mock Exam'   order by xsection";
            ...
            string str = "SELECT distinct xsubject,xpaper,coalesce(xext,'') as xext FROM amexamh inner join amexamd on amexamh.zid=amexamd.zid and amexamh.xrow=amexamd.xrow  " +
                " WHERE amexamh.zid=@zid AND amexamh.xsession=@xsession AND amexamh.xclass=@xclass AND amexamh.xterm=@xterm AND amexamh.xgroup=@xgroup AND amexamh.xtype='Mock Exam'  order by xsubject,xpaper,xext";
            ...
            if (dtmarks.Rows.Count > 0)
            {
                ...
                tfield12000.ItemStyle.HorizontalAlign = HorizontalAlign.Center;
                tfield12000.ItemStyle.Width = 50;
                ...
                using (SqlConnection con = new SqlConnection(zglobal.constring))
                {
                    using (DataSet dts1 = new DataSet())
                    {
                        ...
                        string query =
                            "select xsubject,xpaper,coalesce(xext,'') as xext,MAX(tbl.best) as best1 from " +
                            " (select zid,xsession,xterm,xclass,xgroup,xsection,xsubject,xpaper,xext,count(*) as best " +
                            " from amexamh where xtype='Mock Exam' " +
                            " group by zid,xsession,xterm,xclass,xgroup,xsection,xsubject,xpaper,xext) as tbl " +
                            "WHERE zid=@zid AND xsession=@xsession AND xclass=@xclass AND xterm=@xterm AND xgroup=@xgroup  " +
                            " group by xsubject,xpaper,xext ";
                ...
                using (SqlConnection con = new SqlConnection(zglobal.constring))
                {
                    using (DataSet dts1 = new DataSet())
                    {
                        ...
                        string query =
                            ...
                            "WHERE zid=@zid AND xsession=@xsession AND xclass=@xclass AND xterm=@xterm AND xgroup=@xgroup AND xtype='Mock Exam' AND xstatus in ('New','Approved3') ";
                ...
                using (SqlConnection con = new SqlConnection(zglobal.constring))
                {
                    using (DataSet dts1 = new DataSet())
                    {
                        ...
                        string query =
                            ...
                            " (select max(xdate) from amexamh where xtype='Mock Exam' and zid=@zid and " +
                ...
                for (int i = GridView1.Rows.Count - 2; i >= 0; i--)
                {
                    ...
                    if (txt1.Text == txt2.Text)
                    {
                        ...
                        if (ctn != 0)
                        {
                            for (int m = 1; m <= ctn; m++)
                            {
                                currRow.Cells[m + 7].RowSpan = RowSpan;
                                prevRow.Cells[m + 7].Visible = false;
                            }
                        }
                        ...
                        if (lblpap1.Text == lblpap2.Text)
                        {
                            ...
                            currRow.Cells[3].RowSpan = RowSpan3;
                            prevRow.Cells[3].Visible = false;


                            currRow.Cells[ctn + 8].RowSpan = RowSpan3;
                            prevRow.Cells[ctn + 8].Visible = false;

                            currRow.Cells[ctn + 9].RowSpan = RowSpan3;
                            prevRow.Cells[ctn + 9].Visible = false;

                            currRow.Cells[ctn + 10].RowSpan = RowSpan3;
                            prevRow.Cells[ctn + 10].Visible = false;
                ...
                for (int i = 0; i <= GridView1.Rows.Count - 2; i++)
                {
                    ...
                    if (ctn != 0)
                    {
                        ...
                        {
                            //ctn = 10 + i;
                            currRow.Cells[m + 7].BackColor = ColorTranslator.FromHtml(htmlColorCode);

                        }
                    }

                    currRow.Cells[ctn + 8].BackColor = ColorTranslator.FromHtml(htmlColorCode);
                    currRow.Cells[ctn + 9].BackColor = ColorTranslator.FromHtml(htmlColorCode);
                    currRow.Cells[ctn + 10].BackColor = ColorTranslator.FromHtml(htmlColorCode);
                    ...
                    if (ctn != 0)
                    {
                        ...
                        {
                            //ctn = 10 + i;
                            nextRow.Cells[m + 7].BackColor = ColorTranslator.FromHtml(htmlColorCode);
                        }
                    }

                    nextRow.Cells[ctn + 8].BackColor = ColorTranslator.FromHtml(htmlColorCode);
                    nextRow.Cells[ctn + 9].BackColor = ColorTranslator.FromHtml(htmlColorCode);
                    nextRow.Cells[ctn + 10].BackColor = ColorTranslator.FromHtml(htmlColorCode);
                ...
                foreach (GridViewRow row in GridView1.Rows)
                {
                    ...
                    using (SqlConnection con = new SqlConnection(zglobal.constring))
                    {
                        using (DataSet dts1 = new DataSet())
                        {
                            ...
                            //    " except " +
                            //    "select xstdid from amexamvw where zid=@zid  AND xtype='Mock Exam'  " +
                            ...
                            string query =
                               "select xstdid from amexamvw where zid=@zid  AND xtype='Mock Exam'  " +
                               " and xsession=@xsession and xterm=@xterm and xclass=@xclass and xgroup=@xgroup and xsubject=@xsubject and xpaper=@xpaper   and coalesce(xabsent,0) = 1";
                    ...
                    using (SqlConnection con = new SqlConnection(zglobal.constring))
                    {
                        using (DataSet dts1 = new DataSet())
                        {
                            ...
                            string query =
                                "select xstdid from amexamvw where zid=@zid  AND xtype='Mock Exam'  " +
                                " and xsession=@xsession and xterm=@xterm and xclass=@xclass and xgroup=@xgroup and xsubject=@xsubject and xpaper=@xpaper  and  coalesce(xna,0) = 1";
        ...
        protected void OnRowDataBound(object sender, GridViewRowEventArgs e)
        {
            try
            {
                ...
                if (e.Row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    txtPaper.Style["text-align"] = "center";
                    //txtPaper.Attributes.Add("text-align","center");
                    //txtSubject.CssClass = "bm_academic_textbox_grid bm_academic_ctl_global bm_academic_textbox";
                    ...
                    e.Row.Cells[4].Controls.Add(lblSubject);
                    ...
                    e.Row.Cells[5].Controls.Add(lblPaper);
                    ...
                    e.Row.Cells[6].Controls.Add(lblExtension);
                    ...
                    txtSubWeight.BorderWidth = Unit.Pixel(1);
                    txtSubWeight.Attributes.Add("onkeyup", "enter(this,event)");
                    e.Row.Cells[3].Controls.Add(txtSubWeight);
                    ...
                    //{
                    //    DataRow[] result50 =
                    //      ((DataTable)ViewState["amexamhh"]).Select("xsubject='" + (e.Row.DataItem as DataRowView).Row["xsubject"].ToString() + "' and xpaper='" + (e.Row.DataItem as DataRowView).Row["xpaper"].ToString() + "' and xtype1='Mock Exam'");
                    ...
                    {
                        DataRow[] result50 =
                          ((DataTable)ViewState["amexamhh3"]).Select("xsubject='" + (e.Row.DataItem as DataRowView).Row["xsubject"].ToString() + "' and xpaper='" + (e.Row.DataItem as DataRowView).Row["xpaper"].ToString() + "' ");
                ...
                if (row != null)
                {
                    ...
                    using (SqlConnection con = new SqlConnection(zglobal.constring))
                    {
                        using (DataSet dts1 = new DataSet())
                        {
                           ...
                           "where xstatus not in ('Approved2','Approved3') and amexamh.zid=@zid and xclass=@xclass  and xgroup=@xgroup and xsession=@xsession and xterm=@xterm and amexamh.xtype='Mock Exam' and xsubject=@xsubject and xpaper=@xpaper  " +
                    ...
                    if (xperc_subweight != "")
                    {
                        using (SqlConnection con = new SqlConnection(zglobal.constring))
                        {
                            using (DataSet dts1 = new DataSet())
                            {
                                ...
                                //        "and xpaper=@xpaper and xtype='Mock Exam' and xstatus in ('New','Approved3')";
                                ...
                                //                                " AND xsubject=@xsubject AND xpaper=@xpaper  and xtype='Mock Exam'";
                                ...
                                //           "where xstatus  in ('Approved2','Approved3') and amexamh.zid=@zid and xclass=@xclass  and xgroup=@xgroup and xsession=@xsession and xterm=@xterm and amexamh.xtype='Mock Exam'  " +
                                ...
                                //                                query = "IF EXISTS(select * from amexamhh where zid=@zid  and xsession=@xsession and xterm=@xterm and xclass=@xclass and xgroup=@xgroup " +
                                //                                "and xsection=@xsection and xsubject=@xsubject and xpaper=@xpaper and xext=@xext and xtype='Mock Exam' and xtype1='Subject Extension' and xstatus='Test') " +
                                //                                "UPDATE amexamhh SET xtbest=@xtbest,xperc=@xperc,xstatus=@xstatus " +
                                //                                "where zid=@zid  and xsession=@xsession and xterm=@xterm and xclass=@xclass and xgroup=@xgroup " +
                                //                                "and xsection=@xsection and xsubject=@xsubject and xpaper=@xpaper and xext=@xext and xtype='Mock Exam' and xtype1=@xtype1 " +
                                //                                "ELSE " +
                                ...
                                //                               // query = "IF EXISTS(select * from amexamhh where zid=@zid  and xsession=@xsession and xterm=@xterm and xclass=@xclass and xgroup=@xgroup " +
                                //                               //"and xsection=@xsection and xsubject=@xsubject and xpaper=@xpaper and xext=@xext and xtype='Mock Exam'  and xstatus='Test') " +
                                //                               //"UPDATE amexamhh SET xtbest=@xtbest,xperc=@xperc,xstatus=@xstatus " +
                                //                               //"where zid=@zid  and xsession=@xsession and xterm=@xterm and xclass=@xclass and xgroup=@xgroup " +
                                //                               //"and xsection=@xsection and xsubject=@xsubject and xpaper=@xpaper and xext=@xext and xtype='Mock Exam'  " +
                                //                               //"ELSE " +
                                //                               //"INSERT INTO amexamhh (ztime,zid,xrow,xsession,xterm,xclass,xgroup,xsection,xsubject,xpaper,xext,xtype,xtbest,xperc,xstatus,zemail) " +
                                //                               //"VALUES(@ztime,@zid,@xrow,@xsession,@xterm,@xclass,@xgroup,@xsection,@xsubject,@xpaper,@xext,@xtype,@xtbest,@xperc,@xstatus,@zemail) ";
                                ...
                                //                                cmd.Parameters.AddWithValue("@xsubject", xsubject1);
                                //                                cmd.Parameters.AddWithValue("@xpaper", xpaper1t);
                                //                                cmd.Parameters.AddWithValue("@xext", xext1t);
                                //                                cmd.Parameters.AddWithValue("@xtype", "Mock Exam");
                                ...
                                //                                query = "IF EXISTS(select * from amexamhh where zid=@zid  and xsession=@xsession and xterm=@xterm and xclass=@xclass and xgroup=@xgroup " +
                                //                                        "and xsection=@xsection and xsubject=@xsubject and xpaper=@xpaper  and xtype='Mock Exam' and xtype1='Mock Exam' and xstatus='Test') " +
                                //                                        "UPDATE amexamhh SET xtbest=@xtbest,xperc=@xperc,xstatus=@xstatus " +
                                //                                        "where zid=@zid  and xsession=@xsession and xterm=@xterm and xclass=@xclass and xgroup=@xgroup " +
                                //                                        "and xsection=@xsection and xsubject=@xsubject and xpaper=@xpaper and xtype='Mock Exam' and xtype1=@xtype1 " +
                                //                                        "ELSE " +
                                ...
                                //                                cmd.Parameters.AddWithValue("@xapproved1by", xapproved1by);
                                //                                cmd.Parameters.AddWithValue("@xapproved1dt", xapproved1dt);
                                //                                cmd.Parameters.AddWithValue("@xtype1", "Mock Exam");
                                //                                cmd.ExecuteNonQuery();
                                ...
                                //                                //if (result50.Length > 0)
                                //                                //{
                                //                                //    //Insert row for have Mock Exam but not class test
                ...
                if (txtconformmessageValue3.Value == "Yes")
                {
                    ...
                    using (SqlConnection con = new SqlConnection(zglobal.constring))
                    {
                        using (DataSet dts1 = new DataSet())
                        {
                            ...
                            string query =
                           "select xsubject,xpaper,coalesce(xext,'') as xext,xsection from amexamh inner join mscodesam on amexamh.zid=mscodesam.zid and mscodesam.xtype='Section' and amexamh.xsection=mscodesam.xcode " +
                           "where xstatus not in ('Approved2','Approved3') and amexamh.zid=@zid and xclass=@xclass  and xgroup=@xgroup and xsession=@xsession and xterm=@xterm and amexamh.xtype='Mock Exam'  " +
                           "group by xsubject,xpaper,xext,xsection  order by min(cast(xcodealt as int))";
                    ...
                    for (int i = 0; i <= GridView1.Rows.Count - 2; i++)
                    {
                        ...
                        if (txt1.Text == txt2.Text)
                        {
                            ...
                            //    txtWeight2.Text.Trim().ToString() == "")
                            if (subwt1.ToString() == "" || txtSubWeight1.Text.Trim().ToString() == "" || txtSubWeight2.Text.Trim().ToString() == "")
                            {
                                currRow.Cells[0].BackColor = zglobal.rowerr;
                                currRow.Cells[1].BackColor = zglobal.rowerr;
                                currRow.Cells[2].BackColor = zglobal.rowerr;
                        ...
                        else
                        {
                            ...
                            if (txtSubWeight1.Text.Trim().ToString() == "")
                            {
                            ...
                            if ((i + 1) == GridView1.Rows.Count - 1)
                            {
                                ...
                                if (txtSubWeight2.Text.Trim().ToString() == "")
                                {
                    ...
                    using (TransactionScope tran = new TransactionScope())
                    {
                        using (SqlConnection conn = new SqlConnection(zglobal.constring))
                        {
                            ...
                            string query =
                                ...
                                "WHERE zid=@zid AND xsession=@xsession AND xterm=@xterm AND xclass=@xclass AND xgroup=@xgroup and xtype='Mock Exam'";
                            cmd.Parameters.Clear();
                            ...
                            query =
                                    "DELETE FROM amexamhh " +
                                    "WHERE zid=@zid AND xsession=@xsession AND xterm=@xterm AND xclass=@xclass AND xgroup=@xgroup " +
                                    "and xtype='Mock Exam' and xstatus='Test' ";
                                ...
                                foreach (GridViewRow row1 in GridView1.Rows)
                                {
                                    ...
                                    if (result60.Length > 0)
                                    {
                                        foreach (DataRow row2 in result60)
                                        {
                                            ...
                                            query = "IF EXISTS(select * from amexamhh where zid=@zid  and xsession=@xsession and xterm=@xterm and xclass=@xclass and xgroup=@xgroup " +
                                            "and xsection=@xsection and xsubject=@xsubject and xpaper=@xpaper and xext=@xext and xtype='Mock Exam' and xtype1='Subject Extension') " +
                                ...
                                foreach (GridViewRow row1 in GridView1.Rows)
                                {
                                    ...
                                    if (result60.Length > 0)
                                    {
                                        foreach (DataRow row2 in result60)
                                        {
                                            ...
                                            query = "IF EXISTS(select * from amexamhh where zid=@zid  and xsession=@xsession and xterm=@xterm and xclass=@xclass and xgroup=@xgroup " +
                                                    "and xsection=@xsection and xsubject=@xsubject and xpaper=@xpaper  and xtype='Mock Exam' and xtype1='Mock Exam') " +
                                                    "UPDATE amexamhh SET xtbest=@xtbest,xperc=@xperc,xstatus=@xstatus,xapproved1by=@xapproved1by,xapproved1dt=@xapproved1dt " +
                                                    "where zid=@zid  and xsession=@xsession and xterm=@xterm and xclass=@xclass and xgroup=@xgroup " +
                                                    "and xsection=@xsection and xsubject=@xsubject and xpaper=@xpaper and xtype='Mock Exam' and xtype1=@xtype1 " +
                                                    "ELSE " +
