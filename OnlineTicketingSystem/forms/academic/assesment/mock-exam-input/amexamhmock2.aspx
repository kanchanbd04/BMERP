<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="amexamhmock2.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.amexamhmock2" %>
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Mock Exam Marks Approval (Class Teacher)</span>
                    </div>
                </div>
                                            ...
                                            <tr>
                                                ...
                                                <tr>
                                                    <td align="left" style="padding: 5px">
                                                        ...
                                                        <asp:Label ID="Label14" runat="server" Text="-" CssClass="xstatus"></asp:Label>
                                                    </td>
                                                </tr>
