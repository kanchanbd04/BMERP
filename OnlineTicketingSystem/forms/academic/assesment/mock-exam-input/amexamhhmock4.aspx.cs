...
{
    public partial class amexamhhmock4 : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                using (SqlConnection con = new SqlConnection(zglobal.constring))
                {
                    using (DataSet dts1 = new DataSet())
                    {
                        ...
                        da1.SelectCommand.Parameters.AddWithValue("@xtype", "CombinedMock");
        ...
        private void BindGrid()
        {
            ...
            using (SqlConnection con = new SqlConnection(zglobal.constring))
            {
                using (DataSet dts1 = new DataSet())
                {
                  ...
                  "WHERE zid=@zid AND xsession=@xsession AND xclass=@xclass AND xgroup=@xgroup and xtype in ('Mock Exam') ";
            ...
            if (xsection.Text == "All")
            {
                str = "select zid, xsession,xterm,xclass,xgroup,xsection,xrow,xname,xstdid,xcodealt,xexam,(xname + '<br/>' + xstdid) as xnmid from amstdgs1,amexammock  " +
                      "WHERE amstdgs1.zid=@zid AND amstdgs1.xsession=@xsession  AND amstdgs1.xclass=@xclass AND amstdgs1.xgroup=@xgroup and xtype='Mock Exam' " +
                       "and xterm in (select xcode from mscodesam where zid=amstdgs1.zid and xtype='Mock No' and xcodealt<=(select xcodealt from mscodesam where zid=amstdgs1.zid and xtype='Mock No' and xcode=@xterm)) " +
            ...
            {
                str = "select zid, xsession,xterm,xclass,xgroup,xsection,xrow,xname,xstdid,xcodealt,xexam,(xname + '<br/>' + xstdid) as xnmid from amstdgs1,amexammock  " +
                      "WHERE amstdgs1.zid=@zid AND amstdgs1.xsession=@xsession  AND amstdgs1.xclass=@xclass AND amstdgs1.xgroup=@xgroup AND amstdgs1.xsection=@xsection and xtype='Mock Exam' " +
                       "and xterm in (select xcode from mscodesam where zid=amstdgs1.zid and xtype='Mock No' and xcodealt<=(select xcodealt from mscodesam where zid=amstdgs1.zid and xtype='Mock No' and xcode=@xterm)) " +
                      "order by xname,xcodealt ";
            }
            ...
            if (dtmarks.Rows.Count > 0)
            {
                ...
                using (SqlConnection con = new SqlConnection(zglobal.constring))
                {
                    ...
                    string query = "SELECT distinct xsubject,xpaper FROM amexamh inner join amexamd on amexamh.zid=amexamd.zid and amexamh.xrow=amexamd.xrow " +
                                   "WHERE amexamh.zid=@zid AND xsession=@xsession AND xclass=@xclass AND xterm=@xterm AND xgroup=@xgroup and amexamh.xstatus='Approved3' ORDER BY xsubject,xpaper";
                ...
                using (SqlConnection con = new SqlConnection(zglobal.constring))
                {
                    using (DataSet dts1 = new DataSet())
                    {
                        string query = "SELECT * FROM amexamhhd1 WHERE zid=@zid AND xsession=@xsession AND xclass=@xclass  AND xgroup=@xgroup AND xtype='CombinedMock'   ";
            ...
            try
            {
                ...
                using (SqlConnection con = new SqlConnection(zglobal.constring))
                {
                    using (DataSet dts1 = new DataSet())
                    {
                        ...
                        //          "WHERE zid=@zid AND xsession=@xsession  AND xclass=@xclass AND xgroup=@xgroup AND xtype='Mock Exam' and xstatus='Approved3'";

                        //}
                        //else
                        //{
                        //    query = "select distinct xterm from amexamh  " +
                        //          "WHERE zid=@zid AND xsession=@xsession  AND xclass=@xclass AND xgroup=@xgroup AND xsection=@xsection AND xtype='Mock Exam' and xstatus='Approved3'";
                        //}
                        ...
                        {
                            query = "select * from amexammock  ";

                            SqlDataAdapter da2 = new SqlDataAdapter(query, con);


                            da2.Fill(dts1, "tempztcode1");
                            DataTable dtamexammock = new DataTable();
                            dtamexammock = dts1.Tables["tempztcode1"];
                            ...
                            //    gvRow.Cells[1].RowSpan = dtxtermcount.Rows.Count * dtamexammock.Rows.Count;
                            //    gvRow.Cells[0].RowSpan = dtxtermcount.Rows.Count * dtamexammock.Rows.Count;


                            //    for (int i = 1; i < dtxtermcount.Rows.Count * dtamexammock.Rows.Count; i++)
                            //    {
                            ...
                            //    rowno = rowno + 1;
                            //    rowIndex = rowIndex + dtxtermcount.Rows.Count * dtamexammock.Rows.Count;
                            //}
                            ...
                            while (rowIndex1 < GridView1.Rows.Count)
                            {
                                ...
                                gvRow.Cells[2].RowSpan = dtamexammock.Rows.Count;
                                gvRow.Cells[4 + (int)ViewState["rowCount"]].RowSpan = dtamexammock.Rows.Count;
                                gvRow.Cells[4 + (int)ViewState["rowCount"] + 1].RowSpan = dtamexammock.Rows.Count;
                                gvRow.Cells[4 + (int)ViewState["rowCount"] + 2].RowSpan = dtamexammock.Rows.Count;

                                for (int i = 1; i < dtamexammock.Rows.Count; i++)
                                {
                                ...
                                rowIndex1 = rowIndex1 + dtamexammock.Rows.Count;
                            }
                            ...
                            while (rowIndex1 < GridView1.Rows.Count)
                            {
                                ...
                                for (int i = 4; i < 4 + (int)ViewState["rowCount"]; )
                                {
                                    ...
                                    if (m + 2 < (int)ViewState["rowCount"])
                                    {
                                        if (((List<string>)ViewState["xsubject"])[m + 2] == "")
                                        {
                                            gvRow.Cells[i + 2].RowSpan = dtamexammock.Rows.Count;


                                            for (int h = 1; h < dtamexammock.Rows.Count; h++)
                                            {
                    ...
                    for (int i = 4; i < 4 + (int)ViewState["rowCount"]; ) //i = i + 2
                    {
                        if (m + 2 < (int)ViewState["rowCount"])
                        {
                            if (((List<string>)ViewState["xsubject"])[m + 2] == "")
                            {
                                ...
                                DataRow[] result;
                                DataRow[] result1;
                                if ((e.Row.DataItem as DataRowView).Row["xexam"].ToString() != "Total" && (e.Row.DataItem as DataRowView).Row["xexam"].ToString() != "Weight")
                                {
                                    if ((e.Row.DataItem as DataRowView).Row["xexam"].ToString() == "%")
                                    {
                                        result =
                                           ...
                                           ((List<string>)ViewState["xsubject"])[m].ToString() + "' and xtype='Mock Exam' and xpaper='" + ((List<string>)ViewState["xpaper"])[k].ToString() + "'");
                                    }
                                ...
                                if (result.Length > 0)
                                {
                                    ...
                                    else if ((e.Row.DataItem as DataRowView).Row["xexam"].ToString() == "Total" || (e.Row.DataItem as DataRowView).Row["xexam"].ToString() == "Weight")
                                    {
                                        lblmarks.Text =
                        ...
                        //            (e.Row.DataItem as DataRowView).Row["xterm"].ToString() + "' and xsrow=" + xsrow + " and xsubject='" +
                        //           ((List<string>)ViewState["xsubject"])[k].ToString() + "' and xtype='Mock Exam' and xpaper='" + ((List<string>)ViewState["xpaper"])[k].ToString() + "'");
                        //    }
                        //    else if ((e.Row.DataItem as DataRowView).Row["xexam"].ToString() == "Marks")
                        //    {
                        //        result =
        ...
        public void btnGenerate_Click(object sender, EventArgs e)
        {
            ...
            //            if (dtamexamh.Rows.Count > 0)
            //            {
            //                message.InnerHtml = "Please check for all class test & Mock Exam approval.";
            //                message.Style.Value = zglobal.am_warningmsg;
            //                return;
            //            }
            //        }
            ...
            //    //        da1.SelectCommand.Parameters.AddWithValue("@xterm", xterm.Text.ToString().Trim());
            //    //        da1.SelectCommand.Parameters.AddWithValue("@xgroup", xgroup.Text.ToString().Trim());
            //    //        da1.SelectCommand.Parameters.AddWithValue("@xtype", "Mock Exam");
            //    //        //da1.SelectCommand.Parameters.AddWithValue("@xsubject", xsubject1);
            //    //        //da1.SelectCommand.Parameters.AddWithValue("@xpaper", xpaper1);
            //    //        //da1.SelectCommand.Parameters.AddWithValue("@xsection", xsection.Text.ToString().Trim());
            //    //        //da1.SelectCommand.Parameters.AddWithValue("@xsrow", _student.Value.ToString().Trim());
            ...
            //    //        if (dtamexamh.Rows.Count <= 0)
            //    //        {
            //    //            message.InnerHtml = "Please approve all Mock Exam before generate tabulation sheet.";
            //    //            message.Style.Value = zglobal.am_warningmsg;
            //    //            return;
            //    //        }
            ...
            //    //insert rows for have class test but not Mock Exam
            ...
            //    //                                    "and xsection=@xsection and xsubject=@xsubject and xpaper=@xpaper  and xtype='Mock Exam' and xtype1='Subject Extension') " +
            //    //                                    "UPDATE amexamhh SET xtbest=@xtbest,xperc=@xperc,xstatus=@xstatus,xapproved1by=@xapproved1by,xapproved1dt=@xapproved1dt " +
            //    //                                    "where zid=@zid  and xsession=@xsession and xterm=@xterm and xclass=@xclass and xgroup=@xgroup " +
                ...
                using (SqlConnection conn = new SqlConnection(zglobal.constring))
                {
                    using (DataSet dts = new DataSet())
                    {
                        ...
                        try
                        {
                            ...
                            string query = "DELETE FROM amexamhhd1 WHERE zid=@zid AND xsession=@xsession AND xclass=@xclass AND xterm=@xterm AND xgroup=@xgroup AND xtype='CombinedMock'  AND xsection=@xsection AND xsrow=@xsrow  ";
                            cmd.Parameters.Clear();
                            ...
                            query = "INSERT INTO amexamhhd1 (ztime,zid,xsession,xterm,xclass,xgroup,xsection,xsrow,xtype,xremarks,zemail) " +
                                       "VALUES(@ztime,@zid,@xsession,@xterm,@xclass,@xgroup,@xsection,@xsrow,'CombinedMock',@xremarks,@zemail) ";
        ...
        public static string fnFetchComments(string xsession1, string xterm1, string xclass1, string xgroup1, string xsection1, string xsrow1)
        {
            try
            {
                ...
                using (SqlConnection con = new SqlConnection(zglobal.constring))
                {
                    using (DataSet dts1 = new DataSet())
                    {
                        string query = "SELECT * FROM amexamhhd1 WHERE zid=@zid AND xsession=@xsession AND xclass=@xclass AND xterm=@xterm AND xgroup=@xgroup AND xtype='CombinedMock'  AND xsection=@xsection AND xsrow=@xsrow ";
                ...
                if (txtconformmessageValue3.Value == "Yes")
                {
                    ...
                    using (SqlConnection con = new SqlConnection(zglobal.constring))
                    {
                        using (DataSet dts1 = new DataSet())
                        {
                            ...
                            string query =
                                "select * from amexamh where zid=@zid and xsession=@xsession and xclass=@xclass and xterm=@xterm and xgroup=@xgroup and xtype='Mock Exam'";
                    ...
                    using (SqlConnection con = new SqlConnection(zglobal.constring))
                    {
                        using (DataSet dts1 = new DataSet())
                        {
                            ...
                            if (dtamexamh.Rows.Count > 0)
                            {
                                message.InnerHtml = "Result already approved for this term.";
                                message.Style.Value = zglobal.am_warningmsg;
                                return;
                            }
                    ...
                    using (SqlConnection con = new SqlConnection(zglobal.constring))
                    {
                        using (DataSet dts1 = new DataSet())
                        {
                            ...
                            string query =
                          "SELECT * FROM amexamph_sumext_exam " +
                          "WHERE zid=@zid AND xsession=@xsession AND xclass=@xclass AND xgroup=@xgroup and xtype='Mock Exam'";
                    ...
                    using (TransactionScope tran = new TransactionScope())
                    {
                        using (SqlConnection conn = new SqlConnection(zglobal.constring))
                        {
                            ...
                            string query = "INSERT INTO amexamhh (ztime,zid,xrow,xsession,xterm,xclass,xgroup,xtype,xstatus,zemail,xapproved1by,xapproved1dt) " +
                                            "VALUES(@ztime,@zid,@xrow,@xsession,@xterm,@xclass,@xgroup,@xtype,@xstatus,@zemail,@xapproved1by,@xapproved1dt) ";
                            ...
                            cmd.Parameters.AddWithValue("@xterm", xterm.Text.ToString().Trim());
                            cmd.Parameters.AddWithValue("@xgroup", xgroup.Text.ToString().Trim());
                            cmd.Parameters.AddWithValue("@xtype", "CombinedMock");
                            cmd.Parameters.AddWithValue("@xstatus", xstatus);
                            cmd.Parameters.AddWithValue("@zemail", zemail);
                            cmd.Parameters.AddWithValue("@xapproved1by", xapproved1by);
                            cmd.Parameters.AddWithValue("@xapproved1dt", xapproved1dt);
