<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/academic_site.Master"
    CodeBehind="amexamhhmock2.aspx.cs" Inherits="OnlineTicketingSystem.forms.BMERP.amexamhhmock2"
...
//                            scrolling: "yes" // must have the jquery-1.3.2.min.js script installed to use
        ...
        $("body").on("click", ".bm_am_btn_generate", function () {
            //alert("HI");
            //return false;
            var selectedvalue = confirm("Press 'OK' to generate tabulation sheet for " + document.getElementById('<%=xclass.ClientID %>').value + ".");
               if (selectedvalue) {
                   document.getElementById('<%=hgenerate.ClientID %>').value = "Yes";
            } else {
                document.getElementById('<%=hgenerate.ClientID %>').value = "No";
            }
               //return false;
           });
        ...
        $("body").on("click", ".btnComments", function () {
            ...
            $.ajax({
                url: "amexamhhmock2.aspx/fnFetchComments",
        ...
        $("body").on("click", "#btnOk", function () {
            ...
            $.ajax({
                url: "amexamhhmock2.aspx/fnInsetComments",
    ...
    <div class="bm_academic_container">
        <div class="bm_academic_container_header">
            <div class="header_label1" id="header_label" runat="server">
                <span class="bm_am_header_round">Generate Tabulation Sheet</span>
            </div>
        </div>
                        ...
                        <div class="bm_layout_box_padding">
                            ...
                            <div style="width: 100%; clear: both;">
                                ...
                                <div class="bm_ctl_container_100_special" style="display: inline-block; width: 160px">
                                    <div class="bm_ctl_label_align_right_100_special">
                                        <asp:Label ID="Label8" runat="server" Text="Mock :" AssociatedControlID="xterm" CssClass="label"></asp:Label>
                                    </div>
                                    <div class="bm_clt_ctl_100_special">
    ...
    <asp:HiddenField ID="hgenerate" runat="server" />
