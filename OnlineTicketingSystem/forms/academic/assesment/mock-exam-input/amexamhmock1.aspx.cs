...
{
    public partial class amexamhmock1 : System.Web.UI.Page
    {
                ...
                using (SqlConnection con = new SqlConnection(zglobal.constring))
                {
                    using (DataSet dts = new DataSet())
                    {
                        ...
                        string query =
                            ...
                            "SELECT count(*) FROM amexamhh WHERE zid=@zid AND xsession=@xsession AND xclass=@xclass AND xterm=@xterm AND xgroup=@xgroup AND xtype='Mock Exam' AND xstatus='Approved3' ";
        ...
        protected void btnRefresh_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //message.InnerHtml = xterm.Text.ToString().Trim();
