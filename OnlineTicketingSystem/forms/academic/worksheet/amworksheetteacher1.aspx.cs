...
{
    public partial class amworksheetteacher1 : System.Web.UI.Page
    {
        ...
        public void fnTeacherFeedback(object sender, EventArgs e)
        {
            try
            {
                ...
                using (SqlConnection con = new SqlConnection(zglobal.constring))
                {
                    string query = "SELECT xsubject,xpapext FROM amclasssubvw WHERE zid=@zid AND xclass=@xclass order by xsubject";
