...
{
    public partial class lbbook_temp : System.Web.UI.Page
    {
        private int globalerr;

        private void fnButtonState()
        {
            //if (ViewState["xlbtrncode"] == null)
            //{
            ...
            //                   "zid=" + _zid + " AND xlbtrncode='" + Convert.ToString(ViewState["xlbtrncode"]) + "'");
            ...
            //    //               "zid=" + _zid + " AND xrow=" + Convert.ToInt32(ViewState["xlbtrncode"]));
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!IsPostBack)
                {
                    ...
                    ViewState["xtrnlb"] = "ISSU";
                    xtrnlb.Text = ViewState["xtrnlb"].ToString();
                    ...
                    //"and xtrn='" + ViewState["xtrnlb"].ToString() + "'");

                    fnButtonState();

                    //ViewState["xrel"] = zglobal.fnGetValue("xrel", "mstrnp",
                    //  "zid=" + Convert.ToInt32(Convert.ToString(HttpContext.Current.Session["business"])) + " and xtypetrn='" + ViewState["xtypetrn"].ToString() + "' " +
                    //  "and xtrn='" + ViewState["xtrnlb"].ToString() + "' and xtyperel='" + ViewState["xtyperel"].ToString() + "'");
                    ...
                    //string xlbtrncode1 = Request.QueryString["xlbtrncode"] != null ? Request.QueryString["xlbtrncode"].ToString() : "";

                    //if (xlbtrncode1 != "")
                    //{
                    //    MasterPage m = this.Page.Master;
                    //    zglobal.fnDisableMasterPageContent(m);
                    //    fnFillControl(xlbtrncode1);
        ...
        public void fnRegisterPostBack()
        {
            ...
            //{
            //    LinkButton lnkFull1 = row.FindControl("xlbtrncode") as LinkButton;
        ...
        private void BindGrid()
        {
            ...
            //                     da1.SelectCommand.Parameters.AddWithValue("xrow", Convert.ToInt32(ViewState["xlbtrncode"]));
        ...
        private void SetInitialRow()
        {
            ...
            for (int i = 0; i < 20; i++)
            {
                ...
                //dr["Column4"] = DateTime.Now.ToString("dd/MM/yyyy");
            ...
            foreach (GridViewRow row in GridView1.Rows)
            {
                DropDownList ddl2 = (DropDownList)row.Cells[3].FindControl("xlbslf");
                zglobal.fnGetComboDataCD("Book Shelf", ddl2);
            }

            //DropDownList ddl2 = (DropDownList)GridView1.Rows[0].Cells[3].FindControl("xlbslf");
            //zglobal.fnGetComboDataCD("Book Shelf", ddl2);
            ...
            if (ViewState["CurrentTable"] != null)
            {
                ...
                if (dtCurrentTable.Rows.Count > 0)
                {
                    ...
                    for (int i = 0; i < dtCurrentTable.Rows.Count - 1; i++)
                    {
                        ...
                        TextBox box1 = (TextBox)GridView1.Rows[i].Cells[1].FindControl("xlbord");
                        TextBox box2 = (TextBox)GridView1.Rows[i].Cells[2].FindControl("xlbtitle");
                        DropDownList box3 = (DropDownList)GridView1.Rows[i].Cells[3].FindControl("xlbslf");
                        //TextBox box4 = (TextBox)GridView1.Rows[i].Cells[4].FindControl("xlbrfdate");
                        //TextBox box5 = (TextBox)GridView1.Rows[i].Cells[5].FindControl("xlbrcvdate");
                        //TextBox box6 = (TextBox)GridView1.Rows[i].Cells[6].FindControl("xlbtrnrcv");
                        //TextBox box7 = (TextBox)GridView1.Rows[i].Cells[7].FindControl("xlbstatus");
                        //TextBox box8 = (TextBox)GridView1.Rows[i].Cells[8].FindControl("xnote");
                        //DropDownList box9 = (DropDownList)GridView1.Rows[i].Cells[9].FindControl("xlbslf");

                        //box3.Text = DateTime.Now.ToString("dd/MM/yyyy");
                        ...
                        //dtCurrentTable.Rows[i]["Column10"] = box9.Text;
                        ...
                        //DropDownList ddl2 = (DropDownList)GridView1.Rows[i].Cells[3].FindControl("xlbslf");
                        ////zglobal.fnGetComboDataCD("Book Shelf", ddl2);
                        //dtCurrentTable.Rows[i]["Column3"] = ddl2.Text;
                    ...
                    //DropDownList ddl22 = (DropDownList)GridView1.Rows[GridView1.Rows.Count-1].Cells[3].FindControl("xlbslf");
                    //zglobal.fnGetComboDataCD("Book Shelf", ddl22);
            ...
            if (ViewState["CurrentTable"] != null)
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    for (int i = 0; i < dt.Rows.Count; i++)
                    {
                        ...
                        //TextBox box7 = (TextBox)GridView1.Rows[i].Cells[7].FindControl("xlbstatus");
                        //TextBox box8 = (TextBox)GridView1.Rows[i].Cells[8].FindControl("xnote");
                        //TextBox box9 = (TextBox)GridView1.Rows[i].Cells[9].FindControl("xlbslf");
            ...
            try
            {
                ...
                if (ViewState["CurrentTable"] != null)
                {
                    ...
                    for (int i = 0; i < dt.Rows.Count; i++)
                    {
                        ...
                        //TextBox box7 = (TextBox)GridView1.Rows[i].Cells[7].FindControl("xlbstatus");
                        //TextBox box8 = (TextBox)GridView1.Rows[i].Cells[8].FindControl("xnote");
                        //TextBox box9 = (TextBox)GridView1.Rows[i].Cells[9].FindControl("xnote");
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //if (xlbmemcode.Text == "" || xlbmemcode.Text == string.Empty || xlbmemcode.Text == "[Select]")
                //{
                //    rtnMessage = rtnMessage + "<li>Member Code</li>";
                //    isValid = false;
                //}
                ...
                //string ismemfound = zglobal.fnGetValue("xlbmemcode", "lbmemlistvw",
                //      "zid=" + Convert.ToInt32(Convert.ToString(HttpContext.Current.Session["business"])) +
                //      "  and xlbmemcode='" + xlbmemcode.Text.ToString().Trim() + "' and xtype='"+ hxlbmemtype.Value.Trim().ToString() +"'");

                //if (ismemfound == "")
                //{
                //    message.InnerHtml = "Wrong Member Selected.";
                //    message.Style.Value = zglobal.warningmsg;
                //    globalerr = 1;
                //    return;
                //}
                ...
                foreach (GridViewRow row in GridView1.Rows)
                {
                    TextBox txtTextBox1 = row.FindControl("xlbord") as TextBox;
                ...
                foreach (GridViewRow row in GridView1.Rows)
                {
                    ...
                    if (txtTextBox1.Text != String.Empty)
                    {
                        if (zglobal.fnGetValue("xlbord", "lbbook",
                      "zid=" + Convert.ToInt32(Convert.ToString(HttpContext.Current.Session["business"])) + "  and xlbord='" + txtTextBox1.Text.ToString().Trim() + "'") == "")
                        {
                            //txtTextBox1.Text = "";
                            row.BackColor = zglobal.rowerr;
                            flag = 1;
                ...
                //        if (txtTextBox1.Text != String.Empty)
                //        {
                //            if (zglobal.fnGetValue("coalesce(xlbstatus,'')", "lbbook",
                //                "zid=" + Convert.ToInt32(Convert.ToString(HttpContext.Current.Session["business"])) +
                //                "  and xlbord='" + txtTextBox1.Text.ToString().Trim() + "'") != "")
                //            {
                //                //txtTextBox1.Text = "";
                //                row.BackColor = zglobal.rowerr;
                //                flag = 1;
                ...
                //    if (flag == 1)
                //    {
                //        message.InnerText = "Book is not Available.";
                //        message.Style.Value = zglobal.warningmsg;
                //        globalerr = 1;
                //        return;
                //    }
                ...
                foreach (GridViewRow row in GridView1.Rows)
                {
                    ...
                    if (txtTextBox1.Text != String.Empty)
                    {
                        stat = zglobal.fnGetValue("coalesce(xdesc01,'')", "lbbook",
                            "zid=" + Convert.ToInt32(Convert.ToString(HttpContext.Current.Session["business"])) +
                            "  and xlbord='" + txtTextBox1.Text.ToString().Trim() + "'");
                        ...
                        if ( stat != "")
                        {
                            ...
                            row.BackColor = zglobal.rowerr;
                            flag = 1;
                            message.InnerText = message.InnerText + "You are Entering Book which is Set as  " + stat + "</br>";
                            message.Style.Value = zglobal.warningmsg;
                        }
                        else
                        {
                ...
                if (flag == 1)
                {
                    //message.InnerText = "You are Entering Book which is Set as  " + stat;
                    //message.Style.Value = zglobal.warningmsg;
                    globalerr = 1;
                    return;
                }
                ...
                //{
                //    TextBox txtTextBox1 = row.FindControl("xlbord") as TextBox;
                //    TextBox txtTextBox2 = row.FindControl("xdate") as TextBox;
                //    TextBox txtTextBox3 = row.FindControl("xlbrfdate") as TextBox;
                //    if (txtTextBox1.Text != String.Empty)
                //    {

                //        if (txtTextBox2.Text == "" || txtTextBox3.Text == "")
                //        {
                //            //txtTextBox1.Text = "";
                //            row.BackColor = zglobal.rowerr;
                //            flag = 1;
                ...
                //if (flag == 1)
                //{
                //    message.InnerText = "Must be Enter Date and Refund Date.";
                //    message.Style.Value = zglobal.warningmsg;
                //    globalerr = 1;
                //    return;
                //}
                ...
                //        {
                //            if (
                //                DateTime.ParseExact(txtTextBox3.Text.Trim().ToString(), "dd/MM/yyyy",
                //                    CultureInfo.InvariantCulture) <
                //                DateTime.ParseExact(txtTextBox2.Text.Trim().ToString(), "dd/MM/yyyy",
                //                    CultureInfo.InvariantCulture))
                //            {
                //                //txtTextBox1.Text = "";
                //                row.BackColor = zglobal.rowerr;
                ...
                //if (flag == 1)
                //{
                //    message.InnerText = "Refund Date Must Be Greater Than Issue Date.";
                //    message.Style.Value = zglobal.warningmsg;
                //    globalerr = 1;
                //    return;
                //}
                ...
                //            "zid=" + Convert.ToInt32(Convert.ToString(HttpContext.Current.Session["business"])) +
                //            "  and xlbord='" + txtTextBox1.Text.ToString().Trim() + "' and xwh='" + xfwh.Text.Trim().ToString() + "' and xdate<='" + date + "'");

                //        xstk = zglobal.fnGetValue("sum(xqty*xsign)", "imtrn",
                //           "zid=" + Convert.ToInt32(Convert.ToString(HttpContext.Current.Session["business"])) +
                //           "  and xlbord='" + txtTextBox1.Text.ToString().Trim() + "' and xwh='" + xfwh.Text.Trim().ToString() + "'");
                ...
                //        {
                //            ViewState["xlbtrncode"] = tempTable.Rows[0]["xlbtrncode"].ToString();
                //        }
                //        else
                //        {
                //            ViewState["xlbtrncode"] = null;
                ...
                using (TransactionScope tran = new TransactionScope())
                {
                    ...
                    //        string query =
                    //          "INSERT INTO lbtrn (ztime,zid,xtrnlb,xlbtrncode,xlbtrntype,xlbmemcode,xlbmemtype,xrem,zemail) " +
                    //                "VALUES(@ztime,@zid,@xtrnlb,@xlbtrncode,@xlbtrntype,@xlbmemcode,@xlbmemtype,@xrem,@zemail)";

                    //        xlbtrncode_1 = zglobal.GetMaximumIDWithTRN(ViewState["xtrnlb"].ToString(), "xlbtrncode", "lbtrn");
                    //        ViewState["xlbtrncode"] = xlbtrncode_1;
                    //        hiddenxrow.Value = xlbtrncode_1;
                    //        xtrnlb1 = ViewState["xtrnlb"].ToString();
                    ...
                    //        //xstatustrn1 = "Open";
                    //        xlbmemcode1 = xlbmemcode.Text.Trim().ToString();
                    //        //xsign1 = -1;
                    //        xrem1 = xremarks.Text.Trim().ToString();
                    ...
                    //        cmd.Parameters.AddWithValue("@xlbtrncode", xlbtrncode_1);
                    //        cmd.Parameters.AddWithValue("@xtrnlb", xtrnlb1);
                    //        cmd.Parameters.AddWithValue("@xlbtrntype", xlbtrntype1);
                    ...
                    using (SqlConnection conn = new SqlConnection(zglobal.constring))
                    {
                        ...
                        string query = "";
                        //query = "DELETE FROM lbtrndt WHERE zid=@zid AND xlbtrncode=@xlbtrncode AND coalesce(xlbstatus,'')=''";
                        //cmd.Parameters.Clear();

                        //cmd.CommandText = query;
                        //cmd.Parameters.AddWithValue("@zid", _zid);
                        //cmd.Parameters.AddWithValue("@xlbtrncode", ViewState["xlbtrncode"].ToString());
                        ...
                        //    query = "UPDATE lbtrn SET zutime=@zutime,xemail=@xemail, " +
                        //           "xlbmemcode=@xlbmemcode, xlbmemtype=@xlbmemtype, xrem=@xrem " +
                        //           "WHERE zid=@zid AND xlbtrncode=@xlbtrncode ";

                        //    cmd.Parameters.Clear();

                        //    cmd.CommandText = query;
                        //    cmd.Parameters.AddWithValue("@zid", _zid);
                        //    cmd.Parameters.AddWithValue("@xlbtrncode", Convert.ToString(ViewState["xlbtrncode"]));
                        ...
                        foreach (GridViewRow row in GridView1.Rows)
                        {
                            TextBox xlbord1234 = row.FindControl("xlbord") as TextBox;
                            DropDownList xlbslf1234 = row.FindControl("xlbslf") as DropDownList;

                            if (xlbord1234.Text != string.Empty)
                            {
                                //int xline = zglobal.GetMaximumIdInt("xrow", "lbtrndt",
                                //    " zid=" + _zid + " and xlbtrncode='" + Convert.ToString(ViewState["xlbtrncode"] + "'"), "line");
                                //TextBox xlbord12 = row.FindControl("xlbord") as TextBox;
                                //TextBox xdate12 = row.FindControl("xdate") as TextBox;
                                //TextBox xlbrfdate12 = row.FindControl("xlbrfdate") as TextBox;
                                ////TextBox xlbrcvdate12 = row.FindControl("xlbrcvdate") as TextBox;
                                ////TextBox xlbtrnrcv12 = row.FindControl("xlbtrnrcv") as TextBox;
                                ////TextBox xlbstatus12 = row.FindControl("xlbstatus") as TextBox;
                                //TextBox xnote12 = row.FindControl("xnote") as TextBox;
                               ...
                               // query =
                               //     "INSERT INTO lbtrndt (zid,xlbtrncode,xrow,xlbord,xdate,xlbrfdate,xnote,xlbmemcode,xlbmemtype) " +
                               //     "VALUES(@zid,@xlbtrncode,@xrow,@xlbord,@xdate,@xlbrfdate,@xnote,@xlbmemcode,@xlbmemtype) ";
                               ...
                               // cmd.Parameters.AddWithValue("@zid", _zid);
                               // cmd.Parameters.AddWithValue("@xlbtrncode", Convert.ToString(ViewState["xlbtrncode"]));
                               // cmd.Parameters.AddWithValue("@xrow", xline);
                               // cmd.Parameters.AddWithValue("@xlbord", xlbord12.Text.Trim().ToString());
                               // cmd.Parameters.AddWithValue("@xlbmemcode", xlbmemcode1);
                               // cmd.Parameters.AddWithValue("@xlbmemtype", xlbmemtype1);
                               // cmd.Parameters.AddWithValue("@xnote", xnote12.Text.Trim().ToString());
                               // cmd.Parameters.AddWithValue("@xdate", xdate12.Text.Trim().ToString() != string.Empty
                               // ? DateTime.ParseExact(xdate12.Text.ToString().Trim(), "dd/MM/yyyy",
                               //     CultureInfo.InvariantCulture)
                               // : DateTime.Now);
                               // cmd.Parameters.AddWithValue("@xlbrfdate", xlbrfdate12.Text.Trim().ToString() != string.Empty
                               //? DateTime.ParseExact(xlbrfdate12.Text.ToString().Trim(), "dd/MM/yyyy",
                               //    CultureInfo.InvariantCulture)
                               ...
                               // cmd.ExecuteNonQuery();
                                ...
                                query = "UPDATE lbbook SET xlbslf=@xlbslf,xstavil=@xstavil,xemail2=@xemail2,xdatestadd=@xdatestadd " +
                                ...
                                cmd.Parameters.AddWithValue("@zid", _zid);
                                //cmd.Parameters.AddWithValue("@xlbtrncode", Convert.ToString(ViewState["xlbtrncode"]));
                                cmd.Parameters.AddWithValue("@xlbord", xlbord1234.Text.Trim().ToString());
                                cmd.Parameters.AddWithValue("@xlbslf", xlbslf1234.Text.Trim().ToString());
                                cmd.Parameters.AddWithValue("@xstavil", "Available");
                                cmd.Parameters.AddWithValue("@xemail2", Convert.ToString(HttpContext.Current.Session["curuser"]));
                                cmd.Parameters.AddWithValue("@xdatestadd", DateTime.Now);
                                cmd.ExecuteNonQuery();
                ...
                //ViewState["xlbtrncode"] = xrow;
                //ViewState["xstatus"] = "New";
                //hiddenxstatus.Value = "New";

                //BindGrid();

                //xlbtrncode.Text = ViewState["xlbtrncode"].ToString();
                //fnButtonState();
                fnFillGrid2();
        ...
        private void fnFillGrid2()
        {
            ...
            using (SqlConnection con = new SqlConnection(zglobal.constring))
            {
                using (DataSet dts1 = new DataSet())
                {
                    con.Open();
                    string query =
                         "SELECT Top " + Int32.Parse(_gridrow.Text.Trim().ToString()) + " xlbord,xlbtitle,xdesc02,coalesce(xdatestadd,'2999-12-31') as xdate,coalesce(xlbstatus,'') as xlbstatus,xlbslf " +
                         "FROM lbbook WHERE zid=@zid and xemail2=@xemail2 and (xlbtitle like N'%" + _searchbox.Text.Trim().ToString() + "%' or xlbord like '%" + _searchbox.Text.Trim().ToString() + "%') and coalesce(xstavil,'')='Available' " +
                         "order by xdatestadd desc";

                    SqlDataAdapter da1 = new SqlDataAdapter(query, con);

                    da1.SelectCommand.Parameters.AddWithValue("@zid", _zid);
                    da1.SelectCommand.Parameters.AddWithValue("@xemail2", HttpContext.Current.Session["curuser"].ToString());
        ...
        protected void FillControl2(object sender, EventArgs e)
        {
            try
            {
                ...
                if (xlbtrncode.Text.Trim().ToString() != String.Empty)
                {
                    fnFillControl(xlbtrncode.Text.Trim().ToString());
                    fnFillGrid2();
                }
                else
                {
        ...
        private void fnFillControl(string xrow123)
        {
            ...
            int _zid = Convert.ToInt32(Convert.ToString(HttpContext.Current.Session["business"]));
            string xlbtrncode123 = xrow123;


            string str = "SELECT  xtrnlb,xlbtrncode,xlbmemcode,xlbmemtype,xrem,zemail,xemail " +
                         "FROM lbtrn where zid=@zid  and xlbtrncode=@xlbtrncode ";
            ...
            SqlDataAdapter da = new SqlDataAdapter(str, conn1);
            da.SelectCommand.Parameters.AddWithValue("@zid", _zid);
            da.SelectCommand.Parameters.AddWithValue("@xlbtrncode", xlbtrncode123);
            da.Fill(dts, "tempztcode");
            ...
            ViewState["xlbtrncode"] = xlbtrncode123;
            hiddenxrow.Value = ViewState["xlbtrncode"].ToString();

            xtrnlb.Text = dttemp.Rows[0]["xtrnlb"].ToString();
            ...
            xremarks.Text = dttemp.Rows[0]["xrem"].ToString();
            ...
            zemail.InnerHtml = zglobal.fnGetValue("coalesce(zemail,'') as zemail", "lbtrn",
                           "zid=" + _zid + " AND xlbtrncode='" + Convert.ToString(ViewState["xlbtrncode"]) + "'");

            xemail.InnerHtml = zglobal.fnGetValue("coalesce(xemail,'') as xemail", "lbtrn",
                           "zid=" + _zid + " AND xlbtrncode='" + Convert.ToString(ViewState["xlbtrncode"]) + "'");
            ...
            using (SqlConnection con = new SqlConnection(zglobal.constring))
            {
                using (DataSet dts1 = new DataSet())
                {
                    con.Open();
                    string query =
                         "SELECT xlbord,(select xlbtitle from lbbook where zid=lbtrndt.zid and xlbord=lbtrndt.xlbord) as xlbtitle,xdate,xlbrfdate,xlbrcvdate,xlbtrnrcv,xlbstatus,xnote," +
                         "(select xdesc01 from lbbook where zid=lbtrndt.zid and xlbord=lbtrndt.xlbord) as xdesc01 " +
                         "FROM lbtrndt WHERE zid=@zid AND xlbtrncode=@xlbtrncode  " +
                         "order by xlbord";

                    SqlDataAdapter da1 = new SqlDataAdapter(query, con);

                    da1.SelectCommand.Parameters.AddWithValue("@zid", _zid);
                    da1.SelectCommand.Parameters.AddWithValue("@xlbtrncode", xlbtrncode123);
                    ...
                    if (tempTable.Rows.Count > 0)
                    {
                        ...
                        foreach (DataRow row in tempTable.Rows)
                        {
                            dr = dt.NewRow();
                            //dr["RowNumber"] = 1;
                            //dr["Column1"] = tempTable.Rows[i]["xlbord"].ToString();
                            dr["Column2"] = tempTable.Rows[i]["xlbord"].ToString();
                            dr["Column3"] = tempTable.Rows[i]["xlbtitle"].ToString();
                            dr["Column4"] = DBNull.Value.Equals(tempTable.Rows[i]["xdate"]) ? "" : Convert.ToDateTime(tempTable.Rows[i]["xdate"]).ToString("dd/MM/yyyy");
                            dr["Column5"] = DBNull.Value.Equals(tempTable.Rows[i]["xlbrfdate"]) ? "" : Convert.ToDateTime(tempTable.Rows[i]["xlbrfdate"]).ToString("dd/MM/yyyy");
                            dr["Column6"] = DBNull.Value.Equals(tempTable.Rows[i]["xlbrcvdate"]) ? "" : Convert.ToDateTime(tempTable.Rows[i]["xlbrcvdate"]).ToString("dd/MM/yyyy");
                            dr["Column7"] = DBNull.Value.Equals(tempTable.Rows[i]["xlbtrnrcv"]) ? "" : tempTable.Rows[i]["xlbtrnrcv"].ToString();
                            dr["Column8"] = DBNull.Value.Equals(tempTable.Rows[i]["xlbstatus"]) ? "" : tempTable.Rows[i]["xlbstatus"].ToString();
                            dr["Column9"] = tempTable.Rows[i]["xnote"].ToString();
                            dt.Rows.Add(dr);
                        ...
                        foreach (GridViewRow row in GridView1.Rows)
                        {
                            ...
                            TextBox box1 = row.FindControl("xlbord") as TextBox;
                            TextBox box2 = row.FindControl("xlbtitle") as TextBox;
                            TextBox box3 = (TextBox)row.FindControl("xdate");
                            TextBox box4 = (TextBox)row.FindControl("xlbrfdate");
                            TextBox box5 = (TextBox)row.FindControl("xlbrcvdate");
                            TextBox box6 = (TextBox)row.FindControl("xlbtrnrcv");
                            TextBox box7 = (TextBox)row.FindControl("xlbstatus");
                            TextBox box8 = (TextBox)row.FindControl("xnote");
                            LinkButton btnRemove = row.FindControl("btnRemove") as LinkButton;

                            if (i < tempTable.Rows.Count)
                            {
                                box1.Text = tempTable.Rows[i]["xlbord"].ToString();
                                box2.Text = tempTable.Rows[i]["xlbtitle"].ToString();
                                box3.Text = DBNull.Value.Equals(tempTable.Rows[i]["xdate"]) ? "" : Convert.ToDateTime(tempTable.Rows[i]["xdate"]).ToString("dd/MM/yyyy");
                                box4.Text = DBNull.Value.Equals(tempTable.Rows[i]["xlbrfdate"]) ? "" : Convert.ToDateTime(tempTable.Rows[i]["xlbrfdate"]).ToString("dd/MM/yyyy");
                                box5.Text = DBNull.Value.Equals(tempTable.Rows[i]["xlbrcvdate"]) ? "" : Convert.ToDateTime(tempTable.Rows[i]["xlbrcvdate"]).ToString("dd/MM/yyyy");
                                box6.Text = DBNull.Value.Equals(tempTable.Rows[i]["xlbtrnrcv"]) ? "" : tempTable.Rows[i]["xlbtrnrcv"].ToString();
                                box7.Text = DBNull.Value.Equals(tempTable.Rows[i]["xlbstatus"]) ? "" : tempTable.Rows[i]["xlbstatus"].ToString();
                                box8.Text = tempTable.Rows[i]["xnote"].ToString();

                                if ((DBNull.Value.Equals(tempTable.Rows[i]["xlbstatus"]) ? "" : tempTable.Rows[i]["xlbstatus"].ToString()) == "Refunded")
                                {
                                    box1.Enabled = false;
                                    box2.Enabled = false;
                                    box3.Enabled = false;
                                ...
                                if ((DBNull.Value.Equals(tempTable.Rows[i]["xdesc01"]) ? "" : tempTable.Rows[i]["xdesc01"].ToString()) != "")
                                {
                                    box1.Enabled = false;
                                    box2.Enabled = false;
                                    box3.Enabled = false;
            ...
            string count_all_row = zglobal.fnGetValue("count(xlbtrncode) as countallrow", "lbtrndt",
                           "zid=" + _zid + " AND xlbtrncode='" + Convert.ToString(ViewState["xlbtrncode"]) + "'");

            string count_all_row_refunded = zglobal.fnGetValue("count(xlbtrncode) as countallrow", "lbtrndt",
                           "zid=" + _zid + " AND xlbtrncode='" + Convert.ToString(ViewState["xlbtrncode"]) + "' and coalesce(xlbstatus,'')='Refunded'");

            //message.InnerHtml = count_all_row + " R:" + count_all_row_refunded;
            Button btnaddrow = GridView1.FooterRow.Cells[0].FindControl("btnAddRow") as Button;

            if (count_all_row != "" && count_all_row == count_all_row_refunded)
            {
                xlbtrncode.Enabled = false;
                xtrnlb.Enabled = false;
                xlbmemcode.Enabled = false;
            ...
            {
                xlbtrncode.Enabled = true;
                xtrnlb.Enabled = true;
                xlbmemcode.Enabled = true;
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            //                    string query = "";
            //                    //string xstatus1 = zglobal.fnGetValue("xstatus", "amexamh", "zid=" + _zid + " AND xrow=" + Convert.ToInt32(ViewState["xlbtrncode"]));
            ...
            //                    //        cmd.CommandText = query;
            //                    //        cmd.Parameters.AddWithValue("@zid", _zid);
            //                    //        cmd.Parameters.AddWithValue("@xrow", Convert.ToInt32(ViewState["xlbtrncode"]));
                    ...
                    if (txtconformmessageValue1.Value == "Yes")
                    {
                        ...
                        using (TransactionScope tran = new TransactionScope())
                        {
                            using (SqlConnection conn = new SqlConnection(zglobal.constring))
                            {
                                ...
                                string query = "DELETE FROM lbtrndt WHERE zid=@zid AND xlbtrncode=@xlbtrncode AND coalesce(xlbstatus,'')=''";
                                cmd.Parameters.Clear();
                                ...
                                query = "DELETE FROM lbtrn WHERE zid=@zid AND xlbtrncode=@xlbtrncode";
                                cmd.CommandText = query;
                                cmd.ExecuteNonQuery();
                            }
        ...
        protected void btnConfirm_Click(object sender, EventArgs e)
        {
            ...
            //        "zid=" + _zid + " and xlbtrncode='" + ViewState["xlbtrncode"].ToString() + "'");
            ...
            //                            string xcostmeth1 = zglobal.fnGetValue("xcostmeth", "lbbook",
            //                                "zid=" + _zid + " and xlbord='" + xlbord12.Text.Trim().ToString() + "'");
            ...
            //                                "zid=" + _zid + " and xwh='" + xwh1 + "' and xlbord='" + xlbord12.Text.Trim().ToString() + "'");
            ...
            //                       "WHERE zid=@zid AND xlbtrncode=@xlbtrncode AND xlbord=@xlbord";
        ...
        protected void btnUndo_Click(object sender, EventArgs e)
        {
            ...
            //            //BindGrid();
            //            fnFillGrid2();
            //            fnFillControl(Convert.ToString(ViewState["xlbtrncode"]));
            //        }
            //    }
            //    else
            //    {
        ...
        protected void xtfccode_OnTextChanged(object sender, EventArgs e)
        {
            ...
            //    string istfccodefound = zglobal.fnGetValue("xlbmemcode", "lbmemlistvw",
            //          "zid=" + Convert.ToInt32(Convert.ToString(HttpContext.Current.Session["business"])) + " and xlbmemcode='" + xlbmemcode.Text.ToString().Trim() + "' and xtype='"+hxlbmemtype.Value.Trim().ToString()+"'");

            //    if (istfccodefound == "")
            //    {
            //        message.InnerHtml = "Wrong Member Code Selected.";
            //        message.Style.Value = zglobal.warningmsg;
        ...
        protected void xglevel2_OnTextChanged(object sender, EventArgs e)
        {
            ...
            //            con.Open();
            //            string query =
            //                "SELECT xlbordset FROM lbbook WHERE zid=@zid AND xglevel2=@xglevel2 and coalesce(xlbordset,'')<>'' group by xlbordset";
            ...
            //                    setlink.Text = row["xlbordset"].ToString();
        ...
        private void SetlinkOnClick(object sender, EventArgs eventArgs)
        {
            ...
            //            string query =
            //                "SELECT xlbord,xdesc,xunitiss as xunit,xcfiss as xcf, " +
            //                "coalesce((select sum(xqty*xsign) from imtrn where zid=@zid and xwh=@xwh and xlbord=lbbook.xlbord ),0) as xstock " +
            //                "FROM lbbook WHERE zid=@zid AND xglevel2=@xglevel2 and coalesce(xlbordset,'')=@xlbordset";

            //            SqlDataAdapter da = new SqlDataAdapter(query, con);

            //            da.SelectCommand.Parameters.AddWithValue("@zid", _zid);
            //            da.SelectCommand.Parameters.AddWithValue("@xglevel2", xglevel2.Text.ToString().Trim());
            //            da.SelectCommand.Parameters.AddWithValue("@xlbordset", lnk.Text.ToString().Trim());
            ...
            //                    TextBox xlbord1 = row.FindControl("xlbord") as TextBox;
            ...
            //                    if (i < tempTable.Rows.Count)
            //                    {
            //                        xlbord1.Text = tempTable.Rows[i]["xlbord"].ToString();
