...
{
    public partial class lbcond : System.Web.UI.Page
    {
        private void fnButtonState()
        {
            if (ViewState["xlbtrncnd"] == null)
            {
            ...
            {
                xlbtrncnd.Text = ViewState["xlbtrncnd"].ToString();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!IsPostBack)
                {
                    ...
                    ViewState["xlbtrncnd"] = null;

                    ViewState["xtrncnd"] = "STAT";
                    xtrncnd.Text = ViewState["xtrncnd"].ToString();
                    ...
                    xdesc01.Items.Add("");
                    xdesc01.Items.Add("Damaged");
                    xdesc01.Items.Add("Lost");
                    xdesc01.Items.Add("Prize");
                    //xdesc01.Items.Add("Not Returned");
                    //xdesc01.Items.Add("Sold");
                    xdesc01.Items.Add("Donated");
                    xdesc01.Items.Add("Gift");
                    xdesc01.Text = "";
         ...
         xlbord.Text.ToString().Trim() + "' ");
                ...
                xlbmemcode.Text = zglobal.fnGetValue("xlbmemcode", "lbcond",
         "zid=" + Convert.ToInt32(Convert.ToString(HttpContext.Current.Session["business"])) + " and xlbtrncnd='" +
         xlbtrncnd.Text.ToString().Trim() + "' ") == "" ? zglobal.fnGetValue("xlbmemcode", "lbbook",
         "zid=" + Convert.ToInt32(Convert.ToString(HttpContext.Current.Session["business"])) + " and xlbord='" +
         xlbord.Text.ToString().Trim() + "' ") :
        zglobal.fnGetValue("xlbmemcode", "lbcond",
         "zid=" + Convert.ToInt32(Convert.ToString(HttpContext.Current.Session["business"])) + " and xlbtrncnd='" +
         xlbtrncnd.Text.ToString().Trim() + "' ");

                hxlbmemtype.Value = zglobal.fnGetValue("xlbmemtype", "lbcond",
        "zid=" + Convert.ToInt32(Convert.ToString(HttpContext.Current.Session["business"])) + " and xlbtrncnd='" +
        xlbtrncnd.Text.ToString().Trim() + "' ") == "" ? zglobal.fnGetValue("xlbmemtype", "lbbook",
        "zid=" + Convert.ToInt32(Convert.ToString(HttpContext.Current.Session["business"])) + " and xlbord='" +
        xlbord.Text.ToString().Trim() + "' ") :
        zglobal.fnGetValue("xlbmemtype", "lbcond",
        "zid=" + Convert.ToInt32(Convert.ToString(HttpContext.Current.Session["business"])) + " and xlbtrncnd='" +
        xlbtrncnd.Text.ToString().Trim() + "' ");
         ...
         xlbmemcode.Text.ToString().Trim() + "' and xtype='" + hxlbmemtype.Value.Trim().ToString() + "'");
                ...
                xlbtrncode.Text = zglobal.fnGetValue("xlbtrncode", "lbcond",
         "zid=" + Convert.ToInt32(Convert.ToString(HttpContext.Current.Session["business"])) + " and xlbtrncnd='" +
         xlbtrncnd.Text.ToString().Trim() + "' ") == "" ? zglobal.fnGetValue("xlbtrncode", "lbbook",
         "zid=" + Convert.ToInt32(Convert.ToString(HttpContext.Current.Session["business"])) + " and xlbord='" +
         xlbord.Text.ToString().Trim() + "' ")
         : zglobal.fnGetValue("xlbtrncode", "lbcond",
         "zid=" + Convert.ToInt32(Convert.ToString(HttpContext.Current.Session["business"])) + " and xlbtrncnd='" +
         xlbtrncnd.Text.ToString().Trim() + "' ");
                ...
                //        ? zglobal.fnGetValue("xlbrfdate", "lbcond",
                //            "zid=" + Convert.ToInt32(Convert.ToString(HttpContext.Current.Session["business"])) +
                //            " and xlbtrncnd='" +
                //            xlbtrncnd.Text.ToString().Trim() + "' ") == "" ? Convert.ToDateTime(zglobal.fnGetValue("xlbrfdate", "lbbook",
                //            "zid=" + Convert.ToInt32(Convert.ToString(HttpContext.Current.Session["business"])) +
                //            " and xlbord='" +
                //            xlbord.Text.ToString().Trim() + "' ")).ToString("dd/MM/yyyy") : Convert.ToDateTime(zglobal.fnGetValue("xlbrfdate", "lbcond",
                //            "zid=" + Convert.ToInt32(Convert.ToString(HttpContext.Current.Session["business"])) +
                //            " and xlbtrncnd='" +
                //            xlbtrncnd.Text.ToString().Trim() + "' ")).ToString("dd/MM/yyyy")
        ...
        public void fnRegisterPostBack()
        {
            ...
            {
                LinkButton lnkFull1 = row.FindControl("xlbtrncnd") as LinkButton;
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (xdesc01.Text == "" || xdesc01.Text == string.Empty || xdesc01.Text == "[Select]")
                {
                    rtnMessage = rtnMessage + "<li> Physical Status</li>";
                    isValid = false;
                }
                ...
                //          "zid=" + _zid + " AND xsup=" + ViewState["xlbtrncnd"].ToString());
                //    if (xstatus2 != "1-Open")
                //    {
                ...
                string xstatus2 = zglobal.fnGetValue("coalesce(xdesc01,'')", "lbbook",
                      "zid=" + _zid + " AND xlbord='" + xlbord.Text.ToString().Trim() + "'");
                if (xstatus2 != "")
                {
                    message.InnerHtml = "You are Entering Book which is Already Set as  " + xstatus2;
                    message.Style.Value = zglobal.warningmsg;
                    return;
                }
                ...
                DateTime xdateexp1 = DateTime.Now;
                string xlbmemcode1 = "";
                string xlbmemtype1 = "";
                string xrem1 = "";
                string xnote1 = "";
                ...
                using (TransactionScope tran = new TransactionScope())
                {
                    ...
                    if (ViewState["xlbtrncnd"] == null)
                    {
                        ...
                        using (SqlConnection conn = new SqlConnection(zglobal.constring))
                        {
                            ...
                            string query =
                               "INSERT INTO lbcond (ztime,zid,xtrncnd,xlbtrncnd,xlbord,xlbtrncode,xdate,xlbmemcode,xlbmemtype,xnote,xdateexp,xdesc01,zemail,xdesc03) " +
                               "VALUES(@ztime,@zid,@xtrncnd,@xlbtrncnd,@xlbord,@xlbtrncode,@xdate,@xlbmemcode,@xlbmemtype,@xnote,@xdateexp,@xdesc01,@zemail," +
                               "(select coalesce(xlbstatus,'') as xlbstatus from lbbook where zid=@zid and xlbord=@xlbord)) ";


                            //xrow = zglobal.GetMaximumIDWithTRN("xcdate", "xrow", "amtfch", xcdate1);
                            //ViewState["xrow"] = xrow;
                            //hiddenxrow.Value = xrow.ToString();
                            xtrncnd1 = xtrncnd.Text.Trim().ToString();
                            xlbtrncnd1 = zglobal.GetMaximumIDWithTRN(xtrncnd1, "xlbtrncnd", "lbcond");
                            ViewState["xlbtrncnd"] = xlbtrncnd1;
                            xlbtrncndrr = xlbtrncnd1;
                            ...
                            xdate1 = xdate.Text.Trim().ToString() != string.Empty
                            ...
                            xdesc011 = xdesc01.Text.ToString().Trim();
                            //xlast1 = xlast.Text.ToString().Trim();
                            //xdesig1 = xdesig.Text.ToString().Trim();
                            xlbmemtype1 = hxlbmemtype.Value.Trim().ToString();
                            xnote1 = xnote.Value.Trim().ToString();
                            xdateexp1 = xdateexp.Text.Trim().ToString() != string.Empty
                                ? DateTime.ParseExact(xdateexp.Text.ToString().Trim(), "dd/MM/yyyy",
                                    CultureInfo.InvariantCulture)
                                : DateTime.Now;
                            ...
                            cmd.Parameters.AddWithValue("@xtrncnd", xtrncnd1);
                            cmd.Parameters.AddWithValue("@xlbtrncnd", xlbtrncnd1);
                            ...
                            cmd.Parameters.AddWithValue("@xdateexp", xdateexp1);
                            ...
                            query = "UPDATE lbbook SET xdesc01=@xdesc01,xdateph=@xdateph, xlbstatus='Unavailable' " +
                            ...
                            cmd.Parameters.AddWithValue("@xdesc01", xdesc011);
                            cmd.Parameters.AddWithValue("@xdateph", xdateexp1);
                            cmd.ExecuteNonQuery();
                    ...
                    //               "WHERE zid=@zid AND xlbtrncnd=@xlbtrncnd ";

                    //        cmd.Parameters.Clear();

                    //        cmd.CommandText = query;
                    //        cmd.Parameters.AddWithValue("@zid", _zid);
                    //        cmd.Parameters.AddWithValue("@xlbtrncnd", ViewState["xlbtrncnd"].ToString());
        ...
        private void fnFillGrid2()
        {
            ...
            using (SqlConnection con = new SqlConnection(zglobal.constring))
            {
                using (DataSet dts1 = new DataSet())
                {
                    con.Open();
                    string query =
                         "SELECT Top " + Int32.Parse(_gridrow.Text.Trim().ToString()) + " xlbtrncnd,xlbord,xdate," +
                         "(select xlbtitle from lbbook where zid=lbcond.zid and xlbord=lbcond.xlbord) as xlbtitle " +
                         "FROM lbcond WHERE zid=@zid  " +
                         "order by xlbtrncnd asc";
        ...
        protected void FillControl2(object sender, EventArgs e)
        {
            try
            {
                ...
                if (xlbtrncnd.Text.Trim().ToString() != String.Empty)
                {
                    fnFillControl(xlbtrncnd.Text.Trim().ToString());
                }
                else
                {
        ...
        private void fnFillControl(string xlbtrncnd1)
        {
            message.InnerHtml = "";
            ...
            string str = "SELECT  *,(select xlbtitle from lbbook where zid=lbcond.zid and xlbord=lbcond.xlbord) as xlbtitle, " +
                         "(select xname from lbmemlistvw where zid=lbcond.zid and xlbmemcode=lbcond.xlbmemcode and xtype=lbcond.xlbmemtype) as mem_name " +
                         "FROM lbcond where zid=@zid  and xlbtrncnd=@xlbtrncnd ";
            ...
            SqlDataAdapter da = new SqlDataAdapter(str, conn1);
            da.SelectCommand.Parameters.AddWithValue("@zid", _zid);
            da.SelectCommand.Parameters.AddWithValue("@xlbtrncnd", xlbtrncnd1);
            da.Fill(dts, "tempztcode");
            ...
            ViewState["xlbtrncnd"] = xlbtrncnd1.ToString();
            //hiddenxrow.Value = ViewState["xrow"].ToString();

            xlbtrncnd.Text = dttemp.Rows[0]["xlbtrncnd"].ToString();
            xtrncnd.Text = dttemp.Rows[0]["xtrncnd"].ToString();
            xlbord.Text = dttemp.Rows[0]["xlbord"].ToString();
            xlbtitle.Text = dttemp.Rows[0]["xlbtitle"].ToString();
            xdate.Text = Convert.ToDateTime(dttemp.Rows[0]["xdate"].ToString()).ToString("dd/MM/yyyy");
            ...
            xdateexp.Text = Convert.ToDateTime(dttemp.Rows[0]["xdateexp"].ToString()).ToString("dd/MM/yyyy");
            xnote.Value = dttemp.Rows[0]["xnote"].ToString();
                    ...
                    if (txtconformmessageValue1.Value == "Yes")
                    {
                        ...
                        using (TransactionScope tran = new TransactionScope())
                        {
                            using (SqlConnection conn = new SqlConnection(zglobal.constring))
                            {
                                ...
                                query = "UPDATE lbbook SET xdesc01=@xdesc01,xdateph=@xdateph, xlbstatus=(select xdesc03 from  lbcond where zid=@zid and xlbtrncnd=@xlbtrncnd) " +
                                 "WHERE zid=@zid AND xlbord=@xlbord ";
                                ...
                                cmd.Parameters.AddWithValue("@zid", _zid);
                                cmd.Parameters.AddWithValue("@xlbord", xlbord.Text.ToString().Trim());
                                cmd.Parameters.AddWithValue("@xdesc01", "");
                                cmd.Parameters.AddWithValue("@xdateph", new DateTime(2999, 12, 31));
                                cmd.Parameters.AddWithValue("@xlbtrncnd", ViewState["xlbtrncnd"].ToString());
                                cmd.ExecuteNonQuery();
                                ...
                                //cmd.Parameters.AddWithValue("@xlbtrncnd", "");
                                //cmd.ExecuteNonQuery();

                                query = "DELETE FROM lbcond WHERE zid=@zid AND xlbtrncnd=@xlbtrncnd";
                                cmd.Parameters.Clear();
