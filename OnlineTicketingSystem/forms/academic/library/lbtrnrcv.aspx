<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="lbtrnrcv.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.lbtrnrcv" %>
            ...
            <%--    $("body").on("change", "#<%=xclass.ClientID%>", function() {
               ...
               <%--     if ($("#<%=hxstatus.ClientID%>").val() == "")--%>
                ...
                $("body").on("click", ".bm_bookcd", function () {
                    //alert("Hi");
                    fnOpenBookList3(<%= HttpContext.Current.Session["business"] %>, $(this).parent(".bm_list_img").siblings(".bm_list_text").find(".bm_academic_textbox").attr("ID"), $(this).parent(".bm_list_img").siblings(".bm_list_text").find(".bm_academic_textbox").val(),$("#<%=xlbtitle.ClientID%>").attr("ID"),$("#<%=xlbmemcode.ClientID%>").attr("ID"),$("#<%=mem_name.ClientID%>").attr("ID"),$("#<%=xlbtrncode.ClientID%>").attr("ID"),$("#<%=xlbrfdate.ClientID%>").attr("ID"),$("#<%=hxlbmemtype.ClientID%>").attr("ID"));
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Receive Transaction</span>
                    </div>
                </div>
                            ...
                            <div class="bm_layout_box_100">
                                ...
                                <div class="bm_layout_box_padding" style="padding-top: 0px;">
                                    ...
                                    <div style="width: 100%; clear: both; display: inline-block; padding-top: 5px; vertical-align: top;">
                                        ...
                                        <div class="bm_ctl_container_100_special" style="width: 270px;">
                                            <div class="bm_ctl_label_align_right_100_special" style="width: 120px">
                                                <asp:Label ID="Label9" runat="server" Text="Transactoin Prefix :" AssociatedControlID="xtrnrcv"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_100_special" style="width: 148px">
                                                <asp:TextBox ID="xtrnrcv" runat="server" CssClass="bm_academic_textbox_50_100 bm_academic_ctl_global bm_academic_textbox "
                                                    Enabled="False" Text="RCVD" BackColor="Transparent" ForeColor="Black"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="bm_clt_padding">
                                        </div>
                                        ...
                                        <div style="width: 100%">
                                            <div style="float: left;">
                                                <div class="bm_ctl_container_50_50" style="width: 270px">
                                                    <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                        <asp:Label ID="Label37" runat="server" Text="Transactoin No :" AssociatedControlID="xlbtrnrcv"
                                                            CssClass="label"></asp:Label>
                                                    </div>
                                                    <div class="bm_clt_ctl_50_50" style="width: 148px">

                                                        <asp:TextBox ID="xlbtrnrcv" runat="server" CssClass="bm_academic_textbox_50_40 bm_academic_ctl_global bm_academic_textbox"
                                                            AutoPostBack="True" OnTextChanged="FillControl2"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="bm_clt_padding">
                                          ...
                                          <div class="bm_ctl_container_50_50" style="float: left; width: 270px">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label27" runat="server" Text="Receive Date :" AssociatedControlID="xlbrcvdate"
                                                    CssClass="label "></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 148px">
                                                <asp:TextBox ID="xlbrcvdate" runat="server" CssClass="bm_academic_textbox_50_40 bm_academic_ctl_global bm_academic_datepicker"></asp:TextBox>
                                            </div>
                                        </div>
                                    ...
                                    <div class="bm_academic_grid_container" id="list" runat="server">
                                        <div class="grid_header">
                                            <div class="grid_header_label" id="_grid_header" runat="server">
                                                Book Receive Transaction List(s)
                                            </div>
                                            ...
                                            <asp:GridView ID="dgvcollectionew" runat="server" AutoGenerateColumns="False" ShowFooter="False"
                                               ...
                                               <Columns>
                                                    <asp:TemplateField HeaderText="Transaction No.">
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="xlbtrnrcv" runat="server" Text='<%#Eval("xlbtrnrcv") %>' CssClass="_gridrow_link"
                                                    ...
                                                    <asp:BoundField DataField="xlbrcvdate" HeaderText="Receive Date" DataFormatString="{0:dd/MM/yyyy}"
