<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="lbauthor.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.lbauthor" %>
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Author Info</span>
                    </div>
                </div>
                                ...
                                <div class="bm_layout_box_padding" style="padding-top: 0px;">
                                    ...
                                    <div style="width: 100%; clear: both; display: inline-block; padding-top: 5px; vertical-align: top;">
                                        <div class="bm_ctl_container_50_50" style="width: 200px">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label9" runat="server" Text="Author Prefix :" AssociatedControlID="xtrnaut"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 78px">
                                                <asp:DropDownList ID="xtrnaut" runat="server" CssClass="bm_academic_dropdown_50_50 bm_academic_ctl_global bm_academic_dropdown bm_xclass">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                        <div class="bm_clt_padding">
                                        ...
                                        <div style="width: 100%">
                                            <div style="float: left;">
                                                <div class="bm_ctl_container_50_50" style="width: 270px">
                                                    <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                        <asp:Label ID="Label37" runat="server" Text="Author Number :" AssociatedControlID="xlbauthr"
                                                            CssClass="label"></asp:Label>
                                                    </div>
                                                    <div class="bm_clt_ctl_50_50" style="width: 148px">

                                                        <asp:TextBox ID="xlbauthr" runat="server" CssClass="bm_academic_textbox_50_40 bm_academic_ctl_global bm_academic_textbox"
                                                            AutoPostBack="True" OnTextChanged="FillControl2"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <asp:GridView ID="dgvcollectionew" runat="server" AutoGenerateColumns="False" ShowFooter="False"
                                                ...
                                                <Columns>
                                                    <asp:TemplateField HeaderText="Author Number">
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="xlbauthr" runat="server" Text='<%#Eval("xlbauthr") %>' CssClass="_gridrow_link"
