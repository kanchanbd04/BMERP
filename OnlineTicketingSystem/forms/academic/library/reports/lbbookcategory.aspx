<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="lbbookcategory.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.lbbookcategory" %>
    ...
    <script type="text/javascript">
        ...
        function fnShowReport() {
          ...
          <%--  var dateParts1 = $("#<%= tdate.ClientID%>").val().split("/");
           ...
           var xlbcatgry1 = $("#<%= xlbcatgry.ClientID%>").val();

            var openwin = window.open('/forms/academic/reports/library/lbbookcategoryrpt.aspx?zid=' + zid + '&xlbcatgry=' + xlbcatgry1.replace(/&/gi, "%26") + '&xdesc02=' + xdesc021, 'lbbookcatwise', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, copyhistory=no, width=' + screen.width + ', height=' + screen.height + ', top=0, left=0, targets=_blank');
           openwin.focus();
           //openwin.print();
           return false;
       }
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Catagory Wise Book  list</span>
                    </div>
                </div>
