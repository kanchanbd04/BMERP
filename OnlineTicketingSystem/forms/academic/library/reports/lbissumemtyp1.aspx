<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="lbissumemtyp1.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.lbissumemtyp1" %>
...
.GridViewScrollFooterFreeze TD {
    ...
    <script type="text/javascript">
       ...
       function fnShowReport() {
           ...
           var openwin = window.open('/forms/academic/reports/library/lbissumemtyp1rpt.aspx?zid=' + zid + '&memcode=' + memcode + '&memtype=' + memtype + '&fdate=' + fdate1 + '&tdate=' + tdate1, 'lbissumemtyp1', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, copyhistory=no, width=' + screen.width + ', height=' + screen.height + ', top=0, left=0, targets=_blank');
            openwin.focus();
            //openwin.print();
            return false;
        }
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Member Wise Book Issue (Not Refunded)</span>
                    </div>
                </div>
