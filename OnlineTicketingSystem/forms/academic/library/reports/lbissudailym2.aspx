<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="lbissudailym2.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.lbissudailym2" %>
    ...
    <script type="text/javascript">
       ...
       function fnShowReport() {
          ...
          <%-- var xlbcatgry1 = $("#<%= xlbcatgry.ClientID%>").val();--%>
           ...
           var openwin = window.open('/forms/academic/reports/library/lbissudailym2rpt.aspx?zid=' + zid + '&fdate=' + fdate1 + '&tdate=' + tdate1 + '&xdesc02=' + xdesc021, 'dailyissnotrf', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, copyhistory=no, width=' + screen.width + ', height=' + screen.height + ', top=0, left=0, targets=_blank');
            openwin.focus();
            //openwin.print();
            return false;
        }
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Daily Issue (not Refunded)</span>
                    </div>
                </div>
