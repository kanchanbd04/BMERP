<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="lbbookpubli.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.lbbookpubli" %>
...
.GridViewScrollFooterFreeze TD {
    ...
    <script type="text/javascript">
       ...
       function fnShowReport() {
           ...
           var publisher = $("#<%= xlbpubcode.ClientID%>").val();
           var xdesc021 = $("#<%= xdesc02.ClientID%>").val();

           var openwin = window.open('/forms/academic/reports/library/lbbookpublirpt.aspx?zid=' + zid + '&publisher=' + publisher + '&xdesc02=' + xdesc021 , 'lbbookpubwise', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, copyhistory=no, width=' + screen.width + ', height=' + screen.height + ', top=0, left=0, targets=_blank');
            openwin.focus();
            //openwin.print();
            return false;
        }
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Publisher Wise Book  list</span>
                    </div>
                </div>
                                ...
                                <div class="bm_layout_box_padding" style="padding-top: 10px; min-height: 300px;">
                                    ...
                                    <div style="width: 100%; clear: both;">
                                     ...
                                     <%--   <div>
                                       ...
                                       <%-- <div class="bm_ctl_container_50_50" style="float: left; width: 270px">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label4" runat="server" Text="Category :" AssociatedControlID="xlbcatgry"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 148px">
                                        ...
                                        <div class="bm_ctl_container_50_50" style="width: 270px">
                                            ...
                                            <div class="bm_clt_ctl_50_50" style="width: 148px">
                                                ...
                                                <asp:DropDownList ID="xdesc02" runat="server" CssClass="bm_academic_dropdown_50_50 bm_academic_ctl_global bm_academic_dropdown bm_xclass">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
