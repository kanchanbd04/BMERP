<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="lbbook_temp.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.lbbook_temp" %>
        ...
        <ContentTemplate>
            <script type="text/javascript">
                             ...
                             <%-- { "id": "<%= xsession.ClientID%>", "prop": "combo", "tab": "0" },--%>
                               ...
                               <%-- { "id": "<%= xdate.ClientID%>", "prop": "text", "tab": "0" },--%>
                                  <%--  { "id": "<%= xsup.ClientID%>", "prop": "listtext", "tab": "0" },--%>
                                    <%--{ "id": "<%= xfwh.ClientID%>", "prop": "combo", "tab": "0" }--%>
                    ];
               ...
               <%--$("body").on("blur", "#<%=xtfccode.ClientID%>", function() {
                ...
                $("body").on("blur", "[id*=xlbord]", function() {
                    //alert("hi");
                  ...
                  <%--  var xclass1 = $("#<%=xclass.ClientID%>").val();
                   ...
                   <%-- var xeffdate1 = $("#<%=xcdate.ClientID%>").val();
                    ...
                    //var xstdid1 = '3036';
                    //alert(zid1);
                    <%--var xwh1 = $("#<%=xfwh.ClientID%>").val();--%>

                    $.ajax({
                        type: "POST",
                        url: "/edusoft.asmx/BookInfo",
                        data: "{ zid: '" + zid1 + "', xlbord:'" + xlbord1 + "' }",
                        dataType: "json",
                        contentType: "application/json; charset=utf-8",
                        success: function (data) {
                            //alert(data.d);
                     ...
                     <%--    //$("#<%=xname.ClientID%>").val(student.xname);
                            ...
                            row.cells[2].getElementsByTagName("input")[0].value = stdinfo.xlbtitle;
                            row.cells[7].getElementsByTagName("input")[0].value = stdinfo.xlbstatus;
                ...
                $("body").on("click", ".bm_bookcd", function () {
                    ...
                    fnOpenBookList1(<%= HttpContext.Current.Session["business"] %>,$(this).parent(".bm_list_img").siblings(".bm_list_text").find(".bm_academic_textbox").attr("ID"),$(this).parent(".bm_list_img").siblings(".bm_list_text").find(".bm_academic_textbox").val(),row.cells[2].getElementsByTagName("input")[0].id,$("#<%=hdf.ClientID%>").attr("ID"));
                        $(this).parent(".bm_list_img").siblings(".bm_list_text").find(".bm_academic_textbox").focus();
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Book Stocks' Update (Temporary)</span>
                    </div>
                </div>
                            ...
                            <div class="button_section_style1" style="text-align: left; margin-bottom: 5px;">
                                ...
                                <asp:Button ID="btnSubmit" runat="server" Text="Confirm" CssClass="bm_academic_button3 bm_am_btn_edit"
                                  ...
                                  <asp:Button ID="btnUndo" runat="server" Text="Undo" CssClass="bm_academic_button3 bm_am_btn_undo"
                                    OnClientClick="javascript:ConfirmMessage2();" OnClick="btnUndo_Click" Visible="False" />
                                <%--<asp:Button ID="btnRefresh" runat="server" Text="Confirm" CssClass="bm_academic_button3 bm_am_btn_edit"
                                    Visible="False" />--%>
                                <asp:Button ID="Button1" runat="server" Text="Member Book Info" CssClass="bm_academic_button3 bm_am_btn_click"
                                     OnClick="fnFillGrid6" Width="150" Visible="False" />

                                <%--<input id="btnclick" type="button" value="button" runat="server" style="display: none;" OnServerClick="fnFillGrid6"/>--%>
                            </div>
                        </div>
                    </div>
                    <div class="bm_academic_container_body_input_section">
                        <div class="bm_layout_container">
                            <div class="bm_layout_box_100">
                                ...
                                <div class="bm_layout_box_padding" style="padding-top: 0px; display: none;">
                                    ...
                                    <div style="width: 100%; clear: both;">
                                        ...
                                        <div class="bm_ctl_container_100_special" style="width: 270px;">
                                            <div class="bm_ctl_label_align_right_100_special" style="width: 120px">
                                                <asp:Label ID="Label8" runat="server" Text="Transactoin Prefix :" AssociatedControlID="xtrnlb"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_100_special" style="width: 148px">
                                                <asp:TextBox ID="xtrnlb" runat="server" CssClass="bm_academic_textbox_50_100 bm_academic_ctl_global bm_academic_textbox "
                                                    Enabled="False" Text="ISSU" BackColor="Transparent" ForeColor="Black"></asp:TextBox>
                                            </div>
                                        </div>
                                            ...
                                            <div style="float: left;">
                                                <div class="bm_ctl_container_50_50" style="float: left; width: 270px">
                                                    <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                        <asp:Label ID="Label3" runat="server" Text="Transaction No :" AssociatedControlID="xlbtrncode"
                                                            CssClass="label"></asp:Label>
                                                    </div>
                                                    <div class="bm_clt_ctl_50_50" style="width: 148px">
                                                        <asp:TextBox ID="xlbtrncode" runat="server" CssClass="bm_academic_textbox_50_40 bm_academic_ctl_global bm_academic_textbox"
                                        ...
                                        <div>
                                            <div class="bm_ctl_container_50_100" style="width: 270px; float: left">
                                                <div class="bm_ctl_label_align_right_50_100" style="width: 120px">
                                                    <asp:Label ID="Label6" runat="server" Text="Member Code :" AssociatedControlID="xlbmemcode"
                                                        CssClass="label"></asp:Label>
                                                </div>
                                                <div class="bm_clt_ctl_50_100" style="width: 148px">
                                                    ...
                                                    <div class="bm_list_text" style="width: 120px">
                                                        <asp:TextBox ID="xlbmemcode" runat="server" CssClass="bm_academic_textbox_50_100 bm_academic_ctl_global bm_academic_textbox "
                                                            ></asp:TextBox>
                                                    </div>
                                                    <div class="bm_list_img">
                                                        <asp:Image ID="Image2" runat="server" ImageUrl="~/images/list-am32x32.png" CssClass="bm_academic_list bm_mem" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div style="float: left; padding-left: 5px; padding-top: 1px">
                                                <asp:Label ID="xnamemem" runat="server" Text="" CssClass="xnamemem"></asp:Label>
                                            </div>
                                       ...
                                       <%-- <div class="bm_clt_padding">
                                        ...
                                        <div class="bm_ctl_container_100_special" style="width: 270px;">
                                            <div class="bm_ctl_label_align_right_100_special" style="width: 120px">
                                                <asp:Label ID="Label31" runat="server" Text="Warehouse :" AssociatedControlID="xfwh"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_100_special" style="width: 148px">
                                                <asp:DropDownList ID="xfwh" runat="server" CssClass="bm_academic_dropdown_100_special bm_academic_ctl_global bm_academic_dropdown">
                                                </asp:DropDownList>
                                            </div>
                                        </div>--%>
                                      ...
                                      <%-- <div class="bm_clt_padding">
                                        ...
                                        <div class="bm_ctl_container_100_special" style="width: 270px;">
                                            <div class="bm_ctl_label_align_right_100_special" style="width: 120px">
                                                <asp:Label ID="Label7" runat="server" Text="Item Class :" AssociatedControlID="xglevel2"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_100_special" style="width: 148px">
                                                <asp:DropDownList ID="xglevel2" runat="server" CssClass="bm_academic_dropdown_100_special bm_academic_ctl_global bm_academic_dropdown"
                                                    AutoPostBack="True" OnTextChanged="xglevel2_OnTextChanged">
                                                </asp:DropDownList>
                                            </div>
                                        </div>--%>
                                      ...
                                      <%--  
                                        <div runat="server" id="includeset">
                                            ...
                                            <div class="bm_ctl_container_50_50" style="width: 120px; margin-bottom: 10px; margin-right: 10px; float: left;">
                                                <div class="bm_ctl_label_align_right_50_50" style="width: 118px">
                                                    <asp:Label ID="Label9" runat="server" Text="Include Set :"
                                                        CssClass="label "></asp:Label>
                                                </div>
                                            </div>
                                            <div style=" float: left;" runat="server" id="setlist">
                                        ...
                                        <%-- <div class="bm_ctl_container_100_special" style="width: 270px;">
                                            <div class="bm_ctl_label_align_right_100_special" style="width: 120px">
                                                <asp:Label ID="Label1" runat="server" Text="Rent Amount :" AssociatedControlID="xlbramt"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_100_special" style="width: 148px">
                                                <asp:TextBox ID="xlbramt" runat="server" CssClass="bm_academic_textbox_50_100 bm_academic_ctl_global bm_academic_textbox "
                                                    Enabled="False" Text="0.00" BackColor="Transparent" ForeColor="Black"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="bm_clt_padding">
                                        </div>--%>
                        ...
                        <div class="bm_academic_container_footer">
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Book Code">
                                                            ...
                                                            <ItemTemplate>
                                                                <div class="bm_clt_ctl_50_100" style="width: 148px">
                                                                    ...
                                                                    <div class="bm_list_img">
                                                                        <asp:Image ID="Image4" runat="server" ImageUrl="~/images/list-am32x32.png" CssClass="bm_academic_list bm_bookcd" Height="22px" />
                                                                    </div>
                                                                </div>
                                                            </ItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="Book Title">
                                                            ...
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:TextBox ID="xlbtitle" runat="server" CssClass="bm_academic_textbox_50_100 bm_academic_ctl_global bm_academic_textbox " Enabled="False" ForeColor="black" BackColor="Transparent"></asp:TextBox>
                                                        ...
                                                        <asp:TemplateField HeaderText="Date" Visible="false">
                                                            ...
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:TextBox ID="xdate" runat="server" CssClass="bm_academic_textbox_50_100 bm_academic_ctl_global bm_academic_datepicker"  ></asp:TextBox>

                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        
                                                                 <asp:TemplateField HeaderText="Refund Date" Visible="false">
                                                            <ItemStyle Width="160px" HorizontalAlign="Center" />
                                                            <ItemTemplate>

                                                                <asp:TextBox ID="xlbrfdate" runat="server" CssClass="bm_academic_textbox_50_100 bm_academic_ctl_global bm_academic_datepicker"  ></asp:TextBox>
                                                            ...
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:TextBox ID="xlbrcvdate" runat="server" CssClass="bm_academic_textbox_50_100 bm_academic_ctl_global bm_academic_textbox" Enabled="False" ForeColor="black" BackColor="Transparent"></asp:TextBox>

                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        
                                                        <asp:TemplateField HeaderText="Receive Trn. No." Visible="false">
                                                            <ItemStyle Width="150px" HorizontalAlign="Center" />
                                                            <ItemTemplate>

                                                                <asp:TextBox ID="xlbtrnrcv" runat="server" CssClass="bm_academic_textbox_50_100 bm_academic_ctl_global bm_academic_textbox" Enabled="False" ForeColor="black" BackColor="Transparent"></asp:TextBox>
                                                         ...
                                                         <%-- <asp:TemplateField HeaderText="Base Amount">
                                                            ...
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:TextBox ID="xbase" runat="server" CssClass="bm_academic_textbox_50_100 bm_academic_ctl_global bm_academic_textbox "></asp:TextBox>
                                                            ...
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:TextBox ID="xlbstatus" runat="server" CssClass="bm_academic_textbox_50_100 bm_academic_ctl_global bm_academic_textbox " Enabled="False" BackColor="Transparent" ForeColor="Black"></asp:TextBox>
                                                        ...
                                                        <asp:TemplateField HeaderText="Remarks" Visible="false">
                                                            ...
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:TextBox ID="xnote" runat="server" CssClass="bm_academic_textbox_50_100 bm_academic_ctl_global bm_academic_textbox "></asp:TextBox>
                                                        ...
                                                        <asp:TemplateField HeaderText="Shelf" >
                                                            ...
                                                            <ItemTemplate>
                                                                 ...
                                                                 <asp:DropDownList ID="xlbslf" runat="server" CssClass="bm_academic_dropdown_100_special bm_academic_ctl_global bm_academic_dropdown">
                                                </asp:DropDownList>
                            ...
                            <div class="bm_academic_container_body_button_section">
                                <div class="button_section_padding">
                                    ...
                                    Visible="False" />--%>
                                        <asp:Button ID="Button2" runat="server" Text="Member Book Info" CssClass="bm_academic_button3 bm_am_btn_click"
                                     OnClick="fnFillGrid6" Width="150"/>
                            ...
                            <div class="bm_academic_container_footer">
                                <div class="footer_list_padding">
                                    <div class="bm_academic_grid_container" id="Div3" runat="server" >
                                        <div class="grid_header" style="background-color: #b22222;">
                                            ...
                                            <div class="flot_right">
                                                ...
                                                <div class="grid_header_row">
                                                    <asp:TextBox ID="TextBox1" runat="server" AutoPostBack="True" CssClass="_gridrow"
                                            ...
                                            <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" ShowFooter="False"
                                                ...
                                                <Columns>
                                                    <asp:TemplateField HeaderText="Transaction No.">
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="xlbtrncode" runat="server" Text='<%#Eval("xlbtrncode") %>' CssClass="_gridrow_link"
                                                    ...
                                                    <asp:BoundField DataField="xdate" HeaderText="Issue Date" DataFormatString="{0:dd/MM/yyyy}"
                                    ...
                                    <div class="bm_academic_grid_container" id="Div5" runat="server">
                                        <div class="grid_header">
                                            ...
                                            <div class="flot_right">
                                                ...
                                                <div class="grid_header_row">
                                                    <asp:TextBox ID="TextBox2" runat="server" AutoPostBack="True" CssClass="_gridrow"
                                                        OnTextChanged="fnFillGrid6"></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="grid_body">
                                            <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" ShowFooter="False"
                                                CssClass="bm_academic_grid" HeaderStyle-CssClass="HeaderStyle" FooterStyle-CssClass="FooterStyle"
                                                RowStyle-CssClass="RowStyle" AlternatingRowStyle-CssClass="AlternatingRowStyle"
                                                PagerStyle-CssClass="PagerStyle" GridLines="None">
                                                <Columns>
                                                    <asp:TemplateField HeaderText="Transaction No.">
                                                       ...
                                                       <asp:BoundField DataField="xlbmemcode" HeaderText="Member Code" ItemStyle-Width="150px"
                                                        ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="pad5" />
                                                    
                                                    <asp:BoundField DataField="mem_name" HeaderText="Member Name" ItemStyle-Width="250px"
                                                        ItemStyle-HorizontalAlign="Left" ItemStyle-CssClass="pad5" />
                                                    
                                                    <asp:BoundField DataField="ztime" HeaderText="Date Created" DataFormatString="{0:dd/MM/yyyy}"
                                                        ItemStyle-Width="120px" ItemStyle-HorizontalAlign="Center" />
                                            ...
                                            <asp:GridView ID="dgvcollectionew" runat="server" AutoGenerateColumns="False" ShowFooter="False"
                                                ...
                                                <Columns>
                                                   ...
                                                   <%-- <asp:TemplateField HeaderText="Book Code" SortExpression="xlbord">
                                                        ...
                                                        <asp:BoundField DataField="xlbord" HeaderText="Book Code" ItemStyle-Width="150px"
                                                        ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="pad5" SortExpression="xlbord" />
                                        ...
                                        <div class="grid_body">
                                            <asp:GridView ID="dgvgenerateduesconfirmed" runat="server" AutoGenerateColumns="False" ShowFooter="False"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="xfwh" HeaderText="Warehouse" ItemStyle-Width="200px"
                                                        ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="pad5" />
