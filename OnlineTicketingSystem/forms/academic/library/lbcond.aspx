<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="lbcond.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.lbcond" %>
        ...
        <ContentTemplate>
            ...
            <%--    $("body").on("change", "#<%=xclass.ClientID%>", function() {
               ...
               <%--     if ($("#<%=hxstatus.ClientID%>").val() == "")--%>
                ...
                $("body").on("click", ".bm_bookcd", function () {
                    //alert("Hi");
                    fnOpenBookList4(<%= HttpContext.Current.Session["business"] %>, $(this).parent(".bm_list_img").siblings(".bm_list_text").find(".bm_academic_textbox").attr("ID"), $(this).parent(".bm_list_img").siblings(".bm_list_text").find(".bm_academic_textbox").val(),$("#<%=xlbtitle.ClientID%>").attr("ID"),$("#<%=xlbmemcode.ClientID%>").attr("ID"),$("#<%=mem_name.ClientID%>").attr("ID"),$("#<%=xlbtrncode.ClientID%>").attr("ID"),$("#<%=hxlbmemtype.ClientID%>").attr("ID"));
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Book Status Transaction</span>
                    </div>
                </div>
                        ...
                        <div class="bm_layout_container">
                            <div class="bm_layout_box_100">
                                ...
                                <div class="bm_layout_box_padding" style="padding-top: 0px;">
                                    ...
                                    <div style="width: 100%; clear: both; display: inline-block; padding-top: 5px; vertical-align: top;">


                                        <div class="bm_ctl_container_100_special" style="width: 270px;">
                                            <div class="bm_ctl_label_align_right_100_special" style="width: 120px">
                                                <asp:Label ID="Label9" runat="server" Text="Transactoin Prefix :" AssociatedControlID="xtrncnd"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_100_special" style="width: 148px">
                                                <asp:TextBox ID="xtrncnd" runat="server" CssClass="bm_academic_textbox_50_100 bm_academic_ctl_global bm_academic_textbox "
                                                    Enabled="False" Text="STAT" BackColor="Transparent" ForeColor="Black"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="bm_clt_padding">
                                        </div>
                                        ...
                                        <div style="width: 100%">
                                            <div style="float: left;">
                                                <div class="bm_ctl_container_50_50" style="width: 270px">
                                                    <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                        <asp:Label ID="Label37" runat="server" Text="Transactoin No :" AssociatedControlID="xlbtrncnd"
                                                            CssClass="label"></asp:Label>
                                                    </div>
                                                    <div class="bm_clt_ctl_50_50" style="width: 148px">

                                                        <asp:TextBox ID="xlbtrncnd" runat="server" CssClass="bm_academic_textbox_50_40 bm_academic_ctl_global bm_academic_textbox"
                                                            AutoPostBack="True" OnTextChanged="FillControl2"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                            <div style="float: left; padding-left: 3px;">
                                                <asp:ImageButton ID="ImageButton3" ImageUrl="~/images/search32x32.png" runat="server"
                                                    CssClass="bm_academic_list" Width="20px" Height="20px" OnClick="FillControl2" />
                                            </div>
                                        </div>
                                        <div class="bm_clt_padding">
                                        ...
                                        <div>
                                            <div class="bm_ctl_container_50_100" style="width: 270px; float: left">
                                                <div class="bm_ctl_label_align_right_50_100" style="width: 120px">
                                                    <asp:Label ID="Label12" runat="server" Text="Book Code :" AssociatedControlID="xlbord"
                                                        CssClass="label"></asp:Label>
                                                </div>
                                                <div class="bm_clt_ctl_50_100" style="width: 148px">
                                                    ...
                                                    <div class="bm_list_text" style="width: 120px">
                                                        <asp:TextBox ID="xlbord" runat="server" CssClass="bm_academic_textbox_50_100 bm_academic_ctl_global bm_academic_textbox "></asp:TextBox>
                                                    </div>
                                                    <div class="bm_list_img">
                                                        <asp:Image ID="Image2" runat="server" ImageUrl="~/images/list-am32x32.png" CssClass="bm_academic_list bm_bookcd" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div style="float: left; padding-left: 5px; padding-top: 1px">
                                                <asp:Label ID="xlbtitle" runat="server" Text="" CssClass="xlbtitle"></asp:Label>
                                            </div>
                                        ...
                                        <div class="bm_ctl_container_50_50" style="width: 270px">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label55" runat="server" Text="Physical Status :" AssociatedControlID="xdesc01"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 148px">

                                                <asp:DropDownList ID="xdesc01" runat="server" CssClass="bm_academic_dropdown_50_50 bm_academic_ctl_global bm_academic_dropdown bm_xclass">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                         ...
                                         <div class="bm_clt_padding">
                                          ...
                                          <div class="bm_ctl_container_50_50" style="float: left; width: 270px">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label13" runat="server" Text="Expiration Date :" AssociatedControlID="xdateexp"
                                                    CssClass="label "></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 148px">
                                                <asp:TextBox ID="xdateexp" runat="server" CssClass="bm_academic_textbox_50_40 bm_academic_ctl_global bm_academic_datepicker"></asp:TextBox>
                                            </div>
                                        </div>
                                        ...
                                        <div class="bm_clt_padding">
                                         ...
                                         <div class="bm_ctl_container_50_50" style="width: 400px">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label54" runat="server" Text="Member Code :" AssociatedControlID="xlbmemcode"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                        ...
                                        <div class="bm_ctl_container_50_50" style="width: 400px">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label11" runat="server" Text="Member Name :" AssociatedControlID="mem_name"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 278px">
                                        ...
                                        <div class="bm_ctl_container_50_50" style="width: 400px">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label16" runat="server" Text="Library Trn. No. :" AssociatedControlID="xlbtrncode"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 278px">
                                       ...
                                       <%-- <div class="bm_clt_padding">
                                        ...
                                        <div class="bm_ctl_container_50_50" style="width: 400px">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label17" runat="server" Text="Refund Date :" AssociatedControlID="xlbrfdate"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 278px">
                                        ...
                                        <div class="bm_ctl_container_dynamic_100_80">
                                            <div class="bm_ctl_container_dynamic_100_80_l" style="width: 120px">
                                                <div class="bm_ctl_label_align_right_dynamic_100_80_l">
                                                    <asp:Label ID="Label15" runat="server" Text="Note :" CssClass="label"></asp:Label>
                                                </div>
                                            </div>
                                            <div class="bm_clt_ctl_dynamic_100_80">
                                                <div class="_ctl_padding">
                                                    <textarea id="xnote" class="bm_academic_textarea_100_80  bm_academic_textarea"
                                        ...
                                        <div class="bm_ctl_container_50_50" style="width: 400px">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label38" runat="server" Text="Created By :" AssociatedControlID="zemail"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 278px">
                                    ...
                                    <div class="bm_ctl_container_50_50" style="width: 885px">
                                        <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                    ...
                                    <div class="bm_academic_grid_container" id="list" runat="server">
                                        <div class="grid_header">
                                            <div class="grid_header_label" id="_grid_header" runat="server">
                                                Book Status Transaction List(s)
                                            </div>
                                            ...
                                            <asp:GridView ID="dgvcollectionew" runat="server" AutoGenerateColumns="False" ShowFooter="False"
                                               ...
                                               <Columns>
                                                    <asp:TemplateField HeaderText="Transaction No.">
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="xlbtrncnd" runat="server" Text='<%#Eval("xlbtrncnd") %>' CssClass="_gridrow_link"
                                                                OnClick="FillControl"></asp:LinkButton>
                                                        </ItemTemplate>

                                                    </asp:TemplateField>
                                                    
                                                       <asp:BoundField DataField="xlbord" HeaderText="Book Code" ItemStyle-Width="150px"
                                                        ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="pad5" />
                                                    
                                                    <asp:BoundField DataField="xlbtitle" HeaderText="Book Title" ItemStyle-Width="250px"
                                                        ItemStyle-HorizontalAlign="Left" ItemStyle-CssClass="pad5" />
                                                 ...
                                                 <%--   <asp:BoundField DataField="xlbrfdate" HeaderText="Refund Date" DataFormatString="{0:dd/MM/yyyy}"
                                                        ItemStyle-Width="120px" ItemStyle-HorizontalAlign="Center" />--%>

                                                <%--   <asp:BoundField DataField="zemail" HeaderText="Created By" ItemStyle-Width="200px"
                                                        ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="pad5" />--%>
