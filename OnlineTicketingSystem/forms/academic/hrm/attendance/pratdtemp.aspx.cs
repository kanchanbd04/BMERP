...
{
    public partial class pratdtemp : System.Web.UI.Page
    {
        private void fnButtonState()
        {
            ...
            else
            {
                ...
                string xstatus1 = zglobal.fnGetValue("xstatus", "pratdtemp",
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!IsPostBack)
                {
                    ...
                    //zglobal.fnGetComboDataCD("Employee Code", xemp);
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string chk_shift = zglobal.fnGetValue("xemp", "hrmst",
                     "zid=" + _zid + " AND xstatusemp='A-Active' AND  xemp='" + xemp.Text.ToString().Trim() + "'");
                ...
                if (ViewState["xsup"] != null)
                {
                    xstatus2 = zglobal.fnGetValue("xstatus", "pratdtemp",
                ...
                using (SqlConnection con = new SqlConnection(zglobal.constring))
                {
                    using (DataSet dts = new DataSet())
                    {
                        con.Open();
                        string query =
                            "SELECT * FROM pratdtemp WHERE zid=@zid AND xdate=@xdate and xemp=@xemp";
                ...
                using (TransactionScope tran = new TransactionScope())
                {
                    ...
                    if (ViewState["xsup"] == null)
                    {
                        ...
                        using (SqlConnection conn = new SqlConnection(zglobal.constring))
                        {
                            ...
                            string query =
                               "INSERT INTO pratdtemp (ztime,zid,xdate,xemp,xlotime,xintime,xpnlttime,zemail,xouttime,xmrgntime,xremark,xstatus,xdayab,xatdstat,xinc,xnum,xscore,xqtycount," +
                               "xstr01,xrowauth,xrowappt,xrowprob,xint01,xint02) " +
                               "VALUES(@ztime,@zid,@xdate,@xemp,@xlotime,@xintime,@xpnlttime,@zemail,@xouttime,@xmrgntime,@xremark,@xstatus,@xdayab,@xatdstat,@xinc,@xnum,@xscore,@xqtycount," +
                               "@xstr01,@xrowauth,@xrowappt,@xrowprob,@xint01,@xint02) ";
                    ...
                    using (SqlConnection conn = new SqlConnection(zglobal.constring))
                    {
                        ...
                        if (xsupp == "")
                        {
                            ...
                            query = "UPDATE pratdtemp SET zutime=@zutime,xemail=@xemail, xlotime=@xlotime, " +
                                    "xintime=@xintime,xpnlttime=@xpnlttime,xouttime=@xouttime,xmrgntime=@xmrgntime,xremark=@xremark,xstatus=@xstatus,xdayab=@xdayab," +
                                   "xatdstat=@xatdstat," +
                                    "xinc=@xinc,xnum=@xnum,xscore=@xscore,xqtycount=@xqtycount,xstr01=@xstr01,xrowauth=@xrowauth,xrowappt=@xrowappt, " +
                                    "xrowprob=@xrowprob, xint01=@xint01,xint02=@xint02 " +
                                   "WHERE zid=@zid AND xdate=@xdate AND xemp=@xemp ";
        ...
        private void fnFillGrid2()
        {
            ...
            using (SqlConnection con = new SqlConnection(zglobal.constring))
            {
                using (DataSet dts1 = new DataSet())
                {
                    con.Open();
                    string query =
                         "SELECT Top " + Int32.Parse(_gridrow1.Text.Trim().ToString()) + " xemp," +
                       ...
                       "FROM pratdtemp WHERE zid=@zid and xemp = '"+xemp.Text.ToString().Trim()+"' " +
                       "order by xemp,xdate desc";
        ...
        protected void FillControl(object sender, EventArgs e)
        {
            try
            {
                ...
                fnFillControl(((LinkButton)sender).Text,xdate1);
        ...
        private void fnFillControl(string xsup1,DateTime xdate1)
        {
            ...
            string str = "SELECT  * " +
                         "FROM pratdtemp where zid=@zid  and xemp=@xemp and xdate=@xdate ";
            ...
            try
            {
                ...
                if (ViewState["xsup"] != null)
                {
                    if (txtconformmessageValue1.Value == "Yes")
                    {
                        ...
                        string xstatus1 = zglobal.fnGetValue("xstatus", "pratdtemp",
                         "zid=" + _zid + " AND xemp='" + xemp.Text.ToString().Trim() + "' AND xdate='" + DateTime.ParseExact(xdate.Text.ToString().Trim(), "dd/MM/yyyy",
                                    CultureInfo.InvariantCulture) + "'");
                        if (xstatus1 != "")
                        {
                        ...
                        using (TransactionScope tran = new TransactionScope())
                        {
                            using (SqlConnection conn = new SqlConnection(zglobal.constring))
                            {
                                ...
                                string query = "DELETE FROM pratdtemp WHERE zid=" + _zid + " AND xemp='" + xemp.Text.ToString().Trim() + "' AND xdate='" + DateTime.ParseExact(xdate.Text.ToString().Trim(), "dd/MM/yyyy",
                                    CultureInfo.InvariantCulture) + "'";
                                cmd.Parameters.Clear();
                    ...
                    if (txtconformmessageValue.Value == "Yes")
                    {
                        ...
                        using (TransactionScope tran = new TransactionScope())
                        {
                            using (SqlConnection conn = new SqlConnection(zglobal.constring))
                            {
                                ...
                                query =
                                    "UPDATE pratdtemp SET xstatus=@xstatus " +
