<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="pratdmon.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.pratdmon" %>
    ...
    <script type="text/javascript">
       ...
       function fnShowReport() {
         ...
         <%--  var fdep1 = $("#<%= fdep.ClientID%>").val();
           ...
           var openwin = window.open('/forms/academic/reports/hrm/pratdmonrpt.aspx?zid=' + zid + '&femp=' + femp1 + '&temp=' + temp1 +  '&fdate=' + fdate1 +  '&tdate=' + tdate1, 'pratdmon', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, copyhistory=no, width=' + screen.width + ', height=' + screen.height + ', top=0, left=0, targets=_blank');
            openwin.focus();
            //openwin.print();
            return false;
        }
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Periodical Attendance Sheet</span>
                    </div>
                </div>
                                        ...
                                        <table>
                                            ...
                                            <tr>
                                             ...
                                             <tr>
                                                ...
                                                <td>:</td>
                                                <td>
                                                    <asp:TextBox ID="tdate" runat="server" CssClass=" bm_academic_datepicker"></asp:TextBox></td>
                                            </tr>
