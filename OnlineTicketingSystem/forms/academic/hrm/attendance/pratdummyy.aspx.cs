...
{
    public partial class pratdummyy : System.Web.UI.Page
    {
        private void fnButtonState()
        {
            ...
            //    //string xstatus1 = zglobal.fnGetValue("xstatus", "pratdummy",
            //    //    "zid=" + _zid + " AND xemp='" + xemp.Text.ToString().Trim() + "' AND xdate='" +
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //if (ViewState["xsup"] != null)
                //{
                //    xstatus2 = zglobal.fnGetValue("xstatus", "pratdummy",
                //          "zid=" + _zid + " AND xdate='" + xdate1 + "' AND xemp='" + xemp.Text.ToString().Trim() + "'");
                //    if (xstatus2 != "")
                //    {
                ...
                //        con.Open();
                //        string query =
                //            "SELECT * FROM prholiday WHERE zid=@zid AND xdate=@xdate and xemp=@xemp";
                ...
                using (TransactionScope tran = new TransactionScope())
                {
                    ...
                    //if (ViewState["xsup"] == null)
                    {
                        ...
                        //        con.Open();
                        //        string query =
                        //            "SELECT * FROM prholiday WHERE zid=@zid AND xdate=@xdate and xshift=@xshift";
                        ...
                        using (SqlConnection conn = new SqlConnection(zglobal.constring))
                        {
                            ...
                            string query =
                               "INSERT INTO pratdummy (zid,xemp,xdate,xdesc,xref,xstatusjv,xpflag) " +
                               "VALUES(@zid,@xemp,@xdate,@xdesc,@xref,'','Thumb Missing') ";
                            ...
                            //xlotime1 = xlotime.Text.ToString().Trim();
                            //xintime1 = xintime.Text.ToString().Trim();
                            //xpnlttime1 = xpnlttime.Text.ToString().Trim();
                            //xouttime1 = xouttime.Text.ToString().Trim();
                            //xmrgntime1 = xmrgntime.Text.ToString().Trim();
                            xdesc1 = "1900-01-01" + " " + xstr01.Text.ToString().Trim();
                            xstatusjv1 = xstatusjv.Text.ToString().Trim();
                            xref1 = xref.Text.ToString().Trim();
                            xstr011 = xstr01.Text.ToString().Trim();
                            //xdayab1 = Convert.ToInt32(xdayab.Text.ToString().Trim());
                            //xatdstat1 = xatdstat.Text.ToString().Trim();
                            //xinc1 = Convert.ToInt32(xinc.Text.ToString().Trim());
                            //xnum1 = Convert.ToInt32(xnum.Text.ToString().Trim());
                            //xscore1 = Convert.ToDecimal(xscore.Text.ToString().Trim());
                            //xqtycount1 = Convert.ToInt32(xqtycount.Text.ToString().Trim());
                            //xstr011 = xstr01.Text.ToString().Trim();
                            //xrowauth1 = Convert.ToInt32(xrowauth.Text.ToString().Trim());
                            //xrowappt1 = Convert.ToInt32(xrowappt.Text.ToString().Trim());
                            //xrowprob1 = Convert.ToInt32(xrowprob.Text.ToString().Trim());
                            //xint011 = Convert.ToInt32(xint01.Text.ToString().Trim());
                            //xint021 = Convert.ToInt32(xint02.Text.ToString().Trim());
                            ...
                            //cmd.Parameters.AddWithValue("@xlotime", xlotime1);
                            //cmd.Parameters.AddWithValue("@xintime", xintime1);
                            //cmd.Parameters.AddWithValue("@xpnlttime", xpnlttime1);
                            //cmd.Parameters.AddWithValue("@xouttime", xouttime1);
                            //cmd.Parameters.AddWithValue("@xmrgntime", xmrgntime1);
                            cmd.Parameters.AddWithValue("@xdesc", xdesc1);
                            cmd.Parameters.AddWithValue("@xstatusjv", xstatusjv1);
                            //cmd.Parameters.AddWithValue("@xdayab", xdayab1);
                            //cmd.Parameters.AddWithValue("@xatdstat", xatdstat1);
                            //cmd.Parameters.AddWithValue("@xinc", xinc1);
                            //cmd.Parameters.AddWithValue("@xnum", xnum1);
                            //cmd.Parameters.AddWithValue("@xscore", xscore1);
                            //cmd.Parameters.AddWithValue("@xqtycount", xqtycount1);
                            //cmd.Parameters.AddWithValue("@xstr01", xstr011);
                            //cmd.Parameters.AddWithValue("@xrowauth", xrowauth1);
                            //cmd.Parameters.AddWithValue("@xrowappt", xrowappt1);
                            //cmd.Parameters.AddWithValue("@xrowprob", xrowprob1);
                            //cmd.Parameters.AddWithValue("@xint01", xint011);
                            //cmd.Parameters.AddWithValue("@xint02", xint021);
                    ...
                    //        xshift1 = xshift.Text.ToString().Trim();
                    //        //xlotime1 = xlotime.Text.ToString().Trim();
                    //        //xintime1 = xintime.Text.ToString().Trim();
                    //        //xpnlttime1 = xpnlttime.Text.ToString().Trim();
                    //        //xouttime1 = xouttime.Text.ToString().Trim();
                    //        //xmrgntime1 = xmrgntime.Text.ToString().Trim();
                    //        xremark1 = xremark.Text.ToString().Trim();
                    //        xstatus1 = xstatus.Text.ToString().Trim();
                    //        xnote1 = xnote.Text.ToString().Trim();
                    //        //xdayab1 = Convert.ToInt32(xdayab.Text.ToString().Trim());
                    //        //xatdstat1 = xatdstat.Text.ToString().Trim();
                    //        //xinc1 = Convert.ToInt32(xinc.Text.ToString().Trim());
                    //        //xnum1 = Convert.ToInt32(xnum.Text.ToString().Trim());
                    ...
                    //        query = "UPDATE prholiday SET zutime=@zutime,xemail=@xemail, xremark=@xremark, xnote=@xnote,xstatus=@xstatus " +
                    //               "WHERE zid=@zid AND xdate=@xdate AND xshift=@xshift ";
                    ...
                    //        //cmd.Parameters.AddWithValue("@xouttime", xouttime1);
                    //        //cmd.Parameters.AddWithValue("@xmrgntime", xmrgntime1);
                    //        cmd.Parameters.AddWithValue("@xremark", xremark1);
        ...
        private void fnFillGrid2()
        {
            ...
            using (SqlConnection con = new SqlConnection(zglobal.constring))
            {
                using (DataSet dts1 = new DataSet())
                {
                    con.Open();
                    string query =
                         "SELECT Top " + Int32.Parse(_gridrow1.Text.Trim().ToString()) + " xdate,xemp,xdesc,xstr01,xref,xpflag,xstatusjv " +
                       "FROM pratdummyy WHERE zid=@zid and xpflag='Thumb Missing' and xstatusjv=''" +
                       "order by xdate,xemp ";
        ...
        protected void FillControl(object sender, EventArgs e)
        {
            try
            {
                ...
                DateTime xdate1 = DateTime.ParseExact(row.Cells[0].Text, "dd/MM/yyyy",
                                    CultureInfo.InvariantCulture);
                string xemp1 = btn.Text.ToString().Trim();
                string xref1 = row.Cells[4].Text.ToString().Trim();
                string xstr011 = row.Cells[3].Text.ToString().Trim();

                fnFillControl(xemp1,xdate1,xref1,xstr011);
        ...
        private void fnFillControl(string xsup1,DateTime xdate1,string xref1, string xstr011)
        {
            message.InnerHtml = "";
            ...
            string str = "SELECT  * " +
                         "FROM pratdummyy where zid=@zid  and xemp=@xemp and xdate=@xdate and xref=@xref and xstr01=@xstr01 and xpflag='Thumb Missing' ";
            ...
            SqlDataAdapter da = new SqlDataAdapter(str, conn1);
            da.SelectCommand.Parameters.AddWithValue("@zid", _zid);
            da.SelectCommand.Parameters.AddWithValue("@xemp", xsup1);
            da.SelectCommand.Parameters.AddWithValue("@xdate", xdate1);
            da.SelectCommand.Parameters.AddWithValue("@xref", xref1);
            da.SelectCommand.Parameters.AddWithValue("@xstr01", xstr011);
            da.Fill(dts, "tempztcode");
            ...
            {
                message.InnerHtml = "Wrong employee code.";
                message.Style.Value = zglobal.am_warningmsg;
                return;
            }
            ...
            xstatusjv.Text = dttemp.Rows[0]["xstatusjv"].ToString();
            ...
            try
            {
                ...
                if (ViewState["xsup"] != null)
                {
                    if (txtconformmessageValue1.Value == "Yes")
                    {
                        ...
                        //string xstatus1 = zglobal.fnGetValue("xshift", "pratdummyy",
                        ...
                        using (TransactionScope tran = new TransactionScope())
                        {
                            using (SqlConnection conn = new SqlConnection(zglobal.constring))
                            {
                                ...
                                string query = "DELETE FROM pratdummy WHERE zid=" + _zid + " AND xemp='" + xemp.Text.ToString().Trim() + "' AND xdate='" + DateTime.ParseExact(xdate.Text.ToString().Trim(), "dd/MM/yyyy",
                                    CultureInfo.InvariantCulture) + "' and xdesc='" + xdesc.Text.ToString().Trim() + "' and xpflag='Thumb Missing' and xref='"+ xref.Text.ToString().Trim() +"'";
                                cmd.Parameters.Clear();
                    ...
                    if (txtconformmessageValue.Value == "Yes")
                    {
                        ...
                        using (TransactionScope tran = new TransactionScope())
                        {
                            using (SqlConnection conn = new SqlConnection(zglobal.constring))
                            {
                                ...
                                query =
                                    "UPDATE pratdummy SET xstatusjv='"+inout+"' " +
                                    "WHERE zid=" + _zid + " AND xemp='" + xemp.Text.ToString().Trim() + "' AND xdate='" + DateTime.ParseExact(xdate.Text.ToString().Trim(), "dd/MM/yyyy",
                                    CultureInfo.InvariantCulture) + "' and xdesc='" + xdesc.Text.ToString().Trim() + "' and xpflag='Thumb Missing' and xref='" + xref.Text.ToString().Trim() + "'";
                                cmd.Parameters.Clear();
