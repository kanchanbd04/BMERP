...
{
    public partial class pratdprss : System.Web.UI.Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                using (TransactionScope tran = new TransactionScope())
                {
                    ...
                    DateTime xfdate = xdate1.AddDays(-7);
                    DateTime xtdate = xdate1.AddDays(7);

                    int chk_dt = zglobal.fnGetValueInt("count(xdate)", "cadate",
                      "zid=" + _zid + " AND xpflag='1'");
                    ...
                    using (SqlConnection conn = new SqlConnection(zglobal.constring))
                    {
                        ...
                        string query =
                                "UPDATE cadate " +
                                "SET xpflag='1' " +
                                "WHERE zid=@zid AND xdate>=@xfdate and xdate<=@xtdate ";
                    ...
                    int chk_cnt = zglobal.fnGetValueInt("count(xemp)", "pratdummy_t",
                      "zid=" + _zid );
                    ...
                    if (chk_cnt != 0)
                    {
                        using (SqlConnection conn = new SqlConnection(zglobal.constring))
                        {
                            ...
                            string query =
                                    "DELETE FROM pratdummy_t  WHERE zid=@zid";
                    ...
                    using (SqlConnection conn = new SqlConnection(zglobal.constring))
                    {
                        ...
                        string query =
                           "INSERT INTO pratdummy_t (zid,xemp,xdate,xdesc,xref,xstatusjv,xpflag,xdatetime) " +
                           "SELECT DISTINCT @zid,pratdummyvw.xemp,pratdummyvw.xdate,pratdummyvw.xdesc,pratdummyvw.xref, " +
						   "pratdummyvw.xstatusjv,pratdummyvw.xpflag,pratdummyvw.xdatetime " +
						   "FROM pratdummyvw " +
						   "WHERE zid=@zid and xdate>=@xfdate and xdate<=@xtdate ";
                    ...
                    chk_cnt = zglobal.fnGetValueInt("count(xemp)", "prshiftdaily",
                      "zid=" + _zid);
                    ...
                    if (chk_cnt != 0)
                    {
                        using (SqlConnection conn = new SqlConnection(zglobal.constring))
                        {
                            ...
                            string query =
                                    "DELETE FROM prshiftdaily  WHERE zid=@zid";
                    ...
                    using (SqlConnection conn = new SqlConnection(zglobal.constring))
                    {
                        ...
                        string query =
                           "INSERT INTO prshiftdaily (ztime,zid,xdate,xemp,xshift) " +
                           "SELECT @ztime,prshiftvw_dt.zid,prshiftvw_dt.xdate,prshiftvw_dt.xemp,prshiftvw_dt.xshift " +						
						   "FROM prshiftvw_dt " +
                           "WHERE zid=@zid and xdate>=@xfdate and xdate<=@xtdate ";
                    ...
                    chk_cnt = zglobal.fnGetValueInt("count(xemp)", "prdumatdvw3_copy",
                      "zid=" + _zid);
                    ...
                    if (chk_cnt != 0)
                    {
                        using (SqlConnection conn = new SqlConnection(zglobal.constring))
                        {
                            ...
                            string query =
                                    "DELETE FROM prdumatdvw3_copy  WHERE zid=@zid";
                    ...
                    using (SqlConnection conn = new SqlConnection(zglobal.constring))
                    {
                        ...
                        string query =
                           "INSERT INTO prdumatdvw3_copy(ztime,zid,xdate,xemp,xremarks) " +
                           "SELECT @ztime,prdumatdvw3.zid,prdumatdvw3.xdate,prdumatdvw3.xemp,prdumatdvw3.xholiday " +
                           "FROM prdumatdvw3 " +
                           "WHERE prdumatdvw3.zid=@zid ";
                    ...
                    using (SqlConnection conn = new SqlConnection(zglobal.constring))
                    {
                        ...
                        string query =
                                "DELETE FROM pratd  WHERE zid=@zid AND xdate=@xdate";
                    ...
                    using (SqlConnection conn = new SqlConnection(zglobal.constring))
                    {
                        ...
                        string query =
                                "DELETE FROM prath  WHERE zid=@zid AND xdate=@xdate";
                    ...
                    using (SqlConnection conn = new SqlConnection(zglobal.constring))
                    {
                        ...
                        string query =
                           "INSERT INTO prath (ztime,zutime,zid,xyear,xper,xday,xdate,xshift,zemail,xemail,xatdrem,xstatusresp) " +
                           "SELECT @ztime,'',@zid,prdumatdgrp.xyear,prdumatdgrp.xper,prdumatdgrp.xday,prdumatdgrp.xdate, " +
						   "prdumatdgrp.xshift, " +
						   "@zemail,'','','' " +
                           "FROM prdumatdgrp " +
                           "WHERE zid=@zid AND xdate=@xdate ";
                    ...
                    using (SqlConnection conn = new SqlConnection(zglobal.constring))
                    {
                        ...
                        string query =
                           "INSERT INTO pratd(ztime,zutime,zid,xyear,xper,xday,xdate,xshift,xemp, " +
						   "xintime,xouttime,xlotime,xlitime,xatdstat,xpflag,zemail,xemail,xrem,xstatleave,xstatus, " +
						   "xinteger,xdatecom,xdatefrom,xdateto) " +
                           "SELECT @ztime,'',@zid,prdumatdvw7.xyear,prdumatdvw7.xper,prdumatdvw7.xday,prdumatdvw7.xdate, " +
						   "prdumatdvw7.xshift,prdumatdvw7.xemp,prdumatdvw7.xindttim,prdumatdvw7.xoutdttim, " +
						   "'','',prdumatdvw7.xatdstat,'',@zemail,'',prdumatdvw7.lv_note,prdumatdvw7.lv_statlv,'Machine Data', " +
						   "prdumatdvw7.stdhour,prdumatdvw7.stdlastindttim,prdumatdvw7.stdoutdttim,prdumatdvw7.stdlastoutdttim " +
                           "FROM prdumatdvw7 " +
                           "WHERE zid=@zid AND xdate=@xdate ";
                    ...
                    if (xstr01.Text.Trim().ToString() != "Check")
                    {
                        using (SqlConnection conn = new SqlConnection(zglobal.constring))
                        {
                            conn.Open();
                ...
                message.InnerHtml = "<font color=blue size=4>IN & Out Time Processing Completed </font> <br/> "+ DateTime.Now.TimeOfDay +" End Time";
