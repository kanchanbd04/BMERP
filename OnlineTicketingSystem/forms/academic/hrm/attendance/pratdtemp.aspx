<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="pratdtemp.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.pratdtemp" %>
          ...
          //gridviewScroll();
            ...
            $('#<%=GridView1.ClientID%>').gridviewScroll({
                ...
                $("body").on("click", ".bm_xemp", function () {
                    ...
                    fnOpenEMPList1(<%= HttpContext.Current.Session["business"] %>,$(this).parent(".bm_span2").siblings(".bm_span1").find(".bm_text1").attr("ID"),$(this).parent(".bm_span2").siblings(".bm_span1").find(".bm_text1").val(),$(this).parent(".bm_span2").siblings(".bm_span3").find(".xnameemp").attr("ID"));
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Employee wise Default Time Settings</span>
                    </div>
                </div>
                                    ...
                                    <div style="display: inline-block; width: 500px; font-size: 14px; vertical-align: top; color: #0000ff;">
                                        <table>
                                            <tr>
                                                ...
                                                <td>:</td>
                                                <td>
                                                    <asp:TextBox ID="xdate" runat="server" CssClass=" bm_academic_datepicker"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td style="text-align: right">In Time</td>
                                                <td>:</td>
                                                <td>
                                                    <asp:TextBox ID="xlotime" runat="server"></asp:TextBox>
                                                    &nbsp; <span style="color: gray">HH:MM:SS</span> </td>
                                            </tr>

                                            <tr>
                                                <td style="text-align: right">Penalty Time</td>
                                                <td>:</td>
                                                <td>
                                                    <asp:TextBox ID="xpnlttime" runat="server"></asp:TextBox>&nbsp; <span style="color: gray">HH:MM:SS</span></td>
                                            </tr>

                                            <tr>
                                                <td style="text-align: right">Time Out(OT Start Time)</td>
                                                <td>:</td>
                                                <td>
                                                    <asp:TextBox ID="xouttime" runat="server"></asp:TextBox>&nbsp; <span style="color: gray">HH:MM:SS</span></td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>:</td>
                                                <td>
                                                    <asp:DropDownList ID="xstr01" runat="server"></asp:DropDownList>
                                                </td>
                                            </tr>

                                            <tr>
                                                <td style="text-align: right">Minimum Consider Out(minutes)</td>
                                                <td>:</td>
                                                <td>
                                                    <asp:TextBox ID="xrowappt" runat="server" Text="0"></asp:TextBox></td>
                                            </tr>

                                            <tr>
                                                <td style="text-align: right">Margine Time</td>
                                                <td>:</td>
                                                <td>
                                                    <asp:TextBox ID="xmrgntime" runat="server"></asp:TextBox></td>
                                            </tr>
                                            
                                            <tr>
                                                <td style="text-align: right">Deduct OT hour for<br> Holiday Lunch(Minute)</td>
                                                <td>:</td>
                                                <td>
                                                    <asp:TextBox ID="xqtycount" runat="server" Text="0"></asp:TextBox></td>
                                            </tr>
                                            
                                            <tr>
                                                <td style="text-align: right">Check Machine Data<br>In/Out Status</td>
                                                <td>:</td>
                                                <td>
                                                    <asp:DropDownList ID="xatdstat" runat="server"></asp:DropDownList>
                                                </td>
                                            </tr>
                                            
                                            <tr>
                                                <td style="text-align: right">Working Day(s)</td>
                                                <td>:</td>
                                                <td>
                                                    <asp:TextBox ID="xint01" runat="server" Text="0"></asp:TextBox></td>
                                            </tr>
                                    ...
                                    <div style="display: inline-block; width: 500px; font-size: 14px; vertical-align: top; color: #0000ff;">
                                        <table>
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="bm_span1">
                                                    <asp:TextBox ID="xemp" runat="server" Height="20px" Width="100px" CssClass="bm_text1"></asp:TextBox>
                                                </span>
                                                <span class="bm_span2">
                                                ...
                                                <span class="bm_span3">
                                                    <asp:Label ID="xnameemp" runat="server" Text="" CssClass="xnameemp"></asp:Label>
                                                </span>
                                                </td>
                                            </tr>

                                            <tr>
                                                <td style="text-align: right">Intime tolerance
                                                    <br>
                                                    (Minute)</td>
                                                <td>:</td>
                                                <td>
                                            ...
                                            <tr>
                                                <td style="text-align: right">Maximum In Time</td>
                                                <td>:</td>
                                                <td>
                                                    <asp:TextBox ID="xintime" runat="server"></asp:TextBox>&nbsp; <span style="color: gray">HH:MM:SS</span></td>
                                            </tr>

                                            <tr>
                                                <td style="text-align: right">Penalty(Hour)</td>
                                                <td>:</td>
                                                <td>
                                                    <asp:TextBox ID="xinc" runat="server" Text="0"></asp:TextBox></td>
                                            </tr>

                                            <tr>
                                                <td style="text-align: right">Std. Out Hour (OT Start Time)</td>
                                                <td>:</td>
                                                <td>
                                                    <asp:TextBox ID="xnum" runat="server" Text="0"></asp:TextBox></td>
                                            </tr>

                                            <tr>
                                                <td style="text-align: right">Half Day Std. Out minutes (OT Start Time)</td>
                                                <td>:</td>
                                                <td>
                                                    <asp:TextBox ID="xrowauth" runat="server" Text="0"></asp:TextBox></td>
                                            </tr>

                                            <tr>
                                                <td style="text-align: right">Penalty Out(minutes)</td>
                                                <td>:</td>
                                                <td>
                                                    <asp:TextBox ID="xrowprob" runat="server" Text="0"></asp:TextBox></td>
                                            </tr>

                                            <tr>
                                                <td style="text-align: right">Shift Holiday</td>
                                                <td>:</td>
                                                <td>
                                                    <asp:DropDownList ID="xremark" runat="server"></asp:DropDownList>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td style="text-align: right">OT Consider(Minute)</td>
                                                <td>:</td>
                                                <td>
                                                    <asp:TextBox ID="xscore" runat="server" Text="0.00"></asp:TextBox></td>
                                            </tr>
                                            
                                            <tr>
                                                <td style="text-align: right">Working Hour(s)</td>
                                                <td>:</td>
                                                <td>
                                                    <asp:TextBox ID="xint02" runat="server" Text="0"></asp:TextBox></td>
                                            </tr>
