...
{
    public partial class prholiday : System.Web.UI.Page
    {
                ...
                using (TransactionScope tran = new TransactionScope())
                {
                    ...
                    if (ViewState["xsup"] == null)
                    {
                        ...
                        using (SqlConnection conn = new SqlConnection(zglobal.constring))
                        {
                            ...
                            string query =
                               "INSERT INTO prholiday (zid,ztime,xdate,xshift,xremark,xnote,xstatus,zemail) " +
                               "VALUES(@zid,@ztime,@xdate,@xshift,@xremark,@xnote,@xstatus,@zemail) ";
