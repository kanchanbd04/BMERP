<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="pratdummyy.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.pratdummyy" %>
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Thumb Missing</span>
                    </div>
                </div>
                    ...
                    <div class="bm_academic_container_body_button_section">
                        <div class="button_section_padding" style="border-bottom: 0px; padding-bottom: 0px">
                            <div class="button_section_style1" style="text-align: left; margin-bottom: 5px;">
                                ...
                                <asp:Button ID="btnSave" runat="server" Text="Add Entry" CssClass="bm_academic_button3 bm_am_btn_save"
                                ...
                                <div class="bm_hotkey" style="clear: both; padding-left: 10px; padding-bottom: 5px">
                                    <table style="border: 1px solid white">
                                        <tr style="border: 1px solid white">
                                            ...
                                            <td style="background-color: silver; color: green; margin: 1px">Add Entry - F10</td>
                                    ...
                                    <div style="display: inline-block; width: 500px; font-size: 14px; vertical-align: top; color: #0000ff;">
                                        <table>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="bm_span1">
                                                    <asp:TextBox ID="xemp" runat="server" Height="20px"  CssClass="bm_text1"></asp:TextBox>
                                                </span>
                                                <span class="bm_span2">
                                             ...
                                             <tr>
                                                ...
                                                <td>:</td>
                                                <td>
                                                    <asp:Label ID="xdesc" runat="server" Text=""></asp:Label></td>
                                            </tr>

                                            <tr>
                                                <td style="text-align: right">Time(hh:mm:ss)</td>
                                                <td>:</td>
                                                <td>
                                                    <asp:TextBox ID="xstr01" runat="server" ></asp:TextBox></td>
                                            </tr>

                                            <tr>
                                                <td style="text-align: right; vertical-align: top;">In/Out</td>
                                                <td style="vertical-align: top;">:</td>
                                                <td>
                                                     <asp:DropDownList ID="xref" runat="server">
                                             ...
                                             <tr>
                                                <td style="text-align: right">Entry Type</td>
                                                <td>:</td>
                                                <td>
                                                    <asp:Label ID="xpflag" runat="server" Text="Thumb Missing"></asp:Label>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>:</td>
                                                <td>
                                                    <asp:Label ID="xstatusjv" runat="server" Text=""></asp:Label>
                                            </tr>
                                ...
                                <div class="button_section_padding">
                                    <div class="button_section_style1" style="text-align: left; margin-top: 10px;">
                                        <asp:Button ID="btnRefresh1" runat="server" Text="Refresh" CssClass="bm_academic_button3 bm_am_btn_refresh"
                                            OnClick="btnRefresh_Click" />
                                        <asp:Button ID="btnSave1" runat="server" Text="Add Entry" CssClass="bm_academic_button3 bm_am_btn_save"
                                            OnClick="btnSave_Click" />
                                        ...
                                        <div class="grid_body">
                                            <asp:GridView ID="dgvcollectionew" runat="server" AutoGenerateColumns="False" ShowFooter="False"
                                              ...
                                              <Columns>
                                                    ...
                                                    <asp:BoundField DataField="xstr01" HeaderText="Time(hh:mm:ss)" ItemStyle-Width="120px"
                                                        ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="pad5" HtmlEncode="False"/>

                                                    <asp:BoundField DataField="xref" HeaderText="In/Out" ItemStyle-Width="120px"
                                                        ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="pad5" />
                                                  
                                                   <asp:BoundField DataField="xpflag" HeaderText="Entry Type" ItemStyle-Width="120px"
                                                        ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="pad5" />
                                                  
                                                   <asp:BoundField DataField="xstatusjv" HeaderText="Status" ItemStyle-Width="120px"
                                                        ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="pad5" />
