<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="prpayhead.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.prpayhead" %>
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Payment Head</span>
                    </div>
                </div>
                                ...
                                <div class="bm_layout_box_padding" style="padding-top: 0px;">
                                    ...
                                    <div style="display: inline-block; width: 500px; font-size: 14px; vertical-align: top; color: #0000ff;">
                                        <table>
                                            ...
                                            <tr>
                                                ...
                                                <td>:</td>
                                                <td>
                                                    <asp:TextBox ID="xpaycode" runat="server"></asp:TextBox>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>:</td>
                                                <td>
                                                    <asp:DropDownList ID="xprsign" runat="server"></asp:DropDownList>
                                                </td>
                                            </tr>

                                            <tr>
                                                <td style="text-align: right">Caption Appeared in the Salary Sheet</td>
                                                <td>:</td>
                                                <td>
                                                    <asp:TextBox ID="xlast" runat="server"></asp:TextBox>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>:</td>
                                                <td>
                                                    <asp:TextBox ID="xday" runat="server" Text="0"></asp:TextBox>
                                                </td>
                                            </tr>
                                    ...
                                    <div style="display: inline-block; width: 500px; font-size: 14px; vertical-align: top; color: #0000ff;">
                                        <table>
                                            ...
                                            <tr>
                                                <td style="text-align: right">Round Digit</td>
                                                <td>:</td>
                                                <td>
                                                    <asp:TextBox ID="xdigit" runat="server" Text="0"></asp:TextBox>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>:</td>
                                                <td>
                                                    <asp:DropDownList ID="xoption" runat="server"></asp:DropDownList>
                                                </td>
                                            </tr>
                                        ...
                                        <div class="grid_body">
                                            <asp:GridView ID="dgvcollectionew" runat="server" AutoGenerateColumns="False" ShowFooter="False"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="xprsign" HeaderText="Sign" 
                                                        ItemStyle-Width="120px" ItemStyle-HorizontalAlign="Left" ItemStyle-CssClass="pad5"/>
                                                    
                                                    <asp:BoundField DataField="xoption" HeaderText="Option" 
                                                        ItemStyle-Width="200px" ItemStyle-HorizontalAlign="Left" ItemStyle-CssClass="pad5"/>
