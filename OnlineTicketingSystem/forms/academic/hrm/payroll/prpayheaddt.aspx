<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="prpayheaddt.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.prpayheaddt" %>
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Details for Payment Head: &nbsp;<span id="spanxpaycode" runat="server"> </span>- &nbsp; <span id="spanxdesc" runat="server"></span>
                    </div>
                </div>
                                                ...
                                                <td>
                                                    ...
                                                    <span class="bm_span3">
                                                        <asp:Label ID="tmpdesc" runat="server" Text="" CssClass="bm_label1"></asp:Label>
                                                             ...
                                                             <tr>
                                                <td style="text-align: right">Dependent Pay Code</td>
                                                <td>:</td>
                                                <td>
                                                    
                                                    <span class="bm_span1">
                                                        <asp:TextBox ID="xpcode" runat="server" Height="20px" Width="150px" CssClass="bm_text1"></asp:TextBox>
                                                    </span>
                                                    <span class="bm_span2">
                                                        <asp:Image ID="Image1" runat="server" ImageUrl="~/images/list-am32x32.png" Height="20px" Width="20px" ImageAlign="Top" CssClass="bm_academic_list3 bm_tmpdesc1" />
                                                    </span>
                                                    <span class="bm_span3">
                                                        <asp:Label ID="tmpdesc1" runat="server" Text="" CssClass="bm_label1"></asp:Label>
                                                    </span>
                                                            ...
                                                            <tr>
                                                                <td style="text-align: right;">Percentage Rate
                                                                </td>
                                                                <td>:
                                                                </td>
                                                                <td>
                                                                    <asp:TextBox ID="xpercent" runat="server" Text="0.00"></asp:TextBox> &nbsp; &nbsp;OR
                                                                </td>
                                                            </tr>
                                                            ...
                                                            <tr style="padding-top: 15px;">
                                                                <td style="text-align: right;">Fixed Amount
                                                                </td>
                                                                <td>:
                                                                </td>
                                                                <td>
                                                                     <asp:TextBox ID="xamount" runat="server" Text="0.00"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            
                                                            <tr>
                                                                <td style="text-align: right;">Mininum Limit
                                                                </td>
                                                                <td>:
                                                                </td>
                                                                <td>
                                                                     <asp:TextBox ID="xminpay" runat="server" Text="0.00"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            
                                                            <tr>
                                                                <td style="text-align: right;">Maximun Limit
                                                                </td>
                                                                <td>:
                                                                </td>
                                                                <td>
                                                                     <asp:TextBox ID="xmaxpay" runat="server" Text="0.00"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                        ...
                                        <div class="grid_body">
                                            <asp:GridView ID="dgvcollectionew" runat="server" AutoGenerateColumns="False" ShowFooter="False"
                                                ...
                                                <Columns>
                                                   ...
                                                   <asp:TemplateField HeaderText="Pay scale Code">
                                                        <ItemStyle Width="200px" HorizontalAlign="Center" />
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="xpsclcode" runat="server" Text='<%#Eval("xpsclcode") %>' CssClass="_gridrow_link"
                                                                OnClick="FillControl"></asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>

                                                    <asp:BoundField DataField="xpcode" HeaderText="Dependent Pay Code" 
                                                        ItemStyle-Width="200px" ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="pad5"/>
                                                    
                                                    <asp:BoundField DataField="xpercent" HeaderText="Percentage Rate" 
                                                        ItemStyle-Width="120px" ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="pad5"/>
                                                    
                                                    <asp:BoundField DataField="xamount" HeaderText="Amount" 
                                                        ItemStyle-Width="120px" ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="pad5"/>
                                                    
                                                    <asp:BoundField DataField="xminpay" HeaderText="Mininum Limit" 
                                                        ItemStyle-Width="120px" ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="pad5"/>
                                                    
                                                    <asp:BoundField DataField="xmaxpay" HeaderText="Maximun Limit" 
                                                        ItemStyle-Width="120px" ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="pad5"/>
