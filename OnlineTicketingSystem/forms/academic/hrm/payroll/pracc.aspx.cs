...
{
    public partial class pracc : System.Web.UI.Page
    {
            ...
            try
            {
                if (!IsPostBack)
                {
                    ...
                    if (xpaydate1 != "")
                    {
                        ...
                        string str = "SELECT  * " +
                                     "FROM prpay where zid=@zid  and xpaydate=@xpaydate ";
        ...
        public void fnRegisterPostBack()
        {
            ...
            {
                LinkButton lnkFull1 = row.FindControl("xpaydate") as LinkButton;
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            //    if (xper.Text == "" || xper.Text == string.Empty || xper.Text == "[Select]")
            //    {
            //        rtnMessage = rtnMessage + "<li>Period</li>";
            //        isValid = false;
            //    }
            ...
            //    string salcal = zglobal.fnGetValue("xprsalcalc", "prdef",
            //          "zid=" + _zid );

            //    if (salcal == "")
            //    {
            //        message.InnerHtml = "Payroll Default not defined";
            //        message.Style.Value = zglobal.warningmsg;
            //        return;
            //    }
            ...
            //    if (salcal == "Last Day")
            //    {
            //        if (xper.Text.Trim() == "01" || xper.Text.Trim() == "03" || xper.Text.Trim() == "05" ||
            //            xper.Text.Trim() == "07" || xper.Text.Trim() == "08" || xper.Text.Trim() == "10" ||
            //            xper.Text.Trim() == "12")
            //        {
            //            day = 31;
            //        }
            //        else if (xper.Text.Trim() == "1" || xper.Text.Trim() == "3" || xper.Text.Trim() == "5" ||
            //           xper.Text.Trim() == "7" || xper.Text.Trim() == "8" || xper.Text.Trim() == "10" ||
            //           xper.Text.Trim() == "12")
            //        {
            //            day = 31;
            //        }

            //        if (xper.Text.Trim() == "04" || xper.Text.Trim() == "06" || xper.Text.Trim() == "09" || xper.Text.Trim() == "11" )
            //        {
            //            day = 30;
            //        }
            //        else if (xper.Text.Trim() == "4" || xper.Text.Trim() == "6" || xper.Text.Trim() == "9" || xper.Text.Trim() == "11")
            //        {
            //            day = 30;
            //        }

            //        if(Convert.ToInt32(xyear.Text.Trim())%4==0)
            //        {
            //            if (xper.Text.Trim() == "2" || xper.Text.Trim() == "02" )
            //            {
            //                day = 29;
            //            }
            //        }
            ...
            //    else
            //    {
            //        day = Convert.ToInt32(zglobal.fnGetValue("xperend", "prdef","zid=" + _zid)) + 1;
            //    }

            //    if (xper.Text.Trim() == "1" || xper.Text.Trim() == "2" || xper.Text.Trim() == "3" ||
            //            xper.Text.Trim() == "4" || xper.Text.Trim() == "5" || xper.Text.Trim() == "6" ||
            //            xper.Text.Trim() == "7" || xper.Text.Trim() == "8" || xper.Text.Trim() == "9")
            //    {
            //        xper.Text = "0" + xper.Text;
            //    }

            //    DateTime tempdate =
            //        DateTime.ParseExact(
            //            day.ToString() + "/" + xper.Text.ToString().Trim() + "/" + xyear.Text.Trim().ToString(),
            //            "dd/MM/yyyy", CultureInfo.InvariantCulture);

            //    xpaydate.Text = tempdate.ToString("dd/MM/yyyy");
            ...
            //            con.Open();
            //            string query =
            //                "SELECT * FROM prpay WHERE zid=@zid AND xpaydate=@xpaydate ";

            //            SqlDataAdapter da = new SqlDataAdapter(query, con);

            //            da.SelectCommand.Parameters.AddWithValue("@zid", _zid);
            //            da.SelectCommand.Parameters.AddWithValue("@xpaydate", tempdate);
            ...
            //            if (tempTable.Rows.Count > 0)
            //            {
            //                ViewState["xpaydate"] = xpaydate.Text.ToString().Trim();
            //            }
            //            else
            //            {
            //                ViewState["xpaydate"] = null;
            ...
            //                string query =
            //                   "INSERT INTO prpay (zid,ztime,xpaydate,xremarks,xyear,xper,zemail,xyearq,xperend,xflags) " +
            //                   "VALUES(@zid,@ztime,@xpaydate,@xremarks,@xyear,@xper,@zemail,@xyear,@xper,0) ";
            ...
            //                cmd.Parameters.AddWithValue("@xpaydate", tempdate);
            //                cmd.Parameters.AddWithValue("@xremarks", xremark1);
        ...
        private void fnFillGrid2()
        {
            ...
            using (SqlConnection con = new SqlConnection(zglobal.constring))
            {
                using (DataSet dts1 = new DataSet())
                {
                    con.Open();
                    string query =
                       "SELECT Top " + Int32.Parse(_gridrow1.Text.Trim().ToString()) + " xpaydate,xremarks,xyear,xper " +
                       "FROM prpay WHERE zid=@zid " +
                       "order by xpaydate desc ";
        ...
        private void fnFillControl(string xpaydate1)
        {
            message.InnerHtml = "";
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            //                    string query = "DELETE FROM prtrndt WHERE zid=" + _zid + " AND  " +
        ...
        protected void btnDetails_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (ViewState["xpaydate"] != null)
                {
                    string xpaydate1 = xpaydate.Text.Trim().ToString();
                    //string xdesc1 = xdesc.Text.Trim().ToString();

                    string url =
                         string.Format(
                             "~/forms/academic/hrm/payroll/prmsgacc.aspx?subnav=myDropdown21&link=LinkButton21&xid=205005010&xpaydate={0}",
                             xpaydate1);
