<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="pradvd.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.pradvd" %>
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                       <span class="bm_am_header_round">Loans & Advance Details for Employee: &nbsp;<span id="spanxemp" runat="server"> </span></span>
                    </div>
                </div>
                        ...
                        <div class="button_section_padding" style="border-bottom: 0px; padding-bottom: 0px">
                            <div class="button_section_style1" style="text-align: left; margin-bottom: 5px;">
                                ...
                                <%--<asp:Button ID="btnRefresh" runat="server" Text="Confirm" CssClass="bm_academic_button3 bm_am_btn_edit"
                                    Visible="False" />--%>
                                <asp:Button ID="btnAdjustment" runat="server" Text="Adjustment" CssClass="bm_academic_button3 bm_am_btn_adjustment"
                        ...
                        <div class="bm_layout_container">
                            <div class="bm_layout_box_100">
                                ...
                                <div class="bm_layout_box_padding" style="padding-top: 0px;">
                                    ...
                                    <div style="display: inline-block; width: 400px; font-size: 14px; vertical-align: top; color: #0000ff;">
                                        <table>
                                             <tr>
                                                <td style="text-align: right">Line No</td>
                                                <td>:</td>
                                                <td>
                                                    <asp:TextBox ID="xrow11" runat="server" Text="0" width="50px" ReadOnly="True"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                              ...
                                              <tr>
                                                ...
                                                <td>:</td>
                                                <td>
                                                    <asp:TextBox ID="xprime" runat="server" Text="0"></asp:TextBox>
                                                </td>
                                            </tr>
                                              ...
                                              <tr>
                                                ...
                                                <td>:</td>
                                                <td>
                                                    <asp:TextBox ID="xcomm" runat="server" Text="0"></asp:TextBox>
                                                </td>
                                            </tr>
                                            
                                              <tr>
                                                <td style="text-align: right">Repayment Rate</td>
                                                <td>:</td>
                                                <td>
                                                    <asp:TextBox ID="xprrate" runat="server" Text="0"></asp:TextBox>
                                                </td>
                                            </tr>
                                            
                                            <tr>
                                                <td style="text-align: right">Amount Adjusted</td>
                                                <td>:</td>
                                                <td>
                                                    <asp:Label ID="adjust" runat="server" Text="0"></asp:Label>
                                                </td>
                                            </tr>
                                            
                                            <tr>
                                                <td style="text-align: right">App. No</td>
                                                <td>:</td>
                                                <td>
                                                    <asp:Label ID="xref" runat="server" Text=""></asp:Label>
                                                </td>
                                            </tr>
                                            
                                             <tr>
                                                <td style="text-align: right">Entry /Approved by</td>
                                                <td>:</td>
                                                <td>
                                                    <asp:Label ID="zemail1" runat="server" Text=""></asp:Label>
                                                </td>
                                            </tr>
                                    ...
                                    <div style="display: inline-block; width: 500px; font-size: 14px; vertical-align: top; color: #0000ff;">
                                        <table>
                                             ...
                                             <tr>
                                                <td style="text-align: right">Close Flag</td>
                                                <td>:</td>
                                                <td>
                                             ...
                                             <tr>
                                                <td style="text-align: right">Repayment Commencing Date</td>
                                                <td>:</td>
                                                <td>
                                                    <asp:TextBox ID="xpaydate" runat="server" CssClass=" bm_academic_datepicker"></asp:TextBox>
                                                </td>
                                            </tr>
                                            
                                             <tr>
                                                <td style="text-align: right">Number of Installment</td>
                                                <td>:</td>
                                                <td>
                                                    <asp:TextBox ID="xinstalno" runat="server" Text="0"></asp:TextBox>
                                                </td>
                                            </tr>
                                            
                                            <tr>
                                                <td style="text-align: right">Total Amount (Loan+Interest)</td>
                                                <td>:</td>
                                                <td>
                                                    <asp:Label ID="xadvance" runat="server" Text=""></asp:Label>
                                                </td>
                                            </tr>
                                            
                                            <tr>
                                                <td style="text-align: right">Amount Deducted</td>
                                                <td>:</td>
                                                <td>
                                                    <asp:Label ID="xamount" runat="server" Text="0"></asp:Label>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>:</td>
                                                <td>
                                                    <asp:Label ID="balance" runat="server" Text="0"></asp:Label>
                                                </td>
                                            </tr>
                                              ...
                                              <tr>
                                                ...
                                                <td>:</td>
                                                <td>
                                                    <asp:TextBox ID="xremarks1" runat="server" Text="" TextMode="Multiline"></asp:TextBox>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>:</td>
                                                <td>
                                                    <asp:Label ID="xemail11" runat="server" Text=""></asp:Label>
                                                </td>
                                            </tr>
                                ...
                                <div class="button_section_padding">
                                    ...
                                    Visible="False" />--%>
                                        ...
                                        <asp:Button ID="btnPrint1" runat="server" Text="Print" CssClass="bm_academic_button3 bm_am_btn_print"
                                            OnClientClick="fnPrintReceipt();" Visible="False" />
                                        <asp:Button ID="btnAdjustment1" runat="server" Text="Adjustment" CssClass="bm_academic_button3 bm_am_btn_adjustment"
                                    OnClick="btnAdjustment_Click" />
                                        ...
                                        <div class="grid_body" >
                                            <asp:GridView ID="dgvcollectionpaid" runat="server" AutoGenerateColumns="False" ShowFooter="False"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="xadvance" HeaderText="Advance/Loan Amt" ItemStyle-Width="120px"
                                                        ItemStyle-HorizontalAlign="Right" ItemStyle-CssClass="pad5" HtmlEncode="False"/>

                                                    <asp:BoundField DataField="xinstalno" HeaderText="Installment(s)" ItemStyle-Width="120px"
                                                        ItemStyle-HorizontalAlign="Right" ItemStyle-CssClass="pad5" />

                                                    <asp:BoundField DataField="xprrate" HeaderText="Repayment Rate" ItemStyle-Width="120px"
                                                        ItemStyle-HorizontalAlign="Right" ItemStyle-CssClass="pad5" />
                                                    
                                                    <asp:BoundField DataField="xremarks" HeaderText="Remarks" ItemStyle-Width="250px"
                                                        ItemStyle-HorizontalAlign="Left" ItemStyle-CssClass="pad5" />
