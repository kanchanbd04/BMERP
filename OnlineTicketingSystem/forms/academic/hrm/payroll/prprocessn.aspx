<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="prprocessn.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.prprocessn" %>
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Payroll Process</span>
                    </div>
                </div>
                                        ...
                                        <table>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <span><b><font color=red size=2>LAST DATE OF MONTH </font></b></span>
                                                </td>
                                            </tr>
                                           
                                            <tr style="vertical-align: top;">
                                                <td style="text-align: right">Processing Type</td>
                                                <td>:</td>
                                                <td>
                                                    <asp:RadioButton ID="xptype_test" runat="server" GroupName="ptype" Text="Test Run" Checked="True"/><br/>
                                                    <asp:RadioButton ID="xptype_final" runat="server" GroupName="ptype" Text="Final Run"/>
                                                </td>
                                            </tr>
