...
{
    public partial class pradvd : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
         ...
         xemp1 + "' "); ;
                    ...
                    if (xpaycode1 != "" && xemp1 != "")
                    {
                        ...
                        string str = "SELECT  *, " +
                                     "(select sum(xreturn)  from prloanview where zid=@zid and xemp=@xemp and xpaycode=@xpaycode and xrow=@xrow) as xamount, " +
                                     ...
                                     "FROM pradvd where zid=@zid  and xemp=@xemp and xpaycode=@xpaycode and xrow=@xrow ";
                        ...
                        ViewState["xrow"] = xrow123.ToString();
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    rtnMessage = rtnMessage + "<li>Repayment Commencing Date</li>";
                    isValid = false;
                }
                ...
                using (SqlConnection con = new SqlConnection(zglobal.constring))
                {
                    using (DataSet dts = new DataSet())
                    {
                        con.Open();
                        string query =
                            "SELECT * FROM pradvd WHERE zid=@zid AND xemp=@xemp and xpaycode=@xpaycode and xrow=@xrow";
                        ...
                        da.SelectCommand.Parameters.AddWithValue("@xemp", xemp1);
                        da.SelectCommand.Parameters.AddWithValue("@xpaycode", xpaycode1);
                        da.SelectCommand.Parameters.AddWithValue("@xrow", Convert.ToInt32(xrow11.Text.Trim().ToString()));
                ...
                using (TransactionScope tran = new TransactionScope())
                {
                    ...
                    if (ViewState["xrow"] == null)
                    {
                        ...
                        using (SqlConnection conn = new SqlConnection(zglobal.constring))
                        {
                            ...
                            string query =
                               "INSERT INTO pradvd (ztime,zid,xemp,xpaycode,xrow,xdate,xpaydate,xadvance,xprrate,xpflag,xamount,zemail,xinstalno,xcomm,xprime,xref,xremarks) " +
                               "VALUES(@ztime,@zid,@xemp,@xpaycode,@xrow,@xdate,@xpaydate,@xadvance,@xprrate,@xpflag,@xamount,@zemail,@xinstalno,@xcomm,@xprime,@xref,@xremarks) ";
                            ...
                            xrow123 = zglobal.GetMaximumIdInt("xrow", "pradvd",
                                "zid=" + _zid + " and xemp='" + xemp1 + "' and xpaycode='" + xpaycode1 + "'", "xline", 10);
                            xrow11.Text = xrow123.ToString();
                            ...
                            cmd.Parameters.AddWithValue("@xadvance", xadvance1);
                            cmd.Parameters.AddWithValue("@xprrate", xprrate1);
                            ...
                            cmd.Parameters.AddWithValue("@xinstalno", xinstalno1);
                            cmd.Parameters.AddWithValue("@xcomm", xcomm1);
                            cmd.Parameters.AddWithValue("@xprime", xprime1);
                            cmd.Parameters.AddWithValue("@xref", xref1);
                            cmd.Parameters.AddWithValue("@xremarks", xremarks11);
                            cmd.ExecuteNonQuery();
                    ...
                    using (SqlConnection conn = new SqlConnection(zglobal.constring))
                    {
                        ...
                        if (xsupp == "")
                        {
                            ...
                            xrow123 = Convert.ToInt32(xrow11.Text.ToString().Trim());
                            xdate1 = xdate.Text.Trim() != string.Empty ? DateTime.ParseExact(xdate.Text.Trim().ToString(), "dd/MM/yyyy", CultureInfo.InvariantCulture) : DateTime.ParseExact("01/01/1900", "dd/MM/yyyy", CultureInfo.InvariantCulture);
                            xpaydate1 = xpaydate.Text.Trim() != string.Empty ? DateTime.ParseExact(xpaydate.Text.Trim().ToString(), "dd/MM/yyyy", CultureInfo.InvariantCulture) : DateTime.ParseExact("01/01/1900", "dd/MM/yyyy", CultureInfo.InvariantCulture);
                            xamount1 = Convert.ToDecimal(xamount.Text.Trim().ToString());
                            xinstalno1 = Convert.ToInt32(xinstalno.Text.Trim().ToString());
                            ...
                            query = "UPDATE pradvd SET zutime=@zutime,xemail=@xemail, xdate=@xdate, " +
                                    "xpaydate=@xpaydate,xprime=@xprime,xinstalno=@xinstalno,xcomm=@xcomm,xprrate=@xprrate,xremarks=@xremarks " +
                                    "WHERE zid=@zid AND xemp=@xemp AND xpaycode=@xpaycode and xrow=@xrow ";
        ...
        private void fnFillGrid2()
        {
            ...
            using (SqlConnection con = new SqlConnection(zglobal.constring))
            {
                using (DataSet dts1 = new DataSet())
                {
                    ...
                    string query =
                       "SELECT Top " + Int32.Parse(_gridrow1.Text.Trim().ToString()) + " xrow," +
                       "xadvance,xinstalno,xprrate,xremarks " +
                       "FROM pradvd WHERE zid=@zid and xemp=@xemp and xpaycode=@xpaycode  " +
        ...
        protected void FillControl(object sender, EventArgs e)
        {
            try
            {
                ...
                string xpaycode1 = Request.QueryString["xpaycode"] != null ? Request.QueryString["xpaycode"].ToString().Trim() : "";
                string xemp1 = Request.QueryString["xemp"] != null ? Request.QueryString["xemp"].ToString().Trim() : "";
                fnFillControl(((LinkButton)sender).Text, xpaycode1,xemp1);
        ...
        private void fnFillControl(string xrow123, string xpaycode1, string xemp1)
        {
            message.InnerHtml = "";
                    ...
                    if (txtconformmessageValue1.Value == "Yes")
                    {
                        ...
                        using (TransactionScope tran = new TransactionScope())
                        {
                            using (SqlConnection conn = new SqlConnection(zglobal.constring))
                            {
                                ...
                                string query = "DELETE FROM pradvd WHERE zid=" + _zid + " AND xemp='" + xemp1 + "' AND xpaycode='" + xpaycode1 + "' and xrow=" + Convert.ToInt32(xrow11.Text.Trim().ToString());
                                cmd.Parameters.Clear();
        ...
        protected void btnBack_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string url =
                     string.Format(
                         "~/forms/academic/hrm/payroll/pradvh.aspx?subnav=myDropdown21&link=LinkButton21&xid=205005015&xemp={0}&xpaycode={1}",
                         xemp1, xpaycode1);
        ...
        protected void btnAdjustment_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (ViewState["xrow"] != null)
                {
                    string xemp1 = Request.QueryString["xemp"] != null
                        ? Request.QueryString["xemp"].ToString().Trim()
                        : "";
                    string xpaycode1 = Request.QueryString["xpaycode"] != null
                        ? Request.QueryString["xpaycode"].ToString().Trim()
                        : "";
                    string xrow123 = xrow11.Text.Trim().ToString();
                    string url =
                        string.Format(
                            "~/forms/academic/hrm/payroll/pradvdadj.aspx?subnav=myDropdown21&link=LinkButton21&xid=205005015&xemp={0}&xpaycode={1}&xrow={2}",
