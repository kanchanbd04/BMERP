...
{
    public partial class prpayscaldt : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!IsPostBack)
                {
                    ...
                    spanxpsclcode.InnerHtml = xpsclcode1;
        ...
        private void fnFillGrid2()
        {
            ...
            using (SqlConnection con = new SqlConnection(zglobal.constring))
            {
                using (DataSet dts1 = new DataSet())
                {
                    ...
                    da1.SelectCommand.Parameters.AddWithValue("@zid", _zid);
                    da1.SelectCommand.Parameters.AddWithValue("@xpsclcode", xpsclcode1);
        ...
        protected void FillControl(object sender, EventArgs e)
        {
            try
            {
                ...
                fnFillControl(xpsclcode1, xpaycode1);
        ...
        private void fnFillControl(string xpsclcode1, string xpaycode1)
        {
            message.InnerHtml = "";
            ...
            string str = "SELECT  * " +
                         "FROM prpayheaddt where zid=@zid  and xpsclcode=@xpsclcode and xpaycode=@xpaycode ";
                    ...
                    if (txtconformmessageValue1.Value == "Yes")
                    {
                        ...
                        using (TransactionScope tran = new TransactionScope())
                        {
                            using (SqlConnection conn = new SqlConnection(zglobal.constring))
                            {
                                ...
                                string query = "DELETE FROM prpayheaddt WHERE zid=" + _zid + " AND xpsclcode='" + xpsclcode1 + "' and xpaycode='" + xpaycode.Text.Trim().ToString() + "'";
                                cmd.Parameters.Clear();
        ...
        protected void btnBack_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string url =
                         string.Format(
                             "~/forms/academic/hrm/payroll/prpayscal.aspx?subnav=myDropdown21&link=LinkButton21&xid=205001001&xpsclcode={0}",
                             xpsclcode1);
