<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="prpayscaldt.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.prpayscaldt" %>
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Payment Details for Salary Scale: &nbsp;<span id="spanxpsclcode" runat="server"> </span>- &nbsp; <span id="spanxdesc" runat="server"></span>
                    </div>
                </div>
                                                ...
                                                <tr>
                                                    <td align="left" style="padding: 5px;">
                                                        <table style="border: none;">
                                                              <tr>
                                                <td style="text-align: right">Pay Code</td>
                                                <td>:</td>
                                                <td>
                                                    
                                                    <span class="bm_span1">
                                                        <asp:TextBox ID="xpaycode" runat="server" Height="20px" Width="150px" CssClass="bm_text1"></asp:TextBox>
                                                    </span>
                                                    <span class="bm_span2">
