<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="prpayscal.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.prpayscal" %>
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Salay Structure</span>
                    </div>
                </div>
                                ...
                                <div class="bm_layout_box_padding" style="padding-top: 0px;">
                                    ...
                                    <div style="display: inline-block; width: 500px; font-size: 14px; vertical-align: top; color: #0000ff;">
                                        <table>
                                            ...
                                            <tr>
                                                <td style="text-align: right">Salary Scale</td>
                                                <td>:</td>
                                                <td>
                                                   <span class="bm_span1">
                                            ...
                                            <tr>
                                                ...
                                                <td>:</td>
                                                <td>
                                                   <asp:TextBox ID="xdesc" runat="server"></asp:TextBox>
                                                </td>
                                            </tr>

                                            <tr>
                                                <td style="text-align: right">Per Increment</td>
                                                <td>:</td>
                                                <td>
                                        ...
                                        <div class="grid_body">
                                            <asp:GridView ID="dgvcollectionew" runat="server" AutoGenerateColumns="False" ShowFooter="False"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Salary Scale">
                                                        <ItemStyle Width="150px" HorizontalAlign="Center" />
                                                        <ItemTemplate>
