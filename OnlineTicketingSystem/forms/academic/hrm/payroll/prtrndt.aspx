<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="prtrndt.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.prtrndt" %>
          ...
          //gridviewScroll();
            ...
            $('#<%=GridView1.ClientID%>').gridviewScroll({
                ...
                $("body").on("click", ".bm_tmpdesc", function () {
                    ...
                    fnOpenPayCode(<%= HttpContext.Current.Session["business"] %>,$(this).parent(".bm_span2").siblings(".bm_span1").find(".bm_text1").attr("ID"),$(this).parent(".bm_span2").siblings(".bm_span1").find(".bm_text1").val(),$("#<%= tmpdesc.ClientID%>").attr("ID")); 
                });
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Payment Transactions of Employee: &nbsp;<span id="spanxemp" runat="server"> </span>- &nbsp; &nbsp;Payment Date:&nbsp;<span id="spanxpaydate" runat="server"></span>
                    </div>
                </div>
                                                    ...
                                                    <span class="bm_span3">
                                                        <asp:Label ID="tmpdesc1" runat="server" Text="" CssClass="bm_label1"></asp:Label>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                     <asp:TextBox ID="xrem" runat="server" TextMode="MultiLine"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            
                                                            <tr>
                                                                <td style="text-align: right;">Added By
                                                                </td>
                                                                <td>:
                                                                </td>
                                                                <td>
                                                             ...
                                                             <tr>
                                                                <td style="text-align: right;">Updated By
                                                                </td>
                                                                <td>:
                                                                </td>
                                                                <td>
