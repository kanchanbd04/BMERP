...
{
    public partial class pradvdadj : System.Web.UI.Page
    {
        private void fnButtonState()
        {
            if (ViewState["xline"] == null)
            {
            ...
            {
                xsup.Text = ViewState["xline"].ToString();
                ////xsession.Enabled = false;
                ////xstdid.Enabled = false;

                //string xstatus1 = "";
                int _zid = Convert.ToInt32(Convert.ToString(HttpContext.Current.Session["business"]));
                //string xstatus1 = zglobal.fnGetValue("xstatus", "pratdt",
                ...
                ////               "zid=" + _zid + " AND xrow=" + Convert.ToInt32(ViewState["xline"]));
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!IsPostBack)
                {
                    ...
                    string xpaycode1 = Request.QueryString["xpaycode"] != null ? Request.QueryString["xpaycode"].ToString().Trim() : "";
                    string xemp1 = Request.QueryString["xemp"] != null ? Request.QueryString["xemp"].ToString().Trim() : "";
                    string xrow123 = Request.QueryString["xrow"] != null ? Request.QueryString["xrow"].ToString().Trim() : "";

                    spanxemp.InnerHtml = zglobal.fnGetValue("xemp + '- (' + xname + ')'", "hrmst",
         ...
         xemp1 + "' "); ;
                    ...
                    //    string str = "SELECT  *, " +
                    //                 "(select sum(xadvance)  from prloanview where zid=@zid and xemp=@xemp and xpaycode=@xpaycode and xrow=@xrow) as advance, " +
                    //                 "(select sum(xreturn)  from prloanview where zid=@zid and xemp=@xemp and xpaycode=@xpaycode and xrow=@xrow) as amount, " +
                    //                 "(select sum(xpayamt)  from prloanview where zid=@zid and xemp=@xemp and xpaycode=@xpaycode and xrow=@xrow) as adjust, " +
                    //                 "(select sum(xadvance-xreturn-xpayamt)  from prloanview where zid=@zid and xemp=@xemp and xpaycode=@xpaycode and xrow=@xrow) as balance " +
                    //                 "FROM pradvdadj where zid=@zid  and xemp=@xemp and xpaycode=@xpaycode and xrow=@xrow ";
                    ...
                    //    da.SelectCommand.Parameters.AddWithValue("@xrow", Convert.ToInt32(xrow123));
                    ...
                    //    ViewState["xline"] = xrow123.ToString();
                    //    //hiddenxrow.Value = ViewState["xline"].ToString();

                    //    xrow11.Text = dttemp.Rows[0]["xrow"].ToString();
                    //    xdate.Text = Convert.ToDateTime(dttemp.Rows[0]["xdate"]).ToString("dd/MM/yyyy");
                    //    xprime.Text = dttemp.Rows[0]["xprime"].ToString();
                    //    xcomm.Text = dttemp.Rows[0]["xcomm"].ToString();
                    //    xprrate.Text = dttemp.Rows[0]["xprrate"].ToString();
                    //    adjust.Text = dttemp.Rows[0]["adjust"].ToString();
                    //    xref.Text = dttemp.Rows[0]["xref"].ToString();
                    //    zemail1.Text = dttemp.Rows[0]["zemail"].ToString();
                    //    xpflag.Text = dttemp.Rows[0]["xpflag"].ToString();
                    //    xpaydate.Text = Convert.ToDateTime(dttemp.Rows[0]["xpaydate"].ToString()).ToString("dd/MM/yyyy");
                    //    xinstalno.Text = dttemp.Rows[0]["xinstalno"].ToString();
                    //    xadvance.Text = dttemp.Rows[0]["xadvance"].ToString();
                    //    xamount.Text = dttemp.Rows[0]["xamount"].ToString();
                    //    balance.Text = dttemp.Rows[0]["balance"].ToString();
                    //    xremarks1.Text = dttemp.Rows[0]["xremarks"].ToString();
                    //    xemail11.Text = dttemp.Rows[0]["xemail"].ToString();
                    //}
        ...
        public void fnRegisterPostBack()
        {
            ...
            {
                LinkButton lnkFull1 = row.FindControl("xline") as LinkButton;
                ScriptManager.GetCurrent(this).RegisterPostBackControl(lnkFull1);
            }
        }
        ...
        private void BindGrid()
        {
            ...
            //                da1.SelectCommand.Parameters.AddWithValue("xrow", Convert.ToInt32(ViewState["xline"]));
            ...
            //   //"ORDER BY xsequence";
            //    xrow1 = Convert.ToInt32(ViewState["xline"].ToString());
            //}
            //else
            //{
        ...
        protected void OnLinkClick(object sender, EventArgs e)
        {
            try
            {
                ...
                //        {
                //            int _zid = Convert.ToInt32(Convert.ToString(HttpContext.Current.Session["business"]));
                //            int xrow = Convert.ToInt32(ViewState["xline"]);
        ...
        private void fnCheckRow()
        {
            ...
            //        if (tempTable.Rows.Count > 0)
            //        {
            //            ViewState["xline"] = tempTable.Rows[0]["xrow"].ToString();
            //        }
            //        else
            //        {
            //            ViewState["xline"] = null;
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (xdatesch.Text == "" || xdatesch.Text == string.Empty || xdatesch.Text == "[Select]")
                {
                    rtnMessage = rtnMessage + "<li>Payment Date</li>";
                    isValid = false;
                }
                //if (xprime.Text == "" || xprime.Text == string.Empty || xprime.Text == "[Select]")
                //{
                //    rtnMessage = rtnMessage + "<li>Loan Amount</li>";
                //    isValid = false;
                //}
                ...
                string balamt = zglobal.fnGetValue("sum(xadvance-xreturn-xpayamt)", "prloanview",
                      "zid=" + _zid + " AND xemp='" + xemp1 + "' and xpaycode='"+xpaycode1+"' and xrow=" + Convert.ToInt32(xrow123));

                if (Convert.ToDecimal(balamt) == 0)
                {
                    message.InnerHtml = "Nothing to Adjust.";
                    message.Style.Value = zglobal.warningmsg;
                    return;
                }
                else if (Convert.ToDecimal(balamt) < Convert.ToDecimal(xpayamt.Text.Trim().ToString()))
                {
                    message.InnerHtml = "Amount cannot be more than " + balamt;
                    message.Style.Value = zglobal.warningmsg;
                    return;
                }

                //string chk_shift = zglobal.fnGetValue("xcode", "mscodesam",
                //     "zid=" + _zid + " AND xtype='Shift' and xcode='" + xshift.Text.ToString().Trim() + "'");

                //if (chk_shift != "")
                //{
                //    message.InnerHtml = "Invalid Shift Code<br>Pick from the list.";
                //    message.Style.Value = zglobal.warningmsg;
                //    return;
                //}
                ...
                //if (ViewState["xline"] != null)
                //{
                //    xstatus2 = zglobal.fnGetValue("xstatus", "pratdt",
                ...
                DateTime xpaydate1 = DateTime.Now;
                DateTime xdatesch1 = DateTime.Now;
                decimal xpayamt1 = 0;

                //decimal temp = 0;
                //decimal xadvance1 = 0;
                //decimal xprime1 = Convert.ToDecimal(xprime.Text.ToString().Trim());
                //decimal xcomm1 = Convert.ToDecimal(xcomm.Text.ToString().Trim());
                //temp = xprime1 * (xcomm1 / 100);

                //xadvance1 = 0 + xprime1 + temp;
                //xadvance.Text = xadvance1.ToString();

                //decimal xprrate1 = Convert.ToDecimal(xprrate.Text.ToString().Trim());

                //if (xprrate1 <= 0)
                //{
                //    xprrate1 = xadvance1 / Convert.ToDecimal(xinstalno.Text.Trim().ToString());
                //    xprrate.Text = xprrate1.ToString();
                //}
                ...
                //xpaycode1 = Request.QueryString["xpaycode"] != null ? Request.QueryString["xpaycode"].ToString().Trim() : "";
                //xemp1 = Request.QueryString["xemp"] != null ? Request.QueryString["xemp"].ToString().Trim() : "";
                ...
                using (SqlConnection con = new SqlConnection(zglobal.constring))
                {
                    using (DataSet dts = new DataSet())
                    {
                        con.Open();
                        string query =
                            "SELECT * FROM pradvdadj WHERE zid=@zid AND xemp=@xemp and xpaycode=@xpaycode and xrow=@xrow and xline=@xline";
                        ...
                        da.SelectCommand.Parameters.AddWithValue("@xpaycode", xpaycode1);
                        da.SelectCommand.Parameters.AddWithValue("@xrow", Convert.ToInt32(xrow123));
                        da.SelectCommand.Parameters.AddWithValue("@xline", Convert.ToInt32(xline.Text.Trim().ToString()));
                ...
                using (TransactionScope tran = new TransactionScope())
                {
                    ...
                    if (ViewState["xline"] == null)
                    {
                        ...
                        using (SqlConnection conn = new SqlConnection(zglobal.constring))
                        {
                            ...
                            string query =
                               "INSERT INTO pradvdadj (ztime,zid,xemp,xpaycode,xrow,xline,xdatesch,xpayamt,zemail) " +
                               "VALUES(@ztime,@zid,@xemp,@xpaycode,@xrow,@xline,@xdatesch,@xpayamt,@zemail) ";


                            //xrow = zglobal.GetMaximumIDWithTRN("xcdate", "xrow", "amtfch", xcdate1);
                            //ViewState["xline"] = xrow;
                            //hiddenxrow.Value = xrow.ToString();
                            //xtrnsup1 = xtrnsup.Text.Trim().ToString();
                            //xsup1 = zglobal.GetMaximumIDWithTRN(xtrnsup1, "xsup", "mssup");
                            //ViewState["xline"] = xsup1;
                            //xsupp = xsup1;
                            ...
                            xline1 = zglobal.GetMaximumIdInt("xline", "pradvdadj",
                                "zid=" + _zid + " and xemp='" + xemp1 + "' and xpaycode='" + xpaycode1 + "' and xrow=" + Convert.ToInt32(xrow123), "xline", 10);
                            xline.Text = xline1.ToString();

                            //xdate1 = xdate.Text.Trim() != string.Empty ? DateTime.ParseExact(xdate.Text.Trim().ToString(), "dd/MM/yyyy", CultureInfo.InvariantCulture) : DateTime.ParseExact("01/01/1900", "dd/MM/yyyy", CultureInfo.InvariantCulture);
                            //xpaydate1 = xpaydate.Text.Trim() != string.Empty ? DateTime.ParseExact(xpaydate.Text.Trim().ToString(), "dd/MM/yyyy", CultureInfo.InvariantCulture) : DateTime.ParseExact("01/01/1900", "dd/MM/yyyy", CultureInfo.InvariantCulture);
                            //xamount1 = Convert.ToDecimal(xamount.Text.Trim().ToString());
                            //xinstalno1 = Convert.ToInt32(xinstalno.Text.Trim().ToString());
                            //xremarks11 = xremarks1.Text.Trim().ToString();

                            xdatesch1 = xdatesch.Text.Trim() != string.Empty ? DateTime.ParseExact(xdatesch.Text.Trim().ToString(), "dd/MM/yyyy", CultureInfo.InvariantCulture) : DateTime.ParseExact("01/01/1900", "dd/MM/yyyy", CultureInfo.InvariantCulture);
                            xpayamt1 = Convert.ToDecimal(xpayamt.Text.Trim().ToString());
                            ...
                            cmd.Parameters.AddWithValue("@xrow", xrow123);
                            cmd.Parameters.AddWithValue("@xline", xline1);
                            cmd.Parameters.AddWithValue("@xdatesch", xdatesch1);
                            cmd.Parameters.AddWithValue("@xpayamt", xpayamt1);
                    ...
                    using (SqlConnection conn = new SqlConnection(zglobal.constring))
                    {
                        ...
                        if (xsupp == "")
                        {
                            ...
                            xline1 = Convert.ToInt32(xline.Text.ToString().Trim());
                            //xdate1 = xdate.Text.Trim() != string.Empty ? DateTime.ParseExact(xdate.Text.Trim().ToString(), "dd/MM/yyyy", CultureInfo.InvariantCulture) : DateTime.ParseExact("01/01/1900", "dd/MM/yyyy", CultureInfo.InvariantCulture);
                            //xpaydate1 = xpaydate.Text.Trim() != string.Empty ? DateTime.ParseExact(xpaydate.Text.Trim().ToString(), "dd/MM/yyyy", CultureInfo.InvariantCulture) : DateTime.ParseExact("01/01/1900", "dd/MM/yyyy", CultureInfo.InvariantCulture);
                            //xamount1 = Convert.ToDecimal(xamount.Text.Trim().ToString());
                            //xinstalno1 = Convert.ToInt32(xinstalno.Text.Trim().ToString());
                            ...
                            query = "UPDATE pradvdadj SET zutime=@zutime,xemail=@xemail, xdatesch=@xdatesch,xpayamt=@xpayamt " +
                                    "WHERE zid=@zid AND xemp=@xemp AND xpaycode=@xpaycode and xrow=@xrow and xline=@xline ";
                ...
                //BindGrid();
                //xrow1.Text = ViewState["xline"].ToString();
                //xsup.Text = ViewState["xline"].ToString();
        ...
        protected void btnOk_Click(object sender, EventArgs e)
        {
            ...
            {
                //int _zid = Convert.ToInt32(Convert.ToString(HttpContext.Current.Session["business"]));
                //int xrow = int.Parse(ViewState["xline"].ToString());
                //int xline1 = 0;
                //message.InnerHtml = "";
        ...
        private void fnFillGrid2()
        {
            ...
            //           "FROM pratdt WHERE zid=@zid and xshift = '"+xshift.Text.ToString().Trim()+"' " +
            ...
            using (SqlConnection con = new SqlConnection(zglobal.constring))
            {
                using (DataSet dts1 = new DataSet())
                {
                    ...
                    string query =
                       "SELECT Top " + Int32.Parse(_gridrow1.Text.Trim().ToString()) + " xline," +
                       "xpayamt " +
                       "FROM pradvdadj WHERE zid=@zid and xemp=@xemp and xpaycode=@xpaycode and xrow=@xrow " +
                       "order by xemp,xpaycode,xrow DESC";

                    SqlDataAdapter da1 = new SqlDataAdapter(query, con);

                    da1.SelectCommand.Parameters.AddWithValue("@zid", _zid);
                    da1.SelectCommand.Parameters.AddWithValue("@xemp", xemp1);
                    da1.SelectCommand.Parameters.AddWithValue("@xpaycode", xpaycode1);
                    da1.SelectCommand.Parameters.AddWithValue("@xrow", Convert.ToInt32(xrow123));
        ...
        protected void FillControl(object sender, EventArgs e)
        {
            try
            {
                ...
                //DateTime xdate1 = DateTime.ParseExact(row.Cells[1].Text, "dd/MM/yyyy",
                //                    CultureInfo.InvariantCulture);
                string xpaycode1 = Request.QueryString["xpaycode"] != null ? Request.QueryString["xpaycode"].ToString().Trim() : "";
                string xemp1 = Request.QueryString["xemp"] != null ? Request.QueryString["xemp"].ToString().Trim() : "";
                string xrow123 = Request.QueryString["xrow"] != null ? Request.QueryString["xrow"].ToString().Trim() : "";
                fnFillControl(((LinkButton)sender).Text, xpaycode1,xemp1,xrow123);
        ...
        private void fnFillControl(string xline1, string xpaycode1, string xemp1, string xrow123)
        {
            message.InnerHtml = "";
            ...
            string str = "SELECT  *, " +
                         ...
                         "(select sum(xpayamt)  from prloanview where zid=@zid and xemp=@xemp and xpaycode=@xpaycode and xrow=@xrow) as adjust, " +
                         "(select sum(xadvance-xreturn-xpayamt)  from prloanview where zid=@zid and xemp=@xemp and xpaycode=@xpaycode and xrow=@xrow) as balance " +
                         "FROM pradvdadj where zid=@zid  and xemp=@xemp and xpaycode=@xpaycode and xrow=@xrow and xline=@xline ";
            ...
            da.SelectCommand.Parameters.AddWithValue("@xpaycode", xpaycode1);
            da.SelectCommand.Parameters.AddWithValue("@xrow", Convert.ToInt32(xrow123));
            da.SelectCommand.Parameters.AddWithValue("@xline", Convert.ToInt32(xline1));
            da.Fill(dts, "tempztcode");
            DataTable dttemp = new DataTable();
            dttemp = dts.Tables[0];
            ...
            ViewState["xline"] = xline1.ToString();
            //hiddenxrow.Value = ViewState["xline"].ToString();

            xline.Text = dttemp.Rows[0]["xline"].ToString();
            //xdate.Text = Convert.ToDateTime(dttemp.Rows[0]["xdate"]).ToString("dd/MM/yyyy");
            advance.Text = dttemp.Rows[0]["advance"].ToString();
            amount.Text = dttemp.Rows[0]["amount"].ToString();
            adjust.Text = dttemp.Rows[0]["adjust"].ToString();
            adjust.Text = dttemp.Rows[0]["adjust"].ToString();
            balance.Text = dttemp.Rows[0]["balance"].ToString();
            xdatesch.Text = Convert.ToDateTime(dttemp.Rows[0]["xdatesch"].ToString()).ToString("dd/MM/yyyy");
            xpayamt.Text = dttemp.Rows[0]["xpayamt"].ToString();
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            //                    string query = "";
            //                    //string xstatus1 = zglobal.fnGetValue("xstatus", "amexamh", "zid=" + _zid + " AND xrow=" + Convert.ToInt32(ViewState["xline"]));
            ...
            //                    //        cmd.CommandText = query;
            //                    //        cmd.Parameters.AddWithValue("@zid", _zid);
            //                    //        cmd.Parameters.AddWithValue("@xrow", Convert.ToInt32(ViewState["xline"]));
            ...
            try
            {
                ...
                if (ViewState["xline"] != null)
                {
                    if (txtconformmessageValue1.Value == "Yes")
                    {
                        ...
                        string xemp1 = Request.QueryString["xemp"] != null ? Request.QueryString["xemp"].ToString().Trim() : "";
                        string xrow123 = Request.QueryString["xrow"] != null ? Request.QueryString["xrow"].ToString().Trim() : "";
                        //string xstatus1 = zglobal.fnGetValue("sum(xreturn)", "prloanview",
                        // "zid=" + _zid + " AND xemp='" + xemp1 + "' AND xpaycode='" + xpaycode1 + "' and xrow=" + Convert.ToInt32(xrow11.Text.Trim().ToString()));
                        //if (Convert.ToDecimal(xstatus1) > 0)
                        //{
                        //    message.InnerHtml = "Cann't delete data. Record exists.";
                        //    message.Style.Value = zglobal.warningmsg;
                        //    return;
                        //}
                        ...
                        using (TransactionScope tran = new TransactionScope())
                        {
                            using (SqlConnection conn = new SqlConnection(zglobal.constring))
                            {
                                ...
                                string query = "DELETE FROM pradvdadj WHERE zid=" + _zid + " AND xemp='" + xemp1 + "' AND xpaycode='" + xpaycode1 + "' and xrow="+ Convert.ToInt32(xrow123) +" and xline=" + Convert.ToInt32(xline.Text.Trim().ToString());
                                cmd.Parameters.Clear();

                                cmd.CommandText = query;
                                cmd.Parameters.AddWithValue("@zid", _zid);
                                //cmd.Parameters.AddWithValue("@xsup", ViewState["xline"].ToString());
                                cmd.ExecuteNonQuery();
        ...
        protected void btnRefresh_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                ////                SqlDataAdapter da = new SqlDataAdapter(query, conn);
                ////                da.SelectCommand.Parameters.AddWithValue("@zid", _zid);
                ////                da.SelectCommand.Parameters.AddWithValue("@xrow", Convert.ToInt32(ViewState["xline"]));
                ////                da.Fill(dts, "tempztcode");
                ////                DataTable dtexam = new DataTable();
                ////                dtexam = dts.Tables[0];
        ...
        protected void btnConfirm_Click(object sender, EventArgs e)
        {
            ...
            //                    query =
            //                        "UPDATE pratdt SET xstatus=@xstatus " +
        ...
        protected void btnPaid_Click(object sender, EventArgs e)
        {
            ...
            //            fnFillControl(ViewState["xline"].ToString());
        ...
        protected void btnBack_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string url =
                     string.Format(
                         "~/forms/academic/hrm/payroll/pradvd.aspx?subnav=myDropdown21&link=LinkButton21&xid=205005015&xemp={0}&xpaycode={1}&xrow={2}",
                         xemp1, xpaycode1,xrow123);
