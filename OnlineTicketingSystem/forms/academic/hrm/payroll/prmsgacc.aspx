<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="prmsgacc.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.prmsgacc" %>
                            ...
                            <div class="button_section_style1" style="text-align: left; margin-bottom: 5px;">
                             ...
                             <%--   <asp:Button ID="btnConfirm" runat="server" Text="Confirm" CssClass="bm_academic_button3 bm_am_btn_edit"
                               ...
                               <%-- <asp:Button ID="btnPaid" runat="server" Text="Paid" CssClass="bm_academic_button3 bm_am_btn_paid"
                                ...
                                <asp:Button ID="btnTop" runat="server" Text="Top" CssClass="bm_academic_button3 bm_am_btn_top"
                                    OnClick="btnTop_Click" />
                                 <asp:Button ID="btnPrevious" runat="server" Text="Previous" CssClass="bm_academic_button3 bm_am_btn_previous"
                                    OnClick="btnPrevious_Click" />
                                 <asp:Button ID="btnNext" runat="server" Text="Next" CssClass="bm_academic_button3 bm_am_btn_next"
                                    OnClick="btnNext_Click" />
                                <asp:Button ID="btnBottom" runat="server" Text="Bottom" CssClass="bm_academic_button3 bm_am_btn_bottom"
                                    OnClick="btnBottom_Click" />
                            ...
                            <div class="bm_layout_box_100">
                                ...
                                <div class="bm_layout_box_padding" style="padding-top: 0px;">
                                         ...
                                         <table>
                                             ...
                                             <tr>
                                               ...
                                               <tr style="vertical-align: top">
                                                ...
                                                <td>:</td>
                                                <td >
                                                    <asp:Label ID="xadvflag" runat="server" Text="" CssClass="xnameemp"></asp:Label>
                                                    </td>
                                            </tr>
                                             ...
                                             <tr>
                                                ...
                                                <td>:</td>
                                                <td>
                                                  <asp:Label ID="xdayab" runat="server" Text="0"></asp:Label>
                                            </tr>
                                             
                                             <tr>
                                                <td style="text-align: right">Leave Days</td>
                                                <td>:</td>
                                                <td>
                                              ...
                                              <tr>
                                                <td style="text-align: right">Leave Day (w/o Pay)</td>
                                                <td>:</td>
                                                <td>
                                                    <asp:Label ID="xratev" runat="server" Text="0"></asp:Label>
                                            </tr>
                                             ...
                                             <tr>
                                                ...
                                                <td>:</td>
                                                <td>
                                                    <asp:TextBox ID="xremarks" runat="server" Text="" TextMode="MultiLine" ReadOnly="True"></asp:TextBox></td>
                                            </tr>
                                    ...
                                    <div style="display: inline-block; width: 500px;   vertical-align: top; ">
                                        ...
                                        <div class="grid_header" style="height: 40px;">
                                            <div class="grid_header_label" >
                                               Payment Details for: &nbsp; <asp:Label ID="xempid" runat="server" ></asp:Label>
                                            </div>
                                        ...
                                        <div class="grid_body" style=" width: 100%;">
                                         <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" ShowFooter="true"
                                            ...
                                            UseAccessibleHeaderText="true" OnDataBound="GridView1_DataBound1">
                                             <Columns>
                                                   ...
                                                   <asp:BoundField DataField="xpaycode" HeaderText="Pay Code" 
                                                    ...
                                                    <asp:BoundField DataField="xdesc" HeaderText="Description" 
                                                        ItemStyle-Width="200px" ItemStyle-HorizontalAlign="Left" ItemStyle-CssClass="pad5"/>
                                                    
                                                    
                                                    <asp:BoundField DataField="xamount" HeaderText="Amount" 
                                                        ItemStyle-Width="120px" ItemStyle-HorizontalAlign="Right" ItemStyle-CssClass="pad5"/>
                                    ...
                                    Visible="False" />--%>
                                      <%--  <asp:Button ID="btnPaid1" runat="server" Text="Paid" CssClass="bm_academic_button3 bm_am_btn_paid"
                                        ...
                                        <asp:Button ID="Button3" runat="server" Text="Back" CssClass="bm_academic_button3 bm_am_btn_back"
                                            OnClick="btnBack_Click" />
                                        <asp:Button ID="Button1" runat="server" Text="Top" CssClass="bm_academic_button3 bm_am_btn_top"
                                    OnClick="btnTop_Click" />
                                 <asp:Button ID="Button2" runat="server" Text="Previous" CssClass="bm_academic_button3 bm_am_btn_previous"
                                    OnClick="btnPrevious_Click" />
                                 <asp:Button ID="Button4" runat="server" Text="Next" CssClass="bm_academic_button3 bm_am_btn_next"
                                    OnClick="btnNext_Click" />
                                <asp:Button ID="Button5" runat="server" Text="Bottom" CssClass="bm_academic_button3 bm_am_btn_bottom"
                                    OnClick="btnBottom_Click" />
                                    </div>
                                </div>
                            </div>
