...
{
    public partial class prpayscal : System.Web.UI.Page
    {
            ...
            try
            {
                if (!IsPostBack)
                {
                    ...
                    if (xpsclcode1 != "" )
                    {
                        ...
                        string str = "SELECT  * " +
                                     "FROM prpayscal where zid=@zid  and xpsclcode=@xpsclcode ";
                        ...
                        da.SelectCommand.Parameters.AddWithValue("@xpsclcode", xpsclcode1);
        ...
        public void fnRegisterPostBack()
        {
            ...
            {
                LinkButton lnkFull1 = row.FindControl("xpsclcode") as LinkButton;
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (xpsclcode.Text == "" || xpsclcode.Text == string.Empty || xpsclcode.Text == "[Select]")
                {
                    rtnMessage = rtnMessage + "<li>Salary Scale</li>";
                    isValid = false;
                }
                ...
                using (SqlConnection con = new SqlConnection(zglobal.constring))
                {
                    using (DataSet dts = new DataSet())
                    {
                        con.Open();
                        string query =
                            "SELECT * FROM prpayscal WHERE zid=@zid AND xpsclcode=@xpsclcode ";

                        SqlDataAdapter da = new SqlDataAdapter(query, con);

                        da.SelectCommand.Parameters.AddWithValue("@zid", _zid);
                        da.SelectCommand.Parameters.AddWithValue("@xpsclcode", xpsclcode.Text.ToString().Trim());
                        ...
                        if (tempTable.Rows.Count > 0)
                        {
                            ViewState["xpsclcode"] = xpsclcode.Text.ToString().Trim();
                        }
                        else
                        {
                            ViewState["xpsclcode"] = null;
                ...
                using (TransactionScope tran = new TransactionScope())
                {
                    ...
                    if (ViewState["xpsclcode"] == null)
                    {
                        ...
                        using (SqlConnection conn = new SqlConnection(zglobal.constring))
                        {
                            ...
                            string query =
                               "INSERT INTO prpayscal (zid,ztime,xpsclcode,xdesc,xamount,zemail) " +
                               "VALUES(@zid,@ztime,@xpsclcode,@xdesc,@xamount,@zemail) ";
                    ...
                    using (SqlConnection conn = new SqlConnection(zglobal.constring))
                    {
                        ...
                        if (xsupp == "")
                        {
                            ...
                            query = "UPDATE prpayscal SET zutime=@zutime,xdesc=@xdesc, xamount=@xamount,xemail=@xemail " +
        ...
        private void fnFillGrid2()
        {
            ...
            using (SqlConnection con = new SqlConnection(zglobal.constring))
            {
                using (DataSet dts1 = new DataSet())
                {
                    con.Open();
                    string query =
                         "SELECT Top " + Int32.Parse(_gridrow1.Text.Trim().ToString()) + " xpsclcode,xdesc " +
        ...
        protected void FillControl(object sender, EventArgs e)
        {
            try
            {
                ...
                string xpsclcode1 = ((LinkButton)sender).Text;

                fnFillControl(xpsclcode1);
        ...
        private void fnFillControl(string xpsclcode1)
        {
            message.InnerHtml = "";
                    ...
                    if (txtconformmessageValue1.Value == "Yes")
                    {
                        ...
                        using (TransactionScope tran = new TransactionScope())
                        {
                            using (SqlConnection conn = new SqlConnection(zglobal.constring))
                            {
                                ...
                                string query = "DELETE FROM prpayscal WHERE zid=" + _zid + " AND xpsclcode='" + xpsclcode.Text.ToString().Trim() + "' ";
                                cmd.Parameters.Clear();
        ...
        protected void btnDetails_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (ViewState["xpsclcode"] != null)
                {
                    string xpsclcode1 = xpsclcode.Text.Trim().ToString();
                    string xdesc1 = xdesc.Text.Trim().ToString();

                    string url =
                        string.Format(
                            "~/forms/academic/hrm/payroll/prpayscaldt.aspx?subnav=myDropdown21&link=LinkButton21&xid=205001001&xpsclcode={0}&xdesc={1}",
                            xpsclcode1, xdesc1);
