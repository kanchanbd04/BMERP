<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="pracc.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.pracc" %>
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Actual Query</span>
                    </div>
                </div>
                                    ...
                                    <div style="display: inline-block; width: 500px; font-size: 14px; vertical-align: top; color: #0000ff;">
                                        <table>
                                            ...
                                            <tr>
                                                ...
                                                <td>:</td>
                                                <td>
                                                   <asp:TextBox ID="xyear" runat="server" Text="0"></asp:TextBox>
                                                </td>
                                            </tr>
                                           ...
                                           <tr>
                                                ...
                                                <td>:</td>
                                                <td>
                                                   <asp:TextBox ID="xper" runat="server" Text="0"></asp:TextBox>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>:</td>
                                                <td>
                                                    <asp:TextBox ID="xpaydate" runat="server" ReadOnly="True" ></asp:TextBox>
                                                </td>
                                            </tr>
                                             ...
                                             <tr>
                                                ...
                                                <td>:</td>
                                                <td>
                                                    <asp:TextBox ID="xremarks" runat="server" TextMode="MultiLine"></asp:TextBox>
                                                </td>
                                            </tr>
                                            ...
                                            <asp:GridView ID="dgvcollectionew" runat="server" AutoGenerateColumns="False" ShowFooter="False"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="xyear" HeaderText="Year" 
                                                     ...
                                                     <asp:BoundField DataField="xper" HeaderText="Period" 
                                                        ItemStyle-Width="100px" ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="pad5"/>

                                                    <asp:TemplateField HeaderText="Payment Date">
                                                        <ItemStyle Width="150px" HorizontalAlign="Center" />
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="xpaydate" runat="server" Text='<%# Bind("xpaydate", "{0:dd/MM/yyyy}") %>' CssClass="_gridrow_link"
                                                                OnClick="FillControl"></asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>

                                                    <asp:BoundField DataField="xremarks" HeaderText="Payment Description" 
