...
{
    public partial class prpaypkg : System.Web.UI.Page
    {
        private void fnButtonState()
        {
            ...
            {
                //xsup.Text = ViewState["xemp"].ToString();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!IsPostBack)
                {
                    ...
                    //    string str = "SELECT  * " +
                    //                 "FROM pradvh where zid=@zid  and xemp=@xemp and xpaycode=@xpaycode ";
       ...
       xemp.Text.ToString().Trim() + "' ");
                ...
                xstatusemp.Text = zglobal.fnGetValue("xstatusemp", "hrmst",
       "zid=" + Convert.ToInt32(Convert.ToString(HttpContext.Current.Session["business"])) + " and xemp='" +
       xemp.Text.ToString().Trim() + "' ");
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            //    {
            //        rtnMessage = rtnMessage + "<li>Loan Type</li>";
            //        isValid = false;
            //    }

            //    //if (xdateexp.Text == "" || xdateexp.Text == string.Empty || xdateexp.Text == "[Select]")
            //    //{
            //    //    rtnMessage = rtnMessage + "<li>Expiration Date</li>";
            //    //    isValid = false;
            //    //}
            ...
            //    if (chk_emp == "")
            //    {
            //        message.InnerHtml = "Not a valid Employee.";
            //        message.Style.Value = zglobal.warningmsg;
            //        return;
            //    }
            ...
            //            con.Open();
            //            string query =
            //                "SELECT * FROM pradvh WHERE zid=@zid AND xemp=@xemp and xpaycode=@xpaycode ";

            //            SqlDataAdapter da = new SqlDataAdapter(query, con);

            //            da.SelectCommand.Parameters.AddWithValue("@zid", _zid);
            //            da.SelectCommand.Parameters.AddWithValue("@xemp", xemp.Text.Trim().ToString());
            ...
            //            if (tempTable.Rows.Count > 0)
            //            {
            //                ViewState["xemp"] = xemp.Text.ToString().Trim();
            //            }
            //            else
            //            {
            //                ViewState["xemp"] = null;
            ...
            //                string query =
            //                   "INSERT INTO pradvh (zid,ztime,xemp,xpaycode,zemail) " +
            //                   "VALUES(@zid,@ztime,@xemp,@xpaycode,@zemail) ";
            ...
            //                //xremark1 = xremarks.Text.ToString().Trim();
            //                //xper1 = Convert.ToInt32(xper.Text.ToString().Trim());
            //                //xyear1 = Convert.ToInt32(xyear.Text.ToString().Trim());
            ...
            //                cmd.Parameters.AddWithValue("@xpaycode", xpaycode.Text.Trim().ToString());
            ...
            //            //    query = "UPDATE prpay SET zutime=@zutime,xremarks=@xremarks, xyear=@xyear,xper=@xper,xemail=@xemail " +
        ...
        private void fnFillGrid2()
        {
            ...
            //        con.Open();
            //        string query =
            //           "SELECT Top " + Int32.Parse(_gridrow.Text.Trim().ToString()) + " xrow,xinstalno,xadvance,xreturn,xpayamt," +
            //           "(select xemp + '- (' + xname + ')' from hrmst where zid=prloanview.zid and xemp=prloanview.xemp) as spanemp " +
            //           "FROM prloanview WHERE zid=@zid and xemp=@xemp and xpaycode=@xpaycode " +
            ...
            //        da1.SelectCommand.Parameters.AddWithValue("@xpaycode", xpaycode.Text.Trim().ToString());
            ...
            //            spanemp.Text = tempTable.Rows[0]["spanemp"].ToString();
            //        }
            //        else
            //        {
            ...
            //        con.Open();
            //        string query =
            //           "SELECT Top " + Int32.Parse(_gridrow1.Text.Trim().ToString()) + " xemp,xpaycode," +
            //           "(select xname from hrmst where zid=pradvh.zid and xemp=pradvh.xemp) as xname, " +
            //           "(select xdesc from prpayhead where zid=pradvh.zid and xpaycode=pradvh.xpaycode) as xdesc " +
            //           "FROM pradvh WHERE zid=@zid  " +
            //           "order by xemp,xpaycode ";
        ...
        protected void FillControl(object sender, EventArgs e)
        {
            ...
            //    string xpaycode1 = row.Cells[2].Text.ToString().Trim();

            //    fnFillControl(xemp1,xpaycode1);
        ...
        protected void FillControl1(object sender, EventArgs e)
        {
            ...
            //            ////string xempcat1 = row.Cells[0].Text.ToString().Trim();
            //            //string xpaydate1 = ((LinkButton)sender).Text;

            //            //fnFillControl(xpaydate1);

            //            string xemp1 = xemp.Text.Trim().ToString();
            //            string xpaycode1 = xpaycode.Text.Trim().ToString();
        ...
        protected void FillControl2(object sender, EventArgs e)
        {
            ...
            //    if (xemp.Text.Trim().ToString() != String.Empty && xpaycode.Text.Trim().ToString() != String.Empty)
            //    {
            //        fnFillControl(xemp1, xpaycode1);
            //    }
            //    else
            //    {
            //        message.InnerHtml = "Invalid Parameter.";
        ...
        private void fnFillControl(string xemp1,string xpaycode1)
        {
        //    message.InnerHtml = "";
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            //            int xstatus1 = zglobal.fnGetValueInt("count(xrow)", "pradvd",
            //             "zid=" + _zid + " AND xemp='" + xemp.Text.ToString().Trim() + "' AND xpaycode='" + xpaycode.Text.Trim().ToString() + "'");
            //            if (xstatus1 >0)
            //            {
            //                message.InnerHtml = "Detail Exists; Cannot Delete.";
            //                message.Style.Value = zglobal.warningmsg;
            //                return;
            //            }
            ...
            //         //"zid=" + _zid + " AND xpaydate>='" + DateTime.ParseExact(xpaydate.Text.Trim().ToString(), "dd/MM/yyyy", CultureInfo.InvariantCulture) + "' and xflags='1'");
            ...
            //                    string query = "DELETE FROM pradvh WHERE zid=" + _zid + " AND  " +
            //                                   "xemp='" + xemp.Text.Trim().ToString() + "' and xpaycode='"+ xpaycode.Text.Trim().ToString() +"'";
            //                    cmd.Parameters.Clear();

            //                    cmd.CommandText = query;
            //                    cmd.Parameters.AddWithValue("@zid", _zid);
            //                    //cmd.Parameters.AddWithValue("@xsup", ViewState["xemp"].ToString());
            //                    cmd.ExecuteNonQuery();

            //                    //query = "DELETE FROM prmsg WHERE zid=" + _zid + " AND " +
            //                    //        "xpaydate='" + DateTime.ParseExact(xpaydate.Text.Trim().ToString(), "dd/MM/yyyy", CultureInfo.InvariantCulture) + "'";
            //                    //cmd.Parameters.Clear();
            ...
            //                    //query = "DELETE FROM prpay WHERE zid=" + _zid + " AND " +
            //                    //        "xpaydate='" + DateTime.ParseExact(xpaydate.Text.Trim().ToString(), "dd/MM/yyyy", CultureInfo.InvariantCulture) + "'";
            //                    //cmd.Parameters.Clear();
       ...
       xemp.Text.ToString().Trim() + "' ");
        ...
        //            string xemp1 = xemp.Text.Trim().ToString();
        //            string xpaycode1 = xpaycode.Text.Trim().ToString();
        //            string xrow1 = zglobal.fnGetValue("coalesce(max(xrow),10) ", "pradvd",
        //"zid=" + Convert.ToInt32(Convert.ToString(HttpContext.Current.Session["business"])) + " and xemp='" +
        //xemp1 + "' and xpaycode='"+ xpaycode1 +"'"); ;
