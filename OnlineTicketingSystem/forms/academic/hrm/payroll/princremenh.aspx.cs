...
{
    public partial class princremenh : System.Web.UI.Page
    {
        private void fnButtonState()
        {
            if (ViewState["xpsclcode"] == null)
            {
            ...
            {
                //xsup.Text = ViewState["xpsclcode"].ToString();
                ...
                string xstatus1 = zglobal.fnGetValue("xpostflag", "princremenh",
                    "zid=" + _zid + " AND xemp='" + xemp.Text.ToString().Trim() + "' AND xpaydate='" +
                    DateTime.ParseExact(xpaydate.Text.ToString().Trim(), "dd/MM/yyyy",
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!IsPostBack)
                {
                    ...
                    //xprsign.Items.Clear();
                    //xprsign.Items.Add("");
                    //xprsign.Items.Add("1-Pay");
                    //xprsign.Items.Add("2-Deduct");
                    //xprsign.Items.Add("3-Total Pay");
                    //xprsign.Items.Add("4-Total Deduction");
                    //xprsign.Items.Add("5-Net Pay");
                    //xprsign.Text = "";

                    //xoption.Items.Clear();
                    //xoption.Items.Add("");
                    //xoption.Items.Add("Advance");
                    //xoption.Items.Add("None");
                    //xoption.Text = "";

                    xsites.Items.Clear();
                    xsites.Items.Add("Yes");
                    xsites.Items.Add("No");
                    xsites.Text = "No";

                    xnewdesig_tr.Visible = false;
                    xpsclcode_tr.Visible = false;

                    zglobal.fnGetComboDataCD("Designation", xnewdesig);
                    ...
                    if (xemp1 != "" && xpaydate1!="")
                    {
                        DateTime xpaydate11 = DateTime.ParseExact(xpaydate1, "dd/MM/yyyy", CultureInfo.InvariantCulture);

                        fnFillControl(xemp1,xpaydate11);
       ...
       "xemp='" + xemp.Text.ToString().Trim()+ "'  ");
                ...
                xdept.Text = zglobal.fnGetValue("xdept", "hrmst",
       "zid=" + Convert.ToInt32(Convert.ToString(HttpContext.Current.Session["business"])) + " and " +
       "xemp='" + xemp.Text.ToString().Trim() + "'  ");

                xdesig.Text = zglobal.fnGetValue("xdesig", "hrmst",
       "zid=" + Convert.ToInt32(Convert.ToString(HttpContext.Current.Session["business"])) + " and " +
       "xemp='" + xemp.Text.ToString().Trim() + "'  ");

                xlocation.Text = zglobal.fnGetValue("xlocation", "hrmst",
       "zid=" + Convert.ToInt32(Convert.ToString(HttpContext.Current.Session["business"])) + " and " +
       "xemp='" + xemp.Text.ToString().Trim() + "'  ");

                xoldpsclcode.Text = zglobal.fnGetValue("xpsclcode", "hrmst",
       "zid=" + Convert.ToInt32(Convert.ToString(HttpContext.Current.Session["business"])) + " and " +
       "xemp='" + xemp.Text.ToString().Trim() + "'  ");

                xempid.Text = xemp.Text + "- " + xname.Text;

              //  tmpdesc.Text = zglobal.fnGetValue("xdesc", "prpayscal",
              //"zid=" + Convert.ToInt32(Convert.ToString(HttpContext.Current.Session["business"])) + " and xpsclcode='" + xpsclcode.Text.ToString().Trim() + "' ");

                //xsubcbtitle.Text = zglobal.fnGetValue("xdesc", "glmst",
                // "zid=" + Convert.ToInt32(Convert.ToString(HttpContext.Current.Session["business"])) + " and xacc='" + xacc.Text.ToString().Trim() + "' ");
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    rtnMessage = rtnMessage + "<li>Increment Effective Date</li>";
                    isValid = false;
                }
                ...
                DateTime xpaydate1 = xpaydate.Text.Trim() != string.Empty ? DateTime.ParseExact(xpaydate.Text.Trim().ToString(), "dd/MM/yyyy", CultureInfo.InvariantCulture) : DateTime.Now;
                ...
                string chk_emp = zglobal.fnGetValue("xemp", "hrmst",
                     "zid=" + _zid + "  and xemp='" + xemp.Text.ToString().Trim() + "'");

                if (chk_emp == "")
                {
                    message.InnerHtml = "Invalid Employee Code<br>Pick from the list.";
                    message.Style.Value = zglobal.warningmsg;
                    return;
                }
                ...
                int xyearq1 = tempyear;
                int xperend1 = tempper;

                ////fnCheckRow();
                string xstatus2 = "";
                if (ViewState["xpsclcode"] != null)
                {
                    xstatus2 = zglobal.fnGetValue("xpostflag", "princremenh",
                          "zid=" + _zid + " AND xpaydate='" + xpaydate1 + "' AND xemp='" + xemp.Text.ToString().Trim() + "'");
                    if (xstatus2 != "")
                    {
                ...
                string xdept1 = "";
                string xdesig1 = "";
                string xnewlocation1 = "";
                string xoldpsclcode1 = "";
                string xnewsec1 = "";
                string xnewsubsec1 = "";
                string xnewempcat1 = "";
                string xnewzone1 = "";
                ...
                using (SqlConnection con = new SqlConnection(zglobal.constring))
                {
                    using (DataSet dts = new DataSet())
                    {
                        con.Open();
                        string query =
                            "SELECT * FROM princremenh WHERE zid=@zid AND xpaydate=@xpaydate and xemp=@xemp ";
                        ...
                        if (tempTable.Rows.Count > 0)
                        {
                            ViewState["xpsclcode"] = xemp.Text.ToString().Trim();
                        }
                        else
                        {
                            ViewState["xpsclcode"] = null;
                ...
                using (TransactionScope tran = new TransactionScope())
                {
                    ...
                    if (ViewState["xpsclcode"] == null)
                    {
                        ...
                        //        con.Open();
                        //        string query =
                        //   "SELECT * FROM prlvyear WHERE zid=@zid AND xempcat=@xempcat and xyear=@xyear ";

                        //        SqlDataAdapter da = new SqlDataAdapter(query, con);

                        //        da.SelectCommand.Parameters.AddWithValue("@zid", _zid);
                        //        da.SelectCommand.Parameters.AddWithValue("@xempcat", xempcat.Text.ToString().Trim());
                        //        da.SelectCommand.Parameters.AddWithValue("@xyear", xyear.Text.ToString().Trim());
                        //        da.SelectCommand.Parameters.AddWithValue("@xdateeff", xdateeff1);
                        //        da.SelectCommand.Parameters.AddWithValue("@xdateexp", xdateexp1);
                        ...
                        using (SqlConnection conn = new SqlConnection(zglobal.constring))
                        {
                            ...
                            string query =
                               "INSERT INTO princremenh (zid,ztime,xemp,xpaydate,xremarks,xref,xsites,xnewdept,xnewdesig,xlocation,xpostflag,xsubsec,xsec,xpsclcode,xdept,xdesig,xnewlocation,xoldpsclcode,xnewsec,xnewsubsec,xnewempcat,xnewzone,xyearq,xperend,xnaic,zemail) " +
                               "VALUES(@zid,@ztime,@xemp,@xpaydate,@xremarks,@xref,@xsites,@xnewdept,@xnewdesig,@xlocation,@xpostflag,@xsubsec,@xsec,@xpsclcode,@xdept,@xdesig,@xnewlocation,@xoldpsclcode,@xnewsec,@xnewsubsec,@xnewempcat,@xnewzone,@xyearq,@xperend,@xnaic,@zemail) ";
                            ...
                            xref1 = xref.Text.ToString().Trim();
                            xsites1 = xsites.Text.ToString().Trim();
                            xnewdesig1 = xnewdesig.Text.ToString().Trim();
                            xlocation1 = xlocation.Text.ToString().Trim();
                            xpsclcode1 = xpsclcode.Text.ToString().Trim();
                            xdept1 = xdept.Text.ToString().Trim();
                            xdesig1 = xdesig.Text.ToString().Trim();
                            xoldpsclcode1 = xoldpsclcode.Text.ToString().Trim();
                            xnaic1 = "No";
                            ...
                            cmd.Parameters.AddWithValue("@xsites", xsites1);
                            cmd.Parameters.AddWithValue("@xnewdept", xnewdept1);
                            cmd.Parameters.AddWithValue("@xnewdesig", xnewdesig1);
                            cmd.Parameters.AddWithValue("@xlocation", xlocation1);
                            cmd.Parameters.AddWithValue("@xpostflag", xpostflag1);
                            cmd.Parameters.AddWithValue("@xsubsec", xsubsec1);
                            ...
                            cmd.Parameters.AddWithValue("@xnewlocation", xnewlocation1);
                            cmd.Parameters.AddWithValue("@xoldpsclcode", xoldpsclcode1);
                            cmd.Parameters.AddWithValue("@xnewsec", xnewsec1);
                            cmd.Parameters.AddWithValue("@xnewsubsec", xnewsubsec1);
                            cmd.Parameters.AddWithValue("@xnewempcat", xnewempcat1);
                            cmd.Parameters.AddWithValue("@xnewzone", xnewzone1);
                            cmd.Parameters.AddWithValue("@xyearq", xyearq1);
                            cmd.Parameters.AddWithValue("@xperend", xperend1);
                            cmd.Parameters.AddWithValue("@xnaic", xnaic1);
                            cmd.ExecuteNonQuery();
                        }
                    }
                    ...
                    using (SqlConnection conn = new SqlConnection(zglobal.constring))
                    {
                        ...
                        if (xsupp == "")
                        {
                            ...
                            query = "UPDATE princremenh SET zutime=@zutime,xref=@xref, xsites=@xsites,xnewdesig=@xnewdesig,xpsclcode=@xpsclcode,xemail=@xemail " +
        ...
        private void fnFillGrid2()
        {
            ...
            using (SqlConnection con = new SqlConnection(zglobal.constring))
            {
                using (DataSet dts1 = new DataSet())
                {
                    con.Open();
                    string query =
                         "SELECT Top " + Int32.Parse(_gridrow.Text.Trim().ToString()) + " xemp,xdept,xpaydate,xsites,xlocation,xpostflag,(select xname from hrmst where zid=princremenh.zid and xemp=princremenh.xemp) as xname " +
                       "FROM princremenh WHERE zid=@zid and xemp=@xemp " +
                       "order by xemp,xpaydate ";

                    SqlDataAdapter da1 = new SqlDataAdapter(query, con);

                    da1.SelectCommand.Parameters.AddWithValue("@zid", _zid);
                    da1.SelectCommand.Parameters.AddWithValue("@xemp", xemp.Text.ToString().Trim());
            ...
            using (SqlConnection con = new SqlConnection(zglobal.constring))
            {
                using (DataSet dts1 = new DataSet())
                {
                    con.Open();
                    string query =
                         "SELECT Top " + Int32.Parse(_gridrow1.Text.Trim().ToString()) + " xemp,xdept,xpaydate,xsites,xlocation,xpostflag,(select xname from hrmst where zid=princremenh.zid and xemp=princremenh.xemp) as xname " +
                       "FROM princremenh WHERE zid=@zid and xpostflag='' " +
                       "order by xemp,xpaydate ";
                    ...
                    {
                        dgvcollectionpaid.DataSource = null;
                        dgvcollectionpaid.DataBind();
                    }
            ...
            using (SqlConnection con = new SqlConnection(zglobal.constring))
            {
                using (DataSet dts1 = new DataSet())
                {
                    con.Open();
                    string query =
                         "SELECT Top " + Int32.Parse(TextBox2.Text.Trim().ToString()) + " xemp,xdept,xpaydate,xsites,xlocation,xpostflag,(select xname from hrmst where zid=princremenh.zid and xemp=princremenh.xemp) as xname " +
                       "FROM princremenh WHERE zid=@zid and xpostflag<>'' " +
                       "order by xemp,xpaydate ";
            ...
            using (SqlConnection con = new SqlConnection(zglobal.constring))
            {
                using (DataSet dts1 = new DataSet())
                {
                    con.Open();
                    string query =
                         "SELECT Top " + Int32.Parse(TextBox1.Text.Trim().ToString()) + " xpaycode,xamount, xsign," +
        ...
        protected void FillControl(object sender, EventArgs e)
        {
            try
            {
                ...
                //string xempcat1 = row.Cells[0].Text.ToString().Trim();
                string xemp1 = ((LinkButton)sender).Text;
                DateTime xpaydate1 = DateTime.ParseExact(row.Cells[3].Text.ToString().Trim(), "dd/MM/yyyy", CultureInfo.InvariantCulture);

                fnFillControl(xemp1, xpaydate1);
        ...
        private void fnFillControl(string xemp1, DateTime xpaydate1)
        {
            message.InnerHtml = "";
            ...
            string str = "SELECT  *,(select xname from hrmst where zid=princremenh.zid and xemp=princremenh.xemp) as xname " +
                         "FROM princremenh where zid=@zid  and xemp=@xemp and xpaydate=@xpaydate ";
            ...
            xlocation.Text = dttemp.Rows[0]["xlocation"].ToString();
            xoldpsclcode.Text = dttemp.Rows[0]["xoldpsclcode"].ToString();
            xpaydate.Text = Convert.ToDateTime(dttemp.Rows[0]["xpaydate"]).ToString("dd/MM/yyyy");
            xref.Text = dttemp.Rows[0]["xref"].ToString();
            xsites.Text = dttemp.Rows[0]["xsites"].ToString();
            xpostflag.Text = dttemp.Rows[0]["xpostflag"].ToString();
            ...
            xyearq.Text = dttemp.Rows[0]["xyearq"].ToString();
            xperend.Text = dttemp.Rows[0]["xperend"].ToString();
            //xdigit.Text = dttemp.Rows[0]["xdigit"].ToString();
            //xlast.Text = dttemp.Rows[0]["xlast"].ToString();
            //xoption.Text = dttemp.Rows[0]["xoption"].ToString();
            //xday.Text = dttemp.Rows[0]["xday"].ToString();
            //xacc.Text = dttemp.Rows[0]["xacc"].ToString();
            //xdateeff.Text = Convert.ToDateTime(dttemp.Rows[0]["xdateeff"]).ToString("dd/MM/yyyy");
            //xdateexp.Text = Convert.ToDateTime(dttemp.Rows[0]["xdateexp"]).ToString("dd/MM/yyyy");
   ...
   "xemp='" + xemp.Text.ToString().Trim() + "'  ");
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            try
            {
                DateTime xpaydate1 = DateTime.ParseExact(xpaydate.Text.ToString().Trim(), "dd/MM/yyyy", CultureInfo.InvariantCulture);
                int _zid = Convert.ToInt32(Convert.ToString(HttpContext.Current.Session["business"]));
                message.InnerText = "";
                //fnCheckRow();
                    ...
                    if (txtconformmessageValue1.Value == "Yes")
                    {
                        ...
                        using (TransactionScope tran = new TransactionScope())
                        {
                            using (SqlConnection conn = new SqlConnection(zglobal.constring))
                            {
                                ...
                                string query = "DELETE FROM princrementd WHERE zid=" + _zid + " AND xemp='" + xemp.Text.ToString().Trim() + "' and xpaydate='"+xpaydate1+"' ";
                                cmd.Parameters.Clear();

                                cmd.CommandText = query;
                                cmd.Parameters.AddWithValue("@zid", _zid);
                                //cmd.Parameters.AddWithValue("@xsup", ViewState["xpsclcode"].ToString());
                                cmd.ExecuteNonQuery();

                                query = "DELETE FROM princremenh WHERE zid=" + _zid + " AND xemp='" + xemp.Text.ToString().Trim() + "' and xpaydate='" + xpaydate1 + "' ";
                                cmd.Parameters.Clear();
            ...
            try
            {
                ...
                if (ViewState["xpsclcode"] != null)
                {
                    if (txtconformmessageValue.Value == "Yes")
                    {
                        ...
                        string xstatus23 = zglobal.fnGetValue("xemp", "princrementd",
                         "zid=" + _zid + " AND xpaydate='" + xpaydate1 + "' AND xemp='" + xemp.Text.ToString().Trim() + "'");
                        if (xstatus2 != "")
                        {
                            message.InnerHtml = "Detail has no records. Can't confirm.";
                            message.Style.Value = zglobal.warningmsg;
                            return;
                        }
                        ...
                        using (TransactionScope tran = new TransactionScope())
                        {
                            using (SqlConnection conn = new SqlConnection(zglobal.constring))
                            {
                                ...
                                using (SqlConnection con = new SqlConnection(zglobal.constring))
                                {
                                    using (DataSet dts1 = new DataSet())
                                    {
                                        ...
                                        if (tempTable.Rows.Count > 0)
                                        {
                                            ...
                                            {
                                                decimal xamount11 = 0 + Convert.ToDecimal(row["xamount"].ToString()) * Convert.ToDecimal(row["xsign"].ToString());
                                                decimal xamtpaid1 = Convert.ToDecimal(row["xamtpaid"].ToString());

                                                string paycd = zglobal.fnGetValue("xamount", "prpaymentdt",
                                                         "zid=" + _zid + " AND xpaycode='" + row["xpaycode"].ToString() + "' AND xemp='" + xemp.Text.ToString().Trim() + "'");

                                                decimal xamount1 = (paycd == "" ? 0 : Convert.ToDecimal(paycd)) + xamount11;

                                                if (paycd != "")
                                                {
                                                    query1 = "UPDATE prpaymentdt SET zutime=@zutime,xemail=@xemail,xamount=@xamount " +
                                                             "WHERE zid=@zid AND xemp=@xemp AND xpaycode=@xpaycode ";
                                                    ...
                                                    cmd.Parameters.AddWithValue("@xemp", xemp.Text.Trim().ToString());
                                                    cmd.Parameters.AddWithValue("@xpaycode", row["xpaycode"].ToString());
                                                    cmd.ExecuteNonQuery();

                                                }
                                                else
                                                {
                                                    query1 = "INSERT INTO prpaymentdt (zid,ztime,zemail,xemp,xpaycode,xamount) " +
                                                             "VALUES(@zid,@ztime,@zemail,@xemp,@xpaycode,@xamount) ";
                                ...
                                {
                                    query =
                                   "UPDATE hrmst SET xempnature = 'Regular', xdesig=@xdesig,xpsclcode=@xpsclcode " +
                                   "WHERE zid=@zid AND xemp=@xemp ";
                                    ...
                                    cmd.Parameters.AddWithValue("@zid", _zid);
                                    cmd.Parameters.AddWithValue("@xemp", xemp.Text.Trim().ToString());
                                    cmd.Parameters.AddWithValue("@xdesig", xnewdesig.Text.ToString());
                                    cmd.Parameters.AddWithValue("@xpsclcode", xpsclcode.Text.ToString().Trim());
                                    cmd.ExecuteNonQuery();
                                }

                                query =
                                    "UPDATE princremenh SET xpostflag='Confirmed',xemail1=@xemail1 " +
                                    "WHERE zid=@zid AND xemp=@xemp and xpaydate=@xpaydate ";
                                cmd.Parameters.Clear();
                                ...
                                cmd.Parameters.AddWithValue("@zid", _zid);
                                cmd.Parameters.AddWithValue("@xemp", xemp.Text.Trim().ToString());
                                cmd.Parameters.AddWithValue("@xemail1", xpaidby);
                                cmd.Parameters.AddWithValue("@xpaydate", xpaydate1);
                                cmd.ExecuteNonQuery();
                            }
                        ...
                        //fnFillControl(xemp.Text.ToString().Trim(),xpaydate1);

                        message.InnerHtml = "<font color=blue size=+1><strong>Approved Successfully</strong></font>";
                        message.Style.Value = zglobal.successmsg;
                    }
                }
                else
        ...
        protected void btnDetails_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (ViewState["xpsclcode"] != null)
                {
                    ...
                    string xpaydate1 = xpaydate.Text.ToString().Trim();
                    string xname1 = xname.Text.ToString().Trim();

                    string url =
                        string.Format(
                            "~/forms/academic/hrm/payroll/princrementd.aspx?subnav=myDropdown14&link=LinkButton14&xid=165005&xemp={0}&xpaydate={1}&xname={2}",
                            xemp1, xpaydate1,xname1);
        ...
        protected void xsites_OnSelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                message.InnerHtml = "";

                string xsites1 = xsites.Text.ToString();

                if (xsites1 == "Yes")
                {
                    xnewdesig_tr.Visible = true;
                    xpsclcode_tr.Visible = true;
                }
                else
                {
                    xnewdesig_tr.Visible = false;
        ...
        //protected void xemp_OnTextChanged(object sender, EventArgs e)
        //{
        //    try
        //    {
        //        message.InnerHtml = "";
