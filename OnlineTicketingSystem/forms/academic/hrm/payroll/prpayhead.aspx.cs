...
{
    public partial class prpayhead : System.Web.UI.Page
    {
            ...
            try
            {
                if (!IsPostBack)
                {
                    ...
                    if (xpaycode1 != "" )
                    {
                        ...
                        string str = "SELECT  * " +
                                     "FROM prpayhead where zid=@zid  and xpaycode=@xpaycode ";
                        ...
                        xprsign.Text = dttemp.Rows[0]["xprsign"].ToString();
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    rtnMessage = rtnMessage + "<li>Payment Code</li>";
                    isValid = false;
                }
                if (xdesc.Text == "" || xdesc.Text == string.Empty || xdesc.Text == "[Select]")
                {
                    rtnMessage = rtnMessage + "<li>Description</li>";
                    isValid = false;
                }
                if (xprsign.Text == "" || xprsign.Text == string.Empty || xprsign.Text == "[Select]")
                {
                ...
                using (SqlConnection con = new SqlConnection(zglobal.constring))
                {
                    using (DataSet dts = new DataSet())
                    {
                        con.Open();
                        string query =
                            "SELECT * FROM prpayhead WHERE zid=@zid AND xpaycode=@xpaycode ";

                        SqlDataAdapter da = new SqlDataAdapter(query, con);

                        da.SelectCommand.Parameters.AddWithValue("@zid", _zid);
                        da.SelectCommand.Parameters.AddWithValue("@xpaycode", xpaycode.Text.ToString().Trim());
                        ...
                        if (tempTable.Rows.Count > 0)
                        {
                            ViewState["xpaycode"] = xpaycode.Text.ToString().Trim();
                        }
                        else
                        {
                            ViewState["xpaycode"] = null;
                ...
                using (TransactionScope tran = new TransactionScope())
                {
                    ...
                    if (ViewState["xpaycode"] == null)
                    {
                        ...
                        using (SqlConnection conn = new SqlConnection(zglobal.constring))
                        {
                            ...
                            string query =
                               "INSERT INTO prpayhead (zid,ztime,xpaycode,xdesc,xprsign,xdigit,xlast,xoption,xday,zemail,xacc,xsign) " +
                               "VALUES(@zid,@ztime,@xpaycode,@xdesc,@xprsign,@xdigit,@xlast,@xoption,@xday,@zemail,@xacc,@xsign) ";
                            ...
                            xpaycode1 = xpaycode.Text.ToString().Trim();
                            xdesc1 = xdesc.Text.ToString().Trim();
                            xprsign1 = xprsign.Text.ToString().Trim();
                            xdigit1 = Convert.ToInt32(xdigit.Text.ToString().Trim());
                            xlast1 = xlast.Text.ToString().Trim();
                            xoption1 = xoption.Text.ToString().Trim();
                            xday1 = Convert.ToInt32(xday.Text.ToString().Trim());
                            xacc1 = xacc.Text.ToString().Trim();

                            if (xprsign.Text == "1-Pay")
                            {
                                xsign1 = 1;
                            }
                            else if (xprsign.Text == "2-Deduct")
                            {
                                xsign1 = -1;
                            }
                            else
                            ...
                            cmd.Parameters.AddWithValue("@xprsign", xprsign1);
                            cmd.Parameters.AddWithValue("@xdigit", xdigit1);
                            cmd.Parameters.AddWithValue("@xlast", xlast1);
                            cmd.Parameters.AddWithValue("@xoption", xoption1);
                    ...
                    using (SqlConnection conn = new SqlConnection(zglobal.constring))
                    {
                        ...
                        if (xsupp == "")
                        {
                            ...
                            query = "UPDATE prpayhead SET zutime=@zutime,xdesc=@xdesc, xprsign=@xprsign,xdigit=@xdigit,xlast=@xlast,xoption=@xoption,xday=@xday,xacc=@xacc,xsign=@xsign,xemail=@xemail " +
                                   "WHERE zid=@zid AND xpaycode=@xpaycode ";
        ...
        private void fnFillGrid2()
        {
            ...
            using (SqlConnection con = new SqlConnection(zglobal.constring))
            {
                using (DataSet dts1 = new DataSet())
                {
                    con.Open();
                    string query =
                         "SELECT Top " + Int32.Parse(_gridrow.Text.Trim().ToString()) + " xpaycode,xdesc,xprsign,xoption " +
                       "FROM prpayhead WHERE zid=@zid " +
                       "order by xpaycode ";
        ...
        private void fnFillControl(string xpaycode1)
        {
            message.InnerHtml = "";
                    ...
                    if (txtconformmessageValue1.Value == "Yes")
                    {
                        ...
                        using (TransactionScope tran = new TransactionScope())
                        {
                            using (SqlConnection conn = new SqlConnection(zglobal.constring))
                            {
                                ...
                                string query = "DELETE FROM prpayhead WHERE zid=" + _zid + " AND xpaycode='" + xpaycode.Text.ToString().Trim() + "' ";
                                cmd.Parameters.Clear();
        ...
        protected void btnDetails_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (ViewState["xpaycode"] != null)
                {
                    ...
                    string url =
                        string.Format(
                            "~/forms/academic/hrm/payroll/prpayheaddt.aspx?subnav=myDropdown21&link=LinkButton21&xid=205001005&xpaycode={0}&xdesc={1}",
                            xpaycode1, xdesc1);
