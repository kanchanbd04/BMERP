...
{
    public partial class prlvpolicy : System.Web.UI.Page
    {
        ...
        public void fnRegisterPostBack()
        {
            ...
            {
                LinkButton lnkFull1 = row.FindControl("xleave") as LinkButton;
                ...
                using (TransactionScope tran = new TransactionScope())
                {
                    ...
                    if (ViewState["xsup"] == null)
                    {
                        ...
                        using (SqlConnection conn = new SqlConnection(zglobal.constring))
                        {
                            ...
                            string query =
                               "INSERT INTO prlvpolicy (zid,ztime,xempcat,xyear,xleave,xleavealc,xefffrom,xcalcday,xleavecfd,xleavecfy,xmaxleave,xminleave,xmaxencash,xminencash, " +
                               "xmaxoffers,xstatus,xfstslabday,xfstslabpay,xsndslabday,xsndslabpay,xtrdslabday,xtrdslabpay,xcfleave,zemail) " +
                               "VALUES(@zid,@ztime,@xempcat,@xyear,@xleave,@xleavealc,@xefffrom,@xcalcday,@xleavecfd,@xleavecfy,@xmaxleave,@xminleave,@xmaxencash,@xminencash, " +
                               "@xmaxoffers,@xstatus,@xfstslabday,@xfstslabpay,@xsndslabday,@xsndslabpay,@xtrdslabday,@xtrdslabpay,@xcfleave,@zemail) ";
                            ...
                            xleave1 = xleave.Text.ToString();
                            xleavealc1 = Convert.ToInt32(xleavealc.Text.ToString().Trim());
                            xleavecfy1 = Convert.ToInt32(xleavecfy.Text.ToString().Trim());
                            xminleave1 = Convert.ToInt32(xminleave.Text.ToString().Trim());
                            xminencash1 = Convert.ToDecimal(xminencash.Text.ToString().Trim());
                            xleavecfd1 = Convert.ToInt32(xleavecfd.Text.ToString().Trim());
                            xmaxleave1 = Convert.ToInt32(xmaxleave.Text.ToString().Trim());
                            xmaxencash1 = Convert.ToDecimal(xmaxencash.Text.ToString().Trim());
                            ...
                            cmd.Parameters.AddWithValue("@xempcat", xempcat1);
                            cmd.Parameters.AddWithValue("@xyear", xyear1);
                            cmd.Parameters.AddWithValue("@xleave", xleave1);
                            cmd.Parameters.AddWithValue("@xleavealc", xleavealc1);
                            cmd.Parameters.AddWithValue("@xefffrom", xefffrom1);
                            cmd.Parameters.AddWithValue("@xcalcday", xcalcday1);
                            cmd.Parameters.AddWithValue("@xleavecfd", xleavecfd1);
                            cmd.Parameters.AddWithValue("@xleavecfy", xleavecfy1);
                            cmd.Parameters.AddWithValue("@xmaxleave", xmaxleave1);
                            cmd.Parameters.AddWithValue("@xminleave", xminleave1);
                            cmd.Parameters.AddWithValue("@xmaxencash", xmaxencash1);
                            cmd.Parameters.AddWithValue("@xminencash", xminencash1);
                            cmd.Parameters.AddWithValue("@xmaxoffers", xmaxoffers1);
                            cmd.Parameters.AddWithValue("@xstatus", xstatus1);
                            cmd.Parameters.AddWithValue("@xfstslabday", xfstslabday1);
                            cmd.Parameters.AddWithValue("@xfstslabpay", xfstslabpay1);
                            cmd.Parameters.AddWithValue("@xsndslabday", xsndslabday1);
                            cmd.Parameters.AddWithValue("@xsndslabpay", xsndslabpay1);
                            cmd.Parameters.AddWithValue("@xtrdslabday", xtrdslabday1);
                            cmd.Parameters.AddWithValue("@xtrdslabpay", xtrdslabpay1);
                            cmd.Parameters.AddWithValue("@xcfleave", xcfleave1);
                            cmd.ExecuteNonQuery();
                        }
                    }
                    ...
                    using (SqlConnection conn = new SqlConnection(zglobal.constring))
                    {
                        ...
                        if (xsupp == "")
                        {
                            ...
                            query = "UPDATE prlvpolicy SET zutime=@zutime,xleavealc=@xleavealc, xleavecfy=@xleavecfy, xminleave=@xminleave, xminencash=@xminencash, xleavecfd=@xleavecfd, " +
                                    "xmaxleave=@xmaxleave,xmaxencash=@xmaxencash, xemail=@xemail " +
                                    "WHERE zid=@zid AND xempcat=@xempcat AND xyear=@xyear and xleave=@xleave ";
            ...
            using (SqlConnection con = new SqlConnection(zglobal.constring))
            {
                using (DataSet dts1 = new DataSet())
                {
                    ...
                    string query =
                       ...
                       "FROM prlvpolicy WHERE zid=@zid and xempcat=@xempcat and xyear=@xyear " +
                       "order by xempcat,xyear,xleave ";

                    SqlDataAdapter da1 = new SqlDataAdapter(query, con);

                    da1.SelectCommand.Parameters.AddWithValue("@zid", _zid);
                    da1.SelectCommand.Parameters.AddWithValue("@xempcat", xempcat1);
        ...
        protected void FillControl(object sender, EventArgs e)
        {
            try
            {
                ...
                xempcat1 = Request.QueryString["xempcat"] != null ? Request.QueryString["xempcat"].ToString().Trim() : "";
                xyear1 = Request.QueryString["xyear"] != null ? Request.QueryString["xyear"].ToString().Trim() : "";
                string xleave1 = ((LinkButton)sender).Text;

                fnFillControl(xempcat1, xyear1, xleave1);
        ...
        private void fnFillControl(string xempcat1, string xyear1, string xleave1)
        {
            message.InnerHtml = "";
            ...
            string str = "SELECT  * " +
                         "FROM prlvpolicy where zid=@zid  and xempcat=@xempcat and xyear=@xyear and xleave=@xleave ";
            ...
            da.SelectCommand.Parameters.AddWithValue("@xempcat", xempcat1);
            da.SelectCommand.Parameters.AddWithValue("@xyear", xyear1);
            da.SelectCommand.Parameters.AddWithValue("@xleave", xleave1);
            da.Fill(dts, "tempztcode");
            ...
            xleavealc.Text = dttemp.Rows[0]["xleavealc"].ToString();
            xleavecfd.Text = dttemp.Rows[0]["xleavecfd"].ToString();
            xleavecfy.Text = dttemp.Rows[0]["xleavecfy"].ToString();
            xmaxleave.Text = dttemp.Rows[0]["xmaxleave"].ToString();
            xminleave.Text = dttemp.Rows[0]["xminleave"].ToString();
            xmaxencash.Text = dttemp.Rows[0]["xmaxencash"].ToString();
            xminencash.Text = dttemp.Rows[0]["xminencash"].ToString();
                    ...
                    if (txtconformmessageValue1.Value == "Yes")
                    {
                        ...
                        using (TransactionScope tran = new TransactionScope())
                        {
                            using (SqlConnection conn = new SqlConnection(zglobal.constring))
                            {
                                ...
                                string query = "DELETE FROM prlvpolicy WHERE zid=" + _zid + " AND xempcat='" + xempcat1 + "' AND xyear='" + xyear1 + "' and xleave='"+ xleave.Text.Trim().ToString() +"'";
                                cmd.Parameters.Clear();
        ...
        protected void btnBack_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string url =
                       string.Format(
                           "~/forms/academic/hrm/leave/prlvyear.aspx?subnav=myDropdown20&link=LinkButton20&xid=200001010&xempcat={0}&xyear={1}&xdateeff={2}&xdateexp={3}",
                           xempcat1, xyear1, xdateeff1, xdateexp1);
