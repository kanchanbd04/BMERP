<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="prlvpolicy.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.prlvpolicy" %>
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Leave Policy</span>
                    </div>
                </div>
                                        ...
                                        <div class="grid_body">
                                            <asp:GridView ID="dgvcollectionew" runat="server" AutoGenerateColumns="False" ShowFooter="False"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="xyear" HeaderText="Year"
                                                        ItemStyle-Width="100px" ItemStyle-HorizontalAlign="Center" />

                                                    <asp:TemplateField HeaderText="Leave Type">
                                                        <ItemStyle Width="120px" HorizontalAlign="Center" />
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="xleave" runat="server" Text='<%#Eval("xleave") %>' CssClass="_gridrow_link"
                                                                OnClick="FillControl"></asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>

                                                    <asp:BoundField DataField="xleavealc" HeaderText="Allocated Leave Day(s)" 
                                                        ItemStyle-Width="120px" ItemStyle-HorizontalAlign="Center" />

                                                    <asp:BoundField DataField="xleavecfd" HeaderText="Leave Carry Over Limit Day(s)" 
                                                        ItemStyle-Width="120px" ItemStyle-HorizontalAlign="Center" />
                                                    
                                                    <asp:BoundField DataField="xleavecfy" HeaderText="Max Carry Over for No. of Year" 
                                                        ItemStyle-Width="120px" ItemStyle-HorizontalAlign="Center" />
                                                    
                                                     <asp:BoundField DataField="xmaxleave" HeaderText="Day(s) on Leave at a stretch (Max)" 
                                                        ItemStyle-Width="120px" ItemStyle-HorizontalAlign="Center" />
                                                    
                                                    <asp:BoundField DataField="xminleave" HeaderText="Day(s) on Leave at a stretch (Min)" 
                                                        ItemStyle-Width="120px" ItemStyle-HorizontalAlign="Center" />
                                                    
                                                    <asp:BoundField DataField="xmaxencash" HeaderText="Maximum Encashment%" 
                                                        ItemStyle-Width="120px" ItemStyle-HorizontalAlign="Center" />
                                                    
                                                    <asp:BoundField DataField="xminencash" HeaderText="Minimum Encashment%" 
                                                        ItemStyle-Width="120px" ItemStyle-HorizontalAlign="Center" />
