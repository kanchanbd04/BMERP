...
{
    public partial class prlvapphirchy : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!IsPostBack)
                {
                    ...
                    xstatus.Items.Add("");
                    xstatus.Items.Add("Check");
                    xstatus.Items.Add("Pre approve");
                    xstatus.Items.Add("Approve");
                    xstatus.Items.Add("Check-Pre approve");
                    xstatus.Items.Add("Check-Approve");
                    xstatus.Items.Add("Pre approve-Approve");
                    xstatus.Items.Add("Check-Pre approve-Approve");
                ...
                xnameemp.Text = zglobal.fnGetValue("xusername", "ztuser",
        " xuser='" +
        xauthor.Text.ToString().Trim() + "' ");
        ...
        public void fnRegisterPostBack()
        {
            ...
            {
                LinkButton lnkFull1 = row.FindControl("xauthor") as LinkButton;
            ...
            if (xrow.Text != "")
            {
                using (SqlConnection con = new SqlConnection(zglobal.constring))
                {
                    using (DataSet dts = new DataSet())
                    {
                        con.Open();
                        string query =
                            "SELECT * FROM prlvapphirchy WHERE zid=@zid AND xrow=@xrow ";

                        SqlDataAdapter da = new SqlDataAdapter(query, con);

                        da.SelectCommand.Parameters.AddWithValue("@zid", _zid);
                        da.SelectCommand.Parameters.AddWithValue("@xrow", Convert.ToInt32(xrow.Text.ToString().Trim()));
            ...
            using (TransactionScope tran = new TransactionScope())
                {
                    ...
                    if (ViewState["xsup"] == null)
                    {
                        ...
                        using (SqlConnection conn = new SqlConnection(zglobal.constring))
                        {
                            ...
                            string query =
                               "INSERT INTO prlvapphirchy (ztime,zid,xrow,xdesig,xauthor,xdept,dumzid,xstatus,zemail) " +
                               "VALUES(@ztime,@zid,@xrow,@xdesig,@xauthor,@xdept,@dumzid,@xstatus,@zemail) ";


                            xrow11 = zglobal.GetMaximumIdInt("xrow", "prlvapphirchy");
                           // xrow.Text = xrow11.ToString();
                            ...
                            xdesig1 = xdesig.Text.ToString().Trim();
                            xauthor1 = xauthor.Text.ToString().Trim();
                            xdept1 = xdept.Text.ToString().Trim();
                            dumzid1 = _zid.ToString();
                            ...
                            cmd.Parameters.AddWithValue("@xauthor", xauthor1);
                            cmd.Parameters.AddWithValue("@xdept", xdept1);
                            cmd.Parameters.AddWithValue("@dumzid", Convert.ToInt32(dumzid1));
                    ...
                    using (SqlConnection conn = new SqlConnection(zglobal.constring))
                    {
                        ...
                        if (xsupp == "")
                        {
                            ...
                            query = "UPDATE prlvapphirchy SET zutime=@zutime,xemail=@xemail, xdesig=@xdesig, " +
                                    "xauthor=@xauthor,xdept=@xdept,dumzid=@dumzid,xstatus=@xstatus " +
                                   "WHERE zid=@zid AND xrow=@xrow ";
                            ...
                            cmd.Parameters.AddWithValue("@xrow", Convert.ToInt32(xrow.Text.ToString()));
                            cmd.Parameters.AddWithValue("@xdesig", xdesig1);
                            cmd.Parameters.AddWithValue("@xauthor", xauthor1);
                            cmd.Parameters.AddWithValue("@xdept", xdept1);
                            cmd.Parameters.AddWithValue("@dumzid", Convert.ToInt32(dumzid1));
                ...
                xrow.Text = ViewState["xsup"].ToString();
                fnButtonState();
                fnFillGrid2();
        ...
        private void fnFillGrid2()
        {
            ...
            using (SqlConnection con = new SqlConnection(zglobal.constring))
            {
                using (DataSet dts1 = new DataSet())
                {
                    ...
                    string query =
                       ...
                       "FROM prlvapphirchy WHERE zid=@zid and xauthor=@xauthor " +
                       "order by zid,xrow desc ";

                    SqlDataAdapter da1 = new SqlDataAdapter(query, con);

                    da1.SelectCommand.Parameters.AddWithValue("@zid", _zid);
                    da1.SelectCommand.Parameters.AddWithValue("@xauthor", xauthor.Text.ToString().Trim());
            ...
            using (SqlConnection con = new SqlConnection(zglobal.constring))
            {
                using (DataSet dts1 = new DataSet())
                {
                    ...
                    string query =
                       "SELECT Top " + Int32.Parse(_gridrow1.Text.Trim().ToString()) + " * " +
                       "FROM prlvapphirchy WHERE zid=@zid  " +
                       "order by zid,xrow desc";
        ...
        protected void FillControl(object sender, EventArgs e)
        {
            try
            {
                ...
                fnFillControl(row.Cells[0].Text);
        ...
        private void fnFillControl(string xsup1)
        {
            message.InnerHtml = "";
            ...
            string str = "SELECT  * " +
                         "FROM prlvapphirchy where zid=@zid  and xrow=@xrow ";
            ...
            SqlDataAdapter da = new SqlDataAdapter(str, conn1);
            da.SelectCommand.Parameters.AddWithValue("@zid", _zid);
            da.SelectCommand.Parameters.AddWithValue("@xrow", xsup1);
            da.Fill(dts, "tempztcode");
            ...
            xauthor.Text = dttemp.Rows[0]["xauthor"].ToString();
                    ...
                    if (txtconformmessageValue1.Value == "Yes")
                    {
                        ...
                        using (TransactionScope tran = new TransactionScope())
                        {
                            using (SqlConnection conn = new SqlConnection(zglobal.constring))
                            {
                                ...
                                string query = "DELETE FROM prlvapphirchy WHERE zid=@zid AND xrow=@xrow";
                                cmd.Parameters.Clear();

                                cmd.CommandText = query;
                                cmd.Parameters.AddWithValue("@zid", _zid);
                                cmd.Parameters.AddWithValue("@xrow", Convert.ToInt32(xrow.Text.ToString().Trim()));
