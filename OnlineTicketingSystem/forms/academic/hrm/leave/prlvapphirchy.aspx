<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="prlvapphirchy.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.prlvapphirchy" %>
          ...
          //gridviewScroll();
            ...
            $('#<%=GridView1.ClientID%>').gridviewScroll({
                ...
                $("body").on("click", ".bm_xemp", function () {
                    ...
                    fnOpenUserList1(<%= HttpContext.Current.Session["business"] %>,$(this).parent(".bm_span2").siblings(".bm_span1").find(".bm_text1").attr("ID"),$(this).parent(".bm_span2").siblings(".bm_span1").find(".bm_text1").val(),$(this).parent(".bm_span2").siblings(".bm_span3").find(".xnameemp").attr("ID"));
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Leave Approve Hierarchy</span>
                    </div>
                </div>
                                    ...
                                    <div style="display: inline-block; width: 500px; font-size: 14px; vertical-align: top; color: #0000ff;">
                                        <table>
                                            <tr>
                                                ...
                                                <td>:</td>
                                                <td>
                                                    <%--<asp:TextBox ID="xrow" runat="server" Width="50px" ReadOnly="True"></asp:TextBox>--%>
                                                    <asp:Label ID="xrow" runat="server" Text=""></asp:Label>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>:</td>
                                                <td> <asp:DropDownList ID="xdesig" runat="server"></asp:DropDownList> </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="bm_span1">
                                                    <asp:TextBox ID="xauthor" runat="server" Height="20px" Width="100px" CssClass="bm_text1"></asp:TextBox>
                                                </span>
                                                <span class="bm_span2">
                                             ...
                                             <tr>
                                                ...
                                                <td>:</td>
                                                <td> <asp:DropDownList ID="xdept" runat="server"></asp:DropDownList> </td>
                                            </tr>
                                            
                                            <tr>
                                                <td style="text-align: right">Authority</td>
                                                <td>:</td>
                                                <td> <asp:DropDownList ID="xstatus" runat="server"></asp:DropDownList> </td>
                                            </tr>
                                            ...
                                            <asp:GridView ID="dgvcollectionew" runat="server" AutoGenerateColumns="False" ShowFooter="False"
                                              ...
                                              <Columns>
                                                   ...
                                                   <%-- <asp:TemplateField HeaderText="Row">
                                                    ...
                                                    <asp:BoundField DataField="xrow" HeaderText="Row" ItemStyle-Width="120px"
                                                        ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="pad5" />
                                                  ...
                                                  <%--  <asp:BoundField DataField="xdate" HeaderText="Date" DataFormatString="{0:dd/MM/yyyy}"
                                                    ...
                                                    <asp:BoundField DataField="xdesig" HeaderText="Designation" ItemStyle-Width="120px"
                                                        ItemStyle-HorizontalAlign="Left" ItemStyle-CssClass="pad5"/>
                                                   ...
                                                   <asp:TemplateField HeaderText="Author">
                                                        <ItemStyle Width="120px" HorizontalAlign="Center" />
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="xauthor" runat="server" Text='<%#Eval("xauthor") %>' CssClass="_gridrow_link"
                                                                OnClick="FillControl"></asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>

                                                    <asp:BoundField DataField="xdept" HeaderText="Department" ItemStyle-Width="120px"
                                                        ItemStyle-HorizontalAlign="Left" ItemStyle-CssClass="pad5" />


                                                    <asp:BoundField DataField="xstatus" HeaderText="Status" ItemStyle-Width="250px"
                                                        ItemStyle-HorizontalAlign="Left" ItemStyle-CssClass="pad5" />
                                                    
                                                     <asp:BoundField DataField="zemail" HeaderText="Entry By" ItemStyle-Width="120px"
                                                        ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="pad5" />
                                                    
                                                     <asp:BoundField DataField="xemail" HeaderText="Updated By" ItemStyle-Width="120px"
                                                        ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="pad5" />
