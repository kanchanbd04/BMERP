<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="imitemsetdt.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.imitemsetdt" %>
          ...
          //gridviewScroll();
            ...
            $('#<%=GridView1.ClientID%>').gridviewScroll({
                ...
                $("body").on("click", ".bm_tmpdesc", function () {
                    ...
                    fnOpenItemList2(<%= HttpContext.Current.Session["business"] %>,$(this).parent(".bm_span2").siblings(".bm_span1").find(".bm_text1").attr("ID"),$(this).parent(".bm_span2").siblings(".bm_span1").find(".bm_text1").val(),$(this).parent(".bm_span2").siblings(".bm_span3").find(".bm_label1").attr("ID")); 
                });
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Item Set Details: &nbsp;<span id="spanxclass" runat="server"> </span>- &nbsp; <span id="spanxsetname" runat="server"></span>
                    </div>
                </div>
                                        ...
                                        <div style="vertical-align: top; display: inline-block; width: 48%;">
                                            <table width="100%" style="width: 100%; height: 100%; border-collapse: collapse;"
                                                ...
                                                <tr>
                                                    <td align="left" style="padding: 5px;">
                                                        <table style="border: none;">
                                                             ...
                                                             <tr>
                                                                <td style="text-align: right;">Item Set
                                                                </td>
                                                                <td>:
                                                                </td>
                                                                <td>
                                                                    <asp:Label ID="xsetname" runat="server" Text=""></asp:Label>
                                                                </td>
                                                            </tr>
                                                ...
                                                <td>
                                                    ...
                                                    <span class="bm_span1">
                                                        <asp:TextBox ID="xitem" runat="server" Height="20px" Width="150px" CssClass="bm_text1"></asp:TextBox>
                                                    </span>
                                                    <span class="bm_span2">
                                                    ...
                                                    <span class="bm_span3">
                                                        <asp:Label ID="tmpdesc" runat="server" Text="" CssClass="bm_label1"></asp:Label>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:TextBox ID="xqty" runat="server" Text="0.00"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                            ...
                                            <asp:GridView ID="dgvcollectionew" runat="server" AutoGenerateColumns="False" ShowFooter="False"
                                                ...
                                                <Columns>
                                                   ...
                                                   <asp:TemplateField HeaderText="Item Code">
                                                        <ItemStyle Width="150px" HorizontalAlign="Center" />
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="xitem" runat="server" Text='<%#Eval("xitem") %>' CssClass="_gridrow_link"
                                                                OnClick="FillControl"></asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>

                                                    <asp:BoundField DataField="xdesc" HeaderText="Description" 
                                                        ItemStyle-Width="300px" ItemStyle-HorizontalAlign="Left" ItemStyle-CssClass="pad5"/>
                                                    
                                            
                                                    <asp:BoundField DataField="xqty" HeaderText="Quantity" 
