<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="imconfirmtran.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.imconfirmtran" %>
          ...
          //gridviewScroll();
            ...
            var grid = document.getElementById('<%=dgvunposted.ClientID %>');
                    ...
                    var openwin;
                       ...
                       if (xprefix1 == "RE--") {
                           openwin = window.open('/forms/academic/inventory/imtemptrn.aspx?subnav=myDropdown16&link=LinkButton16&xid=175010001&ximtmptrn=' + xvoucher1, 're1', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, copyhistory=no, width=' + screen.width + ', height=' + screen.height + ', top=0, left=0, targets=_blank');
                           openwin.focus();
                       }else if (xprefix1 == "IS--") {
                           openwin = window.open('/forms/academic/inventory/imtemptrn_issu.aspx?subnav=myDropdown16&link=LinkButton16&xid=175010005&ximtmptrn=' + xvoucher1, 'is1', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, copyhistory=no, width=' + screen.width + ', height=' + screen.height + ', top=0, left=0, targets=_blank');
                           openwin.focus();
                       } else {
                           openwin = window.open('/forms/academic/inventory/imtemptrn_transfer.aspx?subnav=myDropdown16&link=LinkButton16&xid=175010010&ximtmptrn=' + xvoucher1, 'to1', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, copyhistory=no, width=' + screen.width + ', height=' + screen.height + ', top=0, left=0, targets=_blank');
                           openwin.focus();
                       }
                ...
                function ConfirmMessage() {
                    var selectedvalue = confirm("Do you want to confirm? After confirm cann't change record.");
                    if (selectedvalue) {
                        document.getElementById('<%=txtconformmessageValue.ClientID %>').value = "Yes";
                    } else {
                        document.getElementById('<%=txtconformmessageValue.ClientID %>').value = "No";
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Check and Confirm Transection</span>
                    </div>
                </div>
                                    ...
                                    <div class="bm_academic_grid_container" id="list" runat="server">
                                        <div class="grid_header">
                                            <div class="grid_header_label" id="_grid_header" runat="server">
                                                Pending List for Check & Confirm Transection(s)
                                            </div>
                                        ...
                                        <div class="grid_body">
                                            ...
                                            <asp:GridView ID="dgvunposted" runat="server" AutoGenerateColumns="False" ShowFooter="False"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Transection No.">
                                                        <ItemStyle Width="120px" HorizontalAlign="Center" />
                                                        <ItemTemplate>
                                                        <%--    <asp:LinkButton ID="xvoucher" runat="server" Text='<%#Eval("xvoucher") %>' CssClass="_gridrow_link"
                                                                ></asp:LinkButton>--%>
                                                   <asp:HyperLink ID="ximtmptrn" runat="server"  CssClass="_gridrow_link" ForeColor="blue" OnClick="fnPrintInfo(this);"  Text='<%#Eval("ximtmptrn") %>'>
                                                   ...
                                                   <asp:BoundField DataField="xfwh" HeaderText="From Warehouse" ItemStyle-Width="200px"
                                                        ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="pad5" />
                                                    

                                                    
  <asp:BoundField DataField="xtwh" HeaderText="To Warehouse" ItemStyle-Width="200px"
                                                        ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="pad5" />
                                                  ...
                                                  <%--  <asp:BoundField DataField="xstatustrn" HeaderText="Status" ItemStyle-Width="150px"
                                                    ...
                                                    <asp:TemplateField Visible="False">
                                                        <HeaderTemplate>
                                                            ...
                                                            <asp:Button ID="btnOk1" runat="server" Text="Confirm Selected" CssClass="bm_academic_button3 bm_am_btn_ok1 btnok1"  Width="120px" OnClientClick="javascript:ConfirmMessage1();" OnClick="btnOk1_OnClick" />
                                                        </HeaderTemplate>
                                                        <ItemStyle Width="120px" HorizontalAlign="Center" />
                                                        <ItemTemplate>
                                                            <%--<input id="btnConfDropout" type="button" value="Confirm" class="bm_academic_button5 bm_am_btn_edit btnconf"/>--%>
                                                            <asp:Button ID="btnOk2" runat="server" Text="Confirm This" CssClass="bm_academic_button5 bm_am_btn_ok2 btnok2" OnClientClick="javascript:ConfirmMessage();" OnClick="btnOk_OnClick" Width="120px" />
                                                        </ItemTemplate>
