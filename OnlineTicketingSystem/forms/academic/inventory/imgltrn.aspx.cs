...
{
    public partial class imgltrn : System.Web.UI.Page
    {
        ...
        protected void btnProcess_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (xdateto < xdatefrom)
                {
                    message.InnerHtml = "Cann't Process. <br/>Check the value of 'To Date'";
                    message.Style.Value = zglobal.warningmsg;
                    return;
                }
                ...
                string xglevel11 = xglevel1.Text.Trim().ToString();
                string xwh1 = xwh.Text.Trim().ToString();
                ...
                using (SqlConnection con = new SqlConnection(zglobal.constring))
                {
                    using (DataSet dts = new DataSet())
                    {
                        ...
                        query = "SELECT * " +
                                "FROM imtrnvw " +
                                "WHERE zid=@zid AND xgitem=@xgitem and xwh=@xwh AND xdate>=@xdatefrom AND xdate<=@xdateto and coalesce(xitemfaflag,'')<>'Yes'";
                        ...
                        da.SelectCommand.Parameters.AddWithValue("@xgitem", xglevel1.Text.Trim().ToString());
                        da.SelectCommand.Parameters.AddWithValue("@xwh", xwh.Text.Trim().ToString());
                        ...
                        if (tempTable.Rows.Count > 0)
                        {
                            ViewState["imgltrn"] = tempTable;
                        }
                        else
                        {
                            ViewState["imgltrn"] = null;
                        }
                ...
                using (SqlConnection con = new SqlConnection(zglobal.constring))
                {
                    using (DataSet dts = new DataSet())
                    {
                        ...
                        query = "SELECT * " +
                                       "FROM glinterface " +
                                       "WHERE zid=@zid AND xmodule='Inventory' AND xglevel1=@xglevel1 and xwh=@xwh";
                        ...
                        //da.SelectCommand.Parameters.AddWithValue("@xdatefrom", xdatefrom);
                        //da.SelectCommand.Parameters.AddWithValue("@xdateto", xdateto);
                        da.SelectCommand.Parameters.AddWithValue("@xglevel1", xglevel1.Text.Trim().ToString());
                        da.SelectCommand.Parameters.AddWithValue("@xwh", xwh.Text.Trim().ToString());
                ...
                if (ViewState["imgltrn"] != null)
                {
                    using (TransactionScope tran = new TransactionScope())
                    {
                        using (SqlConnection conn = new SqlConnection(zglobal.constring))
                        {
                            ...
                            query = "UPDATE imtemptrn SET xvoucher='' " +
                                        "WHERE zid=@zid AND ximtmptrn in (select ximtmptrn from imgltrn where zid=@zid AND xtdate>=@xdatefrom AND xtdate<=@xdateto and xglevel1=@xglevel1 and xwh=@xwh)";
                            ...
                            cmd.Parameters.AddWithValue("@xglevel1", xglevel1.Text.Trim().ToString());
                            cmd.Parameters.AddWithValue("@xwh", xwh.Text.Trim().ToString());
                            cmd.ExecuteNonQuery();

                            query = "DELETE FROM gldetail " +
                                    "WHERE zid=@zid AND xvoucher in (select xvoucher from imgltrn where zid=@zid AND xtdate>=@xdatefrom AND xtdate<=@xdateto and xglevel1=@xglevel1 and xwh=@xwh )";
                            ...
                            query = "DELETE FROM imgltrn " +
                                       "where zid=@zid AND xtdate>=@xdatefrom AND xtdate<=@xdateto and xglevel1=@xglevel1 and xwh=@xwh  ";
                            ...
                            foreach (DataRow row in ((DataTable)ViewState["imgltrn"]).Rows)
                            {
                                if (ViewState["glinterface"] != null)
                                {
                                    DataRow[] rowglint =
                                        ((DataTable)ViewState["glinterface"]).Select("zid=" + row["zid"] +
                                                                                      " and xtrnim='" +
                                                                                      row["xtrnim"] + "'" + " and xaction= '"+row["xaction"]+"'");

                                    if (rowglint.Length > 0)
                                    {
                                        foreach (var row1 in rowglint)
                                        {
                                            query = "INSERT INTO imgltrn (ztime,zid,xrow,ximtmptrn,xline,xitem,xval,xtdate,xmodule,xrow_int,xtrnim,xaction,xglevel1,xwh,xprefix,xaccdr,xsubdr,xacccr,xsubcr,zemail) " +
                                                    "VALUES(@ztime,@zid,@xrow,@ximtmptrn,@xline,@xitem,@xval,@xtdate,@xmodule,@xrow_int,@xtrnim,@xaction,@xglevel1,@xwh,@xprefix,@xaccdr,@xsubdr,@xacccr,@xsubcr,@zemail)";

                                            cmd.CommandText = query;
                                            cmd.Parameters.Clear();
                                            cmd.Parameters.AddWithValue("@ztime", DateTime.Now);
                                            cmd.Parameters.AddWithValue("@zid", _zid);
                                            cmd.Parameters.AddWithValue("@xrow", zglobal.GetMaximumIdInt("xrow", "imgltrn", " zid=" + _zid, 1, 1));
                                            cmd.Parameters.AddWithValue("@ximtmptrn", row["ximtrnnum"].ToString());
                                            cmd.Parameters.AddWithValue("@xline", Convert.ToInt32(row["xline"]));
                                            cmd.Parameters.AddWithValue("@xval", Convert.ToDecimal(row["xval"]));
                                            cmd.Parameters.AddWithValue("@xtdate", Convert.ToDateTime(row["xdate"]));
                                            cmd.Parameters.AddWithValue("@xmodule", ViewState["xmodule"].ToString());
                                            cmd.Parameters.AddWithValue("@xitem", row["xitem"].ToString());
                                            cmd.Parameters.AddWithValue("@xrow_int", Convert.ToInt32(row1["xrow"]));
                                            cmd.Parameters.AddWithValue("@xtrnim", row1["xtrnim"].ToString());
                                            cmd.Parameters.AddWithValue("@xaction", row1["xaction"].ToString());
                                            cmd.Parameters.AddWithValue("@xglevel1", row1["xglevel1"].ToString());
                                            cmd.Parameters.AddWithValue("@xwh", row1["xwh"].ToString());
        ...
        protected void btnPost_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (xdateto < xdatefrom)
                {
                    message.InnerHtml = "Cann't Post. <br/>Check the value of 'To Date'";
                    message.Style.Value = zglobal.warningmsg;
                    return;
                }
...
//                        query =
//                            @"select zid,xmodule,xtrnim,xaction,xglevel1,xwh,xprefix,xaccdr as xacc,xsubdr as xsub,1 as xsign,sum(xval) as xval from imgltrn
//                              where zid=@zid and xtdate>=@xdatefrom and xtdate<=@xdateto and xglevel1=@xglevel1 and xwh=@xwh and xmodule=@xmodule and coalesce(xvoucher,'') =''
//                              group by zid,xmodule,xtrnim,xaction,xglevel1,xwh,xprefix,xaccdr,xsubdr
//                              union
//                              select zid,xmodule,xtrnim,xaction,xglevel1,xwh,xprefix,xacccr,xsubcr,-1 as xsign,sum(xval) from imgltrn
//                              where zid=@zid and xtdate>=@xdatefrom and xtdate<=@xdateto and xglevel1=@xglevel1 and xwh=@xwh and xmodule=@xmodule and coalesce(xvoucher,'') =''
//                              group by zid,xmodule,xtrnim,xaction,xglevel1,xwh,xprefix,xacccr,xsubcr";

                        query =
                           @"select zid,xmodule,xtrnim,xaction,xglevel1,xwh,xprefix,xaccdr,xsubdr,xacccr,xsubcr,sum(xval) as xval from imgltrn
                              where zid=@zid and xtdate>=@xdatefrom and xtdate<=@xdateto and xglevel1=@xglevel1 and xwh=@xwh and xmodule=@xmodule and coalesce(xvoucher,'') =''
                              group by zid,xmodule,xtrnim,xaction,xglevel1,xwh,xprefix,xaccdr,xsubdr,xacccr,xsubcr";
                        ...
                        if (tempTable.Rows.Count > 0)
                        {
                            ...
                            using (TransactionScope tran = new TransactionScope())
                            {
                                using (SqlConnection conn = new SqlConnection(zglobal.constring))
                                {
                                    ...
                                    _zid = Convert.ToInt32(Convert.ToString(HttpContext.Current.Session["business"]));
                                    string xvoucher_1 = "";
                                    DateTime xdate1 = xtdate.Text.ToString().Trim() != string.Empty
                                        ? DateTime.ParseExact(xtdate.Text.ToString().Trim(), "dd/MM/yyyy",
                                            CultureInfo.InvariantCulture)
                                            : DateTime.Now;
                                    int chk = 0;
                                    ...
                                    foreach (DataRow row in tempTable.Rows)
                                    {
                                        ...
                                        if (Convert.ToDecimal(row["xval"]) == 0)
                                        {
                                     ...
                                     "INSERT INTO glheader (ztime,zid,xvoucher,xref,xdate,xlong,xpostflag,xyear,xper,xstatusjv,xdesc03,zemail,xnumofper,xtrngl,xnote,xaction,xflag,xstatus,xemailc,xdatepost) " +
                                        ...
                                        xvou = xvou + xvoucher_1 + ";";

                                        xtrngl1 = row["xprefix"].ToString();
                                        xref1 = "Transfered From IM.";
                                        xdesc031 = "";
                                        xnote1 = "**System Generated Voucher Transfered From Inventory**";
                                  ...
                                  " zid=" + _zid + " and xvoucher='" + Convert.ToString(ViewState["xvoucher"] + "'"), "row");
                                        ...
                                        xprime1 = Convert.ToDecimal(row["xval"]);
                                        xacc1 = row["xaccdr"].ToString();
                                        xsub1 = row["xsubdr"].ToString();
                                        ...
                                        if (Math.Abs(xprime1) != 0)
                                        {
                                            ...
                                            query =
                                                "INSERT INTO gldetail (zid,xvoucher,xrow,xacc,xaccusage,xaccsource,xsub,xdiv,xsec,xcur,xexch,xprime,xbase,xacctype,xcheque,xpaytype,xstatus) " +
                                                "VALUES(@zid,@xvoucher,@xrow,@xacc,@xaccusage,@xaccsource,@xsub,@xdiv,@xsec,@xcur,@xexch,@xprime,@xbase,@xacctype,@xcheque,@xpaytype,@xstatus) ";
                                            ...
                                            cmd.Parameters.AddWithValue("@xbase", xprime1);
                                        ...
                                        xrow11 = zglobal.GetMaximumIdInt("xrow", "gldetail",
                                  " zid=" + _zid + " and xvoucher='" + Convert.ToString(ViewState["xvoucher"] + "'"), "row");

                                        xprime1 = -Convert.ToDecimal(row["xval"]);
                                        xacc1 = row["xacccr"].ToString();
                                        xsub1 = row["xsubcr"].ToString();
                                        ...
                                        query = "UPDATE imgltrn SET xvoucher=@xvoucher,xvalpost=xval " +
                                               "WHERE zid=@zid  AND xtdate>=@xdatefrom AND xtdate<=@xdateto and xtrnim=@xtrnim and xaction=@xaction and xglevel1=@xglevel1 and xwh=@xwh and coalesce(xvoucher,'')=''";
                                        ...
                                        cmd.Parameters.AddWithValue("@xdatefrom", xdatefrom);
                                        cmd.Parameters.AddWithValue("@xdateto", xdateto);
                                        cmd.Parameters.AddWithValue("@xtrnim", row["xtrnim"].ToString());
                                        cmd.Parameters.AddWithValue("@xaction", row["xaction"].ToString());
                                        cmd.Parameters.AddWithValue("@xglevel1", row["xglevel1"].ToString());
                                        cmd.Parameters.AddWithValue("@xwh", row["xwh"].ToString());
                                        cmd.Parameters.AddWithValue("@xvoucher", ViewState["xvoucher"].ToString());
                                        cmd.ExecuteNonQuery();

                                        query = "UPDATE imtemptrn SET xvoucher=@xvoucher " +
                                                    "WHERE zid=@zid AND ximtmptrn in (select ximtmptrn from imgltrn where zid=@zid  AND xtdate>=@xdatefrom AND xtdate<=@xdateto and xtrnim=@xtrnim and xaction=@xaction and xglevel1=@xglevel1 and xwh=@xwh and coalesce(xvoucher,'')=@xvoucher)";
                ...
                message.InnerHtml = "<h3><center><font color=blue>Transaction Transferred Successfully<br>Voucher# <font color=red>" + xvou + "</font> Created.</font></center></h3>";
                message.Style.Value = zglobal.successmsg;
        ...
        protected void xtype_OnSelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                if (xtype.Text.Trim().ToString() == "Received")
                {
                    xbnk.Visible = true;
                    //xbank.Text = "";
                }
