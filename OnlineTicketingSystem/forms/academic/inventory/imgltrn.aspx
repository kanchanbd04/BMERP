<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="imgltrn.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.imgltrn" %>
            ...
            return true;
              ...
              <%-- // alert("Hi");
               var zid = <%= HttpContext.Current.Session["business"] %>;
                ...
                $("body").on("click", ".bm_xaccdr", function () {
                    //alert("Hi");
                   
                    fnOpenChartofAccounts(<%= HttpContext.Current.Session["business"] %>, $(this).parent(".bm_list_img").siblings(".bm_list_text").find(".bm_academic_textbox").attr("ID"), $(this).parent(".bm_list_img").siblings(".bm_list_text").find(".bm_academic_textbox").val(), $(this).parent(".bm_list_img").parent(".bm_clt_ctl_50_100").parent(".bm_ctl_container_50_100").siblings().find(".xdescdr").attr("ID"));
                      $("#<%=xaccdr.ClientID%>").focus();

                      return false;
                });

                $("body").on("click", ".bm_xsubdr", function () {
                    //alert("Hi");
                   
                    fnOpenChartofAccountsSub(<%= HttpContext.Current.Session["business"] %>, $(this).parent(".bm_list_img").siblings(".bm_list_text").find(".bm_academic_textbox").attr("ID"), $(this).parent(".bm_list_img").siblings(".bm_list_text").find(".bm_academic_textbox").val(), $(this).parent(".bm_list_img").parent(".bm_clt_ctl_50_100").parent(".bm_ctl_container_50_100").siblings().find(".xdescsubdr").attr("ID"),  $("#<%=xaccdr.ClientID%>").val());
                     $("#<%=xsubdr.ClientID%>").focus();

                     return false;
                });

                $("body").on("click", ".bm_xacccr", function () {
                    //alert("Hi");
                   
                    fnOpenChartofAccounts(<%= HttpContext.Current.Session["business"] %>, $(this).parent(".bm_list_img").siblings(".bm_list_text").find(".bm_academic_textbox").attr("ID"), $(this).parent(".bm_list_img").siblings(".bm_list_text").find(".bm_academic_textbox").val(), $(this).parent(".bm_list_img").parent(".bm_clt_ctl_50_100").parent(".bm_ctl_container_50_100").siblings().find(".xdesccr").attr("ID"));
                     $("#<%=xacccr.ClientID%>").focus();

                     return false;
                 });

                 $("body").on("click", ".bm_xsubcr", function () {
                     //alert("Hi");
                   
                     fnOpenChartofAccountsSub(<%= HttpContext.Current.Session["business"] %>, $(this).parent(".bm_list_img").siblings(".bm_list_text").find(".bm_academic_textbox").attr("ID"), $(this).parent(".bm_list_img").siblings(".bm_list_text").find(".bm_academic_textbox").val(), $(this).parent(".bm_list_img").parent(".bm_clt_ctl_50_100").parent(".bm_ctl_container_50_100").siblings().find(".xdescsubcr").attr("ID"),  $("#<%=xacccr.ClientID%>").val());
                    $("#<%=xsubcr.ClientID%>").focus();
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">IM to GL Posting</span>
                    </div>
                </div>
                        ...
                        <div class="button_section_padding" style="border-bottom: 0px;">
                            <div class="button_section_style1" style="text-align: left">
                                ...
                                <asp:Button ID="btnActive" runat="server" Text="Active" CssClass="bm_academic_button3 bm_am_btn_active"
                                 ...
                                 <asp:Button ID="btnProcess" runat="server" Text="Process" CssClass="bm_academic_button3 bm_am_btn_active"
                                     OnClick="btnProcess_Click" />
                                 <asp:Button ID="btnPost" runat="server" Text="Post" CssClass="bm_academic_button3 bm_am_btn_inactive"
                            ...
                            <div class="footer_list_padding1" style="padding-top: 0px">
                                <div class="bm_academic_grid_container2" style="width: 100%">
                                    ...
                                    <div style="float: left; width: 50%; padding: 0px 2px 10px 10px;">
                                        ...
                                        <div style="width: 270px; display: none;">
                                            <div class="bm_ctl_container_50_100" style="width: 120px; margin-right: 10px; float: left;">
                                                <div class="bm_ctl_label_align_right_50_100" style="width: 100%">
                                                    <asp:Label ID="Label16" runat="server" Text="Module :" AssociatedControlID="xmodule"
                                                        CssClass="label"></asp:Label>
                                                </div>
                                            </div>
                                            <div style="float: left; width: 137px">
                                                <asp:Label ID="xmodule" runat="server" Text="Collection" ForeColor="Black"></asp:Label>
                                            </div>
                                        </div>
                                       ...
                                       <%-- <div class="bm_clt_padding">
                                        ...
                                        <div class="bm_ctl_container_50_50" style="float: left; width: 270px; display: none;">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label18" runat="server" Text="Row :" AssociatedControlID="xrow1"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 148px">
                                                <asp:TextBox ID="xrow1" runat="server" ForeColor="Black" Enabled="False" CssClass="bm_academic_textbox_50_40 bm_academic_ctl_global bm_academic_textbox"></asp:TextBox>
                                            </div>
                                        </div>
                                        ...
                                        <div style="display: none;">
                                            <div class="bm_ctl_container_50_100" style="width: 270px; float: left">
                                                <div class="bm_ctl_label_align_right_50_100" style="width: 120px">
                                                    <asp:Label ID="Label14" runat="server" Text=" TFC Code :" AssociatedControlID="xkey"
                                                        CssClass="label "></asp:Label>
                                                </div>
                                                <div class="bm_clt_ctl_50_100" style="width: 148px">
                                                    ...
                                                    <div class="bm_list_text" style="width: 120px">
                                                        <asp:TextBox ID="xkey" runat="server" CssClass="bm_academic_textbox_50_100 bm_academic_ctl_global bm_academic_textbox "></asp:TextBox>
                                                    </div>
...
<%--                                        <div class="bm_clt_padding">
                                       ...
                                       <%-- <div class="bm_clt_padding">
                                        ...
                                        <div class="bm_ctl_container_50_50" style="float: left; width: 270px; display: none;">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label17" runat="server" Text="Type :" AssociatedControlID="xtype"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 148px">
                                                <asp:DropDownList ID="xtype" AutoPostBack="True" OnSelectedIndexChanged="xtype_OnSelectedIndexChanged" runat="server" CssClass="bm_academic_dropdown_50_50 bm_academic_ctl_global bm_academic_dropdown bm_xclass">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                        
                                        <div runat="server" id="xbnk" style="display: none;">
                                         <div class="bm_clt_padding">
                                        </div>
                                        <div class="bm_ctl_container_50_50" style="float: left; width: 270px">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label22" runat="server" Text="Bank :" AssociatedControlID="xbank"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 148px">
                                        ...
                                        <div class="bm_clt_padding">
                                         ...
                                         <div class="bm_ctl_container_50_50" style="float: left; width: 270px; ">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label26" runat="server" Text="Item Group :" AssociatedControlID="xglevel1"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 148px">
                                                <asp:DropDownList ID="xglevel1"  runat="server" CssClass="bm_academic_dropdown_50_50 bm_academic_ctl_global bm_academic_dropdown bm_xclass">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                         ...
                                         <div class="bm_ctl_container_50_50" style="float: left; width: 270px; ">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label27" runat="server" Text="Warehouse :" AssociatedControlID="xwh"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 148px">
                                                <asp:DropDownList ID="xwh"  runat="server" CssClass="bm_academic_dropdown_50_50 bm_academic_ctl_global bm_academic_dropdown bm_xclass">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                        ...
                                        <div class="bm_ctl_container_50_50" style="float: left; width: 270px; ">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label24" runat="server" Text="From Date :" AssociatedControlID="xfdate"
                                                    CssClass="label "></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 148px">
                                        ...
                                        <div class="bm_ctl_container_50_50" style="float: left; width: 270px; ">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label25" runat="server" Text="To Date :" AssociatedControlID="xtdate"
                                                    CssClass="label "></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 148px">
                                        ...
                                        <div class="bm_ctl_container_50_50" style="float: left; width: 270px; display: none;">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label23" runat="server" Text="Voucher Prefix :" AssociatedControlID="xprefix"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 148px">
                                                <asp:DropDownList ID="xprefix" runat="server" CssClass="bm_academic_dropdown_50_50 bm_academic_ctl_global bm_academic_dropdown bm_xclass">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                     ...
                                     <div style="display: none;">
                                            <div class="bm_ctl_container_50_100" style="width: 270px; float: left">
                                                <div class="bm_ctl_label_align_right_50_100" style="width: 120px">
                                                    <asp:Label ID="Label4444" runat="server" Text=" Debit Account :" AssociatedControlID="xaccdr"
                                                        CssClass="label"></asp:Label>
                                                </div>
                                                <div class="bm_clt_ctl_50_100" style="width: 148px">
                                                    
                                                    <div class="bm_list_text" style="width: 120px">
                                                        <asp:TextBox ID="xaccdr" runat="server" CssClass="bm_academic_textbox_50_100 bm_academic_ctl_global bm_academic_textbox "></asp:TextBox>
                                                    </div>
                                                    <div class="bm_list_img">
                                                        <asp:Image ID="Image2" runat="server" ImageUrl="~/images/list-am32x32.png" CssClass="bm_academic_list bm_xaccdr" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div style="float: left; padding-left: 5px; padding-top: 1px">
                                                <asp:Label ID="xdescdr" runat="server" Text="" CssClass="xdescdr"></asp:Label>
                                            </div>
                                       ...
                                       <%-- <div class="bm_clt_padding">
                                        ...
                                        <div style="display: none;">
                                            <div class="bm_ctl_container_50_100" style="width: 270px; float: left">
                                                <div class="bm_ctl_label_align_right_50_100" style="width: 120px">
                                                    <asp:Label ID="Label19" runat="server" Text=" Debit Sub Acc. :" AssociatedControlID="xsubdr"
                                                        CssClass="label"></asp:Label>
                                                </div>
                                                <div class="bm_clt_ctl_50_100" style="width: 148px">
                                                    
                                                    <div class="bm_list_text" style="width: 120px">
                                                        <asp:TextBox ID="xsubdr" runat="server" CssClass="bm_academic_textbox_50_100 bm_academic_ctl_global bm_academic_textbox "></asp:TextBox>
                                                    </div>
                                                    <div class="bm_list_img">
                                                        <asp:Image ID="Image3" runat="server" ImageUrl="~/images/list-am32x32.png" CssClass="bm_academic_list bm_xsubdr" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div style="float: left; padding-left: 5px; padding-top: 1px">
                                                <asp:Label ID="xdescsubdr" runat="server" Text="" CssClass="xdescsubdr"></asp:Label>
                                            </div>
                                     ...
                                     <div style="display: none;">
                                            <div class="bm_ctl_container_50_100" style="width: 270px; float: left">
                                                <div class="bm_ctl_label_align_right_50_100" style="width: 120px">
                                                    <asp:Label ID="Label20" runat="server" Text=" Credit Account :" AssociatedControlID="xacccr"
                                                        CssClass="label"></asp:Label>
                                                </div>
                                                <div class="bm_clt_ctl_50_100" style="width: 148px">
                                                    
                                                    <div class="bm_list_text" style="width: 120px">
                                                        <asp:TextBox ID="xacccr" runat="server" CssClass="bm_academic_textbox_50_100 bm_academic_ctl_global bm_academic_textbox "></asp:TextBox>
                                                    </div>
                                                    <div class="bm_list_img">
                                                        <asp:Image ID="Image5" runat="server" ImageUrl="~/images/list-am32x32.png" CssClass="bm_academic_list bm_xacccr" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div style="float: left; padding-left: 5px; padding-top: 1px">
                                                <asp:Label ID="xdesccr" runat="server" Text="" CssClass="xdesccr"></asp:Label>
                                            </div>
                                       ...
                                       <%-- <div class="bm_clt_padding">
                                        ...
                                        <div style="display: none;">
                                            <div class="bm_ctl_container_50_100" style="width: 270px; float: left">
                                                <div class="bm_ctl_label_align_right_50_100" style="width: 120px">
                                                    <asp:Label ID="Label21" runat="server" Text=" Credit Sub Acc. :" AssociatedControlID="xsubcr"
                                                        CssClass="label"></asp:Label>
                                                </div>
                                                <div class="bm_clt_ctl_50_100" style="width: 148px">
                                                    
                                                    <div class="bm_list_text" style="width: 120px">
                                                        <asp:TextBox ID="xsubcr" runat="server" CssClass="bm_academic_textbox_50_100 bm_academic_ctl_global bm_academic_textbox "></asp:TextBox>
                                                    </div>
                                                    <div class="bm_list_img">
                                                        <asp:Image ID="Image6" runat="server" ImageUrl="~/images/list-am32x32.png" CssClass="bm_academic_list bm_xsubcr" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div style="float: left; padding-left: 5px; padding-top: 1px">
                                                <asp:Label ID="xdescsubcr" runat="server" Text="" CssClass="xdescsubcr"></asp:Label>
                                            </div>
                                       ...
                                       <%-- <div class="bm_clt_padding">
                                        ...
                                        <%--<div class="bm_clt_padding">
                                            ...
                                            <div class="bm_ctl_container_50_100" style="width: 270px; float: left; display: none;">
                                                <div class="bm_ctl_label_align_right_50_100" style="width: 120px">
                                     ...
                                     <%--   <div class="bm_clt_padding">
                                        ...
                                        <div class="bm_ctl_container_50_50" style="width: 450px; height: 70px; display: none;">
                                    ...
                                    <div style="float: left; width: 48%; padding-bottom: 10px; margin-top: 0px; display: none;">
                            ...
                            <div class="button_section_style1" style="text-align: left">
                                ...
                                <asp:Button ID="btnActive1" runat="server" Text="Active" CssClass="bm_academic_button3 bm_am_btn_active"
                                 ...
                                 <asp:Button ID="btnInactive1" runat="server" Text="Inactive" CssClass="bm_academic_button3 bm_am_btn_inactive"
                                     OnClick="btnInactive_Click" />
                                <asp:Button ID="btnProcess1" runat="server" Text="Process" CssClass="bm_academic_button3 bm_am_btn_active"
                                     OnClick="btnProcess_Click" />
                                 <asp:Button ID="btnPost1" runat="server" Text="Post" CssClass="bm_academic_button3 bm_am_btn_inactive"
                                     OnClick="btnPost_Click" />
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="bm_academic_grid_container" id="list" runat="server">
                                    <div class="grid_header">
                                        <div class="grid_header_label" id="_grid_header" runat="server">
                                            List of TFC to GL Interface Table
                                        </div>
                                ...
                                <asp:TextBox ID="_searchbox" runat="server" AutoPostBack="True" CssClass="_searchbox"></asp:TextBox>
                                    ...
                                    <div class="grid_body">
                                        ...
                                        <asp:Label ID="footerlabel" Text="Total" CssClass="footer_label_total" runat="server" />
                                                ...
                                                <asp:BoundField DataField="xkey" HeaderText="TFC Code" ItemStyle-Width="250px"
                                                ...
                                                <asp:BoundField DataField="xbank" HeaderText="Bank" ItemStyle-Width="120px"
                                                    ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="pad5" />

                                                <asp:BoundField DataField="xprefix" HeaderText="Prefix" ItemStyle-Width="50px"
                                                    ItemStyle-HorizontalAlign="left" ItemStyle-CssClass="pad5" />

                                                <asp:BoundField DataField="xaccdr" HeaderText="Debit"  
                                                    ItemStyle-Width="250px" ItemStyle-HorizontalAlign="left" ItemStyle-CssClass="pad5"/>

                                                  <asp:BoundField DataField="xsubdr" HeaderText="Debit Sub"  
                                                    ItemStyle-Width="250px" ItemStyle-HorizontalAlign="left" ItemStyle-CssClass="pad5"/>
                                                
                                                 <asp:BoundField DataField="xacccr" HeaderText="Credit"  
                                                    ItemStyle-Width="250px" ItemStyle-HorizontalAlign="left" ItemStyle-CssClass="pad5"/>
                                                
                                                  <asp:BoundField DataField="xsubcr" HeaderText="Credit Sub"  
                                                    ItemStyle-Width="250px" ItemStyle-HorizontalAlign="left" ItemStyle-CssClass="pad5"/>
                                ...
                                <div class="bm_academic_grid_container" id="Div1" runat="server">
                                    <div class="grid_header">
                                        <div class="grid_header_label" id="Div2" runat="server">
                                            Special Discount List (Submitted)
                                        </div>
                                        <div class="grid_header_control">
                                        </div>
                                        <div class="flot_right">
                                    ...
                                    <div class="grid_body">
                                        ...
                                        <asp:Label ID="footerlabel" Text="Total" CssClass="footer_label_total" runat="server" />
                                                ...
                                                <asp:BoundField DataField="xname" HeaderText="Name" ItemStyle-Width="250px"
                                                    ItemStyle-HorizontalAlign="left" ItemStyle-CssClass="pad5" />
                                                <asp:BoundField DataField="xdisperc" HeaderText="Discount (%)"  
                                                    ItemStyle-Width="120px" ItemStyle-HorizontalAlign="left" ItemStyle-CssClass="pad5"/>
                                                  <asp:BoundField DataField="xdisfixed" HeaderText="Discount (Fixed)"  
                                                    ItemStyle-Width="120px" ItemStyle-HorizontalAlign="left" ItemStyle-CssClass="pad5"/>
                                                  <asp:TemplateField HeaderText="Active?" ItemStyle-HorizontalAlign="Center">
                                                    <ItemTemplate >
                                                        <asp:CheckBox ID="status" runat="server" Enabled="false" Checked='<%# (Eval("zactive").ToString() == "1" ? true : false) %>' />
