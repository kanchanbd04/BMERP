<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="imledwqtygrp.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.imledwqtygrp" %>
    ...
    <script type="text/javascript">
       ...
       function fnShowReport() {
           ...
           //var xfdate1 = new Date(+dateParts[2], dateParts[1] - 1, +dateParts[0]);
            ...
            var openwin = window.open('/forms/academic/reports/inventory/imledwqtygrprpt.aspx?zid=' + zid + '&fdate=' + fdate1 + '&tdate=' + tdate1 + '&fware=' + fware1 + '&fgitem=' + fgitem1 + '&tgitem=' + tgitem1 + '&fitem=' + fitem1 + '&titem=' + titem1  , 'itemlgd', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, copyhistory=no, width=' + screen.width + ', height=' + screen.height + ', top=0, left=0, targets=_blank');
            openwin.focus();
            //openwin.print();
            return false;
        }
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Item Ledger</span>
                    </div>
                </div>
