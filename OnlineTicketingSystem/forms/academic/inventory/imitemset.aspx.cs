...
{
    public partial class imitemset : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!IsPostBack)
                {
                    ...
                    string xsetname1 = Request.QueryString["xsetname"] != null ? Request.QueryString["xsetname"].ToString().Trim() : "";

                    if (xclass1 != "" && xsetname1 != "")
                    {
                        //xpsclcode.Text = xpsclcode1;
                        ...
                        string str = "SELECT  * " +
                                     "FROM imitemset where zid=@zid  and xclass=@xclass and xsetname=@xsetname ";
                        ...
                        da.SelectCommand.Parameters.AddWithValue("@xsetname", xsetname1);
                        ...
                        xsetname.Text = dttemp.Rows[0]["xsetname"].ToString();
                        zemail.Text = dttemp.Rows[0]["zemail"].ToString();
                        xemail.Text = dttemp.Rows[0]["xemail"].ToString();

                        xclass_tl.Text = dttemp.Rows[0]["xclass"].ToString();



                        ViewState["xpsclcode"] = xclass1;

                        //fnFillGrid2();

                       //fnFillControl(xclass1,xsetname1);
                    }
        ...
        public void fnRegisterPostBack()
        {
            ...
            {
                LinkButton lnkFull1 = row.FindControl("xsetname") as LinkButton;
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (xsetname.Text == "" || xsetname.Text == string.Empty || xsetname.Text == "[Select]")
                {
                    rtnMessage = rtnMessage + "<li>Set Name</li>";
                    isValid = false;
                }
                ...
                using (SqlConnection con = new SqlConnection(zglobal.constring))
                {
                    using (DataSet dts = new DataSet())
                    {
                        con.Open();
                        string query =
                            "SELECT * FROM imitemset WHERE zid=@zid AND xclass=@xclass and xsetname=@xsetname ";

                        SqlDataAdapter da = new SqlDataAdapter(query, con);

                        da.SelectCommand.Parameters.AddWithValue("@zid", _zid);
                        da.SelectCommand.Parameters.AddWithValue("@xclass", xclass.Text.ToString().Trim());
                        da.SelectCommand.Parameters.AddWithValue("@xsetname", xsetname.Text.ToString().Trim());
                        ...
                        if (tempTable.Rows.Count > 0)
                        {
                            ViewState["xpsclcode"] = xclass.Text.ToString().Trim();
                        }
                        else
                        {
                            ViewState["xpsclcode"] = null;
                ...
                using (TransactionScope tran = new TransactionScope())
                {
                    ...
                    if (ViewState["xpsclcode"] == null)
                    {
                        ...
                        using (SqlConnection conn = new SqlConnection(zglobal.constring))
                        {
                            ...
                            string query =
                               "INSERT INTO imitemset (zid,ztime,xclass,xsetname,zemail) " +
                               "VALUES(@zid,@ztime,@xclass,@xsetname,@zemail) ";
                            ...
                            xclass1 = xclass.Text.ToString().Trim();
                            xsetname1 = xsetname.Text.ToString().Trim();
                            ...
                            cmd.Parameters.AddWithValue("@xsetname", xsetname1);
                    ...
                    using (SqlConnection conn = new SqlConnection(zglobal.constring))
                    {
                        ...
                        if (xsupp == "")
                        {
                            ...
                            //query = "UPDATE imitemset SET zutime=@zutime,xclass=@xdesc, xamount=@xamount,xemail=@xemail " +
                            //       "WHERE zid=@zid AND xpsclcode=@xpsclcode ";
        ...
        private void fnFillGrid2()
        {
            ...
            using (SqlConnection con = new SqlConnection(zglobal.constring))
            {
                using (DataSet dts1 = new DataSet())
                {
                    con.Open();
                    string query =
                         "SELECT Top " + Int32.Parse(_gridrow1.Text.Trim().ToString()) + " xclass,xsetname " +
                       "FROM imitemset WHERE zid=@zid " +
                       "order by zid,xclass,xsetname ";
            ...
            using (SqlConnection con = new SqlConnection(zglobal.constring))
            {
                using (DataSet dts1 = new DataSet())
                {
                    con.Open();
                    string query =
                         "SELECT Top " + Int32.Parse(TextBox1.Text.Trim().ToString()) + " xclass,xsetname " +
                       "FROM imitemset WHERE zid=@zid and xclass=@xclass " +
                       "order by zid,xclass,xsetname ";

                    SqlDataAdapter da1 = new SqlDataAdapter(query, con);

                    da1.SelectCommand.Parameters.AddWithValue("@zid", _zid);
                    da1.SelectCommand.Parameters.AddWithValue("@xclass", xclass.Text);
        ...
        protected void FillControl(object sender, EventArgs e)
        {
            try
            {
                ...
                string xclass1 = row.Cells[0].Text.ToString().Trim();
                string xsetname1 = ((LinkButton)sender).Text;
        ...
        private void fnFillControl(string xclass1, string xsetname1)
        {
            message.InnerHtml = "";
                    ...
                    if (txtconformmessageValue1.Value == "Yes")
                    {
                        ...
                        using (TransactionScope tran = new TransactionScope())
                        {
                            using (SqlConnection conn = new SqlConnection(zglobal.constring))
                            {
                                ...
                                string query = "DELETE FROM imitemsetdt WHERE zid=" + _zid + " AND xclass='" + xclass.Text.ToString().Trim() + "' and xsetname='"+ xsetname.Text.ToString().Trim() +"' ";
                                cmd.Parameters.Clear();
                                ...
                                query = "DELETE FROM imitemset WHERE zid=" + _zid + " AND xclass='" + xclass.Text.ToString().Trim() + "' and xsetname='" + xsetname.Text.ToString().Trim() + "' ";
                                cmd.Parameters.Clear();
        ...
        protected void btnDetails_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    string xclass1 = xclass.Text.Trim().ToString();
                    string xsetname1 = xsetname.Text.Trim().ToString();

                    string url =
                        string.Format(
                            "~/forms/academic/inventory/imitemsetdt.aspx?subnav=myDropdown16&link=LinkButton16&xid=175005010&xclass={0}&xsetname={1}",
                            xclass1, xsetname1);
        ...
        protected void xclass_OnTextChanged(object sender, EventArgs e)
        {
            try
            {
                message.InnerHtml = "";
