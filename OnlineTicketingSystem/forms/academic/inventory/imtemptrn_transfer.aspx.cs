...
{
    public partial class imtemptrn_transfer : System.Web.UI.Page
    {

        private int xglobalerr;
            ...
            try
            {
                if (!IsPostBack)
                {
                   ...
                   // xsession.Text = zglobal.fnDefaults("xsession", "Student");
                    ...
                    ViewState["xmode"] = "Transfer Entry";
                    ViewState["xtypetrn"] = "Transfer Transaction";
                    ...
                    ViewState["xtyperel1"] = "Inventory Transaction:+";

                    //ViewState["xaction1"] = zglobal.fnGetValue("xaction", "mstrn",
                    //"zid=" + Convert.ToInt32(Convert.ToString(HttpContext.Current.Session["business"])) + " and xtypetrn='" + ViewState["xtypetrn"].ToString() + "' " +
                    //"and xtrn='" + ViewState["xtrnim"].ToString() + "'");
                    ...
                    ViewState["xrel1"] = zglobal.fnGetValue("xrel", "mstrnp",
                   "zid=" + Convert.ToInt32(Convert.ToString(HttpContext.Current.Session["business"])) + " and xtypetrn='" + ViewState["xtypetrn"].ToString() + "' " +
                   "and xtrn='" + ViewState["xtrnim"].ToString() + "' and xtyperel='" + ViewState["xtyperel1"].ToString() + "'");
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    rtnMessage = rtnMessage + "<li>From Warehouse</li>";
                    isValid = false;
                }

                if (xtwh.Text == "" || xtwh.Text == string.Empty || xtwh.Text == "[Select]")
                {
                    rtnMessage = rtnMessage + "<li>To Warehouse</li>";
                    isValid = false;
                }
                ...
                string xfwh123 = xfwh.Text.Trim().ToString();
                string xtwh123 = xtwh.Text.Trim().ToString();

                if (xfwh123 == xtwh123)
                {
                    message.InnerHtml = "Cann't Transfer Between Same Warehouse.";
                    message.Style.Value = zglobal.warningmsg;
                    xglobalerr = 1;
                    return;
                }
                ...
                using (TransactionScope tran = new TransactionScope())
                {
                    ...
                    if (ViewState["ximtmptrn"] == null)
                    {
                        ...
                        using (SqlConnection conn = new SqlConnection(zglobal.constring))
                        {
                            ...
                            string query =
                              "INSERT INTO imtemptrn (ztime,zid,ximtmptrn,xtrnim,xref,xdate,xemp,xstdid,xstatustrn,xfwh,xsign,xremarks,zemail,xaction,xmode,xtwh,xsign1,xyear,xper) " +
                                    "VALUES(@ztime,@zid,@ximtmptrn,@xtrnim,@xref,@xdate,@xemp,@xstdid,@xstatustrn,@xfwh,@xsign,@xremarks,@zemail,@xaction,@xmode,@xtwh,@xsign1,@xyear,@xper )";
                            ...
                            cmd.Parameters.AddWithValue("@xtwh", xtwh.Text.Trim().ToString());
                            cmd.Parameters.AddWithValue("@xsign", xsign1);
                            cmd.Parameters.AddWithValue("@xsign1", 1);
                    ...
                    using (SqlConnection conn = new SqlConnection(zglobal.constring))
                    {
                        ...
                        if (ximtmptrn_1 == "")
                        {
                            ...
                            query = "UPDATE imtemptrn SET zutime=@zutime,xemail=@xemail, " +
                                   "xdate=@xdate, xemp=@xemp, xstdid=@xstdid, xfwh=@xfwh, xref=@xref, xremarks=@xremarks,xtwh=@xtwh,xyear=@xyear,xper=@xper " +
        ...
        private void fnFillGrid2()
        {
            ...
            using (SqlConnection con = new SqlConnection(zglobal.constring))
            {
                using (DataSet dts1 = new DataSet())
                {
                    con.Open();
                    string query =
                         "SELECT Top " + Int32.Parse(_gridrow.Text.Trim().ToString()) + " ximtmptrn,xdate,xfwh,xtwh,xaction,xstatustrn " +
            ...
            using (SqlConnection con = new SqlConnection(zglobal.constring))
            {
                using (DataSet dts1 = new DataSet())
                {
                    ...
                    string query =
                       "SELECT Top " + Int32.Parse(_gridrow1.Text.Trim().ToString()) + " ximtmptrn,xdate,xfwh,xtwh,xaction,xstatustrn " +
        ...
        private void fnFillControl(string xrow123)
        {
            ...
            string str = "SELECT  xtrnim,ximtmptrn,xdate,xsup,xfwh,xtwh,xremarks,xstatustrn as xstatus,xemp,xstdid " +
