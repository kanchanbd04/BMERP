...
{
    public partial class hrcoachconfig : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
         ...
         ////           btnPaid.Visible = false;
         ////           btnPaid1.Visible = false;
         //           zglobal.fnGetCheckBoxListItems("Subject Paper", xpaper);
         //           zglobal.fnGetCheckBoxListItems("Subject Extension", xext);
                    //zglobal.fnGetComboDataCD("Class", xclass);
                    //zglobal.fnGetComboDataCD("Class Subject", xsubject);

                    //zglobal.fnGetComboDataCD("Class", xclass1);
                    //zglobal.fnGetComboDataCD("Class Subject", xsubject1);
...
//                    con.Open();
//                    string query =
//                        @"SELECT xrow,xsubject, STUFF((SELECT ',   ' + xpaper 
//                                                      FROM amclasssubd
//                                                      WHERE amclasssubh.zid = amclasssubd.zid and amclasssubh.xrow = amclasssubd.xrow
//                                                      FOR XML PATH('')), 1, 1, '') as xpaper, 
//                             STUFF((SELECT ',   ' + xext 
//                                                      FROM amclasssubex
//                                                      WHERE amclasssubh.zid = amclasssubex.zid and amclasssubh.xrow = amclasssubex.xrow
//                                                      FOR XML PATH('')), 1, 1, '') as xext
//                               FROM amclasssubh WHERE zid=@zid AND xclass=@xclass order by  xsubject";
...
//                    con.Open();
//                    string query =
//                        "SELECT top "+_gridrow.Text+"  xclass,xsubject, STUFF((SELECT ',   ' + xpaper " +
//                                                      "FROM amclasssubd " +
//                                                      "WHERE amclasssubh.zid = amclasssubd.zid and amclasssubh.xrow = amclasssubd.xrow " +
//                                                      "FOR XML PATH('')), 1, 1, '') as xpaper, " + 
//                             "STUFF((SELECT ',   ' + xext " + 
...
//                                                      "WHERE amclasssubh.zid = amclasssubex.zid and amclasssubh.xrow = amclasssubex.xrow " +
//                                                      "FOR XML PATH('')), 1, 1, '') as xext " +
//                               "FROM amclasssubh WHERE zid=@zid order by  xclass,xsubject ";
...
//                    if (tempTable.Rows.Count > 0)
//                    {
//                        dgvclasssub.DataSource = tempTable;
//                        dgvclasssub.DataBind();
//                    }
//                    else
//                    {
//                        dgvclasssub.DataSource = null;
//                        dgvclasssub.DataBind();
//                    }
//                }
//            }
...
//            foreach (GridViewRow row in GridView1.Rows)
//            {
//                Label sl = row.FindControl("xsl") as Label;
//                sl.Text = i.ToString();
//                i = i + 1;
//            }

//            i = 1;
//            foreach (GridViewRow row in dgvclasssub.Rows)
//            {
//                Label sl = row.FindControl("xsl") as Label;
//                sl.Text = i.ToString();
//                i = i + 1;
//            }
        ...
        private void fnFillControl(string xrow123)
        {
            ...
            string str = "SELECT  xname FROM hrcoachconfighvw where zid=@zid  and xrow=@xrow ";
            ...
            _coach.Value = dttemp.Rows[0]["xname"].ToString();
        ...
        protected void btnAddSubject_OnClick(object sender, EventArgs e)
        {
            ...
            //            con.Open();
            //            string query =
            //                "SELECT * FROM amclasssubh WHERE zid=@zid AND xclass=@xclass AND xsubject=@xsubject ";
            ...
            //            string query =
            //                        "INSERT INTO amclasssubh (ztime,zid,xrow,xclass,xsubject,zemail) " +
            //                        "VALUES(@ztime,@zid,@xrow,@xclass,@xsubject,@zemail) ";

            //            xrow = zglobal.GetMaximumIdInt("xrow", "amclasssubh", " zid=" + _zid, 1, 1);
            ...
            //            query = 
            //                "INSERT INTO amclasssubd (zid,xrow,xline,xpaper) " +
            //                "VALUES(@zid,@xrow,@xline,@xpaper) ";
            //            foreach (ListItem item in xpaper.Items)
            //            {
            //                if (item.Selected)
            //                {
            //                    int xline = zglobal.GetMaximumIdInt("xline", "amclasssubd",
            ...
            //                    cmd.Parameters.AddWithValue("@xrow", xrow);
            //                    cmd.Parameters.AddWithValue("@xline", xline);
            //                    cmd.Parameters.AddWithValue("@xpaper", item.Text);
            //                    cmd.ExecuteNonQuery();
            //                }
            //            }

            //            query =
            //                "INSERT INTO amclasssubex (zid,xrow,xline,xext) " +
            //                "VALUES(@zid,@xrow,@xline,@xext) ";
            //            foreach (ListItem item in xext.Items)
            //            {
            //                if (item.Selected)
            //                {
            //                    int xline = zglobal.GetMaximumIdInt("xline", "amclasssubex",
            //                    " zid=" + _zid + " and xrow=" + xrow, "line");
            ...
            //                    cmd.Parameters.AddWithValue("@xrow", xrow);
            //                    cmd.Parameters.AddWithValue("@xline", xline);
            //                    cmd.Parameters.AddWithValue("@xext", item.Text);
            //                    cmd.ExecuteNonQuery();
            //                }
            //            }
        ...
        protected void xsubject_OnTextChanged(object sender, EventArgs e)
        {
            //try
            //{
            //    message.InnerHtml = "";
        ...
        protected void ImageButton1_OnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                GridViewRow gvRow = (GridViewRow)lb.NamingContainer;
                int rowID = gvRow.RowIndex;
                //message.InnerHtml = "Hi " + GridView1.Rows[rowID].Cells[6].Text.ToString();
                //return;
                if (txtconformmessageValue1.Value == "Yes")
                {
                    using (TransactionScope tran = new TransactionScope())
                    {
                        using (SqlConnection conn = new SqlConnection(zglobal.constring))
                        {
                            ...
                            //string query = "DELETE FROM hrcoachconfigd WHERE zid=@zid AND xrow=@xrow";
                            string query = "UPDATE hrcoachconfigh SET zactive=0 WHERE zid=@zid AND xrow=@xrow";
                            cmd.Parameters.Clear();

                            cmd.CommandText = query;
                            cmd.Parameters.AddWithValue("@zid", _zid);
                            cmd.Parameters.AddWithValue("@xrow", Convert.ToInt32(GridView2.Rows[rowID].Cells[GridView2.Columns.Count - 1].Text));
                            cmd.ExecuteNonQuery();

                            //query = "DELETE FROM hrcoachconfigh WHERE zid=@zid AND xrow=@xrow";
                            //cmd.CommandText = query;
                            //cmd.ExecuteNonQuery();
        ...
        protected void btnAddCoach_OnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                if (_coach.Value == "" || _coach.Value == string.Empty || _coach.Value == "[Select]")
                {
                    rtnMessage = rtnMessage + "<li>Coach</li>";
                    isValid = false;
                }
                //if (xclass.Text == "" || xclass.Text == string.Empty || xclass.Text == "[Select]")
                //{
                ...
                string isStudentFound = zglobal.fnGetValue("xcoach", "hrcoachconfigh",
                   "zid=" + Convert.ToInt32(Convert.ToString(HttpContext.Current.Session["business"])) + " and xcoach='" +
                   _coach.Value.ToString().Trim() + "' and zactive=1");

                if (isStudentFound != "")
                {
                    message.InnerHtml = "Coach already exists.";
                    message.Style.Value = zglobal.warningmsg;
                    return;
                }
                ...
                using (TransactionScope tran = new TransactionScope())
                {
                    using (SqlConnection conn = new SqlConnection(zglobal.constring))
                    {
                        ...
                        string query =
                            "INSERT INTO hrcoachconfigh (ztime,zid,xrow,xcoach,xclass,xsubject,zactive,zemail) " +
                            "VALUES(@ztime,@zid,@xrow,@xcoach,@xclass,@xsubject,1,@zemail) ";

                        xrow = zglobal.GetMaximumIdInt("xrow", "hrcoachconfigh", " zid=" + _zid, 1, 1);
                        ViewState["xrow"] = xrow;
                        hiddenxrow.Value = xrow.ToString();
                        xcoach1 = _coach.Value.Trim().ToString();
                        ...
                        cmd.Parameters.AddWithValue("@zid", _zid);
                        cmd.Parameters.AddWithValue("@xrow", xrow);
                        cmd.Parameters.AddWithValue("@xcoach", xcoach1);
                        cmd.Parameters.AddWithValue("@xclass", xclass1);
                        cmd.Parameters.AddWithValue("@xsubject", xsubject1);
                        cmd.Parameters.AddWithValue("@zemail", zemail1);
                        cmd.ExecuteNonQuery();
        ...
        protected void btnAddTeacher_OnClick(object sender, EventArgs e)
        {
            try
            {
                //message.InnerHtml = ViewState["xrow"].ToString();
                //return;
                if (ViewState["xrow"] == null)
                {
                    message.InnerHtml = "Cann't add teacher.";
                    message.Style.Value = zglobal.warningmsg;
                    return;
                }
                ...
                if (_coach.Value == "" || _coach.Value == string.Empty || _coach.Value == "[Select]")
                {
                    rtnMessage = rtnMessage + "<li>Teacher</li>";
                    isValid = false;
                }
                //if (xclass.Text == "" || xclass.Text == string.Empty || xclass.Text == "[Select]")
                //{
                ...
                string isStudentFound = zglobal.fnGetValue("xteacher", "hrcoachconfigd",
                   "zid=" + Convert.ToInt32(Convert.ToString(HttpContext.Current.Session["business"])) + " and xteacher='" +
                   _teacher.Value.ToString().Trim() + "' and xrow=" + Convert.ToInt32(ViewState["xrow"]));

                if (isStudentFound != "")
                {
                    message.InnerHtml = "Teacher already exists.";
                    message.Style.Value = zglobal.warningmsg;
                    return;
                }
                ...
                using (TransactionScope tran = new TransactionScope())
                {
                    using (SqlConnection conn = new SqlConnection(zglobal.constring))
                    {
                        ...
                        string query =
                            "INSERT INTO hrcoachconfigd (ztime,zid,xrow,xline,xteacher,xclass,xsubject,zactive,zemail) " +
                            "VALUES(@ztime,@zid,@xrow,@xline,@xteacher,@xclass,@xsubject,1,@zemail) ";

                        int xline = zglobal.GetMaximumIdInt("xline", "hrcoachconfigd", " zid=" + _zid + " and xrow=" + Convert.ToInt32(ViewState["xrow"]), "line");
                        //ViewState["xrow"] = xrow;
                        hiddenxrow.Value = xrow.ToString();
                        xteacher1 = _teacher.Value.Trim().ToString();
                        //xclass1 = xclass.Text.ToString().Trim();
                        //xsubject1 = xsubject.Text.Trim().ToString();
                ...
                if (txtconformmessageValue2.Value == "Yes")
                {
                    using (TransactionScope tran = new TransactionScope())
                    {
                        using (SqlConnection conn = new SqlConnection(zglobal.constring))
                        {
                            ...
                            //string query = "DELETE FROM hrcoachconfigd WHERE zid=@zid AND xrow=@xrow";
                            string query = "UPDATE hrcoachconfigd SET zactive=0 WHERE zid=@zid AND xrow=@xrow AND xline=@xline";
                            cmd.Parameters.Clear();

                            cmd.CommandText = query;
                            cmd.Parameters.AddWithValue("@zid", _zid);
                            cmd.Parameters.AddWithValue("@xrow", Convert.ToInt32(ViewState["xrow"]));
                            cmd.Parameters.AddWithValue("@xline", Convert.ToInt32(GridView1.Rows[rowID].Cells[GridView1.Columns.Count - 1].Text));
                            cmd.ExecuteNonQuery();
