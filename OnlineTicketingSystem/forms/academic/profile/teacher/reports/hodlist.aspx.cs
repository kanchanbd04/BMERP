...
{
    public partial class hodlist : System.Web.UI.Page
    {
        ...
        private void BindGrid()
        {
            ...
            using (SqlConnection conn = new SqlConnection(zglobal.constring))
            {
                ...
                {
                    string query = @"select xemp,xname,xposition,xsubject_hrjobs,xcontact,xemail1 from hrmstcurhod where zid=@zid 
                                    order by xsubject_hrjobs";
