<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/academic_site.Master"
    CodeBehind="hodlist.aspx.cs" Inherits="OnlineTicketingSystem.forms.BMERP.hodlist"
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Head of The Department</span>
                    </div>
                </div>
                ...
                <div class="bm_academic_container_footer">
                    <div class="footer_list_padding2">
                        ...
                        <div class="bm_academic_grid_container" id="list" runat="server" >
                            <div class="grid_header" style="display: none;">
                                ...
                                <div class="grid_header_control" style="margin-left: 15px; margin-top: 5px; ">
                                    <%--<div class="bm_ctl_container_100_special" style="display: inline-block;">
                                     ...
                                     <div class="bm_ctl_container_100_special" style="display: inline-block; width: 300px;" runat="server" id="designation">
                                        <div class="bm_ctl_label_align_right_100_special" style="width: 85px">
                                            <asp:Label ID="Label1" runat="server" Text="Designation :" AssociatedControlID="xdesig"
                                                CssClass="label"></asp:Label>
                                        </div>
                                        <div class="bm_clt_ctl_100_special" style="width: 213px">
                            ...
                            <div class="grid_body" style="margin-top: 5px">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="No" HeaderStyle-Width="5%" HeaderStyle-HorizontalAlign="Left">
                                     ...
                                     <asp:BoundField DataField="xsubject_hrjobs" HeaderText="Subject" ItemStyle-Width="200px"
                                        ItemStyle-CssClass="_grid_text_padding" ItemStyle-HorizontalAlign="Left" />
                                    <asp:BoundField DataField="xemp" HeaderText="ID" ItemStyle-Width="120px"
                                        ItemStyle-CssClass="_grid_text_padding" ItemStyle-HorizontalAlign="Center" />
                                    <asp:BoundField DataField="xname" HeaderText="Name" ItemStyle-Width="300px"
                                        ItemStyle-CssClass="_grid_text_padding" ItemStyle-HorizontalAlign="Left" />
                                    <asp:BoundField DataField="xcontact" HeaderText="Mobile No." ItemStyle-Width="200px"
                                        ItemStyle-CssClass="_grid_text_padding" ItemStyle-HorizontalAlign="Left" />
                                    <asp:BoundField DataField="xemail1" HeaderText="Email" ItemStyle-Width="200px"
                                        ItemStyle-CssClass="_grid_text_padding" ItemStyle-HorizontalAlign="Left" />
