...
{
    public partial class hrtecherinfoindivi : System.Web.UI.Page
    {
        ...
        public void fnFillDataGrid(object sender, EventArgs e)
        {
            try
            {
                ...
                if (TabContainer1.ActiveTabIndex == 0)
                {
                    ...
                    str = "SELECT  xemp,xname,xcontact,xemail1,xblood,xfather,xmother FROM hrmst where zid=@zid and ( xname like '%" + _searchbox.Text.Trim().ToString() + "%' or xemp like '%" + _searchbox.Text.Trim().ToString() + "%' or xcontact like '%" + _searchbox.Text.Trim().ToString() + "%' ) and xtype='teacher' ORDER BY xemp ";
                ...
                grid.FooterRow.Cells[1].Text = grid.Rows.Count.ToString();
                grid.FooterRow.Cells[1].Font.Bold = true;
                grid.FooterRow.Cells[1].HorizontalAlign = HorizontalAlign.Left;
                grid.FooterRow.Cells[1].ForeColor = Color.White;
