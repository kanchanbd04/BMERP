<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="teacher_indivi.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.admission.teacher_indivi" %>
        ...
        $(document).ready(function () {
            ...
            $('.bm_am_btn_edit').click(function () {
                ...
                var mendatoryFields = [
                    ...
                    { "id": "<%= xname.ClientID%>", "prop": "text", "tab": "0" },
                    { "id": "<%= xcontact.ClientID%>", "prop": "text", "tab": "0" },
                    { "id": "<%= xposition_job.ClientID%>", "prop": "combo", "tab": "3" },
                     { "id": "<%= xfdate_job.ClientID%>", "prop": "text", "tab": "3" },
                                    { "id": "<%= getActiveTabIndex.ClientID%>", "prop": "tab", "tab": "-1" }
                                ];
                var mendatoryString = JSON.stringify(mendatoryFields);
                if (!fnMendatoryFields(mendatoryString)) {
            ...
            <div class="bm_academic_container_body_input_section">
                <cc1:TabContainer ID="TabContainer1" runat="server" CssClass="bm_academic_tab_250 bm_am_tab1"
                                        ...
                                        <div class="bm_clt_padding">
                                         ...
                                         <div style="width: 100%;">
                                            <div class="float_left" style="width: 300px;">
                                                <div class="bm_ctl_container_60_100_50" style="width:300px">
                                                    <div class="bm_ctl_label_align_right_60_100_50" style="width:170px">
                                                        <asp:Label ID="Label51" runat="server" Text="Date of Birth :" AssociatedControlID="xdob"
                                                            CssClass="label"></asp:Label>
                                                    </div>
                                                    <div class="bm_clt_ctl_60_100_50" style="width:128px">
                                             ...
                                             <div class="float_left" style="width: 195px; margin-left: 2px;">
                                                <div class="bm_ctl_container_60_100_50" style="width: 195px;">
                                                    <div class="bm_ctl_label_align_right_60_100_50" style="width: 90px;">
                                                        <asp:Label ID="Label69" runat="server" Text="Joining Date :" AssociatedControlID="xjdate_job"
                                                            CssClass="label"></asp:Label>
                                                    </div>
                                                    <div class="bm_clt_ctl_60_100_50" style="width: 103px;">
                                                        <asp:TextBox ID="xjdate_job" runat="server" CssClass="bm_academic_textbox_60_100_50 bm_academic_ctl_global bm_academic_datepicker"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="float_left" style="width: 200px; margin-left: 2px;">
                                                <div class="bm_ctl_container_60_100_50" style="width: 200px;">
                                                    <div class="bm_ctl_label_align_right_60_100_50" style="width: 80px;">
                                                        <asp:Label ID="Label49" runat="server" Text="Nationality :" AssociatedControlID="xnationality"
                                                            CssClass="label"></asp:Label>
                                                    </div>
                                                    <div class="bm_clt_ctl_60_100_50" style="width: 118px;">
                    ...
                    <cc1:TabPanel ID="TabPanel3" runat="server" HeaderText="TabPanel3">
                        <HeaderTemplate>
                            Training/ Courses/ Experiences</HeaderTemplate>
                        <ContentTemplate>
                            <div class="bm_layout_container">
                                <div class="bm_layout_box_100">
            ...
            <div class="bm_academic_container_body_button_section">
                <div class="button_section_padding">
                    ...
                    <div class="button_section_style">
                        ...
                        <asp:Button ID="btnSubmit" runat="server" Text="Submit" CssClass="bm_academic_button bm_am_btn_refresh"
