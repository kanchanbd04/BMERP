<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="stdresvivaapp.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.admission.stdresvivaapp" %>
...
//                return true;
           ...
           // });
            ...
            $('.stdimagecapture').click(function () {
                ...
                //$("#<%= FileUpload1.ClientID%>").css('visibility', 'hidden');
                //$("#<%= ImageButton3.ClientID%>").css('visibility', 'hidden');
                fnImageCapture(<%= HttpContext.Current.Session["business"] %>,'~/images/profile/student/',$("#<%= ximagelink.ClientID%>").attr("ID"),$("#<%= _stdimageurl.ClientID%>").attr("ID"),$("[id$='_row']").val());
            });
            //
        ...
        function fnPrintAdmit() {
         ...
         function fnPrintVivaList() {
            //alert("Hi");
            var xrow_1 = $("#<%= _row.ClientID%>").val();
            var xsession1 = $("#<%= xsession_res.ClientID%>").val();
            var xclass1 = $("#<%= xclass_res.ClientID%>").val();
            var xgroup1 = $("#<%= xgroup_res.ClientID%>").val();
            var xnumexam1 = $("#<%= xnumexam_res.ClientID%>").val();
            var xvivadate1 = $("#<%= xvivadate.ClientID%>").val();
            var xstatus = $("#<%= xschfor.ClientID%>").val();
            var openwin = window.open('/forms/academic/reports/stdvivalistfinal.aspx?xsession=' + xsession1 + '&xclass=' + xclass1 + '&xgroup=' + xgroup1 + '&xnumexam='+ xnumexam1 + '&xvivadate='+xvivadate1+'&xstatus='+xstatus, 'vivalist', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, copyhistory=no, width='+screen.width+', height='+screen.height+', top=0, left=0, targets=_blank');
            openwin.focus();
            return false;
        }
        function fnPrintResultPdf() {
//            //alert("Hi");
//            var xsession1 = $("#<%= xsession_res.ClientID%>").val();
//             var xclass1 = $("#<%= xclass_res.ClientID%>").val();
//             var xgroup1 = $("#<%= xgroup_res.ClientID%>").val();
...
//            var openwin = window.open('/forms/academic/reports/stdresult.aspx?xtype=pdf&xsession='+xsession1+'&xclass='+xclass1+'&xgroup='+xgroup1+'&xnumexam='+xnumexam1, 'result', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, copyhistory=no, width=450, height=450, top='+ top +', left='+ left +', targets=_blank');
//            openwin.focus();
//            return false;
        }

        function fnPrintResultWord() {
//            //alert("Hi");
//            var xsession1 = $("#<%= xsession_res.ClientID%>").val();
//             var xclass1 = $("#<%= xclass_res.ClientID%>").val();
//             var xgroup1 = $("#<%= xgroup_res.ClientID%>").val();
...
//            var left = Math.round((screen.width / 2) - (500 / 2));
//            var top = Math.round((screen.height / 2) - (500 / 2));
//            var openwin = window.open('/forms/academic/reports/stdresult.aspx?xtype=word&xsession='+xsession1+'&xclass='+xclass1+'&xgroup='+xgroup1+'&xnumexam='+xnumexam1, 'result', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, copyhistory=no, width=450, height=450, top='+ top +', left='+ left +', targets=_blank');
//            openwin.focus();
//            return false;
        }

        function fnPrintResultExcel() {
//            //alert("Hi");
//            var xsession1 = $("#<%= xsession_res.ClientID%>").val();
//             var xclass1 = $("#<%= xclass_res.ClientID%>").val();
//             var xgroup1 = $("#<%= xgroup_res.ClientID%>").val();
...
//            var left = Math.round((screen.width / 2) - (500 / 2));
//            var top = Math.round((screen.height / 2) - (500 / 2));
//            var openwin = window.open('/forms/academic/reports/stdresult.aspx?xtype=excel&xsession='+xsession1+'&xclass='+xclass1+'&xgroup='+xgroup1+'&xnumexam='+xnumexam1, 'result', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, copyhistory=no, width=450, height=450, top='+ top +', left='+ left +', targets=_blank');
//            openwin.focus();
//            return false;
        }

         function ConfirmMessage() {
               var selectedvalue = confirm("Do you want to approve result? After approve cannot change data.");
               if (selectedvalue) {
    ...
    <div class="bm_academic_container">
        <div class="bm_academic_container_header">
            <div class="header_label1" id="header_label" runat="server">
                <span class="bm_am_header_round"> Approval For Admission</span>
            </div>
        </div>
        ...
        <div class="bm_academic_container_body">
            <div class="bm_academic_container_body_input_section">
                <cc1:TabContainer ID="TabContainer1" runat="server" CssClass="bm_academic_tab_250 bm_am_tab1"
                    Height="120px" OnActiveTabChanged="TabContainer1_ActiveTabChanged" AutoPostBack="True">
                    ...
                    <cc1:TabPanel ID="TabPanel2" runat="server" HeaderText="TabPanel2">
                        <HeaderTemplate>
                            APPROVAL FOR ADMISSION</HeaderTemplate>
                        <ContentTemplate>
                            <div class="bm_layout_container">
                                    ...
                                    <div class="bm_layout_box_padding">
                                            ...
                                            <div style="float: left; width: 25%">
                                                <div class="bm_ctl_container_100_25" style="width: 100%">
                                                    <div class="bm_ctl_label_align_right_100_25">
                                                        <asp:Label ID="Label31" runat="server" Text="Viva Exam For :" AssociatedControlID="xschfor"
                                                            CssClass="label"></asp:Label>
                                                    </div>
                                                    <div class="bm_clt_ctl_100_25">
                                                        <asp:DropDownList ID="xschfor" runat="server" CssClass="bm_academic_dropdown_100_25 bm_academic_ctl_global bm_academic_dropdown"
                                        ...
                                        <div style="width: 100%">
                                            ...
                                            <div style="float: left; width: 24%; margin-left: 10px;">
                                                <div class="bm_ctl_container_100_25" style="width: 100%">
                                                    ...
                                                    <div class="bm_clt_ctl_100_25" >
                                                        <asp:TextBox Enabled="False" ID="xexamdate_res" runat="server" CssClass="bm_academic_textbox_100_25 bm_academic_ctl_global bm_academic_datepicker" ReadOnly="True"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div style="width: 100%">
                                            <div style="float: left; ;width: 25%">
                                                <div class="bm_ctl_container_100_25" style="width: 100%">
                                                    <div class="bm_ctl_label_align_right_100_25">
                                                        <asp:Label ID="Label70" runat="server" Text="Viva Exam Date :" AssociatedControlID="xvivadate"
                                                            CssClass="label"></asp:Label>
                                                    </div>
                                                    <div class="bm_clt_ctl_100_25">
                                                        <asp:DropDownList ID="xvivadate" runat="server" CssClass="bm_academic_dropdown_100_25 bm_academic_ctl_global bm_academic_dropdown">
                                                        </asp:DropDownList>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div style="float: left; width: 48%;">
                                                    <div class="bm_ctl_container_100_25" style="width: 100%">
                                                        ...
                                                        <div class="bm_clt_ctl_100_25" style="width: 30%">
                                                            <asp:TextBox Enabled="False"  ID="xtotalmaks" runat="server" CssClass="bm_academic_textbox_100_25 bm_academic_ctl_global bm_academic_textbox"
                                                                ReadOnly="True"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div style="float: left; width: 48%; margin-left: 11.1px;">
                                                    <div class="bm_ctl_container_100_25" style="width: 100%">
                                                        <div class="bm_ctl_label_align_left_100_25" style="width: 70%">
                                                        ...
                                                        <div class="bm_clt_ctl_100_25" style="width: 30%">
                                                            <asp:TextBox Enabled="False"  ID="xpassmarks" runat="server" CssClass="bm_academic_textbox_100_25 bm_academic_ctl_global bm_academic_textbox"
                                                                ReadOnly="True"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="bm_layout_box_50">
                                    <div class="bm_layout_box_padding">
                                        ...
                                        <div class="bm_ctl_container_50_50">
                                            ...
                                            <div class="bm_clt_ctl_50_50">
                                                <asp:TextBox ID="xstdid" runat="server" CssClass="bm_academic_textbox_50_50 bm_academic_ctl_global bm_academic_textbox"
                                                    ReadOnly="True"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="bm_clt_padding">
            ...
            <div class="bm_academic_container_body_button_section">
                <div class="button_section_padding">
                    ...
                    <div class="button_section_style" style="display: inline-block; width: 78%; text-align: left;
                        padding-left: 350px">
                        <asp:Button ID="btnSave" runat="server" Text="Add" CssClass="bm_academic_button bm_am_btn_save"
                            OnClick="btnSave_Click" />
                        <asp:Button ID="btnEdit" runat="server" Text="Save" CssClass="bm_academic_button bm_am_btn_edit"
                            OnClick="btnEdit_Click" />
                        <asp:Button ID="btnApproved" runat="server" Text="Approve" CssClass="bm_academic_button bm_am_btn_approve"
                            OnClientClick="javascript:ConfirmMessage();" OnClick="btnApproved_Click" />
                        ...
                        <asp:Button ID="btnVivaList" runat="server" Text="Show Viva List" CssClass="bm_academic_button bm_am_btn_refresh"
                            Style="width: 150px" OnClientClick="fnPrintVivaList();" />
                    ...
                    <div style="display: inline-block; width: 20%; padding-left: 130px">
                        <asp:ImageButton ID="ImageButton10" runat="server" ImageUrl="~/images/pdf.png" Width="30px"
                            Height="30px" CssClass="bm_academic_button_zoom" OnClientClick="fnPrintResultPdf();" />
                        <asp:ImageButton ID="ImageButton11" runat="server" ImageUrl="~/images/word.png" Width="30px"
                            Height="30px" CssClass="bm_academic_button_zoom" OnClientClick="fnPrintResultWord();" />
                        <asp:ImageButton ID="ImageButton12" runat="server" ImageUrl="~/images/excel.png"
                            Width="30px" Height="30px" CssClass="bm_academic_button_zoom" OnClientClick="fnPrintResultExcel();" />
                    </div>
                    <%--</ContentTemplate>
                     </asp:UpdatePanel>--%>
                </div>
