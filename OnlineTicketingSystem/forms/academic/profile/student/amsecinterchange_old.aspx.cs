...
{
    public partial class amsecinterchange_old : System.Web.UI.Page
    {
                ...
                using (TransactionScope tran = new TransactionScope())
                {
                    ...
                    if (ViewState["xrow"] == null)
                    {
                        ...
                        using (SqlConnection conn = new SqlConnection(zglobal.constring))
                        {
                            ...
                            string query =
                                "INSERT INTO amsecinterchange (ztime,zid,xrow,xsession,xsrow,xsection,xsectionnew,xstatus,xremarks,zemail) " +
                                "VALUES(@ztime,@zid,@xrow,@xsession,(select xrow from amadmis where zid=@zid and xstdid=@xstdid),@xsection,@xsectionnew,@xstatus,@xremarks,@zemail) ";
                    ...
                    using (SqlConnection conn = new SqlConnection(zglobal.constring))
                    {
                        ...
                        if (xrow == 0)
                        {
                            ...
                            query = "UPDATE amsecinterchange SET zutime=@zutime,xemail=@xemail, " +
                                   "xsection=@xsection,xsectionnew=@xsectionnew,xremarks=@xremarks " +
                        ...
                        using (DataSet dts = new DataSet())
                        {
                            ...
                            {
                                query =
                                    "UPDATE ampromotiond SET xsection=@xsection WHERE zid=@zid AND xrow=@xrow AND xsrow=(select xrow from amadmis where zid=@zid AND xstdid=@xstdid)";
                            ...
                            {
                                query =
                                   "UPDATE amadmis SET xsection=@xsection WHERE zid=@zid AND xrow=(select xrow from amadmis where zid=@zid AND xstdid=@xstdid)";
                            ...
                            query =
                                    "UPDATE amexamph_sumext_exam SET xsection=@xsection WHERE zid=@zid AND xsession=@xsession AND xsrow=(select xrow from amadmis where zid=@zid AND xstdid=@xstdid)";
                            ...
                            query =
                                   "UPDATE amexamph_sumext_exam2_sub SET xsection=@xsection WHERE zid=@zid AND xsession=@xsession AND xsrow=(select xrow from amadmis where zid=@zid AND xstdid=@xstdid)";
                            ...
                            query =
                                   "UPDATE amexamph_sumext_exam2_wt1 SET xsection=@xsection WHERE zid=@zid AND xsession=@xsession AND xsrow=(select xrow from amadmis where zid=@zid AND xstdid=@xstdid)";
                            ...
                            query =
                                   "UPDATE amexamph_sumext_exam_vw SET xsection=@xsection WHERE zid=@zid AND xsession=@xsession AND xsrow=(select xrow from amadmis where zid=@zid AND xstdid=@xstdid)";
                            ...
                            query =
                                   "UPDATE amexamph_sumext_exam2_sub_vw SET xsection=@xsection WHERE zid=@zid AND xsession=@xsession AND xsrow=(select xrow from amadmis where zid=@zid AND xstdid=@xstdid)";
                            ...
                            query =
                                   "UPDATE amexamph_sumext_exam2_wt1_vw SET xsection=@xsection WHERE zid=@zid AND xsession=@xsession AND xsrow=(select xrow from amadmis where zid=@zid AND xstdid=@xstdid)";
                            ...
                            query =
                                   "UPDATE amexamph_result_avg1 SET xsection=@xsection WHERE zid=@zid AND xsession=@xsession AND xsrow=(select xrow from amadmis where zid=@zid AND xstdid=@xstdid)";
                            ...
                            query =
                                  "UPDATE amexamph_result_avg_sub SET xsection=@xsection WHERE zid=@zid AND xsession=@xsession AND xsrow=(select xrow from amadmis where zid=@zid AND xstdid=@xstdid)";
                            ...
                            if (tempTable.Rows.Count > 0)
                            {
                               ...
                               // da1.SelectCommand.Parameters.AddWithValue("@xsubject", tempTable.Rows[i]["xsubject"].ToString());
                                ...
                                for (int i = 0; i < tempTable.Rows.Count; i++)
                                {
                                    ...
                                    DataRow[] result;
                                    result =
                                           tempTable1.Select("zid=" + _zid + " and xterm='" +
                                           tempTable.Rows[i]["xterm"].ToString() + "'  and xsubject='" +
                                          tempTable.Rows[i]["xsubject"].ToString() + "' and xtype='" + tempTable.Rows[i]["xtype"].ToString() +
                                          "' and xpaper='" + tempTable.Rows[i]["xpaper"].ToString() + "' and xext='" + tempTable.Rows[i]["xext"].ToString() + "' and " +
                                                             "xctno='" + xctno1 + "'");
                                    ...
                                    {
                                        query =
                                            "UPDATE amexamd SET xline=@xline,xrow=@xrow,xctno1=@xctno1,xgetmark=@xgetmark*@xmarks1/@xmarks " +
                                            "WHERE zid=@zid AND xrow=@xrow1 AND xsrow=@xsrow";

                                        cmd.CommandText = query;
                                        cmd.Parameters.Clear();
                                        cmd.Parameters.AddWithValue("@zid", _zid);
                                        cmd.Parameters.AddWithValue("@xrow1", Convert.ToInt32(tempTable.Rows[i]["xrow"].ToString()));
                                        ...
                                        cmd.Parameters.AddWithValue("@xline",
                                            zglobal.GetMaximumIdInt("xline", "amexamd", " zid=" + _zid + " and xrow=" +
                                            Convert.ToInt32(result[0]["xrow"].ToString()), "line"));
                                        cmd.Parameters.AddWithValue("@xctno1", tempTable.Rows[i]["xctno"].ToString());
                                        cmd.Parameters.AddWithValue("@xgetmark", Convert.ToDecimal(tempTable.Rows[i]["xgetmark"].ToString()));
                                        cmd.Parameters.AddWithValue("@xmarks", Convert.ToDecimal(tempTable.Rows[i]["xmarks"].ToString()));
                                        cmd.Parameters.AddWithValue("@xmarks1", Convert.ToDecimal(result[0]["xmarks"].ToString()));
                                        cmd.ExecuteNonQuery();
                                    }
                                    else
                                    {
            ...
            try
            {
                ...
                string str = "SELECT  xsession, " +
                    ...
                    //"(select xsection from amstudentvw where zid=amsecinterchange.zid and xsession=amsecinterchange.xsession and xrow=amsecinterchange.xsrow) as xsection, " +
                             ...
                             "xsectionnew,xstatus,zemail,xapprovedby,xremarks,xsection " +
