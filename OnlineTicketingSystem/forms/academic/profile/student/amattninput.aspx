<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="amattninput.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.amattninput" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    font-weight: normal;
     ...
     font-family: Myriad Pro,tahoma; 
        ...
        .container:hover input ~ .checkmark, .container:hover input ~ .checkmark1, .container:hover input ~ .checkmark2, .container:hover input ~ .checkmark3 {
        ...
        .container input:checked ~ .checkmark:after, .container input:checked ~ .checkmark1:after, .container input:checked ~ .checkmark2:after, .container input:checked ~ .checkmark3:after {
            display: block;
        }

        /* Style the indicator (dot/circle) */
        .container .checkmark:after, .container .checkmark1:after, .container .checkmark2:after, .container .checkmark3:after {
            top: 9px;
            left: 9px;
            width: 8px;
            height: 8px;
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Input Attendance</span>
                    </div>
                </div>
                ...
                <div class="bm_academic_container_body1">
                    <div class="bm_academic_container_body_button_section" style="padding-bottom: 0px; margin-bottom: 0px; text-align: left;">
                        <div class="button_section_padding" style="border-bottom: 0px; padding-bottom: 0px; margin-bottom: 0px;text-align: left;">
                            ...
                            <div class="button_section_style1" style="text-align: left;">
                                ...
                                <asp:Button ID="btnSubmit" runat="server" Text="Submit" CssClass="bm_academic_button1 bm_am_btn_edit"
                                    OnClientClick="javascript:ConfirmMessage();" OnClick="btnSubmit_Click" Visible="False"/>
                                <asp:Button ID="btnPrint" runat="server" Text="Print" CssClass="bm_academic_button1 bm_am_btn_edit"
                                    OnClientClick="fnPrintObservationForm();" Visible="False"/>
                            </div>
                    ...
                    <div class="bm_academic_container_body_input_section" style="padding-top: 10px; margin-top: 0px;">
                        <div class="bm_layout_container" style="padding-top: 0px; margin-top: 0px;">
                            <div class="bm_layout_box_100" style="padding-top: 0px; margin-top: 0px;">
                                <div class="bm_layout_box_padding" style="padding-top: 0px; margin-top: 0px;">
                                    ...
                                    <div style="width: 100%; clear: both; padding-top: 0px; margin-top: 0px;">
                                        <div class="bm_ctl_container_100_special" style="display: inline-block;">
                                            ...
                                            <div class="bm_clt_ctl_100_special" style="width: 113px">
                                        ...
                                        <div class="bm_ctl_container_100_special" style="display: inline-block;">
                                            <div class="bm_ctl_label_align_right_100_special" style="width: 65px">
                                                <asp:Label ID="Label8" runat="server" Text="Term :" AssociatedControlID="xterm"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_100_special" style="width: 113px">
                                        ...
                                        <%-- <div class="bm_ctl_container_100_special" style="display: inline-block;">
                                            ...
                                            <div class="bm_clt_ctl_100_special" style="width: 103px">
                                                <asp:DropDownList ID="DropDownList1" runat="server" CssClass="bm_academic_dropdown_100_special bm_academic_ctl_global bm_academic_dropdown">
                                                </asp:DropDownList>
                                            </div>
                                        </div>--%>
                                        ...
                                        <div class="bm_ctl_container_100_special" style="display: inline-block;">
                                            <div class="bm_ctl_label_align_right_100_special" style="width: 65px">
                                                <asp:Label ID="Label4" runat="server" Text="Date :" AssociatedControlID="xdate"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_100_special" style="width: 113px">
                                                <asp:TextBox ID="xdate" runat="server" CssClass="bm_academic_dropdown_100_special bm_academic_ctl_global bm_academic_datepicker">
                                                </asp:TextBox>
                                            </div>
                                        </div>

                                        <div class="bm_ctl_container_50_50" style="display: inline-block; width: 32px; border: none; height: 32px; padding-top: 7px">
                                            <div class="bm_clt_ctl_50_50" style="width: 100%;">
                                                <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/images/reload70.png"
                                                    Width="25px" Height="25px" CssClass="bm_academic_button_zoom" OnClick="ImageButton1_OnClick" />
                                            </div>
                                        </div>
                                ...
                                <div class="bm_hotkey" style="clear: both; padding-left: 10px; padding-bottom: 5px" runat="server" id="_abbr">
                                    <table style="border: 1px solid white">
                                        <tr style="border: 1px solid white">
                                            <td style="background-color: Gray; color: black; margin: 1px">Abbreviations</td>
                                            <td style="background-color: silver; color: green; margin: 1px">P - Present</td>
                                            <td style="background-color: silver; color: red; margin: 1px">A - Absent</td>
                                            <%--<td style="background-color: silver; color: blue; margin: 1px">Paid - Alt + P</td>--%>
                                            <td style="background-color: silver; color: yellow; margin: 1px">LT - Late</td>
                                            <%--<td style="background-color: silver; color: blue; margin: 1px">L - Leave</td>--%>
                        ...
                        <div class="bm_academic_container_footer" style="padding-top: 0px;">
                            <div class="footer_list_padding1" style="padding-top: 0px;">
                                <div class="bm_academic_grid_container2" style="width: 100%">

                                    <div style="width: 100%; margin-bottom: 10px; padding-left: 10px; padding-right: 10px;">
                                        ...
                                        <asp:GridView ID="dgvOBListNew" runat="server" AutoGenerateColumns="False" ShowFooter="False"
                                            ...
                                            <Columns>
                                               <%-- <asp:TemplateField HeaderText="Session">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="xsession" runat="server" Text='<%#Eval("xsession") %>' CssClass="_gridrow_link"
                                                            OnClick="FillControl"></asp:LinkButton>
                                                    </ItemTemplate>
                                                ...
                                                <asp:BoundField DataField="xterm" HeaderText="Term" ItemStyle-Width="50px"
                                                    ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="pad5" />
