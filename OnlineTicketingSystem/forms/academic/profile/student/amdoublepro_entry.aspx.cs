...
{
    public partial class amdoublepro_entry : System.Web.UI.Page
    {
        private void fnButtonState()
        {
            ...
            else
            {
                ...
                zemail.InnerHtml = zglobal.fnGetValue("coalesce(zemail,'') as zemail", "amdoublepro",
                               "zid=" + _zid + " AND xrow=" + Convert.ToInt32(ViewState["xrow"]));
                xpreapprovedby.InnerHtml = zglobal.fnGetValue("coalesce(xpreapprovedby,'') as xpreapprovedby", "amdoublepro",
                               "zid=" + _zid + " AND xrow=" + Convert.ToInt32(ViewState["xrow"]));
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!IsPostBack)
                {
                    ...
                    zglobal.fnGetComboDataCD("Section", xsectionpro);
                ...
                {
                    xclass.Text = zglobal.fnGetValue("xclass", "amdoublepro",
                   "zid=" + Convert.ToInt32(Convert.ToString(HttpContext.Current.Session["business"])) + " and xrow=" + 
                   Convert.ToInt32(ViewState["xrow"]));
                }
                ...
                {
                    xgroup.Text = zglobal.fnGetValue("xgroup", "amdoublepro",
                   "zid=" + Convert.ToInt32(Convert.ToString(HttpContext.Current.Session["business"])) + " and xrow=" +
                   Convert.ToInt32(ViewState["xrow"]));
                }
                ...
                {
                    xsection.Text = zglobal.fnGetValue("xsection", "amdoublepro",
                   "zid=" + Convert.ToInt32(Convert.ToString(HttpContext.Current.Session["business"])) + " and xrow=" +
                   Convert.ToInt32(ViewState["xrow"]));
                }
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (xclasspro.Text == "" || xclasspro.Text == string.Empty || xclasspro.Text == "[Select]")
                {
                    rtnMessage = rtnMessage + "<li>New Class</li>";
                    isValid = false;
                }
                if (xgroup.Text != "")
                {
                    if (xgrouppro.Text == "" || xgrouppro.Text == string.Empty || xgrouppro.Text == "[Select]")
                    {
                        rtnMessage = rtnMessage + "<li>New Group</li>";
                        isValid = false;
                    }
                }
                if (xsectionpro.Text == "" || xsectionpro.Text == string.Empty || xsectionpro.Text == "[Select]")
                {
                    ...
                    if (ViewState["xrow"] == null)
                    {
                        ...
                        using (SqlConnection con = new SqlConnection(zglobal.constring))
                        {
                            using (DataSet dts = new DataSet())
                            {
                                con.Open();
                                string query =
                                    "SELECT * FROM amdoublepro WHERE zid=@zid AND xsession=@xsession AND xstdid=@xstdid ";
                        ...
                        using (SqlConnection conn = new SqlConnection(zglobal.constring))
                        {
                            ...
                            string query =
                                "INSERT INTO amdoublepro (ztime,zid,xrow,xsession,xstdid,xclasspro,xgrouppro,xsectionpro,xdate,xstatus,xremarks,zemail,xname,xclass,xgroup,xsection) " +
                                "VALUES(@ztime,@zid,@xrow,@xsession,@xstdid,@xclasspro,@xgrouppro,@xsectionpro,@xdate,@xstatus,@xremarks,@zemail," +
                            ...
                            xclasspro1 = xclasspro.Text.Trim().ToString();
                            xgrouppro1 = xgrouppro.Text.Trim().ToString();
                            xsectionpro1 = xsectionpro.Text.Trim().ToString();
                            ...
                            cmd.Parameters.AddWithValue("@xsectionpro", xsectionpro1);
                    ...
                    using (SqlConnection conn = new SqlConnection(zglobal.constring))
                    {
                        ...
                        if (xrow == 0)
                        {
                            ...
                            query = "UPDATE amdoublepro SET zutime=@zutime,xemail=@xemail, " +
                                   "xclasspro=@xclasspro,xgrouppro=@xgrouppro, xsectionpro=@xsectionpro, " +
                                   "xdate=@xdate, xremarks=@xremarks,xstdid=@xstdid," +
                                    "xname=(select xname from amstudentvw where zid=@zid and xstdid=@xstdid and xsession=@xsession), " +
                                    "xclass=(select xclass from amstudentvw where zid=@zid and xstdid=@xstdid and xsession=@xsession), " +
                                    "xgroup=(select xgroup from amstudentvw where zid=@zid and xstdid=@xstdid and xsession=@xsession), " +
                                    "xsection=(select xsection from amstudentvw where zid=@zid and xstdid=@xstdid and xsession=@xsession) " +
        ...
        private void fnFillGrid2()
        {
            ...
            using (SqlConnection con = new SqlConnection(zglobal.constring))
            {
                using (DataSet dts1 = new DataSet())
                {
                    ...
                    string query =
                       "SELECT Top " + Int32.Parse(_gridrow2.Text.Trim().ToString()) + " xrow,xsession," +
                      "(select xname from amadmis where zid=amdoublepro.zid and xstdid=amdoublepro.xstdid) as xname," +
                       "xstdid, xclass, xgroup, xsection, " +
                       "xclasspro, xgrouppro, xsectionpro, xdate " +
        ...
        protected void FillControl(object sender, EventArgs e)
        {
            try
            {
                ...
                string str = "SELECT  xsession, xstdid, xname, xclass, xgroup, xsection, " +
                             "(select xfname from amadmis where zid=amdoublepro.zid and xstdid=amdoublepro.xstdid) as xfname, " +
                             "(select xmname from amadmis where zid=amdoublepro.zid and xstdid=amdoublepro.xstdid) as xmname, " +
                             "xclasspro, xgrouppro, xsectionpro,xdate,xstatus,zemail,xpreapprovedby,xapprovedby,xremarks " +
                             "FROM amdoublepro where zid=@zid  and xrow=@xrow ";
                ...
                xsectionpro.Text = dttemp.Rows[0]["xsectionpro"].ToString();
                ...
                xpreapprovedby.InnerHtml = dttemp.Rows[0]["xpreapprovedby"].ToString();
