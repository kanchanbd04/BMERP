<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="amnotice.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.amnotice" %>
                ...
                $("body").on("click", ".bm_am_btn_save", function () {
                    ...
                    var mendatoryFields = [
                              { "id": "<%= xsession.ClientID%>", "prop": "combo", "tab": "0" },
                               { "id": "<%= xtitle.ClientID%>", "prop": "text", "tab": "0" }
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Send Notice & Other Documents</span>
                    </div>
                </div>
                                    ...
                                    <div style="width: 98%; margin-bottom: 10px; margin-left: 10px;">
                                      ...
                                      <%--  <div class="bm_clt_padding">
                                       ...
                                       <%-- <div class="bm_clt_padding">
                                        ...
                                        <div class="bm_ctl_container_50_50" style="float: left; width: 520px;">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label19" runat="server" Text="Title :" AssociatedControlID="xtitle"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 398px">
                                                <asp:TextBox ID="xtitle" runat="server" CssClass="bm_academic_textbox_50_40 bm_academic_ctl_global bm_academic_textbox"></asp:TextBox>
                                            </div>
                                        </div>
                ...
                <div class="bm_ctl_container_dynamic_100_80" style="width: 100%;">
                    <div class="bm_ctl_container_dynamic_100_80_l" style="width: 120px">
                        <div class="bm_ctl_label_align_right_dynamic_100_80_l">
                            <asp:Label ID="Label20" runat="server" Text="Select a file :" CssClass="label"></asp:Label>
                        </div>
                    </div>
                    <div class="bm_clt_ctl_dynamic_100_80 bm_academic_label" style="color: #000;">
                        ...
                        <asp:FileUpload ID="xlink" runat="server" Width="400px" />
                    </div>
                </div>
                                        ...
                                        <div class="bm_ctl_container_dynamic_100_80">
                                            <div class="bm_ctl_container_dynamic_100_80_l" style="width: 120px">
                                                <div class="bm_ctl_label_align_right_dynamic_100_80_l">
                                                    <asp:Label ID="Label17" runat="server" Text="Confirmed By :" CssClass="label"></asp:Label>
                                                </div>
                                            </div>
                                            <div class="bm_clt_ctl_dynamic_100_80 bm_academic_label">
