...
{
    public partial class amstdatd : System.Web.UI.Page
    {
        private void fnButtonState()
        {
            ...
            else
            {
                ...
                string xstatus1 = zglobal.fnGetValue("xstatus", "amstdatdh",
        ...
        private void BindGrid()
        {
            ...
            if (dtmarks.Rows.Count > 0)
            {
                ...
                tfield = new TemplateField();
                tfield.HeaderText = "Days Present";
                tfield.ItemStyle.HorizontalAlign = HorizontalAlign.Center;
                ...
                if (ViewState["xrow"] != null)
                {
                    using (SqlConnection conn = new SqlConnection(zglobal.constring))
                    {
                        ...
                        {
                            string query = "SELECT * FROM amstdatdd WHERE zid=@zid AND xrow=@xrow";
                    ...
                    if (ViewState["xrow"] != null)
                    {
                        ...
                        if (amexamd.Rows.Count > 0)
                        {
                            foreach (DataRow row in amexamd.Rows)
                            {
                                ...
                                {
                                    //if (row["xpresent"].ToString() == "-1.00")
                                    //{
                                    //    txtMarks.Text = "";
                                    //}
                                    //else
                                    //{
                                        txtMarks.Text = row["xpresent"].ToString();
                                    //}
        ...
        protected void OnTextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                if (row != null)
                {
                    ...
                    if (Convert.ToDecimal(row.Cells[val].Text.ToString()) > Convert.ToDecimal(xdays.Text.Trim()))
                    {
        ...
        private void fnCheckRow()
        {
            ...
            using (SqlConnection con = new SqlConnection(zglobal.constring))
            {
                using (DataSet dts = new DataSet())
                {
                    ...
                    // {
                    query =
                    "SELECT * FROM amstdatdh WHERE zid=@zid AND xsession=@xsession AND xclass=@xclass AND xterm=@xterm AND xgroup=@xgroup  AND xsection=@xsection ";
                    // }
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (ViewState["xrow"] != null)
                {
                    xstatus1 = zglobal.fnGetValue("xstatus", "amstdatdh",
                          "zid=" + _zid + " AND xrow=" + Convert.ToInt32(ViewState["xrow"]));
                    ...
                    if (GridView1.Rows.Count > 0)
                    {
                        if (ViewState["xrow"] == null)
                        {
                            ...
                            using (SqlConnection conn = new SqlConnection(zglobal.constring))
                            {
                                ...
                                string query =
                                    "INSERT INTO amstdatdh (ztime,zid,xrow,xsession,xterm,xclass,xgroup,xsection,xdays,xstatus,zemail) " +
                                    "VALUES(@ztime,@zid,@xrow,@xsession,@xterm,@xclass,@xgroup,@xsection,@xdays,@xstatus,@zemail) ";

                                xrow = zglobal.GetMaximumIdInt("xrow", "amstdatdh", " zid=" + _zid, 1, 1);
                                ViewState["xrow"] = xrow;
                                ...
                                xdays1 = Int32.Parse(xdays.Text.Trim().ToString());
                                ...
                                cmd.Parameters.AddWithValue("@xdays", xdays1);
                        ...
                        using (SqlConnection conn = new SqlConnection(zglobal.constring))
                        {
                            ...
                            string query = "DELETE FROM amstdatdd WHERE zid=@zid AND xrow=@xrow";
                            ...
                            if (xrow == 0)
                            {
                                ...
                                query = "UPDATE amstdatdh SET zutime=@zutime,xemail=@xemail,xdays=@xdays " +
                                ...
                                cmd.Parameters.AddWithValue("@xdays", xdays.Text.Trim().ToString());
                            ...
                            foreach (GridViewRow row in GridView1.Rows)
                            {
                                ...
                                if (getmarks > decimal.Parse(xdays.Text.Trim().ToString()))
                                {
                            ...
                            if (flag == 1)
                            {
                                message.InnerText = "Present days can not greater than working days.";
                                message.Style.Value = zglobal.warningmsg;
                                return;
                            }
                            ...
                            foreach (GridViewRow row in GridView1.Rows)
                            {
                                ...
                                int xline = zglobal.GetMaximumIdInt("xline", "amstdatdd", " zid=" + _zid + " and xrow=" + Convert.ToInt32(ViewState["xrow"]), "line");
                                TextBox txtTextBox1 = row.FindControl("txtMarks") as TextBox;
                                int xpresent;
                                if (txtTextBox1.Text.Trim().ToString() == "" || txtTextBox1.Text.Trim().ToString() == String.Empty)
                                {
                                ...
                                {
                                    xpresent = Int32.Parse(txtTextBox1.Text.Trim().ToString());
                                }
                                ...
                                query = "INSERT INTO amstdatdd (zid,xrow,xline,xstdid,xsrow,xpresent,xremarks) " +
                                        "VALUES(@zid,@xrow,@xline,@xstdid,@xsrow,@xpresent,@xremarks) ";
                                    ...
                                    cmd.Parameters.AddWithValue("@xpresent", xpresent);
        ...
        private void fnFillGrid2()
        {
            ...
            //             " (case when coalesce(xretestfor,'')='' then '' else 'Reference : ' + xretestfor end) as xremarks FROM amexamh WHERE zid=@zid AND xsession=@xsession AND xclass=@xclass AND xterm=@xterm AND xgroup=@xgroup AND xtype='Class Test'  AND xsection=@xsection AND xsubject=@xsubject AND xpaper=@xpaper order by xcttype desc, xctno asc";
                    ...
                    if (txtconformmessageValue.Value == "Yes")
                    {
                        ...
                        using (TransactionScope tran = new TransactionScope())
                        {
                            using (SqlConnection conn = new SqlConnection(zglobal.constring))
                            {
                                ...
                                string query = "";
                                string xstatus1 = zglobal.fnGetValue("xstatus", "amstdatdh", "zid=" + _zid + " AND xrow=" + Convert.ToInt32(ViewState["xrow"]));

                               


                                query =
                                    "UPDATE amstdatdh SET xstatus=@xstatus,xsubmitedby=@xsubmitedby,xsubmitdt=@xsubmitdt " +
                                    "WHERE zid=@zid AND xrow=@xrow ";
                                cmd.Parameters.Clear();
        ...
        protected void btnRefresh_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (ViewState["xrow"] != null)
                {
                    string xmarks1 = zglobal.fnGetValue("xdays", "amstdatdh",
                        "zid=" + _zid + " AND xrow=" + Convert.ToInt32(ViewState["xrow"]));
                    xdays.Text = xmarks1;
                }
                else
