...
{
    public partial class oldstudent : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                try
                {
                    ...
                    zglobal.fnGetComboDataCD("Session", xsession_admis);
                    zglobal.fnGetComboDataCD("Class", xclass);
                    //zglobal.fnGetComboDataCD("Nationality", xnation);
                    zglobal.fnGetComboDataCD("Religion", xreligion);
                    zglobal.fnGetComboDataCD("Religion", xreligion_admis);
                    zglobal.fnGetComboDataCD("Gender", xgender);
                    zglobal.fnGetComboDataCD("Gender", xgender_admis);
                    ...
                    zglobal.fnGetComboDataCD("Section", grid_xsection);
            ...
            try
            {
                ...
                if (TabContainer1.ActiveTabIndex == 0)
                {
                    if (grid_xnumexam.Text == "All")
                    {
                        ...
                        //      " xrow,xname,xexamroll,xexamdate,xexamvenue,(xcellno +', '+ xcellno1) as xcontact,xgender FROM amadmis where zid=@zid and xsession=@xsession and xclass=@xclass and xgroup=@xgroup AND coalesce(xstatus3,'')<>'Revised' AND coalesce(xstatus4,'')='old' ORDER BY xrow DESC";

                        str = "SELECT TOP " + _gridrow.Text.Trim().ToString() +
                              " xrow,xname,xexamdate,xexamvenue,(xcellno +', '+ xcellno1) as xcontact,xgender FROM amstudentvw where zid=@zid and xsession=@xsession and xclass=@xclass and xgroup=@xgroup   ORDER BY xrow DESC";
                    }
                    else
                    {
                        //str = "SELECT TOP " + _gridrow.Text.Trim().ToString() +
                        //      " xrow,xname,xexamroll,xexamdate,xexamvenue,(xcellno +', '+ xcellno1) as xcontact,xgender FROM amadmis where zid=@zid and xsession=@xsession and xclass=@xclass and xgroup=@xgroup AND coalesce(xstatus3,'')<>'Revised' AND xnumexam=@xnumexam AND coalesce(xstatus4,'')='old' ORDER BY xrow DESC";

                        str = "SELECT TOP " + _gridrow.Text.Trim().ToString() +
                             " xrow,xname,xexamroll,xexamdate,xexamvenue,(xcellno +', '+ xcellno1) as xcontact,xgender FROM amadmis where zid=@zid and xsession=@xsession and xclass=@xclass and xgroup=@xgroup AND coalesce(xstatus3,'')<>'Revised' AND xnumexam=@xnumexam  ORDER BY xrow DESC";
                    }
                ...
                else if (TabContainer1.ActiveTabIndex == 1)
                {
                    ...
                    str = "SELECT TOP " + _gridrow.Text.Trim().ToString() + " xrow,xname,xexamroll,xexamdate,xexamvenue,xcontact FROM amadmis where zid=@zid and xsession=@xsession and xclass=@xclass AND coalesce(xstatus3,'')<>'Revised'  ORDER BY xrow DESC";
                    grid = _grid_admis_res;
                }
                else if (TabContainer1.ActiveTabIndex == 2)
                {
                    if (grid_xsection.Text == "All")
                    {
                        //str = "SELECT TOP " + _gridrow.Text.Trim().ToString() + " xrow,xstdid,xname,xmname,xfname,xcontact FROM amadmis where zid=@zid and xsession=@xsession and xclass=@xclass and xgroup=@xgroup  AND coalesce(xstatus4,'')='old'  ORDER BY xrow DESC";
                        str = "SELECT TOP " + _gridrow.Text.Trim().ToString() + " xrow,xstdid,xname,xmname,xfname,(xcellno +', '+ xcellno1) as xcontact,xgender FROM amstudentvw where zid=@zid and xsession=@xsession and xclass=@xclass and xgroup=@xgroup   ORDER BY xrow DESC";
                    }
                    else
                    {
                        //str = "SELECT TOP " + _gridrow.Text.Trim().ToString() +
                        //      " xrow,xstdid,xname,xmname,xfname,xcontact FROM amadmis where zid=@zid and xsession=@xsession and xclass=@xclass and xgroup=@xgroup  AND coalesce(xstatus4,'')='old' AND xsection=@xsection ORDER BY xrow DESC";

                        str = "SELECT TOP " + _gridrow.Text.Trim().ToString() +
                              " xrow,xstdid,xname,xmname,xfname,(xcellno +', '+ xcellno1) as xcontact,xgender FROM amstudentvw where zid=@zid and xsession=@xsession and xclass=@xclass and xgroup=@xgroup  AND xsection=@xsection ORDER BY xrow DESC";
                    }
                ...
                da.SelectCommand.Parameters.AddWithValue("@xsection", grid_xsection.Text.Trim().ToString());
        ...
        private void BindGrid()
        {
            ...
            //return;
            //string str = "SELECT   xrow,ROW_NUMBER() OVER (ORDER BY xrow) AS xid, xname, xexamroll, coalesce(xstatus,'n') AS xstatus,xfname,xremarks,xnumexam FROM amadmis WHERE zid=@zid AND xsession=@xsession AND xnumexam=@xnumexam AND xclass=@xclass AND xgroup=@xgroup AND xnumexam<>'' ";
            string str = "SELECT   xrow,ROW_NUMBER() OVER (ORDER BY xrow) AS xid, xname, xexamroll, coalesce(xstatus,'n') AS xstatus,xfname,xremarks,xnumexam FROM amadmis WHERE zid=@zid AND xsession=@xsession AND xnumexam=@xnumexam AND xclass=@xclass AND xgroup=@xgroup AND xnumexam<>'' ";
        ...
        protected void FillControls(object sender, EventArgs e)
        {
            try
            {
                ...
                //}
                //string str = "SELECT  * FROM amstudentvw where zid=@zid  and xrow=@xrow ";

                    string str = @"select  a.zid, a.xrow, a.xname, xexamroll, xpschool, a.xmname, xprofession, a.xfname, xprofession1, xcontact, a.xphone, a.xpadd, xperadd, a.xemail1, xnation, a.xdob, 
		a.xreligion, 
        a.xgender, a.ximagelink, xlocation,xdate, xftime, xttime, a.xstdid,  xoffadd, a.xcellno, xmailid, xoffadd1, a.xcellno1, xmailid1, a.xfimagelink, a.xmimagelink, 
		a.xblood, xq1, xq2, xq2d, xq3, xq3d, xnumchild, xchildpos, xsibling, xq4, xq5, xq6, xq7, xnamedriver, xcellnodriver, xniddriver, xpadddriver, xperadddriver, 
		a.ximagedriver, xhour, xminitue, xperiod, xdate1, xremarks,
		b.xsession, b.xclass, b.xsection, b.xgroup,coalesce(a.xadmitdate,'1999-01-01') as xadmitdate
from amadmis as a inner join amstudentvwext as b on a.zid=b.zid and a.xrow=b.xrow  
where a.zid=@zid  and a.xrow=@xrow and b.xsession=@xsession";
                ...
                else if (TabContainer1.ActiveTabIndex == 2)
                {
                    ...
                    xmailid1.Text = dtztcode.Rows[0]["xmailid1"].ToString();
                    ...
                    xgroup_admis.Text = dtztcode.Rows[0]["xgroup"].ToString();
        ...
        protected void FillControls3(object sender, EventArgs e)
        {
            try
            {
                //message.InnerHtml = _row_global.Value;
                ...
                int _zid = Convert.ToInt32(Convert.ToString(HttpContext.Current.Session["business"]));
                //Int64 xrow;
                string xstdid123 = xstdid.Text.Trim().ToString();
                //if (TabContainer1.ActiveTabIndex != 2)
                //{
                //xrow = Convert.ToInt64(xstdid.Text);
                //}
                //else
                //{
                //    if (_row_global.Value == "")
                ...
                //    xrow = Convert.ToInt64(_row_global.Value);
                //}
                //string str = "SELECT  * FROM amadmis where zid=@zid  and xrow=(select xrow from amadmis where zid=@zid and xstdid=@xrow) and coalesce(xstatus4,'')='old' ";
                //string str = "SELECT  * FROM amadmis where zid=@zid  and xrow=(select xrow from amadmis where zid=@zid and xstdid=@xrow) ";
		...
		b.xsession, b.xclass, b.xsection, b.xgroup,coalesce(a.xadmitdate,'1999-01-01') as xadmitdate
from amadmis as a inner join amstudentvwext as b on a.zid=b.zid and a.xrow=b.xrow  
where a.zid=@zid  and a.xstdid=@xstdid and b.xsession=@xsession";



                SqlDataAdapter da = new SqlDataAdapter(str, conn1);
                da.SelectCommand.Parameters.AddWithValue("@zid", _zid);
                da.SelectCommand.Parameters.AddWithValue("@xstdid", xstdid123);
                da.SelectCommand.Parameters.AddWithValue("@xsession", xsession_admis.Text.Trim().ToString());
                da.Fill(dts, "tempztcode");
                DataTable dtztcode = new DataTable();
                dtztcode = dts.Tables[0];
                ...
                if (dtztcode.Rows.Count <= 0)
                {
                    message.InnerHtml = "Wrong Student ID.";
                    ...
                    xpschool_admis.Text = "";
                    xmname_admis.Text = "";
                    xprofession_admis.Text = "";
                    xoffadd.Value = "";
                    xcellno.Text = "";
                    xmailid.Text = "";
                    xfname_admis.Text = "";
                    xprofession1_admis.Text = "";
                    xoffadd1.Value = "";
                    xcellno1.Text = "";
                    xclass_admis.Text = "";
                    xsection.Text = "";
                    ...
                    xage_admis.Text = "";
                    xnation_admis.Text = "";
                    xreligion_admis.Text = "";
                    xgender_admis.Text = "";
                    xpadd_admis.Text = "";
                    xperadd_admis.Text = "";
                    xcontact_admis.Text = "";
                    xemail1_admis.Text = "";
                    ximagelink_admis.ImageUrl = "";
                    xmimagelink.ImageUrl = "";
                    xfimagelink.ImageUrl = "";
                    xblood.Text = "";
                    xq1.Text = "";
                    xq2.Text = "";
                    xq2d.Value = "";
                ...
                else if (TabContainer1.ActiveTabIndex == 2)
                {
                    ...
                    xdob_admis.Text = dtztcode.Rows[0]["xdob"].Equals(DBNull.Value) == true ? "31/12/2999" : Convert.ToDateTime(dtztcode.Rows[0]["xdob"]).ToString("dd/MM/yyyy");
                    //fnAge(xage_admis, xdob_admis);
                    xnation_admis.Text = dtztcode.Rows[0]["xnation"].ToString();
                    xreligion_admis.Text = dtztcode.Rows[0]["xreligion"].ToString();
                    xgender_admis.Text = dtztcode.Rows[0]["xgender"].ToString();
                ...
                //if (TabContainer1.ActiveTabIndex != 2)
                //{
                _row.Value = dtztcode.Rows[0]["xrow"].ToString(); 
                _row_global.Value = dtztcode.Rows[0]["xrow"].ToString(); 
                // }
                message.InnerHtml = "";
        ...
        protected void TabContainer1_ActiveTabChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                else if (TabContainer1.ActiveTabIndex == 2)
                {
                    ...
                    list.Visible = true;
                    list_res.Visible = false;
                    _grid_header.InnerHtml = "Student's Information :";
                    fnGridVisibleProp("_grid_admis_stdinfo");
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                using (SqlConnection conn = new SqlConnection(zglobal.constring))
                {
                    ...
                    while (dr.Read())
                    {
                        if (dr["xstatus"].ToString() != "n" && xnumexam.Text.ToString().Trim() != "Special")
                        {
        ...
        protected void btnEdit_Click(object sender, EventArgs e)
        {
            try
            {
                    ...
                    using (SqlConnection conn = new SqlConnection(zglobal.constring))
                    {
                        ...
                        else if (TabContainer1.ActiveTabIndex == 2)
                        {
                            using (SqlConnection con = new SqlConnection(zglobal.constring))
                            {
                                using (DataSet dts = new DataSet())
                                {
                                    string query1 = "SELECT TOP 1 * FROM amexamvw WHERE zid=@zid AND xsrow=@xrow";
                                    ...
                                    {
                                        query = "UPDATE amadmis SET zutime=@zutime,xoffadd=@xoffadd, " +
                                        "xcellno=@xcellno,xmailid=@xmailid,xoffadd1=@xoffadd1,xcellno1=@xcellno1,xmailid1=@xmailid1,ximagelink=@ximagelink, xfimagelink=@xfimagelink, " +
                                        ...
                                        "ximagedriver=@ximagedriver,xemail=@xemail,xphone=@xphone,xpadd=@xpadd, xperadd=@xperadd, xemail1=@xemail1,xname=@xname,xmname=@xmname,xprofession=@xprofession," +
                                                "xfname=@xfname,xprofession1=@xprofession1,xgender=@xgender,xdob=@xdob,xreligion=@xreligion,xadmitdate=@xadmitdate " +
                                       "WHERE zid=@zid AND xrow=@xrow ";
                                    ...
                                    {
                                        query = "UPDATE amadmis SET zutime=@zutime,xsection=@xsection,xoffadd=@xoffadd, " +
                                    "xcellno=@xcellno,xmailid=@xmailid,xoffadd1=@xoffadd1,xcellno1=@xcellno1,xmailid1=@xmailid1,ximagelink=@ximagelink,xfimagelink=@xfimagelink, " +
                                    "xmimagelink=@xmimagelink,xblood=@xblood,xq1=@xq1,xq2=@xq2,xq2d=@xq2d,xq3=@xq3,xq3d=@xq3d,xnumchild=@xnumchild, " +
                                    "xchildpos=@xchildpos,xsibling=@xsibling,xq4=@xq4,xq5=@xq5,xq6=@xq6,xq7=@xq7,xnamedriver=@xnamedriver, " +
                                    "xcellnodriver=@xcellnodriver,xniddriver=@xniddriver,xpadddriver=@xpadddriver,xperadddriver=@xperadddriver, " +
                            ...
                            xprofession11=xprofession_admis.Text.Trim().ToString(); 
                            xfname1=xfname_admis.Text.Trim().ToString(); 
                            xprofession12=xprofession1_admis.Text.Trim().ToString();
                            xgender1 = xgender_admis.Text.ToString().Trim();
                            xdob1 = xdob_admis.Text.Trim() != string.Empty ? DateTime.ParseExact(xdob_admis.Text.Trim().ToString(), "dd/MM/yyyy", CultureInfo.InvariantCulture) : DateTime.ParseExact("31/12/2999", "dd/MM/yyyy", CultureInfo.InvariantCulture);
                            xreligion1 = xreligion_admis.Text.Trim().ToString();
                        }
                        else if (TabContainer1.ActiveTabIndex == 3)
                        {
                ...
                else
                {
                    ...
                    {
                        FillControls(null, null);
                        message.InnerHtml = zglobal.updatesuccmsg + "3";
                        // + ".<br/>" + "<font color=red>Already taken term exam/ class test. Cann't change Student Id & Section.</font>";
                    }
                }
                ...
                if (xrevisedst.Value == "Yes")
                {
                    ...
                    using (TransactionScope tran = new TransactionScope())
                    {
                        using (SqlConnection conn = new SqlConnection(zglobal.constring))
                        {
                            ...
                            if (TabContainer1.ActiveTabIndex == 0)
                            {
                                query = "INSERT INTO amadmis (ztime,zid,xrow,xsession,xname,xclass,xexamroll,xpschool,xmname,xprofession,xfname,xprofession1,xcontact,xphone,xpadd,xperadd,xemail1,xnation,xdob,xreligion,xgender,ximagelink,zemail,xgroup,xcellno,xcellno1,xdate1,xref1,xref2,xstatus2) " +
                                        "SELECT @ztime,zid,@xrow,xsession,xname,xclass,@xexamroll,xpschool,xmname,xprofession,xfname,xprofession1,xcontact,xphone,xpadd,xperadd,xemail1,xnation,xdob,xreligion,xgender,ximagelink,@zemail,xgroup,xcellno,xcellno1,@xdate1,@xref1,@xref2,'Revised' FROM amadmis WHERE zid=@zid AND xrow= @xrow1 ";
                                //xtype = "day_o";
