<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="amattn_termwise.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.amattn_termwise" %>
...
<%--            var xsession1 = '';
    ...
    <%--   var rb = document.getElementById("<%=RadioButtonList1.ClientID%>");
            ...
            var openwin = window.open('/forms/academic/reports/amattn_termwiserpt.aspx?zid=' + zid + '&xclass=' + xclass1 + '&xschool=' + xschool1 + '&xsession=' + xsession1 + '&xsection=' + xsection1 + '&xterm=' + xterm1 , 'amattn_termwise', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, copyhistory=no, width=' + screen.width + ', height=' + screen.height + ', top=0, left=0, targets=_blank');
             openwin.focus();
             //openwin.print();
             return false;
         }
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Term-wise Attendance Report</span>
                    </div>
                </div>
