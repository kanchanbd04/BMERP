...
.GridViewScrollFooterFreeze TD {
    ...
    <script type="text/javascript">
        ...
        function fnShowReport1() {
            ...
            var openwin = window.open('/forms/academic/reports/amstudentlistrpt1.aspx?zid=' + zid + '&xsession=' + xsession1 + '&xclass=' + xclass1 + '&xgroup=' + xgroup1 + '&xsection=' + xsection1 + '&xtype=' + xtype1 + '&xrtype=' + xrtype1, 'rptamstudentlist', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, copyhistory=no, width=' + screen.width + ', height=' + screen.height + ', top=0, left=0, targets=_blank');
            openwin.focus();
            //openwin.print();
            return false;
        }
