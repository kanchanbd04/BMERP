<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="amstdindivi.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.amstdindivi" %>
    ...
    <script type="text/javascript">
        ...
        function fnShowReport() {
          ...
          var zid = <%= HttpContext.Current.Session["business"] %>;
            ...
            var openwin = window.open('/forms/academic/reports/amstdindivirpt.aspx?zid=' + zid + '&xsession=' + xsession1 + '&xclass=' + xclass1 + '&xgroup=' + xgroup1 + '&xsection=' + xsection1 + '&xstdid=' + xstdid1 + '&xrtype=' + xrtype1, 'rptstdindivi', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, copyhistory=no, width=' + screen.width + ', height=' + screen.height + ', top=0, left=0, targets=_blank');
             openwin.focus();
             //openwin.print();
             return false;
        }
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Student-wise Detail Information</span>
                    </div>
                </div>
                            ...
                            <div class="bm_layout_box_100" style="width: 500px;display: inline-block">
                                ...
                                <div class="bm_layout_box_padding" style="padding-top: 10px; min-height: 300px;">
                                    ...
                                    <div style="width: 100%; clear: both;">
                                        ...
                                        <div>
                                            <div class="bm_ctl_container_50_100" style="width: 290px; float: left">
                                                <div class="bm_ctl_label_align_right_50_100" style="width: 120px">
                                                    <asp:Label ID="Label5" runat="server" Text=" Student ID :" AssociatedControlID="xstdid"
                                                        CssClass="label"></asp:Label>
                                                </div>
                                                <div class="bm_clt_ctl_50_100" style="width: 168px">
                                                    ...
                                                    <div class="bm_list_text" style="width: 140px">
                                            ...
                                            <div style="float: left; padding-left: 5px; padding-top: 1px">
                                             ...
                                             <div style="float: left; padding-left: 5px; padding-top: 1px; color: #00f;">
                                                 [Keep Student Id blank for showing all students' information.]
                                                 </div>
