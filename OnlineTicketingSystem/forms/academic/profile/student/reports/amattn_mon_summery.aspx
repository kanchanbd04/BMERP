<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="amattn_mon_summery.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.amattn_mon_summery" %>
...
<%--            var xsession1 = '';
    ...
    <%--   var rb = document.getElementById("<%=RadioButtonList1.ClientID%>");
            ...
            var openwin = window.open('/forms/academic/reports/amattn_mon_summeryrpt.aspx?zid=' + zid + '&xclass=' + xclass1 + '&xschool=' + xschool1 + '&xfdate=' + xfdate1 + '&xtdate=' + xtdate1 + '&xsession=' + xsession1 + '&xsection=' + xsection1 + '&xtype=Present' , 'amattn_mon_summery', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, copyhistory=no, width=' + screen.width + ', height=' + screen.height + ', top=0, left=0, targets=_blank');
             openwin.focus();
             //openwin.print();
             return false;
         }
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Monthly Summery Attendance Report</span>
                    </div>
                </div>
