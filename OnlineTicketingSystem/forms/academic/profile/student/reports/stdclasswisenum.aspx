<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="stdclasswisenum.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.stdclasswisenum" %>
        ...
        function fnShowReport() {
          ...
          var zid = <%= HttpContext.Current.Session["business"] %>;
           ...
           <%-- var xclass1 = $("#<%= xclass.ClientID%>").val();
            ...
            var openwin = window.open('/forms/academic/reports/stdclasswisenumrpt.aspx?zid=' + zid + '&xsession=' + xsession1 + '&xtype=' + xtype1 + '&xrtype=' + xrtype1, 'rptamstudentlist', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, copyhistory=no, width=' + screen.width + ', height=' + screen.height + ', top=0, left=0, targets=_blank');
             openwin.focus();
             //openwin.print();
             return false;
         }
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Number of Students'</span>
                    </div>
                </div>
