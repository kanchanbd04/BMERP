...
{
    public partial class amtfcseatconf_old : System.Web.UI.Page
    {
                        ...
                        using (SqlConnection con = new SqlConnection(zglobal.constring))
                        {
                            using (DataSet dts = new DataSet())
                            {
                                ...
                                query =
                                    ...
                                    "WHERE h.zid=@zid AND xsessionpro=@xsession AND xsrow=(select xrow from amadmis where zid=@zid and xstdid=@xstdid)";
