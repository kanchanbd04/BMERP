...
{
    public partial class amtfcconfig12 : System.Web.UI.Page
    {
        ...
        private void BindGrid()
        {
            ...
            DateTime xeffdate1 = xeffdate.Text.ToString().Trim() != string.Empty
        ...
        protected void OnRowDataBound(object sender, GridViewRowEventArgs e)
        {
            try
            {
                if (e.Row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    txtxdisfixed.CssClass = "bm_academic_textbox_grid bm_academic_ctl_global bm_academic_textbox right xreceive";
                    ...
                    txtxdisperc.CssClass = "bm_academic_textbox_grid bm_academic_ctl_global bm_academic_textbox right xreceive";
                    txtxdisperc.Attributes.Add("onkeyup", "enter(this,event)");
                    e.Row.Cells[4].Controls.Add(txtxdisperc);

                    TextBox txtdamount = new TextBox();
                    txtdamount.ID = "xdamount";
                    txtdamount.CssClass = "bm_academic_textbox_grid bm_academic_ctl_global bm_academic_textbox right xreceive";
                    txtdamount.Attributes.Add("onkeyup", "enter(this,event)");
                    txtdamount.Enabled = false;
                    e.Row.Cells[5].Controls.Add(txtdamount);

                    TextBox txtamount = new TextBox();
                    txtamount.ID = "xamount";
                    txtamount.CssClass = "bm_academic_textbox_grid bm_academic_ctl_global bm_academic_textbox right xreceive";
                    txtamount.Attributes.Add("onkeyup", "enter(this,event)");
                    txtamount.Enabled = false;
                    e.Row.Cells[6].Controls.Add(txtamount);
