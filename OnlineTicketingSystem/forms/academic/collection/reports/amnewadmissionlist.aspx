<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="amnewadmissionlist.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.amnewadmissionlist" %>
...
.GridViewScrollFooterFreeze TD {
    ...
    <script type="text/javascript">
        ...
        function fnShowReport() {
            ...
            var label1 = chk.getElementsByTagName("label");
            var check1 = chk.getElementsByTagName("input");
            var xwithdate1 = "No";
            ...
            var openwin = window.open('/forms/academic/reports/amnewadmissionlistrpt.aspx?zid=' + zid + '&xclass=' + xclass1  + '&xfdate=' + xfdate1 + '&xtdate=' + xtdate1 + '&xtype=' + xtype1 + "&xsession=" + xsession1 + "&xwithdate=" + xwithdate1, 'rpttfcactivity123', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, copyhistory=no, width=' + screen.width + ', height=' + screen.height + ', top=0, left=0, targets=_blank');
            openwin.focus();
            //openwin.print();
            return false;
        }
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">New Admission & Seat Confirmation List</span>
                    </div>
                </div>
                                ...
                                <div class="bm_layout_box_padding" style="padding-top: 10px; min-height: 300px;">
                                    ...
                                    <div style="width: 100%; clear: both;">
                                       ...
                                       <%-- <div>
                                        ...
                                        <div class="bm_ctl_container_50_50" style="float: left; width: 270px">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label2" runat="server" Text="Bank :" AssociatedControlID="xbank"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 148px">
                                        ...
                                        <div style="width: 100%">
                                            <div class="bm_ctl_container_100_special" style="width: 120px; float: left;">
                                                <div class="bm_ctl_label_align_right_100_special" style="width: 100%">
                                                    <asp:Label ID="Label31" runat="server" Text=" Type :"
                                                        CssClass="label"></asp:Label>
                                                </div>
                                            </div>
                                            <%--<div style="float: left; padding-left: 5px">
                                            ...
                                            <div style="float: left; padding-left: 5px">
                                                <asp:RadioButtonList ID="RadioButtonList1" runat="server" RepeatDirection="Horizontal">
                                                    <asp:ListItem Text="New Admission" Value="New Admission" Selected="True"></asp:ListItem>
                                                    <asp:ListItem Text="Seat Confirmation" Value="Seat Confirmation"></asp:ListItem>
                                        ...
                                        <div style="width: 100%">
                                            ...
                                            <div style="float: left; padding-left: 5px">
                                               <%-- <asp:CheckBoxList ID="CheckBoxList1" runat="server" RepeatDirection="Horizontal">
                                                    <asp:ListItem Text="With Date" Value="With Date" Selected="True"></asp:ListItem>
                                                </asp:CheckBoxList>--%>
                                                <asp:CheckBox ID="CheckBox1" runat="server" Checked="True" Text="With Date"/>
                                            </div>
                                        </div>
