<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="amtfcadmitcard.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.amtfcadmitcard" %>
    ...
    <script type="text/javascript">
        ...
        function fnShowReport() {
           ...
           <%-- var dateParts1 = $("#<%= xtdate.ClientID%>").val().split("/");--%>
            ...
            var xterm1 = $("#<%= xterm.ClientID%>  option:selected").text();
          ...
          <%--  var xbank1 = $("#<%= xbank.ClientID%>").val();--%>
            ...
            var openwin = window.open('/forms/academic/reports/amtfcadmitcardrpt.aspx?zid=' + zid + '&xclass=' + xclass1 + '&xterm=' + xterm1  + '&xsession=' + xsession1, 'amtfcadmitcardrpt', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, copyhistory=no, width=' + screen.width + ', height=' + screen.height + ', top=0, left=0, targets=_blank');
            openwin.focus();
            //openwin.print();
            return false;
        }
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Admit Card</span>
                    </div>
                </div>
