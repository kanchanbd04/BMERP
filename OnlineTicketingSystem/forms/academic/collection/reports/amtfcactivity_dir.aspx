<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="amtfcactivity_dir.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.amtfcactivity_dir" %>
...
.GridViewScrollFooterFreeze TD {
    ...
    <script type="text/javascript">
        ...
        function fnShowReport() {
            ...
            var openwin = window.open('/forms/academic/reports/amtfcactivityrpt_dir.aspx?zid=' + zid + '&xclass=' + xclass1 + '&xstdid=' + xstdid1 + '&xfdate=' + xfdate1 + '&xtdate=' + xtdate1 + '&xbank=' + xbank1 + '&xsize=' + xsize1 + '&xorientation=' + xorientation1 + '&xtype=' + xtype1, 'rpttfcactivity', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, copyhistory=no, width=' + screen.width + ', height=' + screen.height + ', top=0, left=0, targets=_blank');
            openwin.focus();
            //openwin.print();
            return false;
        }
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Daily Activity Report</span>
                    </div>
                </div>
