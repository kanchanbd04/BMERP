...
{
    public partial class amtfcadvancedrcv : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!IsPostBack)
                {
                    ...
                    xyear.Text = DateTime.Now.Year.ToString();

                    xmonth.Items.Add(new ListItem("Jan","01"));
                    xmonth.Items.Add(new ListItem("Feb","02"));
                    xmonth.Items.Add(new ListItem("Mar","03"));
                    xmonth.Items.Add(new ListItem("Apr","04"));
                    xmonth.Items.Add(new ListItem("May","05"));
                    xmonth.Items.Add(new ListItem("Jun","06"));
                    xmonth.Items.Add(new ListItem("Jul","07"));
                    xmonth.Items.Add(new ListItem("Aug","08"));
                    xmonth.Items.Add(new ListItem("Sep","09"));
                    xmonth.Items.Add(new ListItem("Oct","10"));
                    xmonth.Items.Add(new ListItem("Nov","11"));
                    xmonth.Items.Add(new ListItem("Dec","12"));
                    xmonth.SelectedValue = "07";
                }
