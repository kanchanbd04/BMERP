<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="amduest_tuition_fee.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.amduest_tuition_fee" %>
...
.GridViewScrollFooterFreeze TD {
    ...
    <%--   var rb = document.getElementById("<%=RadioButtonList1.ClientID%>");
            ...
            var openwin = window.open('/forms/academic/reports/amduest_tuition_feerpt.aspx?zid=' + zid + '&xtfccode=' + xtfccode1 + '&xclass=' + xclass1 + '&xschool=' + xschool1 + '&xfdate=' + xfdate1 + '&xtdate=' + xtdate1 + '&xsize=' + xsize1 + '&xorientation=' + xorientation1 + '&xtype2=' + xtype2 + '&xsession=' + xsession1 + '&xstdid=' + xstdid1 + '&xpaytype=' + xpaytype1 + '&xsection=' + xsection1 + '&xrtype=' + xrtype1 + '&xper=' + xper1, 'amduest_tuition_feerpt', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, copyhistory=no, width=' + screen.width + ', height=' + screen.height + ', top=0, left=0, targets=_blank');
             openwin.focus();
             //openwin.print();
             return false;
         }
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Tuition Fees Dues Remaining</span>
                    </div>
                </div>
                                ...
                                <div class="bm_layout_box_padding" style="padding-top: 10px; min-height: 300px;">
                                    ...
                                    <div style="width: 100%; clear: both;">
                                       ...
                                       <div class="bm_clt_padding">
                                        ...
                                        <div class="bm_ctl_container_100_special" style="width: 270px;">
                                            <div class="bm_ctl_label_align_right_100_special" style="width: 120px">
                                                <asp:Label ID="Label11" runat="server" Text="Section :" AssociatedControlID="xsection"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_100_special" style="width: 148px">
                                      ...
                                      <%--  <div class="bm_clt_padding">
                                        ...
                                        <div class="bm_ctl_container_50_50" style="float: left; width: 270px">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label13" runat="server" Text="Due Period :" AssociatedControlID="xper"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 148px">
                                                <asp:DropDownList ID="xper" runat="server" CssClass="bm_academic_dropdown_50_50 bm_academic_ctl_global bm_academic_dropdown bm_xclass">
                                                </asp:DropDownList>
                                        ...
                                        <div style="width: 100%; display: none;">
                                            ...
                                            <div style="float: left; padding-left: 5px">
                                                <asp:RadioButtonList ID="RadioButtonList3" runat="server" RepeatDirection="Horizontal">
                                                     <asp:ListItem Text="Tuition Fees" Value="Tuition Fees" Selected="True"></asp:ListItem>
                                                    <%-- <asp:ListItem Text="Details (Headwise)" Value="Details (Headwise)"></asp:ListItem>
                                                     <asp:ListItem Text="Details (Studentwise)" Value="Details (Studentwise)"></asp:ListItem>--%>
                                                </asp:RadioButtonList>
                                            </div>
                                        </div>
