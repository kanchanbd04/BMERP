<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="amstdstrengthacc.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.amstdstrengthacc" %>
    ...
    <script type="text/javascript">
        ...
        function fnShowReport() {
          ...
          <%--  var xbank1 = $("#<%= xbank.ClientID%>").val();--%>
            ...
            var openwin = window.open('/forms/academic/reports/amstdstrengthaccrpt.aspx?zid=' + zid  + '&xsession=' + xsession1, 'amtfcadmitcardrpt', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, copyhistory=no, width=' + screen.width + ', height=' + screen.height + ', top=0, left=0, targets=_blank');
            openwin.focus();
            //openwin.print();
            return false;
        }
