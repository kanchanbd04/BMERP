<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="amaccclearance_admitcard.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.amaccclearance_admitcard" %>
...
<%--            var xsession1 = '';
          ...
          var zid = <%= HttpContext.Current.Session["business"] %>;
           ...
           <%-- var xpaytype1 = $("#<%= xpaytype.ClientID%>").val();
            ...
            var rb = document.getElementById("<%=RadioButtonList2.ClientID%>");
            ...
            <%--var xtrm = $("#<%= xterm.ClientID%>").val().split(" ");
            ...
            var openwin = window.open('/forms/academic/reports/amaccclearance_admitcardrpt.aspx?zid=' + zid + '&xclass=' + xclass1 + '&xschool=' + xschool1 + '&xflag=' + xtype1  + '&xsession=' + xsession1 + '&xsection=' + xsection1 + '&xterm=' + xterm1, 'amaccclearance_admitcard', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, copyhistory=no, width=' + screen.width + ', height=' + screen.height + ', top=0, left=0, targets=_blank');
             openwin.focus();
             //openwin.print();
             return false;
         }
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Admit Card Status</span>
                    </div>
                </div>
                                    ...
                                    <div style="width: 100%; clear: both;">
                                        ...
                                        <div class="bm_ctl_container_50_50" style="float: left; width: 270px">
                                         ...
                                         <div class="bm_clt_padding">
                                          ...
                                          <div class="bm_ctl_container_100_special" style="width: 270px; ">
                                            <div class="bm_ctl_label_align_right_100_special" style="width: 120px">
                                                <asp:Label ID="Label13" runat="server" Text="Term :" AssociatedControlID="xterm"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_100_special" style="width: 148px">
                                         ...
                                         <div style="width: 100%">
                                            <div class="bm_ctl_container_100_special" style="width: 120px; float: left;">
                                                <div class="bm_ctl_label_align_right_100_special" style="width: 100%">
                                                    <asp:Label ID="Label2222" runat="server" Text=" Status :"
                                                        CssClass="label"></asp:Label>
                                                </div>
                                            </div>
                                            ...
                                            <div style="float: left; padding-left: 5px">
                                                <asp:RadioButtonList ID="RadioButtonList2" runat="server" RepeatDirection="Horizontal" >
                                                    <asp:ListItem Text="Sent" Value="Sent" Selected="True"></asp:ListItem>
                                                    <asp:ListItem Text="Not Sent" Value="Not Sent"></asp:ListItem>
                                                </asp:RadioButtonList>
                                            </div>
                                        </div>
