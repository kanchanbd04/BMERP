<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="amtfcdue5.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.amtfcdue5" %>
        ...
        <ContentTemplate>
            <script type="text/javascript">
               ...
               <%--$("body").on("blur", "#<%=xtfccode.ClientID%>", function() {
                ...
                $("body").on("blur", "[id*=xstdid]", function() {
                    //alert("hi");
                  ...
                  <%--  var xclass1 = $("#<%=xclass.ClientID%>").val();
                   ...
                   <%-- var xeffdate1 = $("#<%=xcdate.ClientID%>").val();
                    ...
                    $.ajax({
                        ...
                        data: "{ zid: '" + zid1 + "', xsession:'" + xsession1 + "', xstdid: '" + xstdid1 + "' }",
                        dataType: "json",
                        contentType: "application/json; charset=utf-8",
                        success: function (data) {
                            //alert(data.d);
                     ...
                     <%--    //$("#<%=xname.ClientID%>").val(student.xname);
                            ...
                            row.cells[2].getElementsByTagName("input")[0].value = stdinfo.xclass;
                ...
                $("body").on("change keyup", "[id*=xamount]", function() {
                    //if (window.event.keyCode == 67) {
                    //    //alert("c");
                    //    var row = this.parentNode.parentNode;
                    //    var rowIndex = row.rowIndex - 1;
                    //    $(this).val(row.cells[4].innerHTML);
                ...
                $("body").on("change keyup", "[id*=xamtdue]", function() {
                    //if (window.event.keyCode == 67) {
                    //    //alert("c");
                    //    var row = this.parentNode.parentNode;
                    //    var rowIndex = row.rowIndex - 1;
                ...
                $("body").on("keyup", "[id*=xamtdue]", function() {
                    enter(this, event);
                });
                ...
                $("body").on("click", ".bm_student", function () {
                    ...
                    if (xst == '' || xst == 'New' || xst == 'Undo' || xst == 'Undo1')
                    {
                        fnOpenStudentList4(<%= HttpContext.Current.Session["business"] %>,$(this).parent(".bm_list_img").siblings(".bm_list_text").find(".bm_academic_textbox").attr("ID"),$(this).parent(".bm_list_img").siblings(".bm_list_text").find(".bm_academic_textbox").val());
                    }
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Generate Due Classwise</span>
                    </div>
                </div>
                    ...
                    <div class="bm_academic_container_body_button_section">
                        <div class="button_section_padding" style="border-bottom: 0px;">
                            <div class="button_section_style1" style="text-align: left; margin-bottom: 5px;">
                                ...
                                <asp:Button ID="btnSave" runat="server" Text="Generate" CssClass="bm_academic_button3 bm_am_btn_save"
                                ...
                                <div class="bm_hotkey" style="clear: both; padding-left: 10px; padding-bottom: 5px">
                                    <table style="border: 1px solid white">
                                        <tr style="border: 1px solid white">
                                            ...
                                            <td style="background-color: silver; color: green; margin: 1px">Generate - F10</td>
                                    ...
                                    <div style="width: 100%; clear: both;">
                                        ...
                                        <div style="width: 100%">
                                            <div class="bm_ctl_container_100_special" style="width: 120px; float: left;">
                                                <div class="bm_ctl_label_align_right_100_special" style="width: 100%">
                                                    <asp:Label ID="Label2222" runat="server" Text="Type :"
                                                        CssClass="label"></asp:Label>
                                                </div>
                                            </div>
                                        ...
                                        <div>
                                            <div class="bm_ctl_container_50_100" style="width: 270px; float: left">
                                                <div class="bm_ctl_label_align_right_50_100" style="width: 120px">
                                                    <asp:Label ID="Label4" runat="server" Text=" TFC Code :" AssociatedControlID="xtfccode"
                                                        CssClass="label"></asp:Label>
                                                </div>
                                                <div class="bm_clt_ctl_50_100" style="width: 148px">
                                                    ...
                                                    <div class="bm_list_text" style="width: 120px">
                                                        <asp:TextBox ID="xtfccode" runat="server" CssClass="bm_academic_textbox_50_100 bm_academic_ctl_global bm_academic_textbox "
                                                            AutoPostBack="True" OnTextChanged="xtfccode_OnTextChanged"></asp:TextBox>
                                                    </div>
                                                    <div class="bm_list_img">
                                                        <asp:Image ID="Image1" runat="server" ImageUrl="~/images/list-am32x32.png" CssClass="bm_academic_list bm_tfccode" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div style="float: left; padding-left: 5px; padding-top: 1px">
                                                <asp:Label ID="xtfccodetitle" runat="server" Text="" CssClass="xtfccodetitle"></asp:Label>
                                            </div>
                                       ...
                                       <%-- <div class="bm_clt_padding">
                                        ...
                                        <div class="bm_ctl_container_50_50" style="float: left; width: 350px; display: none;">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label18" runat="server" Text="Description :" AssociatedControlID="xdescdet"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 228px">
                                                ...
                                                <asp:TextBox ID="xdescdet" runat="server" CssClass="bm_academic_textbox_50_40 bm_academic_ctl_global bm_academic_textbox" Enabled="False"></asp:TextBox>
                                            </div>
                                        </div>
                                       <%-- <div class="bm_clt_padding">
                                        </div>--%>
                                        <div class="bm_ctl_container_50_50" style="float: left; width: 270px;display: none;">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label6" runat="server" Text="Amount :" AssociatedControlID="xamount"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 148px">
                                        ...
                                        <div class="bm_ctl_container_50_50" style="float: left; width: 270px">
                                            ...
                                            <div class="bm_clt_ctl_50_50" style="width: 148px">
                                                ...
                                                <asp:DropDownList ID="xcdate" runat="server" CssClass="bm_academic_dropdown_50_50 bm_academic_ctl_global bm_academic_dropdown bm_xclass" AutoPostBack="True" OnSelectedIndexChanged="xcdate_OnSelectedIndexChanged">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                            </div>
                                       ...
                                       <%-- <div class="bm_clt_padding">
                                        ...
                                        <div style="display: none;">
                                            <div class="bm_ctl_container_100_special" style="width: 270px; float: left;">
                                                <div class="bm_ctl_label_align_right_100_special" style="width: 120px">
                                            ...
                                            <div style="float: left; margin-top: 1px;">
                                                <asp:Button ID="btnGenerate" runat="server" Text="Generate" CssClass="bm_academic_button5 bm_am_btn_addnew" Width="120px"
                                            ...
                                            <ContentTemplate>--%>
                                               <%-- OnRowDataBound="OnRowDataBound"--%>
                                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" ShowFooter="True"
                                                    ...
                                                    RowStyle-CssClass="RowStyle" AlternatingRowStyle-CssClass="AlternatingRowStyle" OnRowDataBound="OnRowDataBound"
                                                    ...
                                                    <Columns>
                                                      ...
                                                      <%--  <asp:TemplateField HeaderText="Student ID">
                                                            ...
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:TextBox ID="xstdid" runat="server" CssClass="bm_academic_textbox_50_100 bm_academic_ctl_global bm_academic_textbox " Enabled="False" ForeColor="black" BackColor="Transparent"></asp:TextBox>
                                                            </ItemTemplate>
                                                       ...
                                                       <%-- <asp:TemplateField HeaderText="Student Name">
                                                            ...
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:TextBox ID="xname" runat="server" CssClass="bm_academic_textbox_50_100 bm_academic_ctl_global bm_academic_textbox " Enabled="False" ForeColor="black" BackColor="Transparent"></asp:TextBox>
                                                       ...
                                                       <%-- <asp:TemplateField HeaderText="Class">
                                                            ...
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:TextBox ID="xclass" runat="server" CssClass="bm_academic_textbox_50_100 bm_academic_ctl_global bm_academic_textbox " Enabled="False" ForeColor="black" BackColor="Transparent"></asp:TextBox>

                                                            </ItemTemplate>
                                                        </asp:TemplateField>--%>
                                                        
                                                    <%--    <asp:BoundField DataField="xclass" HeaderText="Classes" ItemStyle-Width="150px"
                                                    ItemStyle-HorizontalAlign="Left" ItemStyle-CssClass="pad5" />
                                                        ...
                                                        <asp:TemplateField HeaderText="Amount">
                                                            ...
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:TextBox ID="xamtdue" runat="server" CssClass="bm_academic_textbox_grid bm_academic_ctl_global bm_academic_textbox right xamtdue"></asp:TextBox>
...
<%--                                                        <asp:TemplateField>
                                ...
                                <div class="button_section_padding">
                                    <div class="button_section_style1" style="text-align: left; margin-top: 10px;">
                                        <asp:Button ID="btnRefresh1" runat="server" Text="Refresh" CssClass="bm_academic_button3 bm_am_btn_refresh"
                                            OnClick="btnRefresh_Click" />
                                        <asp:Button ID="btnSave1" runat="server" Text="Generate" CssClass="bm_academic_button3 bm_am_btn_save"
                                            OnClick="btnSave_Click" />
                                        ...
                                        <div class="grid_body">
                                            <asp:GridView ID="dgvgenerateduesnew" runat="server" AutoGenerateColumns="False" ShowFooter="False"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="xsession" HeaderText="Session" ItemStyle-Width="150px"
                                                        ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="pad5" />
                                                    <asp:BoundField DataField="xtfccode" HeaderText="TFC Code" ItemStyle-Width="150px"
                                                        ItemStyle-HorizontalAlign="Center" ItemStyle-CssClass="pad5" />
                                                    <asp:BoundField DataField="xdescdet" HeaderText="Description" ItemStyle-Width="250px"
                                                        ItemStyle-HorizontalAlign="Left" ItemStyle-CssClass="pad5" />
                                                 ...
                                                 <asp:BoundField DataField="xcdate" HeaderText="Charge Period" DataFormatString="{0:MMM-yy}"
                                                    ...
                                                    <asp:BoundField DataField="xusername" HeaderText="Entered By" ItemStyle-Width="250px"
                                                        ItemStyle-HorizontalAlign="Left" ItemStyle-CssClass="pad5" />
                                                    <asp:TemplateField>
                                                        <ItemTemplate>
                                                        </ItemTemplate>
                                    ...
                                    <div class="bm_academic_grid_container" id="Div1" runat="server">
                                        <div class="grid_header">
                                            <div class="grid_header_label" id="Div2" runat="server">
                                                List of Generated Dues (Confirmed)
                                            </div>
                                            <div class="grid_header_control">
                                            </div>
                                            <div class="flot_right">
            ...
            <cc1:ModalPopupExtender ID="ModalPopupExtender1" runat="server" TargetControlID="btnShowList"
                ...
                <asp:HiddenField ID="_class" runat="server" />
                <asp:HiddenField ID="_group" runat="server" />
        </ContentTemplate>
    </asp:UpdatePanel>
</asp:Content>
