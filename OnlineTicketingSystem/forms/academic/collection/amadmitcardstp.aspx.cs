...
{
    public partial class amadmitcardstp : System.Web.UI.Page
    {
...
//                   ORDER BY xname";
            ...
            str = @"select xrow, xname, xstdid,xemail1,
                   ...
                   (select xdue from amtfcduecalvw4 where zid=amstudentvwextacc.zid and xsession=amstudentvwextacc.xsession and xsrow=amstudentvwextacc.xrow) as xdue
            ...
            if (dtmarks.Rows.Count > 0)
            {
                ...
                string str2 = "";                
                    ...
                    bfield = new BoundField();
                    bfield.HeaderText = "Fees dues remain till date (Tk.)";
                    //bfield.SortExpression = "xname";
        ...
        private void SendMail(int zid1, string xsession1, string xterm1, string xstdid1)
        {
            ...
            string filename = Server.MapPath("~/admitcard.html");
            ...
            //else if (xterm1 == "Mock")
            //{
            //    if (trm[1].Trim().ToString() == "Final")
            //    {
            //        xterm2 = "Final Mock Exam";
            //    }
            //    else
            //    {
            //        xterm2 = "Mock Exam"; 
            ...
            xterm2 = xterm.SelectedItem.Text;
            ...
            crystalReport.SetParameterValue("xterm", xterm2);
