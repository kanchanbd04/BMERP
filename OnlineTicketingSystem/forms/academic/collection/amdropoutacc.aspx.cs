...
{
    public partial class amdropoutacc : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                using (TransactionScope tran = new TransactionScope())
                {
                    using (SqlConnection conn = new SqlConnection(zglobal.constring))
                    {
                        ...
                        string query =
                            "UPDATE amdropout SET xstatus1=@xstatus1,xemailacc=@xemailacc,xapproveaccdt=@xapproveaccdt,xdateacc=@xdateacc,xremarksacc=@xremarksacc " +
                            "WHERE zid=@zid AND xrow=@xrow ";
                        ...
                        cmd.CommandText = query;
                        cmd.Parameters.AddWithValue("@zid", _zid);
                        cmd.Parameters.AddWithValue("@xrow", Convert.ToInt32(lblstdrow.Text));
                        cmd.Parameters.AddWithValue("@xstatus1", xstatus);
                        cmd.Parameters.AddWithValue("@xemailacc", xsubmitedby);
                        cmd.Parameters.AddWithValue("@xapproveaccdt", xsubmitdt);
                        cmd.Parameters.AddWithValue("@xremarksacc", xremarksacc1);
                        cmd.Parameters.AddWithValue("@xdateacc", xdateacc1);
                        cmd.ExecuteNonQuery();
                        ...
                        using (DataSet dts = new DataSet())
                        {
                            ...
                            query =
                               ...
                               "WHERE zid=@zid AND  xstdid=@xstdid AND xsession=@xsession and coalesce(xstatus,'')='Seat Conf'";
                            ...
                            {
                                query =
                                    "UPDATE amtfcseatconf SET zactive=0, zactiveacc=0 WHERE zid=@zid AND xrow=@xrow AND xstdid=@xstdid and coalesce(xstatus,'')='Seat Conf'";
