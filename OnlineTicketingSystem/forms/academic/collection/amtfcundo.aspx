<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="amtfcundo.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.amtfcundo" %>
        ...
        <ContentTemplate>
            <script type="text/javascript">
                ...
                function ConfirmMessage() {
                    var selectedvalue = confirm("Do you want to undo record?");
                    if (selectedvalue) {
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Transaction Undo</span>
                    </div>
                </div>
                    ...
                    <div class="bm_academic_container_body_button_section">
                        <div class="button_section_padding" style="border-bottom: 0px; padding-bottom: 0px">
                            <div class="button_section_style1" style="text-align: left; margin-bottom: 5px;">
                                <asp:Button ID="btnUndo" runat="server" Text="Undo" CssClass="bm_academic_button3 bm_am_btn_refresh"
                                    OnClientClick="javascript:ConfirmMessage();" OnClick="btnUndo_Click" />
                                    ...
                                    <div style="width: 100%; clear: both;">
                                        <div style="width: 100%">
                                            ...
                                            <div style="float: left;padding-left: 5px">
                                                <asp:RadioButton AutoPostBack="True" ID="rdoDue" runat="server" GroupName="tfctype" Text="Due" OnCheckedChanged="rdo_OnCheckedChanged"/>
                                            </div>
                                            <div style="float: left;padding-left: 15px">
                                                <asp:RadioButton AutoPostBack="True" ID="rdoCollection" runat="server" GroupName="tfctype" Text="Collection" OnCheckedChanged="rdo_OnCheckedChanged"/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="bm_ctl_container_50_50" style="float: left; width: 350px;">
                                            <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                <asp:Label ID="Label18" runat="server" Text="Transaction No :" AssociatedControlID="xrow"
                                                    CssClass="label"></asp:Label>
                                            </div>
                                            <div class="bm_clt_ctl_50_50" style="width: 228px">

                                                <asp:TextBox ID="xrow" runat="server" CssClass="bm_academic_textbox_50_40 bm_academic_ctl_global bm_academic_textbox"></asp:TextBox>
                                            </div>
                                        </div>
                            ...
                            <div class="bm_academic_container_body_button_section">
                                <div class="button_section_padding">
                                    <div class="button_section_style1" style="text-align: left; margin-top: 10px;">
                                        <asp:Button ID="btnUndo1" runat="server" Text="Undo" CssClass="bm_academic_button3 bm_am_btn_refresh"
                                            OnClientClick="javascript:ConfirmMessage();" OnClick="btnUndo_Click" />
