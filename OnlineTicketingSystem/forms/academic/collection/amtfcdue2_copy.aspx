<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="amtfcdue2_copy.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.amtfcdue2_copy" %>
            ...
            <script type="text/javascript">
               ...
               <%-- $("body").on("blur", "#<%=xstdid.ClientID%>", function() {
                ...
                $("body").on("blur", "[id*=xtfccode]", function() {
                   ...
                   $.ajax({
                        type: "POST",
                        url: "/edusoft.asmx/TFCCodeInfo",
                        data: "{ zid: '" + zid1 + "', xrow:'" + xrow1 + "', xclass: '" + xclass1 + "', xgroup: '"+xgroup1+"', xstdid: '"+xstdid1+"', xeffdate: '"+xeffdate1+"', xtfccode: '"+xtfccode1+"' }",
                        dataType: "json",
                        contentType: "application/json; charset=utf-8",
                        success: function (data) {
                            //alert(data.d);
                         ...
                         //$("#<%=xname.ClientID%>").val(student.xname);
                            ...
                            row.cells[2].getElementsByTagName("input")[0].value = tfccode.xamount;
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Generate Due Studentwise</span>
                    </div>
                </div>
                                            ...
                                            <div style="float: left;">
                                                <div class="bm_ctl_container_50_50" style="float: left; width: 270px">
                                                    <div class="bm_ctl_label_align_right_50_50" style="width: 120px">
                                                        <asp:Label ID="Label6" runat="server" Text="Transaction No :" AssociatedControlID="xrow1"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Amount">
                                                    ...
                                                    <ItemTemplate>
                                                            ...
                                                            <asp:TextBox ID="xamtdue" runat="server" CssClass="bm_academic_textbox_50_100 bm_academic_ctl_global bm_academic_textbox " ></asp:TextBox>
