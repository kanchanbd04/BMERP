...
{
    public partial class amtfcreadmission1 : System.Web.UI.Page
    {
            ...
            try
            {
                if (!IsPostBack)
                {
                    ...
                    string xrow = zglobal.fnGetValue("xrow", "amtfch",
                                   "zid=" + Convert.ToInt32(Convert.ToString(HttpContext.Current.Session["business"])) +
                                   " AND xsrow=" + Convert.ToInt64(ViewState["xrow1"]) + " AND xtype='Readmission' AND xsession='" + xsession.Text.Trim().ToString() + "'");
                    if (xrow != "")
                    {
                        ViewState["xrow"] = xrow;
        ...
        private void BindGrid()
        {
            ...
            {
                str =
               "SELECT  xtfccode,xdescdet,xtype,xamount,xdisfixed,xdisperc,xvatfixed,xvatperc,xnettotal,xnettotal1,xdiscount,xvat,xreceived,xremarks1 FROM amtfcvw " +
            ...
            {
               // str =
               //"SELECT  xtfccode,xdescdet,xtype,xamount,xdisfixed,xdisperc,xvatfixed,xvatperc,xnettotal,xnettotal1,xdiscount,xvat FROM amtfcconfigvw1 " +
               //"WHERE zid=@zid AND xtype='Admission' AND zactive=1 AND xclass=@xclass AND xgroup=@xgroup " +
            ...
            if (dtmarks.Rows.Count > 0)
            {
                ...
                //bfield = new BoundField();
                //bfield.HeaderText = "Discount \n (Fixed)";
                //bfield.DataField = "xdisfixed";
                ...
                bfield = new BoundField();
                bfield.HeaderText = "Net Total <br> (After Discount)";
                bfield.HtmlEncode = false;
                bfield.DataField = "xnettotal";
                bfield.ItemStyle.Width = 120;
                bfield.ItemStyle.HorizontalAlign = HorizontalAlign.Right;
                GridView1.Columns.Add(bfield);

                //bfield = new BoundField();
                //bfield.HeaderText = "VAT \n (Fixed)";
                //bfield.DataField = "xvatfixed";
                //bfield.ItemStyle.Width = 150;
                //bfield.ItemStyle.HorizontalAlign = HorizontalAlign.Right;
                //GridView1.Columns.Add(bfield);
                ...
                bfield = new BoundField();
                bfield.HeaderText = "Net Total <br> (Including VAT)";
                ...
                tfield = new TemplateField();
                tfield.HeaderText = "Received <br> Amount";
                tfield.ItemStyle.HorizontalAlign = HorizontalAlign.Right;
                tfield.ItemStyle.Width = 120;
                GridView1.Columns.Add(tfield);

                tfield = new TemplateField();
                tfield.HeaderText = "Due <br> Amount";
                tfield.ItemStyle.HorizontalAlign = HorizontalAlign.Right;
                tfield.ItemStyle.Width = 120;
                GridView1.Columns.Add(tfield);

                //tfield = new TemplateField();
                //tfield.HeaderText = "Due";
                //tfield.ItemStyle.HorizontalAlign = HorizontalAlign.Right;
        ...
        private decimal xdefault = 0;
        private decimal xdisfixed = 0;
        private decimal xdisperc = 0;
        private decimal xdiscount = 0;
        private decimal xnettotal = 0;
        private decimal xvatfixed = 0;
        private decimal xvatperc = 0;
        private decimal xvat = 0;
        ...
        protected void OnRowDataBound(object sender, GridViewRowEventArgs e)
        {
            try
            {
                ...
                if (e.Row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    xdefault += Convert.ToDecimal(DataBinder.Eval(e.Row.DataItem, "xamount"));
                    //xdisfixed += Convert.ToDecimal(DataBinder.Eval(e.Row.DataItem, "xdisfixed"));
                    //xdisperc += Convert.ToDecimal(DataBinder.Eval(e.Row.DataItem, "xdisperc"));
                    xdiscount += Convert.ToDecimal(DataBinder.Eval(e.Row.DataItem, "xdiscount"));
                    xnettotal += Convert.ToDecimal(DataBinder.Eval(e.Row.DataItem, "xnettotal"));
                    //xvatfixed += Convert.ToDecimal(DataBinder.Eval(e.Row.DataItem, "xvatfixed"));
                    //xvatperc += Convert.ToDecimal(DataBinder.Eval(e.Row.DataItem, "xvatperc"));
                    xvat += Convert.ToDecimal(DataBinder.Eval(e.Row.DataItem, "xvat"));
                    ...
                    TextBox txtxdisfixed = new TextBox();
                    txtxdisfixed.ID = "xdisfixed";
                    //txtxdisfixed.CssClass = "xdisfixed";
                    //txtxdisfixed.ClientIDMode = ClientIDMode.Static;
                    txtxdisfixed.CssClass = "bm_academic_textbox_grid bm_academic_ctl_global bm_academic_textbox right xdisfixed";
                    txtxdisfixed.Attributes.Add("onkeyup", "enter(this,event)");
                    txtxdisfixed.Text = (e.Row.DataItem as DataRowView).Row["xdisfixed"].ToString();
                    e.Row.Cells[3].Controls.Add(txtxdisfixed);

                    TextBox txtxdisperc = new TextBox();
                    txtxdisperc.ID = "xdisperc";
                    //txtxdisperc.CssClass = "xdisperc";
                    // txtxdisperc.ClientIDMode = ClientIDMode.Static;
                    txtxdisperc.CssClass = "bm_academic_textbox_grid bm_academic_ctl_global bm_academic_textbox right xdisperc";
                    txtxdisperc.Attributes.Add("onkeyup", "enter(this,event)");
                    txtxdisperc.Text = (e.Row.DataItem as DataRowView).Row["xdisperc"].ToString();
                    e.Row.Cells[4].Controls.Add(txtxdisperc);



                    TextBox txtxvatfixed = new TextBox();
                    txtxvatfixed.ID = "xvatfixed";
                    //txtxvatfixed.CssClass = "xvatfixed";
                    //txtxvatfixed.ClientIDMode = ClientIDMode.Static;
                    txtxvatfixed.CssClass = "bm_academic_textbox_grid bm_academic_ctl_global bm_academic_textbox right xvatfixed";
                    txtxvatfixed.Attributes.Add("onkeyup", "enter(this,event)");
                    txtxvatfixed.Text = (e.Row.DataItem as DataRowView).Row["xvatfixed"].ToString();
                    e.Row.Cells[7].Controls.Add(txtxvatfixed);

                    TextBox txtxvatperc = new TextBox();
                    txtxvatperc.ID = "xvatperc";
                    //txtxvatperc.CssClass = "xvatperc";
                    //txtxvatperc.ClientIDMode=ClientIDMode.Static;
                    txtxvatperc.CssClass = "bm_academic_textbox_grid bm_academic_ctl_global bm_academic_textbox right xvatperc";
                    txtxvatperc.Attributes.Add("onkeyup", "enter(this,event)");
                    txtxvatperc.Text = (e.Row.DataItem as DataRowView).Row["xvatperc"].ToString();
                    e.Row.Cells[8].Controls.Add(txtxvatperc);
                    ...
                    e.Row.Cells[11].Controls.Add(txtReceive);

                    //Label lblxdue = new Label();
                    //lblxdue.ID = "xdue";
                    //lblxdue.CssClass = "right xdue";
                    //e.Row.Cells[1].Controls.Add(lblxdue);

                    //if (e.Row.Cells[7].Text.ToString() == "" ||
                    //    e.Row.Cells[7].Text.ToString() == (e.Row.DataItem as DataRowView).Row["xnettotal1"].ToString())
                    //{
                    //    txtReceive.Text = (e.Row.DataItem as DataRowView).Row["xnettotal1"].ToString();
                    //}
                    ...
                    //xreceived += Convert.ToDecimal(txtReceive.Text.ToString().Trim() == "" || txtReceive.Text.ToString().Trim() == string.Empty
                    //    ? "0" : txtReceive.Text.ToString().Trim());
                    ...
                    e.Row.Cells[13].Controls.Add(txtRemarks);


                    //decimal xamount1 = Convert.ToDecimal(e.Row.Cells[2].Text);
                    ////decimal xdisfixed1 = Convert.ToDecimal(e.Row.Cells[3].Text);
                    ////decimal xdisperc1 = Convert.ToDecimal(e.Row.Cells[4].Text);
                    //decimal xdiscount1 = Convert.ToDecimal(e.Row.Cells[5].Text);
                    //decimal xnettotal11 = Convert.ToDecimal(e.Row.Cells[6].Text);
                    ////decimal xvatfixed1 = Convert.ToDecimal(e.Row.Cells[7].Text);
                    ////decimal xvatperc1 = Convert.ToDecimal(e.Row.Cells[8].Text);
                    //decimal xvat1 = Convert.ToDecimal(e.Row.Cells[9].Text);
                    //decimal xnettotal111 = Convert.ToDecimal(e.Row.Cells[10].Text);

                    //e.Row.Cells[2].Text = string.Format(zglobal.GetCultureInfo(), zglobal.CurrecnyFormatSpecifierGridView, xamount1);
                    ////e.Row.Cells[3].Text = string.Format(zglobal.GetCultureInfo(), zglobal.CurrecnyFormatSpecifierGridView, xdisfixed1);
                    ////e.Row.Cells[4].Text = string.Format(zglobal.GetCultureInfo(), zglobal.CurrecnyFormatSpecifierGridView, xdisperc1);
                    //e.Row.Cells[5].Text = string.Format(zglobal.GetCultureInfo(), zglobal.CurrecnyFormatSpecifierGridView, xdiscount1);
                    //e.Row.Cells[6].Text = string.Format(zglobal.GetCultureInfo(), zglobal.CurrecnyFormatSpecifierGridView, xnettotal11);
                    ////e.Row.Cells[7].Text = string.Format(zglobal.GetCultureInfo(), zglobal.CurrecnyFormatSpecifierGridView, xvatfixed1);
                    ////e.Row.Cells[8].Text = string.Format(zglobal.GetCultureInfo(), zglobal.CurrecnyFormatSpecifierGridView, xvatperc1);
                    //e.Row.Cells[9].Text = string.Format(zglobal.GetCultureInfo(), zglobal.CurrecnyFormatSpecifierGridView, xvat1);
                    //e.Row.Cells[10].Text = string.Format(zglobal.GetCultureInfo(), zglobal.CurrecnyFormatSpecifierGridView, xnettotal111);
                    ...
                    if (ViewState["amtfcd"] != null)
                    {
                        ...
                        foreach (DataRow row in dt.Rows)
                        {
                            if (row["xtfccode"].ToString() == e.Row.Cells[0].Text.ToString())
                            {
                                ...
                                txtxdisfixed.Text = row["xdisfixed"].ToString();
                                txtxdisperc.Text = row["xdisperc"].ToString();
                                txtxvatfixed.Text = row["xvatfixed"].ToString();
                                txtxvatperc.Text = row["xvatperc"].ToString();
                    ...
                    if (ViewState["xstatus"] != null)
                    {
                        if (ViewState["xstatus"].ToString() == "Paid")
                        {
                            txtReceive.Enabled = false;
                            txtRemarks.Enabled = false;
                            txtxdisfixed.Enabled = false;
                            txtxdisperc.Enabled = false;
                            txtxvatfixed.Enabled = false;
                            txtxvatperc.Enabled = false;
                ...
                if (e.Row.RowType == DataControlRowType.Footer)
                {
                    ...
                    e.Row.Cells[2].Text = xdefault.ToString(zglobal.CurrecnyFormatSpecifier, zglobal.GetCultureInfo());
                    e.Row.Cells[2].Font.Bold = true;
                    e.Row.Cells[2].HorizontalAlign = HorizontalAlign.Right;
                    e.Row.Cells[2].ForeColor = Color.White;

                    //e.Row.Cells[3].Text = xdisfixed.ToString(zglobal.CurrecnyFormatSpecifier, zglobal.GetCultureInfo());
                    ...
                    //e.Row.Cells[4].Text = xdisperc.ToString(zglobal.CurrecnyFormatSpecifier, zglobal.GetCultureInfo());
                    ...
                    e.Row.Cells[5].Text = xdiscount.ToString(zglobal.CurrecnyFormatSpecifier, zglobal.GetCultureInfo());
                    e.Row.Cells[5].Font.Bold = true;
                    e.Row.Cells[5].HorizontalAlign = HorizontalAlign.Right;
                    e.Row.Cells[5].ForeColor = Color.White;

                    e.Row.Cells[6].Text = xnettotal.ToString(zglobal.CurrecnyFormatSpecifier, zglobal.GetCultureInfo());
                    e.Row.Cells[6].Font.Bold = true;
                    e.Row.Cells[6].HorizontalAlign = HorizontalAlign.Right;
                    e.Row.Cells[6].ForeColor = Color.White;

                    //e.Row.Cells[7].Text = xvatfixed.ToString(zglobal.CurrecnyFormatSpecifier, zglobal.GetCultureInfo());
                    ...
                    //e.Row.Cells[8].Text = xvatperc.ToString(zglobal.CurrecnyFormatSpecifier, zglobal.GetCultureInfo());
                    ...
                    e.Row.Cells[9].Text = xvat.ToString(zglobal.CurrecnyFormatSpecifier, zglobal.GetCultureInfo());
                    e.Row.Cells[9].Font.Bold = true;
                    e.Row.Cells[9].HorizontalAlign = HorizontalAlign.Right;
                    e.Row.Cells[9].ForeColor = Color.White;

                    e.Row.Cells[10].Text = xnettotal1.ToString(zglobal.CurrecnyFormatSpecifier, zglobal.GetCultureInfo());
                ...
                using (TransactionScope tran = new TransactionScope())
                {
                    ...
                    if (ViewState["xrow"] == null)
                    {
                        ...
                        using (SqlConnection conn = new SqlConnection(zglobal.constring))
                        {
                            ...
                            xrow = zglobal.GetMaximumIdInt("xrow", "amtfch", " zid=" + _zid, 1, 1);
                            ViewState["xrow"] = xrow;
                            hiddenxrow.Value = xrow.ToString();
                    ...
                    using (SqlConnection conn = new SqlConnection(zglobal.constring))
                    {
                        ...
                        foreach (GridViewRow row in GridView1.Rows)
                        {
                            ...
                            cmd.Parameters.AddWithValue("@xdisfixed", xdisfixed12);
                            cmd.Parameters.AddWithValue("@xdisperc", xdisperc12);
                            cmd.Parameters.AddWithValue("@xdiscount", xdiscount12);
                            cmd.Parameters.AddWithValue("@xvatfixed", xvatfixed12);
                            cmd.Parameters.AddWithValue("@xvatperc", xvatperc12);
                            cmd.Parameters.AddWithValue("@xvat", xvat12);
        ...
        private void fnCalTotal()
        {
            ...
            GridView1.FooterRow.Cells[2].Text = xdefault.ToString(zglobal.CurrecnyFormatSpecifier, zglobal.GetCultureInfo());
            ...
            GridView1.FooterRow.Cells[3].Text = xdisfixed.ToString(zglobal.CurrecnyFormatSpecifier, zglobal.GetCultureInfo());
            ...
            try
            {
                ...
                if (GridView1.DataSource != null)
                {
                    foreach (GridViewRow row in GridView1.Rows)
                    {
                        ...
                        if (xrec.Text.Trim().ToString() == "" || xrec.Text.Trim().ToString() == String.Empty)
                        {
                            xrec.Text = Convert.ToDecimal(row.Cells[6].Text.ToString()).ToString("###0");
                            row.Cells[12].Text = Convert.ToDecimal("0").ToString("F");
                        }
                        if (xdisfixed1.Text.Trim().ToString() == "" || xdisfixed1.Text.Trim().ToString() == String.Empty)
                        {
                            xdisfixed1.Text = Convert.ToDecimal("0").ToString("###0");
                        }
                        if (xdisperc1.Text.Trim().ToString() == "" || xdisperc1.Text.Trim().ToString() == String.Empty)
                        {
                            xdisperc1.Text = Convert.ToDecimal("0").ToString("###0");
                        }
                        if (xvatfixed1.Text.Trim().ToString() == "" || xvatfixed1.Text.Trim().ToString() == String.Empty)
                        {
                            xvatfixed1.Text = Convert.ToDecimal("0").ToString("###0");
                        }
                        if (xvatperc1.Text.Trim().ToString() == "" || xvatperc1.Text.Trim().ToString() == String.Empty)
                        {
                            xvatperc1.Text = Convert.ToDecimal("0").ToString("###0");
                        }
                        //else
                        //{
                        xreceived += decimal.Parse(xrec.Text.Trim().ToString());
                    ...
                    GridView1.FooterRow.Cells[12].Text = Convert.ToDecimal("0").ToString(zglobal.CurrecnyFormatSpecifier, zglobal.GetCultureInfo());
                    GridView1.FooterRow.Cells[12].Font.Bold = true;
                    GridView1.FooterRow.Cells[12].HorizontalAlign = HorizontalAlign.Right;
                    GridView1.FooterRow.Cells[12].ForeColor = Color.White;
                }
