...
{
    public partial class amtfcdue4 : System.Web.UI.Page
    {
                    ...
                    using (SqlConnection conn = new SqlConnection(zglobal.constring))
                    {
                        ...
                        foreach (GridViewRow row in GridView1.Rows)
                        {
                            ...
                            //{
                                ...
                                query =
                                    "INSERT INTO amtfcdued (zid,xrow,xline,xtfccode,xamount,xdisfixed,xdisperc,xdiscount,xvatfixed,xvatperc,xvat,xamtdue,xremarks,xsrow) " +
