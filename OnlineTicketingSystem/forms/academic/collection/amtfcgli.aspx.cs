...
{
    public partial class amtfcgli : System.Web.UI.Page
    {
                        ...
                        if (ViewState["xrow"] == null)
                        {
                            ...
                            using (SqlConnection con = new SqlConnection(zglobal.constring))
                            {
                                using (DataSet dts = new DataSet())
                                {
                                    con.Open();
                                    string query =
                                        "SELECT * FROM glinterface WHERE zid=@zid AND xtype=@xtype AND xprefix=@xprefix AND xaccdr=@xaccdr AND xsubdr=@xsubdr AND xacccr=@xacccr AND xsubcr=@xsubcr and xmodule=@xmodule and xbank=@xbank";
