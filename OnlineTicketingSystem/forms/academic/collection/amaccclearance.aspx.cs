...
{
    public partial class amaccclearance : System.Web.UI.Page
    {
...
//                   ORDER BY xname";
            ...
            if (dtmarks.Rows.Count > 0)
            {
                ...
                using (SqlConnection conn = new SqlConnection(zglobal.constring))
                {
                    ...
                    {
                        string query = "SELECT xsrow,coalesce(xclearance,0) as xclearance FROM amaccclearance WHERE zid=@zid AND xsession=@xsession";
                    ...
                    if (GridView1.Rows.Count > 0)
                    {
                        ...
                        using (SqlConnection conn = new SqlConnection(zglobal.constring))
                        {
                            ...
                            foreach (GridViewRow row in GridView1.Rows)
                            {
                                ...
                                query = "DELETE FROM amaccclearance WHERE zid=@zid AND xsession=@xsession AND xsrow=@xsrow ";
                                ...
                                query = "INSERT INTO amaccclearance (ztime,zid,xsession,xsrow,xclearance,zemail,xterm) " +
                                       "VALUES(@ztime,@zid,@xsession,@xsrow,@xclearance,@zemail,@xterm) ";
