...
{
    public partial class amtfcconfig1_old : System.Web.UI.Page
    {
                ...
                using (TransactionScope tran = new TransactionScope())
                {
                    ...
                    using (SqlConnection conn = new SqlConnection(zglobal.constring))
                    {
                        ...
                        foreach (GridViewRow row in GridView1.Rows)
                        {
                            ...
                            query =
                                     "INSERT INTO amtfcconfig (ztime,zid,xrow,xtfccode,xclass,xgroup,xsection,xstdid,xamount,xdisfixed,xdisperc,xvatfixed,xvatperc,xsign,xeffdate,zactive,xstatus,xremarks,zemail,xsrow,xtype1,xsession,xdistype) " +
                                     "VALUES(@ztime,@zid,@xrow,@xtfccode,@xclass,'','',@xstdid,@xamount,@xdisfixed,@xdisperc,0,0,1,@xeffdate,1,'Submited',@xremarks,@zemail,@xsrow,@xtype1,@xsession,@xdistype) ";
                            ...
                            cmd.Parameters.AddWithValue("@xsession", xsession.Text);
                            cmd.Parameters.AddWithValue("@xsrow", xsrow1);
                            cmd.Parameters.AddWithValue("@xdistype", xdistype.Text.Trim().ToString());
            ...
            using (SqlConnection con = new SqlConnection(zglobal.constring))
            {
                using (DataSet dts1 = new DataSet())
                {
                    ...
                    string query =
                         ...
                         "(select xname from amadmis where zid=amtfcconfig.zid and xrow=amtfcconfig.xsrow) as xname,coalesce(xdistype,'-') as xdistype " +
