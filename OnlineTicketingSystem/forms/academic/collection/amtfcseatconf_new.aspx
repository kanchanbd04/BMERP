<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="amtfcseatconf_new.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.amtfcseatconf_new" %>
                ...
                $("body").on("change keyup", "[id*=xdiscount]", function () {
                    ...
                    $("[id*=xdiscount]").each(function () {
                        ...
                        if(quantity1!=0 || $.trim($(this).val())!="") {
                            ...
                            var discount = xdefamount * quantity1 / 100;

                            var netamount = xdefamount - discount;

                            grid.rows[i].cells[4].innerHTML = netamount;
