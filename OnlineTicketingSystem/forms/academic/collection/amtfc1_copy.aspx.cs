...
{
    public partial class amtfc1_copy : System.Web.UI.Page
    {
                ...
                using (TransactionScope tran = new TransactionScope())
                {
                    ...
                    using (SqlConnection conn = new SqlConnection(zglobal.constring))
                    {
                        ...
                        foreach (GridViewRow row in GridView1.Rows)
                        {
                            ...
                            cmd.Parameters.AddWithValue("@xtfccode", xtfccode1.Text.ToString().Trim());
        ...
        private void fnFillControl(string xrow123)
        {
            ...
            using (SqlConnection con = new SqlConnection(zglobal.constring))
            {
                using (DataSet dts1 = new DataSet())
                {
                    con.Open();
                    string query =
                         "SELECT xtfccode, xdescdet," +
                         "xreceived, xremarks,xamount, " +
                         ...
                         "FROM amtfcvw WHERE zid=@zid AND xrow=@xrow  " +
                         "order by xline";
                    ...
                    if (tempTable.Rows.Count > 0)
                    {
                        ...
                        foreach (DataRow row in tempTable.Rows)
                        {
                            ...
                            dr["Column3"] = tempTable.Rows[i]["xamount"].ToString();
                            dr["Column4"] = tempTable.Rows[i]["xdue"].ToString();
                            dr["Column5"] = tempTable.Rows[i]["xreceived"].ToString();
                        ...
                        foreach (GridViewRow row in GridView1.Rows)
                        {
                            ...
                            TextBox xamount1 = row.FindControl("xamount") as TextBox;
                            TextBox xreceivable1 = row.FindControl("xreceivable") as TextBox;
                            TextBox xreceived1 = row.FindControl("xreceived") as TextBox;
                            ...
                            xamount1.Text = tempTable.Rows[i]["xamount"].ToString();
                            xreceivable1.Text = tempTable.Rows[i]["xdue"].ToString();
                            xreceived1.Text = tempTable.Rows[i]["xreceived"].ToString();
                            ...
                            if (dttemp.Rows[0]["xstatus"].ToString() == "Paid")
                            {
                                ...
                                xamount1.Enabled = false;
                                xreceivable1.Enabled = false;
                                xreceived1.Enabled = false;
            ...
            if (dttemp.Rows[0]["xstatus"].ToString() == "New")
            {
                using (SqlConnection con = new SqlConnection(zglobal.constring))
                {
                    using (DataSet dts1 = new DataSet())
                    {
                        con.Open();
                        string query =
                            "SELECT  xtfccode,(select xdescdet from mscodesam where zid=amtfcduecalvw1.zid and xtype='TFC Code' and xcode=amtfcduecalvw1.xtfccode) as xdescdet, " +
                            "xsrow, " +
                            "xdue FROM amtfcduecalvw1 " +
                            "WHERE zid=@zid and xsession=@xsession and xsrow=(select xrow from amadmis where zid=amtfcduecalvw1.zid and xstdid=@xstdid and xdue<>0) ";
                        ...
                        if (tempTable.Rows.Count > 0)
                        {
                            List<String> xtfccd = new List<String>();
                            foreach (GridViewRow row in GridView1.Rows)
                            {
                                TextBox txtTextBox1 = row.FindControl("xtfccode") as TextBox;
                                xtfccd.Add(txtTextBox1.Text.Trim().ToString());
                            ...
                            {
                                TextBox box1 = (TextBox)GridView1.Rows[k].Cells[0].FindControl("xtfccode");
                                TextBox box2 = (TextBox)GridView1.Rows[k].Cells[1].FindControl("xdescdet");
                                TextBox box3 = (TextBox)GridView1.Rows[k].Cells[2].FindControl("xamount");
                                TextBox box4 = (TextBox)GridView1.Rows[k].Cells[3].FindControl("xreceivable");
                                TextBox box5 = (TextBox)GridView1.Rows[k].Cells[3].FindControl("xreceived");
                                TextBox box6 = (TextBox)GridView1.Rows[k].Cells[3].FindControl("xremarks");

                                //dt.Rows[k]["Column1"] = box1.Text;
                                //dt.Rows[k]["Column2"] = box2.Text;
                                //dt.Rows[k]["Column3"] = box3.Text;
                                //dt.Rows[k]["Column4"] = box4.Text;
                                //dt.Rows[k]["Column5"] = box5.Text;
                                //dt.Rows[k]["Column6"] = box6.Text;

                                dr = dt.NewRow();
                                dr["Column1"] = box1.Text;
                                dr["Column2"] = box2.Text;
                                dr["Column3"] = box3.Text;
                                dr["Column4"] = box4.Text;
                                dr["Column5"] = box5.Text;
                                dr["Column6"] = box6.Text;
                                dt.Rows.Add(dr);
                            ...
                            foreach (DataRow row in tempTable.Rows)
                            {
                                if (!xtfccd.Contains(row["xtfccode"].ToString()))
                                {
                                    ...
                                    using (DataSet dts2 = new DataSet())
                                    {
                                        query = zglobal.xtfcdefault2;

                                        SqlDataAdapter da2 = new SqlDataAdapter(query, con);
                                        da2.SelectCommand.Parameters.AddWithValue("@zid", _zid);
                                        da2.SelectCommand.Parameters.AddWithValue("@xclass",
                                            xclass.Text.Trim().ToString());
                                        da2.SelectCommand.Parameters.AddWithValue("@xgroup",
                                            xgroup.Text.Trim().ToString());
                                        da2.SelectCommand.Parameters.AddWithValue("@xsrow",
                                            row["xsrow"].ToString());
                                        da2.SelectCommand.Parameters.AddWithValue("@xeffdate", xeffdate1);
                                        da2.SelectCommand.Parameters.AddWithValue("@xtfccode",
                                            row["xtfccode"].ToString());
                                        da2.Fill(dts2, "tempztcode");
                                    ...
                                    dr = dt.NewRow();
                                    dr["Column1"] = row["xtfccode"].ToString();
                                    dr["Column2"] = row["xdescdet"].ToString();
                                    if (dttemp1.Rows.Count > 0)
                                    {
                                        dr["Column3"] = dttemp1.Rows[0]["xnettotal1"].ToString();
                                    }
                                    else
                                    {
                                        dr["Column3"] = string.Empty;
                            ...
                            int i = 0;
                            decimal xreceivable11 = 0;
                            decimal xreceived11 = 0;
                            ...
                            foreach (GridViewRow row in GridView1.Rows)
                            {
                                ...
                                xtfccode1.Text = dt.Rows[i]["Column1"].ToString();
                                xdescdet1.Text = dt.Rows[i]["Column2"].ToString();
                                xamount1.Text = dt.Rows[i]["Column3"].ToString();
                                xreceivable1.Text = dt.Rows[i]["Column4"].ToString();
                                xreceived1.Text = dt.Rows[i]["Column5"].ToString();
                                xremarks1.Text = dt.Rows[i]["Column6"].ToString();

                                if (dt.Rows[i]["Column4"].ToString() != String.Empty)
                                {
                                    xreceivable11 = xreceivable11 + decimal.Parse(dt.Rows[i]["Column4"].ToString());
                                }

                                if (dt.Rows[i]["Column5"].ToString() != String.Empty)
                                {
                                    xreceived11 = xreceived11 + decimal.Parse(dt.Rows[i]["Column5"].ToString());
                                }
                            ...
                            xreceivedtot1.Text = xreceived11.ToString(zglobal.CurrecnyFormatSpecifier, zglobal.GetCultureInfo()); ;
                            xreceivabletot1.Text = xreceivable11.ToString(zglobal.CurrecnyFormatSpecifier, zglobal.GetCultureInfo());
                        }
        ...
        protected void xcdate_OnTextChanged(object sender, EventArgs e)
        {
            try
            {
                            ...
                            if (tempTable.Rows.Count > 0)
                            {
                                ...
                                foreach (DataRow row in tempTable.Rows)
                                {
                                    ...
                                    using (DataSet dts2 = new DataSet())
                                    {
                                        ...
                                        SqlDataAdapter da = new SqlDataAdapter(query, con);
                                        da.SelectCommand.Parameters.AddWithValue("@zid", _zid);
                                        da.SelectCommand.Parameters.AddWithValue("@xclass",
                                            xclass.Text.Trim().ToString());
                                        da.SelectCommand.Parameters.AddWithValue("@xgroup",
                                            xgroup.Text.Trim().ToString());
                                        da.SelectCommand.Parameters.AddWithValue("@xsrow", row["xsrow"].ToString());
                                        da.SelectCommand.Parameters.AddWithValue("@xeffdate", xeffdate1);
                                        da.SelectCommand.Parameters.AddWithValue("@xtfccode", row["xtfccode"].ToString());
                                        da.Fill(dts2, "tempztcode");
                                    ...
                                    if (dttemp.Rows.Count > 0)
                                    {
                                        dr["Column3"] = dttemp.Rows[0]["xnettotal1"].ToString();
                                    }
                                    else
                                    {
                                        dr["Column3"] = string.Empty;
                ...
                else
                {
                    ...
                    string xstatus1 = zglobal.fnGetValue("xstatus", "amtfch",
                        "zid=" + _zid + " AND xrow=" + Int32.Parse(ViewState["xrow"].ToString()));
                    if (xstatus1 == "New")
                    {
                        using (SqlConnection con = new SqlConnection(zglobal.constring))
                        {
                                    ...
                                    foreach (DataRow row in tempTable.Rows)
                                    {
                                        if (!xtfccd.Contains(row["xtfccode"].ToString()))
                                        {
                                            ...
                                            using (DataSet dts2 = new DataSet())
                                            {
                                                ...
                                                da.SelectCommand.Parameters.AddWithValue("@xgroup",
                                                    xgroup.Text.Trim().ToString());
                                                da.SelectCommand.Parameters.AddWithValue("@xsrow",
                                                    row["xsrow"].ToString());
                                                da.SelectCommand.Parameters.AddWithValue("@xeffdate", xeffdate1);
                                                da.SelectCommand.Parameters.AddWithValue("@xtfccode",
                                                    row["xtfccode"].ToString());
                                                da.Fill(dts2, "tempztcode");
        ...
        private void fnCalculateTotal()
        {
            ...
            foreach (GridViewRow row in GridView1.Rows)
            {
                ...
                if (xreceivable1.Text.Trim().ToString() != String.Empty)
                {
                    xreceivable11 = xreceivable11 + decimal.Parse(xreceivable1.Text.Trim().ToString());
                }

                if (xreceived1.Text.Trim().ToString() != String.Empty)
                {
                    xreceived11 = xreceived11 + decimal.Parse(xreceived1.Text.Trim().ToString());
                }
