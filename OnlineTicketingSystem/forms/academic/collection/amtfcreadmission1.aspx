<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true"
    CodeBehind="amtfcreadmission1.aspx.cs" Inherits="OnlineTicketingSystem.forms.academic.assesment.class_test_schedule.amtfcreadmission1" %>
        ...
        <ContentTemplate>--%>
            <script type="text/javascript">
                ...
                $("body").on("change keyup", "[id*=xreceived]", function () {
                    ...
                    //alert(grid);
                    grid.rows[grid.rows.length - 1].cells[11].innerHTML = grandTotal;

                    var grandTotal1 = 0;

                    for (var i = 2; i < grid.rows.length - 1; i++) {
                        var xreceived1 = parseFloat(grid.rows[i].cells[11].children[0].value);
            ...
            <div class="bm_academic_container">
                <div class="bm_academic_container_header">
                    <div class="header_label1" id="header_label" runat="server">
                        <span class="bm_am_header_round">Readmission Receipts</span>
                    </div>
                </div>
                                ...
                                <div class="bm_academic_grid_container2" style="width: 100%">
                                    <div class="bm_hotkey" style="clear: both; padding-left: 10px;padding-bottom: 5px">
                                        <table style="border:1px solid white"><tr style="border: 1px solid white">
                                            ...
                                            <td style="background-color: silver; color: black;margin: 1px">Close - Alt + C</td>
                                            <td style="background-color: silver; color:darkcyan;margin: 1px">GenerateID - Alt + G</td>
                                            </tr></table>
                                    </div>
