...
{
    public partial class glhrc3 : Page
    {
        ...
        protected void FillControls(object sender, EventArgs e)
        {
            try
            {
                ...
                string str = "SELECT xhrc3,xdesc FROM glhrc31 where xhrc1=@xhrc1 and xhrc2=@xhrc2 and xhrc3=@xhrc3";
        ...
        public void fnFillDataGrid()
        {
            ...
            dts.Reset();
            string str = "SELECT xhrc3 FROM glhrc31 WHERE xhrc1=@xhrc1 and xhrc2=@xhrc2";
            SqlDataAdapter da = new SqlDataAdapter(str, conn1);
            da.SelectCommand.Parameters.AddWithValue("@xhrc1", ViewState["level1"]);
            da.SelectCommand.Parameters.AddWithValue("@xhrc2", ViewState["level2"]);
            da.Fill(dts, "tempztcode");
            ...
            if (dtztcode.Rows.Count > 0)
            {
                ...
                dts.Reset();
                str = "SELECT xhrc4 FROM glhrc41 WHERE xhrc1=@xhrc1 and xhrc2=@xhrc2 and xhrc3=@xhrc3";
                da = new SqlDataAdapter(str, conn1);
                da.SelectCommand.Parameters.AddWithValue("@xhrc1", ViewState["level1"]);
                da.SelectCommand.Parameters.AddWithValue("@xhrc2", ViewState["level2"]);
                ...
                if (tbl.Rows.Count > 0)
                {
                    using (TransactionScope tran = new TransactionScope())
                    {
                        using (SqlConnection conn = new SqlConnection(zglobal.constring))
                        {
                            ...
                            cmd.Connection = conn;
                            string query = "INSERT INTO glhrc31 (ztime,xhrc1,xhrc2,xhrc3,xdesc) " +
                                           "VALUES(@ztime,@xhrc1,@xhrc2,@xhrc3,@xdesc) ";
                            ...
                            {
                                cmd.Parameters.Clear();
                                query = "INSERT INTO glhrc32 (xhrc1,xhrc2,xhrc3,zid) " +
                                           "VALUES(@xhrc1,@xhrc2,@xhrc3,@zid) ";
                                cmd.CommandText = query;
                                cmd.Parameters.AddWithValue("@xhrc1", xhrc11);
                                cmd.Parameters.AddWithValue("@xhrc2", xhrc21);
                                cmd.Parameters.AddWithValue("@xhrc3", xhrc311);
                ...
                if (tbl.Rows.Count > 0)
                {
                    using (TransactionScope tran = new TransactionScope())
                    {
                        using (SqlConnection conn = new SqlConnection(zglobal.constring))
                        {
                            ...
                            SqlCommand cmd = new SqlCommand();
                            cmd.Connection = conn;
                            string query = "UPDATE glhrc31 SET zutime=@zutime,xdesc=@xdesc " +
                                           "WHERE xhrc1=@xhrc1 and xhrc2=@xhrc2 and xhrc3=@xhrc3";
                            ...
                            cmd.Parameters.Clear();
                            query = "DELETE FROM glhrc32 WHERE xhrc1=@xhrc1 and xhrc2=@xhrc2 and xhrc3=@xhrc3 ";
                            cmd.CommandText = query;
                            cmd.Parameters.AddWithValue("@xhrc1", xhrc11);
                            cmd.Parameters.AddWithValue("@xhrc2", xhrc21);
                            cmd.Parameters.AddWithValue("@xhrc3", xhrc311);
                ...
                if (txtconformmessageValue.Value == "Yes")
                {
                    ...
                    using (TransactionScope tran = new TransactionScope())
                    {
                        using (SqlConnection conn = new SqlConnection(zglobal.constring))
                        {
                            ...
                            SqlCommand cmd = new SqlCommand();
                            cmd.Connection = conn;
                            string query = "DELETE FROM glhrc32 WHERE xhrc1=@xhrc1 and xhrc2=@xhrc2 and xhrc3=@xhrc3";
                            string xhrc11 = ViewState["level1"].ToString();
                            string xhrc21 = ViewState["level2"].ToString();
                            string xhrc311 = xhrc3.Text.ToString().Trim();
                            cmd.Parameters.AddWithValue("@xhrc1", xhrc11);
                            ...
                            cmd.Parameters.Clear();
                            query = "DELETE FROM glhrc31 WHERE xhrc1=@xhrc1 and xhrc2=@xhrc2 and xhrc3=@xhrc3";
                            cmd.CommandText = query;
                            cmd.Parameters.AddWithValue("@xhrc1", xhrc11);
                            cmd.Parameters.AddWithValue("@xhrc2", xhrc21);
                            cmd.Parameters.AddWithValue("@xhrc3", xhrc311);
                            ...
                            cmd.Parameters.Clear();
                            query = "DELETE FROM glhrc42 WHERE xhrc1=@xhrc1 and xhrc2=@xhrc2 and xhrc3=@xhrc3";
                            cmd.CommandText = query;
                            cmd.Parameters.AddWithValue("@xhrc1", xhrc11);
                            cmd.Parameters.AddWithValue("@xhrc2", xhrc21);
                            cmd.Parameters.AddWithValue("@xhrc3", xhrc311);
                            ...
                            cmd.Parameters.Clear();
                            query = "DELETE FROM glhrc41 WHERE xhrc1=@xhrc1 and xhrc2=@xhrc2 and xhrc3=@xhrc3";
                            cmd.CommandText = query;
                            cmd.Parameters.AddWithValue("@xhrc1", xhrc11);
                            cmd.Parameters.AddWithValue("@xhrc2", xhrc21);
                            cmd.Parameters.AddWithValue("@xhrc3", xhrc311);
                            ...
                            cmd.Parameters.Clear();
                            query = "DELETE FROM glhrc52 WHERE xhrc1=@xhrc1 and xhrc2=@xhrc2 and xhrc3=@xhrc3";
                            cmd.CommandText = query;
                            cmd.Parameters.AddWithValue("@xhrc1", xhrc11);
                            cmd.Parameters.AddWithValue("@xhrc2", xhrc21);
                            cmd.Parameters.AddWithValue("@xhrc3", xhrc311);
                            ...
                            cmd.Parameters.Clear();
                            query = "DELETE FROM glhrc51 WHERE xhrc1=@xhrc1 and xhrc2=@xhrc2 and xhrc3=@xhrc3";
                            cmd.CommandText = query;
                            cmd.Parameters.AddWithValue("@xhrc1", xhrc11);
                            cmd.Parameters.AddWithValue("@xhrc2", xhrc21);
                            cmd.Parameters.AddWithValue("@xhrc3", xhrc311);
        ...
        protected void LinkButton3_Click(object sender, EventArgs e)
        {
            try
            {
                if (ViewState["level3"] == null)
                {
                    ...
                    string str = "SELECT TOP 1 xhrc3 FROM glhrc31 WHERE xhrc1=@xhrc1 and xhrc2=@xhrc2";
                    SqlDataAdapter da = new SqlDataAdapter(str, conn1);
                    da.SelectCommand.Parameters.AddWithValue("@xhrc1", ViewState["level1"]);
                    da.SelectCommand.Parameters.AddWithValue("@xhrc2", ViewState["level2"]);
                    da.Fill(dts, "tempztcode");
                ...
                Response.Redirect("~/forms/BMERP/Accounts/glhrc4.aspx?level1=" + Server.UrlEncode(ViewState["level1"].ToString()) + "&level2=" + Server.UrlEncode(ViewState["level2"].ToString()) + "&level3=" + Server.UrlEncode(ViewState["level3"].ToString()));
            }
            catch (Exception exp)
            {
                msg.InnerHtml = exp.Message;
        ...
        public void fnGoToNextLevel(object sender, EventArgs e)
        {
            try
            {
                ...
                //    conn1.Dispose();
                //}
                Response.Redirect("~/forms/BMERP/Accounts/glhrc4.aspx?level1=" + Server.UrlEncode(ViewState["level1"].ToString()) + "&level2=" + Server.UrlEncode(ViewState["level2"].ToString()) + "&level3=" + Server.UrlEncode(ViewState["level3"].ToString()) + "&level4=" + Server.UrlEncode(((LinkButton)sender).Text));
            }
            catch (Exception exp)
            {
                msg.InnerHtml = exp.Message;
