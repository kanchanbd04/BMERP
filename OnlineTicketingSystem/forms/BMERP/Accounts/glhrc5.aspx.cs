...
{
    public partial class glhrc5 : Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!IsPostBack)
                {
                    ...
                    ViewState["level5"] = Request.QueryString["level5"];
                    level4.Text = "List of " + ViewState["level4"];
                    if (ViewState["level5"] != null)
                    {
                        //Response.Write(ViewState["level2"].ToString());
                        LinkButton lb = new LinkButton();
                        lb.Text = ViewState["level5"].ToString();
        ...
        private DataTable fnCheckBusiness()
        {
            using (SqlConnection conn = new SqlConnection(zglobal.constring))
            {
                using (DataSet dts = new DataSet())
                {
                    ...
                    {
                        dts.Reset();
                        query = "SELECT zid FROM glhrc42 WHERE xhrc1=@xhrc1 and xhrc2=@xhrc2 and xhrc3=@xhrc3 and xhrc4=@xhrc4";
        ...
        protected void FillControls(object sender, EventArgs e)
        {
            try
            {
                ...
                string str = "SELECT xhrc5,xdesc FROM glhrc51 where xhrc1=@xhrc1 and xhrc2=@xhrc2 and xhrc3=@xhrc3 and xhrc4=@xhrc4 and xhrc5=@xhrc5";
                ...
                da.SelectCommand.Parameters.AddWithValue("@xhrc3", ViewState["level3"]);
                da.SelectCommand.Parameters.AddWithValue("@xhrc4", ViewState["level4"]);
                da.SelectCommand.Parameters.AddWithValue("@xhrc5", ((LinkButton) sender).Text);
                da.Fill(dts, "tempztcode");
                DataTable dtztcode = new DataTable();
                dtztcode = dts.Tables[0];

                xhrc5.Text = dtztcode.Rows[0][0].ToString();
                ...
                da.Dispose();
                conn1.Dispose();
                ViewState["level5"] = ((LinkButton)sender).Text;
                fnFillDataGrid();
            }
            catch (Exception exp)
            {
        ...
        public void fnFillDataGrid()
        {
            ...
            dts.Reset();
            string str = "SELECT xhrc5 FROM glhrc51 WHERE xhrc1=@xhrc1 and xhrc2=@xhrc2 and xhrc3=@xhrc3 and xhrc4=@xhrc4";
            SqlDataAdapter da = new SqlDataAdapter(str, conn1);
            da.SelectCommand.Parameters.AddWithValue("@xhrc1", ViewState["level1"]);
            da.SelectCommand.Parameters.AddWithValue("@xhrc2", ViewState["level2"]);
            da.SelectCommand.Parameters.AddWithValue("@xhrc3", ViewState["level3"]);
                ...
                if (tbl.Rows.Count > 0)
                {
                    using (TransactionScope tran = new TransactionScope())
                    {
                        using (SqlConnection conn = new SqlConnection(zglobal.constring))
                        {
                            ...
                            cmd.Connection = conn;
                            string query = "INSERT INTO glhrc51 (ztime,xhrc1,xhrc2,xhrc3,xhrc4,xhrc5,xdesc) " +
                                           "VALUES(@ztime,@xhrc1,@xhrc2,@xhrc3,@xhrc4,@xhrc5,@xdesc) ";
                            ...
                            string xhrc41 = ViewState["level4"].ToString();
                            string xhrc511 = xhrc5.Text.ToString().Trim();
                            ...
                            cmd.Parameters.AddWithValue("@xhrc4", xhrc41);
                            cmd.Parameters.AddWithValue("@xhrc5", xhrc511);
                            ...
                            {
                                cmd.Parameters.Clear();
                                query = "INSERT INTO glhrc52 (xhrc1,xhrc2,xhrc3,xhrc4,xhrc5,zid) " +
                                           "VALUES(@xhrc1,@xhrc2,@xhrc3,@xhrc4,@xhrc5,@zid) ";
                                cmd.CommandText = query;
                                cmd.Parameters.AddWithValue("@xhrc1", xhrc11);
                                cmd.Parameters.AddWithValue("@xhrc2", xhrc21);
                                cmd.Parameters.AddWithValue("@xhrc3", xhrc31);
                ...
                if (tbl.Rows.Count > 0)
                {
                    using (TransactionScope tran = new TransactionScope())
                    {
                        using (SqlConnection conn = new SqlConnection(zglobal.constring))
                        {
                            ...
                            SqlCommand cmd = new SqlCommand();
                            cmd.Connection = conn;
                            string query = "UPDATE glhrc51 SET zutime=@zutime,xdesc=@xdesc " +
                                           "WHERE xhrc1=@xhrc1 and xhrc2=@xhrc2 and xhrc3=@xhrc3 and xhrc4=@xhrc4 and xhrc5=@xhrc5";
                            ...
                            cmd.Parameters.Clear();
                            query = "DELETE FROM glhrc52 WHERE xhrc1=@xhrc1 and xhrc2=@xhrc2 and xhrc3=@xhrc3 and xhrc4=@xhrc4 and xhrc5=@xhrc5";
                            cmd.CommandText = query;
                            cmd.Parameters.AddWithValue("@xhrc1", xhrc11);
                            cmd.Parameters.AddWithValue("@xhrc2", xhrc21);
                            cmd.Parameters.AddWithValue("@xhrc3", xhrc31);
                ...
                if (txtconformmessageValue.Value == "Yes")
                {
                    ...
                    using (TransactionScope tran = new TransactionScope())
                    {
                        using (SqlConnection conn = new SqlConnection(zglobal.constring))
                        {
                            ...
                            SqlCommand cmd = new SqlCommand();
                            cmd.Connection = conn;
                            string query = "DELETE FROM glhrc52 WHERE xhrc1=@xhrc1 and xhrc2=@xhrc2 and xhrc3=@xhrc3 and xhrc4=@xhrc4 and xhrc5=@xhrc5";
                            string xhrc11 = ViewState["level1"].ToString();
                            string xhrc21 = ViewState["level2"].ToString();
                            string xhrc31 = ViewState["level3"].ToString();
                            string xhrc41 = ViewState["level4"].ToString();
                            ...
                            cmd.Parameters.Clear();
                            query = "DELETE FROM glhrc51 WHERE xhrc1=@xhrc1 and xhrc2=@xhrc2 and xhrc3=@xhrc3 and xhrc4=@xhrc4 and xhrc5=@xhrc5";
                            cmd.CommandText = query;
                            cmd.Parameters.AddWithValue("@xhrc1", xhrc11);
                            cmd.Parameters.AddWithValue("@xhrc2", xhrc21);
                            cmd.Parameters.AddWithValue("@xhrc3", xhrc31);
        ...
        protected void LinkButton6_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //    //conn1.Dispose();
                //}
                Response.Redirect("~/forms/BMERP/Accounts/glhrc4.aspx?level1=" + Server.UrlEncode(ViewState["level1"].ToString()) + "&level2=" + Server.UrlEncode(ViewState["level2"].ToString()) + "&level3=" + Server.UrlEncode(ViewState["level3"].ToString()) + "&level4=" + Server.UrlEncode(ViewState["level4"].ToString()));
            }
            catch (Exception exp)
            {
                msg.InnerHtml = exp.Message;
