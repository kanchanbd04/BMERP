...
{
    public partial class zbusiness_sel_all_code : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //    //}
                ...
                if (!IsPostBack)
                {
                    ...
                    xcode = Request.QueryString["xcode"] != "" ? Request.QueryString["xcode"] : "-1";
                    string tbl = Request.QueryString["tbl"] != "" ? Request.QueryString["tbl"] : "";
                    zid = Request.QueryString["zid"] != "" ? Request.QueryString["zid"] : "-1";
                    xtype = Request.QueryString["xtype"] != "" ? Request.QueryString["xtype"] : "-1";
                    ...
                    string str = "select zid from "+ tbl +" where xtype=@xtype and xcode=@xcode";
                    ...
                    da4.SelectCommand.Parameters.AddWithValue("@xtype", xtype);
                    da4.SelectCommand.Parameters.AddWithValue("@xcode", xcode);
