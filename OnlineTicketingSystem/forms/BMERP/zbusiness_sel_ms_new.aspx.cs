...
{
    public partial class zbusiness_sel_ms_new : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //    //}
                ...
                if (!IsPostBack)
                {
                    ...
                    string str = "select zid,(select zorg from zbusiness where zid=mscusbiz.zid) as zorg, coalesce(xar,'') as xar from mscusbiz where xrowd=@xrowd";
                ...
                using (TransactionScope tran = new TransactionScope())
                {
                    foreach (GridViewRow row in GridView1.Rows)
                    {
                        ...
                        if (chk.Checked)
                        {
                            ...
                            str1 = zglobal.insmscusar1;
                            dataCmd1.CommandText = str1;
                            dataCmd1.Parameters.Clear();
                            dataCmd1.Parameters.AddWithValue("@zid4", row.Cells[1].Text.ToString());
