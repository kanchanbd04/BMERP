<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="zbusiness_sel_ms_sup.aspx.cs"
    Inherits="OnlineTicketingSystem.forms.BMERP.zbusiness_sel_ms_sup" EnableEventValidation="false" %>
                            ...
                            <td>
                                ...
                                <asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                               <%-- <asp:HyperLinkField NavigateUrl='~/forms/BMERP/multiple_accounts_sel.aspx?zid1=<%# Eval("zid") %>>'
                                                    Text="Account(s) Selection" />--%>
                                                    <%-- <a id="biz"  href='multiple_accounts_sel.aspx?zid=<%# Eval("zid") %>&zorg=<%# Eval("zorg") %>'>Account(s) Selection</a>--%>
                                                <asp:TextBox ID="accounts" runat="server" Enabled="False" ></asp:TextBox>
                                               <%-- <asp:ImageButton ID="acclist" runat="server" class="acclistClass"  OnClientClick='<%# String.Format("messagebox(\"{0}\");", ((GridViewRow)Container).FindControl("accounts").ClientID) %>' ImageUrl="~/images/list16x16.png" />--%>
                                            </ItemTemplate>
                                     </asp:TemplateField>
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                <%--<asp:ImageButton ID="acclist" runat="server" class="acclistClass" OnClientClick='<%# String.Format("ow(\"{0}\");", Eval("zid")) %>' ImageUrl="~/images/list16x16.png" /> OnClientClick='<%# String.Format("messagebox(\"{0}\");",GridView1.FindControl("accounts").ClientID) %>'--%>
                                                <asp:ImageButton ID="acclist" runat="server" class="acclistClass" Enabled="False" OnClientClick='<%# String.Format("ow(\"{0}\",\"{1}\",this);", Eval("zid"), ((GridViewRow) Container).FindControl("accounts").ClientID) %>' ImageUrl="~/images/list16x16.png" />
                                                <%--<asp:ImageButton ID="acclist" runat="server" class="acclistClass" CommandName="Select" OnClientClick= "test(this); return false;" ImageUrl="~/images/list16x16.png" />--%>
                                                <%--<asp:ImageButton ID="acclist" runat="server" class="acclistClass"  OnClientClick='<%# String.Format("ow(\"{0}\");",Eval("zid")) %>' ImageUrl="~/images/list16x16.png" />--%>
                                                <%--<asp:ImageButton ID="acclist" runat="server" class="acclistClass" CommandName="Select" OnClientClick= " return SetPIN(100);" ImageUrl="~/images/list16x16.png" />--%>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
