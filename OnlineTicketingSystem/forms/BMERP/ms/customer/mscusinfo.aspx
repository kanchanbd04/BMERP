<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="mscusinfo.aspx.cs" Inherits="OnlineTicketingSystem.forms.BMERP.ms.customer.cacus" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $('#<%=business.ClientID %>').live('click', function (e) {
                ...
                var page = "../../../BMERP/zbusiness_sel_ms_new.aspx?key=" + key1;
                var $dialog = $('<div></div>')
                .html('<iframe style="border: 0px; " src="' + page + '" width="100%" height="100%"></iframe>')
                .dialog({
                    autoOpen: false,
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <tr>
        <td class="style4">
            <strong>Customer Info</strong></td>
        <td class="style2" rowspan="2">
         <table width="100%">
         <tr>
        <td class="style400" colspan="4">
            Confirmed Customer Record(s) List</td>
    </tr>
    <tr><td>
                ...
                Width="536px">
                    ...
                    <asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="#333333" 
                        ...
                        <asp:LinkButton ID="xrow" runat="server"  Text='<%#Eval("xrow") %>' OnClick="FillControls"></asp:LinkButton>
                             ...
                             <asp:BoundField DataField="xcus" HeaderText="Customer Number" />
            ...
            <table style="width:100%;">
                ...
                <tr>
                    <td class="style32">
                        Customer Prefix</td>
                    <td class="style33">
                        <asp:Label ID="xtrn" runat="server" Text="CUS-"></asp:Label>
                    </td>
                    <td class="style7">
                        Customer ID</td>
                    <td class="style29">
                        <asp:TextBox ID="xcus" runat="server" Width="151px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td class="style32">
