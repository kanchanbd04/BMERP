<%@ Page Title="" Language="C#" MasterPageFile="~/academic_site.Master" AutoEventWireup="true" CodeBehind="ztrole.aspx.cs" Inherits="OnlineTicketingSystem.forms.sc.ztrole" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
 ...
 <div id="dialog" style="display: none">
    ...
    <tr>
        <td class="style4">
            <strong>Role Management</strong></td>
        <td class="style2" rowspan="2">
                    ...
                    <asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="#333333" 
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="Role">
                              <ItemTemplate>
                        <asp:LinkButton ID="xrole" runat="server"  Text='<%#Eval("xrole") %>' OnClick="FillControls"></asp:LinkButton>
            ...
            <ItemTemplate><asp:CheckBox ID="status" runat="server" Enabled="false" Checked='<%# (Eval("zactive").ToString() == "1" ? true : false) %>' /></ItemTemplate>
                             ...
                             <asp:TemplateField HeaderText="Permission">
                              <ItemTemplate>
                       <%-- <asp:LinkButton ID="LinkButtonEdit1" runat="server" CommandName="" CommandArgument='<%#Eval("xuser") %>' >Set Permission</asp:LinkButton>--%>
                       <a id="popup" href='ztpermis.aspx?xrole=<%# Eval("xrole") %>&page=role' onclick=>Set Permission</a>
                    </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
            ...
            <table style="width:100%;">
                ...
                <tr>
                    <td class="style7">
                        Role</td>
                    <td class="style10">
                        <asp:TextBox ID="xrole" runat="server" Width="151px"></asp:TextBox>
