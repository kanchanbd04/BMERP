<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="cancelparam.aspx.cs" Inherits="OnlineTicketingSystem.forms.sc.Reports.cancelparam" %>
 ...
 <link rel="stylesheet" href="../../../Scripts/jquery-ui-1.9.2.custom/development-bundle/themes/base/jquery.ui.all.css">
    ...
    <script>
        ...
        $("[id*=btnShow]").live("click", function () {
            ...
            window.open("cancelrpt.aspx?xfrom1=" + xfrom1 + "&xto1=" + xto1 +"&xtype1=" + xtype1 + "&xuser1=" + xuser1);
        });
