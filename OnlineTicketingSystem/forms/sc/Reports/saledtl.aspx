<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="saledtl.aspx.cs" Inherits="OnlineTicketingSystem.forms.sc.Reports.saledtl" %>
            ...
            <table class="style1" style="width: 100%">
                <tr>
                    <td class="style4" colspan="7">
                        <strong><span class="style18">Employeewise </span>
                        <asp:Label ID="Label1" runat="server" style="font-size: medium" Text="Label"></asp:Label>
&nbsp;<span class="style18">Report</span></strong></td>
                </tr>
                <tr>
                    <td class="style8">
                        &nbsp;</td>
                ...
                <tr>
                    <td class="style2" colspan="7">
                        <table border="1" frame='border' style='border-style: ridge; border-width: thin;
                            ...
                            <td>
                                <asp:Label ID="xsold" runat="server" Text="xsold"></asp:Label></td>
                                 <td>
                                <asp:Label ID="xcan" runat="server" Text="xcan"></asp:Label></td>
                                 <td>
                                <asp:Label ID="xtotal" runat="server" Text="xtotal"></asp:Label></td>
                                 <td>
                                <asp:Label ID="xreturn" runat="server" Text="xreturn"></asp:Label></td>
                                 <td>
                                <asp:Label ID="xdiscount" runat="server" Text="xdiscount"></asp:Label></td>
                                 <td>
                                <asp:Label ID="xincome" runat="server" Text="xincome"></asp:Label></td>
                                 <td>
                                &nbsp;</td>
                            </tr>
                        </table>
