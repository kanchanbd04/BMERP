<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ztissue.aspx.cs" Inherits="OnlineTicketingSystem.forms.sc.ztissue" %>
    ...
    .style8
    {
       ...
       <script language="javascript">
           ...
           function ConfirmMessage1() {
               var selectedvalue = confirm("Please check your range. Do you want to Confirm?");
               if (selectedvalue) {
                ...
                Width="536px">
                    ...
                    <asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="#333333" 
                        ...
                        <asp:LinkButton ID="xid" runat="server"  Text='<%#Eval("xid") %>' OnClick="FillControls" ></asp:LinkButton>
                            ...
                            <asp:BoundField DataField="xtoc" HeaderText="Counter Name" />
                            <asp:BoundField DataField="xdatetime" DataFormatString="{0:d}" HeaderText="Issue Date" />
            ...
            <table style="width:100%;">
                ...
                <tr>
                    <td class="style31">
                        Issue&nbsp; ID</td>
                    <td class="style10">
                        <asp:TextBox ID="xid" runat="server" Width="151px"></asp:TextBox>
                    </td>
                    <td class="style8">
                        &nbsp;</td>
                    <td class="style29">
                ...
                <tr>
                    <td class="style40">
                        Counter Name</td>
                    <td class="style41">
                        <asp:DropDownList ID="xtoc" runat="server" Height="35px" Width="153px" 
                            AutoPostBack="True">
                        </asp:DropDownList>
                ...
                <tr>
                    <td class="style40">
                        Ticket To </td>
                    <td class="style41">
                        <asp:TextBox ID="xtot" runat="server" Height="24px" Width="151px"></asp:TextBox>
                ...
                <tr>
                    <td class="style44">
                        Total Ticket</td>
                    <td class="style45">
                        <asp:TextBox ID="xtotal" runat="server" Width="151px"></asp:TextBox>
                    </td>
                    <td class="style46">
                        </td>
                    <td class="style47">
                            ...
                            Font-Bold="True" Height="30px" 
                                ...
                                <td style="text-align: left">
                                    <asp:Button ID="btnConfirm" runat="server" Text="Confirm" Font-Bold="True" Height="30px" 
                                        ...
                                        OnClientClick="javascript:ConfirmMessage1()" onclick="btnConfirm_Click"/>
                                </td>
                                <td>
                                    &nbsp;</td>
