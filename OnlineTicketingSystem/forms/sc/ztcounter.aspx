<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ztcounter.aspx.cs" Inherits="OnlineTicketingSystem.forms.sc.ztcounter" %>
            ...
            <asp:Panel ID="Panel1" runat="server" Height="363px" ScrollBars="Auto" 
                Width="536px">
                    ...
                    <asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="#333333" 
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="Counter Code">
                              <ItemTemplate>
                        <asp:LinkButton ID="xid" runat="server"  Text='<%#Eval("xid") %>' OnClick="FillControls"></asp:LinkButton>
                       
                    </ItemTemplate>
                            </asp:TemplateField>
                            <asp:BoundField DataField="xcname" HeaderText="Counter Name" />
            ...
            <table style="width:100%;">
                ...
                <tr>
                    <td class="style6">
                        Counter ID</td>
                    <td class="style10">
                        <asp:Label ID="xid" runat="server" Font-Bold="True" Font-Size="Medium" 
                ...
                <tr>
                    <td class="style7">
                        Counter Name</td>
                    <td class="style10">
                        <asp:TextBox ID="xcname" runat="server" Width="151px"></asp:TextBox>
                    ...
                    <td class="style7">
                        Status</td>
                    <td class="style29">
                        <asp:DropDownList ID="xstatus" runat="server" Height="20px" Width="151px">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
                    <td class="style7">
                        Owners</td>
                    <td class="style10">
                        <asp:TextBox ID="xowners" runat="server" Width="151px"></asp:TextBox>
                    </td>
                    <td class="style7">
                        Landlord</td>
                    <td class="style29">
                        <asp:TextBox ID="xlandlord" runat="server" Width="151px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td class="style7">
                        City</td>
                    <td class="style10">
                        <asp:DropDownList ID="xcity" runat="server" Height="20px" Width="151px">
                        </asp:DropDownList>
                    ...
                    <td class="style7">
                        Security</td>
                    <td class="style29">
                        <asp:TextBox ID="xsecurity" runat="server" Width="151px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td class="style7">
                        Monthly Rent</td>
                    <td class="style10">
                        <asp:TextBox ID="xmntrent" runat="server" Width="151px"></asp:TextBox>
                    </td>
                    <td class="style7">
                        Contact No</td>
                    <td class="style29">
                ...
                <tr>
                    ...
                    <td class="style10" rowspan="3">
                        <textarea id="xaddress" name="S1" runat="server"></textarea></td>
                    <td class="style7">
                        Active?</td>
                    <td class="style13">
