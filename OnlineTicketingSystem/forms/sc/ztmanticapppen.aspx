<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="ztmanticapppen.aspx.cs" Inherits="OnlineTicketingSystem.forms.sc.ztmanticapppen" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <table class="style1">
        ...
        <tr class="style4">
            <td class="style5">
                <strong style="">Pending Request List for Manual Ticket Approval </strong>
            </td>
        </tr>
        <tr>
            <td>
                <asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="xname" HeaderText="Passenger Name" />
                        <asp:BoundField DataField="xcontact" HeaderText="Contact No." />
                        <asp:BoundField DataField="xrate" HeaderText="Rate" />
                        <asp:BoundField DataField="xamount" HeaderText="Amount" />
                        <asp:BoundField DataField="xdiscount" HeaderText="Discount" />
                        ...
                        <asp:TemplateField HeaderText="">
                            <ItemTemplate>
                                ...
                                <asp:LinkButton ID="approve" runat="server" CommandName="" CommandArgument='<%#Eval("xrow") %>'
                                    OnClick="fnApprove">Approve</asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="">
                            <ItemTemplate>
                                ...
                                <%-- <a id="popup" href='ztpermis.aspx?xuser=<%# Eval("xuser") %>&page=user'>Set Permission</a>--%>
                                <asp:LinkButton ID="cancel" runat="server" CommandName="" CommandArgument='<%#Eval("xrow") %>'
                                    OnClick="fnCancel">Cancel</asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
