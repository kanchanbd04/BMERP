<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ztruncostsetup.aspx.cs" Inherits="OnlineTicketingSystem.forms.sc.ztruncostsetup" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
 ...
 <div id="dialog" style="display: none">
    ...
    <tr>
        <td class="style4">
            <strong>Running Cost AC </strong></td>
                ...
                <tr>
                    ...
                    <td class="style10">
                        <asp:Label ID="xtype" runat="server" Font-Bold="True" Font-Size="Medium" 
                            Text="Running Cost AC"></asp:Label>
                    </td>
                    <td class="style8">
                        &nbsp;</td>
                    <td class="style29">
